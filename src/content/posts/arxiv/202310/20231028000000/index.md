...
### (1/109) Fantastic Gains and Where to Find Them: On the Existence and Prospect of General Knowledge Transfer between Any Pretrained Model (Karsten Roth et al., 2023)
...
### (2/109) Defending Against Transfer Attacks From Public Models (Chawin Sitawarin et al., 2023)
...
### (3/109) Combating Representation Learning Disparity with Geometric Harmonization (Zhihan Zhou et al., 2023)
...
### (4/109) Uncovering Meanings of Embeddings via Partial Orthogonality (Yibo Jiang et al., 2023)
...
### (5/109) PAC-tuning:Fine-tuning Pretrained Language Models with PAC-driven Perturbed Gradient Descent (Guangliang Liu et al., 2023)
...
### (6/109) BLIS-Net: Classifying and Analyzing Signals on Graphs (Charles Xu et al., 2023)
...
### (7/109) Hierarchical Ensemble-Based Feature Selection for Time Series Forecasting (Aysin Tumay et al., 2023)
...
### (8/109) The Expressive Power of Low-Rank Adaptation (Yuchen Zeng et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2310.17513v1)  
...
### (9/109) CBD: A Certified Backdoor Detector Based on Local Dominant Probability (Zhen Xiang et al., 2023)
...
### (10/109) FedPEAT: Convergence of Federated Learning, Parameter-Efficient Fine Tuning, and Emulator Assisted Tuning for Artificial Intelligence Foundation Models with Mobile Edge Computing (Terence Jie Chua et al., 2023)
...
### (11/109) Coalitional Bargaining via Reinforcement Learning: An Application to Collaborative Vehicle Routing (Stephen Mak et al., 2023)
...
### (12/109) Enhancing Graph Neural Networks with Structure-Based Prompt (Qingqing Ge et al., 2023)
...
### (13/109) Towards Unifying Diffusion Models for Probabilistic Spatio-Temporal Graph Learning (Junfeng Hu et al., 2023)
...
### (14/109) De-novo Chemical Reaction Generation by Means of Temporarily Convolutional Neural Networks (Andrei Buin et al., 2023)
...
Categories: cs-LG, cs.LG  
Keywords: NLP  
[Paper Link](http://arxiv.org/abs/2310.17341v1)  
...
### (15/109) CQM: Curriculum Reinforcement Learning with a Quantized World Model (Seungjae Lee et al., 2023)
...
### (16/109) C-Disentanglement: Discovering Causally-Independent Generative Factors under an Inductive Bias of Confounder (Xiaoyu Liu et al., 2023)
...
### (17/109) Looping in the Human: Collaborative and Explainable Bayesian Optimization (Masaki Adachi et al., 2023)
...
Keywords: AI  
[Paper Link](http://arxiv.org/abs/2310.17273v1)  
...
### (18/109) Codebook Features: Sparse and Discrete Interpretability for Neural Networks (Alex Tamkin et al., 2023)
...
### (19/109) miditok: A Python package for MIDI file tokenization (Nathan Fradet et al., 2023)
...
### (20/109) How do Language Models Bind Entities in Context? (Jiahai Feng et al., 2023)
...
### (21/109) Deja Vu: Contextual Sparsity for Efficient LLMs at Inference Time (Zichang Liu et al., 2023)
...
### (22/109) Explainable Spatio-Temporal Graph Neural Networks (Jiabin Tang et al., 2023)
...
### (23/109) Understanding and Addressing the Pitfalls of Bisimulation-based Representations in Offline Reinforcement Learning (Hongyu Zang et al., 2023)
...
### (24/109) Unleashing the potential of GNNs via Bi-directional Knowledge Transfer (Shuai Zheng et al., 2023)
...
### (25/109) LLM4DyG: Can Large Language Models Solve Problems on Dynamic Graphs? (Zeyang Zhang et al., 2023)
...
### (26/109) Network Design through Graph Neural Networks: Identifying Challenges and Improving Performance (Donald Loveland et al., 2023)
...
### (27/109) Transformers Learn Higher-Order Optimization Methods for In-Context Learning: A Study with Linear Models (Deqing Fu et al., 2023)
...
### (28/109) A Coarse-to-Fine Pseudo-Labeling (C2FPL) Framework for Unsupervised Video Anomaly Detection (Anas Al-lahham et al., 2023)
...
### (29/109) Evaluating Bias and Fairness in Gender-Neutral Pretrained Vision-and-Language Models (Laura Cabello et al., 2023)
...
### (30/109) A Hybrid Graph Network for Complex Activity Detection in Video (Salman Khan et al., 2023)
...
### (31/109) OTMatch: Improving Semi-Supervised Learning with Optimal Transport (Zhiquan Tan et al., 2023)
...
### (32/109) Uncertainty-weighted Loss Functions for Improved Adversarial Attacks on Semantic Segmentation (Kira Maag et al., 2023)
...
### (33/109) AntifakePrompt: Prompt-Tuned Vision-Language Models are Fake Image Detectors (You-Ming Chang et al., 2023)
...
### (34/109) Circuit as Set of Points (Jialv Zou et al., 2023)
...
### (35/109) YOLO-BEV: Generating Bird's-Eye View in the Same Way as 2D Object Detection (Chang Liu et al., 2023)
...
### (36/109) CADS: Unleashing the Diversity of Diffusion Models through Condition-Annealed Sampling (Seyedmorteza Sadat et al., 2023)
...
### (37/109) RIO: A Benchmark for Reasoning Intention-Oriented Objects in Open Environments (Mengxue Qu et al., 2023)
...
### (38/109) Prototypical Contrastive Learning-based CLIP Fine-tuning for Object Re-identification (Jiachen Li et al., 2023)
...
### (39/109) Emotion Recognition by Video: A review (Junxiao Xue et al., 2023)
...
### (40/109) Understanding the Effects of Projectors in Knowledge Distillation (Yudong Chen et al., 2023)
...
### (41/109) Bridging The Gaps Between Token Pruning and Full Pre-training via Masked Fine-tuning (Fengyuan Shi et al., 2023)
...
### (42/109) MO-YOLO: End-to-End Multiple-Object Tracking Method with YOLO and MOTR (Liao Pan et al., 2023)
...
### (43/109) Low-Dimensional Gradient Helps Out-of-Distribution Detection (Yingwen Wu et al., 2023)
...
### (44/109) Simple Baselines for Projection-based Full-reference and No-reference Point Cloud Quality Assessment (Zicheng Zhang et al., 2023)
...
### (45/109) LP-OVOD: Open-Vocabulary Object Detection by Linear Probing (Chau Pham et al., 2023)
...
### (46/109) Navigating Data Heterogeneity in Federated Learning: A Semi-Supervised Approach for Object Detection (Taehyeon Kim et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2310.17097v1)  
...
### (47/109) HCT: Hybrid Convnet-Transformer for Parkinson's disease detection and severity prediction from gait (Safwen Naimi et al., 2023)
...
### (48/109) HyperFields: Towards Zero-Shot Generation of NeRFs from Text (Sudarshan Babu et al., 2023)
...
Categories: cs-CV, cs.CV  
Keywords: Zero-Shot  
[Paper Link](http://arxiv.org/abs/2310.17075v1)  
...
### (49/109) Do Graph Neural Networks Dream of Landau Damping? Insights from Kinetic Simulations of a Plasma Sheet Model (Diogo D Carvalho et al., 2023)
...
### (50/109) torchdistill Meets Hugging Face Libraries for Reproducible, Coding-Free Deep Learning Studies: A Case Study on NLP (Yoshitomo Matsubara, 2023)
...
### (51/109) JudgeLM: Fine-tuned Large Language Models are Scalable Judges (Lianghui Zhu et al., 2023)
...
### (52/109) InstOptima: Evolutionary Multi-objective Instruction Optimization via Large Language Model-based Instruction Operators (Heng Yang et al., 2023)
...
### (53/109) Proving Test Set Contamination in Black Box Language Models (Yonatan Oren et al., 2023)
...
### (54/109) LeCaRDv2: A Large-Scale Chinese Legal Case Retrieval Dataset (Haitao Li et al., 2023)
...
### (55/109) Lil-Bevo: Explorations of Strategies for Training Language Models in More Humanlike Ways (Venkata S Govindarajan et al., 2023)
...
### (56/109) An Open Source Data Contamination Report for Llama Series Models (Yucheng Li, 2023)
...
### (57/109) Global Voices, Local Biases: Socio-Cultural Prejudices across Languages (Anjishnu Mukherjee et al., 2023)
...
### (58/109) Skill-Mix: a Flexible and Expandable Family of Evaluations for AI models (Dingli Yu et al., 2023)
...
### (59/109) Can large language models replace humans in the systematic review process? Evaluating GPT-4's efficacy in screening and extracting data from peer-reviewed and grey literature in multiple languages (Qusai Khraisha et al., 2023)
...
Keywords: GPT, GPT-4  
[Paper Link](http://arxiv.org/abs/2310.17526v1)  
...
### (60/109) The Validity of Evaluation Results: Assessing Concurrence Across Compositionality Benchmarks (Kaiser Sun et al., 2023)
...
### (61/109) Improving Zero-shot Reader by Reducing Distractions from Irrelevant Documents in Open-Domain Question Answering (Sukmin Cho et al., 2023)
...
### (62/109) Dialect Adaptation and Data Augmentation for Low-Resource ASR: TalTech Systems for the MADASR 2023 Challenge (Tanel Alumäe et al., 2023)
...
### (63/109) ''Fifty Shades of Bias'': Normative Ratings of Gender Bias in GPT Generated English Text (Rishav Hada et al., 2023)
...
### (64/109) Harnessing GPT-3.5-turbo for Rhetorical Role Prediction in Legal Cases (Anas Belfathi et al., 2023)
...
### (65/109) ToxicChat: Unveiling Hidden Challenges of Toxicity Detection in Real-World User-AI Conversation (Zi Lin et al., 2023)
...
### (66/109) Cultural Adaptation of Recipes (Yong Cao et al., 2023)
...
### (67/109) ACT-SQL: In-Context Learning for Text-to-SQL with Automatically-Generated Chain-of-Thought (Hanchong Zhang et al., 2023)
...
### (68/109) Arabic Fine-Grained Entity Recognition (Haneen Liqreina et al., 2023)
...
### (69/109) An Ensemble Method Based on the Combination of Transformers with Convolutional Neural Networks to Detect Artificially Generated Text (Vijini Liyanage et al., 2023)
...
### (70/109) Learning to Abstract with Nonparametric Variational Information Bottleneck (Melika Behjati et al., 2023)
...
### (71/109) Understanding the Role of Input Token Characters in Language Models: How Does Information Loss Affect Performance? (Ahmed Alajrami et al., 2023)
...
### (72/109) Joint Entity and Relation Extraction with Span Pruning and Hypergraph Neural Networks (Zhaohui Yan et al., 2023)
...
### (73/109) EMMA-X: An EM-like Multilingual Pre-training Algorithm for Cross-lingual Representation Learning (Ping Guo et al., 2023)
...
### (74/109) Beyond MLE: Convex Learning for Text Generation (Chenze Shao et al., 2023)
...
### (75/109) Symbolic Planning and Code Generation for Grounded Dialogue (Justin T. Chiu et al., 2023)
...
### (76/109) Incorporating Probing Signals into Multimodal Machine Translation via Visual Question-Answering Pairs (Yuxin Zuo et al., 2023)
...
### (77/109) Test-time Augmentation for Factual Probing (Go Kamoda et al., 2023)
...
### (78/109) Topic Segmentation of Semi-Structured and Unstructured Conversational Datasets using Language Models (Reshmi Ghosh et al., 2023)
...
### (79/109) In-Context Learning Dynamics with Random Binary Sequences (Eric J. Bigelow et al., 2023)
...
### (80/109) CompeteAI: Understanding the Competition Behaviors in Large Language Model-based Agents (Qinlin Zhao et al., 2023)
...
### (81/109) Orchestration of Emulator Assisted Mobile Edge Tuning for AI Foundation Models: A Multi-Agent Deep Reinforcement Learning Approach (Wenhan Yu et al., 2023)
...
### (82/109) Goals are Enough: Inducing AdHoc cooperation among unseen Multi-Agent systems in IMFs (Kaushik Dey et al., 2023)
...
### (83/109) Dialogue-based generation of self-driving simulation scenarios using Large Language Models (Antonio Valerio Miceli-Barone et al., 2023)
...
### (84/109) Exploring the Potential of Generative AI for the World Wide Web (Nouar AlDahoul et al., 2023)
...
### (85/109) FormaT5: Abstention and Examples for Conditional Table Formatting with Natural Language (Mukul Singh et al., 2023)
...
### (86/109) Content-based Controls For Music Large Language Modeling (Liwei Lin et al., 2023)
...
### (87/109) Verifying Programs with Logic and Extended Proof Rules: Deep Embedding v.s. Shallow Embedding (Zhongye Wang et al., 2023)
...
### (88/109) 1D-Touch: NLP-Assisted Coarse Text Selection via a Semi-Direct Gesture (Peiling Jiang et al., 2023)
...
### (89/109) Effective Prime Factorization via Quantum Annealing by Modular Locally-structured Embedding (Jingwen Ding et al., 2023)
...
### (90/109) Unpacking the Ethical Value Alignment in Big Models (Xiaoyuan Yi et al., 2023)
...
### (91/109) Decoding The Digital Fukú: Deciphering Colonial Legacies to Critically Assess ChatGPT in Dominican Education (Anaelia Ovalle, 2023)
...
### (92/109) Bias in Evaluation Processes: An Optimization-Based Model (L. Elisa Celis et al., 2023)
...
### (93/109) Supercharging academic writing with generative AI: framework, techniques, and caveats (Zhicheng Lin, 2023)
...
### (94/109) Test Bench Study on Attitude Estimation in Ground Effect Region Based on Motor Current for In-Flight Inductive Power Transfer of Drones (Kota Fujimoto et al., 2023)
...
### (95/109) Optimal Robotic Assembly Sequence Planning: A Sequential Decision-Making Approach (Kartik Nagpal et al., 2023)
...
### (96/109) Adaptive Resource Management for Edge Network Slicing using Incremental Multi-Agent Deep Reinforcement Learning (Haiyuan Li et al., 2023)

{{<citation>}}

Haiyuan Li, Yuelin Liu, Xueqing Zhou, Xenofon Vasilakos, Reza Nejabati, Shuangyi Yan, Dimitra Simenidou. (2023)  
...
Keywords: Reinforcement Learning  
[Paper Link](http://arxiv.org/abs/2310.17523v1)  
...
### (97/109) Proposal on Model Based Current Overshoot Suppression of Receiver Side Coil in Drone Wireless Power Transfer System (Kota Fujimoto et al., 2023)
...
### (98/109) LEI2JSON: Schema-based Validation and Conversion of Livestock Event Information (Mahir Habib et al., 2023)
...
### (99/109) Controllable Generation of Artificial Speaker Embeddings through Discovery of Principal Directions (Florian Lux et al., 2023)
...
### (100/109) LightLM: A Lightweight Deep and Narrow Language Model for Generative Recommendation (Kai Mei et al., 2023)
...
### (101/109) Foundation Model Based Native AI Framework in 6G with Cloud-Edge-End Collaboration (Xiang Chen et al., 2023)
...
### (102/109) A near-autonomous and incremental intrusion detection system through active learning of known and unknown attacks (Lynda Boukela et al., 2023)
...
### (103/109) Network Intrusion Detection with Edge-Directed Graph Multi-Head Attention Networks (Xiang Li et al., 2023)
...
### (104/109) Static Semantics Reconstruction for Enhancing JavaScript-WebAssembly Multilingual Malware Detection (Yifan Xia et al., 2023)
...
### (105/109) A Method for Network Intrusion Detection Using Flow Sequence and BERT Framework (Loc Gia Nguyen et al., 2023)
...
### (106/109) Validating Digital Traces with Survey Data: The Use Case of Religiosity (M. Fuat Kına et al., 2023)
...
### (107/109) Automatic Edge Error Judgment in Figure Skating Using 3D Pose Estimation from a Monocular Camera and IMUs (Ryota Tanaka et al., 2023)
...
### (108/109) CosmosDSR -- a methodology for automated detection and tracking of orbital debris using the Unscented Kalman Filter (Daniel S. Roll et al., 2023)
...
### (109/109) Multi-Speaker Expressive Speech Synthesis via Semi-supervised Contrastive Learning (Xinfa Zhu et al., 2023)
