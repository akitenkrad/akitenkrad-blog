...
### (1/113) Efficient Streaming Language Models with Attention Sinks (Guangxuan Xiao et al., 2023)
...
### (2/113) ToRA: A Tool-Integrated Reasoning Agent for Mathematical Problem Solving (Zhibin Gou et al., 2023)
...
### (3/113) A Large Language Model Approach to Educational Survey Feedback Analysis (Michael J. Parker et al., 2023)
...
### (4/113) L2CEval: Evaluating Language-to-Code Generation Capabilities of Large Language Models (Ansong Ni et al., 2023)
...
### (5/113) CRAFT: Customizing LLMs by Creating and Retrieving from Specialized Toolsets (Lifan Yuan et al., 2023)
...
### (6/113) Can Sensitive Information Be Deleted From LLMs? Objectives for Defending Against Extraction Attacks (Vaidehi Patil et al., 2023)
...
### (7/113) Overview of the BioLaySumm 2023 Shared Task on Lay Summarization of Biomedical Research Articles (Tomsa Goldsack et al., 2023)
...
### (8/113) Few-Shot Domain Adaptation for Charge Prediction on Unprofessional Descriptions (Jie Zhao et al., 2023)
...
### (9/113) STRONG -- Structure Controllable Legal Opinion Summary Generation (Yang Zhong et al., 2023)
...
### (10/113) Enhancing Large Language Models in Coding Through Multi-Perspective Self-Consistency (Baizhou Huang et al., 2023)
...
### (11/113) Batch Calibration: Rethinking Calibration for In-Context Learning and Prompt Engineering (Han Zhou et al., 2023)
...
### (12/113) LLM-Deliberation: Evaluating LLMs with Interactive Multi-Agent Negotiation Games (Sahar Abdelnabi et al., 2023)
...
### (13/113) Comparative Analysis of Named Entity Recognition in the Dungeons and Dragons Domain (Gayashan Weerasundara et al., 2023)
...
### (14/113) An evaluation of GPT models for phenotype concept recognition (Tudor Groza et al., 2023)
...
### (15/113) LatticeGen: A Cooperative Framework which Hides Generated Text in a Lattice for Privacy-Aware Generation on Cloud (Mengke Zhang et al., 2023)
...
### (16/113) Using Large Language Models for Qualitative Analysis can Introduce Serious Bias (Julian Ashwin et al., 2023)
...
### (17/113) Promoting Generalized Cross-lingual Question Answering in Few-resource Scenarios via Self-knowledge Distillation (Casimiro Pio Carrino et al., 2023)
...
### (18/113) Fine-grained Late-interaction Multi-modal Retrieval for Retrieval Augmented Visual Question Answering (Weizhe Lin et al., 2023)
...
### (19/113) SCALE: Synergized Collaboration of Asymmetric Language Translation Engines (Xin Cheng et al., 2023)
...
### (20/113) Interpretable Long-Form Legal Question Answering with Retrieval-Augmented Large Language Models (Antoine Louis et al., 2023)
...
### (21/113) Benchmarking Cognitive Biases in Large Language Models as Evaluators (Ryan Koo et al., 2023)
...
### (22/113) I Wish to Have an Argument: Argumentative Reasoning in Large Language Models (Adrian de Wynter et al., 2023)
...
### (23/113) SSHR: Leveraging Self-supervised Hierarchical Representations for Multilingual Automatic Speech Recognition (Hongfei Xue et al., 2023)
...
### (24/113) Multi-task View Synthesis with Neural Radiance Fields (Shuhong Zheng et al., 2023)
...
### (25/113) FACTS: First Amplify Correlations and Then Slice to Discover Bias (Sriram Yenamandra et al., 2023)
...
### (26/113) Classification of Potholes Based on Surface Area Using Pre-Trained Models of Convolutional Neural Network (Chauhdary Fazeel Ahmad et al., 2023)
...
### (27/113) The Dawn of LMMs: Preliminary Explorations with GPT-4V(ision) (Zhengyuan Yang et al., 2023)
...
### (28/113) IFAST: Weakly Supervised Interpretable Face Anti-spoofing from Single-shot Binocular NIR Images (Jiancheng Huang et al., 2023)
...
### (29/113) See Beyond Seeing: Robust 3D Object Detection from Point Clouds via Cross-Modal Hallucination (Jianning Deng et al., 2023)
...
### (30/113) Telling Stories for Common Sense Zero-Shot Action Recognition (Shreyank N Gowda et al., 2023)
...
### (31/113) Efficient Large Scale Medical Image Dataset Preparation for Machine Learning Applications (Stefan Denner et al., 2023)
...
### (32/113) Information Flow in Self-Supervised Learning (Zhiquan Tan et al., 2023)
...
### (33/113) Effect of structure-based training on 3D localization precision and quality (Armin Abdehkakha et al., 2023)
...
### (34/113) When Epipolar Constraint Meets Non-local Operators in Multi-View Stereo (Tianqi Liu et al., 2023)
...
### (35/113) Instant Complexity Reduction in CNNs using Locality-Sensitive Hashing (Lukas Meiner et al., 2023)
...
### (36/113) Revisiting Cephalometric Landmark Detection from the view of Human Pose Estimation with Lightweight Super-Resolution Head (Qian Wu et al., 2023)
...
### (37/113) Reconstruction of Patient-Specific Confounders in AI-based Radiologic Image Interpretation using Generative Pretraining (Tianyu Han et al., 2023)
...
### (38/113) Continual Action Assessment via Task-Consistent Score-Discriminative Feature Distribution Modeling (Yuan-Ming Li et al., 2023)
...
### (39/113) Guiding Instruction-based Image Editing via Multimodal Large Language Models (Tsu-Jui Fu et al., 2023)
...
### (40/113) SegRCDB: Semantic Segmentation via Formula-Driven Supervised Learning (Risa Shinoda et al., 2023)
...
### (41/113) GAIA-1: A Generative World Model for Autonomous Driving (Anthony Hu et al., 2023)
...
### (42/113) GSDC Transformer: An Efficient and Effective Cue Fusion for Monocular Multi-Frame Depth Estimation (Naiyu Fang et al., 2023)
...
### (43/113) On Uniform Scalar Quantization for Learned Image Compression (Haotian Zhang et al., 2023)
...
### (44/113) HoloAssist: an Egocentric Human Interaction Dataset for Interactive AI Assistants in the Real World (Xin Wang et al., 2023)
...
### (45/113) Segment Anything Model is a Good Teacher for Local Feature Learning (Jingqian Wu et al., 2023)
...
### (46/113) COMNet: Co-Occurrent Matching for Weakly Supervised Semantic Segmentation (Yukun Su et al., 2023)
...
### (47/113) CrossZoom: Simultaneously Motion Deblurring and Event Super-Resolving (Chi Zhang et al., 2023)
...
### (48/113) Robust Asynchronous Collaborative 3D Detection via Bird's Eye View Flow (Sizhe Wei et al., 2023)
...
### (49/113) Learning Decentralized Flocking Controllers with Spatio-Temporal Graph Neural Network (Siji Chen et al., 2023)
...
### (50/113) DREAM: Decentralized Reinforcement Learning for Exploration and Efficient Energy Management in Multi-Robot Systems (Dipam Patel et al., 2023)
...
### (51/113) MORPH: Design Co-optimization with Reinforcement Learning via a Differentiable Hardware Model Proxy (Zhanpeng He et al., 2023)
...
### (52/113) Robots That Can See: Leveraging Human Pose for Trajectory Prediction (Tim Salzmann et al., 2023)
...
### (53/113) CrossLoco: Human Motion Driven Control of Legged Robots via Guided Unsupervised Reinforcement Learning (Tianyu Li et al., 2023)
...
### (54/113) Data Filtering Networks (Alex Fang et al., 2023)
...
### (55/113) Building Privacy-Preserving and Secure Geospatial Artificial Intelligence Foundation Models (Jinmeng Rao et al., 2023)
...
### (56/113) AutoAgents: A Framework for Automatic Agent Generation (Guangyao Chen et al., 2023)
...
### (57/113) Suspicion-Agent: Playing Imperfect Information Games with Theory of Mind Aware GPT4 (Jiaxian Guo et al., 2023)
...
### (58/113) Knowledge Graphs for the Life Sciences: Recent Developments, Challenges and Opportunities (Jiaoyan Chen et al., 2023)
...
### (59/113) RLAdapter: Bridging Large Language Models to Reinforcement Learning in Open Worlds (Wanpeng Zhang et al., 2023)
...
### (60/113) DyVal: Graph-informed Dynamic Evaluation of Large Language Models (Kaijie Zhu et al., 2023)
...
### (61/113) Benchmarking the Abilities of Large Language Models for RDF Knowledge Graph Creation and Comprehension: How Well Do LLMs Speak Turtle? (Johannes Frey et al., 2023)
...
### (62/113) Tell Me a Story! Narrative-Driven XAI with Large Language Models (David Martens et al., 2023)
...
### (63/113) On Generating Explanations for Reinforcement Learning Policies: An Empirical Study (Mikihisa Yuasa et al., 2023)
...
### (64/113) Networked Inequality: Preferential Attachment Bias in Graph Neural Network Link Prediction (Arjun Subramonian et al., 2023)
...
### (65/113) Adversarial Machine Learning in Latent Representations of Neural Networks (Milin Zhang et al., 2023)
...
### (66/113) AV-CPL: Continuous Pseudo-Labeling for Audio-Visual Speech Recognition (Andrew Rouditchenko et al., 2023)
...
### (67/113) Tree Cross Attention (Leo Feng et al., 2023)
...
### (68/113) Module-wise Training of Neural Networks via the Minimizing Movement Scheme (Skander Karkar et al., 2023)
...
### (69/113) Efficient Biologically Plausible Adversarial Training (Matilde Tristany Farinha et al., 2023)
...
### (70/113) MixQuant: Mixed Precision Quantization with a Bit-width Optimization Search (Eliska Kloberdanz et al., 2023)
...
### (71/113) Scaling Experiments in Self-Supervised Cross-Table Representation Learning (Maximilian Schambach et al., 2023)
...
### (72/113) Training and inference of large language models using 8-bit floating point (Sergio P. Perez et al., 2023)
...
### (73/113) Memory Gym: Partially Observable Challenges to Memory-Based Agents in Endless Episodes (Marco Pleines et al., 2023)
...
### (74/113) An Investigation Into Race Bias in Random Forest Models Based on Breast DCE-MRI Derived Radiomics Features (Mohamed Huti et al., 2023)
...
### (75/113) RECOMBINER: Robust and Enhanced Compression with Bayesian Implicit Neural Representations (Jiajun He et al., 2023)
...
### (76/113) Alphazero-like Tree-Search can Guide Large Language Model Decoding and Training (Xidong Feng et al., 2023)
...
### (77/113) Efficient Interpretable Nonlinear Modeling for Multiple Time Series (Kevin Roy et al., 2023)
...
### (78/113) Style Transfer for Non-differentiable Audio Effects (Kieran Grant, 2023)
...
### (79/113) Meta-Path Learning for Multi-relational Graph Neural Networks (Francesco Ferrini et al., 2023)
...
### (80/113) Dynamic Interpretability for Model Comparison via Decision Rules (Adam Rida et al., 2023)
...
### (82/113) Deep Representation Learning for Prediction of Temporal Event Sets in the Continuous Time Domain (Parag Dutta et al., 2023)
...
### (83/113) Understanding and Mitigating the Label Noise in Pre-training on Downstream Tasks (Hao Chen et al., 2023)
...
### (84/113) Consistency Models as a Rich and Efficient Policy Class for Reinforcement Learning (Zihan Ding et al., 2023)
...
### (85/113) Benchmarking and In-depth Performance Study of Large Language Models on Habana Gaudi Processors (Chengming Zhang et al., 2023)
...
### (86/113) Towards Robust Offline-to-Online Reinforcement Learning via Uncertainty and Smoothness (Xiaoyu Wen et al., 2023)
...
### (87/113) Multi-Resolution Active Learning of Fourier Neural Operators (Shibo Li et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2309.16971v1)  
...
### (88/113) Physics-Informed Induction Machine Modelling (Qing Shen et al., 2023)
...
### (89/113) G4SATBench: Benchmarking and Advancing SAT Solving with Graph Neural Networks (Zhaoyu Li et al., 2023)
...
### (90/113) TranDRL: A Transformer-Driven Deep Reinforcement Learning Enabled Prescriptive Maintenance Framework (Yang Zhao et al., 2023)
...
### (91/113) Learning to Receive Help: Intervention-Aware Concept Embedding Models (Mateo Espinosa Zarlenga et al., 2023)
...
### (92/113) ACGAN-GNNExplainer: Auxiliary Conditional Generative Explainer for Graph Neural Networks (Yiqiao Li et al., 2023)
...
### (93/113) Improving Audio Captioning Models with Fine-grained Audio Features, Text Embedding Supervision, and LLM Mix-up Augmentation (Shih-Lun Wu et al., 2023)
...
### (94/113) Multi-Depth Branches Network for Efficient Image Super-Resolution (Huiyuan Tian et al., 2023)
...
### (95/113) Development of a Deep Learning Method to Identify Acute Ischemic Stroke Lesions on Brain CT (Alessandro Fontanella et al., 2023)
...
### (96/113) Glioma subtype classification from histopathological images using in-domain and out-of-domain transfer learning: An experimental study (Vladimir Despotovic et al., 2023)
...
### (97/113) Assessing Look-Ahead Bias in Stock Return Predictions Generated By GPT Sentiment Analysis (Paul Glasserman et al., 2023)
...
### (98/113) Quantum Amplitude Estimation for Probabilistic Methods in Power Systems (Emilie Jong et al., 2023)
...
### (99/113) A Quantum States Preparation Method Based on Difference-Driven Reinforcement Learning (Wenjie Liu et al., 2023)
...
### (100/113) Estimation and Inference in Distributional Reinforcement Learning (Liangyu Zhang et al., 2023)
...
### (101/113) Controlling Continuous Relaxation for Combinatorial Optimization (Yuma Ichikawa, 2023)
...
### (102/113) Meta Reinforcement Learning for Fast Spectrum Sharing in Vehicular Networks (Kai Huang et al., 2023)
...
### (103/113) Double-Layer Power Control for Mobile Cell-Free XL-MIMO with Multi-Agent Reinforcement Learning (Ziheng Liu et al., 2023)
...
### (104/113) Redistributing the Precision and Content in 3D-LUT-based Inverse Tone-mapping for HDR/WCG Display (Cheng Guo et al., 2023)
...
### (105/113) Compromise in Multilateral Negotiations and the Global Regulation of Artificial Intelligence (Michal Natorski, 2023)
...
### (106/113) SAppKG: Mobile App Recommendation Using Knowledge Graph and Side Information-A Secure Framework (Daksh Dave et al., 2023)
...
### (107/113) Diffusion Models as Stochastic Quantization in Lattice Field Theory (Lingxiao Wang et al., 2023)
...
### (108/113) Aligning the Capabilities of Large Language Models with the Context of Information Retrieval via Contrastive Feedback (Qian Dong et al., 2023)
...
### (109/113) MaaSDB: Spatial Databases in the Era of Large Language Models (Vision Paper) (Jianzhong Qi et al., 2023)
...
### (110/113) Low-Resource Self-Supervised Learning with SSL-Enhanced TTS (Po-chun Hsu et al., 2023)
...
### (111/113) Enhancing Code-switching Speech Recognition with Interactive Language Biases (Hexin Liu et al., 2023)
...
### (112/113) Reliability Quantification of Deep Reinforcement Learning-based Control (Hitoshi Yoshioka et al., 2023)
...
### (113/113) Lifting the Fog of Uncertainties: Dynamic Resource Orchestration for the Containerized Cloud (Yuqiu Zhang et al., 2023)
