...
### (1/108) CAPIVARA: Cost-Efficient Approach for Improving Multilingual CLIP Performance on Low-Resource Languages (Gabriel Oliveira dos Santos et al., 2023)

{{<citation>}}

Gabriel Oliveira dos Santos, Diego Alysson Moreia, Alef Iury Ferreira, Jhessica Silva, Luiz Pereira, Pedro Bueno, Thiago Sousa, Helena Maia, Nádia Da Silva, Esther Colombini, Helio Pedrini, Sandra Avila. (2023)  
...
[Paper Link](http://arxiv.org/abs/2310.13683v1)  
...
### (2/108) Automatic Unit Test Data Generation and Actor-Critic Reinforcement Learning for Code Synthesis (Philip John Gorinski et al., 2023)
...
### (3/108) Contrastive Prefence Learning: Learning from Human Feedback without RL (Joey Hejna et al., 2023)
...
### (4/108) ReLM: Leveraging Language Models for Enhanced Chemical Reaction Prediction (Yaorui Shi et al., 2023)
...
### (5/108) Tree Search in DAG Space with Model-based Reinforcement Learning for Causal Discovery (Victor-Alexandru Darvariu et al., 2023)
...
### (6/108) Reward Shaping for Happier Autonomous Cyber Security Agents (Elizabeth Bates et al., 2023)
...
### (7/108) Learning Successor Representations with Distributed Hebbian Temporal Memory (Evgenii Dzhivelikian et al., 2023)
...
### (8/108) SigFormer: Signature Transformers for Deep Hedging (Anh Tong et al., 2023)
...
### (9/108) Dissecting Causal Biases (Rūta Binkytė et al., 2023)
...
### (10/108) DIG-MILP: a Deep Instance Generator for Mixed-Integer Linear Programming with Feasibility Guarantee (Haoyu Wang et al., 2023)
...
### (11/108) FLEE-GNN: A Federated Learning System for Edge-Enhanced Graph Neural Network in Analyzing Geospatial Resilience of Multicommodity Food Flows (Yuxiao Qu et al., 2023)
...
### (12/108) Transparency challenges in policy evaluation with causal machine learning -- improving usability and accountability (Patrick Rehill et al., 2023)
...
### (13/108) Scalable Neural Network Kernels (Arijit Sehanobish et al., 2023)
...
### (14/108) In-context Learning with Transformer Is Really Equivalent to a Contrastive Learning Pattern (Ruifeng Ren et al., 2023)
...
### (15/108) Improving Long-form Speech Translation through Segmentation with Large Language Models and Finite State Decoding Constraints (Arya D. McCarthy et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2310.13678v1)  
...
### (16/108) StereoMap: Quantifying the Awareness of Human-like Stereotypes in Large Language Models (Sullam Jeoung et al., 2023)
...
### (17/108) Let's Synthesize Step by Step: Iterative Dataset Synthesis with Large Language Models by Extrapolating Errors from Small Models (Ruida Wang et al., 2023)
...
### (18/108) Explainability, Interpretability, Depression detection, Social Media (Eliseo Bao Souto et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2310.13664v1)  
...
### (19/108) Benchmarking and Improving Text-to-SQL Generation under Ambiguity (Adithya Bhaskar et al., 2023)
...
### (20/108) BotChat: Evaluating LLMs' Capabilities of Having Multi-Turn Dialogues (Haodong Duan et al., 2023)
...
### (21/108) Bridging Information-Theoretic and Geometric Compression in Language Models (Emily Cheng et al., 2023)
...
### (22/108) Three Questions Concerning the Use of Large Language Models to Facilitate Mathematics Learning (An-Zi Yen et al., 2023)
...
### (23/108) Hunayn: Elevating Translation Beyond the Literal (Nasser Almousa et al., 2023)
...
### (24/108) Make Your Decision Convincing! A Unified Two-Stage Framework: Self-Attribution and Decision-Making (Yanrui Du et al., 2023)
...
### (25/108) MULTITuDE: Large-Scale Multilingual Machine-Generated Text Detection Benchmark (Dominik Macko et al., 2023)
...
### (26/108) MarineGPT: Unlocking Secrets of Ocean to the Public (Ziqiang Zheng et al., 2023)
...
### (27/108) Simultaneous Machine Translation with Tailored Reference (Shoutao Guo et al., 2023)
...
### (28/108) Improving Cross-Lingual Transfer through Subtree-Aware Word Reordering (Ofir Arviv et al., 2023)
...
### (29/108) Why Can Large Language Models Generate Correct Chain-of-Thoughts? (Rasul Tutunov et al., 2023)
...
### (30/108) Retrieval-Augmented Neural Response Generation Using Logical Reasoning and Relevance Scoring (Nicholas Thomas Walker et al., 2023)
...
### (31/108) Cache & Distil: Optimising API Calls to Large Language Models (Guillem Ramírez et al., 2023)
...
### (32/108) Self-prompted Chain-of-Thought on Large Language Models for Open-domain Multi-hop Reasoning (Jinyuan Wang et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2310.13552v1)  
...
### (33/108) The Perils & Promises of Fact-checking with Large Language Models (Dorian Quelle et al., 2023)
...
### (34/108) Towards Understanding Sycophancy in Language Models (Mrinank Sharma et al., 2023)
...
### (35/108) A Diachronic Perspective on User Trust in AI under Uncertainty (Shehzaad Dhuliawala et al., 2023)
...
### (36/108) Controlled Randomness Improves the Performance of Transformer Models (Tobias Deußer et al., 2023)
...
### (37/108) Teaching Language Models to Self-Improve through Interactive Demonstrations (Xiao Yu et al., 2023)
...
### (38/108) Improving Question Generation with Multi-level Content Planning (Zehua Xia et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2310.13512v1)  
...
### (39/108) Explaining Interactions Between Text Spans (Sagnik Ray Choudhury et al., 2023)
...
### (40/108) Robust Training for Conversational Question Answering Models with Reinforced Reformulation Generation (Magdalena Kaiser et al., 2023)
...
### (41/108) DistillCSE: Distilled Contrastive Learning for Sentence Embeddings (Jiahao Xu et al., 2023)
...
### (42/108) Mind the instructions: a holistic evaluation of consistency and interactions in prompt-based learning (Lucas Weber et al., 2023)
...
### (43/108) Ask Language Model to Clean Your Noisy Translation Data (Quinten Bolding et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2310.13469v1)  
...
### (44/108) Steering Large Language Models for Machine Translation with Finetuning and In-Context Learning (Duarte M. Alves et al., 2023)
...
### (45/108) The Past, Present, and Future of Typological Databases in NLP (Emi Baylor et al., 2023)
...
### (46/108) Self-Consistency of Large Language Models under Ambiguity (Henning Bartsch et al., 2023)
...
### (47/108) Towards Enhancing Relational Rules for Knowledge Graph Link Prediction (Shuhan Wu et al., 2023)
...
### (48/108) Explicit Alignment and Many-to-many Entailment Based Reasoning for Conversational Machine Reading (Yangyang Luo et al., 2023)
...
### (49/108) Cache me if you Can: an Online Cost-aware Teacher-Student framework to Reduce the Calls to Large Language Models (Ilias Stogiannidis et al., 2023)
...
### (50/108) POSQA: Probe the World Models of LLMs with Size Comparisons (Chang Shu et al., 2023)
...
### (51/108) Tuna: Instruction Tuning using Feedback from Large Language Models (Haoran Li et al., 2023)
...
### (52/108) Towards General Error Diagnosis via Behavioral Testing in Machine Translation (Junjie Wu et al., 2023)
...
### (53/108) Challenges and Contributing Factors in the Utilization of Large Language Models (LLMs) (Xiaoliang Chen et al., 2023)
...
### (54/108) Large-Scale and Multi-Perspective Opinion Summarization with Diverse Review Subsets (Han Jiang et al., 2023)
...
### (55/108) Democratizing Reasoning Ability: Tailored Learning from Large Language Model (Zhaoyang Wang et al., 2023)
...
### (56/108) Zero-Shot Sharpness-Aware Quantization for Pre-trained Language Models (Miaoxi Zhu et al., 2023)
...
### (57/108) Exploring the Impact of Corpus Diversity on Financial Pretrained Language Models (Jaeyoung Choe et al., 2023)
...
### (58/108) Test-Time Self-Adaptive Small Language Models for Question Answering (Soyeong Jeong et al., 2023)
...
### (59/108) Decoding the Silent Majority: Inducing Belief Augmented Social Graph with Large Language Model for Response Forecasting (Chenkai Sun et al., 2023)
...
### (60/108) Assessing Privacy Risks in Language Models: A Case Study on Summarization Tasks (Ruixiang Tang et al., 2023)
...
### (61/108) MoqaGPT : Zero-Shot Multi-modal Open-domain Question Answering with Large Language Model (Le Zhang et al., 2023)
...
### (62/108) Anomaly Detection of Command Shell Sessions based on DistilBERT: Unsupervised and Supervised Approaches (Zefang Liu et al., 2023)
...
### (63/108) Multi-level Contrastive Learning for Script-based Character Understanding (Dawei Li et al., 2023)
...
### (64/108) The Less the Merrier? Investigating Language Representation in Multilingual Models (Hellina Hailu Nigatu et al., 2023)
...
### (65/108) ToolChain*: Efficient Action Space Navigation in Large Language Models with A* Search (Yuchen Zhuang et al., 2023)
...
### (66/108) Enhancing Zero-Shot Crypto Sentiment with Fine-tuned Language Model and Prompt Engineering (Rahman S M Wahidur et al., 2023)
...
### (67/108) MultiCoNER v2: a Large Multilingual dataset for Fine-grained and Noisy Named Entity Recognition (Besnik Fetahu et al., 2023)
...
### (68/108) Primacy Effect of ChatGPT (Yiwei Wang et al., 2023)
...
### (69/108) Using Human-like Mechanism to Weaken Effect of Pre-training Weight Bias in Face-Recognition Convolutional Neural Network (Haojiang Ying et al., 2023)
...
### (70/108) FMRT: Learning Accurate Feature Matching with Reconciliatory Transformer (Xinyu Zhang et al., 2023)
...
### (71/108) Longer-range Contextualized Masked Autoencoder (Taekyung Kim et al., 2023)
...
### (72/108) POTLoc: Pseudo-Label Oriented Transformer for Point-Supervised Temporal Action Localization (Elahe Vahdani et al., 2023)
...
### (73/108) A Simple Baseline for Knowledge-Based Visual Question Answering (Alexandros Xenos et al., 2023)
...
### (74/108) ROSS: Radar Off-road Semantic Segmentation (Peng Jiang et al., 2023)
...
### (75/108) Technical Report for ICCV 2023 Visual Continual Learning Challenge: Continuous Test-time Adaptation for Semantic Segmentation (Damian Sójka et al., 2023)
...
### (76/108) Application of deep learning for livestock behaviour recognition: A systematic literature review (Ali Rohan et al., 2023)
...
### (77/108) Benchmarking Sequential Visual Input Reasoning and Prediction in Multimodal Large Language Models (Mingwei Zhu et al., 2023)
...
### (78/108) Multiscale Superpixel Structured Difference Graph Convolutional Network for VL Representation (Siyu Zhang et al., 2023)
...
### (79/108) OpenAnnotate3D: Open-Vocabulary Auto-Labeling System for Multi-modal 3D Data (Yijie Zhou et al., 2023)
...
### (80/108) Bridging the Gap between Synthetic and Authentic Images for Multimodal Machine Translation (Wenyu Guo et al., 2023)
...
### (81/108) FLAIR: a Country-Scale Land Cover Semantic Segmentation Dataset From Multi-Source Optical Imagery (Anatol Garioud et al., 2023)
...
### (82/108) Zone Evaluation: Revealing Spatial Bias in Object Detection (Zhaohui Zheng et al., 2023)
...
### (83/108) EXPLORA: AI/ML EXPLainability for the Open RAN (Claudio Fiandrino et al., 2023)
...
### (84/108) Using ChatGPT throughout the Software Development Life Cycle by Novice Developers (Muhammad Waseem et al., 2023)
...
### (85/108) The GitHub Recent Bugs Dataset for Evaluating LLM-based Debugging Applications (Jae Yong Lee et al., 2023)
...
### (86/108) Oversight for Frontier AI through a Know-Your-Customer Scheme for Compute Providers (Janet Egan et al., 2023)
...
### (87/108) Entangled Preferences: The History and Risks of Reinforcement Learning and Human Feedback (Nathan Lambert et al., 2023)
...
### (88/108) Skin Lesion Segmentation Improved by Transformer-based Networks with Inter-scale Dependency Modeling (Sania Eskandari et al., 2023)
...
### (89/108) SPARE: A Single-Pass Neural Model for Relational Databases (Benjamin Hilprecht et al., 2023)
...
### (90/108) Cooperative Multi-Agent Deep Reinforcement Learning for Adaptive Decentralized Emergency Voltage Control (Ying Zhang et al., 2023)
...
### (91/108) Deep Reinforcement Learning-Enabled Adaptive Forecasting-Aided State Estimation in Distribution Systems with Multi-Source Multi-Rate Data (Ying Zhang et al., 2023)
...
### (92/108) Thoroughly Modeling Multi-domain Pre-trained Recommendation as Language (Zekai Qu et al., 2023)
...
### (93/108) Towards Multi-Subsession Conversational Recommendation (Yu Ji et al., 2023)
...
### (94/108) Knowledge Graph Context-Enhanced Diversified Recommendation (Xiaolong Liu et al., 2023)
...
### (95/108) TempGNN: Temporal Graph Neural Networks for Dynamic Session-Based Recommendations (Eunkyu Oh et al., 2023)
...
### (96/108) Open-source Large Language Models are Strong Zero-shot Query Likelihood Models for Document Ranking (Shengyao Zhuang et al., 2023)
...
### (97/108) Two-Stage Triplet Loss Training with Curriculum Augmentation for Audio-Visual Retrieval (Donghuo Zeng et al., 2023)
...
### (98/108) Music Augmentation and Denoising For Peak-Based Audio Fingerprinting (Kamil Akesbi et al., 2023)
...
### (99/108) SALMONN: Towards Generic Hearing Abilities for Large Language Models (Changli Tang et al., 2023)
...
### (100/108) RL-X: A Deep Reinforcement Learning Library (not only) for RoboCup (Nico Bohlinger et al., 2023)
...
### (101/108) PathRL: An End-to-End Path Generation Method for Collision Avoidance via Deep Reinforcement Learning (Wenhao Yu et al., 2023)
...
### (102/108) Dynamic Object Detection in Range data using Spatiotemporal Normals (Raphael Falque et al., 2023)
...
### (103/108) An LLM can Fool Itself: A Prompt-Based Adversarial Attack (Xilie Xu et al., 2023)
...
### (104/108) Auxiliary Features-Guided Super Resolution for Monte Carlo Rendering (Qiqi Hou et al., 2023)
...
### (105/108) Equivariant Transformer is all you need (Akio Tomiya et al., 2023)
...
### (106/108) HierCas: Hierarchical Temporal Graph Attention Networks for Popularity Prediction in Information Cascades (Zhizhen Zhang et al., 2023)
...
### (107/108) Facile: Fast, Accurate, and Interpretable Basic-Block Throughput Prediction (Andreas Abel et al., 2023)
...
### (108/108) Foundational Techniques for Wireless Communications: Channel Coding, Modulation, and Equalization (Solomon McKiernan, 2023)
