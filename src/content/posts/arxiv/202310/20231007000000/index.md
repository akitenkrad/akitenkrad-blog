...
### (1/87) Improved Baselines with Visual Instruction Tuning (Haotian Liu et al., 2023)
...
### (2/87) LumiNet: The Bright Side of Perceptual Knowledge Distillation (Md. Ismail Hossain et al., 2023)
...
### (3/87) Robustness-Guided Image Synthesis for Data-Free Quantization (Jianhong Bai et al., 2023)
...
### (4/87) Visual inspection for illicit items in X-ray images using Deep Learning (Ioannis Mademlis et al., 2023)
...
### (5/87) Towards Unified Deep Image Deraining: A Survey and A New Benchmark (Xiang Chen et al., 2023)
...
### (6/87) PrototypeFormer: Learning to Explore Prototype Relationships for Few-shot Image Classification (Feihong He et al., 2023)
...
### (7/87) A Complementary Global and Local Knowledge Network for Ultrasound denoising with Fine-grained Refinement (Zhenyu Bu et al., 2023)
...
### (8/87) Robust Representation Learning via Asymmetric Negative Contrast and Reverse Attention (Nuoyan Zhou et al., 2023)
...
### (9/87) Denoising Diffusion Step-aware Models (Shuai Yang et al., 2023)
...
### (10/87) Real-time Multi-modal Object Detection and Tracking on Edge for Regulatory Compliance Monitoring (Jia Syuen Lim et al., 2023)
...
### (11/87) Investigating the Limitation of CLIP Models: The Worst-Performing Categories (Jie-Jing Shao et al., 2023)
...
### (12/87) PoseAction: Action Recognition for Patients in the Ward using Deep Learning Approaches (Zherui Li et al., 2023)
...
### (13/87) Ablation Study to Clarify the Mechanism of Object Segmentation in Multi-Object Representation Learning (Takayuki Komatsu et al., 2023)
...
### (14/87) EfficientDM: Efficient Quantization-Aware Fine-Tuning of Low-Bit Diffusion Models (Yefei He et al., 2023)
...
### (15/87) MathCoder: Seamless Code Integration in LLMs for Enhanced Mathematical Reasoning (Ke Wang et al., 2023)
...
### (16/87) Modular Speech-to-Text Translation for Zero-Shot Cross-Modal Transfer (Paul-Ambroise Duquenne et al., 2023)
...
### (17/87) A Long Way to Go: Investigating Length Correlations in RLHF (Prasann Singhal et al., 2023)
...
### (18/87) DSPy: Compiling Declarative Language Model Calls into Self-Improving Pipelines (Omar Khattab et al., 2023)
...
### (19/87) Agent Instructs Large Language Models to be General Zero-Shot Reasoners (Nicholas Crispino et al., 2023)
...
### (20/87) Fine-tuning Aligned Language Models Compromises Safety, Even When Users Do Not Intend To! (Xiangyu Qi et al., 2023)
...
### (21/87) DecoderLens: Layerwise Interpretation of Encoder-Decoder Transformers (Anna Langedijk et al., 2023)
...
### (22/87) GoLLIE: Annotation Guidelines improve Zero-Shot Information-Extraction (Oscar Sainz et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2310.03668v1)  
...
### (23/87) MapperGPT: Large Language Models for Linking and Mapping Entities (Nicolas Matentzoglu et al., 2023)
...
### (24/87) Evaluating Self-Supervised Speech Representations for Indigenous American Languages (Chih-Chen Chen et al., 2023)
...
### (25/87) Redefining Digital Health Interfaces with Large Language Models (Fergus Imrie et al., 2023)
...
### (26/87) Tik-to-Tok: Translating Language Models One Token at a Time: An Embedding Initialization Strategy for Efficient Language Adaptation (François Remy et al., 2023)
...
### (27/87) Controllable Multi-document Summarization: Coverage & Coherence Intuitive Policy with Large Language Model Based Rewards (Litton J Kurisinkel et al., 2023)
...
### (28/87) The North System for Formosa Speech Recognition Challenge 2023 (Li-Wei Chen et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2310.03443v1)  
...
### (29/87) LLM Based Multi-Document Summarization Exploiting Main-Event Biased Monotone Submodular Content Extraction (Litton J Kurisinkel et al., 2023)
...
### (30/87) Procedural Text Mining with Large Language Models (Anisa Rula et al., 2023)
...
### (31/87) Evaluating Hallucinations in Chinese Large Language Models (Qinyuan Cheng et al., 2023)
...
### (32/87) Reformulating Domain Adaptation of Large Language Models as Adapt-Retrieve-Revise (Zhen wan et al., 2023)
...
### (33/87) Concise and Organized Perception Facilitates Large Language Models for Deductive Reasoning (Shaotian Yan et al., 2023)
...
### (34/87) Learning Personalized Story Evaluation (Danqing Wang et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2310.03304v1)  
...
### (35/87) A New Dialogue Response Generation Agent for Large Language Models by Asking Questions to Detect User's Intentions (Siwei Wu et al., 2023)
...
### (36/87) A Formalism and Approach for Improving Robustness of Large Language Models Using Risk-Adjusted Confidence Scores (Ke Shen et al., 2023)
...
### (37/87) Can Large Language Models be Good Path Planners? A Benchmark and Investigation on Spatial-temporal Reasoning (Mohamed Aghzal et al., 2023)
...
### (38/87) FreshLLMs: Refreshing Large Language Models with Search Engine Augmentation (Tu Vu et al., 2023)
...
### (39/87) Constraint-Conditioned Policy Optimization for Versatile Safe Reinforcement Learning (Yihang Yao et al., 2023)
...
### (40/87) OMG-ATTACK: Self-Supervised On-Manifold Generation of Transferable Evasion Attacks (Ofir Bar Tal et al., 2023)
...
### (41/87) SmoothLLM: Defending Large Language Models Against Jailbreaking Attacks (Alexander Robey et al., 2023)
...
### (42/87) Rethinking Fairness for Human-AI Collaboration (Haosen Ge et al., 2023)
...
### (43/87) Adversarial Machine Learning for Social Good: Reframing the Adversary as an Ally (Shawqi Al-Maliki et al., 2023)
...
### (44/87) GENER: A Parallel Layer Deep Learning Network To Detect Gene-Gene Interactions From Gene Expression Data (Ahmed Fakhry Elnaggar et al., 2023)

{{<citation>}}

Ahmed Fakhry Elnaggar, Raneem Ali Khafagy, Adriaan-Alexander Ludl. (2023)  
...
Keywords: NER  
[Paper Link](http://arxiv.org/abs/2310.03611v1)  
...
### (45/87) Comparing Time-Series Analysis Approaches Utilized in Research Papers to Forecast COVID-19 Cases in Africa: A Literature Review (Ali Ebadi et al., 2023)
...
### (46/87) TimeGPT-1 (Azul Garza et al., 2023)
...
### (47/87) Targeted Adversarial Attacks on Generalizable Neural Radiance Fields (Andras Horvath et al., 2023)
...
### (48/87) Neural Language Model Pruning for Automatic Speech Recognition (Leonardo Emili et al., 2023)
...
### (49/87) Adapting Large Language Models for Content Moderation: Pitfalls in Data Engineering and Supervised Fine-tuning (Huan Ma et al., 2023)
...
### (50/87) GRAPES: Learning to Sample Graphs for Scalable Graph Neural Networks (Taraneh Younesian et al., 2023)
...
### (51/87) LESSON: Learning to Integrate Exploration Strategies for Reinforcement Learning via an Option Framework (Woojun Kim et al., 2023)
...
### (52/87) Probabilistic Forecasting of Day-Ahead Electricity Prices and their Volatility with LSTMs (Julius Trebbien et al., 2023)
...
### (53/87) Untargeted White-box Adversarial Attack with Heuristic Defence Methods in Real-time Deep Learning based Network Intrusion Detection System (Khushnaseeb Roshan et al., 2023)
...
### (54/87) Fine-tune Language Models to Approximate Unbiased In-context Learning (Timothy Chu et al., 2023)
...
### (55/87) BioBridge: Bridging Biomedical Foundation Models via Knowledge Graph (Zifeng Wang et al., 2023)
...
### (56/87) Benchmarking Large Language Models As AI Research Agents (Qian Huang et al., 2023)
...
### (57/87) LightSeq: Sequence Level Parallelism for Distributed Training of Long Context Transformers (Dacheng Li et al., 2023)
...
### (58/87) A 5' UTR Language Model for Decoding Untranslated Regions of mRNA and Function Predictions (Yanyi Chu et al., 2023)
...
Categories: cs-AI, cs-LG, cs.LG  
Keywords: Language Model  
[Paper Link](http://arxiv.org/abs/2310.03281v1)  
...
### (59/87) Fragment-based Pretraining and Finetuning on Molecular Graphs (Kha-Dinh Luong et al., 2023)
...
### (60/87) UniPredict: Large Language Models are Universal Tabular Predictors (Ruiyu Wang et al., 2023)
...
### (61/87) Molecule Design by Latent Prompt Transformer (Deqian Kong et al., 2023)
...
### (62/87) History Matching for Geological Carbon Storage using Data-Space Inversion with Spatio-Temporal Data Parameterization (Su Jiang et al., 2023)
...
### (63/87) Safe Exploration in Reinforcement Learning: A Generalized Formulation and Algorithms (Akifumi Wachi et al., 2023)
...
### (64/87) Know2BIO: A Comprehensive Dual-View Benchmark for Evolving Biomedical Knowledge Graphs (Yijia Xiao et al., 2023)
...
### (65/87) Artificial Intelligence Index Report 2023 (Nestor Maslej et al., 2023)
...
### (66/87) Balancing Autonomy and Alignment: A Multi-Dimensional Taxonomy for Autonomous LLM-powered Multi-Agent Architectures (Thorsten Händler, 2023)
...
### (67/87) Learning Concept-Based Visual Causal Transition and Symbolic Reasoning for Visual Planning (Yilue Qian et al., 2023)
...
### (68/87) DirectGPT: A Direct Manipulation Interface to Interact with Large Language Models (Damien Masson et al., 2023)
...
### (69/87) Unpacking Human-AI Interaction in Safety-Critical Industries: A Systematic Literature Review (Tita A. Bach et al., 2023)
...
### (70/87) Enhancing Exfiltration Path Analysis Using Reinforcement Learning (Riddam Rishu et al., 2023)
...
### (71/87) Putting a Padlock on Lambda -- Integrating vTPMs into AWS Firecracker (Melker Veltman et al., 2023)
...
### (72/87) FLAIM: AIM-based Synthetic Data Generation in the Federated Setting (Samuel Maddock et al., 2023)
...
### (73/87) Certifiably Robust Graph Contrastive Learning (Minhua Lin et al., 2023)
...
### (74/87) PeaTMOSS: Mining Pre-Trained Models in Open-Source Software (Wenxin Jiang et al., 2023)
...
### (75/87) Large Language Models for Software Engineering: Survey and Open Problems (Angela Fan et al., 2023)
...
### (76/87) Interpreting the Value of Flexibility in AC Security-Constrained Transmission Expansion Planning via a Cooperative Game Framework (Andrey Churkin et al., 2023)
...
### (77/87) Impact of Artificial Intelligence on Electrical and Electronics Engineering Productivity in the Construction Industry (Nwosu Obinnaya Chikezie Victor, 2023)
...
### (78/87) TPDR: A Novel Two-Step Transformer-based Product and Class Description Match and Retrieval Method (Washington Cunha et al., 2023)
...
### (79/87) Personalized Transformer-based Ranking for e-Commerce at Yandex (Kirill Khrylchenko et al., 2023)
...
### (80/87) BTDNet: a Multi-Modal Approach for Brain Tumor Radiogenomic Classification (Dimitrios Kollias et al., 2023)
...
### (81/87) Swin-Tempo: Temporal-Aware Lung Nodule Detection in CT Scans as Video Sequences Using Swin Transformer-Enhanced UNet (Hossein Jafari et al., 2023)
...
### (82/87) User Attitudes to Content Moderation in Web Search (Aleksandra Urman et al., 2023)
...
### (83/87) Progressive Adaptive Chance-Constrained Safeguards for Reinforcement Learning (Zhaorun Chen et al., 2023)
...
### (84/87) A Two-stage Based Social Preference Recognition in Multi-Agent Autonomous Driving System (Jintao Xue et al., 2023)
...
### (85/87) InstructProtein: Aligning Human and Protein Language via Knowledge Instruction (Zeyuan Wang et al., 2023)
...
### (86/87) Sparse Deep Learning for Time Series Data: Theory and Applications (Mingxuan Zhang et al., 2023)
...
### (87/87) Non-Smooth Weakly-Convex Finite-sum Coupled Compositional Optimization (Quanqi Hu et al., 2023)
