...
### (1/41 | 1/314) Evaluating Large Language Models for Health-Related Text Classification Tasks with Public Social Media Data (Yuting Guo et al., 2024)
...
### (2/41 | 2/314) Reshaping Free-Text Radiology Notes Into Structured Reports With Generative Transformers (Laura Bergomi et al., 2024)
...
### (3/41 | 3/314) Long-form factuality in large language models (Jerry Wei et al., 2024)
...
### (4/41 | 4/314) Is Modularity Transferable? A Case Study through the Lens of Knowledge Distillation (Mateusz Klimaszewski et al., 2024)
...
### (5/41 | 5/314) BLADE: Enhancing Black-box Large Language Models with Small Domain-Specific Models (Haitao Li et al., 2024)
...
### (6/41 | 6/314) Quantifying and Mitigating Unimodal Biases in Multimodal Large Language Models: A Causal Perspective (Meiqi Chen et al., 2024)
...
### (7/41 | 7/314) CAUSE: Counterfactual Assessment of User Satisfaction Estimation in Task-Oriented Dialogue Systems (Amin Abolghasemi et al., 2024)
...
### (8/41 | 8/314) Dual Instruction Tuning with Large Language Models for Mathematical Reasoning (Yongwei Zhou et al., 2024)
...
### (9/41 | 9/314) MD-PK: Metaphor Detection via Prompt Learning and Knowledge Distillation (Kaidi Jia et al., 2024)
...
### (10/41 | 10/314) Exploring the Deceptive Power of LLM-Generated Fake News: A Study of Real-World Detection Challenges (Yanshen Sun et al., 2024)
...
### (11/41 | 11/314) Can Language Beat Numerical Regression? Language-Based Multimodal Trajectory Prediction (Inhwan Bae et al., 2024)
...
### (12/41 | 12/314) Projective Methods for Mitigating Gender Bias in Pre-trained Language Models (Hillary Dawkins et al., 2024)
...
### (13/41 | 13/314) A Survey on Large Language Models from Concept to Implementation (Chen Wang et al., 2024)
...
### (14/41 | 14/314) AcTED: Automatic Acquisition of Typical Event Duration for Semi-supervised Temporal Commonsense QA (Felix Virgo et al., 2024)
...
### (15/41 | 15/314) SemRoDe: Macro Adversarial Training to Learn Representations That are Robust to Word-Level Attacks (Brian Formento et al., 2024)
...
### (16/41 | 16/314) BioMedLM: A 2.7B Parameter Language Model Trained On Biomedical Text (Elliot Bolton et al., 2024)
...
### (17/41 | 17/314) ZAEBUC-Spoken: A Multilingual Multidialectal Arabic-English Speech Corpus (Injy Hamed et al., 2024)
...
### (18/41 | 18/314) IterAlign: Iterative Constitutional Alignment of Large Language Models (Xiusi Chen et al., 2024)
...
### (19/41 | 19/314) 'Sorry, Come Again?' Prompting -- Enhancing Comprehension and Diminishing Hallucination with [PAUSE]-injected Optimal Paraphrasing (Vipula Rawte et al., 2024)
...
### (20/41 | 20/314) Fact Checking Beyond Training Set (Payam Karisani et al., 2024)
...
### (21/41 | 21/314) NL-ITI: Optimizing Probing and Intervention for Improvement of ITI Method (Jakub Hoscilowicz et al., 2024)
...
### (22/41 | 22/314) Evaluation of Semantic Search and its Role in Retrieved-Augmented-Generation (RAG) for Arabic Language (Ali Mahboub et al., 2024)
...
### (23/41 | 23/314) A Novel Corpus of Annotated Medical Imaging Reports and Information Extraction Results Using BERT-based Language Models (Namu Park et al., 2024)
...
### (24/41 | 24/314) SDSAT: Accelerating LLM Inference through Speculative Decoding with Semantic Adaptive Tokens (Chengbo Liu et al., 2024)
...
### (25/41 | 25/314) Attention-aware semantic relevance predicting Chinese sentence reading (Kun Sun, 2024)
...
### (26/41 | 26/314) TriviaHG: A Dataset for Automatic Hint Generation from Factoid Questions (Jamshid Mozafari et al., 2024)
...
### (27/41 | 27/314) Improving Attributed Text Generation of Large Language Models via Preference Learning (Dongfang Li et al., 2024)
...
### (28/41 | 28/314) Rejection Improves Reliability: Training LLMs to Refuse Unknown Questions Using RL from Knowledge Feedback (Hongshen Xu et al., 2024)
...
### (29/41 | 29/314) ReflectSumm: A Benchmark for Course Reflection Summarization (Yang Zhong et al., 2024)
...
### (30/41 | 30/314) Measuring Political Bias in Large Language Models: What Is Said and How It Is Said (Yejin Bang et al., 2024)
...
### (31/41 | 31/314) CheckEval: Robust Evaluation Framework using Large Language Model via Checklist (Yukyung Lee et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="CheckEval: Robust Evaluation Framework using Large Language Model via Checklist" index=31>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (32/41 | 32/314) The Invalsi Benchmark: measuring Language Models Mathematical and Language understanding in Italian (Andrea Esuli et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="The Invalsi Benchmark: measuring Language Models Mathematical and Language understanding in Italian" index=32>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (33/41 | 33/314) Conformal Intent Classification and Clarification for Fast and Accurate Intent Recognition (Floris den Hengst et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Conformal Intent Classification and Clarification for Fast and Accurate Intent Recognition" index=33>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (34/41 | 34/314) SemEval Task 1: Semantic Textual Relatedness for African and Asian Languages (Nedjma Ousidhoum et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="SemEval Task 1: Semantic Textual Relatedness for African and Asian Languages" index=34>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (35/41 | 35/314) Improved Neural Protoform Reconstruction via Reflex Prediction (Liang Lu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Improved Neural Protoform Reconstruction via Reflex Prediction" index=35>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (36/41 | 36/314) Debiasing Sentence Embedders through Contrastive Word Pairs (Philip Kenneweg et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Debiasing Sentence Embedders through Contrastive Word Pairs" index=36>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (37/41 | 37/314) Can LLMs Converse Formally? Automatically Assessing LLMs in Translating and Interpreting Formal Specifications (Rushang Karia et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Can LLMs Converse Formally? Automatically Assessing LLMs in Translating and Interpreting Formal Specifications" index=37>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (38/41 | 38/314) Few-Shot Recalibration of Language Models (Xiang Lisa Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Few-Shot Recalibration of Language Models" index=38>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (39/41 | 39/314) BlendX: Complex Multi-Intent Detection with Blended Patterns (Yejin Yoon et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="BlendX: Complex Multi-Intent Detection with Blended Patterns" index=39>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (40/41 | 40/314) Chinese Offensive Language Detection:Current Status and Future Directions (Yunze Xiao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Chinese Offensive Language Detection:Current Status and Future Directions" index=40>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (41/41 | 41/314) Since the Scientific Literature Is Multilingual, Our Models Should Be Too (Abteen Ebrahimi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Since the Scientific Literature Is Multilingual, Our Models Should Be Too" index=41>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/18 | 42/314) To Recommend or Not: Recommendability Identification in Conversations with Pre-trained Language Models (Zhefan Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="To Recommend or Not: Recommendability Identification in Conversations with Pre-trained Language Models" index=42>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/18 | 43/314) Towards LLM-RecSys Alignment with Textual ID Learning (Juntao Tan et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Towards LLM-RecSys Alignment with Textual ID Learning" index=43>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/18 | 44/314) Sequential Recommendation with Latent Relations based on Large Language Model (Shenghao Yang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Sequential Recommendation with Latent Relations based on Large Language Model" index=44>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/18 | 45/314) Lightweight Embeddings for Graph Collaborative Filtering (Xurong Liang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Lightweight Embeddings for Graph Collaborative Filtering" index=45>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/18 | 46/314) Scaling Laws For Dense Retrieval (Yan Fang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Scaling Laws For Dense Retrieval" index=46>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (6/18 | 47/314) Common Sense Enhanced Knowledge-based Recommendation with Large Language Model (Shenghao Yang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Common Sense Enhanced Knowledge-based Recommendation with Large Language Model" index=47>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (7/18 | 48/314) A Novel Behavior-Based Recommendation System for E-commerce (Reza Barzegar Nozari et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Novel Behavior-Based Recommendation System for E-commerce" index=48>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (8/18 | 49/314) RankMamba, Benchmarking Mamba's Document Ranking Performance in the Era of Transformers (Zhichao Xu, 2024)
...
<br/>
<button class="copy-to-clipboard" title="RankMamba, Benchmarking Mamba's Document Ranking Performance in the Era of Transformers" index=49>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (9/18 | 50/314) Modeling Sustainable City Trips: Integrating CO2 Emissions, Popularity, and Seasonality into Tourism Recommender Systems (Ashmi Banerjee et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Modeling Sustainable City Trips: Integrating CO2 Emissions, Popularity, and Seasonality into Tourism Recommender Systems" index=50>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (10/18 | 51/314) Improving Content Recommendation: Knowledge Graph-Based Semantic Contrastive Learning for Diversity and Cold-Start Users (Yejin Kim et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Improving Content Recommendation: Knowledge Graph-Based Semantic Contrastive Learning for Diversity and Cold-Start Users" index=51>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (11/18 | 52/314) Enhanced Generative Recommendation via Content and Collaboration Integration (Yidan Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Enhanced Generative Recommendation via Content and Collaboration Integration" index=52>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (12/18 | 53/314) DELTA: Pre-train a Discriminative Encoder for Legal Case Retrieval via Structural Word Alignment (Haitao Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="DELTA: Pre-train a Discriminative Encoder for Legal Case Retrieval via Structural Word Alignment" index=53>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (13/18 | 54/314) A Recommender System for NFT Collectibles with Item Feature (Minjoo Choi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Recommender System for NFT Collectibles with Item Feature" index=54>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (14/18 | 55/314) High Recall, Small Data: The Challenges of Within-System Evaluation in a Live Legal Search System (Gineke Wiggers et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="High Recall, Small Data: The Challenges of Within-System Evaluation in a Live Legal Search System" index=55>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (15/18 | 56/314) A Situation-aware Enhancer for Personalized Recommendation (Jiayu Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Situation-aware Enhancer for Personalized Recommendation" index=56>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (16/18 | 57/314) Decoy Effect In Search Interaction: Understanding User Behavior and Measuring System Vulnerability (Nuo Chen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Decoy Effect In Search Interaction: Understanding User Behavior and Measuring System Vulnerability" index=57>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (17/18 | 58/314) Improving Out-of-Vocabulary Handling in Recommendation Systems (William Shiao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Improving Out-of-Vocabulary Handling in Recommendation Systems" index=58>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (18/18 | 59/314) One Backpropagation in Two Tower Recommendation Models (Erjia Chen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="One Backpropagation in Two Tower Recommendation Models" index=59>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/20 | 60/314) PhysicsAssistant: An LLM-Powered Interactive Learning Robot for Physics Lab Investigations (Ehsan Latif et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="PhysicsAssistant: An LLM-Powered Interactive Learning Robot for Physics Lab Investigations" index=60>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/20 | 61/314) 3P-LLM: Probabilistic Path Planning using Large Language Model for Autonomous Robot Navigation (Ehsan Latif, 2024)
...
<br/>
<button class="copy-to-clipboard" title="3P-LLM: Probabilistic Path Planning using Large Language Model for Autonomous Robot Navigation" index=61>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/20 | 62/314) Multi-AGV Path Planning Method via Reinforcement Learning and Particle Filters (Shao Shuo, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Multi-AGV Path Planning Method via Reinforcement Learning and Particle Filters" index=62>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/20 | 63/314) Vision-Based Force Estimation for Minimally Invasive Telesurgery Through Contact Detection and Local Stiffness Models (Shuyuan Yang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Vision-Based Force Estimation for Minimally Invasive Telesurgery Through Contact Detection and Local Stiffness Models" index=63>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/20 | 64/314) Gaussian Process-based Traversability Analysis for Terrain Mapless Navigation (Abe Leininger et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Gaussian Process-based Traversability Analysis for Terrain Mapless Navigation" index=64>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (6/20 | 65/314) MLDT: Multi-Level Decomposition for Complex Long-Horizon Robotic Task Planning with Open-Source Large Language Model (Yike Wu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="MLDT: Multi-Level Decomposition for Complex Long-Horizon Robotic Task Planning with Open-Source Large Language Model" index=65>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (7/20 | 66/314) Inverse kinematics learning of a continuum manipulator using limited real time data (Alok Ranjan Sahoo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Inverse kinematics learning of a continuum manipulator using limited real time data" index=66>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (8/20 | 67/314) LORD: Large Models based Opposite Reward Design for Autonomous Driving (Xin Ye et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="LORD: Large Models based Opposite Reward Design for Autonomous Driving" index=67>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (9/20 | 68/314) CoBOS: Constraint-Based Online Scheduler for Human-Robot Collaboration (Marina Ionova et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="CoBOS: Constraint-Based Online Scheduler for Human-Robot Collaboration" index=68>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (10/20 | 69/314) HyRRT-Connect: A Bidirectional Rapidly-Exploring Random Trees Motion Planning Algorithm for Hybrid Systems (Nan Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="HyRRT-Connect: A Bidirectional Rapidly-Exploring Random Trees Motion Planning Algorithm for Hybrid Systems" index=69>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (11/20 | 70/314) Uncertainty-Aware Deployment of Pre-trained Language-Conditioned Imitation Learning Policies (Bo Wu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Uncertainty-Aware Deployment of Pre-trained Language-Conditioned Imitation Learning Policies" index=70>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (12/20 | 71/314) Online Embedding Multi-Scale CLIP Features into 3D Maps (Shun Taguchi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Online Embedding Multi-Scale CLIP Features into 3D Maps" index=71>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (13/20 | 72/314) Towards Human-Centered Construction Robotics: An RL-Driven Companion Robot For Contextually Assisting Carpentry Workers (Yuning Wu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Towards Human-Centered Construction Robotics: An RL-Driven Companion Robot For Contextually Assisting Carpentry Workers" index=72>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.19060v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.19060v1.pdf" filename="2403.19060v1.pdf">Download PDF</button>
...
### (14/20 | 73/314) CaT: Constraints as Terminations for Legged Locomotion Reinforcement Learning (Elliot Chane-Sane et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="CaT: Constraints as Terminations for Legged Locomotion Reinforcement Learning" index=73>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (15/20 | 74/314) Bridging the Gap: Regularized Reinforcement Learning for Improved Classical Motion Planning with Safety Modules (Elias Goldsztejn et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Bridging the Gap: Regularized Reinforcement Learning for Improved Classical Motion Planning with Safety Modules" index=74>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (16/20 | 75/314) Imaging radar and LiDAR image translation for 3-DOF extrinsic calibration (Sangwoo Jung et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Imaging radar and LiDAR image translation for 3-DOF extrinsic calibration" index=75>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (17/20 | 76/314) RoboKeyGen: Robot Pose and Joint Angles Estimation via Diffusion-based 3D Keypoint Generation (Yang Tian et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="RoboKeyGen: Robot Pose and Joint Angles Estimation via Diffusion-based 3D Keypoint Generation" index=76>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (18/20 | 77/314) Preference-Based Planning in Stochastic Environments: From Partially-Ordered Temporal Goals to Most Preferred Policies (Hazhar Rahmani et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Preference-Based Planning in Stochastic Environments: From Partially-Ordered Temporal Goals to Most Preferred Policies" index=77>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (19/20 | 78/314) Sampling-Based Motion Planning with Online Racing Line Generation for Autonomous Driving on Three-Dimensional Race Tracks (Levent Ögretmen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Sampling-Based Motion Planning with Online Racing Line Generation for Autonomous Driving on Three-Dimensional Race Tracks" index=78>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (20/20 | 79/314) Manipulating Neural Path Planners via Slight Perturbations (Zikang Xiong et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Manipulating Neural Path Planners via Slight Perturbations" index=79>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/3 | 80/314) LLMs in HCI Data Work: Bridging the Gap Between Information Retrieval and Responsible Research Practices (Neda Taghizadeh Serajeh et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="LLMs in HCI Data Work: Bridging the Gap Between Information Retrieval and Responsible Research Practices" index=80>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/3 | 81/314) iFace: Hand-Over-Face Gesture Recognition Leveraging Impedance Sensing (Mengxi Liu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="iFace: Hand-Over-Face Gesture Recognition Leveraging Impedance Sensing" index=81>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/3 | 82/314) Will You Participate? Exploring the Potential of Robotics Competitions on Human-centric Topics (Yuchong Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Will You Participate? Exploring the Potential of Robotics Competitions on Human-centric Topics" index=82>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/82 | 83/314) Mini-Gemini: Mining the Potential of Multi-modality Vision Language Models (Yanwei Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Mini-Gemini: Mining the Potential of Multi-modality Vision Language Models" index=83>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/82 | 84/314) An Image Grid Can Be Worth a Video: Zero-shot Video Question Answering Using a VLM (Wonkyun Kim et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="An Image Grid Can Be Worth a Video: Zero-shot Video Question Answering Using a VLM" index=84>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/82 | 85/314) Illicit object detection in X-ray images using Vision Transformers (Jorgen Cani et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Illicit object detection in X-ray images using Vision Transformers" index=85>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/82 | 86/314) Dense Vision Transformer Compression with Few Samples (Hanxiao Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Dense Vision Transformer Compression with Few Samples" index=86>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/82 | 87/314) Learning CNN on ViT: A Hybrid Model to Explicitly Class-specific Boundaries for Domain Adaptation (Ba Hung Ngo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Learning CNN on ViT: A Hybrid Model to Explicitly Class-specific Boundaries for Domain Adaptation" index=87>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (6/82 | 88/314) TextCraftor: Your Text Encoder Can be Image Quality Controller (Yanyu Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="TextCraftor: Your Text Encoder Can be Image Quality Controller" index=88>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (7/82 | 89/314) Beyond Embeddings: The Promise of Visual Table in Multi-Modal Models (Yiwu Zhong et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Beyond Embeddings: The Promise of Visual Table in Multi-Modal Models" index=89>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (8/82 | 90/314) ViTAR: Vision Transformer with Any Resolution (Qihang Fan et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="ViTAR: Vision Transformer with Any Resolution" index=90>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (9/82 | 91/314) LITA: Language Instructed Temporal-Localization Assistant (De-An Huang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="LITA: Language Instructed Temporal-Localization Assistant" index=91>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (10/82 | 92/314) VersaT2I: Improving Text-to-Image Models with Versatile Reward (Jianshu Guo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="VersaT2I: Improving Text-to-Image Models with Versatile Reward" index=92>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (11/82 | 93/314) OrCo: Towards Better Generalization via Orthogonality and Contrast for Few-Shot Class-Incremental Learning (Noor Ahmed et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="OrCo: Towards Better Generalization via Orthogonality and Contrast for Few-Shot Class-Incremental Learning" index=93>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (12/82 | 94/314) Direct mineral content prediction from drill core images via transfer learning (Romana Boiger et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Direct mineral content prediction from drill core images via transfer learning" index=94>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (13/82 | 95/314) Scaling Vision-and-Language Navigation With Offline RL (Valay Bundele et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Scaling Vision-and-Language Navigation With Offline RL" index=95>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (14/82 | 96/314) PLOT-TAL -- Prompt Learning with Optimal Transport for Few-Shot Temporal Action Localization (Edward Fish et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="PLOT-TAL -- Prompt Learning with Optimal Transport for Few-Shot Temporal Action Localization" index=96>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (15/82 | 97/314) ObjectDrop: Bootstrapping Counterfactuals for Photorealistic Object Removal and Insertion (Daniel Winter et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="ObjectDrop: Bootstrapping Counterfactuals for Photorealistic Object Removal and Insertion" index=97>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (16/82 | 98/314) Deep Learning for Robust and Explainable Models in Computer Vision (Mohammadreza Amirian, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Deep Learning for Robust and Explainable Models in Computer Vision" index=98>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (17/82 | 99/314) Artifact Reduction in 3D and 4D Cone-beam Computed Tomography Images with Deep Learning -- A Review (Mohammadreza Amirian et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Artifact Reduction in 3D and 4D Cone-beam Computed Tomography Images with Deep Learning -- A Review" index=99>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (18/82 | 100/314) CosalPure: Learning Concept from Group Images for Robust Co-Saliency Detection (Jiayi Zhu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="CosalPure: Learning Concept from Group Images for Robust Co-Saliency Detection" index=100>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (19/82 | 101/314) Language Plays a Pivotal Role in the Object-Attribute Compositional Generalization of CLIP (Reza Abbasi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Language Plays a Pivotal Role in the Object-Attribute Compositional Generalization of CLIP" index=101>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (20/82 | 102/314) DiffStyler: Diffusion-based Localized Image Style Transfer (Shaoxu Li, 2024)
...
<br/>
<button class="copy-to-clipboard" title="DiffStyler: Diffusion-based Localized Image Style Transfer" index=102>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (21/82 | 103/314) $\mathrm{F^2Depth}$: Self-supervised Indoor Monocular Depth Estimation via Optical Flow Consistency and Feature Map Synthesis (Xiaotong Guo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="$\mathrm{F^2Depth}$: Self-supervised Indoor Monocular Depth Estimation via Optical Flow Consistency and Feature Map Synthesis" index=103>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (22/82 | 104/314) Colour and Brush Stroke Pattern Recognition in Abstract Art using Modified Deep Convolutional Generative Adversarial Networks (Srinitish Srinivasan et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Colour and Brush Stroke Pattern Recognition in Abstract Art using Modified Deep Convolutional Generative Adversarial Networks" index=104>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (23/82 | 105/314) Ship in Sight: Diffusion Models for Ship-Image Super Resolution (Luigi Sigillo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Ship in Sight: Diffusion Models for Ship-Image Super Resolution" index=105>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (24/82 | 106/314) Toward Interactive Regional Understanding in Vision-Large Language Models (Jungbeom Lee et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Toward Interactive Regional Understanding in Vision-Large Language Models" index=106>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (25/82 | 107/314) Benchmarking Object Detectors with COCO: A New Path Forward (Shweta Singh et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Benchmarking Object Detectors with COCO: A New Path Forward" index=107>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (26/82 | 108/314) Middle Fusion and Multi-Stage, Multi-Form Prompts for Robust RGB-T Tracking (Qiming Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Middle Fusion and Multi-Stage, Multi-Form Prompts for Robust RGB-T Tracking" index=108>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (27/82 | 109/314) MetaCap: Meta-learning Priors from Multi-View Imagery for Sparse-view Human Performance Capture and Rendering (Guoxing Sun et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="MetaCap: Meta-learning Priors from Multi-View Imagery for Sparse-view Human Performance Capture and Rendering" index=109>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (28/82 | 110/314) Multi-scale Unified Network for Image Classification (Wenzhuo Liu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Multi-scale Unified Network for Image Classification" index=110>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (29/82 | 111/314) Duolando: Follower GPT with Off-Policy Reinforcement Learning for Dance Accompaniment (Li Siyao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Duolando: Follower GPT with Off-Policy Reinforcement Learning for Dance Accompaniment" index=111>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (30/82 | 112/314) RAP: Retrieval-Augmented Planner for Adaptive Procedure Planning in Instructional Videos (Ali Zare et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="RAP: Retrieval-Augmented Planner for Adaptive Procedure Planning in Instructional Videos" index=112>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (31/82 | 113/314) SingularTrajectory: Universal Trajectory Predictor Using Diffusion Model (Inhwan Bae et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="SingularTrajectory: Universal Trajectory Predictor Using Diffusion Model" index=113>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (32/82 | 114/314) Efficient Test-Time Adaptation of Vision-Language Models (Adilbek Karmanov et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Efficient Test-Time Adaptation of Vision-Language Models" index=114>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (33/82 | 115/314) Image Deraining via Self-supervised Reinforcement Learning (He-Hao Liao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Image Deraining via Self-supervised Reinforcement Learning" index=115>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (34/82 | 116/314) Garment3DGen: 3D Garment Stylization and Texture Generation (Nikolaos Sarafianos et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Garment3DGen: 3D Garment Stylization and Texture Generation" index=116>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (35/82 | 117/314) ECoDepth: Effective Conditioning of Diffusion Models for Monocular Depth Estimation (Suraj Patni et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="ECoDepth: Effective Conditioning of Diffusion Models for Monocular Depth Estimation" index=117>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (36/82 | 118/314) I2CKD : Intra- and Inter-Class Knowledge Distillation for Semantic Segmentation (Ayoub Karine et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="I2CKD : Intra- and Inter-Class Knowledge Distillation for Semantic Segmentation" index=118>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (37/82 | 119/314) DODA: Diffusion for Object-detection Domain Adaptation in Agriculture (Shuai Xiang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="DODA: Diffusion for Object-detection Domain Adaptation in Agriculture" index=119>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (38/82 | 120/314) Unleashing the Potential of SAM for Medical Adaptation via Hierarchical Decoding (Zhiheng Cheng et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Unleashing the Potential of SAM for Medical Adaptation via Hierarchical Decoding" index=120>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (39/82 | 121/314) Road Obstacle Detection based on Unknown Objectness Scores (Chihiro Noguchi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Road Obstacle Detection based on Unknown Objectness Scores" index=121>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (40/82 | 122/314) Few-shot Online Anomaly Detection and Segmentation (Shenxing Wei et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Few-shot Online Anomaly Detection and Segmentation" index=122>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (41/82 | 123/314) Multi-Layer Dense Attention Decoder for Polyp Segmentation (Krushi Patel et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Multi-Layer Dense Attention Decoder for Polyp Segmentation" index=123>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (42/82 | 124/314) Envisioning MedCLIP: A Deep Dive into Explainability for Medical Vision-Language Models (Anees Ur Rehman Hashmi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Envisioning MedCLIP: A Deep Dive into Explainability for Medical Vision-Language Models" index=124>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (43/82 | 125/314) ImageNet-D: Benchmarking Neural Network Robustness on Diffusion Synthetic Object (Chenshuang Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="ImageNet-D: Benchmarking Neural Network Robustness on Diffusion Synthetic Object" index=125>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (44/82 | 126/314) PIPNet3D: Interpretable Detection of Alzheimer in MRI Scans (Lisa Anita De Santi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="PIPNet3D: Interpretable Detection of Alzheimer in MRI Scans" index=126>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (45/82 | 127/314) Towards Non-Exemplar Semi-Supervised Class-Incremental Learning (Wenzhuo Liu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Towards Non-Exemplar Semi-Supervised Class-Incremental Learning" index=127>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (46/82 | 128/314) NeuSDFusion: A Spatial-Aware Generative Model for 3D Shape Completion, Reconstruction, and Generation (Ruikai Cui et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="NeuSDFusion: A Spatial-Aware Generative Model for 3D Shape Completion, Reconstruction, and Generation" index=128>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (47/82 | 129/314) NeuroPictor: Refining fMRI-to-Image Reconstruction via Multi-individual Pretraining and Multi-level Modulation (Jingyang Huo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="NeuroPictor: Refining fMRI-to-Image Reconstruction via Multi-individual Pretraining and Multi-level Modulation" index=129>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (48/82 | 130/314) Lift3D: Zero-Shot Lifting of Any 2D Vision Model to 3D (Mukund Varma T et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Lift3D: Zero-Shot Lifting of Any 2D Vision Model to 3D" index=130>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (49/82 | 131/314) Gamba: Marry Gaussian Splatting with Mamba for single view 3D reconstruction (Qiuhong Shen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Gamba: Marry Gaussian Splatting with Mamba for single view 3D reconstruction" index=131>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.18795v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.18795v1.pdf" filename="2403.18795v1.pdf">Download PDF</button>
...
### (50/82 | 132/314) Density-guided Translator Boosts Synthetic-to-Real Unsupervised Domain Adaptive Segmentation of 3D Point Clouds (Zhimin Yuan et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Density-guided Translator Boosts Synthetic-to-Real Unsupervised Domain Adaptive Segmentation of 3D Point Clouds" index=132>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (51/82 | 133/314) U-Sketch: An Efficient Approach for Sketch to Image Diffusion Models (Ilias Mitsouras et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="U-Sketch: An Efficient Approach for Sketch to Image Diffusion Models" index=133>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (52/82 | 134/314) ECNet: Effective Controllable Text-to-Image Diffusion Models (Sicheng Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="ECNet: Effective Controllable Text-to-Image Diffusion Models" index=134>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (53/82 | 135/314) BAM: Box Abstraction Monitors for Real-time OoD Detection in Object Detection (Changshun Wu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="BAM: Box Abstraction Monitors for Real-time OoD Detection in Object Detection" index=135>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (54/82 | 136/314) Tracking-Assisted Object Detection with Event Cameras (Ting-Kang Yen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Tracking-Assisted Object Detection with Event Cameras" index=136>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (55/82 | 137/314) SGDM: Static-Guided Dynamic Module Make Stronger Visual Models (Wenjie Xing et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="SGDM: Static-Guided Dynamic Module Make Stronger Visual Models" index=137>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (56/82 | 138/314) Fourier or Wavelet bases as counterpart self-attention in spikformer for efficient visual classification (Qingyu Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Fourier or Wavelet bases as counterpart self-attention in spikformer for efficient visual classification" index=138>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (57/82 | 139/314) Mitigating Hallucinations in Large Vision-Language Models with Instruction Contrastive Decoding (Xintong Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Mitigating Hallucinations in Large Vision-Language Models with Instruction Contrastive Decoding" index=139>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (58/82 | 140/314) Bringing Textual Prompt to AI-Generated Image Quality Assessment (Bowen Qu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Bringing Textual Prompt to AI-Generated Image Quality Assessment" index=140>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (59/82 | 141/314) Object Pose Estimation via the Aggregation of Diffusion Features (Tianfu Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Object Pose Estimation via the Aggregation of Diffusion Features" index=141>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (60/82 | 142/314) HandBooster: Boosting 3D Hand-Mesh Reconstruction by Conditional Synthesis and Sampling of Hand-Object Interactions (Hao Xu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="HandBooster: Boosting 3D Hand-Mesh Reconstruction by Conditional Synthesis and Sampling of Hand-Object Interactions" index=142>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (61/82 | 143/314) A Semi-supervised Nighttime Dehazing Baseline with Spatial-Frequency Aware and Realistic Brightness Constraint (Xiaofeng Cong et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Semi-supervised Nighttime Dehazing Baseline with Spatial-Frequency Aware and Realistic Brightness Constraint" index=143>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (62/82 | 144/314) Backpropagation-free Network for 3D Test-time Adaptation (Yanshuo Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Backpropagation-free Network for 3D Test-time Adaptation" index=144>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (63/82 | 145/314) Generative Multi-modal Models are Good Class-Incremental Learners (Xusheng Cao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Generative Multi-modal Models are Good Class-Incremental Learners" index=145>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (64/82 | 146/314) Don't Look into the Dark: Latent Codes for Pluralistic Image Inpainting (Haiwei Chen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Don't Look into the Dark: Latent Codes for Pluralistic Image Inpainting" index=146>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (65/82 | 147/314) Egocentric Scene-aware Human Trajectory Prediction (Weizhuo Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Egocentric Scene-aware Human Trajectory Prediction" index=147>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (66/82 | 148/314) Cross--domain Fiber Cluster Shape Analysis for Language Performance Cognitive Score Prediction (Yui Lo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Cross--domain Fiber Cluster Shape Analysis for Language Performance Cognitive Score Prediction" index=148>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (67/82 | 149/314) UniDepth: Universal Monocular Metric Depth Estimation (Luigi Piccinelli et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="UniDepth: Universal Monocular Metric Depth Estimation" index=149>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (68/82 | 150/314) Enhancing Multiple Object Tracking Accuracy via Quantum Annealing (Yasuyuki Ihara, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Enhancing Multiple Object Tracking Accuracy via Quantum Annealing" index=150>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (69/82 | 151/314) Annolid: Annotate, Segment, and Track Anything You Need (Chen Yang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Annolid: Annotate, Segment, and Track Anything You Need" index=151>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (70/82 | 152/314) Homogeneous Tokenizer Matters: Homogeneous Visual Tokenizer for Remote Sensing Image Understanding (Run Shao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Homogeneous Tokenizer Matters: Homogeneous Visual Tokenizer for Remote Sensing Image Understanding" index=152>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (71/82 | 153/314) Attention Calibration for Disentangled Text-to-Image Personalization (Yanbing Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Attention Calibration for Disentangled Text-to-Image Personalization" index=153>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (72/82 | 154/314) DiffusionFace: Towards a Comprehensive Dataset for Diffusion-Based Face Forgery Analysis (Zhongxi Chen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="DiffusionFace: Towards a Comprehensive Dataset for Diffusion-Based Face Forgery Analysis" index=154>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (73/82 | 155/314) AIC-UNet: Anatomy-informed Cascaded UNet for Robust Multi-Organ Segmentation (Young Seok Jeon et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="AIC-UNet: Anatomy-informed Cascaded UNet for Robust Multi-Organ Segmentation" index=155>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (74/82 | 156/314) A Channel-ensemble Approach: Unbiased and Low-variance Pseudo-labels is Critical for Semi-supervised Classification (Jiaqi Wu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Channel-ensemble Approach: Unbiased and Low-variance Pseudo-labels is Critical for Semi-supervised Classification" index=156>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (75/82 | 157/314) Uncertainty-Aware SAR ATR: Defending Against Adversarial Attacks via Bayesian Neural Networks (Tian Ye et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Uncertainty-Aware SAR ATR: Defending Against Adversarial Attacks via Bayesian Neural Networks" index=157>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (76/82 | 158/314) Enhancing Generative Class Incremental Learning Performance with Model Forgetting Approach (Taro Togo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Enhancing Generative Class Incremental Learning Performance with Model Forgetting Approach" index=158>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (77/82 | 159/314) TAFormer: A Unified Target-Aware Transformer for Video and Motion Joint Prediction in Aerial Scenes (Liangyu Xu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="TAFormer: A Unified Target-Aware Transformer for Video and Motion Joint Prediction in Aerial Scenes" index=159>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (78/82 | 160/314) Towards Image Ambient Lighting Normalization (Florin-Alexandru Vasluianu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Towards Image Ambient Lighting Normalization" index=160>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (79/82 | 161/314) An Evolutionary Network Architecture Search Framework with Adaptive Multimodal Fusion for Hand Gesture Recognition (Yizhang Xia et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="An Evolutionary Network Architecture Search Framework with Adaptive Multimodal Fusion for Hand Gesture Recognition" index=161>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (80/82 | 162/314) SplatFace: Gaussian Splat Face Reconstruction Leveraging an Optimizable Surface (Jiahao Luo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="SplatFace: Gaussian Splat Face Reconstruction Leveraging an Optimizable Surface" index=162>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (81/82 | 163/314) ParCo: Part-Coordinating Text-to-Motion Synthesis (Qiran Zou et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="ParCo: Part-Coordinating Text-to-Motion Synthesis" index=163>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (82/82 | 164/314) DVLO: Deep Visual-LiDAR Odometry with Local-to-Global Feature Fusion and Bi-Directional Structure Alignment (Jiuming Liu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="DVLO: Deep Visual-LiDAR Odometry with Local-to-Global Feature Fusion and Bi-Directional Structure Alignment" index=164>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/47 | 165/314) Physics-Informed Graph Neural Networks for Water Distribution Systems (Inaam Ashraf et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Physics-Informed Graph Neural Networks for Water Distribution Systems" index=165>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/47 | 166/314) Deep Learning for Traffic Flow Prediction using Cellular Automata-based Model and CNN-LSTM architecture (Zhaohui Yang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Deep Learning for Traffic Flow Prediction using Cellular Automata-based Model and CNN-LSTM architecture" index=166>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/47 | 167/314) Self-Expansion of Pre-trained Models with Mixture of Adapters for Continual Learning (Huiyi Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Self-Expansion of Pre-trained Models with Mixture of Adapters for Continual Learning" index=167>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/47 | 168/314) The Topos of Transformer Networks (Mattia Jacopo Villani et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="The Topos of Transformer Networks" index=168>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/47 | 169/314) PDNNet: PDN-Aware GNN-CNN Heterogeneous Network for Dynamic IR Drop Prediction (Yuxiang Zhao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="PDNNet: PDN-Aware GNN-CNN Heterogeneous Network for Dynamic IR Drop Prediction" index=169>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (6/47 | 170/314) Multi-Modal Contrastive Learning for Online Clinical Time-Series Applications (Fabian Baldenweg et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Multi-Modal Contrastive Learning for Online Clinical Time-Series Applications" index=170>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (7/47 | 171/314) Branch-Tuning: Balancing Stability and Plasticity for Continual Self-Supervised Learning (Wenzhuo Liu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Branch-Tuning: Balancing Stability and Plasticity for Continual Self-Supervised Learning" index=171>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (8/47 | 172/314) Contrastive Learning with Orthonormal Anchors (CLOA) (Huanran Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Contrastive Learning with Orthonormal Anchors (CLOA)" index=172>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (9/47 | 173/314) Safe and Robust Reinforcement-Learning: Principles and Practice (Taku Yamagata et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Safe and Robust Reinforcement-Learning: Principles and Practice" index=173>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (10/47 | 174/314) Robustness and Visual Explanation for Black Box Image, Video, and ECG Signal Classification with Reinforcement Learning (Soumyendu Sarkar et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Robustness and Visual Explanation for Black Box Image, Video, and ECG Signal Classification with Reinforcement Learning" index=174>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (11/47 | 175/314) Selective Mixup Fine-Tuning for Optimizing Non-Decomposable Objectives (Shrinivas Ramasubramanian et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Selective Mixup Fine-Tuning for Optimizing Non-Decomposable Objectives" index=175>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (12/47 | 176/314) GeNet: A Graph Neural Network-based Anti-noise Task-Oriented Semantic Communication Paradigm (Chunhang Zheng et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="GeNet: A Graph Neural Network-based Anti-noise Task-Oriented Semantic Communication Paradigm" index=176>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (13/47 | 177/314) CoRAST: Towards Foundation Model-Powered Correlated Data Analysis in Resource-Constrained CPS and IoT (Yi Hu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="CoRAST: Towards Foundation Model-Powered Correlated Data Analysis in Resource-Constrained CPS and IoT" index=177>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (14/47 | 178/314) TransFusion: Contrastive Learning with Transformers (Huanran Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="TransFusion: Contrastive Learning with Transformers" index=178>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (15/47 | 179/314) Fusion approaches for emotion recognition from speech using acoustic and text-based features (Leonardo Pepino et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Fusion approaches for emotion recognition from speech using acoustic and text-based features" index=179>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (16/47 | 180/314) Scalable Lipschitz Estimation for CNNs (Yusuf Sulehman et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Scalable Lipschitz Estimation for CNNs" index=180>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (17/47 | 181/314) Improving Line Search Methods for Large Scale Neural Network Training (Philip Kenneweg et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Improving Line Search Methods for Large Scale Neural Network Training" index=181>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (18/47 | 182/314) Faster Convergence for Transformer Fine-tuning with Line Search Methods (Philip Kenneweg et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Faster Convergence for Transformer Fine-tuning with Line Search Methods" index=182>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (19/47 | 183/314) Collaborative Active Learning in Conditional Trust Environment (Zan-Kai Chong et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Collaborative Active Learning in Conditional Trust Environment" index=183>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (20/47 | 184/314) On Spectrogram Analysis in a Multiple Classifier Fusion Framework for Power Grid Classification Using Electric Network Frequency (Georgios Tzolopoulos et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="On Spectrogram Analysis in a Multiple Classifier Fusion Framework for Power Grid Classification Using Electric Network Frequency" index=184>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (21/47 | 185/314) A Geometric Explanation of the Likelihood OOD Detection Paradox (Hamidreza Kamkari et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Geometric Explanation of the Likelihood OOD Detection Paradox" index=185>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (22/47 | 186/314) Looking Beyond What You See: An Empirical Analysis on Subgroup Intersectional Fairness for Multi-label Chest X-ray Classification Using Social Determinants of Racial Health Inequities (Dana Moukheiber et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Looking Beyond What You See: An Empirical Analysis on Subgroup Intersectional Fairness for Multi-label Chest X-ray Classification Using Social Determinants of Racial Health Inequities" index=186>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (23/47 | 187/314) Detecting Generative Parroting through Overfitting Masked Autoencoders (Saeid Asgari Taghanaki et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Detecting Generative Parroting through Overfitting Masked Autoencoders" index=187>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (24/47 | 188/314) Understanding the Learning Dynamics of Alignment with Human Feedback (Shawn Im et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Understanding the Learning Dynamics of Alignment with Human Feedback" index=188>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (25/47 | 189/314) Semi-Supervised Learning for Deep Causal Generative Models (Yasin Ibrahim et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Semi-Supervised Learning for Deep Causal Generative Models" index=189>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (26/47 | 190/314) FRESCO: Federated Reinforcement Energy System for Cooperative Optimization (Nicolas Mauricio Cuadrado et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="FRESCO: Federated Reinforcement Energy System for Cooperative Optimization" index=190>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (27/47 | 191/314) The Artificial Neural Twin -- Process Optimization and Continual Learning in Distributed Process Chains (Johannes Emmert et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="The Artificial Neural Twin -- Process Optimization and Continual Learning in Distributed Process Chains" index=191>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (28/47 | 192/314) Macroscale fracture surface segmentation via semi-supervised learning considering the structural similarity (Johannes Rosenberger et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Macroscale fracture surface segmentation via semi-supervised learning considering the structural similarity" index=192>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (29/47 | 193/314) A thermodynamically consistent physics-informed deep learning material model for short fiber/polymer nanocomposites (Betim Bahtiri et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A thermodynamically consistent physics-informed deep learning material model for short fiber/polymer nanocomposites" index=193>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (30/47 | 194/314) DSF-GAN: DownStream Feedback Generative Adversarial Network (Oriel Perets et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="DSF-GAN: DownStream Feedback Generative Adversarial Network" index=194>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (31/47 | 195/314) From Two-Dimensional to Three-Dimensional Environment with Q-Learning: Modeling Autonomous Navigation with Reinforcement Learning and no Libraries (Ergon Cugler de Moraes Silva, 2024)
...
<br/>
<button class="copy-to-clipboard" title="From Two-Dimensional to Three-Dimensional Environment with Q-Learning: Modeling Autonomous Navigation with Reinforcement Learning and no Libraries" index=195>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (32/47 | 196/314) Compression of the Koopman matrix for nonlinear physical models via hierarchical clustering (Tomoya Nishikata et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Compression of the Koopman matrix for nonlinear physical models via hierarchical clustering" index=196>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (33/47 | 197/314) Equity in Healthcare: Analyzing Disparities in Machine Learning Predictions of Diabetic Patient Readmissions (Zainab Al-Zanbouri et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Equity in Healthcare: Analyzing Disparities in Machine Learning Predictions of Diabetic Patient Readmissions" index=197>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (34/47 | 198/314) Exploiting Symmetry in Dynamics for Model-Based Reinforcement Learning with Asymmetric Rewards (Yasin Sonmez et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Exploiting Symmetry in Dynamics for Model-Based Reinforcement Learning with Asymmetric Rewards" index=198>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (35/47 | 199/314) Thelxinoë: Recognizing Human Emotions Using Pupillometry and Machine Learning (Darlene Barker et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Thelxinoë: Recognizing Human Emotions Using Pupillometry and Machine Learning" index=199>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (36/47 | 200/314) Conditional Wasserstein Distances with Applications in Bayesian OT Flow Matching (Jannis Chemseddine et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Conditional Wasserstein Distances with Applications in Bayesian OT Flow Matching" index=200>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (37/47 | 201/314) Learning in PINNs: Phase transition, total diffusion, and generalization (Sokratis J. Anagnostopoulos et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Learning in PINNs: Phase transition, total diffusion, and generalization" index=201>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (38/47 | 202/314) Synthesizing EEG Signals from Event-Related Potential Paradigms with Conditional Diffusion Models (Guido Klein et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Synthesizing EEG Signals from Event-Related Potential Paradigms with Conditional Diffusion Models" index=202>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (39/47 | 203/314) Generalized Policy Learning for Smart Grids: FL TRPO Approach (Yunxiang Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Generalized Policy Learning for Smart Grids: FL TRPO Approach" index=203>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (40/47 | 204/314) Global Vegetation Modeling with Pre-Trained Weather Transformers (Pascal Janetzky et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Global Vegetation Modeling with Pre-Trained Weather Transformers" index=204>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (41/47 | 205/314) IIP-Mixer:Intra-Inter Patch Mixing Architecture for Battery Remaining Useful Life Prediction (Guangzai Ye et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="IIP-Mixer:Intra-Inter Patch Mixing Architecture for Battery Remaining Useful Life Prediction" index=205>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (42/47 | 206/314) Stragglers-Aware Low-Latency Synchronous Federated Learning via Layer-Wise Model Updates (Natalie Lang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Stragglers-Aware Low-Latency Synchronous Federated Learning via Layer-Wise Model Updates" index=206>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (43/47 | 207/314) Long and Short-Term Constraints Driven Safe Reinforcement Learning for Autonomous Driving (Xuemin Hu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Long and Short-Term Constraints Driven Safe Reinforcement Learning for Autonomous Driving" index=207>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (44/47 | 208/314) Superior Parallel Big Data Clustering through Competitive Stochastic Sample Size Optimization in Big-means (Rustam Mussabayev et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Superior Parallel Big Data Clustering through Competitive Stochastic Sample Size Optimization in Big-means" index=208>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (45/47 | 209/314) Tensor-based Graph Learning with Consistency and Specificity for Multi-view Clustering (Long Shi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Tensor-based Graph Learning with Consistency and Specificity for Multi-view Clustering" index=209>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (46/47 | 210/314) Nonlinear model reduction for operator learning (Hamidreza Eivazi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Nonlinear model reduction for operator learning" index=210>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (47/47 | 211/314) Multi-Label Adaptive Batch Selection by Highlighting Hard and Imbalanced Samples (Ao Zhou et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Multi-Label Adaptive Batch Selection by Highlighting Hard and Imbalanced Samples" index=211>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/9 | 212/314) Generative Medical Segmentation (Jiayu Huo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Generative Medical Segmentation" index=212>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/9 | 213/314) HEMIT: H&E to Multiplex-immunohistochemistry Image Translation with Dual-Branch Pix2pix Generator (Chang Bian et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="HEMIT: H&E to Multiplex-immunohistochemistry Image Translation with Dual-Branch Pix2pix Generator" index=213>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/9 | 214/314) Benchmarking Image Transformers for Prostate Cancer Detection from Ultrasound Data (Mohamed Harmanani et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Benchmarking Image Transformers for Prostate Cancer Detection from Ultrasound Data" index=214>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/9 | 215/314) CT-3DFlow : Leveraging 3D Normalizing Flows for Unsupervised Detection of Pathological Pulmonary CT scans (Aissam Djahnine et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="CT-3DFlow : Leveraging 3D Normalizing Flows for Unsupervised Detection of Pathological Pulmonary CT scans" index=215>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/9 | 216/314) A vascular synthetic model for improved aneurysm segmentation and detection via Deep Neural Networks (Rafic Nader et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A vascular synthetic model for improved aneurysm segmentation and detection via Deep Neural Networks" index=216>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (6/9 | 217/314) Theoretical Bound-Guided Hierarchical VAE for Neural Image Codecs (Yichi Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Theoretical Bound-Guided Hierarchical VAE for Neural Image Codecs" index=217>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (7/9 | 218/314) Deep Learning Segmentation and Classification of Red Blood Cells Using a Large Multi-Scanner Dataset (Mohamed Elmanna et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Deep Learning Segmentation and Classification of Red Blood Cells Using a Large Multi-Scanner Dataset" index=218>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (8/9 | 219/314) Transformers-based architectures for stroke segmentation: A review (Yalda Zafari-Ghadim et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Transformers-based architectures for stroke segmentation: A review" index=219>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (9/9 | 220/314) H2ASeg: Hierarchical Adaptive Interaction and Weighting Network for Tumor Segmentation in PET/CT Images (Jinpeng Lu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="H2ASeg: Hierarchical Adaptive Interaction and Weighting Network for Tumor Segmentation in PET/CT Images" index=220>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/3 | 221/314) Noise-Robust Keyword Spotting through Self-supervised Pretraining (Jacob Mørk et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Noise-Robust Keyword Spotting through Self-supervised Pretraining" index=221>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/3 | 222/314) A Diffusion-Based Generative Equalizer for Music Restoration (Eloi Moliner et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Diffusion-Based Generative Equalizer for Music Restoration" index=222>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/3 | 223/314) Dual-path Mamba: Short and Long-term Bidirectional Selective Structured State Space Models for Speech Separation (Xilin Jiang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Dual-path Mamba: Short and Long-term Bidirectional Selective Structured State Space Models for Speech Separation" index=223>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/14 | 224/314) LC-LLM: Explainable Lane-Change Intention and Trajectory Predictions with Large Language Models (Mingxing Peng et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="LC-LLM: Explainable Lane-Change Intention and Trajectory Predictions with Large Language Models" index=224>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/14 | 225/314) Boosting Conversational Question Answering with Fine-Grained Retrieval-Augmentation and Self-Check (Linhao Ye et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Boosting Conversational Question Answering with Fine-Grained Retrieval-Augmentation and Self-Check" index=225>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/14 | 226/314) Large Language Models Need Consultants for Reasoning: Becoming an Expert in a Complex Human System Through Behavior Simulation (Chuwen Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Large Language Models Need Consultants for Reasoning: Becoming an Expert in a Complex Human System Through Behavior Simulation" index=226>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/14 | 227/314) Leveraging Large Language Models for Relevance Judgments in Legal Case Retrieval (Shengjie Ma et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Leveraging Large Language Models for Relevance Judgments in Legal Case Retrieval" index=227>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/14 | 228/314) mALBERT: Is a Compact Multilingual BERT Model Still Worth It? (Christophe Servan et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="mALBERT: Is a Compact Multilingual BERT Model Still Worth It?" index=228>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (6/14 | 229/314) Probabilistic Model Checking of Stochastic Reinforcement Learning Policies (Dennis Gross et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Probabilistic Model Checking of Stochastic Reinforcement Learning Policies" index=229>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (7/14 | 230/314) Neural Architecture Search for Sentence Classification with BERT (Philip Kenneweg et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Neural Architecture Search for Sentence Classification with BERT" index=230>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (8/14 | 231/314) Identification and Uses of Deep Learning Backbones via Pattern Mining (Michael Livanos et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Identification and Uses of Deep Learning Backbones via Pattern Mining" index=231>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (9/14 | 232/314) A Path Towards Legal Autonomy: An interoperable and explainable approach to extracting, transforming, loading and computing legal information using large language models, expert systems and Bayesian networks (Axel Constant et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Path Towards Legal Autonomy: An interoperable and explainable approach to extracting, transforming, loading and computing legal information using large language models, expert systems and Bayesian networks" index=232>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (10/14 | 233/314) Leveraging Large Language Models for Fuzzy String Matching in Political Science (Yu Wang, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Leveraging Large Language Models for Fuzzy String Matching in Political Science" index=233>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (11/14 | 234/314) Exploring the Privacy Protection Capabilities of Chinese Large Language Models (Yuqi Yang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Exploring the Privacy Protection Capabilities of Chinese Large Language Models" index=234>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (12/14 | 235/314) Enhancing Manufacturing Quality Prediction Models through the Integration of Explainability Methods (Dennis Gross et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Enhancing Manufacturing Quality Prediction Models through the Integration of Explainability Methods" index=235>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (13/14 | 236/314) FTBC: Forward Temporal Bias Correction for Optimizing ANN-SNN Conversion (Xiaofeng Wu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="FTBC: Forward Temporal Bias Correction for Optimizing ANN-SNN Conversion" index=236>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (14/14 | 237/314) EndToEndML: An Open-Source End-to-End Pipeline for Machine Learning Applications (Nisha Pillai et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="EndToEndML: An Open-Source End-to-End Pipeline for Machine Learning Applications" index=237>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/11 | 238/314) CPR: Retrieval Augmented Generation for Copyright Protection (Aditya Golatkar et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="CPR: Retrieval Augmented Generation for Copyright Protection" index=238>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/11 | 239/314) FoC: Figure out the Cryptographic Functions in Stripped Binaries with LLMs (Guoqiang Chen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="FoC: Figure out the Cryptographic Functions in Stripped Binaries with LLMs" index=239>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/11 | 240/314) MisGUIDE : Defense Against Data-Free Deep Learning Model Extraction (Mahendra Gurve et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="MisGUIDE : Defense Against Data-Free Deep Learning Model Extraction" index=240>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/11 | 241/314) Bayesian Learned Models Can Detect Adversarial Malware For Free (Bao Gia Doan et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Bayesian Learned Models Can Detect Adversarial Malware For Free" index=241>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/11 | 242/314) Privacy-Preserving Distributed Nonnegative Matrix Factorization (Ehsan Lari et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Privacy-Preserving Distributed Nonnegative Matrix Factorization" index=242>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (6/11 | 243/314) A Transformer-Based Framework for Payload Malware Detection and Classification (Kyle Stein et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Transformer-Based Framework for Payload Malware Detection and Classification" index=243>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (7/11 | 244/314) Dealing with Imbalanced Classes in Bot-IoT Dataset (Jesse Atuhurra et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Dealing with Imbalanced Classes in Bot-IoT Dataset" index=244>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (8/11 | 245/314) Spikewhisper: Temporal Spike Backdoor Attacks on Federated Neuromorphic Learning over Low-power Devices (Hanqing Fu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Spikewhisper: Temporal Spike Backdoor Attacks on Federated Neuromorphic Learning over Low-power Devices" index=245>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (9/11 | 246/314) The Impact of Uniform Inputs on Activation Sparsity and Energy-Latency Attacks in Computer Vision (Andreas Müller et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="The Impact of Uniform Inputs on Activation Sparsity and Energy-Latency Attacks in Computer Vision" index=246>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (10/11 | 247/314) Statistical testing of random number generators and their improvement using randomness extraction (Cameron Foreman et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Statistical testing of random number generators and their improvement using randomness extraction" index=247>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (11/11 | 248/314) Optimizing Cyber Response Time on Temporal Active Directory Networks Using Decoys (Huy Q. Ngo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Optimizing Cyber Response Time on Temporal Active Directory Networks Using Decoys" index=248>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/6 | 249/314) Few-Shot Cross-System Anomaly Trace Classification for Microservice-based systems (Yuqing Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Few-Shot Cross-System Anomaly Trace Classification for Microservice-based systems" index=249>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/6 | 250/314) Vulnerability Detection with Code Language Models: How Far Are We? (Yangruibo Ding et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Vulnerability Detection with Code Language Models: How Far Are We?" index=250>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/6 | 251/314) A State-of-the-practice Release-readiness Checklist for Generative AI-based Software Products (Harsh Patel et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A State-of-the-practice Release-readiness Checklist for Generative AI-based Software Products" index=251>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/6 | 252/314) An Exploratory Study on Upper-Level Computing Students' Use of Large Language Models as Tools in a Semester-Long Project (Ben Arie Tanay et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="An Exploratory Study on Upper-Level Computing Students' Use of Large Language Models as Tools in a Semester-Long Project" index=252>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/6 | 253/314) CYCLE: Learning to Self-Refine the Code Generation (Yangruibo Ding et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="CYCLE: Learning to Self-Refine the Code Generation" index=253>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (6/6 | 254/314) Algorithmic Details behind the Predator Shape Analyser (Kamil Dudka et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Algorithmic Details behind the Predator Shape Analyser" index=254>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 255/314) Moderating Illicit Online Image Promotion for Unsafe User-Generated Content Games Using Large Vision-Language Models (Keyan Guo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Moderating Illicit Online Image Promotion for Unsafe User-Generated Content Games Using Large Vision-Language Models" index=255>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/5 | 256/314) Resource Allocation in Large Language Model Integrated 6G Vehicular Networks (Chang Liu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Resource Allocation in Large Language Model Integrated 6G Vehicular Networks" index=256>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/5 | 257/314) Optimizing Communication for Latency Sensitive HPC Applications on up to 48 FPGAs Using ACCL (Marius Meyer et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Optimizing Communication for Latency Sensitive HPC Applications on up to 48 FPGAs Using ACCL" index=257>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/5 | 258/314) Distributed Maximum Consensus over Noisy Links (Ehsan Lari et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Distributed Maximum Consensus over Noisy Links" index=258>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/5 | 259/314) Optimal Resource Efficiency with Fairness in Heterogeneous GPU Clusters (Zizhao Mo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Optimal Resource Efficiency with Fairness in Heterogeneous GPU Clusters" index=259>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/5 | 260/314) Enhanced OpenMP Algorithm to Compute All-Pairs Shortest Path on x86 Architectures (Sergio Calderón et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Enhanced OpenMP Algorithm to Compute All-Pairs Shortest Path on x86 Architectures" index=260>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/2 | 261/314) SMOF: Streaming Modern CNNs on FPGAs with Smart Off-Chip Eviction (Petros Toupas et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="SMOF: Streaming Modern CNNs on FPGAs with Smart Off-Chip Eviction" index=261>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/2 | 262/314) Merits of Time-Domain Computing for VMM -- A Quantitative Comparison (Florian Freye et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Merits of Time-Domain Computing for VMM -- A Quantitative Comparison" index=262>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/2 | 263/314) Real Acoustic Fields: An Audio-Visual Room Acoustics Dataset and Benchmark (Ziyang Chen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Real Acoustic Fields: An Audio-Visual Room Acoustics Dataset and Benchmark" index=263>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/2 | 264/314) ACES: Evaluating Automated Audio Captioning Models on the Semantics of Sounds (Gijs Wijngaard et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="ACES: Evaluating Automated Audio Captioning Models on the Semantics of Sounds" index=264>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/4 | 265/314) Intent-Aware DRL-Based Uplink Dynamic Scheduler for 5G-NR (Salwa Mostafa et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Intent-Aware DRL-Based Uplink Dynamic Scheduler for 5G-NR" index=265>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/4 | 266/314) Mutual Information Optimization for SIM-Based Holographic MIMO Systems (Nemanja Stefan Perović et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Mutual Information Optimization for SIM-Based Holographic MIMO Systems" index=266>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/4 | 267/314) Representatividad Muestral en la Incertidumbre Simétrica Multivariada para la Selección de Atributos (Gustavo Sosa-Cabrera, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Representatividad Muestral en la Incertidumbre Simétrica Multivariada para la Selección de Atributos" index=267>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/4 | 268/314) The Dimensions of the Hulls of Conorm Codes from Algebraic Geometry Codes (Junmin An et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="The Dimensions of the Hulls of Conorm Codes from Algebraic Geometry Codes" index=268>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/10 | 269/314) Differentially Private Distributed Nonconvex Stochastic Optimization with Quantized Communications (Jialong Chen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Differentially Private Distributed Nonconvex Stochastic Optimization with Quantized Communications" index=269>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/10 | 270/314) Differentially Private Dual Gradient Tracking for Distributed Resource Allocation (Wei Huo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Differentially Private Dual Gradient Tracking for Distributed Resource Allocation" index=270>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/10 | 271/314) Nonlinear Model Predictive Control for Enhanced Navigation of Autonomous Surface Vessels (Daniel Menges et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Nonlinear Model Predictive Control for Enhanced Navigation of Autonomous Surface Vessels" index=271>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/10 | 272/314) GENESIS-RL: GEnerating Natural Edge-cases with Systematic Integration of Safety considerations and Reinforcement Learning (Hsin-Jung Yang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="GENESIS-RL: GEnerating Natural Edge-cases with Systematic Integration of Safety considerations and Reinforcement Learning" index=272>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/10 | 273/314) FPGA-Based Neural Thrust Controller for UAVs (Sharif Azem et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="FPGA-Based Neural Thrust Controller for UAVs" index=273>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (6/10 | 274/314) Optimal Control Synthesis of Markov Decision Processes for Efficiency with Surveillance Tasks (Yu Chen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Optimal Control Synthesis of Markov Decision Processes for Efficiency with Surveillance Tasks" index=274>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (7/10 | 275/314) Feedback Linearizable Discretizations of Second Order Mechanical Systems using Retraction Maps (Shreyas N. B. et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Feedback Linearizable Discretizations of Second Order Mechanical Systems using Retraction Maps" index=275>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (8/10 | 276/314) Linear Hybrid Asymmetrical Load-Modulated Balanced Amplifier with Multi-Band Reconfigurability and Antenna-VSWR Resilience (Jiachen Guo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Linear Hybrid Asymmetrical Load-Modulated Balanced Amplifier with Multi-Band Reconfigurability and Antenna-VSWR Resilience" index=276>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (9/10 | 277/314) A Dynamic Programming Approach for Road Traffic Estimation (Mattia Laurini et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Dynamic Programming Approach for Road Traffic Estimation" index=277>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (10/10 | 278/314) Incentive-Compatible Vertiport Reservation in Advanced Air Mobility: An Auction-Based Approach (Pan-Yang Su et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Incentive-Compatible Vertiport Reservation in Advanced Air Mobility: An Auction-Based Approach" index=278>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/7 | 279/314) Higher order multi-dimension reduction methods via Einstein-product (Alaeddine Zahir et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Higher order multi-dimension reduction methods via Einstein-product" index=279>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/7 | 280/314) Fractional variational integrators based on convolution quadrature (Khaled Hariz et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Fractional variational integrators based on convolution quadrature" index=280>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/7 | 281/314) Generalized convergence of the deep BSDE method: a step towards fully-coupled FBSDEs and applications in stochastic control (Balint Negyesi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Generalized convergence of the deep BSDE method: a step towards fully-coupled FBSDEs and applications in stochastic control" index=281>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/7 | 282/314) Concurrent level set and fiber orientation optimization of composite structures (M. Mokhtarzadeh et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Concurrent level set and fiber orientation optimization of composite structures" index=282>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/7 | 283/314) Robust Numerical Algebraic Geometry (Emma R. Cobian et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Robust Numerical Algebraic Geometry" index=283>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (6/7 | 284/314) Global convergence of iterative solvers for problems of nonlinear magnetostatics (Herbert Egger et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Global convergence of iterative solvers for problems of nonlinear magnetostatics" index=284>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (7/7 | 285/314) Stability and convergence of the penalty formulation for nonlinear magnetostatics (Herbert Egger et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Stability and convergence of the penalty formulation for nonlinear magnetostatics" index=285>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 286/314) Super-Resolution of SOHO/MDI Magnetograms of Solar Active Regions Using SDO/HMI Data and an Attention-Aided Convolutional Neural Network (Chunhui Xu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Super-Resolution of SOHO/MDI Magnetograms of Solar Active Regions Using SDO/HMI Data and an Attention-Aided Convolutional Neural Network" index=286>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/2 | 287/314) A Study of Three Influencer Archetypes for the Control of Opinion Spread in Time-Varying Social Networks (Michael DeBuse et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Study of Three Influencer Archetypes for the Control of Opinion Spread in Time-Varying Social Networks" index=287>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/2 | 288/314) The process of polarisation as a loss of dimensionality: measuring changes in polarisation using Singular Value Decomposition of network graphs (Sage Anastasi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="The process of polarisation as a loss of dimensionality: measuring changes in polarisation using Singular Value Decomposition of network graphs" index=288>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/2 | 289/314) Tessellation and interactive visualization of four-dimensional spacetime geometries (Philip Claude Caplan, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Tessellation and interactive visualization of four-dimensional spacetime geometries" index=289>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/2 | 290/314) Sliced Online Model Checking for Optimizing the Beam Scheduling Problem in Robotic Radiation Therapy (Lars Beckers et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Sliced Online Model Checking for Optimizing the Beam Scheduling Problem in Robotic Radiation Therapy" index=290>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 291/314) How to Cache Important Contents for Multi-modal Service in Dynamic Networks: A DRL-based Caching Scheme (Zhe Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="How to Cache Important Contents for Multi-modal Service in Dynamic Networks: A DRL-based Caching Scheme" index=291>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 292/314) Sequential Inference of Hospitalization ElectronicHealth Records Using Probabilistic Models (Alan D. Kaplan et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Sequential Inference of Hospitalization ElectronicHealth Records Using Probabilistic Models" index=292>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 293/314) Using Quantum Computing to Infer Dynamic Behaviors of Biological and Artificial Neural Networks (Gabriel A. Silva, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Using Quantum Computing to Infer Dynamic Behaviors of Biological and Artificial Neural Networks" index=293>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 294/314) MPC-CBF with Adaptive Safety Margins for Safety-critical Teleoperation over Imperfect Network Connections (Riccardo Periotto et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="MPC-CBF with Adaptive Safety Margins for Safety-critical Teleoperation over Imperfect Network Connections" index=294>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 295/314) One flow to correct them all: improving simulations in high-energy physics with a single normalising flow and a switch (Caio Cesar Daumann et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="One flow to correct them all: improving simulations in high-energy physics with a single normalising flow and a switch" index=295>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 296/314) The Metric Distortion of Randomized Social Choice Functions: C1 Maximal Lottery Rules and Simulations (Fabian Frank et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="The Metric Distortion of Randomized Social Choice Functions: C1 Maximal Lottery Rules and Simulations" index=296>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 297/314) Many-Objective Evolutionary Influence Maximization: Balancing Spread, Budget, Fairness, and Time (Elia Cunegatti et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Many-Objective Evolutionary Influence Maximization: Balancing Spread, Budget, Fairness, and Time" index=297>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/2 | 298/314) Algebraic Reasoning Meets Automata in Solving Linear Integer Arithmetic (Peter Habermehl et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Algebraic Reasoning Meets Automata in Solving Linear Integer Arithmetic" index=298>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/2 | 299/314) On Propositional Dynamic Logic and Concurrency (Matteo Acclavio et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="On Propositional Dynamic Logic and Concurrency" index=299>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/5 | 300/314) On the Communication Complexity of Approximate Pattern Matching (Tomasz Kociumaka et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="On the Communication Complexity of Approximate Pattern Matching" index=300>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/5 | 301/314) Hypergraph Unreliability in Quasi-Polynomial Time (Ruoxu Cen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Hypergraph Unreliability in Quasi-Polynomial Time" index=301>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/5 | 302/314) New Graph and Hypergraph Container Lemmas with Applications in Property Testing (Eric Blais et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="New Graph and Hypergraph Container Lemmas with Applications in Property Testing" index=302>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/5 | 303/314) Realizing temporal transportation trees (George B. Mertzios et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Realizing temporal transportation trees" index=303>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/5 | 304/314) Minimum sum vertex cover: kernelization and parameterized algorithms (Yixin Cao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Minimum sum vertex cover: kernelization and parameterized algorithms" index=304>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 305/314) ConstraintFlow: A DSL for Specification and Verification of Neural Network Analyses (Avaljot Singh et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="ConstraintFlow: A DSL for Specification and Verification of Neural Network Analyses" index=305>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/6 | 306/314) Neural Network-Based Piecewise Survival Models (Olov Holmer et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Neural Network-Based Piecewise Survival Models" index=306>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/6 | 307/314) Supervised Multiple Kernel Learning approaches for multi-omics data integration (Mitja Briscik et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Supervised Multiple Kernel Learning approaches for multi-omics data integration" index=307>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/6 | 308/314) Minimax Optimal Fair Classification with Bounded Demographic Disparity (Xianli Zeng et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Minimax Optimal Fair Classification with Bounded Demographic Disparity" index=308>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/6 | 309/314) SteinGen: Generating Fidelitous and Diverse Graph Samples (Gesine Reinert et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="SteinGen: Generating Fidelitous and Diverse Graph Samples" index=309>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/6 | 310/314) skscope: Fast Sparsity-Constrained Optimization in Python (Zezhi Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="skscope: Fast Sparsity-Constrained Optimization in Python" index=310>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (6/6 | 311/314) Clustering Change Sign Detection by Fusing Mixture Complexity (Kento Urano et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Clustering Change Sign Detection by Fusing Mixture Complexity" index=311>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 312/314) Stability Properties of the Impulsive Goodwin's Oscillator in 1-cycle (Anton V. Proskurnikov et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Stability Properties of the Impulsive Goodwin's Oscillator in 1-cycle" index=312>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 313/314) A census of graph-drawing algorithms based on generalized transversal structures (Olivier Bernardi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A census of graph-drawing algorithms based on generalized transversal structures" index=313>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 314/314) InstructBrush: Learning Attention-based Instruction Optimization for Image Editing (Ruoyu Zhao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="InstructBrush: Learning Attention-based Instruction Optimization for Image Editing" index=314>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
