...
### (1/18 | 1/114) Leveraging Zero-Shot Prompting for Efficient Language Model Distillation (Lukas Vöge et al., 2024)
...
### (2/18 | 2/114) EAGLE: A Domain Generalization Framework for AI-generated Text Detection (Amrita Bhattacharjee et al., 2024)
...
### (3/18 | 3/114) LlamBERT: Large-scale low-cost data annotation in NLP (Bálint Csanády et al., 2024)
...
### (4/18 | 4/114) LLMs Instruct LLMs:An Extraction and Editing Method (Xin Zhang et al., 2024)
...
### (5/18 | 5/114) EDDA: A Encoder-Decoder Data Augmentation Framework for Zero-Shot Stance Detection (Daijun Ding et al., 2024)
...
### (6/18 | 6/114) Towards a \textbf{RAG}-based Summarization Agent for the Electron-Ion Collider (Karthik Suresh et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Towards a \textbf{RAG}-based Summarization Agent for the Electron-Ion Collider" index=6>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15729v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15729v1.pdf" filename="2403.15729v1.pdf">Download PDF</button>
...
### (7/18 | 7/114) MRC-based Nested Medical NER with Co-prediction and Adaptive Pre-training (Xiaojing Du et al., 2024)
...
### (8/18 | 8/114) STEntConv: Predicting Disagreement with Stance Detection and a Signed Graph Convolutional Network (Isabelle Lorge et al., 2024)
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15885v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15885v1.pdf" filename="2403.15885v1.pdf">Download PDF</button>
...
### (9/18 | 9/114) VLUE: A New Benchmark and Multi-task Knowledge Transfer Learning for Vietnamese Natural Language Understanding (Phong Nguyen-Thuan Do et al., 2024)
...
### (10/18 | 10/114) Ghost Sentence: A Tool for Everyday Users to Copyright Data from Large Language Models (Shuai Zhao et al., 2024)
...
### (11/18 | 11/114) Few-shot Dialogue Strategy Learning for Motivational Interviewing via Inductive Reasoning (Zhouhang Xie et al., 2024)
...
### (12/18 | 12/114) Modeling Unified Semantic Discourse Structure for High-quality Headline Generation (Minghui Xu et al., 2024)
...
### (13/18 | 13/114) AI for Biomedicine in the Era of Large Language Models (Zhenyu Bi et al., 2024)
...
### (14/18 | 14/114) PEaCE: A Chemistry-Oriented Dataset for Optical Character Recognition on Scientific Documents (Nan Zhang et al., 2024)
...
### (15/18 | 15/114) Computational Sentence-level Metrics Predicting Human Sentence Comprehension (Kun Sun et al., 2024)
...
### (16/18 | 16/114) FEEL: A Framework for Evaluating Emotional Support Capability with Large Language Models (Huaiwen Zhang et al., 2024)
...
### (17/18 | 17/114) Geotokens and Geotransformers (Eren Unlu, 2024)
...
### (18/18 | 18/114) RAAMove: A Corpus for Analyzing Moves in Research Article Abstracts (Hongzheng Li et al., 2024)

{{<citation>}}

Hongzheng Li, Ruojin Wang, Ge Shi, Xing Lv, Lei Lei, Chong Feng, Fang Liu, Jinkun Lin, Yangguang Mei, Lingnan Xu. (2024)  
...
### (1/27 | 19/114) IllusionVQA: A Challenging Optical Illusion Dataset for Vision Language Models (Haz Sameen Shahgir et al., 2024)
...
### (2/27 | 20/114) Technical Report: Masked Skeleton Sequence Modeling for Learning Larval Zebrafish Behavior Latent Embeddings (Lanxin Xu et al., 2024)
...
### (3/27 | 21/114) Temporal-Spatial Object Relations Modeling for Vision-and-Language Navigation (Bowen Huang et al., 2024)
...
### (4/27 | 22/114) An Embarrassingly Simple Defense Against Backdoor Attacks On SSL (Aryan Satpathy et al., 2024)
...
### (5/27 | 23/114) VLM-CPL: Consensus Pseudo Labels from Vision-Language Models for Human Annotation-Free Pathological Image Classification (Lanfeng Zhong et al., 2024)
...
### (6/27 | 24/114) Deep Domain Adaptation: A Sim2Real Neural Approach for Improving Eye-Tracking Systems (Viet Dung Nguyen et al., 2024)
...
### (7/27 | 25/114) Once for Both: Single Stage of Importance and Sparsity Search for Vision Transformer Compression (Hancheng Ye et al., 2024)
...
### (8/27 | 26/114) In-Context Matting (He Guo et al., 2024)
...
### (9/27 | 27/114) iDAT: inverse Distillation Adapter-Tuning (Jiacheng Ruan et al., 2024)
...
### (10/27 | 28/114) Diffusion-based Aesthetic QR Code Generation via Scanning-Robust Perceptual Guidance (Jia-Wei Liao et al., 2024)
...
### (11/27 | 29/114) Towards Human-Like Machine Comprehension: Few-Shot Relational Learning in Visually-Rich Documents (Hao Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Towards Human-Like Machine Comprehension: Few-Shot Relational Learning in Visually-Rich Documents" index=29>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (12/27 | 30/114) X-Portrait: Expressive Portrait Animation with Hierarchical Motion Attention (You Xie et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="X-Portrait: Expressive Portrait Animation with Hierarchical Motion Attention" index=30>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15931v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15931v1.pdf" filename="2403.15931v1.pdf">Download PDF</button>
...
### (13/27 | 31/114) Time-series Initialization and Conditioning for Video-agnostic Stabilization of Video Super-Resolution using Recurrent Networks (Hiroshi Mori et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Time-series Initialization and Conditioning for Video-agnostic Stabilization of Video Super-Resolution using Recurrent Networks" index=31>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (14/27 | 32/114) Depth Estimation fusing Image and Radar Measurements with Uncertain Directions (Masaya Kotani et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Depth Estimation fusing Image and Radar Measurements with Uncertain Directions" index=32>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (15/27 | 33/114) Adversarial Defense Teacher for Cross-Domain Object Detection under Poor Visibility Conditions (Kaiwen Wang et al., 2024)

{{<citation>}}

Kaiwen Wang, Yinzhe Shen, Martin Lauer. (2024)  
**Adversarial Defense Teacher for Cross-Domain Object Detection under Poor Visibility Conditions**
<br/>
<button class="copy-to-clipboard" title="Adversarial Defense Teacher for Cross-Domain Object Detection under Poor Visibility Conditions" index=33>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (16/27 | 34/114) SceneX:Procedural Controllable Large-scale Scene Generation via Large-language Models (Mengqi Zhou et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="SceneX:Procedural Controllable Large-scale Scene Generation via Large-language Models" index=34>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (17/27 | 35/114) The Limits of Perception: Analyzing Inconsistencies in Saliency Maps in XAI (Anna Stubbin et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="The Limits of Perception: Analyzing Inconsistencies in Saliency Maps in XAI" index=35>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (18/27 | 36/114) What Do You See in Vehicle? Comprehensive Vision Solution for In-Vehicle Gaze Estimation (Yihua Cheng et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="What Do You See in Vehicle? Comprehensive Vision Solution for In-Vehicle Gaze Estimation" index=36>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (19/27 | 37/114) Spatio-Temporal Bi-directional Cross-frame Memory for Distractor Filtering Point Cloud Single Object Tracking (Shaoyu Sun et al., 2024)

{{<citation>}}

Shaoyu Sun, Chunyang Wang, Xuelian Liu, Chunhao Shi, Yueyang Ding, Guan Xi. (2024)  
**Spatio-Temporal Bi-directional Cross-frame Memory for Distractor Filtering Point Cloud Single Object Tracking**
<br/>
<button class="copy-to-clipboard" title="Spatio-Temporal Bi-directional Cross-frame Memory for Distractor Filtering Point Cloud Single Object Tracking" index=37>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15831v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15831v1.pdf" filename="2403.15831v1.pdf">Download PDF</button>
...
### (20/27 | 38/114) AOCIL: Exemplar-free Analytic Online Class Incremental Learning with Low Time and Resource Consumption (Huiping Zhuang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="AOCIL: Exemplar-free Analytic Online Class Incremental Learning with Low Time and Resource Consumption" index=38>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15751v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15751v1.pdf" filename="2403.15751v1.pdf">Download PDF</button>

---


**ABSTRACT**  
Online Class Incremental Learning (OCIL) aims to train the model in a task-by-task manner, where data arrive in mini-batches at a time while previous data are not accessible. A significant challenge is known as Catastrophic Forgetting, i.e., loss of the previous knowledge on old data. To address this, replay-based methods show competitive results but invade data privacy, while exemplar-free methods protect data privacy but struggle for accuracy. In this paper, we proposed an exemplar-free approach -- Analytic Online Class Incremental Learning (AOCIL). Instead of back-propagation, we design the Analytic Classifier (AC) updated by recursive least square, cooperating with a frozen backbone. AOCIL simultaneously achieves high accuracy, low resource consumption and data privacy protection. We conduct massive experiments on four existing <b>benchmark</b> datasets, and the results demonstrate the strong capability of handling OCIL scenarios. Codes will be ready.

{{</citation>}}


### (21/27 | 39/114) Feature Manipulation for DDPM based Change Detection (Zhenglin Li et al., 2024)

{{<citation>}}

Zhenglin Li, Yangchen Huang, Mengran Zhu, Jingyu Zhang, JingHao Chang, Houze Liu. (2024)  
**Feature Manipulation for DDPM based Change Detection**
<br/>
<button class="copy-to-clipboard" title="Feature Manipulation for DDPM based Change Detection" index=39>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15943v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15943v1.pdf" filename="2403.15943v1.pdf">Download PDF</button>
...
### (22/27 | 40/114) Centered Masking for Language-Image Pre-Training (Mingliang Liang et al., 2024)

{{<citation>}}

Mingliang Liang, Martha Larson. (2024)  
**Centered Masking for Language-Image Pre-Training**
<br/>
<button class="copy-to-clipboard" title="Centered Masking for Language-Image Pre-Training" index=40>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15837v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15837v1.pdf" filename="2403.15837v1.pdf">Download PDF</button>
...
### (23/27 | 41/114) Contact-aware Human Motion Generation from Textual Descriptions (Sihan Ma et al., 2024)

{{<citation>}}

Sihan Ma, Qiong Cao, Jing Zhang, Dacheng Tao. (2024)  
**Contact-aware Human Motion Generation from Textual Descriptions**
<br/>
<button class="copy-to-clipboard" title="Contact-aware Human Motion Generation from Textual Descriptions" index=41>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 10  
Keywords: GPT  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15709v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15709v1.pdf" filename="2403.15709v1.pdf">Download PDF</button>
...
### (24/27 | 42/114) An active learning model to classify animal species in Hong Kong (Gareth Lamb et al., 2024)

{{<citation>}}

Gareth Lamb, Ching Hei Lo, Jin Wu, Calvin K. F. Lee. (2024)  
**An active learning model to classify animal species in Hong Kong**
<br/>
<button class="copy-to-clipboard" title="An active learning model to classify animal species in Hong Kong" index=42>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15675v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15675v1.pdf" filename="2403.15675v1.pdf">Download PDF</button>

---


**ABSTRACT**  
Camera traps are used by ecologists globally as an efficient and non-invasive method to monitor animals. While it is time-consuming to manually label the collected images, recent advances in deep learning and computer vision has made it possible to automating this process [1]. A major obstacle to this is the generalisability of these models when applying these images to independently collected data from other parts of the world [2]. Here, we use a deep <b>active</b> <b>learning</b> workflow [3], and train a model that is applicable to camera trap images collected in Hong Kong.

{{</citation>}}


### (25/27 | 43/114) MapTracker: Tracking with Strided Memory Fusion for Consistent Vector HD Mapping (Jiacheng Chen et al., 2024)

{{<citation>}}

Jiacheng Chen, Yuefan Wu, Jiaqi Tan, Hang Ma, Yasutaka Furukawa. (2024)  
**MapTracker: Tracking with Strided Memory Fusion for Consistent Vector HD Mapping**
<br/>
<button class="copy-to-clipboard" title="MapTracker: Tracking with Strided Memory Fusion for Consistent Vector HD Mapping" index=43>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15951v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15951v1.pdf" filename="2403.15951v1.pdf">Download PDF</button>
...
### (26/27 | 44/114) Finding needles in a haystack: A Black-Box Approach to Invisible Watermark Detection (Minzhou Pan et al., 2024)

{{<citation>}}

Minzhou Pan, Zhengting Wang, Xin Dong, Vikash Sehwag, Lingjuan Lyu, Xue Lin. (2024)  
**Finding needles in a haystack: A Black-Box Approach to Invisible Watermark Detection**
<br/>
<button class="copy-to-clipboard" title="Finding needles in a haystack: A Black-Box Approach to Invisible Watermark Detection" index=44>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15712v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15712v1.pdf" filename="2403.15712v1.pdf">Download PDF</button>
...
### (1/3 | 46/114) When LLM-based Code Generation Meets the Software Development Process (Feng Lin et al., 2024)

{{<citation>}}

Feng Lin, Dong Jae Kim, Tse-Husn, Chen. (2024)  
**When LLM-based Code Generation Meets the Software Development Process**
<br/>
<button class="copy-to-clipboard" title="When LLM-based Code Generation Meets the Software Development Process" index=46>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15852v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15852v1.pdf" filename="2403.15852v1.pdf">Download PDF</button>
...
### (2/3 | 47/114) CodeShell Technical Report (Rui Xie et al., 2024)

{{<citation>}}

Rui Xie, Zhengran Zeng, Zhuohao Yu, Chang Gao, Shikun Zhang, Wei Ye. (2024)  
**CodeShell Technical Report**
<br/>
<button class="copy-to-clipboard" title="CodeShell Technical Report" index=47>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/3 | 49/114) Graph Image Prior for Unsupervised Dynamic MRI Reconstruction (Zhongsen Li et al., 2024)

{{<citation>}}

Zhongsen Li, Wenxuan Chen, Shuai Wang, Chuyu Liu, Rui Li. (2024)  
**Graph Image Prior for Unsupervised Dynamic MRI Reconstruction**
<br/>
<button class="copy-to-clipboard" title="Graph Image Prior for Unsupervised Dynamic MRI Reconstruction" index=49>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 73  
Keywords: Graph Convolutional Network, Graph, Convolution, Convolutional Neural Network, Convolutional Neural Network, Convolutional Neural Network, Supervised Learning, Unsupervised Learning  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15770v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15770v1.pdf" filename="2403.15770v1.pdf">Download PDF</button>
...
### (2/3 | 50/114) An edge detection-based deep learning approach for tear meniscus height measurement (Kesheng Wang et al., 2024)

{{<citation>}}

Kesheng Wang, Kunhui Xu, Xiaoyu Chen, Chunlei He, Jianfeng Zhang, Dexing Kong, Qi Dai, Shoujun Huang. (2024)  
**An edge detection-based deep learning approach for tear meniscus height measurement**
<br/>
<button class="copy-to-clipboard" title="An edge detection-based deep learning approach for tear meniscus height measurement" index=50>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 20  
Keywords: Convolution, Convolutional Neural Network  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15853v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15853v1.pdf" filename="2403.15853v1.pdf">Download PDF</button>
...
### (3/3 | 51/114) 3D-TransUNet for Brain Metastases Segmentation in the BraTS2023 Challenge (Siwei Yang et al., 2024)

{{<citation>}}

Siwei Yang, Xianhang Li, Jieru Mei, Jieneng Chen, Cihang Xie, Yuyin Zhou. (2024)  
**3D-TransUNet for Brain Metastases Segmentation in the BraTS2023 Challenge**
<br/>
<button class="copy-to-clipboard" title="3D-TransUNet for Brain Metastases Segmentation in the BraTS2023 Challenge" index=51>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/10 | 52/114) Using Large Language Models for OntoClean-based Ontology Refinement (Yihang Zhao et al., 2024)

{{<citation>}}

Yihang Zhao, Neil Vetter, Kaveh Aryan. (2024)  
**Using Large Language Models for OntoClean-based Ontology Refinement**
<br/>
<button class="copy-to-clipboard" title="Using Large Language Models for OntoClean-based Ontology Refinement" index=52>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 70  
Keywords: GPT, GPT-3, GPT-3.5, GPT-4, Large Language Model, Large Language Model, Prompt  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15864v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15864v1.pdf" filename="2403.15864v1.pdf">Download PDF</button>

---


**ABSTRACT**  
This paper explores the integration of <b>Large</b> <b>Language</b> <b>Models</b> <b>(LLMs)</b> such as <b>GPT-3.5</b> and <b>GPT-4</b> into the ontology refinement process, specifically focusing on the OntoClean methodology. OntoClean, critical for assessing the metaphysical quality of ontologies, involves a two-step process of assigning meta-properties to classes and verifying a set of constraints. Manually conducting the first step proves difficult in practice, due to the need for philosophical expertise and lack of consensus among ontologists. By employing <b>LLMs</b> with two <b>prompting</b> strategies, the study demonstrates that high accuracy in the labelling process can be achieved. The findings suggest the potential for <b>LLMs</b> to enhance ontology refinement, proposing the development of plugin software for ontology tools to facilitate this integration.

{{</citation>}}


### (2/10 | 53/114) LAMPER: LanguAge Model and Prompt EngineeRing for zero-shot time series classification (Zhicheng Du et al., 2024)

{{<citation>}}

Zhicheng Du, Zhaotian Xie, Yan Tong, Peiwu Qin. (2024)  
**LAMPER: LanguAge Model and Prompt EngineeRing for zero-shot time series classification**
<br/>
<button class="copy-to-clipboard" title="LAMPER: LanguAge Model and Prompt EngineeRing for zero-shot time series classification" index=53>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 40  
Keywords: Zero-shot, Pre-trained Language Model, Pre-trained Language Model, Prompt  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15875v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15875v1.pdf" filename="2403.15875v1.pdf">Download PDF</button>
...
### (3/10 | 54/114) The Frontier of Data Erasure: Machine Unlearning for Large Language Models (Youyang Qu et al., 2024)

{{<citation>}}

Youyang Qu, Ming Ding, Nan Sun, Kanchana Thilakarathna, Tianqing Zhu, Dusit Niyato. (2024)  
**The Frontier of Data Erasure: Machine Unlearning for Large Language Models**
<br/>
<button class="copy-to-clipboard" title="The Frontier of Data Erasure: Machine Unlearning for Large Language Models" index=54>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<br/>
<button class="copy-to-clipboard" title="An Upload-Efficient Scheme for Transferring Knowledge From a Server-Side Pre-trained Generator to Clients in Heterogeneous Federated Learning" index=55>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 40  
Keywords: Convolutional Neural Network, Federated Learning, Knowledge Transfer, Supervised Learning  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15760v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15760v1.pdf" filename="2403.15760v1.pdf">Download PDF</button>

---


**ABSTRACT**  
Heterogeneous <b>Federated</b> <b>Learning</b> (HtFL) enables collaborative learning on multiple clients with different model architectures while preserving privacy. Despite recent research progress, <b>knowledge</b> <b>sharing</b> in HtFL is still difficult due to data and model heterogeneity. To tackle this issue, we leverage the <b>knowledge</b> <b>stored</b> in pre-trained generators and propose a new upload-efficient <b>knowledge</b> <b>transfer</b> scheme called <b>Federated</b> <b>Knowledge-Transfer</b> <b>Loop</b> (FedKTL). Our FedKTL can produce client-task-related prototypical image-vector pairs via the generator's inference on the server. With these pairs, each client can transfer pre-existing <b>knowledge</b> <b>from</b> the generator to its local model through an additional <b>supervised</b> local task. We conduct extensive experiments on four datasets under two types of data heterogeneity with 14 kinds of models including <b>CNNs</b> and ViTs. Results show that our upload-efficient FedKTL surpasses seven state-of-the-art methods by up to 7.31% in accuracy. Moreover, our <b>knowledge</b> <b>transfer</b> scheme is applicable in scenarios with only one edge client. Code: https://github.com/TsingZ0/FedKTL

{{</citation>}}


### (5/10 | 56/114) MixRED: A Mix-lingual Relation Extraction Dataset (Lingxing Kong et al., 2024)

{{<citation>}}

Lingxing Kong, Yougang Chu, Zheng Ma, Jianbing Zhang, Liang He, Jiajun Chen. (2024)  
**MixRED: A Mix-lingual Relation Extraction Dataset**
<br/>
<button class="copy-to-clipboard" title="MixRED: A Mix-lingual Relation Extraction Dataset" index=56>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Categories: cs-AI, cs-CL, cs.AI  
Keyword Score: 40  
Keywords: Supervised Learning, Relation Extraction, Large Language Model, Large Language Model  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15696v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15696v1.pdf" filename="2403.15696v1.pdf">Download PDF</button>
...
### (6/10 | 57/114) TrustSQL: A Reliability Benchmark for Text-to-SQL Models with Diverse Unanswerable Questions (Gyubok Lee et al., 2024)

{{<citation>}}

Gyubok Lee, Woosog Chay, Seonhee Cho, Edward Choi. (2024)  
**TrustSQL: A Reliability Benchmark for Text-to-SQL Models with Diverse Unanswerable Questions**
<br/>
<button class="copy-to-clipboard" title="TrustSQL: A Reliability Benchmark for Text-to-SQL Models with Diverse Unanswerable Questions" index=57>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Categories: cs-AI, cs.AI  
Keyword Score: 33  
Keywords: Benchmarking, Text2SQL, Large Language Model, Large Language Model  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15879v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15879v1.pdf" filename="2403.15879v1.pdf">Download PDF</button>
...
### (7/10 | 58/114) MatchSeg: Towards Better Segmentation via Reference Image Matching (Ruiqiang Xiao et al., 2024)

{{<citation>}}

Ruiqiang Xiao, Jiayu Huo, Haotian Zheng, Yang Liu, Sebastien Ourselin, Rachel Sparks. (2024)  
**MatchSeg: Towards Better Segmentation via Reference Image Matching**
<br/>
<button class="copy-to-clipboard" title="MatchSeg: Towards Better Segmentation via Reference Image Matching" index=58>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 30  
Keywords: Few-shot, Few-shot Learning, Knowledge Transfer  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15901v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15901v1.pdf" filename="2403.15901v1.pdf">Download PDF</button>
...
### (8/10 | 59/114) Multi-agent transformer-accelerated RL for satisfaction of STL specifications (Albin Larsson Forsberg et al., 2024)

{{<citation>}}

Albin Larsson Forsberg, Alexandros Nikou, Aneta Vulgarakis Feljan, Jana Tumova. (2024)  
**Multi-agent transformer-accelerated RL for satisfaction of STL specifications**
<br/>
<button class="copy-to-clipboard" title="Multi-agent transformer-accelerated RL for satisfaction of STL specifications" index=59>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15916v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15916v1.pdf" filename="2403.15916v1.pdf">Download PDF</button>
...
### (9/10 | 60/114) SAT Encoding of Partial Ordering Models for Graph Coloring Problems (Daniel Faber et al., 2024)

{{<citation>}}

Daniel Faber, Adalat Jabrayilov, Petra Mutzel. (2024)  
**SAT Encoding of Partial Ordering Models for Graph Coloring Problems**
<br/>
<button class="copy-to-clipboard" title="SAT Encoding of Partial Ordering Models for Graph Coloring Problems" index=60>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<br/>
<button class="copy-to-clipboard" title="Understanding Domain-Size Generalization in Markov Logic Networks" index=61>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 3  
Keywords: Graph  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15933v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15933v1.pdf" filename="2403.15933v1.pdf">Download PDF</button>
...
### (1/7 | 62/114) Explore until Confident: Efficient Exploration for Embodied Question Answering (Allen Z. Ren et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Explore until Confident: Efficient Exploration for Embodied Question Answering" index=62>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 60  
Keywords: Simulation, Simulator, Question Answering, Reasoning, Prompt, Vision-and-Language  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15941v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15941v1.pdf" filename="2403.15941v1.pdf">Download PDF</button>

---


**ABSTRACT**  
We consider the problem of Embodied <b>Question</b> <b>Answering</b> (EQA), which refers to settings where an embodied agent such as a robot needs to actively explore an environment to gather information until it is confident about the answer to a <b>question.</b> <b>In</b> this work, we leverage the strong semantic <b>reasoning</b> capabilities of large <b>vision-language</b> models (VLMs) to efficiently explore and answer such <b>questions.</b> <b>However,</b> there are two main challenges when using VLMs in EQA: they do not have an internal memory for mapping the scene to be able to plan how to explore over time, and their confidence can be miscalibrated and can cause the robot to prematurely stop exploration or over-explore. We propose a method that first builds a semantic map of the scene based on depth information and via visual <b>prompting</b> of a VLM - leveraging its vast knowledge of relevant regions of the scene for exploration. Next, we use conformal prediction to calibrate the VLM's <b>question</b> <b>answering</b> confidence, allowing the robot to know when to stop exploration - leading to a more calibrated and efficient exploration strategy. To test our framework in <b>simulation,</b> we also contribute a new EQA dataset with diverse, realistic human-robot scenarios and scenes built upon the Habitat-Matterport 3D Research Dataset (HM3D). Both simulated and real robot experiments show our proposed approach improves the performance and efficiency over baselines that do no leverage VLM for exploration or do not calibrate its confidence. Webpage with experiment videos and code: https://explore-eqa.github.io/

{{</citation>}}


### (2/7 | 63/114) iA$^*$: Imperative Learning-based A$^*$ Search for Pathfinding (Xiangyu Chen et al., 2024)

{{<citation>}}

Xiangyu Chen, Fan Yang, Chen Wang. (2024)  
**iA$^*$: Imperative Learning-based A$^*$ Search for Pathfinding**
<br/>
<button class="copy-to-clipboard" title="iA$^*$: Imperative Learning-based A$^*$ Search for Pathfinding" index=63>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15791v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15791v1.pdf" filename="2403.15791v1.pdf">Download PDF</button>
...
### (5/7 | 66/114) Distributed Robust Learning based Formation Control of Mobile Robots based on Bioinspired Neural Dynamics (Zhe Xu et al., 2024)

{{<citation>}}

Zhe Xu, Tao Yan, Simon X. Yang, S. Andrew Gadsden, Mohammad Biglarbegian. (2024)  
**Distributed Robust Learning based Formation Control of Mobile Robots based on Bioinspired Neural Dynamics**
<br/>
<button class="copy-to-clipboard" title="Distributed Robust Learning based Formation Control of Mobile Robots based on Bioinspired Neural Dynamics" index=66>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 20  
Keywords: Simulation, Simulator  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15716v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15716v1.pdf" filename="2403.15716v1.pdf">Download PDF</button>
...
### (6/7 | 67/114) Data-Driven Predictive Control for Robust Exoskeleton Locomotion (Kejun Li et al., 2024)

{{<citation>}}

Kejun Li, Jeeseop Kim, Xiaobin Xiong, Kaveh Akbari Hamed, Yisong Yue, Aaron D. Ames. (2024)  
**Data-Driven Predictive Control for Robust Exoskeleton Locomotion**
<br/>
<button class="copy-to-clipboard" title="Data-Driven Predictive Control for Robust Exoskeleton Locomotion" index=67>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 20  
Keywords: Simulation, Simulator  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15658v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15658v1.pdf" filename="2403.15658v1.pdf">Download PDF</button>
...
### (7/7 | 68/114) Risk-Calibrated Human-Robot Interaction via Set-Valued Intent Prediction (Justin Lidard et al., 2024)

{{<citation>}}

Justin Lidard, Hang Pham, Ariel Bachman, Bryan Boateng, Anirudha Majumdar. (2024)  
**Risk-Calibrated Human-Robot Interaction via Set-Valued Intent Prediction**
<br/>
<button class="copy-to-clipboard" title="Risk-Calibrated Human-Robot Interaction via Set-Valued Intent Prediction" index=68>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 10  
Keywords: Zero-shot  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15959v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15959v1.pdf" filename="2403.15959v1.pdf">Download PDF</button>
...
### (1/2 | 69/114) Spatio-Temporal Graph Convolutional Network Combined Large Language Model: A Deep Learning Framework for Bike Demand Forecasting (Peisen Li et al., 2024)

{{<citation>}}

Peisen Li, Yizhe Pang, Junyu Ren. (2024)  
...
<br/>
<button class="copy-to-clipboard" title="Spatio-Temporal Graph Convolutional Network Combined Large Language Model: A Deep Learning Framework for Bike Demand Forecasting" index=69>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 53  
Keywords: Graph Convolutional Network, Graph, Convolution, Convolutional Neural Network, Large Language Model, Large Language Model  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15733v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15733v1.pdf" filename="2403.15733v1.pdf">Download PDF</button>

---


**ABSTRACT**  
This study presents a new deep learning framework, combining Spatio-Temporal <b>Graph</b> <b>Convolutional</b> <b>Network</b> (STGCN) with a <b>Large</b> <b>Language</b> <b>Model</b> <b>(LLM),</b> for bike demand forecasting. Addressing challenges in transforming discrete datasets and integrating unstructured language data, the framework leverages <b>LLMs</b> to extract insights from Points of Interest (POI) text data. The proposed STGCN-L model demonstrates competitive performance compared to existing models, showcasing its potential in predicting bike demand. Experiments using Philadelphia datasets highlight the effectiveness of the hybrid model, emphasizing the need for further exploration and enhancements, such as incorporating additional features like weather data for improved accuracy.

{{</citation>}}


### (2/2 | 70/114) Model, Analyze, and Comprehend User Interactions and Various Attributes within a Social Media Platform (Md Kaykobad Reza et al., 2024)

{{<citation>}}

Md Kaykobad Reza, S M Maksudul Alam, Yiran Luo, Youzhe Liu. (2024)  
**Model, Analyze, and Comprehend User Interactions and Various Attributes within a Social Media Platform**
<br/>
<button class="copy-to-clipboard" title="Model, Analyze, and Comprehend User Interactions and Various Attributes within a Social Media Platform" index=70>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 3  
Keywords: Graph  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15937v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15937v1.pdf" filename="2403.15937v1.pdf">Download PDF</button>
...
### (1/13 | 71/114) Safe Reinforcement Learning for Constrained Markov Decision Processes with Stochastic Stopping Time (Abhijit Mazumdar et al., 2024)

{{<citation>}}

Abhijit Mazumdar, Rafal Wisniewski, Manuela L. Bujorianu. (2024)  
**Safe Reinforcement Learning for Constrained Markov Decision Processes with Stochastic Stopping Time**
<br/>
<button class="copy-to-clipboard" title="Safe Reinforcement Learning for Constrained Markov Decision Processes with Stochastic Stopping Time" index=71>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 40  
Keywords: Autoencoder, Self-supervised Learning, Self-supervised Learning, Variational Autoencoder  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15790v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15790v1.pdf" filename="2403.15790v1.pdf">Download PDF</button>
...
### (4/13 | 74/114) Role of Locality and Weight Sharing in Image-Based Tasks: A Sample Complexity Separation between CNNs, LCNs, and FCNs (Aakash Lahoti et al., 2024)

{{<citation>}}

Aakash Lahoti, Stefani Karp, Ezra Winston, Aarti Singh, Yuanzhi Li. (2024)  
**Role of Locality and Weight Sharing in Image-Based Tasks: A Sample Complexity Separation between CNNs, LCNs, and FCNs**
<br/>
<button class="copy-to-clipboard" title="Role of Locality and Weight Sharing in Image-Based Tasks: A Sample Complexity Separation between CNNs, LCNs, and FCNs" index=74>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 40  
Keywords: Convolution, Convolutional Neural Network, Convolutional Neural Network, Knowledge Distillation  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15707v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15707v1.pdf" filename="2403.15707v1.pdf">Download PDF</button>
...
### (5/13 | 75/114) Deep Gaussian Covariance Network with Trajectory Sampling for Data-Efficient Policy Search (Can Bogoclu et al., 2024)

{{<citation>}}

Can Bogoclu, Robert Vosshall, Kevin Cremanns, Dirk Roos. (2024)  
**Deep Gaussian Covariance Network with Trajectory Sampling for Data-Efficient Policy Search**
<br/>
<button class="copy-to-clipboard" title="Deep Gaussian Covariance Network with Trajectory Sampling for Data-Efficient Policy Search" index=75>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15744v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15744v1.pdf" filename="2403.15744v1.pdf">Download PDF</button>
...
### (9/13 | 79/114) Identifiable Latent Neural Causal Models (Yuhang Liu et al., 2024)

{{<citation>}}

Yuhang Liu, Zhen Zhang, Dong Gong, Mingming Gong, Biwei Huang, Anton van den Hengel, Kun Zhang, Javen Qinfeng Shi. (2024)  
**Identifiable Latent Neural Causal Models**
<br/>
<button class="copy-to-clipboard" title="Identifiable Latent Neural Causal Models" index=79>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 15  
Keywords: Distribution Shift, Distribution Shift, Representation Learning  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15711v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15711v1.pdf" filename="2403.15711v1.pdf">Download PDF</button>
...
### (10/13 | 80/114) Sample and Communication Efficient Fully Decentralized MARL Policy Evaluation via a New Approach: Local TD update (Fnu Hairi et al., 2024)

{{<citation>}}

Fnu Hairi, Zifan Zhang, Jia Liu. (2024)  
**Sample and Communication Efficient Fully Decentralized MARL Policy Evaluation via a New Approach: Local TD update**
<br/>
<button class="copy-to-clipboard" title="Sample and Communication Efficient Fully Decentralized MARL Policy Evaluation via a New Approach: Local TD update" index=80>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
---
Primary Category: cs.LG  
Categories: cs-AI, cs-DC, cs-LG, cs.LG, physics-soc-ph  
Keyword Score: 10  
Keywords: Federated Learning  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15855v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15855v1.pdf" filename="2403.15855v1.pdf">Download PDF</button>
...
### (12/13 | 82/114) Convection-Diffusion Equation: A Theoretically Certified Framework for Neural Networks (Tangjun Wang et al., 2024)

{{<citation>}}

Tangjun Wang, Chenglong Bao, Zuoqiang Shi. (2024)  
**Convection-Diffusion Equation: A Theoretically Certified Framework for Neural Networks**
<br/>
<button class="copy-to-clipboard" title="Convection-Diffusion Equation: A Theoretically Certified Framework for Neural Networks" index=82>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15726v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15726v1.pdf" filename="2403.15726v1.pdf">Download PDF</button>

---


**ABSTRACT**  
In this paper, we study the partial differential equation models of neural networks. Neural network can be viewed as a map from a simple base model to a complicate function. Based on solid analysis, we show that this map can be formulated by a convection-diffusion equation. This theoretically certified framework gives mathematical foundation and more understanding of neural networks. Moreover, based on the convection-diffusion equation model, we design a novel network structure, which incorporates diffusion mechanism into network architecture. Extensive experiments on both <b>benchmark</b> datasets and real-world applications validate the performance of the proposed model.

{{</citation>}}


### (13/13 | 83/114) G-ACIL: Analytic Learning for Exemplar-Free Generalized Class Incremental Learning (Huiping Zhuang et al., 2024)

{{<citation>}}

Huiping Zhuang, Yizhu Chen, Di Fang, Run He, Kai Tong, Hongxin Wei, Ziqian Zeng, Cen Chen. (2024)  
**G-ACIL: Analytic Learning for Exemplar-Free Generalized Class Incremental Learning**
<br/>
<button class="copy-to-clipboard" title="G-ACIL: Analytic Learning for Exemplar-Free Generalized Class Incremental Learning" index=83>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15706v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15706v1.pdf" filename="2403.15706v1.pdf">Download PDF</button>
...
### (1/10 | 84/114) Scaling Learning based Policy Optimization for Temporal Tasks via Dropout (Navid Hashemi et al., 2024)

{{<citation>}}

Navid Hashemi, Bardh Hoxha, Danil Prokhorov, Georgios Fainekos, Jyotirmoy Deshmukh. (2024)  
**Scaling Learning based Policy Optimization for Temporal Tasks via Dropout**
<br/>
<button class="copy-to-clipboard" title="Scaling Learning based Policy Optimization for Temporal Tasks via Dropout" index=84>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15700v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15700v1.pdf" filename="2403.15700v1.pdf">Download PDF</button>

---


**ABSTRACT**  
Energy load balancing is an essential issue in designing wireless sensor networks (WSNs). <b>Clustering</b> techniques are utilized as energy-efficient methods to balance the network energy and prolong its lifetime. In this paper, we propose an improved soft-k-means (IS-k-means) <b>clustering</b> algorithm to balance the energy consumption of nodes in WSNs. First, we use the idea of ``clustering by fast search and find of density peaks'' (CFSFDP) and kernel density estimation (KDE) to improve the selection of the initial cluster centers of the soft k-means <b>clustering</b> algorithm. Then, we utilize the flexibility of the soft-k-means and reassign member nodes considering their membership probabilities at the boundary of clusters to balance the number of nodes per cluster. Furthermore, the concept of multi-cluster heads is employed to balance the energy consumption within clusters. {Extensive <b>simulation</b> results under different network scenarios demonstrate that for small-scale WSNs with single-hop transmission}, the proposed algorithm can postpone the first node death, the half of nodes death, and the last node death on average when compared to various <b>clustering</b> algorithms from the literature.

{{</citation>}}


### (4/10 | 87/114) From Raw Data to Safety: Reducing Conservatism by Set Expansion (Mohammad Bajelani et al., 2024)

{{<citation>}}

Mohammad Bajelani, Klaske van Heusden. (2024)  
**From Raw Data to Safety: Reducing Conservatism by Set Expansion**
<br/>
<button class="copy-to-clipboard" title="From Raw Data to Safety: Reducing Conservatism by Set Expansion" index=87>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 20  
Keywords: Simulation, Simulator  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15883v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15883v1.pdf" filename="2403.15883v1.pdf">Download PDF</button>
...
### (5/10 | 88/114) A Modular Safety Filter for Safety-Certified Cyber-Physical Systems (Mohammad Bajelani et al., 2024)

{{<citation>}}

Mohammad Bajelani, Walter Lucia, Klaske van Heusden. (2024)  
**A Modular Safety Filter for Safety-Certified Cyber-Physical Systems**
<br/>
<button class="copy-to-clipboard" title="A Modular Safety Filter for Safety-Certified Cyber-Physical Systems" index=88>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 20  
Keywords: Simulation, Simulator  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15854v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15854v1.pdf" filename="2403.15854v1.pdf">Download PDF</button>
...
### (6/10 | 89/114) TJCCT: A Two-timescale Approach for UAV-assisted Mobile Edge Computing (Zemin Sun et al., 2024)

{{<citation>}}

Zemin Sun, Geng Sun, Qingqing Wu, Long He, Shuang Liang, Hongyang Pan, Dusit Niyato, Chau Yuen, Victor C. M. Leung. (2024)  
**TJCCT: A Two-timescale Approach for UAV-assisted Mobile Edge Computing**
<br/>
<button class="copy-to-clipboard" title="TJCCT: A Two-timescale Approach for UAV-assisted Mobile Edge Computing" index=89>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
---
Primary Category: eess.SY  
Categories: 93C25, cs-SY, eess-SY, eess.SY, math-OC  
Keyword Score: 20  
Keywords: Simulation, Simulator  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15702v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15702v1.pdf" filename="2403.15702v1.pdf">Download PDF</button>

---


**ABSTRACT**  
We consider the problem of optimal swarm tracking which can be formulated as a tracking problem for distributions in the Wasserstein metric. Optimal control solutions to this problem are non-causal and require knowing the time-trajectory of the distribution to be tracked in advance. We propose a scheme where these non-causal solutions can be used together with a predictive model for the reference to achieve causal tracking control of a priori-unknown references. We develop the resulting model-predictive control scheme in the simple case where the reference is predicted to be constant-in-time. A computational algorithm based on particle methods and discrete optimal mass transport is presented, and numerical <b>simulations</b> are provided for various classes of reference signals. The results demonstrate that the proposed control algorithm achieves reasonable performance even when using simple predictive models.

{{</citation>}}


### (9/10 | 92/114) Real-Time Reconfiguration and Connectivity Maintenance for AUVs Network Under External Disturbances using Distributed Nonlinear Model Predictive Control (Nhat Minh Nguyen et al., 2024)

{{<citation>}}

Nhat Minh Nguyen, Stephen McIlvanna, Jack Close, Mien Van. (2024)  
...
<br/>
<button class="copy-to-clipboard" title="Real-Time Reconfiguration and Connectivity Maintenance for AUVs Network Under External Disturbances using Distributed Nonlinear Model Predictive Control" index=92>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 20  
Keywords: Simulation, Simulator  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15671v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15671v1.pdf" filename="2403.15671v1.pdf">Download PDF</button>
...
### (10/10 | 93/114) Safe and Stable Formation Control with Distributed Multi-Agents Using Adaptive Control and Control Barrier Functions (Jose A. Solano-Castellanos et al., 2024)

{{<citation>}}

Jose A. Solano-Castellanos, Anuradha Annaswamy. (2024)  
**Safe and Stable Formation Control with Distributed Multi-Agents Using Adaptive Control and Control Barrier Functions**
<br/>
<button class="copy-to-clipboard" title="Safe and Stable Formation Control with Distributed Multi-Agents Using Adaptive Control and Control Barrier Functions" index=93>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 3  
Keywords: Graph  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15674v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15674v1.pdf" filename="2403.15674v1.pdf">Download PDF</button>
...
### (1/4 | 94/114) Energy Efficient Design of Active STAR-RIS-Aided SWIPT Systems (Sajad Faramarzi et al., 2024)

{{<citation>}}

Sajad Faramarzi, Hosein Zarini, Sepideh Javadi, Mohammad Robat Mili, Rui Zhang, George K. Karagiannidis, Naofal Al-Dhahir. (2024)  
**Energy Efficient Design of Active STAR-RIS-Aided SWIPT Systems**
<br/>
<button class="copy-to-clipboard" title="Energy Efficient Design of Active STAR-RIS-Aided SWIPT Systems" index=94>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<br/>
<button class="copy-to-clipboard" title="Block Orthogonal Sparse Superposition Codes for $ \sf{L}^3 $ Communications: Low Error Rate, Low Latency, and Low Power Consumption" index=95>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 98/114) Negotiating the Shared Agency between Humans & AI in the Recommender System (Mengke Wu et al., 2024)

{{<citation>}}

Mengke Wu, Weizi Liu, Yanyun, Wang, Mike Zhengyu Yao. (2024)  
**Negotiating the Shared Agency between Humans & AI in the Recommender System**
<br/>
<button class="copy-to-clipboard" title="Negotiating the Shared Agency between Humans & AI in the Recommender System" index=98>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 30  
Keywords: Explainable AI, Recommendation, Recommender System  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15919v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15919v1.pdf" filename="2403.15919v1.pdf">Download PDF</button>
...
### (1/1 | 99/114) A hybrid LLM workflow can help identify user privilege related variables in programs of any size (Haizhou Wang et al., 2024)

{{<citation>}}

Haizhou Wang, Zhilong Wang, Peng Liu. (2024)  
**A hybrid LLM workflow can help identify user privilege related variables in programs of any size**
<br/>
<button class="copy-to-clipboard" title="A hybrid LLM workflow can help identify user privilege related variables in programs of any size" index=99>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15723v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15723v1.pdf" filename="2403.15723v1.pdf">Download PDF</button>
...
### (1/2 | 100/114) Optimized Model Selection for Estimating Treatment Effects from Costly Simulations of the US Opioid Epidemic (Abdulrahman A. Ahmed et al., 2024)

{{<citation>}}

Abdulrahman A. Ahmed, M. Amin Rahimian, Mark S. Roberts. (2024)  
**Optimized Model Selection for Estimating Treatment Effects from Costly Simulations of the US Opioid Epidemic**
<br/>
<button class="copy-to-clipboard" title="Optimized Model Selection for Estimating Treatment Effects from Costly Simulations of the US Opioid Epidemic" index=100>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Categories: cs-MA, cs-SI, stat-AP, stat-ME, stat.ME  
Keyword Score: 23  
Keywords: Sample Size, Simulation, Simulator  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15755v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15755v1.pdf" filename="2403.15755v1.pdf">Download PDF</button>
...
### (2/2 | 101/114) Supervised Learning via Ensembles of Diverse Functional Representations: the Functional Voting Classifier (Donato Riccio et al., 2024)

{{<citation>}}

Donato Riccio, Fabrizio Maturo, Elvira Romano. (2024)  
**Supervised Learning via Ensembles of Diverse Functional Representations: the Functional Voting Classifier**
<br/>
<button class="copy-to-clipboard" title="Supervised Learning via Ensembles of Diverse Functional Representations: the Functional Voting Classifier" index=101>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
---
Primary Category: stat.ME  
Categories: 46N30, 62-08, cs-LG, stat-ME, stat-ML, stat.ME  
Keyword Score: 20  
Keywords: Supervised Learning, Supervised Learning  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15778v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15778v1.pdf" filename="2403.15778v1.pdf">Download PDF</button>
...
### (1/3 | 102/114) LOAM: Low-latency Communication, Caching, and Computation Placement in Data-Intensive Computing Networks (Jinkun Zhang et al., 2024)

{{<citation>}}

Jinkun Zhang, Edmund Yeh. (2024)  
**LOAM: Low-latency Communication, Caching, and Computation Placement in Data-Intensive Computing Networks**
<br/>
<button class="copy-to-clipboard" title="LOAM: Low-latency Communication, Caching, and Computation Placement in Data-Intensive Computing Networks" index=102>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 20  
Keywords: Simulation, Simulator  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15927v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15927v1.pdf" filename="2403.15927v1.pdf">Download PDF</button>

---


**ABSTRACT**  
Deploying data- and computation-intensive applications such as large-scale AI into heterogeneous dispersed computing networks can significantly enhance application performance by mitigating bottlenecks caused by limited network resources, including bandwidth, storage, and computing power. However, current resource allocation methods in dispersed computing do not provide a comprehensive solution that considers arbitrary topology, elastic resource amount, reuse of computation results, and nonlinear congestion-dependent optimization objectives. In this paper, we propose LOAM, a low-latency joint communication, caching, and computation placement framework with a rigorous analytical foundation that incorporates the above aspects. We tackle the NP-hard aggregated cost minimization problem with two methods: an offline method with a 1/2 approximation and an online adaptive method with a bounded gap from the optimum. Through extensive <b>simulation,</b> the proposed framework outperforms multiple baselines in both synthesis and real-world network scenarios.

{{</citation>}}


### (2/3 | 103/114) A Novel Non-Terrestrial Networks Architecture: All Optical LEO Constellations with High-Altitude Ground Stations (Pablo G. Madoery et al., 2024)

{{<citation>}}

Pablo G. Madoery, Juan A. Fraire, Jorge M. Finochietto, Halim Yanikomeroglu, Gunes Karabulut Kurt. (2024)  
**A Novel Non-Terrestrial Networks Architecture: All Optical LEO Constellations with High-Altitude Ground Stations**
<br/>
<button class="copy-to-clipboard" title="A Novel Non-Terrestrial Networks Architecture: All Optical LEO Constellations with High-Altitude Ground Stations" index=103>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 20  
Keywords: Simulation, Simulator  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15659v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15659v1.pdf" filename="2403.15659v1.pdf">Download PDF</button>
...
### (3/3 | 104/114) Delay-Optimal Forwarding and Computation Offloading for Service Chain Tasks (Jinkun Zhang et al., 2024)

{{<citation>}}

Jinkun Zhang, Yuezhou Liu, Edmund Yeh. (2024)  
**Delay-Optimal Forwarding and Computation Offloading for Service Chain Tasks**
<br/>
<button class="copy-to-clipboard" title="Delay-Optimal Forwarding and Computation Offloading for Service Chain Tasks" index=104>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15936v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15936v1.pdf" filename="2403.15936v1.pdf">Download PDF</button>
...
### (1/2 | 105/114) Deep Learning Approach to Forecasting COVID-19 Cases in Residential Buildings of Hong Kong Public Housing Estates: The Role of Environment and Sociodemographics (E. Leung et al., 2024)

{{<citation>}}

E. Leung, J. Guan, KO. Kwok, CT. Hung, CC. Ching, KC. Chong, CHK. Yam, T. Sun, WH. Tsang, EK. Yeoh, A. Lee. (2024)  
...
<br/>
<button class="copy-to-clipboard" title="Deep Learning Approach to Forecasting COVID-19 Cases in Residential Buildings of Hong Kong Public Housing Estates: The Role of Environment and Sociodemographics" index=105>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 107/114) Passivity-based Attack Identification and Mitigation with Event-triggered Observer Feedback and Switching Controller (Pushkal Purohit et al., 2024)

{{<citation>}}

Pushkal Purohit, Anoop Jain. (2024)  
**Passivity-based Attack Identification and Mitigation with Event-triggered Observer Feedback and Switching Controller**
<br/>
<button class="copy-to-clipboard" title="Passivity-based Attack Identification and Mitigation with Event-triggered Observer Feedback and Switching Controller" index=107>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 108/114) QueryExplorer: An Interactive Query Generation Assistant for Search and Exploration (Kaustubh D. Dhole et al., 2024)

{{<citation>}}

Kaustubh D. Dhole, Shivam Bajaj, Ramraj Chandradevan, Eugene Agichtein. (2024)  
**QueryExplorer: An Interactive Query Generation Assistant for Search and Exploration**
<br/>
<button class="copy-to-clipboard" title="QueryExplorer: An Interactive Query Generation Assistant for Search and Exploration" index=108>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15667v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15667v1.pdf" filename="2403.15667v1.pdf">Download PDF</button>

---


**ABSTRACT**  
Formulating effective search queries remains a challenging task, particularly when users lack expertise in a specific domain or are not proficient in the language of the content. Providing example documents of interest might be easier for a user. However, such query-by-example scenarios are prone to concept drift, and the retrieval effectiveness is highly sensitive to the query generation method, without a clear way to incorporate user feedback. To enable exploration and to support <b>Human-In-The-Loop</b> experiments we propose QueryExplorer -- an interactive query generation, reformulation, and retrieval interface with support for HuggingFace generation models and PyTerrier's retrieval pipelines and datasets, and extensive logging of human feedback. To allow users to create and modify effective queries, our demo supports complementary approaches of using <b>LLMs</b> interactively, assisting the user with edits and feedback at multiple stages of the query formulation process. With support for recording fine-grained interactions and user annotations, QueryExplorer can serve as a valuable experimental and research platform for annotation, qualitative evaluation, and conducting <b>Human-in-the-Loop</b> (HITL) experiments for complex search tasks where users struggle to formulate queries.
...
### (1/1 | 109/114) Improved Methods of Task Assignment and Resource Allocation with Preemption in Edge Computing Systems (Caroline Rublein et al., 2024)

{{<citation>}}

Caroline Rublein, Fidan Mehmeti, Mark Mahon, Thomas F. La Porta. (2024)  
**Improved Methods of Task Assignment and Resource Allocation with Preemption in Edge Computing Systems**
<br/>
<button class="copy-to-clipboard" title="Improved Methods of Task Assignment and Resource Allocation with Preemption in Edge Computing Systems" index=109>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 20  
Keywords: Simulation, Simulator  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15665v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15665v1.pdf" filename="2403.15665v1.pdf">Download PDF</button>
...
### (1/1 | 110/114) Space Group Informed Transformer for Crystalline Materials Generation (Zhendong Cao et al., 2024)

{{<citation>}}

Zhendong Cao, Xiaoshan Luo, Jian Lv, Lei Wang. (2024)  
**Space Group Informed Transformer for Crystalline Materials Generation**
<br/>
<button class="copy-to-clipboard" title="Space Group Informed Transformer for Crystalline Materials Generation" index=110>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15734v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15734v1.pdf" filename="2403.15734v1.pdf">Download PDF</button>
...
### (1/1 | 111/114) Utilizing Motion Matching with Deep Reinforcement Learning for Target Location Tasks (Jeongmin Lee et al., 2024)

{{<citation>}}

Jeongmin Lee, Taesoo Kwon, Hyunju Shin, Yoonsang Lee. (2024)  
**Utilizing Motion Matching with Deep Reinforcement Learning for Target Location Tasks**
<br/>
<button class="copy-to-clipboard" title="Utilizing Motion Matching with Deep Reinforcement Learning for Target Location Tasks" index=111>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 10  
Keywords: Reinforcement Learning  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15902v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15902v1.pdf" filename="2403.15902v1.pdf">Download PDF</button>
...
### (1/1 | 112/114) Conservative Surrogate Models for Optimization with the Active Subspace Method (Philippe-André Luneau, 2024)

{{<citation>}}

Philippe-André Luneau. (2024)  
**Conservative Surrogate Models for Optimization with the Active Subspace Method**
<br/>
<button class="copy-to-clipboard" title="Conservative Surrogate Models for Optimization with the Active Subspace Method" index=112>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Categories: 65K99, 65C20, cs-NA, math-NA, math-OC, math.NA  
Keyword Score: 10  
Keywords: Gaussian Process  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15678v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15678v1.pdf" filename="2403.15678v1.pdf">Download PDF</button>
...
### (1/1 | 113/114) Distance Adjustment of a Graph Drawing Stress Model (Yosuke Onoue, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Distance Adjustment of a Graph Drawing Stress Model" index=113>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 6  
Keywords: Graph, Benchmarking  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15811v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15811v1.pdf" filename="2403.15811v1.pdf">Download PDF</button>
...
### (1/1 | 114/114) Team Coordination on Graphs: Problem, Analysis, and Algorithms (Manshi Limbu et al., 2024)

{{<citation>}}

Manshi Limbu, Yanlin Zhou, Gregory Stein, Xuan Wang, Daigo Shishika, Xuesu Xiao. (2024)  
**Team Coordination on Graphs: Problem, Analysis, and Algorithms**
<br/>
<button class="copy-to-clipboard" title="Team Coordination on Graphs: Problem, Analysis, and Algorithms" index=114>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 3  
Keywords: Graph  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.15946v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.15946v1.pdf" filename="2403.15946v1.pdf">Download PDF</button>
