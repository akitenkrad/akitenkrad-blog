...
### (19/25 | 40/161) Decoding Continuous Character-based Language from Non-invasive Brain Recordings (Cenyuan Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Decoding Continuous Character-based Language from Non-invasive Brain Recordings" index=40>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (20/25 | 41/161) Evaluation Ethics of LLMs in Legal Domain (Ruizhe Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Evaluation Ethics of LLMs in Legal Domain" index=41>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (21/25 | 42/161) A Challenge Dataset and Effective Models for Conversational Stance Detection (Fuqiang Niu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Challenge Dataset and Effective Models for Conversational Stance Detection" index=42>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.11145v2" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.11145v2.pdf" filename="2403.11145v2.pdf">Download PDF</button>
...
### (22/25 | 43/161) Improving Dialogue Agents by Decomposing One Global Explicit Annotation with Local Implicit Multimodal Feedback (Dong Won Lee et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Improving Dialogue Agents by Decomposing One Global Explicit Annotation with Local Implicit Multimodal Feedback" index=43>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (23/25 | 44/161) HarmPot: An Annotation Framework for Evaluating Offline Harm Potential of Social Media Text (Ritesh Kumar et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="HarmPot: An Annotation Framework for Evaluating Offline Harm Potential of Social Media Text" index=44>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (24/25 | 45/161) Deep Learning-based Sentiment Analysis in Persian Language (Mohammad Heydari et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Deep Learning-based Sentiment Analysis in Persian Language" index=45>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (25/25 | 46/161) TRELM: Towards Robust and Efficient Pre-training for Knowledge-Enhanced Language Models (Junbing Yan et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="TRELM: Towards Robust and Efficient Pre-training for Knowledge-Enhanced Language Models" index=46>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/3 | 47/161) ConvSDG: Session Data Generation for Conversational Search (Fengran Mo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="ConvSDG: Session Data Generation for Conversational Search" index=47>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/3 | 48/161) Is Contrastive Learning Necessary? A Study of Data Augmentation vs Contrastive Learning in Sequential Recommendation (Peilin Zhou et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Is Contrastive Learning Necessary? A Study of Data Augmentation vs Contrastive Learning in Sequential Recommendation" index=48>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/3 | 49/161) Learning Time Slot Preferences via Mobility Tree for Next POI Recommendation (Tianhao Huang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Learning Time Slot Preferences via Mobility Tree for Next POI Recommendation" index=49>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/8 | 50/161) ManipVQA: Injecting Robotic Affordance and Physically Grounded Information into Multi-Modal Large Language Models (Siyuan Huang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="ManipVQA: Injecting Robotic Affordance and Physically Grounded Information into Multi-Modal Large Language Models" index=50>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/8 | 51/161) Driving Style Alignment for LLM-powered Driver Agent (Ruoxuan Yang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Driving Style Alignment for LLM-powered Driver Agent" index=51>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/8 | 52/161) Leveraging Simulation-Based Model Preconditions for Fast Action Parameter Optimization with Multiple Models (M. Yunus Seker et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Leveraging Simulation-Based Model Preconditions for Fast Action Parameter Optimization with Multiple Models" index=52>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/8 | 53/161) Continuous Jumping of a Parallel Wire-Driven Monopedal Robot RAMIEL Using Reinforcement Learning (Kento Kawaharazuka et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Continuous Jumping of a Parallel Wire-Driven Monopedal Robot RAMIEL Using Reinforcement Learning" index=53>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/8 | 54/161) Hybrid Feedback for Three-dimensional Convex Obstacle Avoidance (Mayur Sawant et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Hybrid Feedback for Three-dimensional Convex Obstacle Avoidance" index=54>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (6/8 | 55/161) PyroTrack: Belief-Based Deep Reinforcement Learning Path Planning for Aerial Wildfire Monitoring in Partially Observable Environments (Sahand Khoshdel et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="PyroTrack: Belief-Based Deep Reinforcement Learning Path Planning for Aerial Wildfire Monitoring in Partially Observable Environments" index=55>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (7/8 | 56/161) Learning-Based Wiping Behavior of Low-Rigidity Robots Considering Various Surface Materials and Task Definitions (Kento Kawaharazuka et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Learning-Based Wiping Behavior of Low-Rigidity Robots Considering Various Surface Materials and Task Definitions" index=56>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (8/8 | 57/161) Pioneering SE(2)-Equivariant Trajectory Planning for Automated Driving (Steffen Hagedorn et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Pioneering SE(2)-Equivariant Trajectory Planning for Automated Driving" index=57>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/57 | 58/161) SQ-LLaVA: Self-Questioning for Large Vision-Language Assistant (Guohao Sun et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="SQ-LLaVA: Self-Questioning for Large Vision-Language Assistant" index=58>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/57 | 59/161) Fast Personalized Text-to-Image Syntheses With Attention Injection (Yuxuan Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Fast Personalized Text-to-Image Syntheses With Attention Injection" index=59>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/57 | 60/161) Endora: Video Generation Models as Endoscopy Simulators (Chenxin Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Endora: Video Generation Models as Endoscopy Simulators" index=60>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/57 | 61/161) Tokensome: Towards a Genetic Vision-Language GPT for Explainable and Cognitive Karyotyping (Haoxi Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Tokensome: Towards a Genetic Vision-Language GPT for Explainable and Cognitive Karyotyping" index=61>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/57 | 62/161) A Versatile Framework for Multi-scene Person Re-identification (Wei-Shi Zheng et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Versatile Framework for Multi-scene Person Re-identification" index=62>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (6/57 | 63/161) PhD: A Prompted Visual Hallucination Evaluation Dataset (Jiazhen Liu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="PhD: A Prompted Visual Hallucination Evaluation Dataset" index=63>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (7/57 | 64/161) Self-supervised co-salient object detection via feature correspondence at multiple scales (Souradeep Chakraborty et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Self-supervised co-salient object detection via feature correspondence at multiple scales" index=64>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (8/57 | 65/161) Omni-Recon: Towards General-Purpose Neural Radiance Fields for Versatile 3D Applications (Yonggan Fu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Omni-Recon: Towards General-Purpose Neural Radiance Fields for Versatile 3D Applications" index=65>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (9/57 | 66/161) Uncertainty-Aware Pseudo-Label Filtering for Source-Free Unsupervised Domain Adaptation (Xi Chen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Uncertainty-Aware Pseudo-Label Filtering for Source-Free Unsupervised Domain Adaptation" index=66>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (10/57 | 67/161) Customizing Visual-Language Foundation Models for Multi-modal Anomaly Detection and Reasoning (Xiaohao Xu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Customizing Visual-Language Foundation Models for Multi-modal Anomaly Detection and Reasoning" index=67>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (11/57 | 68/161) MaskDiffusion: Exploiting Pre-trained Diffusion Models for Semantic Segmentation (Yasufumi Kawano et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="MaskDiffusion: Exploiting Pre-trained Diffusion Models for Semantic Segmentation" index=68>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (12/57 | 69/161) Quality-Aware Image-Text Alignment for Real-World Image Quality Assessment (Lorenzo Agnolucci et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Quality-Aware Image-Text Alignment for Real-World Image Quality Assessment" index=69>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (13/57 | 70/161) CGI-DM: Digital Copyright Authentication for Diffusion Models via Contrasting Gradient Inversion (Xiaoyu Wu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="CGI-DM: Digital Copyright Authentication for Diffusion Models via Contrasting Gradient Inversion" index=70>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (14/57 | 71/161) Reconstruct before Query: Continual Missing Modality Learning with Decomposed Prompt Collaboration (Shu Zhao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Reconstruct before Query: Continual Missing Modality Learning with Decomposed Prompt Collaboration" index=71>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (15/57 | 72/161) From Pixels to Predictions: Spectrogram and Vision Transformer for Better Time Series Forecasting (Zhen Zeng et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="From Pixels to Predictions: Spectrogram and Vision Transformer for Better Time Series Forecasting" index=72>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (16/57 | 73/161) Selective Hourglass Mapping for Universal Image Restoration Based on Diffusion Model (Dian Zheng et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Selective Hourglass Mapping for Universal Image Restoration Based on Diffusion Model" index=73>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (17/57 | 74/161) Advanced Knowledge Extraction of Physical Design Drawings, Translation and conversion to CAD formats using Deep Learning (Jesher Joshua M et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Advanced Knowledge Extraction of Physical Design Drawings, Translation and conversion to CAD formats using Deep Learning" index=74>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (18/57 | 75/161) BrightDreamer: Generic 3D Gaussian Generative Framework for Fast Text-to-3D Synthesis (Lutao Jiang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="BrightDreamer: Generic 3D Gaussian Generative Framework for Fast Text-to-3D Synthesis" index=75>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (19/57 | 76/161) CPA-Enhancer: Chain-of-Thought Prompted Adaptive Enhancer for Object Detection under Unknown Degradations (Yuwei Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="CPA-Enhancer: Chain-of-Thought Prompted Adaptive Enhancer for Object Detection under Unknown Degradations" index=76>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (20/57 | 77/161) TAG: Guidance-free Open-Vocabulary Semantic Segmentation (Yasufumi Kawano et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="TAG: Guidance-free Open-Vocabulary Semantic Segmentation" index=77>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (21/57 | 78/161) Artifact Feature Purification for Cross-domain Detection of AI-generated Images (Zheling Meng et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Artifact Feature Purification for Cross-domain Detection of AI-generated Images" index=78>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (22/57 | 79/161) Training A Small Emotional Vision Language Model for Visual Art Comprehension (Jing Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Training A Small Emotional Vision Language Model for Visual Art Comprehension" index=79>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (23/57 | 80/161) Large Language Models Powered Context-aware Motion Prediction (Xiaoji Zheng et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Large Language Models Powered Context-aware Motion Prediction" index=80>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (24/57 | 81/161) Unveiling and Mitigating Memorization in Text-to-image Diffusion Models through Cross Attention (Jie Ren et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Unveiling and Mitigating Memorization in Text-to-image Diffusion Models through Cross Attention" index=81>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (25/57 | 82/161) LERENet: Eliminating Intra-class Differences for Metal Surface Defect Few-shot Semantic Segmentation (Hanze Ding et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="LERENet: Eliminating Intra-class Differences for Metal Surface Defect Few-shot Semantic Segmentation" index=82>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (26/57 | 83/161) m&m's: A Benchmark to Evaluate Tool-Use for multi-step multi-modal Tasks (Zixian Ma et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="m&m's: A Benchmark to Evaluate Tool-Use for multi-step multi-modal Tasks" index=83>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.11085v3" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.11085v3.pdf" filename="2403.11085v3.pdf">Download PDF</button>
...
### (27/57 | 84/161) Recent Advances in 3D Gaussian Splatting (Tong Wu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Recent Advances in 3D Gaussian Splatting" index=84>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (28/57 | 85/161) DynamicGlue: Epipolar and Time-Informed Data Association in Dynamic Environments using Graph Neural Networks (Theresa Huber et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="DynamicGlue: Epipolar and Time-Informed Data Association in Dynamic Environments using Graph Neural Networks" index=85>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (29/57 | 86/161) GRA: Detecting Oriented Objects through Group-wise Rotating and Attention (Jiangshan Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="GRA: Detecting Oriented Objects through Group-wise Rotating and Attention" index=86>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (30/57 | 87/161) Unifying Feature and Cost Aggregation with Transformers for Semantic and Visual Correspondence (Sunghwan Hong et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Unifying Feature and Cost Aggregation with Transformers for Semantic and Visual Correspondence" index=87>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (31/57 | 88/161) 3D Human Reconstruction in the Wild with Synthetic Data Using Generative Models (Yongtao Ge et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="3D Human Reconstruction in the Wild with Synthetic Data Using Generative Models" index=88>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (32/57 | 89/161) Enhancing Bandwidth Efficiency for Video Motion Transfer Applications using Deep Learning Based Keypoint Prediction (Xue Bai et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Enhancing Bandwidth Efficiency for Video Motion Transfer Applications using Deep Learning Based Keypoint Prediction" index=89>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (33/57 | 90/161) NeoNeXt: Novel neural network operator and architecture based on the patch-wise matrix multiplications (Vladimir Korviakov et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="NeoNeXt: Novel neural network operator and architecture based on the patch-wise matrix multiplications" index=90>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (34/57 | 91/161) Concatenate, Fine-tuning, Re-training: A SAM-enabled Framework for Semi-supervised 3D Medical Image Segmentation (Shumeng Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Concatenate, Fine-tuning, Re-training: A SAM-enabled Framework for Semi-supervised 3D Medical Image Segmentation" index=91>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (35/57 | 92/161) MindEye2: Shared-Subject Models Enable fMRI-To-Image With 1 Hour of Data (Paul S. Scotti et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="MindEye2: Shared-Subject Models Enable fMRI-To-Image With 1 Hour of Data" index=92>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (36/57 | 93/161) DuPL: Dual Student with Trustworthy Progressive Learning for Robust Weakly Supervised Semantic Segmentation (Yuanchen Wu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="DuPL: Dual Student with Trustworthy Progressive Learning for Robust Weakly Supervised Semantic Segmentation" index=93>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (37/57 | 94/161) Source Prompt Disentangled Inversion for Boosting Image Editability with Diffusion Models (Ruibin Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Source Prompt Disentangled Inversion for Boosting Image Editability with Diffusion Models" index=94>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (38/57 | 95/161) Zippo: Zipping Color and Transparency Distributions into a Single Diffusion Model (Kangyang Xie et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Zippo: Zipping Color and Transparency Distributions into a Single Diffusion Model" index=95>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (39/57 | 96/161) Intelligent Railroad Grade Crossing: Leveraging Semantic Segmentation and Object Detection for Enhanced Safety (Al Amin et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Intelligent Railroad Grade Crossing: Leveraging Semantic Segmentation and Object Detection for Enhanced Safety" index=96>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (40/57 | 97/161) OSTAF: A One-Shot Tuning Method for Improved Attribute-Focused T2I Personalization (Ye Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="OSTAF: A One-Shot Tuning Method for Improved Attribute-Focused T2I Personalization" index=97>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (41/57 | 98/161) V2X-DGW: Domain Generalization for Multi-agent Perception under Adverse Weather Conditions (Baolu Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="V2X-DGW: Domain Generalization for Multi-agent Perception under Adverse Weather Conditions" index=98>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.11371v3" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.11371v3.pdf" filename="2403.11371v3.pdf">Download PDF</button>
...
### (42/57 | 99/161) Bilateral Propagation Network for Depth Completion (Jie Tang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Bilateral Propagation Network for Depth Completion" index=99>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (43/57 | 100/161) A Dual-Augmentor Framework for Domain Generalization in 3D Human Pose Estimation (Qucheng Peng et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Dual-Augmentor Framework for Domain Generalization in 3D Human Pose Estimation" index=100>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (44/57 | 101/161) Universal Semi-Supervised Domain Adaptation by Mitigating Common-Class Bias (Wenyu Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Universal Semi-Supervised Domain Adaptation by Mitigating Common-Class Bias" index=101>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (45/57 | 102/161) Neural Markov Random Field for Stereo Matching (Tongfan Guan et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Neural Markov Random Field for Stereo Matching" index=102>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2403.11193v2" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2403.11193v2.pdf" filename="2403.11193v2.pdf">Download PDF</button>
...
### (46/57 | 103/161) NetTrack: Tracking Highly Dynamic Objects with a Net (Guangze Zheng et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="NetTrack: Tracking Highly Dynamic Objects with a Net" index=103>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (47/57 | 104/161) 3DGS-ReLoc: 3D Gaussian Splatting for Map Representation and Visual ReLocalization (Peng Jiang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="3DGS-ReLoc: 3D Gaussian Splatting for Map Representation and Visual ReLocalization" index=104>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (48/57 | 105/161) Domain-Guided Masked Autoencoders for Unique Player Identification (Bavesh Balaji et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Domain-Guided Masked Autoencoders for Unique Player Identification" index=105>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (49/57 | 106/161) Stylized Face Sketch Extraction via Generative Prior with Limited Data (Kwan Yun et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Stylized Face Sketch Extraction via Generative Prior with Limited Data" index=106>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (50/57 | 107/161) THOR: Text to Human-Object Interaction Diffusion via Relation Intervention (Qianyang Wu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="THOR: Text to Human-Object Interaction Diffusion via Relation Intervention" index=107>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (51/57 | 108/161) Self-Supervised Video Desmoking for Laparoscopic Surgery (Renlong Wu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Self-Supervised Video Desmoking for Laparoscopic Surgery" index=108>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (52/57 | 109/161) Hierarchical Generative Network for Face Morphing Attacks (Zuyuan He et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Hierarchical Generative Network for Face Morphing Attacks" index=109>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (53/57 | 110/161) Controllable Relation Disentanglement for Few-Shot Class-Incremental Learning (Yuan Zhou et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Controllable Relation Disentanglement for Few-Shot Class-Incremental Learning" index=110>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (54/57 | 111/161) GeoGaussian: Geometry-aware Gaussian Splatting for Scene Rendering (Yanyan Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="GeoGaussian: Geometry-aware Gaussian Splatting for Scene Rendering" index=111>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (55/57 | 112/161) Compact 3D Gaussian Splatting For Dense Visual SLAM (Tianchen Deng et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Compact 3D Gaussian Splatting For Dense Visual SLAM" index=112>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (56/57 | 113/161) Local-consistent Transformation Learning for Rotation-invariant Point Cloud Analysis (Yiyang Chen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Local-consistent Transformation Learning for Rotation-invariant Point Cloud Analysis" index=113>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (57/57 | 114/161) FORCE: Dataset and Method for Intuitive Physics Guided Human-object Interaction (Xiaohan Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="FORCE: Dataset and Method for Intuitive Physics Guided Human-object Interaction" index=114>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/3 | 115/161) An Empirical Study on JIT Defect Prediction Based on BERT-style Model (Yuxiang Guo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="An Empirical Study on JIT Defect Prediction Based on BERT-style Model" index=115>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/3 | 116/161) Java JIT Testing with Template Extraction (Zhiqiang Zang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Java JIT Testing with Template Extraction" index=116>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/3 | 117/161) Efficiently Detecting Reentrancy Vulnerabilities in Complex Smart Contracts (Zexu Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Efficiently Detecting Reentrancy Vulnerabilities in Complex Smart Contracts" index=117>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/3 | 118/161) Unsupervised Learning for Equitable DER Control (Zhenyi Yuan et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Unsupervised Learning for Equitable DER Control" index=118>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/3 | 119/161) Toward Adaptive Cooperation: Model-Based Shared Control Using LQ-Differential Games (Balint Varga, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Toward Adaptive Cooperation: Model-Based Shared Control Using LQ-Differential Games" index=119>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/3 | 120/161) Deep Neural Network NMPC for Computationally Tractable Optimal Power Management of Hybrid Electric Vehicle (Suyong Park et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Deep Neural Network NMPC for Computationally Tractable Optimal Power Management of Hybrid Electric Vehicle" index=120>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/5 | 121/161) usfAD Based Effective Unknown Attack Detection Focused IDS Framework (Md. Ashraf Uddin et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="usfAD Based Effective Unknown Attack Detection Focused IDS Framework" index=121>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/5 | 122/161) A Dual-Tier Adaptive One-Class Classification IDS for Emerging Cyberthreats (Md. Ashraf Uddin et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Dual-Tier Adaptive One-Class Classification IDS for Emerging Cyberthreats" index=122>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/5 | 123/161) Pencil: Private and Extensible Collaborative Learning without the Non-Colluding Assumption (Xuanqi Liu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Pencil: Private and Extensible Collaborative Learning without the Non-Colluding Assumption" index=123>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/5 | 124/161) Programming Frameworks for Differential Privacy (Marco Gaboardi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Programming Frameworks for Differential Privacy" index=124>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/5 | 125/161) A Tip for IOTA Privacy: IOTA Light Node Deanonymization via Tip Selection (Hojung Yang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Tip for IOTA Privacy: IOTA Light Node Deanonymization via Tip Selection" index=125>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/3 | 126/161) Jointly Optimizing Terahertz based Sensing and Communications in Vehicular Networks: A Dynamic Graph Neural Network Approach (Xuefei Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Jointly Optimizing Terahertz based Sensing and Communications in Vehicular Networks: A Dynamic Graph Neural Network Approach" index=126>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/3 | 127/161) Brain-on-Switch: Towards Advanced Intelligent Network Data Plane via NN-Driven Traffic Analysis at Line-Speed (Jinzhu Yan et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Brain-on-Switch: Towards Advanced Intelligent Network Data Plane via NN-Driven Traffic Analysis at Line-Speed" index=127>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/3 | 128/161) Non-Primary Channel Access in IEEE 802.11 UHR: Comprehensive Analysis and Evaluation (Dongyu Wei et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Non-Primary Channel Access in IEEE 802.11 UHR: Comprehensive Analysis and Evaluation" index=128>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/7 | 129/161) Simple 2D Convolutional Neural Network-based Approach for COVID-19 Detection (Chih-Chung Hsu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Simple 2D Convolutional Neural Network-based Approach for COVID-19 Detection" index=129>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/7 | 130/161) Ensembling and Test Augmentation for Covid-19 Detection and Covid-19 Domain Adaptation from 3D CT-Scans (Fares Bougourzi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Ensembling and Test Augmentation for Covid-19 Detection and Covid-19 Domain Adaptation from 3D CT-Scans" index=130>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/7 | 131/161) YOLOv9 for Fracture Detection in Pediatric Wrist Trauma X-ray Images (Chun-Tse Chien et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="YOLOv9 for Fracture Detection in Pediatric Wrist Trauma X-ray Images" index=131>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/7 | 132/161) Adaptive Semantic-Enhanced Denoising Diffusion Probabilistic Model for Remote Sensing Image Super-Resolution (Jialu Sui et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Adaptive Semantic-Enhanced Denoising Diffusion Probabilistic Model for Remote Sensing Image Super-Resolution" index=132>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/7 | 133/161) Interactive $360^{\circ}$ Video Streaming Using FoV-Adaptive Coding with Temporal Prediction (Yixiang Mao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Interactive $360^{\circ}$ Video Streaming Using FoV-Adaptive Coding with Temporal Prediction" index=133>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (6/7 | 134/161) StainDiffuser: MultiTask Dual Diffusion Model for Virtual Staining (Tushar Kataria et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="StainDiffuser: MultiTask Dual Diffusion Model for Virtual Staining" index=134>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (7/7 | 135/161) A lightweight deep learning pipeline with DRDA-Net and MobileNet for breast cancer classification (Mahdie Ahmadi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A lightweight deep learning pipeline with DRDA-Net and MobileNet for breast cancer classification" index=135>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/3 | 136/161) Causality from Bottom to Top: A Survey (Abraham Itzhak Weinberg et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Causality from Bottom to Top: A Survey" index=136>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/3 | 137/161) Circular Belief Propagation for Approximate Probabilistic Inference (Vincent Bouttier et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Circular Belief Propagation for Approximate Probabilistic Inference" index=137>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/3 | 138/161) Research on Personal Credit Risk Assessment Methods Based on Causal Inference (Jiaxin Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Research on Personal Credit Risk Assessment Methods Based on Causal Inference" index=138>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/3 | 139/161) Deep Neural Crossover (Eliad Shem-Tov et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Deep Neural Crossover" index=139>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/3 | 140/161) Spiking Wavelet Transformer (Yuetong Fang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Spiking Wavelet Transformer" index=140>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/3 | 141/161) Multi-Objective Evolutionary Neural Architecture Search for Recurrent Neural Networks (Reinhard Booysen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Multi-Objective Evolutionary Neural Architecture Search for Recurrent Neural Networks" index=141>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/2 | 142/161) Machine learning-based system reliability analysis with Gaussian Process Regression (Lisang Zhou et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Machine learning-based system reliability analysis with Gaussian Process Regression" index=142>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/2 | 143/161) Prior-dependent analysis of posterior sampling reinforcement learning with function approximation (Yingru Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Prior-dependent analysis of posterior sampling reinforcement learning with function approximation" index=143>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 144/161) Multitask frame-level learning for few-shot sound event detection (Liang Zou et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Multitask frame-level learning for few-shot sound event detection" index=144>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 145/161) Regulating Chatbot Output via Inter-Informational Competition (Jiawei Zhang, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Regulating Chatbot Output via Inter-Informational Competition" index=145>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 146/161) Quasi-Monte Carlo and importance sampling methods for Bayesian inverse problems (Zhijian He et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Quasi-Monte Carlo and importance sampling methods for Bayesian inverse problems" index=146>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/2 | 147/161) The Effects of Generative AI on Design Fixation and Divergent Thinking (Samangi Wadinambiarachchi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="The Effects of Generative AI on Design Fixation and Divergent Thinking" index=147>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/2 | 148/161) GOMA: Proactive Embodied Cooperative Communication via Goal-Oriented Mental Alignment (Lance Ying et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="GOMA: Proactive Embodied Cooperative Communication via Goal-Oriented Mental Alignment" index=148>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 149/161) Journey into SPH Simulation: A Comprehensive Framework and Showcase (Haofeng Huang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Journey into SPH Simulation: A Comprehensive Framework and Showcase" index=149>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/2 | 150/161) Enhanced Index Modulation Aided Non-Orthogonal Multiple Access via Constellation Rotation (Ronglan Huang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Enhanced Index Modulation Aided Non-Orthogonal Multiple Access via Constellation Rotation" index=150>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/2 | 151/161) Task-Based Quantizer Design for Sensing With Random Signals (Hang Ruan et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Task-Based Quantizer Design for Sensing With Random Signals" index=151>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 152/161) JustQ: Automated Deployment of Fair and Accurate Quantum Neural Networks (Ruhan Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="JustQ: Automated Deployment of Fair and Accurate Quantum Neural Networks" index=152>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 153/161) Potential of Domain Adaptation in Machine Learning in Ecology and Hydrology to Improve Model Extrapolability (Haiyang Shi, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Potential of Domain Adaptation in Machine Learning in Ecology and Hydrology to Improve Model Extrapolability" index=153>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 154/161) Lion: Minimizing Distributed Transactions through Adaptive Replica Provision (Extended Version) (Qiushi Zheng et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Lion: Minimizing Distributed Transactions through Adaptive Replica Provision (Extended Version)" index=154>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/2 | 155/161) Wait to be Faster: a Smart Pooling Framework for Dynamic Ridesharing (Xiaoyao Zhong et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Wait to be Faster: a Smart Pooling Framework for Dynamic Ridesharing" index=155>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/2 | 156/161) Graph Theory for Consent Management: A New Approach for Complex Data Flows (Dorota Filipczuk et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Graph Theory for Consent Management: A New Approach for Complex Data Flows" index=156>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/2 | 157/161) An SDP-based Branch-and-Cut Algorithm for Biclustering (Antonio M. Sudoso, 2024)
...
<br/>
<button class="copy-to-clipboard" title="An SDP-based Branch-and-Cut Algorithm for Biclustering" index=157>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/2 | 158/161) Learning-Based Pricing and Matching for Two-Sided Queues (Zixian Yang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Learning-Based Pricing and Matching for Two-Sided Queues" index=158>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 159/161) A constant time complexity algorithm for the unbounded knapsack problem with bounded coefficients (Yang Yang, 2024)
...
<br/>
<button class="copy-to-clipboard" title="A constant time complexity algorithm for the unbounded knapsack problem with bounded coefficients" index=159>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 160/161) A Selective Review on Statistical Methods for Massive Data Computation: Distributed Computing, Subsampling, and Minibatch Techniques (Xuetong Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Selective Review on Statistical Methods for Massive Data Computation: Distributed Computing, Subsampling, and Minibatch Techniques" index=160>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 161/161) Wavenumber Domain Sparse Channel Estimation in Holographic MIMO (Xufeng Guo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Wavenumber Domain Sparse Channel Estimation in Holographic MIMO" index=161>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
