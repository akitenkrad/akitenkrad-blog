...
### (1/64) BandRe: Rethinking Band-Pass Filters for Scale-Wise Object Detection Evaluation (Yosuke Shinya, 2023)
...
### (2/64) Enhancing CLIP with GPT-4: Harnessing Visual Descriptions as Prompts (Mayug Maniparambil et al., 2023)
...
### (3/64) Morphological Image Analysis and Feature Extraction for Reasoning with AI-based Defect Detection and Classification Models (Jiajun Zhang et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2307.11643v1)  
...
### (4/64) Deep Reinforcement Learning Based System for Intraoperative Hyperspectral Video Autofocusing (Charlie Budd et al., 2023)
...
### (5/64) Consistency-guided Meta-Learning for Bootstrapping Semi-Supervised Medical Image Segmentation (Qingyue Wei et al., 2023)
...
### (6/64) Advancing Visual Grounding with Scene Knowledge: Benchmark and Method (Zhihong Chen et al., 2023)
...
### (7/64) YOLOPose V2: Understanding and Improving Transformer-based 6D Pose Estimation (Arul Selvam Periyasamy et al., 2023)
...
### (8/64) Improving Viewpoint Robustness for Visual Recognition via Adversarial Training (Shouwei Ruan et al., 2023)
...
### (9/64) Redemption from Range-view for Accurate 3D Object Detection (Yihan Wang et al., 2023)
...
### (10/64) SA-BEV: Generating Semantic-Aware Bird's-Eye-View Feature for Multi-view 3D Object Detection (Jinqing Zhang et al., 2023)
...
### (11/64) Robust Visual Question Answering: Datasets, Methods, and Future Challenges (Jie Ma et al., 2023)
...
### (12/64) Physics-Aware Semi-Supervised Underwater Image Enhancement (Hao Qi et al., 2023)
...
### (13/64) Distribution Shift Matters for Knowledge Distillation with Webly Collected Images (Jialiang Tang et al., 2023)
...
### (14/64) Strip-MLP: Efficient Token Interaction for Vision MLP (Guiping Cao et al., 2023)
...
### (15/64) Attention Consistency Refined Masked Frequency Forgery Representation for Generalizing Face Forgery Detection (Decheng Liu et al., 2023)
...
### (16/64) Deep Directly-Trained Spiking Neural Networks for Object Detection (Qiaoyi Su et al., 2023)
...
Categories: cs-AI, cs-CV, cs.CV  
Keywords: Object Detection  
[Paper Link](http://arxiv.org/abs/2307.11411v1)  
...
### (17/64) Subject-Diffusion:Open Domain Personalized Text-to-Image Generation without Test-time Fine-tuning (Jian Ma et al., 2023)
...
### (18/64) LatentAugment: Data Augmentation via Guided Manipulation of GAN's Latent Space (Lorenzo Tronchin et al., 2023)
...
### (19/64) ParGANDA: Making Synthetic Pedestrians A Reality For Object Detection (Daria Reshetova et al., 2023)
...
### (20/64) Generating Image-Specific Text Improves Fine-grained Image Classification (Emily Mu et al., 2023)
...
### (21/64) OUTFOX: LLM-generated Essay Detection through In-context Learning with Adversarially Generated Examples (Ryuto Koike et al., 2023)
...
### (22/64) CausE: Towards Causal Knowledge Graph Embedding (Yichi Zhang et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2307.11610v1)  
...
### (23/64) Incorporating Human Translator Style into English-Turkish Literary Machine Translation (Zeynep Yirmibeşoğlu et al., 2023)
...
### (24/64) Is ChatGPT Involved in Texts? Measure the Polish Ratio to Detect ChatGPT-Generated Text (Lingyi Yang et al., 2023)
...
### (25/64) CohortGPT: An Enhanced GPT for Participant Recruitment in Clinical Study (Zihan Guan et al., 2023)
...
### (26/64) Making Pre-trained Language Models both Task-solvers and Self-calibrators (Yangyi Chen et al., 2023)
...
### (27/64) Generator-Retriever-Generator: A Novel Approach to Open-domain Question Answering (Abdelrahman Abdallah et al., 2023)
...
### (28/64) A Reinforcement Learning Framework with Region-Awareness and Shared Path Experience for Efficient Routing in Networks-on-Chip (Kamil Khan et al., 2023)
...
### (29/64) Statement-based Memory for Neural Source Code Summarization (Aakash Bansal et al., 2023)
...
### (30/64) Identifying Relevant Features of CSE-CIC-IDS2018 Dataset for the Development of an Intrusion Detection System (László Göcs et al., 2023)
...
### (31/64) Model Reporting for Certifiable AI: A Proposal from Merging EU Regulation into AI Development (Danilo Brajovic et al., 2023)
...
### (32/64) IndigoVX: Where Human Intelligence Meets AI for Optimal Decision Making (Kais Dukes, 2023)
...
### (33/64) Zero-touch realization of Pervasive Artificial Intelligence-as-a-service in 6G networks (Emna Baccour et al., 2023)
...
### (34/64) AIGC Empowering Telecom Sector White Paper (Ye Ouyang et al., 2023)
...
Categories: cs-AI, cs.AI  
Keywords: AI, GPT  
[Paper Link](http://arxiv.org/abs/2307.11449v1)  
...
### (35/64) A Two-stage Fine-tuning Strategy for Generalizable Manipulation Skill of Embodied AI (Fang Gao et al., 2023)
...
### (36/64) Eliminating Unintended Stable Fixpoints for Hybrid Reasoning Systems (Spencer Killen et al., 2023)
...
### (37/64) 3D Skeletonization of Complex Grapevines for Robotic Pruning (Eric Schneider et al., 2023)
...
### (38/64) BatMobility: Towards Flying Without Seeing for Autonomous Drones (Emerson Sie et al., 2023)
...
### (39/64) EV-Planner: Energy-Efficient Robot Navigation via Event-Based Physics-Guided Neuromorphic Planner (Sourav Sanyal et al., 2023)
...
### (40/64) How to Tidy Up a Table: Fusing Visual and Semantic Commonsense Reasoning for Robotic Tasks with Vague Objectives (Yiqing Xu et al., 2023)
...
### (41/64) JoinGym: An Efficient Query Optimization Environment for Reinforcement Learning (Kaiwen Wang et al., 2023)
...
### (42/64) Offline Multi-Agent Reinforcement Learning with Implicit Global-to-Local Value Regularization (Xiangsen Wang et al., 2023)
...
### (43/64) Training Latency Minimization for Model-Splitting Allowed Federated Edge Learning (Yao Wen et al., 2023)
...
### (44/64) Predict, Refine, Synthesize: Self-Guiding Diffusion Models for Probabilistic Time Series Forecasting (Marcel Kollovieh et al., 2023)
...
### (45/64) A New Deep State-Space Analysis Framework for Patient Latent State Estimation and Classification from EHR Time Series Data (Aya Nakamura et al., 2023)
...
### (46/64) A Deep Learning Approach for Overall Survival Analysis with Missing Values (Camillo Maria Caruso et al., 2023)
...
Keywords: AI  
[Paper Link](http://arxiv.org/abs/2307.11465v1)  
...
### (47/64) Batching for Green AI -- An Exploratory Study on Inference (Tim Yarally et al., 2023)
...
### (48/64) An Analysis of Multi-Agent Reinforcement Learning for Decentralized Inventory Control Systems (Marwan Mousa et al., 2023)
...
### (49/64) Towards Better Fairness-Utility Trade-off: A Comprehensive Measurement-Based Reinforcement Learning Framework (Simiao Zhang et al., 2023)
...
### (50/64) Bridging the Reality Gap of Reinforcement Learning based Traffic Signal Control using Domain Randomization and Meta Learning (Arthur Müller et al., 2023)
...
### (51/64) What can a Single Attention Layer Learn? A Study Through the Random Features Lens (Hengyu Fu et al., 2023)
...
### (52/64) Model-based Offline Reinforcement Learning with Count-based Conservatism (Byeongchan Kim et al., 2023)
...
### (53/64) Improving Transferability of Adversarial Examples via Bayesian Attacks (Qizhang Li et al., 2023)
...
### (54/64) XLDA: Linear Discriminant Analysis for Scaling Continual Learning to Extreme Classification at the Edge (Karan Shah et al., 2023)
...
### (55/64) PI-VEGAN: Physics Informed Variational Embedding Generative Adversarial Networks for Stochastic Differential Equations (Ruisong Gao et al., 2023)
...
### (56/64) A Change of Heart: Improving Speech Emotion Recognition through Speech-to-Text Modality Conversion (Zeinab Sadat Taghavi et al., 2023)
...
### (57/64) Diurnal Patterns in the Spread of COVID-19 Misinformation on Twitter within Italy (Elisabeth Stockinger et al., 2023)
...
### (58/64) Prompt-Based Zero- and Few-Shot Node Classification: A Multimodal Approach (Yuexin Li et al., 2023)
...
### (59/64) Friction Interventions to Curb the Spread of Misinformation on Social Media (Laura Jahn et al., 2023)
...
### (60/64) Providing personalized Explanations: a Conversational Approach (Jieting Luo et al., 2023)
...
### (61/64) Attention to Entropic Communication (Torsten Enßlin et al., 2023)
...
### (62/64) Large Language Model-based System to Provide Immediate Feedback to Students in Flipped Classroom Preparation Learning (Shintaro Uchiyama et al., 2023)
...
### (63/64) Exploring Technical Debt in Security Questions on Stack Overflow (Joshua Aldrich Edbert et al., 2023)
...
### (64/64) DEFTri: A Few-Shot Label Fused Contextual Representation Learning For Product Defect Triage in e-Commerce (Ipsita Mohanty, 2023)
