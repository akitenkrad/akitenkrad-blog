...
### (1/56) Point-Bind & Point-LLM: Aligning Point Cloud with Multi-modality for 3D Understanding, Generation, and Instruction Following (Ziyu Guo et al., 2023)
...
### (2/56) CityDreamer: Compositional Generative Model of Unbounded 3D Cities (Haozhe Xie et al., 2023)
...
### (3/56) Time Series Analysis of Urban Liveability (Alex Levering et al., 2023)
...
### (4/56) SQLdepth: Generalizable Self-Supervised Fine-Structured Monocular Depth Estimation (Youhong Wang et al., 2023)
...
### (5/56) A Theoretical and Practical Framework for Evaluating Uncertainty Calibration in Object Detection (Pedro Conde et al., 2023)
...
### (6/56) Fine-grained Recognition with Learnable Semantic Data Augmentation (Yifan Pu et al., 2023)
...
### (7/56) MuraNet: Multi-task Floor Plan Recognition with Relation Attention (Lingxiao Huang et al., 2023)
...
### (8/56) Robust Point Cloud Processing through Positional Embedding (Jianqiao Zheng et al., 2023)
...
### (9/56) Human trajectory prediction using LSTM with Attention mechanism (Amin Manafi Soltan Ahmadi et al., 2023)
...
### (10/56) Fine-Grained Spatiotemporal Motion Alignment for Contrastive Video Representation Learning (Minghao Zhu et al., 2023)
...
### (11/56) Interpretable Medical Imagery Diagnosis with Self-Attentive Transformers: A Review of Explainable AI for Health Care (Tin Lai, 2023)
...
### (12/56) Human-Inspired Facial Sketch Synthesis with Dynamic Adaptation (Fei Gao et al., 2023)
...
### (13/56) Baseline Defenses for Adversarial Attacks Against Aligned Language Models (Neel Jain et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2309.00614v1)  
...
### (14/56) Fast and Regret Optimal Best Arm Identification: Fundamental Limits and Low-Complexity Algorithms (Qining Zhang et al., 2023)
...
### (15/56) PolyGET: Accelerating Polymer Simulations by Accurate and Generalizable Forcefield with Equivariant Transformer (Rui Feng et al., 2023)
...
### (16/56) Curating Naturally Adversarial Datasets for Trustworthy AI in Healthcare (Sydney Pugh et al., 2023)
...
### (17/56) Geometry-aware Line Graph Transformer Pre-training for Molecular Property Prediction (Peizhen Bai et al., 2023)
...
### (18/56) Where Did the Gap Go? Reassessing the Long-Range Graph Benchmark (Jan Tönshoff et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2309.00367v1)  
...
### (19/56) FederatedScope-LLM: A Comprehensive Package for Fine-tuning Large Language Models in Federated Learning (Weirui Kuang et al., 2023)
...
### (20/56) Explainable Active Learning for Preference Elicitation (Furkan Cantürk et al., 2023)
...
### (21/56) Multi-fidelity reduced-order surrogate modeling (Paolo Conti et al., 2023)
...
### (22/56) Leveraging Learning Metrics for Improved Federated Learning (Andre Fu, 2023)
...
### (23/56) Why do universal adversarial attacks work on large language models?: Geometry might be the answer (Varshini Subhash et al., 2023)
...
### (24/56) NeuroSurgeon: A Toolkit for Subnetwork Analysis (Michael A. Lepori et al., 2023)
...
### (25/56) Image Hijacking: Adversarial Images can Control Generative Models at Runtime (Luke Bailey et al., 2023)
...
### (26/56) Subjectivity in Unsupervised Machine Learning Model Selection (Wanyi Chen et al., 2023)
...
### (27/56) Copiloting the Copilots: Fusing Large Language Models with Completion Engines for Automated Program Repair (Yuxiang Wei et al., 2023)
...
### (28/56) Mechanism of feature learning in convolutional neural networks (Daniel Beaglehole et al., 2023)
...
### (29/56) Catalyst Property Prediction with CatBERTa: Unveiling Feature Exploration Strategies through Large Language Models (Janghoon Ock et al., 2023)
...
### (30/56) NeMig -- A Bilingual News Collection and Knowledge Graph about Migration (Andreea Iana et al., 2023)
...
### (31/56) Towards Contrastive Learning in Music Video Domain (Karel Veldkamp et al., 2023)
...
### (32/56) A normative approach to radicalization in social networks (Vincent Bouttier et al., 2023)
...
### (33/56) Rural Access Index: A global study (Quan Sun et al., 2023)
...
### (34/56) Learning-based NLOS Detection and Uncertainty Prediction of GNSS Observations with Transformer-Enhanced LSTM Network (Haoming Zhang et al., 2023)
...
### (35/56) End-to-end Lidar-Driven Reinforcement Learning for Autonomous Racing (Meraj Mammadov, 2023)
...
### (36/56) Parallel Distributional Prioritized Deep Reinforcement Learning for Unmanned Aerial Vehicles (Alisson Henrique Kolling et al., 2023)
...
### (37/56) A FAIR File Format for Mathematical Software (Antony Della Vecchia et al., 2023)
...
### (38/56) CoNeTTE: An efficient Audio Captioning system leveraging multiple datasets with Task Embedding (Étienne Labbé et al., 2023)
...
### (39/56) Mi-Go: Test Framework which uses YouTube as Data Source for Evaluating Speech Recognition Models like OpenAI's Whisper (Tomasz Wojnar et al., 2023)
...
### (40/56) Declarative Reasoning on Explanations Using Constraint Logic Programming (Laura State et al., 2023)
...
### (41/56) On the Aggregation of Rules for Knowledge Graph Completion (Patrick Betz et al., 2023)
...
### (42/56) ALJP: An Arabic Legal Judgment Prediction in Personal Status Cases Using Machine Learning Models (Salwa Abbara et al., 2023)
...
### (43/56) BatchPrompt: Accomplish more with less (Jianzhe Lin et al., 2023)
...
### (44/56) When Do Discourse Markers Affect Computational Sentence Understanding? (Ruiqi Li et al., 2023)
...
### (45/56) Large Content And Behavior Models To Understand, Simulate, And Optimize Content And Behavior (Ashmit Khandelwal et al., 2023)
...
### (46/56) Comparative Topic Modeling for Determinants of Divergent Report Results Applied to Macular Degeneration Studies (Lucas Cassiel Jacaruso, 2023)
...
### (47/56) RLAIF: Scaling Reinforcement Learning from Human Feedback with AI Feedback (Harrison Lee et al., 2023)
...
### (48/56) Detecting Suicidality in Arabic Tweets Using Machine Learning and Deep Learning Techniques (Asma Abdulsalam et al., 2023)
...
### (49/56) FactLLaMA: Optimizing Instruction-Following Language Models with External Knowledge for Automated Fact-Checking (Tsun-Hin Cheung et al., 2023)
...
### (50/56) Publicly Shareable Clinical Large Language Model Built on Synthetic Clinical Notes (Sunjun Kweon et al., 2023)
...
### (51/56) JoTR: A Joint Transformer and Reinforcement Learning Framework for Dialog Policy Learning (Wai-Chung Kwan et al., 2023)
...
### (52/56) Large Language Models for Semantic Monitoring of Corporate Disclosures: A Case Study on Korea's Top 50 KOSPI Companies (Junwon Sung et al., 2023)
...
### (53/56) Will Sentiment Analysis Need Subculture? A New Data Augmentation Approach (Zhenhua Wang et al., 2023)
...
### (54/56) Bespoke Nanoparticle Synthesis and Chemical Knowledge Discovery Via Autonomous Experimentations (Hyuk Jun Yoo et al., 2023)
...
### (55/56) Application of Machine Learning in Melanoma Detection and the Identification of 'Ugly Duckling' and Suspicious Naevi: A Review (Fatima Al Zegair et al., 2023)
...
Keywords: AI  
[Paper Link](http://arxiv.org/abs/2309.00265v1)  
...
### (56/56) Security Verification of Low-Trust Architectures (Qinhan Tan et al., 2023)
