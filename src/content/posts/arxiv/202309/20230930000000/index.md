...
### (1/118) Learning to Transform for Generalizable Instance-wise Invariance (Utkarsh Singhal et al., 2023)
...
### (2/118) Demystifying CLIP Data (Hu Xu et al., 2023)
...
Keywords: ImageNet  
[Paper Link](http://arxiv.org/abs/2309.16671v1)  
...
### (3/118) SA2-Net: Scale-aware Attention Network for Microscopic Image Segmentation (Mustansar Fiaz et al., 2023)
...
### (4/118) Visual In-Context Learning for Few-Shot Eczema Segmentation (Neelesh Kumar et al., 2023)
...
### (5/118) FLIP: Cross-domain Face Anti-spoofing with Language Guidance (Koushik Srivatsan et al., 2023)
...
### (6/118) Improving Equivariance in State-of-the-Art Supervised Depth and Normal Predictors (Yuanyi Zhong et al., 2023)
...
### (7/118) Deep Geometrized Cartoon Line Inbetweening (Li Siyao et al., 2023)
...
### (8/118) KV Inversion: KV Embeddings Learning for Text-Conditioned Real Image Action Editing (Jiancheng Huang et al., 2023)
...
### (9/118) Tensor Factorization for Leveraging Cross-Modal Knowledge in Data-Constrained Infrared Object Detection (Manish Sharma et al., 2023)
...
### (10/118) Vision Transformers Need Registers (Timothée Darcet et al., 2023)
...
### (11/118) MotionLM: Multi-Agent Motion Forecasting as Language Modeling (Ari Seff et al., 2023)
...
### (12/118) Toloka Visual Question Answering Benchmark (Dmitry Ustalov et al., 2023)
...
### (13/118) Rethinking Domain Generalization: Discriminability and Generalizability (Shaocong Long et al., 2023)
...
### (14/118) Radar Instance Transformer: Reliable Moving Instance Segmentation in Sparse Radar Point Clouds (Matthias Zeller et al., 2023)
...
### (15/118) AutoCLIP: Auto-tuning Zero-Shot Classifiers for Vision-Language Models (Jan Hendrik Metzen et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2309.16414v1)  
...
### (16/118) HIC-YOLOv5: Improved YOLOv5 For Small Object Detection (Shiyi Tang et al., 2023)
...
### (17/118) Dark Side Augmentation: Generating Diverse Night Examples for Metric Learning (Albert Mohwald et al., 2023)
...
### (18/118) Logarithm-transform aided Gaussian Sampling for Few-Shot Learning (Vaibhav Ganatra, 2023)
...
### (19/118) Weakly-Supervised Video Anomaly Detection with Snippet Anomalous Attention (Yidan Fan et al., 2023)
...
### (20/118) Multi-scale Recurrent LSTM and Transformer Network for Depth Completion (Xiaogang Jia et al., 2023)
...
### (21/118) FORB: A Flat Object Retrieval Benchmark for Universal Image Embedding (Pengxiang Wu et al., 2023)
...
### (22/118) Object Motion Guided Human Motion Synthesis (Jiaman Li et al., 2023)
...
### (23/118) GAFlow: Incorporating Gaussian Attention into Optical Flow (Ao Luo et al., 2023)
...
### (24/118) VDC: Versatile Data Cleanser for Detecting Dirty Samples via Visual-Linguistic Inconsistency (Zihao Zhu et al., 2023)
...
### (25/118) Parameter-Saving Adversarial Training: Reinforcing Multi-Perturbation Robustness via Hypernetworks (Huihui Gong et al., 2023)
...
### (26/118) BEVHeight++: Toward Robust Visual Centric 3D Object Detection (Lei Yang et al., 2023)
...
### (27/118) Two-Step Active Learning for Instance Segmentation with Uncertainty and Diversity Sampling (Ke Yu et al., 2023)
...
### (28/118) Context-I2W: Mapping Images to Context-dependent Words for Accurate Zero-Shot Composed Image Retrieval (Yuanmin Tang et al., 2023)
...
### (29/118) A dual-branch model with inter- and intra-branch contrastive loss for long-tailed recognition (Qiong Chen et al., 2023)
...
### (30/118) MASK4D: Mask Transformer for 4D Panoptic Segmentation (Kadir Yilmaz et al., 2023)
...
### (31/118) Open Compound Domain Adaptation with Object Style Compensation for Semantic Segmentation (Tingliang Feng et al., 2023)
...
### (32/118) Channel Vision Transformers: An Image Is Worth C x 16 x 16 Words (Yujia Bao et al., 2023)
...
### (33/118) MindShift: Leveraging Large Language Models for Mental-States-Based Problematic Smartphone Use Intervention (Ruolan Wu et al., 2023)
...
### (34/118) Stress Testing Chain-of-Thought Prompting for Large Language Models (Aayush Mishra et al., 2023)
...
### (35/118) Qwen Technical Report (Jinze Bai et al., 2023)
...
### (36/118) Unlikelihood Tuning on Negative Samples Amazingly Improves Zero-Shot Translation (Changtong Zan et al., 2023)
...
### (37/118) GPT-Fathom: Benchmarking Large Language Models to Decipher the Evolutionary Path towards GPT-4 and Beyond (Shen Zheng et al., 2023)
...
### (38/118) A Benchmark for Learning to Translate a New Language from One Grammar Book (Garrett Tanzer et al., 2023)
...
### (39/118) Unsupervised Fact Verification by Language Model Distillation (Adrián Bazaga et al., 2023)
...
### (40/118) KLoB: a Benchmark for Assessing Knowledge Locating Methods in Language Models (Yiming Ju et al., 2023)
...
### (41/118) Prompt-and-Align: Prompt-Based Social Alignment for Few-Shot Fake News Detection (Jiaying Wu et al., 2023)
...
### (42/118) A Comprehensive Survey of Document-level Relation Extraction (2016-2022) (Julien Delaunay et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2309.16396v1)  
...
### (43/118) Human Feedback is not Gold Standard (Tom Hosking et al., 2023)
...
### (44/118) Augmenting transformers with recursively composed multi-grained representations (Xiang Hu et al., 2023)
...
### (45/118) At Which Training Stage Does Cocde Data Help LLMs Reasoning? (Yingwei Ma et al., 2023)
...
### (46/118) LawBench: Benchmarking Legal Knowledge of Large Language Models (Zhiwei Fei et al., 2023)
...
### (47/118) UPB @ ACTI: Detecting Conspiracies using fine tuned Sentence Transformers (Andrei Paraschiv et al., 2023)
...
### (48/118) Social Media Fashion Knowledge Extraction as Captioning (Yifei Yuan et al., 2023)
...
### (49/118) On the Challenges of Fully Incremental Neural Dependency Parsing (Ana Ezquerro et al., 2023)
...
### (50/118) Spider4SPARQL: A Complex Benchmark for Evaluating Knowledge Graph Question Answering Systems (Catherine Kosten et al., 2023)
...
### (51/118) Analyzing Political Figures in Real-Time: Leveraging YouTube Metadata for Sentiment Analysis (Danendra Athallariq Harya Putra et al., 2023)
...
### (52/118) Controllable Text Generation with Residual Memory Transformer (Hanqing Zhang et al., 2023)
...
### (53/118) Marathi-English Code-mixed Text Generation (Dhiraj Amin et al., 2023)
...
### (54/118) Using Weak Supervision and Data Augmentation in Question Answering (Chumki Basu et al., 2023)
...
### (55/118) Large Language Model Soft Ideologization via AI-Self-Consciousness (Xiaotian Zhou et al., 2023)
...
### (56/118) The Trickle-down Impact of Reward (In-)consistency on RLHF (Lingfeng Shen et al., 2023)
...
### (57/118) AE-GPT: Using Large Language Models to Extract Adverse Events from Surveillance Reports-A Use Case with Influenza Vaccine Adverse Events (Yiming Li et al., 2023)
...
### (58/118) The Confidence-Competence Gap in Large Language Models: A Cognitive Study (Aniket Kumar Singh et al., 2023)
...
### (59/118) Forgetting Private Textual Sequences in Language Models via Leave-One-Out Ensemble (Zhe Liu et al., 2023)
...
### (60/118) Mixup Your Own Pairs (Yilei Wu et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2309.16633v1)  
...
### (61/118) Robust Offline Reinforcement Learning -- Certify the Confidence Interval (Jiarui Yao et al., 2023)
...
### (62/118) Can LLMs Effectively Leverage Structural Information for Graph Learning: When and Why (Jin Huang et al., 2023)
...
### (63/118) Augment to Interpret: Unsupervised and Inherently Interpretable Graph Embeddings (Gregory Scafarto et al., 2023)
...
### (64/118) Uncertainty-Aware Decision Transformer for Stochastic Driving Environments (Zenan Li et al., 2023)
...
### (65/118) MHG-GNN: Combination of Molecular Hypergraph Grammar with Graph Neural Network (Akihiro Kishimoto et al., 2023)
...
### (66/118) Leveraging Pre-trained Language Models for Time Interval Prediction in Text-Enhanced Temporal Knowledge Graphs (Duygu Sezen Islakoglu et al., 2023)
...
### (67/118) Transformer-VQ: Linear-Time Transformers via Vector Quantization (Lucas D. Lingle, 2023)
...
### (68/118) ShapeDBA: Generating Effective Time Series Prototypes using ShapeDTW Barycenter Averaging (Ali Ismail-Fawaz et al., 2023)
...
### (69/118) LagrangeBench: A Lagrangian Fluid Mechanics Benchmarking Suite (Artur P. Toshev et al., 2023)
...
### (70/118) Efficiency Separation between RL Methods: Model-Free, Model-Based and Goal-Conditioned (Brieuc Pinon et al., 2023)
...
### (71/118) Beyond Reverse KL: Generalizing Direct Preference Optimization with Diverse Divergence Constraints (Chaoqi Wang et al., 2023)
...
### (72/118) Unmasking the Chameleons: A Benchmark for Out-of-Distribution Detection in Medical Tabular Data (Mohammad Azizmalayeri et al., 2023)
...
### (73/118) Distill to Delete: Unlearning in Graph Networks with Knowledge Distillation (Yash Sinha et al., 2023)
...
### (74/118) Generative Semi-supervised Learning with Meta-Optimized Synthetic Samples (Shin'ya Yamaguchi, 2023)
...
### (75/118) E2Net: Resource-Efficient Continual Learning with Elastic Expansion Network (RuiQi Liu et al., 2023)
...
### (76/118) Class Activation Map-based Weakly supervised Hemorrhage Segmentation using Resnet-LSTM in Non-Contrast Computed Tomography images (Shreyas H Ramananda et al., 2023)
...
### (77/118) Cross-Modal Transformer GAN: Brain Structural-Functional Deep Fusing Network for Alzheimer's Disease Analysis (Qiankun Zuo et al., 2023)
...
### (78/118) Depthwise Hyperparameter Transfer in Residual Networks: Dynamics and Scaling Limit (Blake Bordelon et al., 2023)
...
### (79/118) Generating Personalized Insulin Treatments Strategies with Deep Conditional Generative Time Series Models (Manuel Schürch et al., 2023)
...
### (80/118) 'AI enhances our performance, I have no doubt this one will do the same': The Placebo effect is robust to negative descriptions of AI (Agnes M. Kloft et al., 2023)
...
### (81/118) Does Explanation Matter? An Exploratory Study on the Effects of Covid 19 Misinformation Warning Flags on Social Media (Dipto Barman et al., 2023)
...
### (82/118) ACT2G: Attention-based Contrastive Learning for Text-to-Gesture Generation (Hitoshi Teshima et al., 2023)
...
### (83/118) Navigating Healthcare Insights: A Birds Eye View of Explainability with Knowledge Graphs (Satvik Garg et al., 2023)
...
### (84/118) Neuro Symbolic Reasoning for Planning: Counterexample Guided Inductive Synthesis using Large Language Models and Satisfiability Solving (Sumit Kumar Jha et al., 2023)
...
### (85/118) RLLTE: Long-Term Evolution Project of Reinforcement Learning (Mingqi Yuan et al., 2023)
...
### (86/118) GInX-Eval: Towards In-Distribution Evaluation of Graph Neural Network Explanations (Kenza Amara et al., 2023)
...
### (87/118) CoinRun: Solving Goal Misgeneralisation (Stuart Armstrong et al., 2023)
...
### (88/118) T-COL: Generating Counterfactual Explanations for General User Preferences on Variable Machine Learning Systems (Ming Wang et al., 2023)
...
### (89/118) TPE: Towards Better Compositional Reasoning over Conceptual Tools with Multi-persona Collaboration (Hongru Wang et al., 2023)
...
### (90/118) Audio-Visual Speaker Verification via Joint Cross-Attention (R. Gnana Praveen et al., 2023)
...
### (91/118) Efficient Supervised Training of Audio Transformers for Music Representation Learning (Pablo Alonso-Jiménez et al., 2023)
...
### (92/118) Predicting performance difficulty from piano sheet music images (Pedro Ramoneda et al., 2023)
...
### (93/118) NOMAD: Unsupervised Learning of Perceptual Embeddings for Speech Enhancement and Non-matching Reference Audio Quality Assessment (Alessandro Ragano et al., 2023)
...
### (94/118) Semantic Scene Difference Detection in Daily Life Patroling by Mobile Robots using Pre-Trained Large-Scale Vision-Language Model (Yoshiki Obinata et al., 2023)
...
### (95/118) QwenGrasp: A Usage of Large Vision Language Model for Target-oriented Grasping (Xinyu Chen et al., 2023)
...
### (96/118) Intrinsic Language-Guided Exploration for Complex Long-Horizon Robotic Manipulation Tasks (Eleftherios Triantafyllidis et al., 2023)
...
### (97/118) DiLu: A Knowledge-Driven Approach to Autonomous Driving with Large Language Models (Licheng Wen et al., 2023)
...
### (98/118) Laboratory Automation: Precision Insertion with Adaptive Fingers utilizing Contact through Sliding with Tactile-based Pose Estimation (Sameer Pai et al., 2023)
...
### (99/118) Learning to Terminate in Object Navigation (Yuhang Song et al., 2023)
...
### (100/118) D$^3$Fields: Dynamic 3D Descriptor Fields for Zero-Shot Generalizable Robotic Manipulation (Yixuan Wang et al., 2023)
...
### (101/118) Comparing Active Learning Performance Driven by Gaussian Processes or Bayesian Neural Networks for Constrained Trajectory Exploration (Sapphira Akins et al., 2023)
...
### (102/118) Infer and Adapt: Bipedal Locomotion Reward Learning from Demonstrations via Inverse Reinforcement Learning (Feiyang Wu et al., 2023)
...
### (103/118) SIMD Everywhere Optimization from ARM NEON to RISC-V Vector Extensions (Ju-Hung Li et al., 2023)
...
### (104/118) A Small World of Bad Guys: Investigating the Behavior of Hacker Groups in Cyber-Attacks (Giampiero Giacomello et al., 2023)
...
### (105/118) Cyber Sentinel: Exploring Conversational Agents in Streamlining Security Tasks with GPT-4 (Mehrdad Kaheh et al., 2023)
...
### (106/118) Assessing the Solvency of Virtual Asset Service Providers: Are Current Standards Sufficient? (Pietro Saggese et al., 2023)
...
### (107/118) Physics-Preserving AI-Accelerated Simulations of Plasma Turbulence (Robin Greif et al., 2023)
...
### (108/118) Libertas: Privacy-Preserving Computation for Decentralised Personal Data Stores (Rui Zhao et al., 2023)
...
### (109/118) Astroconformer: The Prospects of Analyzing Stellar Light Curves with Transformer-Based Deep Learning Models (Jia-Shu Pan et al., 2023)
...
### (110/118) TaxAI: A Dynamic Economic Simulator and Benchmark for Multi-Agent Reinforcement Learning (Qirui Mi et al., 2023)
...
### (111/118) A Framework to Assess Knowledge Graphs Accountability (Jennie Andersen et al., 2023)
...
### (112/118) Sampling Methods for Inner Product Sketching (Majid Daliri et al., 2023)
...
### (113/118) Cooperation Dynamics in Multi-Agent Systems: Exploring Game-Theoretic Scenarios with Mean-Field Equilibria (Vaigarai Sathi et al., 2023)
...
### (114/118) Language models in molecular discovery (Nikita Janakarajan et al., 2023)
...
### (115/118) Adaptive Real-Time Numerical Differentiation with Variable-Rate Forgetting and Exponential Resetting (Shashank Verma et al., 2023)
...
### (116/118) Let's Chat to Find the APIs: Connecting Human, LLM and Knowledge Graph through AI Chain (Qing Huang et al., 2023)
...
### (117/118) Test-Case-Driven Programming Understanding in Large Language Models for Better Code Generation (Zhao Tian et al., 2023)
...
### (118/118) Hierarchical Cross-Modality Knowledge Transfer with Sinkhorn Attention for CTC-based ASR (Xugang Lu et al., 2023)
