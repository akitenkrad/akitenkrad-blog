...
### (1/120) D3: Data Diversity Design for Systematic Generalization in Visual Question Answering (Amir Rahimi et al., 2023)
...
### (79/120) Detail Reinforcement Diffusion Model: Augmentation Fine-Grained Visual Categorization in Few-Shot Conditions (Tianxu Wu et al., 2023)
...
### (80/120) Reproducible Domain-Specific Knowledge Graphs in the Life Sciences: a Systematic Literature Review (Samira Babalou et al., 2023)
...
### (81/120) Diverse Neural Audio Embeddings -- Bringing Features back ! (Prateek Verma, 2023)
...
### (82/120) Exploring Meta Information for Audio-based Zero-shot Bird Classification (Alexander Gebhard et al., 2023)
...
### (83/120) HM-Conformer: A Conformer-based audio deepfake detection system with hierarchical pooling and multi-level classification token aggregation methods (Hyun-seo Shin et al., 2023)
...
### (84/120) Syn-Att: Synthetic Speech Attribution via Semi-Supervised Unknown Multi-Class Ensemble of CNNs (Md Awsafur Rahman et al., 2023)
...
### (85/120) Two-Step Knowledge Distillation for Tiny Speech Enhancement (Rayan Daod Nathoo et al., 2023)
...
### (86/120) Foundation Model Assisted Automatic Speech Emotion Recognition: Transcribing, Annotating, and Augmenting (Tiantian Feng et al., 2023)
...
### (87/120) MusiLingo: Bridging Music and Text with Pre-trained Language Models for Music Captioning and Query Response (Zihao Deng et al., 2023)
...
### (88/120) Chunked Attention-based Encoder-Decoder Model for Streaming Speech Recognition (Mohammad Zeineldeen et al., 2023)
...
### (89/120) Semi-supervised Sound Event Detection with Local and Global Consistency Regularization (Yiming Li et al., 2023)
...
### (90/120) One-Class Knowledge Distillation for Spoofing Speech Detection (Jingze Lu et al., 2023)
...
### (91/120) Cross-lingual Knowledge Distillation via Flow-based Voice Conversion for Robust Polyglot Text-To-Speech (Dariusz Piotrowski et al., 2023)
...
### (92/120) Libriheavy: a 50,000 hours ASR corpus with punctuation casing and context (Wei Kang et al., 2023)
...
### (93/120) SculptBot: Pre-Trained Models for 3D Deformable Object Manipulation (Alison Bartsch et al., 2023)
...
### (94/120) MOSAIC: Learning Unified Multi-Sensory Object Property Representations for Robot Perception (Gyan Tatiya et al., 2023)
...
### (95/120) OccupancyDETR: Making Semantic Scene Completion as Straightforward as Object Detection (Yupeng Jia et al., 2023)
...
### (96/120) Sim-to-Real Brush Manipulation using Behavior Cloning and Reinforcement Learning (Biao Jia et al., 2023)
...
### (97/120) Find What You Want: Learning Demand-conditioned Object Attribute Space for Demand-driven Navigation (Hongcheng Wang et al., 2023)
...
### (98/120) RELAX: Reinforcement Learning Enabled 2D-LiDAR Autonomous System for Parsimonious UAVs (Guanlin Wu et al., 2023)
...
### (99/120) Formalizing BPE Tokenization (Martin Berglund et al., 2023)
...
### (100/120) A More Secure Split: Enhancing the Security of Privacy-Preserving Split Learning (Tanveer Khan et al., 2023)
...
### (101/120) XFedHunter: An Explainable Federated Learning Framework for Advanced Persistent Threat Detection in SDN (Huynh Thai Thi et al., 2023)
...
### (102/120) VulnSense: Efficient Vulnerability Detection in Ethereum Smart Contracts by Multimodal Learning with Graph Neural Network and Language Model (Phan The Duy et al., 2023)
...
### (103/120) Probabilistic Constellation Shaping With Denoising Diffusion Probabilistic Models: A Novel Approach (Mehdi Letafati et al., 2023)
...
### (104/120) Denoising Diffusion Probabilistic Models for Hardware-Impaired Communications (Mehdi Letafati et al., 2023)
...
### (105/120) Bayes-Optimal Estimation in Generalized Linear Models via Spatial Coupling (Pablo Pascual Cobo et al., 2023)
...
### (106/120) Speeding up charge exchange recombination spectroscopy analysis in support of NERSC/DIII-D realtime workflow (Aarushi Jain et al., 2023)
...
Keywords: NER  
[Paper Link](http://arxiv.org/abs/2309.08687v2)  
...
### (107/120) Segment Anything Model for Brain Tumor Segmentation (Peng Zhang et al., 2023)
...
### (108/120) 3D SA-UNet: 3D Spatial Attention UNet with 3D ASPP for White Matter Hyperintensities Segmentation (Changlu Guo, 2023)
...
### (109/120) Reconsidering evaluation practices in modular systems: On the propagation of errors in MRI prostate cancer detection (Erlend Sortland Rolfsnes et al., 2023)
...
### (110/120) Cross-Modal Synthesis of Structural MRI and Functional Connectivity Networks via Conditional ViT-GANs (Yuda Bi et al., 2023)
...
### (111/120) Narratives of War: Ukrainian Memetic Warfare on Twitter (Yelena Mejova et al., 2023)
...
### (112/120) Talkin' 'Bout AI Generation: Copyright and the Generative-AI Supply Chain (Katherine Lee et al., 2023)
...
### (113/120) Topological Node2vec: Enhanced Graph Embedding via Persistent Homology (Yasuaki Hiraoka et al., 2023)
...
### (114/120) Silent Vulnerability-fixing Commit Identification Based on Graph Neural Networks (Hieu Dinh Vo et al., 2023)
...
### (115/120) Exploring the Potential of ChatGPT in Automated Code Refinement: An Empirical Study (Qi Guo et al., 2023)
...
### (116/120) 'I'm Not Confident in Debiasing AI Systems Since I Know Too Little': Teaching AI Creators About Gender Bias Through Hands-on Tutorials (Kyrie Zhixuan Zhou et al., 2023)
...
### (117/120) Empowering Private Tutoring by Chaining Large Language Models (Yulin Chen et al., 2023)
...
### (118/120) Low-rank Tensor Train Decomposition Using TensorSketch (Zhongming Chen et al., 2023)
...
### (119/120) Social media polarization reflects shifting political alliances in Pakistan (Anees Baqir et al., 2023)
...
### (120/120) A Stochastic Online Forecast-and-Optimize Framework for Real-Time Energy Dispatch in Virtual Power Plants under Uncertainty (Wei Jiang et al., 2023)
