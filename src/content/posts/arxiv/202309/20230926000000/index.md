...
Categories: cs-AI, cs-CV, cs.CV  
Keywords: AI  
[Paper Link](http://arxiv.org/abs/2309.13550v2)  
...
### (28/57) Global-correlated 3D-decoupling Transformer for Clothed Avatar Reconstruction (Zechuan Zhang et al., 2023)
...
Categories: cs-CV, cs.CV  
Keywords: Semantic Segmentation  
[Paper Link](http://arxiv.org/abs/2309.13505v2)  
...
### (35/57) ALLURE: Auditing and Improving LLM-based Evaluation of Text using Iterative In-Context-Learning (Hosein Hasanbeig et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2309.13701v2)  
