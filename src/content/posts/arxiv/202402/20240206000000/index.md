...
### (1/91) Variational DAG Estimation via State Augmentation With Stochastic Permutations (Edwin V. Bonilla et al., 2024)

{{<citation>}}

Edwin V. Bonilla, Pantelis Elinas, He Zhao, Maurizio Filippone, Vassili Kitsios, Terry O'Kane. (2024)  
**Variational DAG Estimation via State Augmentation With Stochastic Permutations**
<br/>
<button class="copy-to-clipboard" title="Variational DAG Estimation via State Augmentation With Stochastic Permutations" index=0>
...
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2402.02644v1.pdf" filename="2402.02644v1.pdf">Download PDF</button>
...
### (2/91) PROSAC: Provably Safe Certification for Machine Learning Models under Adversarial Attacks (Ziquan Liu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="PROSAC: Provably Safe Certification for Machine Learning Models under Adversarial Attacks" index=0>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-0 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (3/91) Stability Analysis of Various Symbolic Rule Extraction Methods from Recurrent Neural Network (Neisarg Dave et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Stability Analysis of Various Symbolic Rule Extraction Methods from Recurrent Neural Network" index=0>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-0 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (4/91) Enhancing Transformer RNNs with Multiple Temporal Perspectives (Razvan-Gabriel Dumitru et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Enhancing Transformer RNNs with Multiple Temporal Perspectives" index=0>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-0 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (5/91) Increasing Trust in Language Models through the Reuse of Verified Circuits (Philip Quirke et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Increasing Trust in Language Models through the Reuse of Verified Circuits" index=0>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-0 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (6/91) The Virtues of Pessimism in Inverse Reinforcement Learning (David Wu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="The Virtues of Pessimism in Inverse Reinforcement Learning" index=0>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-0 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (7/91) Accelerating Inverse Reinforcement Learning with Expert Bootstrapping (David Wu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Accelerating Inverse Reinforcement Learning with Expert Bootstrapping" index=0>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-0 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (8/91) Unified Training of Universal Time Series Forecasting Transformers (Gerald Woo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Unified Training of Universal Time Series Forecasting Transformers" index=0>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-0 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (9/91) ClipFormer: Key-Value Clipping of Transformers on Memristive Crossbars for Write Noise Mitigation (Abhiroop Bhattacharjee et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="ClipFormer: Key-Value Clipping of Transformers on Memristive Crossbars for Write Noise Mitigation" index=0>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-0 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (10/91) Foundation Model Makes Clustering a Better Initialization for Active Learning (Han Yuan et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Foundation Model Makes Clustering a Better Initialization for Active Learning" index=0>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-0 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (11/91) Weisfeiler Leman for Euclidean Equivariant Machine Learning (Snir Hordan et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Weisfeiler Leman for Euclidean Equivariant Machine Learning" index=0>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-0 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (12/91) BRAIn: Bayesian Reward-conditioned Amortized Inference for natural language generation from feedback (Gaurav Pandey et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="BRAIn: Bayesian Reward-conditioned Amortized Inference for natural language generation from feedback" index=0>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-0 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (13/91) A Graph is Worth $K$ Words: Euclideanizing Graph using Pure Transformer (Zhangyang Gao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Graph is Worth $K$ Words: Euclideanizing Graph using Pure Transformer" index=0>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-0 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (14/91) Discovering More Effective Tensor Network Structure Search Algorithms via Large Language Models (LLMs) (Junhua Zeng et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Discovering More Effective Tensor Network Structure Search Algorithms via Large Language Models (LLMs)" index=0>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-0 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (15/91) On the Role of Initialization on the Implicit Bias in Deep Linear Networks (Oria Gruber et al., 2024)

{{<citation>}}

Oria Gruber, Haim Avron. (2024)  
**On the Role of Initialization on the Implicit Bias in Deep Linear Networks**
<br/>
<button class="copy-to-clipboard" title="On the Role of Initialization on the Implicit Bias in Deep Linear Networks" index=0>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-0 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2402.02454v1.pdf" filename="2402.02454v1.pdf">Download PDF</button>
...
### (16/91) Breaking MLPerf Training: A Case Study on Optimizing BERT (Yongdeok Kim et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Breaking MLPerf Training: A Case Study on Optimizing BERT" index=0>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-0 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (17/91) LQER: Low-Rank Quantization Error Reconstruction for LLMs (Cheng Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="LQER: Low-Rank Quantization Error Reconstruction for LLMs" index=0>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-0 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (18/91) DiffStitch: Boosting Offline Reinforcement Learning with Diffusion-based Trajectory Stitching (Guanghe Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="DiffStitch: Boosting Offline Reinforcement Learning with Diffusion-based Trajectory Stitching" index=0>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-0 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (19/91) Towards an Information Theoretic Framework of Context-Based Offline Meta-Reinforcement Learning (Lanqing Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Towards an Information Theoretic Framework of Context-Based Offline Meta-Reinforcement Learning" index=0>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-0 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (20/91) Uni-RLHF: Universal Platform and Benchmark Suite for Reinforcement Learning with Diverse Human Feedback (Yifu Yuan et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Uni-RLHF: Universal Platform and Benchmark Suite for Reinforcement Learning with Diverse Human Feedback" index=0>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-0 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (21/91) FreDF: Learning to Forecast in Frequency Domain (Hao Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="FreDF: Learning to Forecast in Frequency Domain" index=0>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-0 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2402.02399v1.pdf" filename="2402.02399v1.pdf">Download PDF</button>
...
### (22/91) AutoTimes: Autoregressive Time Series Forecasters via Large Language Models (Yong Liu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="AutoTimes: Autoregressive Time Series Forecasters via Large Language Models" index=0>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-0 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (23/91) Timer: Transformers for Time Series Analysis at Scale (Yong Liu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Timer: Transformers for Time Series Analysis at Scale" index=0>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-0 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (24/91) Transolver: A Fast Transformer Solver for PDEs on General Geometries (Haixu Wu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Transolver: A Fast Transformer Solver for PDEs on General Geometries" index=0>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-0 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (25/91) Unification of Symmetries Inside Neural Networks: Transformer, Feedforward and Neural ODE (Koji Hashimoto et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Unification of Symmetries Inside Neural Networks: Transformer, Feedforward and Neural ODE" index=0>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-0 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (26/91) Minusformer: Improving Time Series Forecasting by Progressively Learning Residuals (Daojun Liang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Minusformer: Improving Time Series Forecasting by Progressively Learning Residuals" index=0>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-0 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (27/91) Active Learning for Graphs with Noisy Structures (Hongliang Chi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Active Learning for Graphs with Noisy Structures" index=0>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-0 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (28/91) INViT: A Generalizable Routing Problem Solver with Invariant Nested View Transformer (Han Fang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="INViT: A Generalizable Routing Problem Solver with Invariant Nested View Transformer" index=0>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-0 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (29/91) Selecting Large Language Model to Fine-tune via Rectified Scaling Law (Haowei Lin et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Selecting Large Language Model to Fine-tune via Rectified Scaling Law" index=0>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-0 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (30/91) Jailbreaking Attack against Multimodal Large Language Model (Zhenxing Niu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Jailbreaking Attack against Multimodal Large Language Model" index=0>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-0 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (31/91) 'It's how you do things that matters': Attending to Process to Better Serve Indigenous Communities with Language Technologies (Ned Cooper et al., 2024)

{{<citation>}}

Ned Cooper, Courtney Heldreth, Ben Hutchinson. (2024)  
...
<br/>
<button class="copy-to-clipboard" title="'It's how you do things that matters': Attending to Process to Better Serve Indigenous Communities with Language Technologies" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2402.02639v2.pdf" filename="2402.02639v2.pdf">Download PDF</button>
...
### (32/91) Can Large Language Models Learn Independent Causal Mechanisms? (Gaël Gendron et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Can Large Language Models Learn Independent Causal Mechanisms?" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (33/91) Predicting Machine Translation Performance on Low-Resource Languages: The Role of Domain Similarity (Eric Khiu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Predicting Machine Translation Performance on Low-Resource Languages: The Role of Domain Similarity" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (34/91) DenseFormer: Enhancing Information Flow in Transformers via Depth Weighted Averaging (Matteo Pagliardini et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="DenseFormer: Enhancing Information Flow in Transformers via Depth Weighted Averaging" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (35/91) Layer-Wise Analysis of Self-Supervised Acoustic Word Embeddings: A Study on Speech Emotion Recognition (Alexandra Saliba et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Layer-Wise Analysis of Self-Supervised Acoustic Word Embeddings: A Study on Speech Emotion Recognition" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (36/91) On the performance of phonetic algorithms in microtext normalization (Yerai Doval et al., 2024)

{{<citation>}}

Yerai Doval, Manuel Vilares, Jesús Vilares. (2024)  
**On the performance of phonetic algorithms in microtext normalization**
<br/>
<button class="copy-to-clipboard" title="On the performance of phonetic algorithms in microtext normalization" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2402.02591v1.pdf" filename="2402.02591v1.pdf">Download PDF</button>
...
### (37/91) DefInt: A Default-interventionist Framework for Efficient Reasoning with Hybrid Large Language Models (Yu Shang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="DefInt: A Default-interventionist Framework for Efficient Reasoning with Hybrid Large Language Models" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (38/91) Enhancing Robustness in Biomedical NLI Models: A Probing Approach for Clinical Trials (Ata Mustafa, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Enhancing Robustness in Biomedical NLI Models: A Probing Approach for Clinical Trials" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (39/91) Are Large Language Models Table-based Fact-Checkers? (Hangwen Zhang et al., 2024)
...
### (40/91) 'What's my model inside of?': Exploring the role of environments for grounded natural language understanding (Ronen Tamari, 2024)
...
<br/>
<button class="copy-to-clipboard" title="'What's my model inside of?': Exploring the role of environments for grounded natural language understanding" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (41/91) Knowledge Generation for Zero-shot Knowledge-based VQA (Rui Cao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Knowledge Generation for Zero-shot Knowledge-based VQA" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (42/91) Factuality of Large Language Models in the Year 2024 (Yuxia Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Factuality of Large Language Models in the Year 2024" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (43/91) Aligner: Achieving Efficient Alignment through Weak-to-Strong Correction (Jiaming Ji et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Aligner: Achieving Efficient Alignment through Weak-to-Strong Correction" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (44/91) GLaPE: Gold Label-agnostic Prompt Evaluation and Optimization for Large Language Model (Xuanchang Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="GLaPE: Gold Label-agnostic Prompt Evaluation and Optimization for Large Language Model" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (45/91) KICGPT: Large Language Model with Knowledge in Context for Knowledge Graph Completion (Yanbin Wei et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="KICGPT: Large Language Model with Knowledge in Context for Knowledge Graph Completion" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (46/91) Evaluating Large Language Models in Analysing Classroom Dialogue (Yun Long et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Evaluating Large Language Models in Analysing Classroom Dialogue" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (47/91) A Survey of Large Language Models in Finance (FinLLMs) (Jean Lee et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Survey of Large Language Models in Finance (FinLLMs)" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (48/91) Key-Graph Transformer for Image Restoration (Bin Ren et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Key-Graph Transformer for Image Restoration" index=2>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (49/91) Spatio-temporal Prompting Network for Robust Video Feature Extraction (Guanxiong Sun et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Spatio-temporal Prompting Network for Robust Video Feature Extraction" index=2>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-2 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (50/91) Generalizable Entity Grounding via Assistance of Large Language Model (Lu Qi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Generalizable Entity Grounding via Assistance of Large Language Model" index=2>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-2 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (51/91) DeSparsify: Adversarial Attack Against Token Sparsification Mechanisms in Vision Transformers (Oryan Yehezkel et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="DeSparsify: Adversarial Attack Against Token Sparsification Mechanisms in Vision Transformers" index=2>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-2 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (52/91) LHRS-Bot: Empowering Remote Sensing with VGI-Enhanced Large Multimodal Language Model (Dilxat Muhtar et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="LHRS-Bot: Empowering Remote Sensing with VGI-Enhanced Large Multimodal Language Model" index=2>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-2 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (53/91) Embedding Non-Distortive Cancelable Face Template Generation (Dmytro Zakharov et al., 2024)

{{<citation>}}

Dmytro Zakharov, Oleksandr Kuznetsov, Emanuele Frontoni, Natalia Kryvinska. (2024)  
**Embedding Non-Distortive Cancelable Face Template Generation**
<br/>
<button class="copy-to-clipboard" title="Embedding Non-Distortive Cancelable Face Template Generation" index=2>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-2 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2402.02540v1.pdf" filename="2402.02540v1.pdf">Download PDF</button>
...
### (54/91) GeReA: Question-Aware Prompt Captions for Knowledge-based Visual Question Answering (Ziyu Ma et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="GeReA: Question-Aware Prompt Captions for Knowledge-based Visual Question Answering" index=2>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-2 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (55/91) AI Art Neural Constellation: Revealing the Collective and Contrastive State of AI-Generated and Human Art (Faizan Farooq Khan et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="AI Art Neural Constellation: Revealing the Collective and Contrastive State of AI-Generated and Human Art" index=2>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-2 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (56/91) BECLR: Batch Enhanced Contrastive Few-Shot Learning (Stylianos Poulakakis-Daktylidis et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="BECLR: Batch Enhanced Contrastive Few-Shot Learning" index=2>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-2 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (57/91) Learning Mutual Excitation for Hand-to-Hand and Human-to-Human Interaction Recognition (Mengyuan Liu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Learning Mutual Excitation for Hand-to-Hand and Human-to-Human Interaction Recognition" index=2>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-2 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (58/91) AI-Generated Content Enhanced Computer-Aided Diagnosis Model for Thyroid Nodules: A ChatGPT-Style Assistant (Jincao Yao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="AI-Generated Content Enhanced Computer-Aided Diagnosis Model for Thyroid Nodules: A ChatGPT-Style Assistant" index=2>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-2 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (59/91) NOAH: Learning Pairwise Object Category Attentions for Image Classification (Chao Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="NOAH: Learning Pairwise Object Category Attentions for Image Classification" index=2>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-2 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (60/91) PromptRR: Diffusion Models as Prompt Generators for Single Image Reflection Removal (Tao Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="PromptRR: Diffusion Models as Prompt Generators for Single Image Reflection Removal" index=2>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-2 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (61/91) M$^3$Face: A Unified Multi-Modal Multilingual Framework for Human Face Generation and Editing (Mohammadreza Mofayezi et al., 2024)

{{<citation>}}

Mohammadreza Mofayezi, Reza Alipour, Mohammad Ali Kakavand, Ehsaneddin Asgari. (2024)  
**M$^3$Face: A Unified Multi-Modal Multilingual Framework for Human Face Generation and Editing**
<br/>
<button class="copy-to-clipboard" title="M$^3$Face: A Unified Multi-Modal Multilingual Framework for Human Face Generation and Editing" index=2>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-2 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2402.02369v1.pdf" filename="2402.02369v1.pdf">Download PDF</button>
...
### (62/91) Exploring Intrinsic Properties of Medical Images for Self-Supervised Binary Semantic Segmentation (Pranav Singh et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Exploring Intrinsic Properties of Medical Images for Self-Supervised Binary Semantic Segmentation" index=2>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-2 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (63/91) Closed-Loop Unsupervised Representation Disentanglement with $β$-VAE Distillation and Diffusion Probabilistic Feedback (Xin Jin et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Closed-Loop Unsupervised Representation Disentanglement with $β$-VAE Distillation and Diffusion Probabilistic Feedback" index=2>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-2 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (64/91) Learning Semantic Proxies from Visual Prompts for Parameter-Efficient Fine-Tuning in Deep Metric Learning (Li Ren et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Learning Semantic Proxies from Visual Prompts for Parameter-Efficient Fine-Tuning in Deep Metric Learning" index=2>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-2 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (65/91) GIRT-Model: Automated Generation of Issue Report Templates (Nafiseh Nikeghbal et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="GIRT-Model: Automated Generation of Issue Report Templates" index=3>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (66/91) UniTSyn: A Large-Scale Dataset Capable of Enhancing the Prowess of Large Language Models for Program Testing (Yifeng He et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="UniTSyn: A Large-Scale Dataset Capable of Enhancing the Prowess of Large Language Models for Program Testing" index=3>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-3 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (67/91) Cryptographically Assured Information Flow: Assured Remote Execution (Scott L. Dyer et al., 2024)

{{<citation>}}

Scott L. Dyer, Christian A. Femrite, Joshua D. Guttman, Julian P. Lanson, Moses D. Liskov. (2024)  
**Cryptographically Assured Information Flow: Assured Remote Execution**
<br/>
<button class="copy-to-clipboard" title="Cryptographically Assured Information Flow: Assured Remote Execution" index=4>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2402.02630v1.pdf" filename="2402.02630v1.pdf">Download PDF</button>
...
### (68/91) Flexible Non-interactive Short-term Implicit Certificate Generation for VANETs (Rui Liu et al., 2024)

{{<citation>}}

Rui Liu, Yun Lu, Jianping Pan. (2024)  
**Flexible Non-interactive Short-term Implicit Certificate Generation for VANETs**
<br/>
<button class="copy-to-clipboard" title="Flexible Non-interactive Short-term Implicit Certificate Generation for VANETs" index=4>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-4 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2402.02607v1.pdf" filename="2402.02607v1.pdf">Download PDF</button>
...
### (69/91) Evading Deep Learning-Based Malware Detectors via Obfuscation: A Deep Reinforcement Learning Approach (Brian Etter et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Evading Deep Learning-Based Malware Detectors via Obfuscation: A Deep Reinforcement Learning Approach" index=4>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-4 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (70/91) XAI-CF -- Examining the Role of Explainable Artificial Intelligence in Cyber Forensics (Shahid Alam et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="XAI-CF -- Examining the Role of Explainable Artificial Intelligence in Cyber Forensics" index=4>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-4 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (71/91) Copyright Protection in Generative AI: A Technical Perspective (Jie Ren et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Copyright Protection in Generative AI: A Technical Perspective" index=4>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-4 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (72/91) Spin: An Efficient Secure Computation Framework with GPU Acceleration (Wuxuan Jiang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Spin: An Efficient Secure Computation Framework with GPU Acceleration" index=4>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-4 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (73/91) A Safe Reinforcement Learning driven Weights-varying Model Predictive Control for Autonomous Vehicle Motion Control (Baha Zarrouki et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Safe Reinforcement Learning driven Weights-varying Model Predictive Control for Autonomous Vehicle Motion Control" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (74/91) Obstacle Avoidance Deep Reinforcement Learning-Based Trajectory Planner with Robust Low-Level Control for Robotic Manipulators (Mehdi Heydari Shahna et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Obstacle Avoidance Deep Reinforcement Learning-Based Trajectory Planner with Robust Low-Level Control for Robotic Manipulators" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (75/91) Angle Robustness Unmanned Aerial Vehicle Navigation in GNSS-Denied Scenarios (Yuxin Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Angle Robustness Unmanned Aerial Vehicle Navigation in GNSS-Denied Scenarios" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (76/91) A Survey on Robotics with Foundation Models: toward Embodied AI (Zhiyuan Xu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Survey on Robotics with Foundation Models: toward Embodied AI" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (77/91) Efficient Market Dynamics: Unraveling Informational Efficiency in UK Horse Racing Betting Markets Through Betfair's Time Series Analysis (Narayan Tondapu, 2024)

{{<citation>}}

Narayan Tondapu. (2024)  
...
<br/>
<button class="copy-to-clipboard" title="Efficient Market Dynamics: Unraveling Informational Efficiency in UK Horse Racing Betting Markets Through Betfair's Time Series Analysis" index=6>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2402.02623v1.pdf" filename="2402.02623v1.pdf">Download PDF</button>
...
### (78/91) PuzzleBench: Can LLMs Solve Challenging First-Order Combinatorial Reasoning Problems? (Chinmay Mittal et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="PuzzleBench: Can LLMs Solve Challenging First-Order Combinatorial Reasoning Problems?" index=7>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (79/91) Delivery Optimized Discovery in Behavioral User Segmentation under Budget Constrain (Harshita Chopra et al., 2024)

{{<citation>}}

Harshita Chopra, Atanu R. Sinha, Sunav Choudhary, Ryan A. Rossi, Paavan Kumar Indela, Veda Pranav Parwatala, Srinjayee Paul, Aurghya Maiti. (2024)  
**Delivery Optimized Discovery in Behavioral User Segmentation under Budget Constrain**
<br/>
<button class="copy-to-clipboard" title="Delivery Optimized Discovery in Behavioral User Segmentation under Budget Constrain" index=7>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-7 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2402.03388v1.pdf" filename="2402.03388v1.pdf">Download PDF</button>
...
### (80/91) DeLLMa: A Framework for Decision Making Under Uncertainty with Large Language Models (Ollie Liu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="DeLLMa: A Framework for Decision Making Under Uncertainty with Large Language Models" index=7>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-7 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (81/91) Enhance Reasoning for Large Language Models in the Game Werewolf (Shuang Wu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Enhance Reasoning for Large Language Models in the Game Werewolf" index=7>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-7 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (82/91) Large Language Model for Table Processing: A Survey (Weizheng Lu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Large Language Model for Table Processing: A Survey" index=7>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-7 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (83/91) Neuromorphic hardware for sustainable AI data centers (Bernhard Vogginger et al., 2024)

{{<citation>}}

Bernhard Vogginger, Amirhossein Rostami, Vaibhav Jain, Sirine Arfa, Andreas Hantsch, David Kappel, Michael Schäfer, Ulrike Faltings, Hector A. Gonzalez, Chen Liu, Christian Mayr. (2024)  
**Neuromorphic hardware for sustainable AI data centers**
<br/>
<button class="copy-to-clipboard" title="Neuromorphic hardware for sustainable AI data centers" index=8>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2402.02521v1.pdf" filename="2402.02521v1.pdf">Download PDF</button>
...
### (84/91) Deep Supervision by Gaussian Pseudo-label-based Morphological Attention for Abdominal Aorta Segmentation in Non-Contrast CTs (Qixiang Ma et al., 2024)

{{<citation>}}

Qixiang Ma, Antoine Lucas, Adrien Kaladji, Pascal Haigron. (2024)  
...
<br/>
<button class="copy-to-clipboard" title="Deep Supervision by Gaussian Pseudo-label-based Morphological Attention for Abdominal Aorta Segmentation in Non-Contrast CTs" index=9>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2402.02514v1.pdf" filename="2402.02514v1.pdf">Download PDF</button>
...
### (85/91) VM-UNet: Vision Mamba UNet for Medical Image Segmentation (Jiacheng Ruan et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="VM-UNet: Vision Mamba UNet for Medical Image Segmentation" index=9>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-9 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (86/91) Vision Transformer-based Multimodal Feature Fusion Network for Lymphoma Segmentation on PET/CT Images (Huan Huang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Vision Transformer-based Multimodal Feature Fusion Network for Lymphoma Segmentation on PET/CT Images" index=9>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-9 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
### (87/91) Device Scheduling and Assignment in Hierarchical Federated Learning for Internet of Things (Tinghao Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Device Scheduling and Assignment in Hierarchical Federated Learning for Internet of Things" index=10>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (88/91) eXplainable Bayesian Multi-Perspective Generative Retrieval (EuiYul Song et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="eXplainable Bayesian Multi-Perspective Generative Retrieval" index=11>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (89/91) History of generative Artificial Intelligence (AI) chatbots: past, present, and future development (Md. Al-Amin et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="History of generative Artificial Intelligence (AI) chatbots: past, present, and future development" index=12>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (90/91) Large Language Model Adaptation for Networking (Duo Wu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Large Language Model Adaptation for Networking" index=13>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (91/91) Predicting Tweet Posting Behavior on Citizen Security: A Hawkes Point Process Analysis (Cristian Pulido et al., 2024)

{{<citation>}}

Cristian Pulido, Francisco Gómez. (2024)  
**Predicting Tweet Posting Behavior on Citizen Security: A Hawkes Point Process Analysis**
<br/>
<button class="copy-to-clipboard" title="Predicting Tweet Posting Behavior on Citizen Security: A Hawkes Point Process Analysis" index=14>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2402.03378v1.pdf" filename="2402.03378v1.pdf">Download PDF</button>
