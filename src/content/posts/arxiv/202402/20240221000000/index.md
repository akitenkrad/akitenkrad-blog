...
### (1/102 | 1/330) ArtPrompt: ASCII Art-based Jailbreak Attacks against Aligned LLMs (Fengqing Jiang et al., 2024)
...
### (2/102 | 2/330) Graph-Based Retriever Captures the Long Tail of Biomedical Knowledge (Julien Delile et al., 2024)
...
### (3/102 | 3/330) Is Open-Source There Yet? A Comparative Study on Commercial and Open-Source LLMs in Their Ability to Label Chest X-Ray Reports (Felix J. Dorfner et al., 2024)
...
### (4/102 | 4/330) BIDER: Bridging Knowledge Inconsistency for Efficient Retrieval-Augmented LLMs via Key Supporting Evidence (Jiajie Jin et al., 2024)
...
### (5/102 | 5/330) Your Large Language Model is Secretly a Fairness Proponent and You Should Prompt it Like One (Tianlin Li et al., 2024)
...
### (6/102 | 6/330) Meta Ranking: Less Capable Language Models are Capable for Single Response Judgement (Zijun Liu et al., 2024)
...
### (7/102 | 7/330) Modularized Networks for Few-shot Hateful Meme Detection (Rui Cao et al., 2024)
...
### (8/102 | 8/330) End-to-end multilingual fact-checking at scale (Vinay Setty, 2024)
...
### (9/102 | 9/330) Creating a Fine Grained Entity Type Taxonomy Using LLMs (Michael Gunn et al., 2024)
...
### (10/102 | 10/330) Do Large Language Models Understand Logic or Just Mimick Context? (Junbing Yan et al., 2024)
...
### (11/102 | 11/330) Where It Really Matters: Few-Shot Environmental Conservation Media Monitoring for Low-Resource Languages (Sameer Jain et al., 2024)
...
### (12/102 | 12/330) Structured Chain-of-Thought Prompting for Few-Shot Generation of Content-Grounded QA Conversations (Md Arafat Sultan et al., 2024)
...
### (13/102 | 13/330) In-Context Learning Demonstration Selection via Influence Analysis (Vinay M. S. et al., 2024)
...
### (14/102 | 14/330) ARKS: Active Retrieval in Knowledge Soup for Code Generation (Hongjin Su et al., 2024)
...
### (15/102 | 15/330) MRKE: The Multi-hop Reasoning Evaluation of LLMs by Knowledge Edition (Jian Wu et al., 2024)
...
### (16/102 | 16/330) Reformatted Alignment (Run-Ze Fan et al., 2024)
...
### (17/102 | 17/330) Distilling Large Language Models for Text-Attributed Graph Learning (Bo Pan et al., 2024)
...
### (18/102 | 18/330) SIBO: A Simple Booster for Parameter-Efficient Fine-Tuning (Zhihao Wen et al., 2024)
...
### (19/102 | 19/330) Standardize: Aligning Language Models with Expert-Defined Standards for Content Generation (Joseph Marvin Imperial et al., 2024)
...
### (20/102 | 20/330) Parallel Structures in Pre-training Data Yield In-Context Learning (Yanda Chen et al., 2024)
...
### (21/102 | 21/330) Task-Oriented Dialogue with In-Context Learning (Tom Bocklisch et al., 2024)
...
### (22/102 | 22/330) Analysis of Multidomain Abstractive Summarization Using Salience Allocation (Tohida Rehman et al., 2024)
...
### (23/102 | 23/330) Investigating Multi-Hop Factual Shortcuts in Knowledge Editing of Large Language Models (Tianjie Ju et al., 2024)
...
### (24/102 | 24/330) ChatGPT Based Data Augmentation for Improved Parameter-Efficient Debiasing of LLMs (Pengrui Han et al., 2024)
...
### (25/102 | 25/330) Speech Translation with Speech Foundation Models and Large Language Models: What is There and What is Missing? (Marco Gaido et al., 2024)
...
### (26/102 | 26/330) HU at SemEval-2024 Task 8A: Can Contrastive Learning Learn Embeddings to Detect Machine-Generated Text? (Shubhashis Roy Dipta et al., 2024)
...
### (27/102 | 27/330) A synthetic data approach for domain generalization of NLI models (Mohammad Javad Hosseini et al., 2024)
...
### (28/102 | 28/330) NEO-BENCH: Evaluating Robustness of Large Language Models with Neologisms (Jonathan Zheng et al., 2024)
...
### (29/102 | 29/330) Model Tailor: Mitigating Catastrophic Forgetting in Multi-modal Large Language Models (Didi Zhu et al., 2024)
...
### (30/102 | 30/330) TrustScore: Reference-Free Evaluation of LLM Response Trustworthiness (Danna Zheng et al., 2024)
...
### (31/102 | 31/330) Your Vision-Language Model Itself Is a Strong Filter: Towards High-Quality Instruction Tuning with Data Selection (Ruibo Chen et al., 2024)
...
### (32/102 | 32/330) GTBench: Uncovering the Strategic Reasoning Limitations of LLMs via Game-Theoretic Evaluations (Jinhao Duan et al., 2024)
...
### (33/102 | 33/330) Emulated Disalignment: Safety Alignment for Large Language Models May Backfire! (Zhanhui Zhou et al., 2024)
...
### (35/102 | 35/330) Towards Cross-Tokenizer Distillation: the Universal Logit Distillation Loss for LLMs (Nicolas Boizard et al., 2024)
...
### (36/102 | 36/330) Uncovering Latent Human Wellbeing in Language Model Embeddings (Pedro Freire et al., 2024)
...
### (37/102 | 37/330) Artifacts or Abduction: How Do LLMs Answer Multiple-Choice Questions Without the Question? (Nishant Balepur et al., 2024)
...
### (38/102 | 38/330) Browse and Concentrate: Comprehending Multimodal Content via prior-LLM Context Fusion (Ziyue Wang et al., 2024)
...
### (39/102 | 39/330) Adaptive Skeleton Graph Decoding (Shuowei Jin et al., 2024)
...
### (40/102 | 40/330) Transformer-based Causal Language Models Perform Clustering (Xinbo Wu et al., 2024)
...
### (41/102 | 41/330) EmoBench: Evaluating the Emotional Intelligence of Large Language Models (Sahand Sabour et al., 2024)
...
### (42/102 | 42/330) How Interpretable are Reasoning Explanations from Prompting Large Language Models? (Yeo Wei Jie et al., 2024)
...
### (43/102 | 43/330) FIPO: Free-form Instruction-oriented Prompt Optimization with Preference Dataset and Modular Fine-tuning Schema (Junru Lu et al., 2024)
...
### (44/102 | 44/330) Language Models are Homer Simpson! Safety Re-Alignment of Fine-tuned Language Models through Task Arithmetic (Rishabh Bhardwaj et al., 2024)
...
### (45/102 | 45/330) TILP: Differentiable Learning of Temporal Logical Rules on Knowledge Graphs (Siheng Xiong et al., 2024)
...
### (46/102 | 46/330) Understanding Fine-grained Distortions in Reports of Scientific Findings (Amelie Wührl et al., 2024)
...
### (47/102 | 47/330) Query-Based Adversarial Prompt Generation (Jonathan Hayase et al., 2024)
...
### (48/102 | 48/330) Key ingredients for effective zero-shot cross-lingual knowledge transfer in generative tasks (Nadezhda Chirkova et al., 2024)
...
### (49/102 | 49/330) Analysis of Levenshtein Transformer's Decoder and Its Variants (Ruiyang Zhou, 2024)
...
### (50/102 | 50/330) Polarization of Autonomous Generative AI Agents Under Echo Chambers (Masaya Ohagi, 2024)
...
### (51/102 | 51/330) A Chinese Dataset for Evaluating the Safeguards in Large Language Models (Yuxia Wang et al., 2024)
...
### (52/102 | 52/330) Is It a Free Lunch for Removing Outliers during Pretraining? (Baohao Liao et al., 2024)
...
### (53/102 | 53/330) Small Models, Big Insights: Leveraging Slim Proxy Models To Decide When and What to Retrieve for LLMs (Jiejun Tan et al., 2024)
...
### (54/102 | 54/330) Remember This Event That Year? Assessing Temporal Information and Reasoning in Large Language Models (Himanshu Beniwal et al., 2024)
...
### (55/102 | 55/330) Direct Large Language Model Alignment Through Self-Rewarding Contrastive Prompt Distillation (Aiwei Liu et al., 2024)
...
### (56/102 | 56/330) The Colorful Future of LLMs: Evaluating and Improving LLMs as Emotional Supporters for Queer Youth (Shir Lissak et al., 2024)
...
### (57/102 | 57/330) Generation Meets Verification: Accelerating Large Language Model Inference with Smart Parallel Auto-Correct Decoding (Hanling Yi et al., 2024)
...
### (58/102 | 58/330) Unveiling the Magic: Investigating Attention Distillation in Retrieval-augmented Generation (Zizhong Li et al., 2024)
...
### (59/102 | 59/330) MARS: Meaning-Aware Response Scoring for Uncertainty Estimation in Generative LLMs (Yavuz Faruk Bakman et al., 2024)
...
### (60/102 | 60/330) Ontology Enhanced Claim Detection (Zehra Melce Hüsünbeyi et al., 2024)
...
### (61/102 | 61/330) AnaloBench: Benchmarking the Identification of Abstract and Long-context Analogies (Xiao Ye et al., 2024)
...
### (62/102 | 62/330) LEMMA: Towards LVLM-Enhanced Multimodal Misinformation Detection with External Knowledge Augmentation (Keyang Xuan et al., 2024)
...
### (63/102 | 63/330) Shallow Synthesis of Knowledge in GPT-Generated Texts: A Case Study in Automatic Related Work Composition (Anna Martin-Boyle et al., 2024)
...
### (64/102 | 64/330) A Systematic Comparison of Contextualized Word Embeddings for Lexical Semantic Change (Francesco Periti et al., 2024)
...
### (65/102 | 65/330) Learning to Edit: Aligning LLMs with Knowledge Editing (Yuxin Jiang et al., 2024)
...
### (66/102 | 66/330) GenAudit: Fixing Factual Errors in Language Model Outputs with Evidence (Kundan Krishna et al., 2024)
...
### (67/102 | 67/330) Confidence Matters: Revisiting Intrinsic Self-Correction Capabilities of Large Language Models (Loka Li et al., 2024)
...
### (68/102 | 68/330) Emergent Word Order Universals from Cognitively-Motivated Language Models (Tatsuki Kuribayashi et al., 2024)
...
### (69/102 | 69/330) High-quality Data-to-Text Generation for Severely Under-Resourced Languages with Out-of-the-box Large Language Models (Michela Lorandi et al., 2024)
...
### (70/102 | 70/330) Empirical Study on Updating Key-Value Memories in Transformer Feed-forward Layers (Zihan Qiu et al., 2024)
...
### (71/102 | 71/330) Groot: Adversarial Testing for Generative Text-to-Image Models with Tree-based Semantic Transformation (Yi Liu et al., 2024)
...
### (72/102 | 72/330) Can LLMs Compute with Reasons? (Harshit Sandilya et al., 2024)
...
### (73/102 | 73/330) Are LLM-based Evaluators Confusing NLG Quality Criteria? (Xinyu Hu et al., 2024)
...
### (74/102 | 74/330) Automatic Evaluation for Mental Health Counseling using LLMs (Anqi Li et al., 2024)
...
### (75/102 | 75/330) SoLA: Solver-Layer Adaption of LLM for Better Logic Reasoning (Yu Zhang et al., 2024)
...
### (76/102 | 76/330) Revisiting Knowledge Distillation for Autoregressive Language Models (Qihuang Zhong et al., 2024)
...
### (77/102 | 77/330) ROSE Doesn't Do That: Boosting the Safety of Instruction-Tuned Large Language Models with Reverse Prompt Contrastive Decoding (Qihuang Zhong et al., 2024)
...
### (78/102 | 78/330) Head-wise Shareable Attention for Large Language Models (Zouying Cao et al., 2024)
...
### (79/102 | 79/330) What Evidence Do Language Models Find Convincing? (Alexander Wan et al., 2024)
...
### (80/102 | 80/330) M2K-VDG: Model-Adaptive Multimodal Knowledge Anchor Enhanced Video-grounded Dialogue Generation (Hongcheng Liu et al., 2024)
...
### (81/102 | 81/330) AnyGPT: Unified Multimodal LLM with Discrete Sequence Modeling (Jun Zhan et al., 2024)
...
### (82/102 | 82/330) Triple-Encoders: Representations That Fire Together, Wire Together (Justus-Jonas Erker et al., 2024)
...
### (83/102 | 83/330) HunFlair2 in a cross-corpus evaluation of biomedical named entity recognition and normalization tools (Mario Sänger et al., 2024)
...
### (84/102 | 84/330) Understanding the Effects of Noise in Text-to-SQL: An Examination of the BIRD-Bench Benchmark (Niklas Wretblad et al., 2024)
...
### (85/102 | 85/330) Language Model Adaptation to Specialized Domains through Selective Masking based on Genre and Topical Characteristics (Anas Belfathi et al., 2024)
...
### (86/102 | 86/330) Comprehensive Cognitive LLM Agent for Smartphone GUI Automation (Xinbei Ma et al., 2024)
...
### (87/102 | 87/330) Have Seen Me Before? Automating Dataset Updates Towards Reliable and Timely Evaluation (Jiahao Ying et al., 2024)
...
### (88/102 | 88/330) Do Pre-Trained Language Models Detect and Understand Semantic Underspecification? Ask the DUST! (Frank Wildenburg et al., 2024)
...
### (89/102 | 89/330) Sequoia: Scalable, Robust, and Hardware-aware Speculative Decoding (Zhuoming Chen et al., 2024)
...
### (90/102 | 90/330) Zero shot VLMs for hate meme detection: Are we there yet? (Naquee Rizwan et al., 2024)
...
### (91/102 | 91/330) Amplifying Training Data Exposure through Fine-Tuning with Pseudo-Labeled Memberships (Myung Gyo Oh et al., 2024)
...
### (92/102 | 92/330) Acquiring Clean Language Models from Backdoor Poisoned Datasets by Downscaling Frequency Space (Zongru Wu et al., 2024)
...
### (93/102 | 93/330) Compress to Impress: Unleashing the Potential of Compressive Memory in Real-World Long-Term Conversations (Nuo Chen et al., 2024)
...
### (94/102 | 94/330) Team QUST at SemEval-2024 Task 8: A Comprehensive Study of Monolingual and Multilingual Approaches for Detecting AI-generated Text (Xiaoman Xu et al., 2024)
...
### (95/102 | 95/330) Semantic Textual Similarity Assessment in Chest X-ray Reports Using a Domain-Specific Cosine-Based Metric (Sayeh Gholipour Picha et al., 2024)
...
### (96/102 | 96/330) Evaluating Image Review Ability of Vision Language Models (Shigeki Saito et al., 2024)
...
### (97/102 | 97/330) Evolving AI Collectives to Enhance Human Diversity and Enable Self-Regulation (Shiyang Lai et al., 2024)
...
### (98/102 | 98/330) Archer: A Human-Labeled Text-to-SQL Dataset with Arithmetic, Commonsense and Hypothetical Reasoning (Danna Zheng et al., 2024)
...
### (99/102 | 99/330) LLM Agents for Psychology: A Study on Gamified Assessments (Qisen Yang et al., 2024)
...
### (100/102 | 100/330) KARL: Knowledge-Aware Retrieval and Representations aid Retention and Learning in Students (Matthew Shu et al., 2024)
...
### (101/102 | 101/330) What Do Dialect Speakers Want? A Survey of Attitudes Towards Language Technology for German Dialects (Verena Blaschke et al., 2024)
...
### (102/102 | 102/330) CausalGym: Benchmarking causal interpretability methods on linguistic tasks (Aryaman Arora et al., 2024)
...
### (1/69 | 103/330) A Critical Evaluation of AI Feedback for Aligning Large Language Models (Archit Sharma et al., 2024)
...
### (2/69 | 104/330) SPML: A DSL for Defending Language Models Against Prompt Attacks (Reshabh K Sharma et al., 2024)
...
### (3/69 | 105/330) Robust CLIP: Unsupervised Adversarial Fine-Tuning of Vision Embeddings for Robust Large Vision-Language Models (Christian Schlarmann et al., 2024)
...
### (4/69 | 106/330) Self-AMPLIFY: Improving Small Language Models with Self Post Hoc Explanations (Milan Bhan et al., 2024)
...
### (5/69 | 107/330) Mafin: Enhancing Black-Box Embeddings with Model Augmented Fine-tuning (Mingtian Zhang et al., 2024)
...
### (6/69 | 108/330) DB-LLM: Accurate Dual-Binarization for Efficient LLMs (Hong Chen et al., 2024)
...
### (7/69 | 109/330) Hierarchical Bayes Approach to Personalized Federated Unsupervised Learning (Kaan Ozkara et al., 2024)
...
### (8/69 | 110/330) Towards Cross-Domain Continual Learning (Marcus de Carvalho et al., 2024)
...
### (9/69 | 111/330) Uncertainty quantification in fine-tuned LLMs using LoRA ensembles (Oleksandr Balabanov et al., 2024)
...
### (10/69 | 112/330) WKVQuant: Quantizing Weight and Key/Value Cache for Large Language Models Gains More (Yuxuan Yue et al., 2024)
...
### (11/69 | 113/330) UniST: A Prompt-Empowered Universal Model for Urban Spatio-Temporal Prediction (Yuan Yuan et al., 2024)
...
### (12/69 | 114/330) Tables as Images? Exploring the Strengths and Limitations of LLMs on Multimodal Representations of Tabular Data (Naihao Deng et al., 2024)
...
### (13/69 | 115/330) Neuro-mimetic Task-free Unsupervised Online Learning with Continual Self-Organizing Maps (Hitesh Vaidya et al., 2024)
...
### (14/69 | 116/330) Endowing Pre-trained Graph Models with Provable Fairness (Zhongjian Zhang et al., 2024)
...
### (15/69 | 117/330) On the Byzantine-Resilience of Distillation-Based Federated Learning (Christophe Roux et al., 2024)
...
### (16/69 | 118/330) All Language Models Large and Small (Zhixun Chen et al., 2024)
...
### (17/69 | 119/330) Reinforcement Learning as a Parsimonious Alternative to Prediction Cascades: A Case Study on Image Segmentation (Bharat Srikishan et al., 2024)
...
### (18/69 | 120/330) Synthetic location trajectory generation using categorical diffusion models (Simon Dirmeier et al., 2024)
...
### (19/69 | 121/330) Generative Semi-supervised Graph Anomaly Detection (Hezhe Qiao et al., 2024)
...
### (20/69 | 122/330) Locality-Sensitive Hashing-Based Efficient Point Transformer with Applications in High-Energy Physics (Siqi Miao et al., 2024)
...
### (21/69 | 123/330) The Edge-of-Reach Problem in Offline Model-Based Reinforcement Learning (Anya Sims et al., 2024)
...
### (22/69 | 124/330) Convergence of Gradient Descent for Recurrent Neural Networks: A Nonasymptotic Analysis (Semih Cayci et al., 2024)
...
### (23/69 | 125/330) Cluster Metric Sensitivity to Irrelevant Features (Miles McCrory et al., 2024)
...
### (24/69 | 126/330) EBFT: Effective and Block-Wise Fine-Tuning for Sparse LLMs (Song Guo et al., 2024)
...
### (25/69 | 127/330) SLADE: Detecting Dynamic Anomalies in Edge Streams without Labels via Self-Supervised Learning (Jongha Lee et al., 2024)
...
### (26/69 | 128/330) A Generative Pre-Training Framework for Spatio-Temporal Graph Transfer Learning (Yuan Yuan et al., 2024)
...
### (27/69 | 129/330) Microstructures and Accuracy of Graph Recall by Large Language Models (Yanbang Wang et al., 2024)
...
### (28/69 | 130/330) Induced Model Matching: How Restricted Models Can Help Larger Ones (Usama Muneeb et al., 2024)
...
### (29/69 | 131/330) In deep reinforcement learning, a pruned network is a good network (Johan Obando-Ceron et al., 2024)
...
### (30/69 | 132/330) Universal Physics Transformers (Benedikt Alkin et al., 2024)
...
### (31/69 | 133/330) Generating Survival Interpretable Trajectories and Data (Andrei V. Konstantinov et al., 2024)
...
### (32/69 | 134/330) Towards a tailored mixed-precision sub-8bit quantization scheme for Gated Recurrent Units using Genetic Algorithms (Riccardo Miccini et al., 2024)
...
### (33/69 | 135/330) Revisiting Data Augmentation in Deep Reinforcement Learning (Jianshu Hu et al., 2024)
...
### (34/69 | 136/330) Beyond Uniform Scaling: Exploring Depth Heterogeneity in Neural Architectures (Akash Guna R. T et al., 2024)
...
### (35/69 | 137/330) LoRA Training in the NTK Regime has No Spurious Local Minima (Uijeong Jang et al., 2024)
...
### (36/69 | 138/330) PARCv2: Physics-aware Recurrent Convolutional Neural Networks for Spatiotemporal Dynamics Modeling (Phong C. H. Nguyen et al., 2024)

{{<citation>}}

Phong C. H. Nguyen, Xinlun Cheng, Shahab Arfaza, Pradeep Seshadri, Yen T. Nguyen, Munho Kim, Sanghun Choi, H. S. Udaykumar, Stephen Baek. (2024)  
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.12503v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2402.12503v1.pdf" filename="2402.12503v1.pdf">Download PDF</button>
...
### (37/69 | 139/330) End-to-end Supervised Prediction of Arbitrary-size Graphs with Partially-Masked Fused Gromov-Wasserstein Matching (Paul Krzakala et al., 2024)
...
### (38/69 | 140/330) A Mechanistic Analysis of a Transformer Trained on a Symbolic Multi-Step Reasoning Task (Jannik Brinkmann et al., 2024)
...
### (39/69 | 141/330) Self-Guided Robust Graph Structure Refinement (Yeonjun In et al., 2024)
...
### (40/69 | 142/330) Easy as ABCs: Unifying Boltzmann Q-Learning and Counterfactual Regret Minimization (Luca D'Amico-Wong et al., 2024)
...
### (41/69 | 143/330) Offline Multi-task Transfer RL with Representational Penalization (Avinandan Bose et al., 2024)
...
### (42/69 | 144/330) Dynamic Environment Responsive Online Meta-Learning with Fairness Awareness (Chen Zhao et al., 2024)
...
### (43/69 | 145/330) Refining Minimax Regret for Unsupervised Environment Design (Michael Beukman et al., 2024)
...
### (44/69 | 146/330) Dictionary Learning Improves Patch-Free Circuit Discovery in Mechanistic Interpretability: A Case Study on Othello-GPT (Zhengfu He et al., 2024)
...
### (45/69 | 147/330) MLFEF: Machine Learning Fusion Model with Empirical Formula to Explore the Momentum in Competitive Sports (Ruixin Peng et al., 2024)
...
### (46/69 | 148/330) Linear bandits with polylogarithmic minimax regret (Josep Lumbreras et al., 2024)
...
### (47/69 | 149/330) Bayesian Active Learning for Censored Regression (Frederik Boe Hüttel et al., 2024)
...
### (48/69 | 150/330) Stochastic Approximation with Delayed Updates: Finite-Time Rates under Markovian Sampling (Arman Adibi et al., 2024)
...
### (49/69 | 151/330) Generative Kaleidoscopic Networks (Harsh Shrivastava, 2024)
...
### (50/69 | 152/330) Diagonalisation SGD: Fast & Convergent SGD for Non-Differentiable Models via Reparameterisation and Smoothing (Dominik Wagner et al., 2024)
...
### (51/69 | 153/330) Gaussian Process Neural Additive Models (Wei Zhang et al., 2024)
...
### (52/69 | 154/330) Energy-Efficient Edge Learning via Joint Data Deepening-and-Prefetching (Sujin Kook et al., 2024)
...
### (53/69 | 155/330) FairProof : Confidential and Certifiable Fairness for Neural Networks (Chhavi Yadav et al., 2024)
...
### (54/69 | 156/330) Dynamic Pricing and Learning with Long-term Reference Effects (Shipra Agrawal et al., 2024)
...
### (55/69 | 157/330) SDEs for Minimax Optimization (Enea Monzio Compagnoni et al., 2024)
...
### (56/69 | 158/330) LoRA+: Efficient Low Rank Adaptation of Large Models (Soufiane Hayou et al., 2024)
...
### (57/69 | 159/330) BEARS Make Neuro-Symbolic Models Aware of their Reasoning Shortcuts (Emanuele Marconato et al., 2024)
...
### (58/69 | 160/330) Learning Discretized Bayesian Networks with GOMEA (Damy M. F. Ha et al., 2024)
...
### (59/69 | 161/330) Federated Bayesian Network Ensembles (Florian van Daalen et al., 2024)
...
### (60/69 | 162/330) Interpretable Brain-Inspired Representations Improve RL Performance on Visual Navigation Tasks (Moritz Lange et al., 2024)
...
### (61/69 | 163/330) Mini-Hes: A Parallelizable Second-order Latent Factor Analysis Model (Jialiang Wang et al., 2024)
...
### (62/69 | 164/330) Predicting trucking accidents with truck drivers 'safety climate perception across companies: A transfer learning approach (Kailai Sun et al., 2024)
...
### (63/69 | 165/330) Vehicle-group-based Crash Risk Formation and Propagation Analysis for Expressways (Tianheng Zhu et al., 2024)
...
### (64/69 | 166/330) Finite-Time Error Analysis of Online Model-Based Q-Learning with a Relaxed Sampling Model (Han-Dong Lim et al., 2024)
...
### (65/69 | 167/330) Communication-Efficient Distributed Learning with Local Immediate Error Compensation (Yifei Cheng et al., 2024)
...
### (66/69 | 168/330) Class-incremental Learning for Time Series: Benchmark and Evaluation (Zhongzheng Qiao et al., 2024)
...
### (67/69 | 169/330) Network Inversion of Binarised Neural Nets (Pirzada Suhail et al., 2024)
...
### (68/69 | 170/330) Graph-based Virtual Sensing from Sparse and Partial Multivariate Observations (Giovanni De Felice et al., 2024)
...
### (69/69 | 171/330) Dynamic Multi-Network Mining of Tensor Time Series (Kohei Obata et al., 2024)
...
### (1/8 | 172/330) LLM as Prompter: Low-resource Inductive Reasoning on Arbitrary Knowledge Graphs (Kai Wang et al., 2024)
...
### (2/8 | 173/330) HIP Network: Historical Information Passing Network for Extrapolation Reasoning on Temporal Knowledge Graph (Yongquan He et al., 2024)
...
### (3/8 | 174/330) A Survey on Extractive Knowledge Graph Summarization: Applications, Approaches, Evaluation, and Future Directions (Xiaxia Wang et al., 2024)
...
### (4/8 | 175/330) SSTKG: Simple Spatio-Temporal Knowledge Graph for Intepretable and Versatile Dynamic Information Embedding (Ruiyi Yang et al., 2024)
...
### (5/8 | 176/330) Shall We Talk: Exploring Spontaneous Collaborations of Competing LLM Agents (Zengqing Wu et al., 2024)
...
### (6/8 | 177/330) WorldCoder, a Model-Based LLM Agent: Building World Models by Writing Code and Interacting with the Environment (Hao Tang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="WorldCoder, a Model-Based LLM Agent: Building World Models by Writing Code and Interacting with the Environment" index=177>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (7/8 | 178/330) Discerning and Resolving Knowledge Conflicts through Adaptive Decoding with Contextual Information-Entropy Constraint (Xiaowei Yuan et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Discerning and Resolving Knowledge Conflicts through Adaptive Decoding with Contextual Information-Entropy Constraint" index=178>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (8/8 | 179/330) MultiFIX: An XAI-friendly feature inducing approach to building models from multimodal data (Mafalda Malafaia et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="MultiFIX: An XAI-friendly feature inducing approach to building models from multimodal data" index=179>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/3 | 180/330) Enhancing Large Language Models for Text-to-Testcase Generation (Saranya Alagarsamy et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Enhancing Large Language Models for Text-to-Testcase Generation" index=180>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/3 | 181/330) CodeArt: Better Code Models by Attention Regularization When Symbols Are Lacking (Zian Su et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="CodeArt: Better Code Models by Attention Regularization When Symbols Are Lacking" index=181>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/3 | 182/330) Parallel Program Analysis on Path Ranges (Jan Haltermanna et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Parallel Program Analysis on Path Ranges" index=182>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/8 | 183/330) Stealing the Invisible: Unveiling Pre-Trained CNN Models through Adversarial Examples and Timing Side-Channels (Shubhi Shukla et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Stealing the Invisible: Unveiling Pre-Trained CNN Models through Adversarial Examples and Timing Side-Channels" index=183>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/8 | 184/330) CovRL: Fuzzing JavaScript Engines with Coverage-Guided Reinforcement Learning for LLM-based Mutation (Jueon Eom et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="CovRL: Fuzzing JavaScript Engines with Coverage-Guided Reinforcement Learning for LLM-based Mutation" index=184>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/8 | 185/330) Evaluation of ChatGPT's Smart Contract Auditing Capabilities Based on Chain of Thought (Yuying Du et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Evaluation of ChatGPT's Smart Contract Auditing Capabilities Based on Chain of Thought" index=185>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/8 | 186/330) An Empirical Evaluation of LLMs for Solving Offensive Security Challenges (Minghao Shao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="An Empirical Evaluation of LLMs for Solving Offensive Security Challenges" index=186>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/8 | 187/330) Defending Against Weight-Poisoning Backdoor Attacks for Parameter-Efficient Fine-Tuning (Shuai Zhao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Defending Against Weight-Poisoning Backdoor Attacks for Parameter-Efficient Fine-Tuning" index=187>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (6/8 | 188/330) Deployment of Advanced and Intelligent Logistics Vehicles with Enhanced Tracking and Security Features (Iqtiar Md Siddique et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Deployment of Advanced and Intelligent Logistics Vehicles with Enhanced Tracking and Security Features" index=188>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (7/8 | 189/330) An Interview Study on Third-Party Cyber Threat Hunting Processes in the U.S. Department of Homeland Security (William P. Maxam III et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="An Interview Study on Third-Party Cyber Threat Hunting Processes in the U.S. Department of Homeland Security" index=189>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (8/8 | 190/330) Attack Tree Generation via Process Mining (Alyzia-Maria Konsta et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Attack Tree Generation via Process Mining" index=190>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/7 | 191/330) FeB4RAG: Evaluating Federated Search in the Context of Retrieval Augmented Generation (Shuai Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="FeB4RAG: Evaluating Federated Search in the Context of Retrieval Augmented Generation" index=191>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/7 | 192/330) Ask Optimal Questions: Aligning Large Language Models with Retriever's Preference in Conversational Search (Chanwoong Yoon et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Ask Optimal Questions: Aligning Large Language Models with Retriever's Preference in Conversational Search" index=192>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/7 | 193/330) Explain then Rank: Scale Calibration of Neural Rankers Using Natural Language Explanations from Large Language Models (Puxuan Yu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Explain then Rank: Scale Calibration of Neural Rankers Using Natural Language Explanations from Large Language Models" index=193>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/7 | 194/330) Leveraging Opposite Gender Interaction Ratio as a Path towards Fairness in Online Dating Recommendations Based on User Sexual Orientation (Yuying Zhao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Leveraging Opposite Gender Interaction Ratio as a Path towards Fairness in Online Dating Recommendations Based on User Sexual Orientation" index=194>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/7 | 195/330) Large Language Models for Stemming: Promises, Pitfalls and Failures (Shuai Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Large Language Models for Stemming: Promises, Pitfalls and Failures" index=195>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (6/7 | 196/330) Heterogeneity-aware Cross-school Electives Recommendation: a Hybrid Federated Approach (Chengyi Ju et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Heterogeneity-aware Cross-school Electives Recommendation: a Hybrid Federated Approach" index=196>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (7/7 | 197/330) TriSampler: A Better Negative Sampling Principle for Dense Retrieval (Zhen Yang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="TriSampler: A Better Negative Sampling Principle for Dense Retrieval" index=197>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/45 | 198/330) PhySU-Net: Long Temporal Context Transformer for rPPG with Self-Supervised Pre-training (Marko Savic et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="PhySU-Net: Long Temporal Context Transformer for rPPG with Self-Supervised Pre-training" index=198>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/45 | 199/330) A Lightweight Parallel Framework for Blind Image Quality Assessment (Qunyue Huang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Lightweight Parallel Framework for Blind Image Quality Assessment" index=199>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/45 | 200/330) Rock Classification Based on Residual Networks (Sining Zhoubian et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Rock Classification Based on Residual Networks" index=200>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/45 | 201/330) ChartX & ChartVLM: A Versatile Benchmark and Foundation Model for Complicated Chart Reasoning (Renqiu Xia et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="ChartX & ChartVLM: A Versatile Benchmark and Foundation Model for Complicated Chart Reasoning" index=201>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/45 | 202/330) MM-SurvNet: Deep Learning-Based Survival Risk Stratification in Breast Cancer Through Multimodal Data Fusion (Raktim Kumar Mondol et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="MM-SurvNet: Deep Learning-Based Survival Risk Stratification in Breast Cancer Through Multimodal Data Fusion" index=202>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (15/45 | 212/330) Integrating kNN with Foundation Models for Adaptable and Privacy-Aware Image Classification (Sebastian Doerrich et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Integrating kNN with Foundation Models for Adaptable and Privacy-Aware Image Classification" index=212>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (16/45 | 213/330) Multilinear Mixture of Experts: Scalable Expert Specialization through Factorization (James Oldfield et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Multilinear Mixture of Experts: Scalable Expert Specialization through Factorization" index=213>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (17/45 | 214/330) System Identification of Neural Systems: Going Beyond Images to Modelling Dynamics (Mai Gamal et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="System Identification of Neural Systems: Going Beyond Images to Modelling Dynamics" index=214>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (18/45 | 215/330) FiT: Flexible Vision Transformer for Diffusion Model (Zeyu Lu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="FiT: Flexible Vision Transformer for Diffusion Model" index=215>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (19/45 | 216/330) 3D Vascular Segmentation Supervised by 2D Annotation of Maximum Intensity Projection (Zhanqiang Guo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="3D Vascular Segmentation Supervised by 2D Annotation of Maximum Intensity Projection" index=216>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (20/45 | 217/330) ISCUTE: Instance Segmentation of Cables Using Text Embedding (Shir Kozlovsky et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="ISCUTE: Instance Segmentation of Cables Using Text Embedding" index=217>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (21/45 | 218/330) InMD-X: Large Language Models for Internal Medicine Doctors (Hansle Gwon et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="InMD-X: Large Language Models for Internal Medicine Doctors" index=218>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (22/45 | 219/330) SDGE: Stereo Guided Depth Estimation for 360° Camera Sets (Jialei Xu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="SDGE: Stereo Guided Depth Estimation for 360° Camera Sets" index=219>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (23/45 | 220/330) Separating common from salient patterns with Contrastive Representation Learning (Robin Louiset et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Separating common from salient patterns with Contrastive Representation Learning" index=220>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (24/45 | 221/330) Feudal Networks for Visual Navigation (Faith Johnson et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Feudal Networks for Visual Navigation" index=221>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (25/45 | 222/330) UnlearnCanvas: A Stylized Image Dataset to Benchmark Machine Unlearning for Diffusion Models (Yihua Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="UnlearnCanvas: A Stylized Image Dataset to Benchmark Machine Unlearning for Diffusion Models" index=222>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (26/45 | 223/330) Avoiding Feature Suppression in Contrastive Learning: Learning What Has Not Been Learned Before (Jihai Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Avoiding Feature Suppression in Contrastive Learning: Learning What Has Not Been Learned Before" index=223>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (27/45 | 224/330) LangXAI: Integrating Large Vision Models for Generating Textual Explanations to Enhance Explainability in Visual Perception Tasks (Truong Thanh Hung Nguyen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="LangXAI: Integrating Large Vision Models for Generating Textual Explanations to Enhance Explainability in Visual Perception Tasks" index=224>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (28/45 | 225/330) DriveVLM: The Convergence of Autonomous Driving and Large Vision-Language Models (Xiaoyu Tian et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="DriveVLM: The Convergence of Autonomous Driving and Large Vision-Language Models" index=225>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (29/45 | 226/330) Surround-View Fisheye Optics in Computer Vision and Simulation: Survey and Challenge (Daniel Jakab et al., 2024)

{{<citation>}}

Daniel Jakab, Brian Michael Deegan, Sushil Sharma, Eoin Martino Grua, Jonathan Horgan, Enda Ward, Pepijn Van De Ven, Anthony Scanlan, Ciaran Eising. (2024)  
**Surround-View Fisheye Optics in Computer Vision and Simulation: Survey and Challenge**
<br/>
<button class="copy-to-clipboard" title="Surround-View Fisheye Optics in Computer Vision and Simulation: Survey and Challenge" index=226>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 20  
Keywords: Simulation, Simulator  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.12041v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2402.12041v1.pdf" filename="2402.12041v1.pdf">Download PDF</button>
...
### (30/45 | 227/330) Language-guided Image Reflection Separation (Haofeng Zhong et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Language-guided Image Reflection Separation" index=227>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (31/45 | 228/330) AICAttack: Adversarial Image Captioning Attack with Attention-Based Optimization (Jiyao Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="AICAttack: Adversarial Image Captioning Attack with Attention-Based Optimization" index=228>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (32/45 | 229/330) DiLightNet: Fine-grained Lighting Control for Diffusion-based Image Generation (Chong Zeng et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="DiLightNet: Fine-grained Lighting Control for Diffusion-based Image Generation" index=229>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (33/45 | 230/330) Interpretable Embedding for Ad-hoc Video Search (Jiaxin Wu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Interpretable Embedding for Ad-hoc Video Search" index=230>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (34/45 | 231/330) Landmark-based Localization using Stereo Vision and Deep Learning in GPS-Denied Battlefield Environment (Ganesh Sapkota et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Landmark-based Localization using Stereo Vision and Deep Learning in GPS-Denied Battlefield Environment" index=231>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (35/45 | 232/330) UncertaintyTrack: Exploiting Detection and Localization Uncertainty in Multi-Object Tracking (Chang Won Lee et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="UncertaintyTrack: Exploiting Detection and Localization Uncertainty in Multi-Object Tracking" index=232>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (36/45 | 233/330) Mixed Gaussian Flow for Diverse Trajectory Prediction (Jiahe Chen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Mixed Gaussian Flow for Diverse Trajectory Prediction" index=233>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (37/45 | 234/330) Perceiving Longer Sequences With Bi-Directional Cross-Attention Transformers (Markus Hiller et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Perceiving Longer Sequences With Bi-Directional Cross-Attention Transformers" index=234>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (38/45 | 235/330) Human Video Translation via Query Warping (Haiming Zhu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Human Video Translation via Query Warping" index=235>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (39/45 | 236/330) One2Avatar: Generative Implicit Head Avatar For Few-shot User Adaptation (Zhixuan Yu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="One2Avatar: Generative Implicit Head Avatar For Few-shot User Adaptation" index=236>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (40/45 | 237/330) ComFusion: Personalized Subject Generation in Multiple Specific Scenes From Single Image (Yan Hong et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="ComFusion: Personalized Subject Generation in Multiple Specific Scenes From Single Image" index=237>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (41/45 | 238/330) WildFake: A Large-scale Challenging Dataset for AI-Generated Images Detection (Yan Hong et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="WildFake: A Large-scale Challenging Dataset for AI-Generated Images Detection" index=238>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (42/45 | 239/330) An evaluation of Deep Learning based stereo dense matching dataset shift from aerial images and a large scale stereo dataset (Teng Wu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="An evaluation of Deep Learning based stereo dense matching dataset shift from aerial images and a large scale stereo dataset" index=239>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (43/45 | 240/330) Binary Opacity Grids: Capturing Fine Geometric Detail for Mesh-Based View Synthesis (Christian Reiser et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Binary Opacity Grids: Capturing Fine Geometric Detail for Mesh-Based View Synthesis" index=240>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (44/45 | 241/330) Pushing Auto-regressive Models for 3D Shape Generation at Capacity and Scalability (Xuelin Qian et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Pushing Auto-regressive Models for 3D Shape Generation at Capacity and Scalability" index=241>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (45/45 | 242/330) Unveiling the Depths: A Multi-Modal Fusion Framework for Challenging Scenarios (Jialei Xu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Unveiling the Depths: A Multi-Modal Fusion Framework for Challenging Scenarios" index=242>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/5 | 243/330) Multimodal Emotion Recognition from Raw Audio with Sinc-convolution (Xiaohui Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Multimodal Emotion Recognition from Raw Audio with Sinc-convolution" index=243>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/5 | 244/330) On the Semantic Latent Space of Diffusion-Based Text-to-Speech Models (Miri Varshavsky Hassid et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="On the Semantic Latent Space of Diffusion-Based Text-to-Speech Models" index=244>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/5 | 245/330) SECP: A Speech Enhancement-Based Curation Pipeline For Scalable Acquisition Of Clean Speech (Adam Sabra et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="SECP: A Speech Enhancement-Based Curation Pipeline For Scalable Acquisition Of Clean Speech" index=245>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/5 | 246/330) Unraveling Complex Data Diversity in Underwater Acoustic Target Recognition through Convolution-based Mixture of Experts (Yuan Xie et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Unraveling Complex Data Diversity in Underwater Acoustic Target Recognition through Convolution-based Mixture of Experts" index=246>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/5 | 247/330) Low-power SNN-based audio source localisation using a Hilbert Transform spike encoding scheme (Saeid Haghighatshoar et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Low-power SNN-based audio source localisation using a Hilbert Transform spike encoding scheme" index=247>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/5 | 248/330) Attacks on Node Attributes in Graph Neural Networks (Ying Xu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Attacks on Node Attributes in Graph Neural Networks" index=248>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/5 | 249/330) Analysis of Persian News Agencies on Instagram, A Words Co-occurrence Graph-based Approach (Mohammad Heydari et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Analysis of Persian News Agencies on Instagram, A Words Co-occurrence Graph-based Approach" index=249>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/5 | 250/330) A Machine Learning Ensemble Model for the Detection of Cyberbullying (Abulkarim Faraj Alqahtani et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Machine Learning Ensemble Model for the Detection of Cyberbullying" index=250>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/5 | 251/330) Bridging or Breaking: Impact of Intergroup Interactions on Religious Polarization (Rochana Chaturvedi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Bridging or Breaking: Impact of Intergroup Interactions on Religious Polarization" index=251>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/5 | 252/330) Deep Structural Knowledge Exploitation and Synergy for Estimating Node Importance Value on Heterogeneous Information Networks (Yankai Chen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Deep Structural Knowledge Exploitation and Synergy for Estimating Node Importance Value on Heterogeneous Information Networks" index=252>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/11 | 253/330) SInViG: A Self-Evolving Interactive Visual Agent for Human-Robot Interaction (Jie Xu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="SInViG: A Self-Evolving Interactive Visual Agent for Human-Robot Interaction" index=253>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/11 | 254/330) Decentralized Multi-Robot Navigation for Autonomous Surface Vehicles with Distributional Reinforcement Learning (Xi Lin et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Decentralized Multi-Robot Navigation for Autonomous Surface Vehicles with Distributional Reinforcement Learning" index=254>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/11 | 255/330) DIO: Dataset of 3D Mesh Models of Indoor Objects for Robotics and Computer Vision Applications (Nillan Nimal et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="DIO: Dataset of 3D Mesh Models of Indoor Objects for Robotics and Computer Vision Applications" index=255>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/11 | 256/330) Learning Input Constrained Control Barrier Functions for Guaranteed Safety of Car-Like Robots (Sven Brüggemann et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Learning Input Constrained Control Barrier Functions for Guaranteed Safety of Car-Like Robots" index=256>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/11 | 257/330) Talk Through It: End User Directed Manipulation Learning (Carl Winge et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Talk Through It: End User Directed Manipulation Learning" index=257>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (6/11 | 258/330) A novel framework for adaptive stress testing of autonomous vehicles in highways (Linh Trinh et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A novel framework for adaptive stress testing of autonomous vehicles in highways" index=258>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (7/11 | 259/330) Decentralized Lifelong Path Planning for Multiple Ackerman Car-Like Robots (Teng Guo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Decentralized Lifelong Path Planning for Multiple Ackerman Car-Like Robots" index=259>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (8/11 | 260/330) From Reals to Logic and Back: Inventing Symbolic Vocabularies, Actions and Models for Planning from Raw Data (Naman Shah et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="From Reals to Logic and Back: Inventing Symbolic Vocabularies, Actions and Models for Planning from Raw Data" index=260>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.11871v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2402.11871v1.pdf" filename="2402.11871v1.pdf">Download PDF</button>
...
### (9/11 | 261/330) CoLRIO: LiDAR-Ranging-Inertial Centralized State Estimation for Robotic Swarms (Shipeng Zhong et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="CoLRIO: LiDAR-Ranging-Inertial Centralized State Estimation for Robotic Swarms" index=261>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (10/11 | 262/330) Targeted Parallelization of Conflict-Based Search for Multi-Robot Path Planning (Teng Guo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Targeted Parallelization of Conflict-Based Search for Multi-Robot Path Planning" index=262>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (11/11 | 263/330) Well-Connected Set and Its Application to Multi-Robot Path Planning (Teng Guo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Well-Connected Set and Its Application to Multi-Robot Path Planning" index=263>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/4 | 264/330) IMBUE: Improving Interpersonal Effectiveness through Simulation and Just-in-time Feedback with Human-Language Model Interaction (Inna Wanyin Lin et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="IMBUE: Improving Interpersonal Effectiveness through Simulation and Just-in-time Feedback with Human-Language Model Interaction" index=264>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/4 | 265/330) Dynamic and Super-Personalized Media Ecosystem Driven by Generative AI: Unpredictable Plays Never Repeating The Same (Sungjun Ahn et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Dynamic and Super-Personalized Media Ecosystem Driven by Generative AI: Unpredictable Plays Never Repeating The Same" index=265>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/4 | 266/330) Enhancing Empathetic Response Generation by Augmenting LLMs with Small-scale Empathetic Models (Zhou Yang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Enhancing Empathetic Response Generation by Augmenting LLMs with Small-scale Empathetic Models" index=266>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/4 | 267/330) Beyond Voice Assistants: Exploring Advantages and Risks of an In-Car Social Robot in Real Driving Scenarios (Yuanchao Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Beyond Voice Assistants: Exploring Advantages and Risks of an In-Car Social Robot in Real Driving Scenarios" index=267>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/3 | 268/330) Language-Codec: Reducing the Gaps Between Discrete Codec Representation and Speech Language Models (Shengpeng Ji et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Language-Codec: Reducing the Gaps Between Discrete Codec Representation and Speech Language Models" index=268>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/3 | 269/330) Parameter Efficient Finetuning for Speech Emotion Recognition and Domain Adaptation (Nineli Lashkarashvili et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Parameter Efficient Finetuning for Speech Emotion Recognition and Domain Adaptation" index=269>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/3 | 270/330) Bayesian Parameter-Efficient Fine-Tuning for Overcoming Catastrophic Forgetting (Haolin Chen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Bayesian Parameter-Efficient Fine-Tuning for Overcoming Catastrophic Forgetting" index=270>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/6 | 271/330) Kernel KMeans clustering splits for end-to-end unsupervised decision trees (Louis Ohl et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Kernel KMeans clustering splits for end-to-end unsupervised decision trees" index=271>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/6 | 272/330) When Do Off-Policy and On-Policy Policy Gradient Methods Align? (Davide Mambelli et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="When Do Off-Policy and On-Policy Policy Gradient Methods Align?" index=272>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/6 | 273/330) Towards AI-Based Precision Oncology: A Machine Learning Framework for Personalized Counterfactual Treatment Suggestions based on Multi-Omics Data (Manuel Schürch et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Towards AI-Based Precision Oncology: A Machine Learning Framework for Personalized Counterfactual Treatment Suggestions based on Multi-Omics Data" index=273>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/6 | 274/330) Regularization by denoising: Bayesian model and Langevin-within-split Gibbs sampling (Elhadji C. Faye et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Regularization by denoising: Bayesian model and Langevin-within-split Gibbs sampling" index=274>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/6 | 275/330) Statistical Test for Generated Hypotheses by Diffusion Models (Teruyuki Katsuoka et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Statistical Test for Generated Hypotheses by Diffusion Models" index=275>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (6/6 | 276/330) Asymptotic Gaussian Fluctuations of Eigenvectors in Spectral Clustering (Hugo Lebeau et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Asymptotic Gaussian Fluctuations of Eigenvectors in Spectral Clustering" index=276>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/3 | 277/330) Automated Security Response through Online Learning with Adaptive Conjectures (Kim Hammar et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Automated Security Response through Online Learning with Adaptive Conjectures" index=277>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/3 | 278/330) Integrating Dynamic Weighted Approach with Fictitious Play and Pure Counterfactual Regret Minimization for Equilibrium Finding (Qi Ju et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Integrating Dynamic Weighted Approach with Fictitious Play and Pure Counterfactual Regret Minimization for Equilibrium Finding" index=278>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/3 | 279/330) Simple Mechanisms for Utility Maximization: Approximating Welfare in the I.I.D. Unit-Demand Setting (Kira Goldner et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Simple Mechanisms for Utility Maximization: Approximating Welfare in the I.I.D. Unit-Demand Setting" index=279>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 280/330) DBNets: A publicly available deep learning tool to measure the masses of young planets in dusty protoplanetary discs (Alessandro Ruzza et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="DBNets: A publicly available deep learning tool to measure the masses of young planets in dusty protoplanetary discs" index=280>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/5 | 281/330) An Adversarial Approach to Evaluating the Robustness of Event Identification Models (Obai Bahwal et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="An Adversarial Approach to Evaluating the Robustness of Event Identification Models" index=281>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/5 | 282/330) An Index Policy Based on Sarsa and Q-learning for Heterogeneous Smart Target Tracking (Yuhang Hao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="An Index Policy Based on Sarsa and Q-learning for Heterogeneous Smart Target Tracking" index=282>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/5 | 283/330) Impact of data usage for forecasting on performance of model predictive control in buildings with smart energy storage (Max Langtry et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Impact of data usage for forecasting on performance of model predictive control in buildings with smart energy storage" index=283>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/5 | 284/330) Flexible Robust Optimal Bidding of Renewable Virtual Power Plants in Sequential Markets (Hadi Nemati et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Flexible Robust Optimal Bidding of Renewable Virtual Power Plants in Sequential Markets" index=284>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/5 | 285/330) Terahertz User-Centric Clustering in the Presence of Beam Misalignment (Khaled Humadi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Terahertz User-Centric Clustering in the Presence of Beam Misalignment" index=285>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/5 | 286/330) Secure Federated Learning Across Heterogeneous Cloud and High-Performance Computing Resources -- A Case Study on Federated Fine-tuning of LLaMA 2 (Zilinghan Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Secure Federated Learning Across Heterogeneous Cloud and High-Performance Computing Resources -- A Case Study on Federated Fine-tuning of LLaMA 2" index=286>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/5 | 287/330) Proximal Byzantine Consensus (Roy Shadmon et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Proximal Byzantine Consensus" index=287>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/5 | 288/330) Even-Cycle Detection in the Randomized and Quantum CONGEST Model (Pierre Fraigniaud et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Even-Cycle Detection in the Randomized and Quantum CONGEST Model" index=288>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/5 | 289/330) Local certification of forbidden subgraphs (Nicolas Bousquet et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Local certification of forbidden subgraphs" index=289>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/5 | 290/330) Evaluating Versal AI Engines for option price discovery in market risk analysis (Mark Klaisoongnoen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Evaluating Versal AI Engines for option price discovery in market risk analysis" index=290>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/3 | 291/330) Hebbian Learning based Orthogonal Projection for Continual Learning of Spiking Neural Networks (Mingqing Xiao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Hebbian Learning based Orthogonal Projection for Continual Learning of Spiking Neural Networks" index=291>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/3 | 292/330) An enhanced Teaching-Learning-Based Optimization (TLBO) with Grey Wolf Optimizer (GWO) for text feature selection and clustering (Mahsa Azarshab et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="An enhanced Teaching-Learning-Based Optimization (TLBO) with Grey Wolf Optimizer (GWO) for text feature selection and clustering" index=292>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/3 | 293/330) Function Class Learning with Genetic Programming: Towards Explainable Meta Learning for Tumor Growth Functionals (E. M. C. Sijben et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Function Class Learning with Genetic Programming: Towards Explainable Meta Learning for Tumor Growth Functionals" index=293>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/3 | 294/330) Cooperative Backscatter Communications with Reconfigurable Intelligent Surfaces: An APSK Approach (Qiang Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Cooperative Backscatter Communications with Reconfigurable Intelligent Surfaces: An APSK Approach" index=294>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/3 | 295/330) Rate-Splitting Multiple Access for Transmissive Reconfigurable Intelligent Surface Transceiver Empowered ISAC System (Ziwei Liu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Rate-Splitting Multiple Access for Transmissive Reconfigurable Intelligent Surface Transceiver Empowered ISAC System" index=295>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/3 | 296/330) Max-Min Fairness for Uplink Rate-Splitting Multiple Access with Finite Blocklength (Jiawei Xu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Max-Min Fairness for Uplink Rate-Splitting Multiple Access with Finite Blocklength" index=296>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/2 | 297/330) Truncated Polynomial Expansion-Based Detection in Massive MIMO: A Model-Driven Deep Learning Approach (Kazem Izadinasab et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Truncated Polynomial Expansion-Based Detection in Massive MIMO: A Model-Driven Deep Learning Approach" index=297>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/2 | 298/330) A Simple Detection and Identification Scheme For Reconfigurable Intelligent Surfaces (Aymen Khaleel et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Simple Detection and Identification Scheme For Reconfigurable Intelligent Surfaces" index=298>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 299/330) Emulating the interstellar medium chemistry with neural operators (Lorenzo Branca et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Emulating the interstellar medium chemistry with neural operators" index=299>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 300/330) Short-Period Variables in TESS Full-Frame Image Light Curves Identified via Convolutional Neural Networks (Greg Olmschenk et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Short-Period Variables in TESS Full-Frame Image Light Curves Identified via Convolutional Neural Networks" index=300>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/5 | 301/330) A high-order, fully well-balanced, unconditionally positivity-preserving finite volume framework for flood simulations (Mirco Ciallella et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A high-order, fully well-balanced, unconditionally positivity-preserving finite volume framework for flood simulations" index=301>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/5 | 302/330) Lax-Wendroff Flux Reconstruction on adaptive curvilinear meshes with error based time stepping for hyperbolic conservation laws (Arpit Babbar et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Lax-Wendroff Flux Reconstruction on adaptive curvilinear meshes with error based time stepping for hyperbolic conservation laws" index=302>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/5 | 303/330) Solving fluid flow problems in space-time with multiscale stabilization: formulation and examples (Biswajit Khara et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Solving fluid flow problems in space-time with multiscale stabilization: formulation and examples" index=303>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/5 | 304/330) A Unified-Field Monolithic Fictitious Domain-Finite Element Method for Fluid-Structure-Contact Interactions and Applications to Deterministic Lateral Displacement Problems (Cheng Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Unified-Field Monolithic Fictitious Domain-Finite Element Method for Fluid-Structure-Contact Interactions and Applications to Deterministic Lateral Displacement Problems" index=304>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/5 | 305/330) Analysis of the Picard-Newton iteration for the Navier-Stokes equations: global stability and quadratic convergence (Sara Pollock et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Analysis of the Picard-Newton iteration for the Navier-Stokes equations: global stability and quadratic convergence" index=305>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/2 | 306/330) Second Order Meanfield Approximation for calculating Dynamics in Au-Nanoparticle Networks (Evan Wonisch et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Second Order Meanfield Approximation for calculating Dynamics in Au-Nanoparticle Networks" index=306>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/2 | 307/330) Recent Extensions of the ZKCM Library for Parallel and Accurate MPS Simulation of Quantum Circuits (Akira SaiToh, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Recent Extensions of the ZKCM Library for Parallel and Accurate MPS Simulation of Quantum Circuits" index=307>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/2 | 308/330) Towards Joint Optimization for DNN Architecture and Configuration for Compute-In-Memory Hardware (Souvik Kundu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Towards Joint Optimization for DNN Architecture and Configuration for Compute-In-Memory Hardware" index=308>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/2 | 309/330) Factor Machine: Mixed-signal Architecture for Fine-Grained Graph-Based Computing (Piotr Dudek, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Factor Machine: Mixed-signal Architecture for Fine-Grained Graph-Based Computing" index=309>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 310/330) Automating Boundary Filling in Cubical Agda (Maximilian Doré et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Automating Boundary Filling in Cubical Agda" index=310>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 311/330) Molecule Generation and Optimization for Efficient Fragrance Creation (Bruno C. L. Rodrigues et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Molecule Generation and Optimization for Efficient Fragrance Creation" index=311>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 312/330) Aligning Individual and Collective Objectives in Multi-Agent Cooperation (Yang Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Aligning Individual and Collective Objectives in Multi-Agent Cooperation" index=312>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/2 | 313/330) Conformally rigid graphs (Stefan Steinerberger et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Conformally rigid graphs" index=313>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/2 | 314/330) Lettericity of graphs: an FPT algorithm and a bound on the size of obstructions (Bogdan Alecu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Lettericity of graphs: an FPT algorithm and a bound on the size of obstructions" index=314>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/2 | 315/330) Optimize Energy Consumption of Wireless Sensor Networks by using modified Ant Colony Optimization ACO (Yasameen Sajid Razooqi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Optimize Energy Consumption of Wireless Sensor Networks by using modified Ant Colony Optimization ACO" index=315>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/2 | 316/330) Strengths and Weaknesses of the ETSI Adaptive DCC Algorithm: A Proposal for Improvement (Ignacio Soto et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Strengths and Weaknesses of the ETSI Adaptive DCC Algorithm: A Proposal for Improvement" index=316>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 317/330) Structure of activity in multiregion recurrent neural networks (David G. Clark et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Structure of activity in multiregion recurrent neural networks" index=317>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 318/330) Causal Equal Protection as Algorithmic Fairness (Marcello Di Bello et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Causal Equal Protection as Algorithmic Fairness" index=318>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 10  
Keywords: Fairness  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.12062v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2402.12062v1.pdf" filename="2402.12062v1.pdf">Download PDF</button>
...
### (1/1 | 319/330) A novel molecule generative model of VAE combined with Transformer (Yasuhiro Yoshikai et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A novel molecule generative model of VAE combined with Transformer" index=319>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/3 | 320/330) Two Online Map Matching Algorithms Based on Analytic Hierarchy Process and Fuzzy Logic (Jeremy J. Lin et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Two Online Map Matching Algorithms Based on Analytic Hierarchy Process and Fuzzy Logic" index=320>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/3 | 321/330) Flip Graphs of Pseudo-Triangulations With Face Degree at Most 4 (Maarten Löffler et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Flip Graphs of Pseudo-Triangulations With Face Degree at Most 4" index=321>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/3 | 322/330) The Complexity of Geodesic Spanners using Steiner Points (Sarita de Berg et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="The Complexity of Geodesic Spanners using Steiner Points" index=322>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 323/330) FOD-Swin-Net: angular super resolution of fiber orientation distribution using a transformer-based deep model (Mateus Oliveira da Silva et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="FOD-Swin-Net: angular super resolution of fiber orientation distribution using a transformer-based deep model" index=323>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 324/330) Thinking Outside the Black Box: Insights from a Digital Exhibition in the Humanities (Sebastian Barzaghi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Thinking Outside the Black Box: Insights from a Digital Exhibition in the Humanities" index=324>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 325/330) On The Fourier Coefficients of High-Dimensional Random Geometric Graphs (Kiril Bangachev et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="On The Fourier Coefficients of High-Dimensional Random Geometric Graphs" index=325>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 326/330) LTL learning on GPUs (Mojtaba Valizadeh et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="LTL learning on GPUs" index=326>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/4 | 327/330) Almost-linear time parameterized algorithm for rankwidth via dynamic rankwidth (Tuukka Korhonen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Almost-linear time parameterized algorithm for rankwidth via dynamic rankwidth" index=327>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/4 | 328/330) Connectivity Labeling in Faulty Colored Graphs (Asaf Petruschka et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Connectivity Labeling in Faulty Colored Graphs" index=328>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/4 | 329/330) Collision-Free Robot Scheduling (Duncan Adamson et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Collision-Free Robot Scheduling" index=329>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/4 | 330/330) Buffered Streaming Edge Partitioning (Adil Chhabra et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Buffered Streaming Edge Partitioning" index=330>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
