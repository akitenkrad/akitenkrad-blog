...
| GPT-4                          | 1.0     | 6.0     |         | 2.0     |
| GPT-4 turbo                    |         | 1.0     |         |         |
| Generative Adversarial Network |         |         | 2.0     |         |
| Graph Attention Networks       |         |         |         | 1.0     |
| Graph Embedding                |         |         |         | 1.0     |
| Graph Neural Network           | 2.0     |         |         | 8.0     |
| Grounding                      |         | 1.0     | 2.0     |         |
| Hallucination Detection        | 1.0     |         |         |         |
| Heuristic Approach             |         |         |         | 1.0     |
| In-context Learning            |         | 6.0     |         | 4.0     |
| Information Retrieval          |         | 1.0     |         |         |
| Instruction Tuning             | 1.0     |         |         |         |
| Knowledge Distillation         | 3.0     |         | 1.0     | 2.0     |
| LLaMA                          |         | 1.0     |         | 2.0     |
| Label Smoothing                |         | 1.0     |         |         |
| Language Generation            |         | 1.0     |         |         |
| Large Language Model           | 10.0    | 35.0    | 11.0    | 9.0     |
| Logistic Regression            |         |         |         | 1.0     |
| Low-Resource                   |         | 4.0     |         |         |
| Machine Unlearning             |         | 1.0     |         |         |
| Message-Passing                |         |         |         | 1.0     |
| Meta Learning                  |         |         |         | 1.0     |
| Mutual Information             |         |         |         | 1.0     |
| Named Entity Recognition       |         | 3.0     |         |         |
| Node Classification            | 1.0     |         |         | 2.0     |
| Object Detection               |         |         | 2.0     |         |
| Offline Reinforcement Learning |         |         |         | 2.0     |
| Optical Character Recognition  |         |         | 3.0     |         |
| Perplexity                     |         | 1.0     |         |         |
| Pre-trained Language Model     |         | 2.0     |         |         |
| Probabilistic Model            |         |         | 1.0     |         |
| Prompt                         | 4.0     | 8.0     | 3.0     | 3.0     |
| Pruning                        |         |         |         | 2.0     |
| Quantization                   |         |         |         | 7.0     |
| Question Answering             | 1.0     | 5.0     | 2.0     |         |
| Reasoning                      | 3.0     | 3.0     | 2.0     | 3.0     |
| Recommendation                 |         | 1.0     |         | 1.0     |
| Recommender System             |         |         |         | 1.0     |
| Reinforcement Learning         | 3.0     |         |         | 10.0    |
| RoBERTa                        |         | 1.0     |         |         |
| Sample Size                    |         |         |         | 2.0     |
| Scaling Law                    |         |         |         | 1.0     |
| Self-Attention                 |         |         | 1.0     | 3.0     |
| Self-supervised Learning       |         |         | 4.0     |         |
| Semi-Supervised Learning       |         |         | 1.0     |         |
| Sentiment Analysis             |         | 2.0     |         |         |
| Simulation                     |         | 2.0     | 1.0     | 2.0     |
| Simulator                      |         | 2.0     | 1.0     | 2.0     |
| Square Loss                    |         |         |         | 1.0     |
| Stemming                       |         |         |         | 1.0     |
| Stochastic Gradient Descent    |         |         |         | 1.0     |
| Summarization                  |         | 1.0     |         |         |
| SuperGLUE                      |         | 1.0     |         |         |
| Supervised Learning            |         |         |         | 3.0     |
| Text Augmentation              |         |         | 1.0     |         |
| Text Embedding                 |         | 1.0     | 2.0     |         |
| Text-to-speech                 |         | 4.0     |         |         |
| Text2image                     |         |         | 2.0     |         |
| Transfer Learning              |         | 1.0     |         |         |
| Transformer                    | 2.0     | 4.0     | 7.0     | 8.0     |
| Unsupervised Learning          |         | 1.0     |         | 4.0     |
| Variational Autoencoder        |         |         |         | 1.0     |
| Vision-and-Language            |         |         | 4.0     |         |
| Visual Question Answering      | 1.0     |         | 2.0     |         |
| Word Embedding                 |         |         |         | 1.0     |
| Zero-shot                      |         | 3.0     | 1.0     | 2.0     |
...
### (1/186) In-Context Principle Learning from Mistakes (Tianjun Zhang et al., 2024)
...
### (5/186) Self-Alignment of Large Language Models via Monopolylogue-based Social Scene Simulation (Xianghe Pang et al., 2024)
...
### (6/186) PromptCrypt: Prompt Encryption for Secure Communication with Large Language Models (Guo Lin et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="PromptCrypt: Prompt Encryption for Secure Communication with Large Language Models" index=6>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<br/>
<button class="copy-to-clipboard" title="TimeArena: Shaping Efficient Multitasking Language Agents in a Time-Aware Simulation" index=7>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (8/186) GPT-4 Generated Narratives of Life Events using a Structured Narrative Prompt: A Validation Study (Christopher J. Lynch et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="GPT-4 Generated Narratives of Life Events using a Structured Narrative Prompt: A Validation Study" index=8>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<br/>
<button class="copy-to-clipboard" title="WebLINX: Real-World Website Navigation with Multi-Turn Dialogue" index=9>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (10/186) Named Entity Recognition for Address Extraction in Speech-to-Text Transcriptions Using Synthetic Data (Bibiána Lajčinová et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Named Entity Recognition for Address Extraction in Speech-to-Text Transcriptions Using Synthetic Data" index=10>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (11/186) It's Never Too Late: Fusing Acoustic Information into Large Language Models for Automatic Speech Recognition (Chen Chen et al., 2024)
...
### (12/186) Efficient Stagewise Pretraining via Progressive Subnetworks (Abhishek Panigrahi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Efficient Stagewise Pretraining via Progressive Subnetworks" index=12>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (13/186) Is it Possible to Edit Large Language Models Robustly? (Xinbei Ma et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Is it Possible to Edit Large Language Models Robustly?" index=13>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (14/186) Selective Forgetting: Advancing Machine Unlearning Techniques and Evaluation in Language Models (Lingzhi Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Selective Forgetting: Advancing Machine Unlearning Techniques and Evaluation in Language Models" index=14>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (15/186) AttnLRP: Attention-Aware Layer-wise Relevance Propagation for Transformers (Reduan Achtibat et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="AttnLRP: Attention-Aware Layer-wise Relevance Propagation for Transformers" index=15>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (16/186) AutoAugment Is What You Need: Enhancing Rule-based Augmentation Methods in Low-resource Regimes (Juhwan Choi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="AutoAugment Is What You Need: Enhancing Rule-based Augmentation Methods in Low-resource Regimes" index=16>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (17/186) Benchmarking Large Language Models on Communicative Medical Coaching: a Novel System and Dataset (Hengguan Huang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Benchmarking Large Language Models on Communicative Medical Coaching: a Novel System and Dataset" index=17>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (18/186) NoisyICL: A Little Noise in Model Parameters Calibrates In-context Learning (Yufeng Zhao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="NoisyICL: A Little Noise in Model Parameters Calibrates In-context Learning" index=18>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (19/186) FACT-GPT: Fact-Checking Augmentation via Claim Matching with LLMs (Eun Cheol Choi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="FACT-GPT: Fact-Checking Augmentation via Claim Matching with LLMs" index=19>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (20/186) Phonetically rich corpus construction for a low-resourced language (Marcellus Amadeus et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Phonetically rich corpus construction for a low-resourced language" index=20>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (21/186) SpiRit-LM: Interleaved Spoken and Written Language Model (Tu Anh Nguyen et al., 2024)
...
### (22/186) GPTs Are Multilingual Annotators for Sequence Generation Tasks (Juhwan Choi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="GPTs Are Multilingual Annotators for Sequence Generation Tasks" index=22>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (23/186) Large Language Models for Psycholinguistic Plausibility Pretesting (Samuel Joseph Amouyal et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Large Language Models for Psycholinguistic Plausibility Pretesting" index=23>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (24/186) Generative Echo Chamber? Effects of LLM-Powered Search Systems on Diverse Information Seeking (Nikhil Sharma et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Generative Echo Chamber? Effects of LLM-Powered Search Systems on Diverse Information Seeking" index=24>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (25/186) Permute-and-Flip: An optimally robust and watermarkable decoder for LLMs (Xuandong Zhao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Permute-and-Flip: An optimally robust and watermarkable decoder for LLMs" index=25>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<br/>
<button class="copy-to-clipboard" title="Text-to-Code Generation with Modality-relative Pre-training" index=26>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<br/>
<button class="copy-to-clipboard" title="Multilingual E5 Text Embeddings: A Technical Report" index=27>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (28/186) Merging Facts, Crafting Fallacies: Evaluating the Contradictory Nature of Aggregated Factual Claims in Long-Form Generations (Cheng-Han Chiang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Merging Facts, Crafting Fallacies: Evaluating the Contradictory Nature of Aggregated Factual Claims in Long-Form Generations" index=28>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (29/186) Pretrained Generative Language Models as General Learning Frameworks for Sequence-Based Tasks (Ben Fauber, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Pretrained Generative Language Models as General Learning Frameworks for Sequence-Based Tasks" index=29>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (30/186) Establishing degrees of closeness between audio recordings along different dimensions using large-scale cross-lingual models (Maxime Fily et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Establishing degrees of closeness between audio recordings along different dimensions using large-scale cross-lingual models" index=30>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (31/186) Traditional Machine Learning Models and Bidirectional Encoder Representations From Transformer (BERT)-Based Automatic Classification of Tweets About Eating Disorders: Algorithm Development and Validation Study (José Alberto Benítez-Andrades et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Traditional Machine Learning Models and Bidirectional Encoder Representations From Transformer (BERT)-Based Automatic Classification of Tweets About Eating Disorders: Algorithm Development and Validation Study" index=31>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (32/186) FAQ-Gen: An automated system to generate domain-specific FAQs to aid content comprehension (Sahil Kale et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="FAQ-Gen: An automated system to generate domain-specific FAQs to aid content comprehension" index=32>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (33/186) SoftEDA: Rethinking Rule-Based Data Augmentation with Soft Labels (Juhwan Choi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="SoftEDA: Rethinking Rule-Based Data Augmentation with Soft Labels" index=33>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (34/186) Improving Agent Interactions in Virtual Environments with Language Models (Jack Zhang, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Improving Agent Interactions in Virtual Environments with Language Models" index=34>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (35/186) Large Language Model Meets Graph Neural Network in Knowledge Distillation (Shengxiang Hu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Large Language Model Meets Graph Neural Network in Knowledge Distillation" index=35>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<br/>
<button class="copy-to-clipboard" title="Guiding Large Language Models with Divide-and-Conquer Program for Discerning Problem Solving" index=36>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<br/>
<button class="copy-to-clipboard" title="How Well Can LLMs Negotiate? NegotiationArena Platform and Analysis" index=37>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
**ABSTRACT**  
Negotiation is the basis of social interactions; humans negotiate everything from the price of cars to how to share common resources. With rapidly growing interest in using large language models (LLMs) to act as agents on behalf of human users, such <b>LLM</b> agents would also need to be able to negotiate. In this paper, we study how well LLMs can negotiate with each other. We develop NegotiationArena: a flexible framework for evaluating and probing the negotiation abilities of <b>LLM</b> agents. We implemented three types of scenarios in NegotiationArena to assess LLM's behaviors in allocating shared resources (ultimatum games), aggregate resources (trading games) and buy/sell goods (price negotiations). Each scenario allows for multiple turns of flexible dialogues between <b>LLM</b> agents to allow for more complex negotiations. Interestingly, <b>LLM</b> agents can significantly boost their negotiation outcomes by employing certain behavioral tactics. For example, by pretending to be desolate and desperate, LLMs can improve their payoffs by 20\% when negotiating against the standard GPT-4. We also quantify irrational negotiation behaviors exhibited by the <b>LLM</b> agents, many of which also appear in humans. Together, \NegotiationArena offers a new environment to investigate <b>LLM</b> interactions, enabling new insights into LLM's theory of mind, irrationality, and <b>reasoning</b> abilities.

{{</citation>}}


### (38/186) Rapid Optimization for Jailbreaking LLMs via Subconscious Exploitation and Echopraxia (Guangyu Shen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Rapid Optimization for Jailbreaking LLMs via Subconscious Exploitation and Echopraxia" index=38>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (39/186) Training Large Language Models for Reasoning through Reverse Curriculum Reinforcement Learning (Zhiheng Xi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Training Large Language Models for Reasoning through Reverse Curriculum Reinforcement Learning" index=39>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (40/186) Knowledge Graphs Meet Multi-Modal Learning: A Comprehensive Survey (Zhuo Chen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Knowledge Graphs Meet Multi-Modal Learning: A Comprehensive Survey" index=40>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2402.05391v1.pdf" filename="2402.05391v1.pdf">Download PDF</button>
...
### (41/186) Limitations of Agents Simulated by Predictive Models (Raymond Douglas et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Limitations of Agents Simulated by Predictive Models" index=41>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (42/186) Prompting Fairness: Artificial Intelligence as Game Players (Jazmia Henry, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Prompting Fairness: Artificial Intelligence as Game Players" index=42>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2402.05786v1.pdf" filename="2402.05786v1.pdf">Download PDF</button>
...
### (43/186) An Interactive Agent Foundation Model (Zane Durante et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="An Interactive Agent Foundation Model" index=43>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (44/186) Optimizing Delegation in Collaborative Human-AI Hybrid Teams (Andrew Fuchs et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Optimizing Delegation in Collaborative Human-AI Hybrid Teams" index=44>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (45/186) KIX: A Metacognitive Generalization Framework (Arun Kumar et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="KIX: A Metacognitive Generalization Framework" index=45>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (46/186) In-Context Learning Can Re-learn Forbidden Tasks (Sophie Xhonneux et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="In-Context Learning Can Re-learn Forbidden Tasks" index=46>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<br/>
<button class="copy-to-clipboard" title="Classifying Nodes in Graphs without GNNs" index=47>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (48/186) Limits of Transformer Language Models on Algorithmic Learning (Jonathan Thomm et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Limits of Transformer Language Models on Algorithmic Learning" index=48>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (49/186) Offline Actor-Critic Reinforcement Learning Scales to Large Models (Jost Tobias Springenberg et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Offline Actor-Critic Reinforcement Learning Scales to Large Models" index=49>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (50/186) Accurate LoRA-Finetuning Quantization of LLMs via Information Retention (Haotong Qin et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Accurate LoRA-Finetuning Quantization of LLMs via Information Retention" index=50>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (51/186) On the Convergence of Zeroth-Order Federated Tuning in Large Language Models (Zhenqing Ling et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="On the Convergence of Zeroth-Order Federated Tuning in Large Language Models" index=51>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (52/186) Let Your Graph Do the Talking: Encoding Structured Data for LLMs (Bryan Perozzi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Let Your Graph Do the Talking: Encoding Structured Data for LLMs" index=52>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (53/186) Rethinking Propagation for Unsupervised Graph Domain Adaptation (Meihan Liu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Rethinking Propagation for Unsupervised Graph Domain Adaptation" index=53>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
**ABSTRACT**  
<b>Unsupervised</b> Graph <b>Domain</b> <b>Adaptation</b> (UGDA) aims to transfer knowledge from a labelled source graph to an unlabelled target graph in order to address the distribution shifts between graph domains. Previous works have primarily focused on aligning data from the source and target graph in the representation space learned by graph neural networks (GNNs). However, the inherent generalization capability of GNNs has been largely overlooked. Motivated by our empirical analysis, we reevaluate the role of GNNs in graph <b>domain</b> <b>adaptation</b> and uncover the pivotal role of the propagation process in GNNs for adapting to different graph domains. We provide a comprehensive theoretical analysis of UGDA and derive a generalization bound for multi-layer GNNs. By formulating <b>GNN</b> Lipschitz for k-layer GNNs, we show that the target risk bound can be tighter by removing propagation layers in source graph and stacking multiple propagation layers in target graph. Based on the empirical and theoretical analysis mentioned above, we propose a simple yet effective approach called A2GNN for graph domain adaptation. Through extensive experiments on real-world datasets, we demonstrate the effectiveness of our proposed A2GNN framework.

{{</citation>}}


### (54/186) Empowering machine learning models with contextual knowledge for enhancing the detection of eating disorders in social media posts (José Alberto Benítez-Andrades et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Empowering machine learning models with contextual knowledge for enhancing the detection of eating disorders in social media posts" index=54>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (55/186) Learning to Route Among Specialized Experts for Zero-Shot Generalization (Mohammed Muqeeth et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Learning to Route Among Specialized Experts for Zero-Shot Generalization" index=55>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (56/186) Sparse-VQ Transformer: An FFN-Free Framework with Vector Quantization for Enhanced Time Series Forecasting (Yanjun Zhao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Sparse-VQ Transformer: An FFN-Free Framework with Vector Quantization for Enhanced Time Series Forecasting" index=56>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (57/186) Implicit Bias and Fast Convergence Rates for Self-attention (Bhavya Vasudeva et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Implicit Bias and Fast Convergence Rates for Self-attention" index=57>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<br/>
<button class="copy-to-clipboard" title="Unichain and Aperiodicity are Sufficient for Asymptotic Optimality of Average-Reward Restless Bandits" index=58>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (59/186) RepQuant: Towards Accurate Post-Training Quantization of Large Transformer Models via Scale Reparameterization (Zhikai Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="RepQuant: Towards Accurate Post-Training Quantization of Large Transformer Models via Scale Reparameterization" index=59>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<br/>
<button class="copy-to-clipboard" title="Binding Dynamics in Rotating Features" index=60>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (61/186) Hypergraph Node Classification With Graph Neural Networks (Bohan Tang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Hypergraph Node Classification With Graph Neural Networks" index=61>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (62/186) Reinforcement Learning as a Catalyst for Robust and Fair Federated Learning: Deciphering the Dynamics of Client Contributions (Jialuo He et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Reinforcement Learning as a Catalyst for Robust and Fair Federated Learning: Deciphering the Dynamics of Client Contributions" index=62>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (63/186) TASER: Temporal Adaptive Sampling for Fast and Accurate Dynamic Graph Representation Learning (Gangda Deng et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="TASER: Temporal Adaptive Sampling for Fast and Accurate Dynamic Graph Representation Learning" index=63>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (64/186) Noise Contrastive Alignment of Language Models with Explicit Rewards (Huayu Chen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Noise Contrastive Alignment of Language Models with Explicit Rewards" index=64>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (65/186) Exploring Learning Complexity for Downstream Data Pruning (Wenyu Jiang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Exploring Learning Complexity for Downstream Data Pruning" index=65>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (66/186) EUGENE: Explainable Unsupervised Approximation of Graph Edit Distance (Aditya Bommakanti et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="EUGENE: Explainable Unsupervised Approximation of Graph Edit Distance" index=66>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (67/186) Federated Offline Reinforcement Learning: Collaborative Single-Policy Coverage Suffices (Jiin Woo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Federated Offline Reinforcement Learning: Collaborative Single-Policy Coverage Suffices" index=67>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (68/186) Discovering Temporally-Aware Reinforcement Learning Algorithms (Matthew Thomas Jackson et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Discovering Temporally-Aware Reinforcement Learning Algorithms" index=68>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (69/186) FusionSF: Fuse Heterogeneous Modalities in a Vector Quantized Framework for Robust Solar Power Forecasting (Ziqing Ma et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="FusionSF: Fuse Heterogeneous Modalities in a Vector Quantized Framework for Robust Solar Power Forecasting" index=69>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (70/186) Latent variable model for high-dimensional point process with structured missingness (Maksim Sinelnikov et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Latent variable model for high-dimensional point process with structured missingness" index=70>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (71/186) Model-Based RL for Mean-Field Games is not Statistically Harder than Single-Agent RL (Jiawei Huang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Model-Based RL for Mean-Field Games is not Statistically Harder than Single-Agent RL" index=71>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (72/186) Improving Token-Based World Models with Parallel Observation Prediction (Lior Cohen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Improving Token-Based World Models with Parallel Observation Prediction" index=72>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (73/186) Simultaneously Achieving Group Exposure Fairness and Within-Group Meritocracy in Stochastic Bandits (Subham Pokhriyal et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Simultaneously Achieving Group Exposure Fairness and Within-Group Meritocracy in Stochastic Bandits" index=73>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (74/186) Asynchronous Diffusion Learning with Agent Subsampling and Local Updates (Elsa Rizk et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Asynchronous Diffusion Learning with Agent Subsampling and Local Updates" index=74>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (75/186) Differentially Private Model-Based Offline Reinforcement Learning (Alexandre Rio et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Differentially Private Model-Based Offline Reinforcement Learning" index=75>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (76/186) Neural Circuit Diagrams: Robust Diagrams for the Communication, Implementation, and Analysis of Deep Learning Architectures (Vincent Abbott, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Neural Circuit Diagrams: Robust Diagrams for the Communication, Implementation, and Analysis of Deep Learning Architectures" index=76>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (77/186) Everybody Prune Now: Structured Pruning of LLMs with only Forward Passes (Lucio Dery et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Everybody Prune Now: Structured Pruning of LLMs with only Forward Passes" index=77>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (78/186) Risk-Sensitive Multi-Agent Reinforcement Learning in Network Aggregative Markov Games (Hafez Ghaemi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Risk-Sensitive Multi-Agent Reinforcement Learning in Network Aggregative Markov Games" index=78>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (79/186) Guided Evolution with Binary Discriminators for ML Program Search (John D. Co-Reyes et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Guided Evolution with Binary Discriminators for ML Program Search" index=79>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (80/186) On Calibration and Conformal Prediction of Deep Classifiers (Lahav Dabah et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="On Calibration and Conformal Prediction of Deep Classifiers" index=80>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (81/186) Unsupervised Discovery of Clinical Disease Signatures Using Probabilistic Independence (Thomas A. Lasko et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Unsupervised Discovery of Clinical Disease Signatures Using Probabilistic Independence" index=81>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (82/186) Stable Autonomous Flow Matching (Christopher Iliffe Sprague et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Stable Autonomous Flow Matching" index=82>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (83/186) Generalized Preference Optimization: A Unified Approach to Offline Alignment (Yunhao Tang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Generalized Preference Optimization: A Unified Approach to Offline Alignment" index=83>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (84/186) Is Adversarial Training with Compressed Datasets Effective? (Tong Chen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Is Adversarial Training with Compressed Datasets Effective?" index=84>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (85/186) S$Ω$I: Score-based O-INFORMATION Estimation (Mustapha Bounoua et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="S$Ω$I: Score-based O-INFORMATION Estimation" index=85>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (86/186) Mesoscale Traffic Forecasting for Real-Time Bottleneck and Shockwave Prediction (Raphael Chekroun et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Mesoscale Traffic Forecasting for Real-Time Bottleneck and Shockwave Prediction" index=86>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (87/186) Flashback: Understanding and Mitigating Forgetting in Federated Learning (Mohammed Aljahdali et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Flashback: Understanding and Mitigating Forgetting in Federated Learning" index=87>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (88/186) Determining the severity of Parkinson's disease in patients using a multi task neural network (María Teresa García-Ordás et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Determining the severity of Parkinson's disease in patients using a multi task neural network" index=88>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (89/186) Multi-Timescale Ensemble Q-learning for Markov Decision Process Policy Optimization (Talha Bozkus et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Multi-Timescale Ensemble Q-learning for Markov Decision Process Policy Optimization" index=89>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (90/186) Learning Uncertainty-Aware Temporally-Extended Actions (Joongkyu Lee et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Learning Uncertainty-Aware Temporally-Extended Actions" index=90>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (91/186) Attention as Robust Representation for Time Series Forecasting (PeiSong Niu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Attention as Robust Representation for Time Series Forecasting" index=91>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (92/186) Sharp Rates in Dependent Learning Theory: Avoiding Sample Size Deflation for the Square Loss (Ingvar Ziemann et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Sharp Rates in Dependent Learning Theory: Avoiding Sample Size Deflation for the Square Loss" index=92>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (93/186) Digital Computers Break the Curse of Dimensionality: Adaptive Bounds via Finite Geometry (Anastasis Kratsios et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Digital Computers Break the Curse of Dimensionality: Adaptive Bounds via Finite Geometry" index=93>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (94/186) CIC: A framework for Culturally-aware Image Captioning (Youngsik Yun et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="CIC: A framework for Culturally-aware Image Captioning" index=94>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (95/186) Question Aware Vision Transformer for Multimodal Reasoning (Roy Ganz et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Question Aware Vision Transformer for Multimodal Reasoning" index=95>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<br/>
<button class="copy-to-clipboard" title="SPHINX-X: Scaling Data and Parameters for a Family of Multi-modal Large Language Models" index=96>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (97/186) Editable Scene Simulation for Autonomous Driving via Collaborative LLM-Agents (Yuxi Wei et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Editable Scene Simulation for Autonomous Driving via Collaborative LLM-Agents" index=97>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (98/186) Enhancing Zero-shot Counting via Language-guided Exemplar Learning (Mingjie Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Enhancing Zero-shot Counting via Language-guided Exemplar Learning" index=98>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (99/186) InstaGen: Enhancing Object Detection by Training on Synthetic Dataset (Chengjian Feng et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="InstaGen: Enhancing Object Detection by Training on Synthetic Dataset" index=99>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (100/186) ClickSAM: Fine-tuning Segment Anything Model using click prompts for ultrasound image segmentation (Aimee Guo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="ClickSAM: Fine-tuning Segment Anything Model using click prompts for ultrasound image segmentation" index=100>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (101/186) CREMA: Multimodal Compositional Video Reasoning via Efficient Modular Adaptation and Fusion (Shoubin Yu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="CREMA: Multimodal Compositional Video Reasoning via Efficient Modular Adaptation and Fusion" index=101>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (102/186) On Convolutional Vision Transformers for Yield Prediction (Alvin Inderka et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="On Convolutional Vision Transformers for Yield Prediction" index=102>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (103/186) Spiking Neural Network Enhanced Hand Gesture Recognition Using Low-Cost Single-photon Avalanche Diode Array (Zhenya Zang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Spiking Neural Network Enhanced Hand Gesture Recognition Using Low-Cost Single-photon Avalanche Diode Array" index=103>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (104/186) Task-customized Masked AutoEncoder via Mixture of Cluster-conditional Experts (Zhili Liu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Task-customized Masked AutoEncoder via Mixture of Cluster-conditional Experts" index=104>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (105/186) Get What You Want, Not What You Don't: Image Content Suppression for Text-to-Image Diffusion Models (Senmao Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Get What You Want, Not What You Don't: Image Content Suppression for Text-to-Image Diffusion Models" index=105>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (106/186) Point-VOS: Pointing Up Video Object Segmentation (Idil Esen Zulfikar et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Point-VOS: Pointing Up Video Object Segmentation" index=106>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (107/186) Mamba-ND: Selective State Space Modeling for Multi-Dimensional Data (Shufan Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Mamba-ND: Selective State Space Modeling for Multi-Dimensional Data" index=107>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (108/186) Memory Consolidation Enables Long-Context Video Understanding (Ivana Balažević et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Memory Consolidation Enables Long-Context Video Understanding" index=108>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (109/186) Privacy-Preserving Synthetic Continual Semantic Segmentation for Robotic Surgery (Mengya Xu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Privacy-Preserving Synthetic Continual Semantic Segmentation for Robotic Surgery" index=109>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<br/>
<button class="copy-to-clipboard" title="AvatarMMC: 3D Head Avatar Generation and Editing with Multi-Modal Conditioning" index=110>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (111/186) Real-time Holistic Robot Pose Estimation with Unknown States (Shikun Ban et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Real-time Holistic Robot Pose Estimation with Unknown States" index=111>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (112/186) Scalable Diffusion Models with State Space Backbone (Zhengcong Fei et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Scalable Diffusion Models with State Space Backbone" index=112>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (113/186) RESMatch: Referring Expression Segmentation in a Semi-Supervised Manner (Ying Zang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="RESMatch: Referring Expression Segmentation in a Semi-Supervised Manner" index=113>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (114/186) Segmentation-free Connectionist Temporal Classification loss based OCR Model for Text Captcha Classification (Vaibhav Khatavkar et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Segmentation-free Connectionist Temporal Classification loss based OCR Model for Text Captcha Classification" index=114>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (115/186) Collaborative Control for Geometry-Conditioned PBR Image Generation (Shimon Vainer et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Collaborative Control for Geometry-Conditioned PBR Image Generation" index=115>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (116/186) Jacquard V2: Refining Datasets using the Human In the Loop Data Correction Method (Qiuhao Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Jacquard V2: Refining Datasets using the Human In the Loop Data Correction Method" index=116>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (117/186) DiffSpeaker: Speech-Driven 3D Facial Animation with Diffusion Transformer (Zhiyuan Ma et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="DiffSpeaker: Speech-Driven 3D Facial Animation with Diffusion Transformer" index=117>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (118/186) DAPlankton: Benchmark Dataset for Multi-instrument Plankton Recognition via Fine-grained Domain Adaptation (Daniel Batrakhanov et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="DAPlankton: Benchmark Dataset for Multi-instrument Plankton Recognition via Fine-grained Domain Adaptation" index=118>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (119/186) Efficient Expression Neutrality Estimation with Application to Face Recognition Utility Prediction (Marcel Grimmer et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Efficient Expression Neutrality Estimation with Application to Face Recognition Utility Prediction" index=119>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (120/186) MIGC: Multi-Instance Generation Controller for Text-to-Image Synthesis (Dewei Zhou et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="MIGC: Multi-Instance Generation Controller for Text-to-Image Synthesis" index=120>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (121/186) Descanning: From Scanned to the Original Images with a Color Correction Diffusion Model (Junghun Cha et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Descanning: From Scanned to the Original Images with a Color Correction Diffusion Model" index=121>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (122/186) Scrapping The Web For Early Wildfire Detection (Mateo Lostanlen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Scrapping The Web For Early Wildfire Detection" index=122>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (123/186) Comprehensive Assessment of Jailbreak Attacks Against LLMs (Junjie Chu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Comprehensive Assessment of Jailbreak Attacks Against LLMs" index=123>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (124/186) Domain-Agnostic Hardware Fingerprinting-Based Device Identifier for Zero-Trust IoT Security (Abdurrahman Elmaghbub et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Domain-Agnostic Hardware Fingerprinting-Based Device Identifier for Zero-Trust IoT Security" index=124>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (125/186) Buffer Overflow in Mixture of Experts (Jamie Hayes et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Buffer Overflow in Mixture of Experts" index=125>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (126/186) Graph Neural Networks for Physical-Layer Security in Multi-User Flexible-Duplex Networks (Tharaka Perera et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Graph Neural Networks for Physical-Layer Security in Multi-User Flexible-Duplex Networks" index=126>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<br/>
<button class="copy-to-clipboard" title="A Non-Intrusive Neural Quality Assessment Model for Surface Electromyography Signals" index=127>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (128/186) Examining Gender and Racial Bias in Large Vision-Language Models Using a Novel Dataset of Parallel Images (Kathleen C. Fraser et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Examining Gender and Racial Bias in Large Vision-Language Models Using a Novel Dataset of Parallel Images" index=128>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (129/186) A Framework for Assessing Proportionate Intervention with Face Recognition Systems in Real-Life Scenarios (Pablo Negri et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Framework for Assessing Proportionate Intervention with Face Recognition Systems in Real-Life Scenarios" index=129>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (130/186) CounterCLR: Counterfactual Contrastive Learning with Non-random Missing Data in Recommendation (Jun Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="CounterCLR: Counterfactual Contrastive Learning with Non-random Missing Data in Recommendation" index=130>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (131/186) Natural Language User Profiles for Transparent and Scrutable Recommendations (Jerome Ramos et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Natural Language User Profiles for Transparent and Scrutable Recommendations" index=131>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (132/186) Real-World Robot Applications of Foundation Models: A Review (Kento Kawaharazuka et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Real-World Robot Applications of Foundation Models: A Review" index=132>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (133/186) Driving Everywhere with Large Language Model Policy Adaptation (Boyi Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Driving Everywhere with Large Language Model Policy Adaptation" index=133>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
**ABSTRACT**  
Adapting driving behavior to new environments, customs, and laws is a long-standing problem in autonomous driving, precluding the widespread deployment of autonomous vehicles (AVs). In this paper, we present LLaDA, a simple yet powerful tool that enables human drivers and autonomous vehicles alike to drive everywhere by adapting their tasks and motion plans to traffic rules in new locations. LLaDA achieves this by leveraging the impressive <b>zero-shot</b> generalizability of large language models (LLMs) in interpreting the traffic rules in the local driver handbook. Through an extensive user study, we show that LLaDA's instructions are useful in disambiguating in-the-wild unexpected situations. We also demonstrate LLaDA's ability to adapt AV motion planning policies in real-world datasets; LLaDA outperforms baseline planning approaches on all our metrics. Please check our website for more details: https://boyiliee.github.io/llada.

{{</citation>}}


### (134/186) uPLAM: Robust Panoptic Localization and Mapping Leveraging Perception Uncertainties (Kshitij Sirohi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="uPLAM: Robust Panoptic Localization and Mapping Leveraging Perception Uncertainties" index=134>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<br/>
<button class="copy-to-clipboard" title="Learning to Control Emulated Muscles in Real Robots: Towards Exploiting Bio-Inspired Actuator Morphology" index=135>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (136/186) On Experimental Emulation of Printability and Fleet Aware Generic Mesh Decomposition for Enabling Aerial 3D Printing (Marios-Nektarios Stamatopoulos et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="On Experimental Emulation of Printability and Fleet Aware Generic Mesh Decomposition for Enabling Aerial 3D Printing" index=136>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (137/186) An Optimal Control Formulation of Tool Affordance Applied to Impact Tasks (Boyang Ti et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="An Optimal Control Formulation of Tool Affordance Applied to Impact Tasks" index=137>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 20  
Keywords: Simulation, Simulator  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.05502v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2402.05502v1.pdf" filename="2402.05502v1.pdf">Download PDF</button>
...
### (138/186) CURE: Simulation-Augmented Auto-Tuning in Robotics (Md Abir Hossen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="CURE: Simulation-Augmented Auto-Tuning in Robotics" index=138>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (139/186) FuncGrasp: Learning Object-Centric Neural Grasp Functions from Single Annotated Example Object (Hanzhi Chen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="FuncGrasp: Learning Object-Centric Neural Grasp Functions from Single Annotated Example Object" index=139>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (140/186) Rocks Coding, Not Development--A Human-Centric, Experimental Evaluation of LLM-Supported SE Tasks (Wei Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Rocks Coding, Not Development--A Human-Centric, Experimental Evaluation of LLM-Supported SE Tasks" index=140>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2402.05650v1.pdf" filename="2402.05650v1.pdf">Download PDF</button>
...
### (141/186) The Impact of AI Tool on Engineering at ANZ Bank An Emperical Study on GitHub Copilot within Coporate Environment (Sayan Chatterjee et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="The Impact of AI Tool on Engineering at ANZ Bank An Emperical Study on GitHub Copilot within Coporate Environment" index=141>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (142/186) Using Changeset Descriptions as a Data Source to Assist Feature Location (Muslim Chochlov et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Using Changeset Descriptions as a Data Source to Assist Feature Location" index=142>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (143/186) Investigating Reproducibility in Deep Learning-Based Software Fault Prediction (Adil Mukhtar et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Investigating Reproducibility in Deep Learning-Based Software Fault Prediction" index=143>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (144/186) POLARIS: A framework to guide the development of Trustworthy AI systems (Maria Teresa Baldassarre et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="POLARIS: A framework to guide the development of Trustworthy AI systems" index=144>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (145/186) I-FENN with Temporal Convolutional Networks: expediting the load-history analysis of non-local gradient damage propagation (Panos Pantidis et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="I-FENN with Temporal Convolutional Networks: expediting the load-history analysis of non-local gradient damage propagation" index=145>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (146/186) Shape Optimization of Eigenfrequencies in MEMS Gyroscopes (Daniel Schiwietz et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Shape Optimization of Eigenfrequencies in MEMS Gyroscopes" index=146>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (147/186) Using YOLO v7 to Detect Kidney in Magnetic Resonance Imaging: A Supervised Contrastive Learning (Pouria Yazdian Anari et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Using YOLO v7 to Detect Kidney in Magnetic Resonance Imaging: A Supervised Contrastive Learning" index=147>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (148/186) Memory-efficient deep end-to-end posterior network (DEEPEN) for inverse problems (Jyothi Rikhab Chand et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Memory-efficient deep end-to-end posterior network (DEEPEN) for inverse problems" index=148>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (149/186) Unleashing the Infinity Power of Geometry: A Novel Geometry-Aware Transformer (GOAT) for Whole Slide Histopathology Image Analysis (Mingxin Liu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Unleashing the Infinity Power of Geometry: A Novel Geometry-Aware Transformer (GOAT) for Whole Slide Histopathology Image Analysis" index=149>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (150/186) Joint End-to-End Image Compression and Denoising: Leveraging Contrastive Learning and Multi-Scale Self-ONNs (Yuxin Xie et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Joint End-to-End Image Compression and Denoising: Leveraging Contrastive Learning and Multi-Scale Self-ONNs" index=150>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (151/186) Coded Many-User Multiple Access via Approximate Message Passing (Xiaoqi Liu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Coded Many-User Multiple Access via Approximate Message Passing" index=151>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (152/186) Boosting Dynamic TDD in Small Cell Networks by the Multiplicative Weight Update Method (Jiaqi Zhu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Boosting Dynamic TDD in Small Cell Networks by the Multiplicative Weight Update Method" index=152>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (153/186) Can Channels be Fully Inferred Between Two Antenna Panels? (Y. Qiu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Can Channels be Fully Inferred Between Two Antenna Panels?" index=153>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (154/186) Localized and Distributed Beyond Diagonal Reconfigurable Intelligent Surfaces with Lossy Interconnections: Modeling and Optimization (Matteo Nerini et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Localized and Distributed Beyond Diagonal Reconfigurable Intelligent Surfaces with Lossy Interconnections: Modeling and Optimization" index=154>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (155/186) Reduced-order modeling of unsteady fluid flow using neural network ensembles (Rakesh Halder et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Reduced-order modeling of unsteady fluid flow using neural network ensembles" index=155>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (156/186) Consensus-driven Deviated Pursuit for Guaranteed Simultaneous Interception of Moving Targets (Abhinav Sinha et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Consensus-driven Deviated Pursuit for Guaranteed Simultaneous Interception of Moving Targets" index=156>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (157/186) Underwater MEMS Gyrocompassing: A Virtual Testing Ground (Daniel Engelsman et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Underwater MEMS Gyrocompassing: A Virtual Testing Ground" index=157>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 20  
Keywords: Simulation, Simulator  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.05790v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2402.05790v1.pdf" filename="2402.05790v1.pdf">Download PDF</button>
...
### (158/186) Stochastic COLREGs Evaluation for Safe Navigation under Uncertainty (Peter Nicholas Hansen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Stochastic COLREGs Evaluation for Safe Navigation under Uncertainty" index=158>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (159/186) Triangular phase-shift detector for drone precise vertical landing RF systems (Víctor Araña-Pulido et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Triangular phase-shift detector for drone precise vertical landing RF systems" index=159>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (160/186) Design and Prototyping of Transmissive RIS-Aided Wireless Communication (Jianan Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Design and Prototyping of Transmissive RIS-Aided Wireless Communication" index=160>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (161/186) Multi-Network Constrained Operational Optimization in Community Integrated Energy Systems: A Safe Reinforcement Learning Approach (Ze Hu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Multi-Network Constrained Operational Optimization in Community Integrated Energy Systems: A Safe Reinforcement Learning Approach" index=161>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (162/186) Combining Voting and Abstract Argumentation to Understand Online Discussions (Michael Bernreiter et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Combining Voting and Abstract Argumentation to Understand Online Discussions" index=162>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (163/186) When is Mean-Field Reinforcement Learning Tractable and Relevant? (Batuhan Yardim et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="When is Mean-Field Reinforcement Learning Tractable and Relevant?" index=163>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (164/186) GET-Tok: A GenAI-Enriched Multimodal TikTok Dataset Documenting the 2022 Attempted Coup in Peru (Gabriela Pinto et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="GET-Tok: A GenAI-Enriched Multimodal TikTok Dataset Documenting the 2022 Attempted Coup in Peru" index=164>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (165/186) Prior-Dependent Allocations for Bayesian Fixed-Budget Best-Arm Identification in Structured Bandits (Nicolas Nguyen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Prior-Dependent Allocations for Bayesian Fixed-Budget Best-Arm Identification in Structured Bandits" index=165>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (166/186) How do Transformers perform In-Context Autoregressive Learning? (Michael E. Sander et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="How do Transformers perform In-Context Autoregressive Learning?" index=166>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (167/186) REMEDI: Corrective Transformations for Improved Neural Entropy Estimation (Viktor Nilsson et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="REMEDI: Corrective Transformations for Improved Neural Entropy Estimation" index=167>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (168/186) A High Dimensional Model for Adversarial Training: Geometry and Trade-Offs (Kasimir Tanner et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A High Dimensional Model for Adversarial Training: Geometry and Trade-Offs" index=168>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (169/186) Classification under Nuisance Parameters and Generalized Label Shift in Likelihood-Free Inference (Luca Masserano et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Classification under Nuisance Parameters and Generalized Label Shift in Likelihood-Free Inference" index=169>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (170/186) Offline Risk-sensitive RL with Partial Observability to Enhance Performance in Human-Robot Teaming (Giorgio Angelotti et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Offline Risk-sensitive RL with Partial Observability to Enhance Performance in Human-Robot Teaming" index=170>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (171/186) Linking Vision and Multi-Agent Communication through Visible Light Communication using Event Cameras (Haruyuki Nakagawa et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Linking Vision and Multi-Agent Communication through Visible Light Communication using Event Cameras" index=171>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (172/186) Performance Evaluation of Associative Watermarking Using Statistical Neurodynamics (Ryoto Kanegae et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Performance Evaluation of Associative Watermarking Using Statistical Neurodynamics" index=172>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (173/186) Multispecies bird sound recognition using a fully convolutional neural network (María Teresa García-Ordás et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Multispecies bird sound recognition using a fully convolutional neural network" index=173>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (174/186) Reconsidering the performance of DEVS modeling and simulation environments using the DEVStone benchmark (José L. Risco-Martín et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Reconsidering the performance of DEVS modeling and simulation environments using the DEVStone benchmark" index=174>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (175/186) A State-of-the-art Survey on Full-duplex Network Design (Yonghwi Kim et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A State-of-the-art Survey on Full-duplex Network Design" index=175>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (176/186) Personalizing Driver Safety Interfaces via Driver Cognitive Factors Inference (Emily S Sumner et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Personalizing Driver Safety Interfaces via Driver Cognitive Factors Inference" index=176>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (177/186) Form-From: A Design Space of Social Media Systems (Amy X. Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Form-From: A Design Space of Social Media Systems" index=177>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (178/186) Dirichlet Flow Matching with Applications to DNA Sequence Design (Hannes Stark et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Dirichlet Flow Matching with Applications to DNA Sequence Design" index=178>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (179/186) Integrating Self-supervised Speech Model with Pseudo Word-level Targets from Visually-grounded Speech Model (Hung-Chieh Fang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Integrating Self-supervised Speech Model with Pseudo Word-level Targets from Visually-grounded Speech Model" index=179>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (180/186) Strassen's algorithm is not optimally accurate (Jean-Guillaume Dumas et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Strassen's algorithm is not optimally accurate" index=180>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (181/186) Neural functional a posteriori error estimates (Vladimir Fanaskov et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Neural functional a posteriori error estimates" index=181>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (182/186) Neural Multigrid Architectures (Vladimir Fanaskov, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Neural Multigrid Architectures" index=182>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (183/186) Neural Graphics Primitives-based Deformable Image Registration for On-the-fly Motion Extraction (Xia Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Neural Graphics Primitives-based Deformable Image Registration for On-the-fly Motion Extraction" index=183>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (184/186) Tight Approximation Bounds on a Simple Algorithm for Minimum Average Search Time in Trees (Svein Høgemo, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Tight Approximation Bounds on a Simple Algorithm for Minimum Average Search Time in Trees" index=184>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (185/186) Machine learning applied to omics data (Aida Calviño et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Machine learning applied to omics data" index=185>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (186/186) Can ChatGPT evaluate research quality? (Mike Thelwall, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Can ChatGPT evaluate research quality?" index=186>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
