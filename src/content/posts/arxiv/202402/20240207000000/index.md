...
### (1/185) Reverse Engineering and Security Evaluation of Commercial Tags for RFID-Based IoT Applications (Tiago M. Fernández-Caramés et al., 2024)

{{<citation>}}

Tiago M. Fernández-Caramés, Paula Fraga-Lamas, Manuel Suárez-Albela, Luis Castedo. (2024)  
**Reverse Engineering and Security Evaluation of Commercial Tags for RFID-Based IoT Applications**
<br/>
<button class="copy-to-clipboard" title="Reverse Engineering and Security Evaluation of Commercial Tags for RFID-Based IoT Applications" index=0>
...
Keywords: Security  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.03591v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03591v1.pdf" filename="2402.03591v1.pdf">Download PDF</button>
...
### (2/185) Multi-Agent Reinforcement Learning for Offloading Cellular Communications with Cooperating UAVs (Abhishek Mondal et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Multi-Agent Reinforcement Learning for Offloading Cellular Communications with Cooperating UAVs" index=0>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-0 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02957v1.pdf" filename="2402.02957v1.pdf">Download PDF</button>
...
### (3/185) Assessing the Impact of Distribution Shift on Reinforcement Learning Performance (Ted Fujimoto et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Assessing the Impact of Distribution Shift on Reinforcement Learning Performance" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03590v1.pdf" filename="2402.03590v1.pdf">Download PDF</button>
...
### (4/185) A Reinforcement Learning Approach for Dynamic Rebalancing in Bike-Sharing System (Jiaqi Liang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Reinforcement Learning Approach for Dynamic Rebalancing in Bike-Sharing System" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03589v1.pdf" filename="2402.03589v1.pdf">Download PDF</button>
...
### (5/185) Revisiting the Dataset Bias Problem from a Statistical Perspective (Kien Do et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Revisiting the Dataset Bias Problem from a Statistical Perspective" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03577v1.pdf" filename="2402.03577v1.pdf">Download PDF</button>
...
### (6/185) Generalization Properties of Adversarial Training for $\ell_0$-Bounded Adversarial Attacks (Payam Delgosha et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Generalization Properties of Adversarial Training for $\ell_0$-Bounded Adversarial Attacks" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
Keywords: Adversarial Attack, Adversarial Training  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.03576v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03576v1.pdf" filename="2402.03576v1.pdf">Download PDF</button>
...
### (7/185) Distinguishing the Knowable from the Unknowable with Language Models (Gustaf Ahdritz et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Distinguishing the Knowable from the Unknowable with Language Models" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03563v1.pdf" filename="2402.03563v1.pdf">Download PDF</button>
...
### (8/185) Path Signatures and Graph Neural Networks for Slow Earthquake Analysis: Better Together? (Hans Riess et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Path Signatures and Graph Neural Networks for Slow Earthquake Analysis: Better Together?" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03558v1.pdf" filename="2402.03558v1.pdf">Download PDF</button>
...
### (9/185) Single-GPU GNN Systems: Traps and Pitfalls (Yidong Gong et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Single-GPU GNN Systems: Traps and Pitfalls" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03548v1.pdf" filename="2402.03548v1.pdf">Download PDF</button>
...
### (10/185) HAMLET: Graph Transformer Neural Operator for Partial Differential Equations (Andrey Bryutkin et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="HAMLET: Graph Transformer Neural Operator for Partial Differential Equations" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03541v1.pdf" filename="2402.03541v1.pdf">Download PDF</button>
...
### (11/185) Deep Reinforcement Learning for Picker Routing Problem in Warehousing (George Dunn et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Deep Reinforcement Learning for Picker Routing Problem in Warehousing" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03525v1.pdf" filename="2402.03525v1.pdf">Download PDF</button>
...
### (12/185) Early prediction of onset of sepsis in Clinical Setting (Fahim Mohammad et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Early prediction of onset of sepsis in Clinical Setting" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03486v1.pdf" filename="2402.03486v1.pdf">Download PDF</button>
...
### (13/185) Trillion Parameter AI Serving Infrastructure for Scientific Discovery: A Survey and Vision (Nathaniel Hudson et al., 2024)

{{<citation>}}

Nathaniel Hudson, J. Gregory Pauloski, Matt Baughman, Alok Kamatar, Mansi Sakarvadia, Logan Ward, Ryan Chard, André Bauer, Maksim Levental, Wenyi Wang, Will Engler, Owen Price Skelly, Ben Blaiszik, Rick Stevens, Kyle Chard, Ian Foster. (2024)  
**Trillion Parameter AI Serving Infrastructure for Scientific Discovery: A Survey and Vision**
<br/>
<button class="copy-to-clipboard" title="Trillion Parameter AI Serving Infrastructure for Scientific Discovery: A Survey and Vision" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
Keywords: AI  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.03480v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03480v1.pdf" filename="2402.03480v1.pdf">Download PDF</button>
...
### (14/185) ICED: Zero-Shot Transfer in Reinforcement Learning via In-Context Environment Design (Samuel Garcin et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="ICED: Zero-Shot Transfer in Reinforcement Learning via In-Context Environment Design" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03479v1.pdf" filename="2402.03479v1.pdf">Download PDF</button>
...
### (15/185) GUARD: Role-playing to Generate Natural-language Jailbreakings to Test Guideline Adherence of Large Language Models (Haibo Jin et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="GUARD: Role-playing to Generate Natural-language Jailbreakings to Test Guideline Adherence of Large Language Models" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03299v1.pdf" filename="2402.03299v1.pdf">Download PDF</button>
...
### (16/185) Multiclass Classification Procedure for Detecting Attacks on MQTT-IoT Protocol (Hector Alaiz-Moreton et al., 2024)

{{<citation>}}

Hector Alaiz-Moreton, Jose Aveleira-Mata, Jorge Ondicol-Garcia, Angel Luis Muñoz-Castañeda, Isaías García, Carmen Benavides. (2024)  
**Multiclass Classification Procedure for Detecting Attacks on MQTT-IoT Protocol**
<br/>
<button class="copy-to-clipboard" title="Multiclass Classification Procedure for Detecting Attacks on MQTT-IoT Protocol" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
---
Primary Category: cs.LG  
Categories: I-2-0, cs-CR, cs-LG, cs.LG  
Keywords: Intrusion Detection  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.03270v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03270v1.pdf" filename="2402.03270v1.pdf">Download PDF</button>
...
### (17/185) Understanding the Reasoning Ability of Language Models From the Perspective of Reasoning Paths Aggregation (Xinyi Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Understanding the Reasoning Ability of Language Models From the Perspective of Reasoning Paths Aggregation" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03268v1.pdf" filename="2402.03268v1.pdf">Download PDF</button>
...
### (18/185) MobilityGPT: Enhanced Human Mobility Modeling with a GPT model (Ammar Haydari et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="MobilityGPT: Enhanced Human Mobility Modeling with a GPT model" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
Primary Category: cs.LG  
Categories: cs-LG, cs.LG  
Keywords: GPT, Reinforcement Learning, Transformer  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.03264v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03264v1.pdf" filename="2402.03264v1.pdf">Download PDF</button>
...
### (19/185) Skill Set Optimization: Reinforcing Language Model Behavior via Transferable Skills (Kolby Nottingham et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Skill Set Optimization: Reinforcing Language Model Behavior via Transferable Skills" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03244v1.pdf" filename="2402.03244v1.pdf">Download PDF</button>
...
### (20/185) FuseMoE: Mixture-of-Experts Transformers for Fleximodal Fusion (Xing Han et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="FuseMoE: Mixture-of-Experts Transformers for Fleximodal Fusion" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03226v1.pdf" filename="2402.03226v1.pdf">Download PDF</button>
...
### (21/185) Empowering Time Series Analysis with Large Language Models: A Survey (Yushan Jiang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Empowering Time Series Analysis with Large Language Models: A Survey" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03182v1.pdf" filename="2402.03182v1.pdf">Download PDF</button>
...
### (22/185) The Matrix: A Bayesian learning model for LLMs (Siddhartha Dalal et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="The Matrix: A Bayesian learning model for LLMs" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03175v1.pdf" filename="2402.03175v1.pdf">Download PDF</button>
...
### (23/185) Optimal and Near-Optimal Adaptive Vector Quantization (Ran Ben-Basat et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Optimal and Near-Optimal Adaptive Vector Quantization" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03158v1.pdf" filename="2402.03158v1.pdf">Download PDF</button>
...
### (24/185) A Multi-step Loss Function for Robust Learning of the Dynamics in Model-based Reinforcement Learning (Abdelhakim Benechehab et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Multi-step Loss Function for Robust Learning of the Dynamics in Model-based Reinforcement Learning" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03146v1.pdf" filename="2402.03146v1.pdf">Download PDF</button>
...
### (25/185) Less is KEN: a Universal and Simple Non-Parametric Pruning Algorithm for Large Language Models (Michele Mastromattei et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Less is KEN: a Universal and Simple Non-Parametric Pruning Algorithm for Large Language Models" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03142v1.pdf" filename="2402.03142v1.pdf">Download PDF</button>
...
### (26/185) Boosting Long-Delayed Reinforcement Learning with Auxiliary Short-Delayed Task (Qingyuan Wu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Boosting Long-Delayed Reinforcement Learning with Auxiliary Short-Delayed Task" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03141v1.pdf" filename="2402.03141v1.pdf">Download PDF</button>
...
### (27/185) Enhancing Neural Subset Selection: Integrating Background Information into Set Representations (Binghui Xie et al., 2024)

{{<citation>}}

Binghui Xie, Yatao Bian, Kaiwen zhou, Yongqiang Chen, Peilin Zhao, Bo Han, Wei Meng, James Cheng. (2024)  
**Enhancing Neural Subset Selection: Integrating Background Information into Set Representations**
<br/>
<button class="copy-to-clipboard" title="Enhancing Neural Subset Selection: Integrating Background Information into Set Representations" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
Categories: cs-LG, cs.LG  
Keywords: AI  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.03139v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03139v1.pdf" filename="2402.03139v1.pdf">Download PDF</button>
...
### (28/185) Infrared Spectra Prediction for Diazo Groups Utilizing a Machine Learning Approach with Structural Attention Mechanism (Chengchun Liu et al., 2024)

{{<citation>}}

Chengchun Liu, Fanyang Mo. (2024)  
**Infrared Spectra Prediction for Diazo Groups Utilizing a Machine Learning Approach with Structural Attention Mechanism**
<br/>
<button class="copy-to-clipboard" title="Infrared Spectra Prediction for Diazo Groups Utilizing a Machine Learning Approach with Structural Attention Mechanism" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
Keywords: Attention  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.03112v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03112v1.pdf" filename="2402.03112v1.pdf">Download PDF</button>
...
### (29/185) Open RL Benchmark: Comprehensive Tracked Experiments for Reinforcement Learning (Shengyi Huang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Open RL Benchmark: Comprehensive Tracked Experiments for Reinforcement Learning" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03046v1.pdf" filename="2402.03046v1.pdf">Download PDF</button>
...
### (30/185) Automatic Combination of Sample Selection Strategies for Few-Shot Learning (Branislav Pecher et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Automatic Combination of Sample Selection Strategies for Few-Shot Learning" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03038v1.pdf" filename="2402.03038v1.pdf">Download PDF</button>
...
### (31/185) Toward Green and Human-Like Artificial Intelligence: A Complete Survey on Contemporary Few-Shot Learning Approaches (Georgios Tsoumplekas et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Toward Green and Human-Like Artificial Intelligence: A Complete Survey on Contemporary Few-Shot Learning Approaches" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03017v1.pdf" filename="2402.03017v1.pdf">Download PDF</button>
...
### (32/185) Careful with that Scalpel: Improving Gradient Surgery with an EMA (Yu-Guan Hsieh et al., 2024)

{{<citation>}}

Yu-Guan Hsieh, James Thornton, Eugene Ndiaye, Michal Klein, Marco Cuturi, Pierre Ablin. (2024)  
**Careful with that Scalpel: Improving Gradient Surgery with an EMA**
<br/>
<button class="copy-to-clipboard" title="Careful with that Scalpel: Improving Gradient Surgery with an EMA" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
Categories: cs-LG, cs.LG, stat-ML  
Keywords: NLP  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.02998v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02998v1.pdf" filename="2402.02998v1.pdf">Download PDF</button>
...
### (33/185) Text-Guided Image Clustering (Andreas Stephan et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Text-Guided Image Clustering" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02996v1.pdf" filename="2402.02996v1.pdf">Download PDF</button>
...
### (34/185) Decoding-time Realignment of Language Models (Tianlin Liu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Decoding-time Realignment of Language Models" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02992v1.pdf" filename="2402.02992v1.pdf">Download PDF</button>
...
### (35/185) Fine-tuning Reinforcement Learning Models is Secretly a Forgetting Mitigation Problem (Maciej Wołczyk et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Fine-tuning Reinforcement Learning Models is Secretly a Forgetting Mitigation Problem" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02868v1.pdf" filename="2402.02868v1.pdf">Download PDF</button>
...
### (36/185) Shortened LLaMA: A Simple Depth Pruning for Large Language Models (Bo-Kyeong Kim et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Shortened LLaMA: A Simple Depth Pruning for Large Language Models" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02834v1.pdf" filename="2402.02834v1.pdf">Download PDF</button>
...
### (37/185) PowerGraph: A power grid benchmark dataset for graph neural networks (Anna Varbella et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="PowerGraph: A power grid benchmark dataset for graph neural networks" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02827v1.pdf" filename="2402.02827v1.pdf">Download PDF</button>
...
### (38/185) Evading Data Contamination Detection for Language Models is (too) Easy (Jasper Dekoninck et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Evading Data Contamination Detection for Language Models is (too) Easy" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02823v1.pdf" filename="2402.02823v1.pdf">Download PDF</button>
...
### (39/185) Revisiting VAE for Unsupervised Time Series Anomaly Detection: A Frequency Perspective (Zexin Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Revisiting VAE for Unsupervised Time Series Anomaly Detection: A Frequency Perspective" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02820v1.pdf" filename="2402.02820v1.pdf">Download PDF</button>
...
### (40/185) Stable and Robust Deep Learning By Hyperbolic Tangent Exponential Linear Unit (TeLU) (Alfredo Fernandez et al., 2024)

{{<citation>}}

Alfredo Fernandez, Ankur Mali. (2024)  
**Stable and Robust Deep Learning By Hyperbolic Tangent Exponential Linear Unit (TeLU)**
<br/>
<button class="copy-to-clipboard" title="Stable and Robust Deep Learning By Hyperbolic Tangent Exponential Linear Unit (TeLU)" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
Keywords: ImageNet  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.02790v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02790v1.pdf" filename="2402.02790v1.pdf">Download PDF</button>
...
### (41/185) Contrastive Diffuser: Planning Towards High Return States via Contrastive Learning (Yixiang Shan et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Contrastive Diffuser: Planning Towards High Return States via Contrastive Learning" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02772v2.pdf" filename="2402.02772v2.pdf">Download PDF</button>
...
### (42/185) Learning from Teaching Regularization: Generalizable Correlations Should be Easy to Imitate (Can Jin et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Learning from Teaching Regularization: Generalizable Correlations Should be Easy to Imitate" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02769v1.pdf" filename="2402.02769v1.pdf">Download PDF</button>
...
### (43/185) Position Paper: What Can Large Language Models Tell Us about Time Series Analysis (Ming Jin et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Position Paper: What Can Large Language Models Tell Us about Time Series Analysis" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02713v1.pdf" filename="2402.02713v1.pdf">Download PDF</button>
...
### (44/185) Understanding What Affects Generalization Gap in Visual Reinforcement Learning: Theory and Empirical Evidence (Jiafei Lyu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Understanding What Affects Generalization Gap in Visual Reinforcement Learning: Theory and Empirical Evidence" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02701v1.pdf" filename="2402.02701v1.pdf">Download PDF</button>
...
### (45/185) Statistical Guarantees for Link Prediction using Graph Neural Networks (Alan Chung et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Statistical Guarantees for Link Prediction using Graph Neural Networks" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02692v2.pdf" filename="2402.02692v2.pdf">Download PDF</button>
...
### (46/185) Counterfactual Explanations of Black-box Machine Learning Models using Causal Discovery with Applications to Credit Rating (Daisuke Takahashi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Counterfactual Explanations of Black-box Machine Learning Models using Causal Discovery with Applications to Credit Rating" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02678v1.pdf" filename="2402.02678v1.pdf">Download PDF</button>
...
### (47/185) Utility-Based Reinforcement Learning: Unifying Single-objective and Multi-objective Reinforcement Learning (Peter Vamplew et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Utility-Based Reinforcement Learning: Unifying Single-objective and Multi-objective Reinforcement Learning" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02665v1.pdf" filename="2402.02665v1.pdf">Download PDF</button>
...
### (48/185) Vision-Language Models Provide Promptable Representations for Reinforcement Learning (William Chen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Vision-Language Models Provide Promptable Representations for Reinforcement Learning" index=1>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-1 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02651v1.pdf" filename="2402.02651v1.pdf">Download PDF</button>
...
### (49/185) Matcha: An IDE Plugin for Creating Accurate Privacy Nutrition Labels (Tianshi Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Matcha: An IDE Plugin for Creating Accurate Privacy Nutrition Labels" index=2>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03582v1.pdf" filename="2402.03582v1.pdf">Download PDF</button>
...
### (50/185) ReviewFlow: Intelligent Scaffolding to Support Academic Peer Reviewing (Lu Sun et al., 2024)

{{<citation>}}

Lu Sun, Aaron Chan, Yun Seo Chang, Steven P. Dow. (2024)  
**ReviewFlow: Intelligent Scaffolding to Support Academic Peer Reviewing**
<br/>
<button class="copy-to-clipboard" title="ReviewFlow: Intelligent Scaffolding to Support Academic Peer Reviewing" index=2>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-2 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
Keywords: AI  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.03530v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03530v1.pdf" filename="2402.03530v1.pdf">Download PDF</button>
...
### (51/185) Knowledge Acquisition and Integration with Expert-in-the-loop (Sajjadur Rahman et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Knowledge Acquisition and Integration with Expert-in-the-loop" index=2>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-2 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03291v1.pdf" filename="2402.03291v1.pdf">Download PDF</button>
...
### (52/185) Feature-Action Design Patterns for Storytelling Visualizations with Time Series Data (Saiful Khan et al., 2024)

{{<citation>}}

Saiful Khan, Scott Jones, Benjamin Bach, Jaehoon Cha, Min Chen, Julie Meikle, Jonathan C Roberts, Jeyan Thiyagalingam, Jo Wood, Panagiotis D. Ritsos. (2024)  
**Feature-Action Design Patterns for Storytelling Visualizations with Time Series Data**
<br/>
<button class="copy-to-clipboard" title="Feature-Action Design Patterns for Storytelling Visualizations with Time Series Data" index=2>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-2 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.03116v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03116v1.pdf" filename="2402.03116v1.pdf">Download PDF</button>
...
### (53/185) MINLP-based hybrid strategy for operating mode selection of TES-backed-up refrigeration systems (G. Bejarano et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="MINLP-based hybrid strategy for operating mode selection of TES-backed-up refrigeration systems" index=3>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03580v2.pdf" filename="2402.03580v2.pdf">Download PDF</button>
...
### (54/185) Toward Human-AI Alignment in Large-Scale Multi-Player Games (Sugandha Sharma et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Toward Human-AI Alignment in Large-Scale Multi-Player Games" index=4>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03575v1.pdf" filename="2402.03575v1.pdf">Download PDF</button>
...
### (55/185) Neural networks for abstraction and reasoning: Towards broad generalization in machines (Mikel Bober-Irizar et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Neural networks for abstraction and reasoning: Towards broad generalization in machines" index=4>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-4 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03507v1.pdf" filename="2402.03507v1.pdf">Download PDF</button>
...
### (56/185) Beyond Text: Improving LLM's Decision Making for Robot Navigation via Vocal Cues (Xingpeng Sun et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Beyond Text: Improving LLM's Decision Making for Robot Navigation via Vocal Cues" index=4>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-4 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03494v1.pdf" filename="2402.03494v1.pdf">Download PDF</button>
...
### (57/185) V-IRL: Grounding Virtual Intelligence in Real Life (Jihan Yang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="V-IRL: Grounding Virtual Intelligence in Real Life" index=4>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-4 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03310v1.pdf" filename="2402.03310v1.pdf">Download PDF</button>
...
### (58/185) C-RAG: Certified Generation Risks for Retrieval-Augmented Language Models (Mintong Kang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="C-RAG: Certified Generation Risks for Retrieval-Augmented Language Models" index=4>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-4 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03181v1.pdf" filename="2402.03181v1.pdf">Download PDF</button>
...
### (59/185) Decidable Reasoning About Time in Finite-Domain Situation Calculus Theories (Till Hofmann et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Decidable Reasoning About Time in Finite-Domain Situation Calculus Theories" index=4>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-4 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03164v1.pdf" filename="2402.03164v1.pdf">Download PDF</button>
...
### (60/185) Mastering Zero-Shot Interactions in Cooperative and Competitive Simultaneous Games (Yannik Mahlau et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Mastering Zero-Shot Interactions in Cooperative and Competitive Simultaneous Games" index=4>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-4 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03136v1.pdf" filename="2402.03136v1.pdf">Download PDF</button>
...
### (61/185) A Review on Building Blocks of Decentralized Artificial Intelligence (Vid Kersic et al., 2024)

{{<citation>}}

Vid Kersic, Muhamed Turkanovic. (2024)  
**A Review on Building Blocks of Decentralized Artificial Intelligence**
<br/>
<button class="copy-to-clipboard" title="A Review on Building Blocks of Decentralized Artificial Intelligence" index=4>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-4 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
---
Primary Category: cs.AI  
Categories: cs-AI, cs-CR, cs-DC, cs.AI  
Keywords: AI  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.02885v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02885v1.pdf" filename="2402.02885v1.pdf">Download PDF</button>
...
### (62/185) Graph-enhanced Large Language Models in Asynchronous Plan Reasoning (Fangru Lin et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Graph-enhanced Large Language Models in Asynchronous Plan Reasoning" index=4>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-4 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02805v1.pdf" filename="2402.02805v1.pdf">Download PDF</button>
...
### (63/185) Understanding the planning of LLM agents: A survey (Xu Huang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Understanding the planning of LLM agents: A survey" index=4>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-4 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02716v1.pdf" filename="2402.02716v1.pdf">Download PDF</button>
...
### (64/185) Multi-step Problem Solving Through a Verifier: An Empirical Analysis on Model-induced Process Supervision (Zihan Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Multi-step Problem Solving Through a Verifier: An Empirical Analysis on Model-induced Process Supervision" index=4>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-4 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02658v1.pdf" filename="2402.02658v1.pdf">Download PDF</button>
...
### (65/185) TexShape: Information Theoretic Sentence Embedding for Language Models (H. Kaan Kale et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="TexShape: Information Theoretic Sentence Embedding for Language Models" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.05132v1.pdf" filename="2402.05132v1.pdf">Download PDF</button>
...
### (66/185) Financial Report Chunking for Effective Retrieval Augmented Generation (Antonio Jimeno Yepes et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Financial Report Chunking for Effective Retrieval Augmented Generation" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.05131v1.pdf" filename="2402.05131v1.pdf">Download PDF</button>
...
### (67/185) Resolving Transcription Ambiguity in Spanish: A Hybrid Acoustic-Lexical System for Punctuation Restoration (Xiliang Zhu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Resolving Transcription Ambiguity in Spanish: A Hybrid Acoustic-Lexical System for Punctuation Restoration" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
Keywords: Language Model, NLP, Speech Recognition  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.03519v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03519v1.pdf" filename="2402.03519v1.pdf">Download PDF</button>
...
### (68/185) SWAG: Storytelling With Action Guidance (Zeeshan Patel et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="SWAG: Storytelling With Action Guidance" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03483v1.pdf" filename="2402.03483v1.pdf">Download PDF</button>
...
### (69/185) Arabic Synonym BERT-based Adversarial Examples for Text Classification (Norah Alshahrani et al., 2024)
...
Primary Category: cs.CL  
Categories: cs-CL, cs.CL  
Keywords: BERT, LSTM, Language Model, Text Classification  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.03477v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03477v1.pdf" filename="2402.03477v1.pdf">Download PDF</button>
...
### (70/185) Psychological Assessments with Large Language Models: A Privacy-Focused and Cost-Effective Approach (Sergi Blanco-Cuaresma, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Psychological Assessments with Large Language Models: A Privacy-Focused and Cost-Effective Approach" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03435v1.pdf" filename="2402.03435v1.pdf">Download PDF</button>
...
### (71/185) Nevermind: Instruction Override and Moderation in Large Language Models (Edward Kim, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Nevermind: Instruction Override and Moderation in Large Language Models" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03303v1.pdf" filename="2402.03303v1.pdf">Download PDF</button>
...
### (72/185) DeepSeekMath: Pushing the Limits of Mathematical Reasoning in Open Language Models (Zhihong Shao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="DeepSeekMath: Pushing the Limits of Mathematical Reasoning in Open Language Models" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03300v2.pdf" filename="2402.03300v2.pdf">Download PDF</button>
...
### (73/185) Deal, or no deal (or who knows)? Forecasting Uncertainty in Conversations using Large Language Models (Anthony Sicilia et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Deal, or no deal (or who knows)? Forecasting Uncertainty in Conversations using Large Language Models" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03284v1.pdf" filename="2402.03284v1.pdf">Download PDF</button>
...
### (74/185) Uncertainty of Thoughts: Uncertainty-Aware Planning Enhances Information Seeking in Large Language Models (Zhiyuan Hu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Uncertainty of Thoughts: Uncertainty-Aware Planning Enhances Information Seeking in Large Language Models" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03271v1.pdf" filename="2402.03271v1.pdf">Download PDF</button>
...
### (75/185) English Prompts are Better for NLI-based Zero-Shot Emotion Classification than Target-Language Prompts (Patrick Barreiß et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="English Prompts are Better for NLI-based Zero-Shot Emotion Classification than Target-Language Prompts" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
Primary Category: cs.CL  
Categories: cs-CL, cs.CL  
Keywords: NLI, Zero-Shot  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.03223v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03223v1.pdf" filename="2402.03223v1.pdf">Download PDF</button>
...
### (76/185) BGE M3-Embedding: Multi-Lingual, Multi-Functionality, Multi-Granularity Text Embeddings Through Self-Knowledge Distillation (Jianlv Chen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="BGE M3-Embedding: Multi-Lingual, Multi-Functionality, Multi-Granularity Text Embeddings Through Self-Knowledge Distillation" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
Primary Category: cs.CL  
Categories: cs-AI, cs-CL, cs-LG, cs.CL  
Keywords: Embedding, Knowledge Distillation  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.03216v2" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03216v2.pdf" filename="2402.03216v2.pdf">Download PDF</button>
...
### (77/185) Unified Hallucination Detection for Multimodal Large Language Models (Xiang Chen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Unified Hallucination Detection for Multimodal Large Language Models" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03190v1.pdf" filename="2402.03190v1.pdf">Download PDF</button>
...
### (78/185) LB-KBQA: Large-language-model and BERT based Knowledge-Based Question and Answering System (Yan Zhao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="LB-KBQA: Large-language-model and BERT based Knowledge-Based Question and Answering System" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
Primary Category: cs.CL  
Categories: cs-AI, cs-CL, cs.CL  
Keywords: AI, BERT, Generative AI, Language Model, QA  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.05130v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.05130v1.pdf" filename="2402.05130v1.pdf">Download PDF</button>
...
### (79/185) CIDAR: Culturally Relevant Instruction Dataset For Arabic (Zaid Alyafeai et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="CIDAR: Culturally Relevant Instruction Dataset For Arabic" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03177v1.pdf" filename="2402.03177v1.pdf">Download PDF</button>
...
### (80/185) Multi: Multimodal Understanding Leaderboard with Text and Images (Zichen Zhu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Multi: Multimodal Understanding Leaderboard with Text and Images" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03173v1.pdf" filename="2402.03173v1.pdf">Download PDF</button>
...
### (81/185) Accurate and Well-Calibrated ICD Code Assignment Through Attention Over Diverse Label Embeddings (Gonçalo Gomes et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Accurate and Well-Calibrated ICD Code Assignment Through Attention Over Diverse Label Embeddings" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
Primary Category: cs.CL  
Categories: cs-AI, cs-CL, cs.CL  
Keywords: Attention, Embedding, Transformer  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.03172v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03172v1.pdf" filename="2402.03172v1.pdf">Download PDF</button>
...
### (82/185) Homograph Attacks on Maghreb Sentiment Analyzers (Fatima Zahra Qachfar et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Homograph Attacks on Maghreb Sentiment Analyzers" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03171v1.pdf" filename="2402.03171v1.pdf">Download PDF</button>
...
### (83/185) Sociolinguistically Informed Interpretability: A Case Study on Hinglish Emotion Classification (Kushal Tatariya et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Sociolinguistically Informed Interpretability: A Case Study on Hinglish Emotion Classification" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03137v1.pdf" filename="2402.03137v1.pdf">Download PDF</button>
...
### (84/185) Constrained Decoding for Cross-lingual Label Projection (Duong Minh Le et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Constrained Decoding for Cross-lingual Label Projection" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
Primary Category: cs.CL  
Categories: cs-CL, cs-LG, cs.CL  
Keywords: NLP, Named Entity Recognition  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.03131v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03131v1.pdf" filename="2402.03131v1.pdf">Download PDF</button>
...
### (85/185) Best Practices for Text Annotation with Large Language Models (Petter Törnberg, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Best Practices for Text Annotation with Large Language Models" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.05129v1.pdf" filename="2402.05129v1.pdf">Download PDF</button>
...
### (86/185) Intent-based Prompt Calibration: Enhancing prompt optimization with synthetic boundary cases (Elad Levi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Intent-based Prompt Calibration: Enhancing prompt optimization with synthetic boundary cases" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03099v1.pdf" filename="2402.03099v1.pdf">Download PDF</button>
...
### (87/185) Multilingual transformer and BERTopic for short text topic modeling: The case of Serbian (Darija Medvecki et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Multilingual transformer and BERTopic for short text topic modeling: The case of Serbian" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03067v1.pdf" filename="2402.03067v1.pdf">Download PDF</button>
...
### (88/185) Multi-Lingual Malaysian Embedding: Leveraging Large Language Models for Semantic Representations (Husein Zolkepli et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Multi-Lingual Malaysian Embedding: Leveraging Large Language Models for Semantic Representations" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
Primary Category: cs.CL  
Categories: cs-CL, cs-LG, cs.CL  
Keywords: AI, Embedding, Language Model, Semantic Similarity, Twitter  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.03053v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03053v1.pdf" filename="2402.03053v1.pdf">Download PDF</button>
...
### (89/185) EasyInstruct: An Easy-to-use Instruction Processing Framework for Large Language Models (Yixin Ou et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="EasyInstruct: An Easy-to-use Instruction Processing Framework for Large Language Models" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03049v2.pdf" filename="2402.03049v2.pdf">Download PDF</button>
...
### (90/185) SIDU-TXT: An XAI Algorithm for NLP with a Holistic Assessment Approach (Mohammad N. S. Jahromi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="SIDU-TXT: An XAI Algorithm for NLP with a Holistic Assessment Approach" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03043v1.pdf" filename="2402.03043v1.pdf">Download PDF</button>
...
### (91/185) UniMem: Towards a Unified View of Long-Context Large Language Models (Junjie Fang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="UniMem: Towards a Unified View of Long-Context Large Language Models" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03009v1.pdf" filename="2402.03009v1.pdf">Download PDF</button>
...
### (92/185) Putting Context in Context: the Impact of Discussion Structure on Text Classification (Nicolò Penzo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Putting Context in Context: the Impact of Discussion Structure on Text Classification" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02975v1.pdf" filename="2402.02975v1.pdf">Download PDF</button>
...
### (93/185) Enhancing Textbook Question Answering Task with Large Language Models and Retrieval Augmented Generation (Hessa Abdulrahman Alawwad et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Enhancing Textbook Question Answering Task with Large Language Models and Retrieval Augmented Generation" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.05128v1.pdf" filename="2402.05128v1.pdf">Download PDF</button>
...
### (94/185) Automated Cognate Detection as a Supervised Link Prediction Task with Cognate Transformer (V. S. D. S. Mahesh Akavarapu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Automated Cognate Detection as a Supervised Link Prediction Task with Cognate Transformer" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02926v1.pdf" filename="2402.02926v1.pdf">Download PDF</button>
...
### (95/185) LLM Agents in Interaction: Measuring Personality Consistency and Linguistic Alignment in Interacting Populations of Large Language Models (Ivar Frisch et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="LLM Agents in Interaction: Measuring Personality Consistency and Linguistic Alignment in Interacting Populations of Large Language Models" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02896v1.pdf" filename="2402.02896v1.pdf">Download PDF</button>
...
### (96/185) Approximate Attributions for Off-the-Shelf Siamese Transformers (Lucas Möller et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Approximate Attributions for Off-the-Shelf Siamese Transformers" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02883v1.pdf" filename="2402.02883v1.pdf">Download PDF</button>
...
### (97/185) How do Large Language Models Learn In-Context? Query and Key Matrices of In-Context Heads are Two Towers for Metric Learning (Zeping Yu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="How do Large Language Models Learn In-Context? Query and Key Matrices of In-Context Heads are Two Towers for Metric Learning" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02872v1.pdf" filename="2402.02872v1.pdf">Download PDF</button>
...
### (98/185) EEVEE: An Easy Annotation Tool for Natural Language Processing (Axel Sorensen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="EEVEE: An Easy Annotation Tool for Natural Language Processing" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02864v1.pdf" filename="2402.02864v1.pdf">Download PDF</button>
...
### (99/185) Comparing Knowledge Sources for Open-Domain Scientific Claim Verification (Juraj Vladika et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Comparing Knowledge Sources for Open-Domain Scientific Claim Verification" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02844v1.pdf" filename="2402.02844v1.pdf">Download PDF</button>
...
### (100/185) KS-Lottery: Finding Certified Lottery Tickets for Multilingual Language Models (Fei Yuan et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="KS-Lottery: Finding Certified Lottery Tickets for Multilingual Language Models" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02801v1.pdf" filename="2402.02801v1.pdf">Download PDF</button>
...
### (101/185) Rethinking Optimization and Architecture for Tiny Language Models (Yehui Tang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Rethinking Optimization and Architecture for Tiny Language Models" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02791v2.pdf" filename="2402.02791v2.pdf">Download PDF</button>
...
### (102/185) Illuminate: A novel approach for depression detection with explainable analysis and proactive therapy using prompt engineering (Aryan Agrawal, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Illuminate: A novel approach for depression detection with explainable analysis and proactive therapy using prompt engineering" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.05127v1.pdf" filename="2402.05127v1.pdf">Download PDF</button>
...
### (103/185) KIVI: A Tuning-Free Asymmetric 2bit Quantization for KV Cache (Zirui Liu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="KIVI: A Tuning-Free Asymmetric 2bit Quantization for KV Cache" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
Keywords: Falcon, Quantization  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.02750v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02750v1.pdf" filename="2402.02750v1.pdf">Download PDF</button>
...
### (104/185) Graph Neural Network and NER-Based Text Summarization (Imaad Zaffar Khan et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Graph Neural Network and NER-Based Text Summarization" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
Primary Category: cs.CL  
Categories: cs-CL, cs-LG, cs.CL  
Keywords: GNN, Graph Neural Network, Graph Neural Networks, NER, Named Entity Recognition, Summarization, Text Summarization  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.05126v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.05126v1.pdf" filename="2402.05126v1.pdf">Download PDF</button>
...
### (105/185) Large Language Models are Geographically Biased (Rohin Manvi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Large Language Models are Geographically Biased" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02680v1.pdf" filename="2402.02680v1.pdf">Download PDF</button>
...
### (106/185) RACER: An LLM-powered Methodology for Scalable Analysis of Semi-structured Mental Health Interviews (Satpreet Harcharan Singh et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="RACER: An LLM-powered Methodology for Scalable Analysis of Semi-structured Mental Health Interviews" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02656v1.pdf" filename="2402.02656v1.pdf">Download PDF</button>
...
### (107/185) VlogQA: Task, Dataset, and Baseline Models for Vietnamese Spoken-Based Machine Reading Comprehension (Thinh Phuoc Ngo et al., 2024)

{{<citation>}}

Thinh Phuoc Ngo, Khoa Tran Anh Dang, Son T. Luu, Kiet Van Nguyen, Ngan Luu-Thuy Nguyen. (2024)  
**VlogQA: Task, Dataset, and Baseline Models for Vietnamese Spoken-Based Machine Reading Comprehension**
<br/>
<button class="copy-to-clipboard" title="VlogQA: Task, Dataset, and Baseline Models for Vietnamese Spoken-Based Machine Reading Comprehension" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.02655v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02655v1.pdf" filename="2402.02655v1.pdf">Download PDF</button>
...
### (108/185) Chain-of-Feedback: Mitigating the Effects of Inconsistency in Responses (Jinwoo Ahn, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Chain-of-Feedback: Mitigating the Effects of Inconsistency in Responses" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02648v1.pdf" filename="2402.02648v1.pdf">Download PDF</button>
...
### (109/185) Zero-Shot Clinical Trial Patient Matching with LLMs (Michael Wornow et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Zero-Shot Clinical Trial Patient Matching with LLMs" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-5 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
Primary Category: cs.CL  
Categories: cs-AI, cs-CL, cs.CL  
Keywords: Clinical, Zero-Shot  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.05125v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.05125v1.pdf" filename="2402.05125v1.pdf">Download PDF</button>
...
### (110/185) VLN-Video: Utilizing Driving Videos for Outdoor Vision-and-Language Navigation (Jialu Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="VLN-Video: Utilizing Driving Videos for Outdoor Vision-and-Language Navigation" index=6>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03561v2.pdf" filename="2402.03561v2.pdf">Download PDF</button>
...
### (111/185) nnMamba: 3D Biomedical Image Segmentation, Classification and Landmark Detection with State Space Model (Haifan Gong et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="nnMamba: 3D Biomedical Image Segmentation, Classification and Landmark Detection with State Space Model" index=6>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-6 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03526v1.pdf" filename="2402.03526v1.pdf">Download PDF</button>
...
### (112/185) An Inpainting-Infused Pipeline for Attire and Background Replacement (Felipe Rodrigues Perche-Mahlow et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="An Inpainting-Infused Pipeline for Attire and Background Replacement" index=6>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-6 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03501v1.pdf" filename="2402.03501v1.pdf">Download PDF</button>
...
### (113/185) Physics-Encoded Graph Neural Networks for Deformation Prediction under Contact (Mahdi Saleh et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Physics-Encoded Graph Neural Networks for Deformation Prediction under Contact" index=6>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-6 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03466v1.pdf" filename="2402.03466v1.pdf">Download PDF</button>
...
### (114/185) Constrained Multiview Representation for Self-supervised Contrastive Learning (Siyuan Dai et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Constrained Multiview Representation for Self-supervised Contrastive Learning" index=6>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-6 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03456v1.pdf" filename="2402.03456v1.pdf">Download PDF</button>
...
### (115/185) HASSOD: Hierarchical Adaptive Self-Supervised Object Detection (Shengcao Cao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="HASSOD: Hierarchical Adaptive Self-Supervised Object Detection" index=6>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-6 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03311v1.pdf" filename="2402.03311v1.pdf">Download PDF</button>
...
### (116/185) A Computer Vision Based Approach for Stalking Detection Using a CNN-LSTM-MLP Hybrid Fusion Model (Murad Hasan et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Computer Vision Based Approach for Stalking Detection Using a CNN-LSTM-MLP Hybrid Fusion Model" index=6>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-6 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
Primary Category: cs.CV  
Categories: cs-CV, cs.CV  
Keywords: Computer Vision, LSTM  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.03417v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03417v1.pdf" filename="2402.03417v1.pdf">Download PDF</button>
...
### (117/185) ActiveAnno3D -- An Active Learning Framework for Multi-Modal 3D Object Detection (Ahmed Ghita et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="ActiveAnno3D -- An Active Learning Framework for Multi-Modal 3D Object Detection" index=6>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-6 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
Keywords: AI, Active Learning, Object Detection  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.03235v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03235v1.pdf" filename="2402.03235v1.pdf">Download PDF</button>
...
### (118/185) Organic or Diffused: Can We Distinguish Human Art from AI-generated Images? (Anna Yoo Jeong Ha et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Organic or Diffused: Can We Distinguish Human Art from AI-generated Images?" index=6>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-6 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03214v2.pdf" filename="2402.03214v2.pdf">Download PDF</button>
...
### (119/185) Video-LaVIT: Unified Video-Language Pre-training with Decoupled Visual-Motional Tokenization (Yang Jin et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Video-LaVIT: Unified Video-Language Pre-training with Decoupled Visual-Motional Tokenization" index=6>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-6 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03161v2.pdf" filename="2402.03161v2.pdf">Download PDF</button>
...
### (120/185) Good Teachers Explain: Explanation-Enhanced Knowledge Distillation (Amin Parchami-Araghi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Good Teachers Explain: Explanation-Enhanced Knowledge Distillation" index=6>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-6 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03119v1.pdf" filename="2402.03119v1.pdf">Download PDF</button>
...
### (121/185) Cross-Domain Few-Shot Object Detection via Enhanced Open-Set Object Detector (Yuqian Fu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Cross-Domain Few-Shot Object Detection via Enhanced Open-Set Object Detector" index=6>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-6 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
Primary Category: cs.CV  
Categories: cs-CV, cs-LG, cs.CV  
Keywords: Few-Shot, Object Detection, Transformer  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.03094v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03094v1.pdf" filename="2402.03094v1.pdf">Download PDF</button>
...
### (122/185) AI-Enhanced Virtual Reality in Medicine: A Comprehensive Survey (Yixuan Wu et al., 2024)

{{<citation>}}

Yixuan Wu, Kaiyuan Hu, Danny Z. Chen, Jian Wu. (2024)  
**AI-Enhanced Virtual Reality in Medicine: A Comprehensive Survey**
<br/>
<button class="copy-to-clipboard" title="AI-Enhanced Virtual Reality in Medicine: A Comprehensive Survey" index=6>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-6 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
Keywords: AI  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.03093v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03093v1.pdf" filename="2402.03093v1.pdf">Download PDF</button>
...
### (123/185) PFDM: Parser-Free Virtual Try-on via Diffusion Model (Yunfang Niu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="PFDM: Parser-Free Virtual Try-on via Diffusion Model" index=6>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-6 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03047v1.pdf" filename="2402.03047v1.pdf">Download PDF</button>
...
### (124/185) [Citation needed] Data usage and citation practices in medical imaging conferences (Théo Sourget et al., 2024)

{{<citation>}}

Théo Sourget, Ahmet Akkoç, Stinna Winther, Christine Lyngbye Galsgaard, Amelia Jiménez-Sánchez, Dovile Juodelyte, Caroline Petitjean, Veronika Cheplygina. (2024)  
**[Citation needed] Data usage and citation practices in medical imaging conferences**
<br/>
<button class="copy-to-clipboard" title="[Citation needed] Data usage and citation practices in medical imaging conferences" index=6>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-6 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
Keywords: AI  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.03003v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03003v1.pdf" filename="2402.03003v1.pdf">Download PDF</button>
...
### (125/185) Exploring the Synergies of Hybrid CNNs and ViTs Architectures for Computer Vision: A survey (Haruna Yunusa et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Exploring the Synergies of Hybrid CNNs and ViTs Architectures for Computer Vision: A survey" index=6>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-6 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
Primary Category: cs.CV  
Categories: cs-CV, cs-LG, cs.CV  
Keywords: Computer Vision, Transformer, Transformers  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.02941v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02941v1.pdf" filename="2402.02941v1.pdf">Download PDF</button>
...
### (126/185) SynthVision -- Harnessing Minimal Input for Maximal Output in Computer Vision Models using Synthetic Image data (Yudara Kularathne et al., 2024)

{{<citation>}}

Yudara Kularathne, Prathapa Janitha, Sithira Ambepitiya, Thanveer Ahamed, Dinuka Wijesundara, Prarththanan Sothyrajah. (2024)  
**SynthVision -- Harnessing Minimal Input for Maximal Output in Computer Vision Models using Synthetic Image data**
<br/>
<button class="copy-to-clipboard" title="SynthVision -- Harnessing Minimal Input for Maximal Output in Computer Vision Models using Synthetic Image data" index=6>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-6 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.02826v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02826v1.pdf" filename="2402.02826v1.pdf">Download PDF</button>
...
### (127/185) Joint Attention-Guided Feature Fusion Network for Saliency Detection of Surface Defects (Xiaoheng Jiang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Joint Attention-Guided Feature Fusion Network for Saliency Detection of Surface Defects" index=6>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-6 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02797v1.pdf" filename="2402.02797v1.pdf">Download PDF</button>
...
### (128/185) ToonAging: Face Re-Aging upon Artistic Portrait Style Transfer (Bumsoo Kim et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="ToonAging: Face Re-Aging upon Artistic Portrait Style Transfer" index=6>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-6 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02733v1.pdf" filename="2402.02733v1.pdf">Download PDF</button>
...
### (129/185) Image-Caption Encoding for Improving Zero-Shot Generalization (Eric Yang Yu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Image-Caption Encoding for Improving Zero-Shot Generalization" index=6>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-6 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02662v1.pdf" filename="2402.02662v1.pdf">Download PDF</button>
...
### (130/185) A security framework for Ethereum smart contracts (Antonio López Vivar et al., 2024)

{{<citation>}}

Antonio López Vivar, Ana Lucila Sandoval Orozco, Luis Javier García Villalba. (2024)  
**A security framework for Ethereum smart contracts**
<br/>
<button class="copy-to-clipboard" title="A security framework for Ethereum smart contracts" index=7>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keywords: Security  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.03555v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03555v1.pdf" filename="2402.03555v1.pdf">Download PDF</button>
...
### (131/185) Extending RAIM with a Gaussian Mixture of Opportunistic Information (Wenjie Liu et al., 2024)

{{<citation>}}

Wenjie Liu, Panos Papadimitratos. (2024)  
**Extending RAIM with a Gaussian Mixture of Opportunistic Information**
<br/>
<button class="copy-to-clipboard" title="Extending RAIM with a Gaussian Mixture of Opportunistic Information" index=7>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-7 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
Keywords: AI  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.03449v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03449v1.pdf" filename="2402.03449v1.pdf">Download PDF</button>
...
### (132/185) Detecting Scams Using Large Language Models (Liming Jiang, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Detecting Scams Using Large Language Models" index=7>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-7 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03147v1.pdf" filename="2402.03147v1.pdf">Download PDF</button>
...
### (133/185) Augmenting Security and Privacy in the Virtual Realm: An Analysis of Extended Reality Devices (Derin Cayir et al., 2024)

{{<citation>}}

Derin Cayir, Abbas Acar, Riccardo Lazzeretti, Marco Angelini, Mauro Conti, Selcuk Uluagac. (2024)  
**Augmenting Security and Privacy in the Virtual Realm: An Analysis of Extended Reality Devices**
<br/>
<button class="copy-to-clipboard" title="Augmenting Security and Privacy in the Virtual Realm: An Analysis of Extended Reality Devices" index=7>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-7 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
Categories: cs-CR, cs.CR  
Keywords: Security  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.03114v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03114v1.pdf" filename="2402.03114v1.pdf">Download PDF</button>
...
### (134/185) Conversation Reconstruction Attack Against GPT Models (Junjie Chu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Conversation Reconstruction Attack Against GPT Models" index=7>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-7 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02987v1.pdf" filename="2402.02987v1.pdf">Download PDF</button>
...
### (135/185) Semantic Entropy Can Simultaneously Benefit Transmission Efficiency and Channel Security of Wireless Semantic Communications (Yankai Rong et al., 2024)

{{<citation>}}

Yankai Rong, Guoshun Nan, Minwei Zhang, Sihan Chen, Songtao Wang, Xuefei Zhang, Nan Ma, Shixun Gong, Zhaohui Yang, Qimei Cui, Xiaofeng Tao, Tony Q. S. Quek. (2024)  
...
<br/>
<button class="copy-to-clipboard" title="Semantic Entropy Can Simultaneously Benefit Transmission Efficiency and Channel Security of Wireless Semantic Communications" index=7>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-7 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
Categories: cs-CR, cs.CR, eess-SP  
Keywords: Security  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.02950v2" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02950v2.pdf" filename="2402.02950v2.pdf">Download PDF</button>
...
### (136/185) DisDet: Exploring Detectability of Backdoor Attack on Diffusion Models (Yang Sui et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="DisDet: Exploring Detectability of Backdoor Attack on Diffusion Models" index=7>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-7 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02739v1.pdf" filename="2402.02739v1.pdf">Download PDF</button>
...
### (137/185) Preliminary Report on Mantis Shrimp: a Multi-Survey Computer Vision Photometric Redshift Model (Andrew Engel et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Preliminary Report on Mantis Shrimp: a Multi-Survey Computer Vision Photometric Redshift Model" index=8>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03535v1.pdf" filename="2402.03535v1.pdf">Download PDF</button>
...
### (138/185) Curriculum reinforcement learning for quantum architecture search under hardware errors (Yash J. Patel et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Curriculum reinforcement learning for quantum architecture search under hardware errors" index=9>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03500v1.pdf" filename="2402.03500v1.pdf">Download PDF</button>
...
### (139/185) Quantum Normalizing Flows for Anomaly Detection (Bodo Rosenhahn et al., 2024)

{{<citation>}}

Bodo Rosenhahn, Christoph Hirche. (2024)  
**Quantum Normalizing Flows for Anomaly Detection**
<br/>
<button class="copy-to-clipboard" title="Quantum Normalizing Flows for Anomaly Detection" index=9>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-9 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.02866v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02866v1.pdf" filename="2402.02866v1.pdf">Download PDF</button>
...
### (140/185) Attention Meets Post-hoc Interpretability: A Mathematical Perspective (Gianluigi Lopardo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Attention Meets Post-hoc Interpretability: A Mathematical Perspective" index=10>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03485v1.pdf" filename="2402.03485v1.pdf">Download PDF</button>
...
### (141/185) Minimum Description Length and Generalization Guarantees for Representation Learning (Milad Sefidgaran et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Minimum Description Length and Generalization Guarantees for Representation Learning" index=10>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-10 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03254v1.pdf" filename="2402.03254v1.pdf">Download PDF</button>
...
### (142/185) Towards Understanding the Word Sensitivity of Attention Layers: A Study via Random Features (Simone Bombari et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Towards Understanding the Word Sensitivity of Attention Layers: A Study via Random Features" index=10>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-10 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02969v1.pdf" filename="2402.02969v1.pdf">Download PDF</button>
...
### (143/185) Graph Neural Machine: A New Model for Learning with Tabular Data (Giannis Nikolentzos et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Graph Neural Machine: A New Model for Learning with Tabular Data" index=10>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-10 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02862v1.pdf" filename="2402.02862v1.pdf">Download PDF</button>
...
### (144/185) Non-asymptotic Analysis of Biased Adaptive Stochastic Approximation (Sobihan Surendran et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Non-asymptotic Analysis of Biased Adaptive Stochastic Approximation" index=10>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-10 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02857v1.pdf" filename="2402.02857v1.pdf">Download PDF</button>
...
### (145/185) Harnessing PubMed User Query Logs for Post Hoc Explanations of Recommended Similar Articles (Ashley Shin et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Harnessing PubMed User Query Logs for Post Hoc Explanations of Recommended Similar Articles" index=11>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03484v1.pdf" filename="2402.03484v1.pdf">Download PDF</button>
...
### (146/185) Comparison of Topic Modelling Approaches in the Banking Context (Bayode Ogunleye et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Comparison of Topic Modelling Approaches in the Banking Context" index=11>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-11 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03176v1.pdf" filename="2402.03176v1.pdf">Download PDF</button>
...
### (147/185) Understanding and Guiding Weakly Supervised Entity Alignment with Potential Isomorphism Propagation (Yuanyi Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Understanding and Guiding Weakly Supervised Entity Alignment with Potential Isomorphism Propagation" index=11>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-11 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03025v1.pdf" filename="2402.03025v1.pdf">Download PDF</button>
...
### (148/185) Domain Adaptation of Multilingual Semantic Search -- Literature Review (Anna Bringmann et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Domain Adaptation of Multilingual Semantic Search -- Literature Review" index=11>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-11 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02932v1.pdf" filename="2402.02932v1.pdf">Download PDF</button>
...
### (149/185) Large Language Model Distilling Medication Recommendation Model (Qidong Liu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Large Language Model Distilling Medication Recommendation Model" index=11>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-11 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02803v1.pdf" filename="2402.02803v1.pdf">Download PDF</button>
...
### (150/185) Active Region-based Flare Forecasting with Sliding Window Multivariate Time Series Forest Classifiers (Anli Ji et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Active Region-based Flare Forecasting with Sliding Window Multivariate Time Series Forest Classifiers" index=12>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03474v1.pdf" filename="2402.03474v1.pdf">Download PDF</button>
...
### (151/185) Assessing the Efficacy of Invisible Watermarks in AI-Generated Medical Images (Xiaodan Xing et al., 2024)

{{<citation>}}

Xiaodan Xing, Huiyu Zhou, Yingying Fang, Guang Yang. (2024)  
**Assessing the Efficacy of Invisible Watermarks in AI-Generated Medical Images**
<br/>
<button class="copy-to-clipboard" title="Assessing the Efficacy of Invisible Watermarks in AI-Generated Medical Images" index=13>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keywords: AI  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.03473v2" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03473v2.pdf" filename="2402.03473v2.pdf">Download PDF</button>
...
### (152/185) Swin-UMamba: Mamba-based UNet with ImageNet-based pretraining (Jiarun Liu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Swin-UMamba: Mamba-based UNet with ImageNet-based pretraining" index=13>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-13 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03302v1.pdf" filename="2402.03302v1.pdf">Download PDF</button>
...
### (153/185) CT-based Anatomical Segmentation for Thoracic Surgical Planning: A Benchmark Study for 3D U-shaped Deep Learning Models (Arash Harirpoush et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="CT-based Anatomical Segmentation for Thoracic Surgical Planning: A Benchmark Study for 3D U-shaped Deep Learning Models" index=13>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-13 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03230v1.pdf" filename="2402.03230v1.pdf">Download PDF</button>
...
### (154/185) One-class anomaly detection through color-to-thermal AI for building envelope inspection (Polina Kurtser et al., 2024)

{{<citation>}}

Polina Kurtser, Kailun Feng, Thomas Olofsson, Aitor De Andres. (2024)  
**One-class anomaly detection through color-to-thermal AI for building envelope inspection**
<br/>
<button class="copy-to-clipboard" title="One-class anomaly detection through color-to-thermal AI for building envelope inspection" index=13>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-13 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
Categories: cs-CV, cs-LG, eess-IV, eess.IV  
Keywords: AI  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.02963v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02963v1.pdf" filename="2402.02963v1.pdf">Download PDF</button>
...
### (155/185) FDNet: Frequency Domain Denoising Network For Cell Segmentation in Astrocytes Derived From Induced Pluripotent Stem Cells (Haoran Li et al., 2024)

{{<citation>}}

Haoran Li, Jiahua Shi, Huaming Chen, Bo Du, Simon Maksour, Gabrielle Phillips, Mirella Dottori, Jun Shen. (2024)  
**FDNet: Frequency Domain Denoising Network For Cell Segmentation in Astrocytes Derived From Induced Pluripotent Stem Cells**
<br/>
<button class="copy-to-clipboard" title="FDNet: Frequency Domain Denoising Network For Cell Segmentation in Astrocytes Derived From Induced Pluripotent Stem Cells" index=13>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-13 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
Categories: cs-CV, cs-LG, eess-IV, eess.IV  
Keywords: AI  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.02724v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02724v1.pdf" filename="2402.02724v1.pdf">Download PDF</button>
...
### (156/185) Recommendation Fairness in Social Networks Over Time (Meng Cao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Recommendation Fairness in Social Networks Over Time" index=14>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03450v1.pdf" filename="2402.03450v1.pdf">Download PDF</button>
...
### (157/185) Security Advice for Parents and Children About Content Filtering and Circumvention as Found on YouTube and TikTok (Ran Elgedawy et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Security Advice for Parents and Children About Content Filtering and Circumvention as Found on YouTube and TikTok" index=14>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-14 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03255v1.pdf" filename="2402.03255v1.pdf">Download PDF</button>
...
### (158/185) Algorithms and Complexity of Difference Logic (Konrad K. Dabrowski et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Algorithms and Complexity of Difference Logic" index=15>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03273v1.pdf" filename="2402.03273v1.pdf">Download PDF</button>
...
### (159/185) Bluesky and the AT Protocol: Usable Decentralized Social Media (Martin Kleppmann et al., 2024)

{{<citation>}}

Martin Kleppmann, Paul Frazee, Jake Gold, Jay Graber, Daniel Holmgren, Devin Ivy, Jeromy Johnson, Bryan Newbold, Jaz Volpert. (2024)  
**Bluesky and the AT Protocol: Usable Decentralized Social Media**
<br/>
<button class="copy-to-clipboard" title="Bluesky and the AT Protocol: Usable Decentralized Social Media" index=16>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Categories: cs-DC, cs-SI, cs.DC  
Keywords: Social Media  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.03239v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03239v1.pdf" filename="2402.03239v1.pdf">Download PDF</button>
...
### (160/185) Design and Implementation of an Automated Disaster-recovery System for a Kubernetes Cluster Using LSTM (Ji-Beom Kim et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Design and Implementation of an Automated Disaster-recovery System for a Kubernetes Cluster Using LSTM" index=16>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-16 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02938v1.pdf" filename="2402.02938v1.pdf">Download PDF</button>
...
### (161/185) Multi-agent Reinforcement Learning for Energy Saving in Multi-Cell Massive MIMO Systems (Tianzhang Cai et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Multi-agent Reinforcement Learning for Energy Saving in Multi-Cell Massive MIMO Systems" index=17>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03204v1.pdf" filename="2402.03204v1.pdf">Download PDF</button>
...
### (162/185) Leveraging IRS Induced Time Delay for Enhanced Physical Layer Security in VLC Systems (Rashid Iqbal et al., 2024)

{{<citation>}}

Rashid Iqbal, Mauro Biagi, Ahmed Zoha, Muhammad Ali Imran, Hanaa Abumarshoud. (2024)  
**Leveraging IRS Induced Time Delay for Enhanced Physical Layer Security in VLC Systems**
<br/>
<button class="copy-to-clipboard" title="Leveraging IRS Induced Time Delay for Enhanced Physical Layer Security in VLC Systems" index=17>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-17 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
Keywords: Security  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.03202v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03202v1.pdf" filename="2402.03202v1.pdf">Download PDF</button>
...
### (163/185) Rejection-Sampled Universal Quantization for Smaller Quantization Errors (Chih Wei Ling et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Rejection-Sampled Universal Quantization for Smaller Quantization Errors" index=17>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-17 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03030v1.pdf" filename="2402.03030v1.pdf">Download PDF</button>
...
### (164/185) Code-Based Single-Server Private Information Retrieval: Circumventing the Sub-Query Attack (Neehar Verma et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Code-Based Single-Server Private Information Retrieval: Circumventing the Sub-Query Attack" index=17>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-17 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02871v1.pdf" filename="2402.02871v1.pdf">Download PDF</button>
...
### (165/185) Fast and Accurate Cooperative Radio Map Estimation Enabled by GAN (Zezhong Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Fast and Accurate Cooperative Radio Map Estimation Enabled by GAN" index=17>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-17 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02729v1.pdf" filename="2402.02729v1.pdf">Download PDF</button>
...
### (166/185) Proof Theory and Decision Procedures for Deontic STIT Logics (Tim S. Lyon et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Proof Theory and Decision Procedures for Deontic STIT Logics" index=18>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03148v1.pdf" filename="2402.03148v1.pdf">Download PDF</button>
...
### (167/185) Computing Generic Fibres of Polynomial Ideals with FGLM and Hensel Lifting (Jérémy Berthomieu et al., 2024)

{{<citation>}}

Jérémy Berthomieu, Rafael Mohr. (2024)  
**Computing Generic Fibres of Polynomial Ideals with FGLM and Hensel Lifting**
<br/>
<button class="copy-to-clipboard" title="Computing Generic Fibres of Polynomial Ideals with FGLM and Hensel Lifting" index=19>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Categories: cs-SC, cs.SC, math-AC  
Keywords: GLM  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.03144v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03144v1.pdf" filename="2402.03144v1.pdf">Download PDF</button>
...
### (168/185) User-Centric Evaluation of ChatGPT Capability of Generating R Program Code (Tanha Miah et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="User-Centric Evaluation of ChatGPT Capability of Generating R Program Code" index=20>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03130v1.pdf" filename="2402.03130v1.pdf">Download PDF</button>
...
### (169/185) FAIR-USE4OS: From open source to Open Source (Raphael Sonabend et al., 2024)

{{<citation>}}

Raphael Sonabend, Hugo Gruson, Leo Wolansky, Agnes Kiragga, Daniel S. Katz. (2024)  
**FAIR-USE4OS: From open source to Open Source**
<br/>
<button class="copy-to-clipboard" title="FAIR-USE4OS: From open source to Open Source" index=20>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-20 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
Keywords: AI  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.02824v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02824v1.pdf" filename="2402.02824v1.pdf">Download PDF</button>
...
### (170/185) XNLP-hardness of Parameterized Problems on Planar Graphs (Hans L. Bodlaender et al., 2024)

{{<citation>}}

Hans L. Bodlaender, Krisztina Szilágyi. (2024)  
**XNLP-hardness of Parameterized Problems on Planar Graphs**
<br/>
<button class="copy-to-clipboard" title="XNLP-hardness of Parameterized Problems on Planar Graphs" index=21>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Categories: 05C10, 68Q15, G-2-2, cs-CC, cs.CC  
Keywords: NLP  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.03087v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03087v1.pdf" filename="2402.03087v1.pdf">Download PDF</button>
...
### (171/185) Enhancing the Stability of LLM-based Speech Generation Systems through Self-Supervised Representations (Álvaro Martín-Cortinas et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Enhancing the Stability of LLM-based Speech Generation Systems through Self-Supervised Representations" index=22>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03407v1.pdf" filename="2402.03407v1.pdf">Download PDF</button>
...
### (172/185) Array Geometry-Robust Attention-Based Neural Beamformer for Moving Speakers (Marvin Tammen et al., 2024)

{{<citation>}}

Marvin Tammen, Tsubasa Ochiai, Marc Delcroix, Tomohiro Nakatani, Shoko Araki, Simon Doclo. (2024)  
**Array Geometry-Robust Attention-Based Neural Beamformer for Moving Speakers**
<br/>
<button class="copy-to-clipboard" title="Array Geometry-Robust Attention-Based Neural Beamformer for Moving Speakers" index=22>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-22 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
Keywords: Attention  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.03058v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03058v1.pdf" filename="2402.03058v1.pdf">Download PDF</button>
...
### (173/185) On combining acoustic and modulation spectrograms in an attention LSTM-based system for speech intelligibility level classification (Ascensión Gallardo-Antolín et al., 2024)

{{<citation>}}

Ascensión Gallardo-Antolín, Juan M. Montero. (2024)  
...
<br/>
<button class="copy-to-clipboard" title="On combining acoustic and modulation spectrograms in an attention LSTM-based system for speech intelligibility level classification" index=22>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-22 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.02865v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02865v1.pdf" filename="2402.02865v1.pdf">Download PDF</button>
...
### (174/185) An Attention Long Short-Term Memory based system for automatic classification of speech intelligibility (Miguel Fernández-Díaz et al., 2024)

{{<citation>}}

Miguel Fernández-Díaz, Ascensión Gallardo-Antolín. (2024)  
**An Attention Long Short-Term Memory based system for automatic classification of speech intelligibility**
<br/>
<button class="copy-to-clipboard" title="An Attention Long Short-Term Memory based system for automatic classification of speech intelligibility" index=22>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-22 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
Keywords: Attention, LSTM  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.02850v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02850v1.pdf" filename="2402.02850v1.pdf">Download PDF</button>
...
### (175/185) Learning to Abstract Visuomotor Mappings using Meta-Reinforcement Learning (Carlos A. Velazquez-Vargas et al., 2024)

{{<citation>}}

Carlos A. Velazquez-Vargas, Isaac Ray Christian, Jordan A. Taylor, Sreejan Kumar. (2024)  
**Learning to Abstract Visuomotor Mappings using Meta-Reinforcement Learning**
<br/>
<button class="copy-to-clipboard" title="Learning to Abstract Visuomotor Mappings using Meta-Reinforcement Learning" index=23>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Categories: cs-AI, cs-LG, q-bio-NC, q-bio.NC  
Keywords: Reinforcement Learning  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.03072v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03072v1.pdf" filename="2402.03072v1.pdf">Download PDF</button>
...
### (176/185) A Comprehensive Study of the Current State-of-the-Art in Nepali Automatic Speech Recognition Systems (Rupak Raj Ghimire et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Comprehensive Study of the Current State-of-the-Art in Nepali Automatic Speech Recognition Systems" index=24>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.03050v1.pdf" filename="2402.03050v1.pdf">Download PDF</button>
...
### (177/185) Exploring Federated Self-Supervised Learning for General Purpose Audio Understanding (Yasar Abbas Ur Rehman et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Exploring Federated Self-Supervised Learning for General Purpose Audio Understanding" index=24>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-24 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02889v1.pdf" filename="2402.02889v1.pdf">Download PDF</button>
...
### (178/185) Dual Knowledge Distillation for Efficient Sound Event Detection (Yang Xiao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Dual Knowledge Distillation for Efficient Sound Event Detection" index=24>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-24 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
Keywords: Event Detection, Knowledge Distillation  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.02781v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02781v1.pdf" filename="2402.02781v1.pdf">Download PDF</button>
...
### (179/185) Adversarial Data Augmentation for Robust Speaker Verification (Zhenyu Zhou et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Adversarial Data Augmentation for Robust Speaker Verification" index=24>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-24 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02699v1.pdf" filename="2402.02699v1.pdf">Download PDF</button>
...
### (180/185) Review on Fault Diagnosis and Fault-Tolerant Control Scheme for Robotic Manipulators: Recent Advances in AI, Machine Learning, and Digital Twin (Md Muzakkir Quamar et al., 2024)

{{<citation>}}

Md Muzakkir Quamar, Ali Nasir. (2024)  
...
<br/>
<button class="copy-to-clipboard" title="Review on Fault Diagnosis and Fault-Tolerant Control Scheme for Robotic Manipulators: Recent Advances in AI, Machine Learning, and Digital Twin" index=25>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keywords: AI  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.02980v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02980v1.pdf" filename="2402.02980v1.pdf">Download PDF</button>
...
### (181/185) Replication of Impedance Identification Experiments on a Reinforcement-Learning-Controlled Digital Twin of Human Elbows (Hao Yu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Replication of Impedance Identification Experiments on a Reinforcement-Learning-Controlled Digital Twin of Human Elbows" index=25>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
<div class="toast toast-copied toast-index-25 align-items-center text-bg-secondary border-0 position-absolute top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
  <div class="d-flex">
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02904v1.pdf" filename="2402.02904v1.pdf">Download PDF</button>
...
### (182/185) Embedding Hardware Approximations in Discrete Genetic-based Training for Printed MLPs (Florentia Afentaki et al., 2024)

{{<citation>}}

Florentia Afentaki, Michael Hefenbrock, Georgios Zervakis, Mehdi B. Tahoori. (2024)  
**Embedding Hardware Approximations in Discrete Genetic-based Training for Printed MLPs**
<br/>
<button class="copy-to-clipboard" title="Embedding Hardware Approximations in Discrete Genetic-based Training for Printed MLPs" index=26>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keywords: Embedding  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.02930v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02930v1.pdf" filename="2402.02930v1.pdf">Download PDF</button>
...
### (183/185) Quantized Approximately Orthogonal Recurrent Neural Networks (Armand Foucault et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Quantized Approximately Orthogonal Recurrent Neural Networks" index=27>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.04012v1.pdf" filename="2402.04012v1.pdf">Download PDF</button>
...
### (184/185) Intent Profiling and Translation Through Emergent Communication (Salwa Mostafa et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Intent Profiling and Translation Through Emergent Communication" index=28>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02768v1.pdf" filename="2402.02768v1.pdf">Download PDF</button>
...
### (185/185) The Gig's Up: How ChatGPT Stacks Up Against Quora on Gig Economy Insights (Thomas Lancaster, 2024)
...
<br/>
<button class="copy-to-clipboard" title="The Gig's Up: How ChatGPT Stacks Up Against Quora on Gig Economy Insights" index=29>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<button type="button" class="btn btn-outline-primary download-pdf" url="http://arxiv.org/pdf/2402.02676v1.pdf" filename="2402.02676v1.pdf">Download PDF</button>
