...
### (35/43 | 35/242) Let's Rectify Step by Step: Improving Aspect-based Sentiment Analysis with Diffusion Models (Shunyu Liu et al., 2024)
...
### (36/43 | 36/242) Machine Unlearning of Pre-trained Large Language Models (Jin Yao et al., 2024)
...
### (37/43 | 37/242) CARBD-Ko: A Contextually Annotated Review Benchmark Dataset for Aspect-Level Sentiment Classification in Korean (Dongjun Jang et al., 2024)
...
### (38/43 | 38/242) Language-Based User Profiles for Recommendation (Joyce Zhou et al., 2024)
...
### (39/43 | 39/242) Alternating Weak Triphone/BPE Alignment Supervision from Hybrid Model Improves End-to-End ASR (Jintao Jiang et al., 2024)
...
### (40/43 | 40/242) Prejudice and Caprice: A Statistical Framework for Measuring Social Discrimination in Large Language Models (Yiran Liu et al., 2024)
...
### (41/43 | 41/242) Chitchat as Interference: Adding User Backstories to Task-Oriented Dialogues (Armand Stricker et al., 2024)
...
### (42/43 | 42/242) Gotcha! Don't trick me with unanswerable questions! Self-aligning Large Language Models for Responding to Unknown Questions (Yang Deng et al., 2024)
...
### (43/43 | 43/242) Biomedical Entity Linking as Multiple Choice Question Answering (Zhenxi Lin et al., 2024)
...
### (1/69 | 44/242) Training Nonlinear Transformers for Efficient In-Context Learning: A Theoretical Learning and Generalization Analysis (Hongkang Li et al., 2024)
...
### (2/69 | 45/242) GraphEdit: Large Language Models for Graph Structure Learning (Zirui Guo et al., 2024)
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2402.15183v3" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2402.15183v3.pdf" filename="2402.15183v3.pdf">Download PDF</button>
...
### (3/69 | 46/242) Towards Efficient Active Learning in NLP via Pretrained Representations (Artem Vysogorets et al., 2024)
...
### (4/69 | 47/242) Sampling-based Distributed Training with Message Passing Neural Network (Priyesh Kakka et al., 2024)
...
### (5/69 | 48/242) Advancing Parameter Efficiency in Fine-tuning via Representation Editing (Muling Wu et al., 2024)
...
### (6/69 | 49/242) Foundation Policies with Hilbert Representations (Seohong Park et al., 2024)
...
### (7/69 | 50/242) Machine Learning-Based Completions Sequencing for Well Performance Optimization (Anjie Liu et al., 2024)
...
### (8/69 | 51/242) Mechanics-Informed Autoencoder Enables Automated Detection and Localization of Unforeseen Structural Damage (Xuyang Li et al., 2024)
...
### (9/69 | 52/242) A Comprehensive Survey of Convolutions in Deep Learning: Applications, Challenges, and Future Trends (Abolfazl Younesi et al., 2024)
...
### (10/69 | 53/242) Debiasing Machine Learning Models by Using Weakly Supervised Learning (Renan D. B. Brotto et al., 2024)
...
### (11/69 | 54/242) GPTVQ: The Blessing of Dimensionality for LLM Quantization (Mart van Baalen et al., 2024)
...
### (12/69 | 55/242) Counterfactual Generation with Identifiability Guarantees (Hanqi Yan et al., 2024)
...
### (13/69 | 56/242) Smoothed Graph Contrastive Learning via Seamless Proximity Integration (Maysam Behmanesh et al., 2024)
...
### (14/69 | 57/242) United We Pretrain, Divided We Fail! Representation Learning for Time Series by Pretraining on 75 Datasets at Once (Maurice Kraus et al., 2024)
...
### (15/69 | 58/242) Fair Resource Allocation in Multi-Task Learning (Hao Ban et al., 2024)
...
### (16/69 | 59/242) Deep Networks Always Grok and Here is Why (Ahmed Imtiaz Humayun et al., 2024)
...
### (17/69 | 60/242) Fine-Tuning of Continuous-Time Diffusion Models as Entropy-Regularized Control (Masatoshi Uehara et al., 2024)
...
### (18/69 | 61/242) Multimodal Transformer With a Low-Computational-Cost Guarantee (Sungjin Park et al., 2024)
...
### (19/69 | 62/242) Understanding Oversmoothing in Diffusion-Based GNNs From the Perspective of Operator Semigroup Theory (Weichen Zhao et al., 2024)
...
### (20/69 | 63/242) Smooth and Sparse Latent Dynamics in Operator Learning with Jerk Regularization (Xiaoyu Xie et al., 2024)
...
### (21/69 | 64/242) Transformers are Expressive, But Are They Expressive Enough for Regression? (Swaroop Nath et al., 2024)
...
### (22/69 | 65/242) Does Combining Parameter-efficient Modules Improve Few-shot Transfer Accuracy? (Nader Asadi et al., 2024)
...
### (23/69 | 66/242) When in Doubt, Think Slow: Iterative Reasoning with Latent Imagination (Martin Benfeghoul et al., 2024)
...
### (24/69 | 67/242) ChunkAttention: Efficient Self-Attention with Prefix-Aware KV Cache and Two-Phase Partition (Lu Ye et al., 2024)
...
### (25/69 | 68/242) Second-Order Fine-Tuning without Pain for LLMs:A Hessian Informed Zeroth-Order Optimizer (Yanjun Zhao et al., 2024)
...
### (26/69 | 69/242) Spatially-Aware Transformer Memory for Embodied Agents (Junmo Cho et al., 2024)
...
### (27/69 | 70/242) Accelerating Convergence of Stein Variational Gradient Descent via Deep Unfolding (Yuya Kawamura et al., 2024)
...
### (28/69 | 71/242) Trajectory-wise Iterative Reinforcement Learning Framework for Auto-bidding (Haoming Li et al., 2024)
...
### (29/69 | 72/242) Enhancing One-Shot Federated Learning Through Data and Ensemble Co-Boosting (Rong Dai et al., 2024)
...
### (30/69 | 73/242) AutoMMLab: Automatically Generating Deployable Models from Language Instructions for Computer Vision Tasks (Zekang Yang et al., 2024)
...
### (31/69 | 74/242) Optimal Transport for Structure Learning Under Missing Data (Vy Vo et al., 2024)
...
### (32/69 | 75/242) MSPipe: Efficient Temporal GNN Training via Staleness-aware Pipeline (Guangming Sheng et al., 2024)
...
### (33/69 | 76/242) Cost-Adaptive Recourse Recommendation by Adaptive Preference Elicitation (Duy Nguyen et al., 2024)
...
### (34/69 | 77/242) MegaScale: Scaling Large Language Model Training to More Than 10,000 GPUs (Ziheng Jiang et al., 2024)
...
### (35/69 | 78/242) Differentially Private Fair Binary Classifications (Hrad Ghoukasian et al., 2024)
...
### (36/69 | 79/242) FAIR: Filtering of Automatically Induced Rules (Divya Jyoti Bajpai et al., 2024)
...
### (37/69 | 80/242) The Impact of LoRA on the Emergence of Clusters in Transformers (Hugo Koubbi et al., 2024)
...
### (38/69 | 81/242) Genie: Generative Interactive Environments (Jake Bruce et al., 2024)
...
### (39/69 | 82/242) Explorations of Self-Repair in Language Models (Cody Rushing et al., 2024)
...
### (40/69 | 83/242) On the Duality Between Sharpness-Aware Minimization and Adversarial Training (Yihao Zhang et al., 2024)
...
### (41/69 | 84/242) Deep Coupling Network For Multivariate Time Series Forecasting (Kun Yi et al., 2024)
...
### (42/69 | 85/242) TransFlower: An Explainable Transformer-Based Model with Flow-to-Flow Attention for Commuting Flow Prediction (Yan Luo et al., 2024)
...
### (43/69 | 86/242) Parameter-Free Algorithms for Performative Regret Minimization under Decision-Dependent Distributions (Sungwoo Park et al., 2024)
...
### (44/69 | 87/242) Multi-Constraint Safe RL with Objective Suppression for Safety-Critical Applications (Zihan Zhou et al., 2024)
...
### (45/69 | 88/242) Co-Supervised Learning: Improving Weak-to-Strong Generalization with Hierarchical Mixture of Experts (Yuejiang Liu et al., 2024)
...
### (46/69 | 89/242) NeuralThink: Algorithm Synthesis that Extrapolates in General Tasks (Bernardo Esteves et al., 2024)
...
### (47/69 | 90/242) Multi-Task Learning for Routing Problem with Cross-Problem Zero-Shot Generalization (Fei Liu et al., 2024)
...
### (48/69 | 91/242) Fair Multivariate Adaptive Regression Splines for Ensuring Equity and Transparency (Parian Haghighat et al., 2024)
...
### (49/69 | 92/242) Optimisic Information Directed Sampling (Gergely Neu et al., 2024)
...
### (50/69 | 93/242) Distributionally Robust Off-Dynamics Reinforcement Learning: Provable Efficiency with Linear Function Approximation (Zhishuai Liu et al., 2024)
...
### (51/69 | 94/242) Offline Inverse RL: New Solution Concepts and Provably Efficient Algorithms (Filippo Lazzati et al., 2024)
...
### (52/69 | 95/242) Information-Theoretic Safe Bayesian Optimization (Alessandro G. Bottero et al., 2024)
...
### (53/69 | 96/242) Categorical Deep Learning: An Algebraic Theory of Architectures (Bruno Gavranović et al., 2024)
...
### (54/69 | 97/242) Linear Dynamics-embedded Neural Network for Long-Sequence Modeling (Tongyi Liang et al., 2024)
...
### (55/69 | 98/242) Calibration of Deep Learning Classification Models in fNIRS (Zhihao Cao et al., 2024)
...
### (56/69 | 99/242) Dynamic Memory Based Adaptive Optimization (Balázs Szegedy et al., 2024)
...
### (57/69 | 100/242) A Bargaining-based Approach for Feature Trading in Vertical Federated Learning (Yue Cui et al., 2024)
...
### (58/69 | 101/242) Which Model to Transfer? A Survey on Transferability Estimation (Yuhe Ding et al., 2024)
...
### (59/69 | 102/242) Fixed Random Classifier Rearrangement for Continual Learning (Shengyang Huang et al., 2024)
...
### (60/69 | 103/242) Bidirectional Uncertainty-Based Active Learning for Open Set Annotation (Chen-Chen Zong et al., 2024)
...
### (61/69 | 104/242) Unified View of Grokking, Double Descent and Emergent Abilities: A Perspective from Circuits Competition (Yufei Huang et al., 2024)
...
### (62/69 | 105/242) Covariance-Adaptive Least-Squares Algorithm for Stochastic Combinatorial Semi-Bandits (Julien Zhou et al., 2024)
...
### (63/69 | 106/242) The Surprising Effectiveness of Skip-Tuning in Diffusion Sampling (Jiajun Ma et al., 2024)
...
### (64/69 | 107/242) Multi-Armed Bandits with Abstention (Junwen Yang et al., 2024)
...
### (65/69 | 108/242) Machine Unlearning by Suppressing Sample Contribution (Xinwen Cheng et al., 2024)
...
### (66/69 | 109/242) Generative Models are Self-Watermarked: Declaring Model Authentication through Re-Generation (Aditya Desu et al., 2024)
...
### (67/69 | 110/242) Fourier Basis Density Model (Alfredo De la Fuente et al., 2024)
...
### (68/69 | 111/242) Towards Principled Task Grouping for Multi-Task Learning (Chenguang Wang et al., 2024)
...
### (69/69 | 112/242) Convergence Analysis of Blurring Mean Shift (Ryoya Yamasaki et al., 2024)
...
### (1/3 | 113/242) Toward Fully Self-Supervised Multi-Pitch Estimation (Frank Cwitkowitz et al., 2024)
...
### (2/3 | 114/242) ChildAugment: Data Augmentation Methods for Zero-Resource Children's Speaker Verification (Vishwanath Pratap Singh et al., 2024)
...
### (3/3 | 115/242) High Resolution Guitar Transcription via Domain Adaptation (Xavier Riley et al., 2024)
...
### (1/33 | 116/242) Self-Supervised Pre-Training for Table Structure Recognition Transformer (ShengYun Peng et al., 2024)
...
### (2/33 | 117/242) On normalization-equivariance properties of supervised and unsupervised denoising methods: a survey (Sébastien Herbreteau et al., 2024)
...
### (3/33 | 118/242) Distilling Adversarial Robustness Using Heterogeneous Teachers (Jieren Deng et al., 2024)
...
### (4/33 | 119/242) CI w/o TN: Context Injection without Task Name for Procedure Planning (Xinjie Li, 2024)
...
### (5/33 | 120/242) Label-efficient Multi-organ Segmentation Method with Diffusion Model (Yongzhi Huang et al., 2024)
...
### (6/33 | 121/242) Fine-tuning CLIP Text Encoders with Two-step Paraphrasing (Hyunjae Kim et al., 2024)
...
### (7/33 | 122/242) Representing Online Handwriting for Recognition in Large Vision-Language Models (Anastasiia Fadeeva et al., 2024)
...
### (8/33 | 123/242) Seeing is Believing: Mitigating Hallucination in Large Vision-Language Models via CLIP-Guided Decoding (Ailin Deng et al., 2024)
...
### (9/33 | 124/242) Modified CycleGAN for the synthesization of samples for wheat head segmentation (Jaden Myers et al., 2024)
...
### (10/33 | 125/242) Benchmarking the Robustness of Panoptic Segmentation for Automated Driving (Yiting Wang et al., 2024)
...
### (11/33 | 126/242) Large Multimodal Agents: A Survey (Junlin Xie et al., 2024)
...
### (12/33 | 127/242) Low-Frequency Black-Box Backdoor Attack via Evolutionary Algorithm (Yanqi Qiao et al., 2024)
...
### (13/33 | 128/242) Cohere3D: Exploiting Temporal Coherence for Unsupervised Representation Learning of Vision-based Autonomous Driving (Yichen Xie et al., 2024)
...
### (14/33 | 129/242) MambaIR: A Simple Baseline for Image Restoration with State-Space Model (Hang Guo et al., 2024)
...
### (15/33 | 130/242) Gen4Gen: Generative Data Pipeline for Generative Multi-Concept Composition (Chun-Hsiao Yeh et al., 2024)
...
### (16/33 | 131/242) Where Visual Speech Meets Language: VSP-LLM Framework for Efficient and Context-Aware Visual Speech Processing (Jeong Hun Yeo et al., 2024)
...
### (17/33 | 132/242) Retinotopic Mapping Enhances the Robustness of Convolutional Neural Networks (Jean-Nicolas Jérémie et al., 2024)
...
### (18/33 | 133/242) Hierarchical Invariance for Robust and Interpretable Vision Tasks at Larger Scales (Shuren Qi et al., 2024)
...
### (19/33 | 134/242) Semi-supervised Counting via Pixel-by-pixel Density Distribution Modelling (Hui Lin et al., 2024)
...
### (20/33 | 135/242) Unsupervised Domain Adaptation for Brain Vessel Segmentation through Transwarp Contrastive Learning (Fengming Lin et al., 2024)
...
### (21/33 | 136/242) Font Impression Estimation in the Wild (Kazuki Kitajima et al., 2024)
...
### (22/33 | 137/242) DeepSet SimCLR: Self-supervised deep sets for improved pathology representation learning (David Torpey et al., 2024)
...
### (23/33 | 138/242) State Space Models for Event Cameras (Nikola Zubić et al., 2024)
...
### (24/33 | 139/242) Outlier detection by ensembling uncertainty with negative objectness (Anja Delić et al., 2024)
...
### (25/33 | 140/242) Source-Guided Similarity Preservation for Online Person Re-Identification (Hamza Rami et al., 2024)
...
### (26/33 | 141/242) Attention-Guided Masked Autoencoders For Learning Image Representations (Leon Sick et al., 2024)
...
### (27/33 | 142/242) Fiducial Focus Augmentation for Facial Landmark Detection (Purbayan Kar et al., 2024)
...
### (28/33 | 143/242) ProTIP: Probabilistic Robustness Verification on Text-to-Image Diffusion Models against Stochastic Perturbation (Yi Zhang et al., 2024)
...
### (29/33 | 144/242) PUAD: Frustratingly Simple Method for Robust Anomaly Detection (Shota Sugawara et al., 2024)
...
### (30/33 | 145/242) Descripción automática de secciones delgadas de rocas: una aplicación Web (Stalyn Paucar et al., 2024)
...
### (31/33 | 146/242) Optimal Transport on the Lie Group of Roto-translations (Daan Bon et al., 2024)
...
### (32/33 | 147/242) EMIFF: Enhanced Multi-scale Image Feature Fusion for Vehicle-Infrastructure Cooperative 3D Object Detection (Zhe Wang et al., 2024)
...
### (33/33 | 148/242) GS-EMA: Integrating Gradient Surgery Exponential Moving Average with Boundary-Aware Contrastive Learning for Enhanced Domain Generalization in Aneurysm Segmentation (Fengming Lin et al., 2024)
...
### (1/10 | 149/242) PREDILECT: Preferences Delineated with Zero-Shot Language-based Reasoning in Reinforcement Learning (Simon Holk et al., 2024)
...
### (2/10 | 150/242) Safe Task Planning for Language-Instructed Multi-Robot Systems using Conformal Prediction (Jun Wang et al., 2024)
...
### (3/10 | 151/242) RoboEXP: Action-Conditioned Scene Graph via Interactive Exploration for Robotic Manipulation (Hanxiao Jiang et al., 2024)
...
### (4/10 | 152/242) Dynamics-Guided Diffusion Model for Robot Manipulator Design (Xiaomeng Xu et al., 2024)
...
### (5/10 | 153/242) Morphological Symmetries in Robotics (Daniel Ordoñez-Apraez et al., 2024)
...
### (6/10 | 154/242) Grasp, See and Place: Efficient Unknown Object Rearrangement with Policy Structure Prior (Kechun Xu et al., 2024)
...
### (7/10 | 155/242) Follow the Footprints: Self-supervised Traversability Estimation for Off-road Vehicle Navigation based on Geometric and Visual Cues (Yurim Jeon et al., 2024)
...
### (8/10 | 156/242) Streaming Gaussian Dirichlet Random Fields for Spatial Predictions of High Dimensional Categorical Observations (J. E. San Soucie et al., 2024)
...
### (9/10 | 157/242) CLIPPER+: A Fast Maximal Clique Algorithm for Robust Global Registration (Kaveh Fathian et al., 2024)
...
### (10/10 | 158/242) Neural Implicit Swept Volume Models for Fast Collision Detection (Dominik Joho et al., 2024)
...
### (1/7 | 159/242) Item-side Fairness of Large Language Model-based Recommendation System (Meng Jiang et al., 2024)
...
### (2/7 | 160/242) Multi-Agent Collaboration Framework for Recommender Systems (Zhefan Wang et al., 2024)
...
### (3/7 | 161/242) RecWizard: A Toolkit for Conversational Recommendation with Modular, Portable Models and Interactive User Interface (Zeyuan Zhang et al., 2024)
...
### (4/7 | 162/242) Text2Pic Swift: Enhancing Long-Text to Image Retrieval for Large-Scale Libraries (Zijun Long et al., 2024)
...
### (5/7 | 163/242) Faithful Temporal Question Answering over Heterogeneous Sources (Zhen Jia et al., 2024)
...
### (6/7 | 164/242) EasyRL4Rec: A User-Friendly Code Library for Reinforcement Learning Based Recommender Systems (Yuanqing Yu et al., 2024)
...
### (7/7 | 165/242) Artful Path to Healing: Using Machine Learning for Visual Art Recommendation to Prevent and Reduce Post-Intensive Care (Bereket A. Yilma et al., 2024)
...
### (1/12 | 166/242) The Good and The Bad: Exploring Privacy Issues in Retrieval-Augmented Generation (RAG) (Shenglai Zeng et al., 2024)
...
### (2/12 | 167/242) A First Look at GPT Apps: Landscape and Vulnerability (Zejun Zhang et al., 2024)
...
### (3/12 | 168/242) On Trojan Signatures in Large Language Models of Code (Aftab Hussain et al., 2024)
...
### (4/12 | 169/242) Fast Adversarial Attacks on Language Models In One GPU Minute (Vinu Sankar Sadasivan et al., 2024)
...
### (5/12 | 170/242) BSPA: Exploring Black-box Stealthy Prompt Attacks against Image Generators (Yu Tian et al., 2024)
...
### (6/12 | 171/242) TREC: APT Tactic / Technique Recognition via Few-Shot Provenance Subgraph Learning (Mingqi Lv et al., 2024)
...
### (7/12 | 172/242) Reinforcement Learning-Based Approaches for Enhancing Security and Resilience in Smart Control: A Survey on Attack and Defense Methods (Zheyu Zhang, 2024)
...
### (8/12 | 173/242) A Blockchain-Enabled Framework of UAV Coordination for Post-Disaster Networks (Sana Hafeez et al., 2024)
...
### (9/12 | 174/242) On the Usability of Next-Generation Authentication: A Study on Eye Movement and Brainwave-based Mechanisms (Matin Fallahi et al., 2024)
...
### (10/12 | 175/242) SoK: What don't we know? Understanding Security Vulnerabilities in SNARKs (Stefanos Chaliasos et al., 2024)
...
### (11/12 | 176/242) A Robust Defense against Adversarial Attacks on Deep Learning-based Malware Detectors via (De)Randomized Smoothing (Daniel Gibert et al., 2024)
...
### (12/12 | 177/242) Chu-ko-nu: A Reliable, Efficient, and Anonymously Authentication-Enabled Realization for Multi-Round Secure Aggregation in Federated Learning (Kaiping Cui et al., 2024)
...
### (1/1 | 178/242) All Thresholds Barred: Direct Estimation of Call Density in Bioacoustic Data (Amanda K. Navine et al., 2024)
...
### (1/6 | 179/242) Efficient semi-supervised inference for logistic regression under case-control studies (Zhuojun Quan et al., 2024)
...
### (2/6 | 180/242) Iteration and Stochastic First-order Oracle Complexities of Stochastic Gradient Descent using Constant and Decaying Learning Rates (Kento Imaizumi et al., 2024)
...
### (3/6 | 181/242) Statistical Agnostic Regression: a machine learning method to validate regression models (Juan M Gorriz et al., 2024)
...
### (4/6 | 182/242) Generative Modelling with Tensor Train approximations of Hamilton--Jacobi--Bellman equations (David Sommer et al., 2024)
...
### (5/6 | 183/242) Nonlinear Bayesian optimal experimental design using logarithmic Sobolev inequalities (Fengyi Li et al., 2024)
...
### (6/6 | 184/242) Learning Cyclic Causal Models from Incomplete Data (Muralikrishnna G. Sethuraman et al., 2024)
...
### (1/1 | 185/242) A Survey of Music Generation in the Context of Interaction (Ismael Agchar et al., 2024)
...
### (1/3 | 186/242) Artificial Bee Colony optimization of Deep Convolutional Neural Networks in the context of Biomedical Imaging (Adri Gomez Martin et al., 2024)
...
### (2/3 | 187/242) Low-Rank Representations Meets Deep Unfolding: A Generalized and Interpretable Network for Hyperspectral Anomaly Detection (Chenyu Li et al., 2024)
...
### (3/3 | 188/242) Closing the AI generalization gap by adjusting for dermatology condition distribution differences across clinical settings (Rajeev V. Rikhye et al., 2024)
...
### (1/4 | 189/242) AgentLite: A Lightweight Library for Building and Advancing Task-Oriented LLM Agent System (Zhiwei Liu et al., 2024)
...
### (2/4 | 190/242) Shapley Value Based Multi-Agent Reinforcement Learning: Theory, Method and Its Application to Energy Network (Jianhong Wang, 2024)
...
### (3/4 | 191/242) Open Ad Hoc Teamwork with Cooperative Game Theory (Jianhong Wang et al., 2024)
...
### (4/4 | 192/242) HiMAP: Learning Heuristics-Informed Policies for Large-Scale Multi-Agent Pathfinding (Huijie Tang et al., 2024)
...
### (1/4 | 193/242) Studying LLM Performance on Closed- and Open-source Data (Toufique Ahmed et al., 2024)
...
### (2/4 | 194/242) LLM-CompDroid: Repairing Configuration Compatibility Bugs in Android Apps with Pre-trained Large Language Models (Zhijie Liu et al., 2024)
...
### (3/4 | 195/242) Statically Inferring Usage Bounds for Infrastructure as Code (Feitong Qiao et al., 2024)
...
### (4/4 | 196/242) Towards Model-Driven Dashboard Generation for Systems-of-Systems (Maria Teresa Rossi et al., 2024)
...
### (1/3 | 197/242) Human vs. Generative AI in Content Creation Competition: Symbiosis or Conflict? (Fan Yao et al., 2024)
...
### (2/3 | 198/242) Platforms for Efficient and Incentive-Aware Collaboration (Nika Haghtalab et al., 2024)
...
### (3/3 | 199/242) Analyzing Games in Maker Protocol Part One: A Multi-Agent Influence Diagram Approach Towards Coordination (Abhimanyu Nag et al., 2024)
...
### (1/1 | 200/242) Combining Transformer based Deep Reinforcement Learning with Black-Litterman Model for Portfolio Optimization (Ruoyu Sun et al., 2024)
...
### (1/10 | 201/242) Farsight: Fostering Responsible AI Awareness During AI Application Prototyping (Zijie J. Wang et al., 2024)
...
### (2/10 | 202/242) Economic and Financial Learning with Artificial Intelligence: A Mixed-Methods Study on ChatGPT (Holger Arndt, 2024)
...
### (3/10 | 203/242) CloChat: Understanding How People Customize, Interact, and Experience Personas in Large Language Models (Juhye Ha et al., 2024)
...
### (4/10 | 204/242) I see an IC: A Mixed-Methods Approach to Study Human Problem-Solving Processes in Hardware Reverse Engineering (René Walendy et al., 2024)
...
### (5/10 | 205/242) MetaStates: An Approach for Representing Human Workers Psychophysiological States in the Industrial Metaverse (Aitor Toichoa Eyam et al., 2024)
...
### (6/10 | 206/242) Enhancing ICU Patient Recovery: Using LLMs to Assist Nurses in Diary Writing (Samuel Kernan Freire et al., 2024)
...
### (7/10 | 207/242) Hands-Free VR (Jorge Askur Vazquez Fernandez et al., 2024)
...
### (8/10 | 208/242) The AffectToolbox: Affect Analysis for Everyone (Silvan Mertes et al., 2024)
...
### (9/10 | 209/242) Exploration and Exploitation in Consumer Automation: Visualizing IoT Interactions with Topological Data Analysis (Thomas P. Novak et al., 2024)
...
### (10/10 | 210/242) Do You See What I See? A Qualitative Study Eliciting High-Level Visualization Comprehension (Ghulam Jilani Quadri et al., 2024)
...
### (1/1 | 211/242) Classification of compact radio sources in the Galactic plane with supervised machine learning (S. Riggi et al., 2024)
...
### (1/2 | 212/242) Pre-Chirp-Domain Index Modulation for Affine Frequency Division Multiplexing (Guangyao Liu et al., 2024)
...
### (2/2 | 213/242) Iterative Inversion of (ELAA-)MIMO Channels Using Symmetric Rank-$1$ Regularization (Jinfei Wang et al., 2024)
...
### (1/2 | 214/242) Toward High Performance, Programmable Extreme-Edge Intelligence for Neuromorphic Vision Sensors utilizing Magnetic Domain Wall Motion-based MTJ (Md Abdullah-Al Kaiser et al., 2024)
...
### (2/2 | 215/242) A$^3$PIM: An Automated, Analytic and Accurate Processing-in-Memory Offloader (Qingcai Jiang et al., 2024)

{{<citation>}}

Qingcai Jiang, Shaojie Tan, Junshi Chen, Hong An. (2024)  
**A$^3$PIM: An Automated, Analytic and Accurate Processing-in-Memory Offloader**
<br/>
<button class="copy-to-clipboard" title="A$^3$PIM: An Automated, Analytic and Accurate Processing-in-Memory Offloader" index=215>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 216/242) Constraint Latent Space Matters: An Anti-anomalous Waveform Transformation Solution from Photoplethysmography to Arterial Blood Pressure (Cheng Bian et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Constraint Latent Space Matters: An Anti-anomalous Waveform Transformation Solution from Photoplethysmography to Arterial Blood Pressure" index=216>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/3 | 217/242) A Relation-Interactive Approach for Message Passing in Hyper-relational Knowledge Graphs (Yonglin Jing, 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Relation-Interactive Approach for Message Passing in Hyper-relational Knowledge Graphs" index=217>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/3 | 218/242) AgentOhana: Design Unified Data and Training Pipeline for Effective Agent Learning (Jianguo Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="AgentOhana: Design Unified Data and Training Pipeline for Effective Agent Learning" index=218>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/3 | 219/242) Improving Explainable Object-induced Model through Uncertainty for Automated Vehicles (Shihong Ling et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Improving Explainable Object-induced Model through Uncertainty for Automated Vehicles" index=219>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/2 | 220/242) Design and Optimization of Functionally-graded Triangular Lattices for Multiple Loading Conditions (Junpeng Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Design and Optimization of Functionally-graded Triangular Lattices for Multiple Loading Conditions" index=220>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/2 | 221/242) Hybrid Physics-Based and Data-Driven Modeling of Vascular Bifurcation Pressure Differences (Natalia L. Rubio et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Hybrid Physics-Based and Data-Driven Modeling of Vascular Bifurcation Pressure Differences" index=221>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/2 | 222/242) Data/moment-driven approaches for fast predictive control of collective dynamics (Giacomo Albi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Data/moment-driven approaches for fast predictive control of collective dynamics" index=222>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/2 | 223/242) Closed-loop design for scalable performance of vehicular formations (Jonas Hansson et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Closed-loop design for scalable performance of vehicular formations" index=223>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/2 | 224/242) A CWENO large time-step scheme for Hamilton--Jacobi equations (E. Carlini et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A CWENO large time-step scheme for Hamilton--Jacobi equations" index=224>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/2 | 225/242) A unified constraint formulation of immersed body techniques for coupled fluid-solid motion: continuous equations and numerical algorithms (Amneet Pal Singh Bhalla et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A unified constraint formulation of immersed body techniques for coupled fluid-solid motion: continuous equations and numerical algorithms" index=225>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 226/242) Safety Optimized Reinforcement Learning via Multi-Objective Policy Optimization (Homayoun Honari et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Safety Optimized Reinforcement Learning via Multi-Objective Policy Optimization" index=226>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/3 | 227/242) Minimax Optimality of Score-based Diffusion Models: Beyond the Density Lower Bound Assumptions (Kaihong Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Minimax Optimality of Score-based Diffusion Models: Beyond the Density Lower Bound Assumptions" index=227>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/3 | 228/242) Universal Lower Bounds and Optimal Rates: Achieving Minimax Clustering Error in Sub-Exponential Mixture Models (Maximilien Dreveton et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Universal Lower Bounds and Optimal Rates: Achieving Minimax Clustering Error in Sub-Exponential Mixture Models" index=228>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/3 | 229/242) The Umeyama algorithm for matching correlated Gaussian geometric models in the low-dimensional regime (Shuyang Gong et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="The Umeyama algorithm for matching correlated Gaussian geometric models in the low-dimensional regime" index=229>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/2 | 230/242) Decoding the Pulse of Community during Disasters: Resilience Analysis Based on Fluctuations in Latent Lifestyle Signatures within Human Visitation Networks (Junwei Ma et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Decoding the Pulse of Community during Disasters: Resilience Analysis Based on Fluctuations in Latent Lifestyle Signatures within Human Visitation Networks" index=230>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/2 | 231/242) Artificial Intelligence for Complex Network: Potential, Methodology and Application (Jingtao Ding et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Artificial Intelligence for Complex Network: Potential, Methodology and Application" index=231>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/2 | 232/242) Convergence Analysis of Split Federated Learning on Heterogeneous Data (Pengchao Han et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Convergence Analysis of Split Federated Learning on Heterogeneous Data" index=232>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/2 | 233/242) PICO: Accelerating All k-Core Paradigms on GPU (Chen Zhao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="PICO: Accelerating All k-Core Paradigms on GPU" index=233>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/5 | 234/242) Algorithmically Fair Maximization of Multiple Submodular Objective Functions (Georgios Amanatidis et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Algorithmically Fair Maximization of Multiple Submodular Objective Functions" index=234>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/5 | 235/242) On the Complexity of Community-aware Network Sparsification (Emanuel Herrendorf et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="On the Complexity of Community-aware Network Sparsification" index=235>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/5 | 236/242) Graph Partitioning With Limited Moves (Majid Behbahani et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Graph Partitioning With Limited Moves" index=236>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/5 | 237/242) Tight Approximation and Kernelization Bounds for Vertex-Disjoint Shortest Paths (Matthias Bentert et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Tight Approximation and Kernelization Bounds for Vertex-Disjoint Shortest Paths" index=237>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/5 | 238/242) Tight Inapproximability of Target Set Reconfiguration (Naoto Ohsaka, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Tight Inapproximability of Target Set Reconfiguration" index=238>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 239/242) On the composable security of weak coin flipping (Jiawei Wu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="On the composable security of weak coin flipping" index=239>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 240/242) Some results involving the $A_α$-eigenvalues for graphs and line graphs (Joao Domingos Gomes da Silva Junior et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Some results involving the $A_α$-eigenvalues for graphs and line graphs" index=240>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 241/242) The Flower Calculus (Pablo Donato, 2024)
...
**The Flower Calculus**
<br/>
<button class="copy-to-clipboard" title="The Flower Calculus" index=241>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 242/242) Rectilinear Crossing Number of Graphs Excluding Single-Crossing Graphs as Minors (Vida Dujmović et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Rectilinear Crossing Number of Graphs Excluding Single-Crossing Graphs as Minors" index=242>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
