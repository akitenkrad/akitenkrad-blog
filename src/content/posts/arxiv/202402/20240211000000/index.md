...
### (18/187) Promoting Target Data in Context-aware Neural Machine Translation (Harritxu Gete et al., 2024)
...
### (41/187) Corruption Robust Offline Reinforcement Learning with Human Feedback (Debmalya Mandal et al., 2024)
...
### (42/187) Feedback Loops With Language Models Drive In-Context Reward Hacking (Alexander Pan et al., 2024)
...
### (43/187) The Deep Equilibrium Algorithmic Reasoner (Dobrik Georgiev et al., 2024)
...
### (44/187) Trust the Process: Zero-Knowledge Machine Learning to Enhance Trust in Generative AI Interactions (Bianca-Mihaela Ganescu et al., 2024)
...
### (45/187) Hierarchical Transformers are Efficient Meta-Reinforcement Learners (Gresa Shala et al., 2024)
...
### (46/187) TEE4EHR: Transformer Event Encoder for Better Representation Learning in Electronic Health Records (Hojjat Karami et al., 2024)
...
### (47/187) Multi-class real-time crash risk forecasting using convolutional neural network: Istanbul case study (Behnaz Alafi et al., 2024)
...
### (48/187) Premier-TACO is a Few-Shot Policy Learner: Pretraining Multitask Representation via Temporal Action-Driven Contrastive Loss (Ruijie Zheng et al., 2024)
...
### (49/187) Jointly Learning Representations for Map Entities via Heterogeneous Graph Contrastive Learning (Jiawei Jiang et al., 2024)
...
### (50/187) Rethinking Node-wise Propagation for Large-scale Graph Learning (Xunkai Li et al., 2024)
...
### (51/187) FL-NAS: Towards Fairness of NAS for Resource Constrained Devices via Large Language Models (Ruiyang Qin et al., 2024)
...
### (52/187) AI enhanced data assimilation and uncertainty quantification applied to Geological Carbon Storage (G. S. Seabra et al., 2024)
...
### (53/187) Explain Variance of Prediction in Variational Time Series Models for Clinical Deterioration Prediction (Jiacheng Liu et al., 2024)
...
### (54/187) Low-Rank Learning by Design: the Role of Network Architecture and Activation Linearity in Gradient Rank Collapse (Bradley T. Baker et al., 2024)
...
### (55/187) Dynamic Graph Information Bottleneck (Haonan Yuan et al., 2024)
...
### (56/187) Fairness of Exposure in Online Restless Multi-armed Bandits (Archit Sood et al., 2024)
...
### (57/187) How Uniform Random Weights Induce Non-uniform Bias: Typical Interpolating Neural Networks Generalize with Narrow Teachers (Gon Buzaglo et al., 2024)
...
### (58/187) TimEHR: Image-based Time Series Generation for Electronic Health Records (Hojjat Karami et al., 2024)
...
### (59/187) Iterated Denoising Energy Matching for Sampling from Boltzmann Densities (Tara Akhound-Sadegh et al., 2024)
...
### (60/187) Multimodal Clinical Trial Outcome Prediction with Large Language Models (Wenhao Zheng et al., 2024)
...
### (61/187) Multimodal Interpretable Data-Driven Models for Early Prediction of Antimicrobial Multidrug Resistance Using Multivariate Time-Series (Sergio Martínez-Agüero et al., 2024)
...
### (62/187) Improved Evidential Deep Learning via a Mixture of Dirichlet Distributions (J. Jon Ryu et al., 2024)
...
### (63/187) Monitored Markov Decision Processes (Simone Parisi et al., 2024)
...
### (64/187) Generative Nowcasting of Marine Fog Visibility in the Grand Banks area and Sable Island in Canada (Eren Gultepe et al., 2024)
...
### (65/187) Scalable Kernel Logistic Regression with Nyström Approximation: Theoretical Analysis and Application to Discrete Choice Modelling (José Ángel Martín-Baos et al., 2024)
...
### (66/187) Where is the Truth? The Risk of Getting Confounded in a Continual World (Florian Peter Busch et al., 2024)
...
### (67/187) High-Precision Geosteering via Reinforcement Learning and Particle Filters (Ressi Bonti Muhammad et al., 2024)
...
### (68/187) Continual Learning on Graphs: A Survey (Zonggui Tian et al., 2024)
...
### (69/187) Value function interference and greedy action selection in value-based multi-objective reinforcement learning (Peter Vamplew et al., 2024)
...
### (70/187) Pushing Boundaries: Mixup's Influence on Neural Collapse (Quinn Fisher et al., 2024)
...
### (71/187) Domain Generalization with Small Data (Kecheng Chen et al., 2024)
...
### (72/187) Revealing Multimodal Contrastive Representation Learning through Latent Partial Causal Models (Yuhang Liu et al., 2024)
...
### (73/187) A Kalman Filter Based Framework for Monitoring the Performance of In-Hospital Mortality Prediction Models Over Time (Jiacheng Liu et al., 2024)
...
### (74/187) Refining Myocardial Infarction Detection: A Novel Multi-Modal Composite Kernel Strategy in One-Class Classification (Muhammad Uzair Zahid et al., 2024)
...
### (75/187) ExaRanker-Open: Synthetic Explanation for IR using Open-Source LLMs (Fernando Ferraretto et al., 2024)
...
### (76/187) Fairly Evaluating Large Language Model-based Recommendation Needs Revisit the Cross-Entropy Loss (Cong Xu et al., 2024)
...
### (77/187) CoSearchAgent: A Lightweight Collaborative Search Agent with Large Language Models (Peiyuan Gong et al., 2024)
...
### (78/187) Collaborative filtering, K-nearest neighbor and cosine similarity in home decor recommender systems (Nanna Bach Munkholm et al., 2024)
...
### (79/187) On the Out-Of-Distribution Generalization of Multimodal Large Language Models (Xingxuan Zhang et al., 2024)
...
### (80/187) BarlowTwins-CXR : Enhancing Chest X-Ray abnormality localization in heterogeneous data with cross-domain self-supervised learning (Haoyue Sheng et al., 2024)
...
### (81/187) Video Annotator: A framework for efficiently building video classifiers using vision-language models and active learning (Amir Ziai et al., 2024)
...
### (82/187) Masked LoGoNet: Fast and Accurate 3D Image Analysis for Medical Domain (Amin Karimi Monsefi et al., 2024)
...
### (83/187) A self-supervised framework for learning whole slide representations (Xinhai Hou et al., 2024)
...
### (84/187) ViGoR: Improving Visual Grounding of Large Vision Language Models with Fine-Grained Reward Modeling (Siming Yan et al., 2024)
...
### (85/187) ControlUDA: Controllable Diffusion-assisted Unsupervised Domain Adaptation for Cross-Weather Semantic Segmentation (Fengyi Shen et al., 2024)
...
### (86/187) Multi-source-free Domain Adaptation via Uncertainty-aware Adaptive Distillation (Yaxuan Song et al., 2024)
...
### (87/187) Is it safe to cross? Interpretable Risk Assessment with GPT-4V for Safety-Aware Street Crossing (Hochul Hwang et al., 2024)
...
### (88/187) Transfer learning with generative models for object detection on limited datasets (Matteo Paiano et al., 2024)
...
### (89/187) Image-based Deep Learning for the time-dependent prediction of fresh concrete properties (Max Meyer et al., 2024)
...
### (90/187) Large Language Models for Captioning and Retrieving Remote Sensing Images (João Daniel Silva et al., 2024)
...
### (91/187) Learning Contrastive Feature Representations for Facial Action Unit Detection (Ziqiao Shang et al., 2024)
...
### (92/187) Multiple Instance Learning for Cheating Detection and Localization in Online Examinations (Yemeng Liu et al., 2024)
...
### (93/187) Neural Rendering based Urban Scene Reconstruction for Autonomous Driving (Shihao Shen et al., 2024)
...
### (94/187) GS-CLIP: Gaussian Splatting for Contrastive Language-Image-3D Pretraining from Real-World Data (Haoyuan Li et al., 2024)
...
### (95/187) Domain Adaptation Using Pseudo Labels (Sachin Chhabra et al., 2024)
...
### (96/187) Hybridnet for depth estimation and semantic segmentation (Dalila Sánchez-Escobedo et al., 2024)
...
### (97/187) Feature Density Estimation for Out-of-Distribution Detection via Normalizing Flows (Evan D. Cook et al., 2024)
...
### (98/187) Improving 2D-3D Dense Correspondences with Diffusion Models for 6D Object Pose Estimation (Peter Hönig et al., 2024)
...
### (99/187) CurveFormer++: 3D Lane Detection by Curve Propagation with Temporal Curve Queries and Attention (Yifeng Bai et al., 2024)
...
### (100/187) Multisource Semisupervised Adversarial Domain Generalization Network for Cross-Scene Sea\textendash Land Clutter Classification (Xiaoxuan Zhang et al., 2024)
...
### (101/187) HeadStudio: Text to Animatable Head Avatars with 3D Gaussian Splatting (Zhenglin Zhou et al., 2024)
...
### (102/187) ContPhy: Continuum Physical Concept Learning and Reasoning from Videos (Zhicheng Zheng et al., 2024)
...
### (103/187) Event-to-Video Conversion for Overhead Object Detection (Darryl Hannan et al., 2024)
...
### (104/187) Fingerprinting New York City's Scaffolding Problem with Longitudinal Dashcam Data (Dorin Shapira et al., 2024)
...
### (105/187) More than the Sum of Its Parts: Ensembling Backbone Networks for Few-Shot Segmentation (Nico Catalano et al., 2024)
...
### (106/187) Transferring facade labels between point clouds with semantic octrees while considering change detection (Sophia Schwarz et al., 2024)
...
### (107/187) Reconstructing facade details using MLS point clouds and Bag-of-Words approach (Thomas Froech et al., 2024)
...
### (108/187) Iris-SAM: Iris Segmentation Using a Foundational Model (Parisa Farmanifard et al., 2024)
...
### (109/187) Maia: A Real-time Non-Verbal Chat for Human-AI Interaction (Dragos Costea et al., 2024)
...
### (110/187) FD-Vision Mamba for Endoscopic Exposure Correction (Zhuoran Zheng et al., 2024)
...
### (111/187) Towards actionability for open medical imaging datasets: lessons from community-contributed platforms for data management and stewardship (Amelia Jiménez-Sánchez et al., 2024)
...
### (112/187) Insomnia Identification via Electroencephalography (Olviya Udeshika et al., 2024)
...
### (113/187) TETRIS: Towards Exploring the Robustness of Interactive Segmentation (Andrey Moskalenko et al., 2024)
...
### (114/187) Spatially-Attentive Patch-Hierarchical Network with Adaptive Sampling for Motion Deblurring (Maitreya Suin et al., 2024)
...
### (115/187) Quantifying and Enhancing Multi-modal Robustness with Modality Preference (Zequn Yang et al., 2024)
...
### (116/187) GLaM: Fine-Tuning Large Language Models for Domain Knowledge Graph Alignment via Neighborhood Partitioning and Generative Subgraph Encoding (Stefan Dernbach et al., 2024)
...
### (117/187) LLaVA-Docent: Instruction Tuning with Multimodal Large Language Model to Support Art Appreciation Education (Unggi Lee et al., 2024)
...
### (118/187) The Quantified Boolean Bayesian Network: Theory and Experiments with a Logical Graphical Model (Gregory Coppola, 2024)
...
### (119/187) Introspective Planning: Guiding Language-Enabled Agents to Refine Their Own Uncertainty (Kaiqu Liang et al., 2024)
...
### (120/187) ACTER: Diverse and Actionable Counterfactual Sequences for Explaining and Diagnosing RL Policies (Jasmina Gajcin et al., 2024)
...
### (121/187) Debating with More Persuasive LLMs Leads to More Truthful Answers (Akbir Khan et al., 2024)
...
### (122/187) Understanding the Weakness of Large Language Model Agents within a Complex Android Environment (Mingzhe Xing et al., 2024)
...
### (123/187) Prompt Learning on Temporal Interaction Graphs (Xi Chen et al., 2024)
...
### (124/187) Human Aesthetic Preference-Based Large Text-to-Image Model Personalization: Kandinsky Generation as an Example (Aven-Le Zhou et al., 2024)
...
### (125/187) Discipline and Label: A WEIRD Genealogy and Social Theory of Data Annotation (Andrew Smart et al., 2024)
...
### (126/187) Predictive representations: building blocks of intelligence (Wilka Carvalho et al., 2024)
...
### (127/187) Modelling Human Values for AI Reasoning (Nardine Osman et al., 2024)
...
### (128/187) Flexible infinite-width graph convolutional networks and the importance of representation learning (Ben Anson et al., 2024)
...
### (129/187) On the Convergence Rate of the Stochastic Gradient Descent (SGD) and application to a modified policy gradient for the Multi Armed Bandit (Stefana Anita et al., 2024)
...
### (130/187) POTEC: Off-Policy Learning for Large Action Spaces via Two-Stage Policy Decomposition (Yuta Saito et al., 2024)
...
### (131/187) Particle Denoising Diffusion Sampler (Angus Phillips et al., 2024)
...
### (132/187) StruQ: Defending Against Prompt Injection with Structured Queries (Sizhe Chen et al., 2024)
...
### (133/187) Towards Principled Assessment of Tabular Data Synthesis Algorithms (Yuntao Du et al., 2024)
...
### (134/187) Delving into Parameter-Efficient Fine-Tuning in Code Change Learning: An Empirical Study (Shuo Liu et al., 2024)
...
### (135/187) CigaR: Cost-efficient Program Repair with LLMs (Dávid Hidvégi et al., 2024)
...
### (136/187) Empirically Exploring How Novices Write Software Models in Alloy (Ana Jovanovic et al., 2024)
...
### (137/187) SWITCH: An Exemplar for Evaluating Self-Adaptive ML-Enabled Systems (Arya Marda et al., 2024)
...
### (138/187) NavFormer: A Transformer Architecture for Robot Target-Driven Navigation in Unknown and Dynamic Environments (Haitong Wang et al., 2024)
...
### (139/187) LLMs for Coding and Robotics Education (Peng Shu et al., 2024)
...
### (140/187) Reasoning Grasping via Multimodal Large Language Model (Shiyu Jin et al., 2024)
...
### (141/187) Learn to Teach: Improve Sample Efficiency in Teacher-student Learning for Sim-to-Real Transfer (Feiyang Wu et al., 2024)
...
### (142/187) Reinforcement Learning for Blind Stair Climbing with Legged and Wheeled-Legged Robots (Simon Chamorro et al., 2024)
...
### (143/187) ASAP-MPC: An Asynchronous Update Scheme for Online Motion Planning with Nonlinear Model Predictive Control (Dries Dirckx et al., 2024)
...
### (144/187) Virtual and Remote Robotic Laboratory Using EJS, MATLAB and LabVIEW (Dictino Chaos et al., 2024)
...
### (145/187) Dynamic Q-planning for Online UAV Path Planning in Unknown and Complex Environments (Lidia Gianne Souza da Rocha et al., 2024)
...
### (146/187) Continuous-Time Radar-Inertial and Lidar-Inertial Odometry using a Gaussian Process Motion Prior (Keenan Burnett et al., 2024)
...
### (147/187) Task Supportive and Personalized Human-Large Language Model Interaction: A User Study (Ben Wang et al., 2024)
...
### (148/187) ScreenAgent: A Vision Language Model-driven Computer Control Agent (Runliang Niu et al., 2024)
...
### (149/187) Exploring Interaction Patterns for Debugging: Enhancing Conversational Capabilities of AI-assistants (Bhavya Chopra et al., 2024)
...
### (150/187) 'When He Feels Cold, He Goes to the Seahorse'-Blending Generative AI into Multimaterial Storymaking for Family Expressive Arts Therapy (Di Liu et al., 2024)
...
### (151/187) A plastic correction algorithm for full-field elasto-plastic finite element simulations : critical assessment of predictive capabilities and improvement by machine learning (Abhishek Palchoudhary et al., 2024)
...
### (152/187) Neural SPH: Improved Neural Modeling of Lagrangian Fluid Dynamics (Artur P. Toshev et al., 2024)
...
### (153/187) Precision Air Flow Control via EHD Actuator: A Co-simulation and Control Design Case Study (Afshin Shaygani et al., 2024)
...
### (154/187) Data-driven Joint Detection and Localization of Acoustic Reflectors (H. Nazim Bicer et al., 2024)
...
### (155/187) Exploiting spatial diversity for increasing the robustness of sound source localization systems against reverberation (Guillermo Garcia-Barrios et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Exploiting spatial diversity for increasing the robustness of sound source localization systems against reverberation" index=155>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (156/187) A New Approach to Voice Authenticity (Nicolas M. Müller et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A New Approach to Voice Authenticity" index=156>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (157/187) Analytical model for the relation between signal bandwidth and spatial resolution in Steered-Response Power Phase Transform (SRP-PHAT) maps (Guillermo Garcia-Barrios et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Analytical model for the relation between signal bandwidth and spatial resolution in Steered-Response Power Phase Transform (SRP-PHAT) maps" index=157>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (158/187) MusicMagus: Zero-Shot Text-to-Music Editing via Diffusion Models (Yixiao Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="MusicMagus: Zero-Shot Text-to-Music Editing via Diffusion Models" index=158>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (159/187) Anubis: Towards Reliable Cloud AI Infrastructure via Proactive Validation (Yifan Xiong et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Anubis: Towards Reliable Cloud AI Infrastructure via Proactive Validation" index=159>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (160/187) Population Protocols for Exact Plurality Consensus -- How a small chance of failure helps to eliminate insignificant opinions (Gregor Bankhamer et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Population Protocols for Exact Plurality Consensus -- How a small chance of failure helps to eliminate insignificant opinions" index=160>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (161/187) Relative frequencies of constrained events in stochastic processes: An analytical approach (S. Rusconi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Relative frequencies of constrained events in stochastic processes: An analytical approach" index=161>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (162/187) Cardiac ultrasound simulation for autonomous ultrasound navigation (Abdoul Aziz Amadou et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Cardiac ultrasound simulation for autonomous ultrasound navigation" index=162>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (163/187) Outage performance of the $α$-Beaulieu-Xie Shadowed Fading Channel Model (Aleksey S. Gvozdarev, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Outage performance of the $α$-Beaulieu-Xie Shadowed Fading Channel Model" index=163>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (164/187) CoRe-GD: A Hierarchical Framework for Scalable Graph Visualization with GNNs (Florian Grötschla et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="CoRe-GD: A Hierarchical Framework for Scalable Graph Visualization with GNNs" index=164>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (165/187) An integrated heart-torso electromechanical model for the simulation of electrophysiogical outputs accounting for myocardial deformation (Elena Zappon et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="An integrated heart-torso electromechanical model for the simulation of electrophysiogical outputs accounting for myocardial deformation" index=165>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (166/187) Mesh-robust stability and convergence of variable-step deferred correction methods based on the BDF2 formula (Jiahe Yue et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Mesh-robust stability and convergence of variable-step deferred correction methods based on the BDF2 formula" index=166>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (167/187) Towards Chip-in-the-loop Spiking Neural Network Training via Metropolis-Hastings Sampling (Ali Safa et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Towards Chip-in-the-loop Spiking Neural Network Training via Metropolis-Hastings Sampling" index=167>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (168/187) Fine-Tuning Surrogate Gradient Learning for Optimal Hardware Performance in Spiking Neural Networks (Ilkin Aliyev et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Fine-Tuning Surrogate Gradient Learning for Optimal Hardware Performance in Spiking Neural Networks" index=168>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (169/187) N-1 Reduced Optimal Power Flow Using Augmented Hierarchical Graph Neural Network (Thuan Pham et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="N-1 Reduced Optimal Power Flow Using Augmented Hierarchical Graph Neural Network" index=169>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (170/187) EJS, JIL Server, and LabVIEW: An Architecture for Rapid Development of Remote Labs (Jesús Chacón et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="EJS, JIL Server, and LabVIEW: An Architecture for Rapid Development of Remote Labs" index=170>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (171/187) Distributed Safe Navigation of Multi-Agent Systems using Control Barrier Function-Based Optimal Controllers (Pol Mestres et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Distributed Safe Navigation of Multi-Agent Systems using Control Barrier Function-Based Optimal Controllers" index=171>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (172/187) Cooperative Nonlinear Guidance Strategies for Guaranteed Pursuit-Evasion (Saurabh Kumar et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Cooperative Nonlinear Guidance Strategies for Guaranteed Pursuit-Evasion" index=172>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (173/187) Coverage and Rate Analysis for Distributed RISs-Assisted mmWave Communications (Yuan Xu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Coverage and Rate Analysis for Distributed RISs-Assisted mmWave Communications" index=173>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (174/187) High-Rate Fair-Density Parity-Check Codes (Hessam Mahdavifar, 2024)
...
<br/>
<button class="copy-to-clipboard" title="High-Rate Fair-Density Parity-Check Codes" index=174>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (175/187) Multi-Modal Concurrent Transmission (Majid Nasiri Khormuji et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Multi-Modal Concurrent Transmission" index=175>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (176/187) CityFlowER: An Efficient and Realistic Traffic Simulator with Embedded Machine Learning Models (Longchao Da et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="CityFlowER: An Efficient and Realistic Traffic Simulator with Embedded Machine Learning Models" index=176>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (177/187) Controllable seismic velocity synthesis using generative diffusion models (Fu Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Controllable seismic velocity synthesis using generative diffusion models" index=177>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (178/187) What We Know About Using Non-Engagement Signals in Content Ranking (Tom Cunningham et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="What We Know About Using Non-Engagement Signals in Content Ranking" index=178>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (179/187) A new edge betweenness measure using a game theoretical approach: an application to hierarchical community detection (Daniel Gómez et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A new edge betweenness measure using a game theoretical approach: an application to hierarchical community detection" index=179>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (180/187) You Still See Me: How Data Protection Supports the Architecture of ML Surveillance (Rui-Jie Yew et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="You Still See Me: How Data Protection Supports the Architecture of ML Surveillance" index=180>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (181/187) Value-based Resource Matching with Fairness Criteria: Application to Agricultural Water Trading (Abhijin Adiga et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Value-based Resource Matching with Fairness Criteria: Application to Agricultural Water Trading" index=181>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (182/187) Assortment Planning with Sponsored Products (Shaojie Tang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Assortment Planning with Sponsored Products" index=182>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (183/187) Bandit Convex Optimisation (Tor Lattimore, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Bandit Convex Optimisation" index=183>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (184/187) PULSE: Parametric Hardware Units for Low-power Sparsity-Aware Convolution Engine (Ilkin Aliyev et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="PULSE: Parametric Hardware Units for Low-power Sparsity-Aware Convolution Engine" index=184>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (185/187) Algorithm-hardware co-design for Energy-Efficient A/D conversion in ReRAM-based accelerators (Chenguang Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Algorithm-hardware co-design for Energy-Efficient A/D conversion in ReRAM-based accelerators" index=185>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (186/187) Peeking with PEAK: Sequential, Nonparametric Composite Hypothesis Tests for Means of Multiple Data Streams (Brian Cho et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Peeking with PEAK: Sequential, Nonparametric Composite Hypothesis Tests for Means of Multiple Data Streams" index=186>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (187/187) evolSOM: an R Package for evolutionary conservation analysis with SOMs (Santiago Prochetto et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="evolSOM: an R Package for evolutionary conservation analysis with SOMs" index=187>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
