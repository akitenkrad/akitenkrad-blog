...
### (1/89) Scenimefy: Learning to Craft Anime Scene via Semi-Supervised Image-to-Image Translation (Yuxin Jiang et al., 2023)
...
### (2/89) Qwen-VL: A Frontier Large Vision-Language Model with Versatile Abilities (Jinze Bai et al., 2023)
...
### (3/89) Dense Text-to-Image Generation with Attention Modulation (Yunji Kim et al., 2023)
...
### (4/89) Motion-Guided Masking for Spatiotemporal Representation Learning (David Fan et al., 2023)
...
### (5/89) Less is More: Towards Efficient Few-shot 3D Semantic Segmentation via Training-free Networks (Xiangyang Zhu et al., 2023)
...
### (6/89) Towards Realistic Zero-Shot Classification via Self Structural Semantic Alignment (Sheng Zhang et al., 2023)
...
### (7/89) Perspective-aware Convolution for Monocular 3D Object Detection (Jia-Quan Yu et al., 2023)
...
### (8/89) CDAN: Convolutional Dense Attention-guided Network for Low-light Image Enhancement (Hossein Shakibania et al., 2023)
...
### (9/89) Boosting Semantic Segmentation from the Perspective of Explicit Class Embeddings (Yuhe Liu et al., 2023)
...
### (10/89) Implicit Obstacle Map-driven Indoor Navigation Model for Robust Obstacle Avoidance (Wei Xie et al., 2023)
...
### (11/89) FaceTouch: Detecting hand-to-face touch with supervised contrastive learning to assist in tracing infectious disease (Mohamed R. Ibrahim et al., 2023)
...
### (12/89) EFormer: Enhanced Transformer towards Semantic-Contour Features of Foreground for Portraits Matting (Zitao Wang et al., 2023)
...
### (13/89) Robotic Scene Segmentation with Memory Network for Runtime Surgical Context Inference (Zongyu Li et al., 2023)
...
### (14/89) On Offline Evaluation of 3D Object Detection for Autonomous Driving (Tim Schreier et al., 2023)
...
### (15/89) PartSeg: Few-shot Part Segmentation via Part-aware Prompt Learning (Mengya Han et al., 2023)
...
### (16/89) Learning Heavily-Degraded Prior for Underwater Object Detection (Chenping Fu et al., 2023)
...
### (17/89) Asymmetric Co-Training with Explainable Cell Graph Ensembling for Histopathological Image Classification (Ziqi Yang et al., 2023)
...
### (18/89) DeepLOC: Deep Learning-based Bone Pathology Localization and Classification in Wrist X-ray Images (Razan Dibo et al., 2023)
...
### (19/89) VIGC: Visual Instruction Generation and Correction (Bin Wang et al., 2023)
...
### (20/89) A Parse-Then-Place Approach for Generating Graphic Layouts from Textual Descriptions (Jiawei Lin et al., 2023)
...
### (21/89) A Study of Age and Sex Bias in Multiple Instance Learning based Classification of Acute Myeloid Leukemia Subtypes (Ario Sadafi et al., 2023)
...
### (22/89) Masked Feature Modelling: Feature Masking for the Unsupervised Pre-training of a Graph Attention Network Block for Bottom-up Video Event Recognition (Dimitrios Daskalakis et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2308.12673v1)  
...
### (23/89) Don't Look into the Sun: Adversarial Solarization Attacks on Image Classifiers (Paul Gavrikov et al., 2023)
...
### (24/89) An All Deep System for Badminton Game Analysis (Po-Yung Chou et al., 2023)
...
### (25/89) Towards Hierarchical Regional Transformer-based Multiple Instance Learning (Josef Cersovsky et al., 2023)
...
### (26/89) Cross-Video Contextual Knowledge Exploration and Exploitation for Ambiguity Reduction in Weakly Supervised Temporal Action Localization (Songchun Zhang et al., 2023)
...
### (27/89) HR-Pro: Point-supervised Temporal Action Localization via Hierarchical Reliability Propagation (Huaxin Zhang et al., 2023)
...
### (28/89) APLA: Additional Perturbation for Latent Noise with Adversarial Training Enables Consistency (Yupu Yao et al., 2023)
...
### (29/89) Logic-induced Diagnostic Reasoning for Semi-supervised Semantic Segmentation (Chen Liang et al., 2023)
...
### (30/89) REB: Reducing Biases in Representation for Industrial Anomaly Detection (Shuai Lyu et al., 2023)
...
### (31/89) NOVA: NOvel View Augmentation for Neural Composition of Dynamic Objects (Dakshit Agrawal et al., 2023)
...
### (32/89) Synchronize Feature Extracting and Matching: A Single Branch Framework for 3D Object Tracking (Teli Ma et al., 2023)
...
### (33/89) Hybrid Models for Facial Emotion Recognition in Children (Rafael Zimmer et al., 2023)
...
### (34/89) Channel and Spatial Relation-Propagation Network for RGB-Thermal Semantic Segmentation (Zikun Zhou et al., 2023)
...
### (35/89) I3DOD: Towards Incremental 3D Object Detection via Prompting (Wenqi Liang et al., 2023)
...
### (36/89) Masked Autoencoders are Efficient Class Incremental Learners (Jiang-Tian Zhai et al., 2023)
...
### (37/89) DD-GCN: Directed Diffusion Graph Convolutional Network for Skeleton-based Human Action Recognition (Chang Li et al., 2023)
...
### (38/89) Low-count Time Series Anomaly Detection (Philipp Renz et al., 2023)
...
### (39/89) Evaluating the Vulnerabilities in ML systems in terms of adversarial attacks (John Harshith et al., 2023)
...
### (40/89) Easy attention: A simple self-attention mechanism for Transformers (Marcial Sanchis-Agudo et al., 2023)
...
### (41/89) Fast Adversarial Training with Smooth Convergence (Mengnan Zhao et al., 2023)
...
### (42/89) Match-And-Deform: Time Series Domain Adaptation through Optimal Transport and Temporal Alignment (François Painblanc et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2308.12686v1)  
...
### (43/89) Try with Simpler -- An Evaluation of Improved Principal Component Analysis in Log-based Anomaly Detection (Lin Yang et al., 2023)
...
### (44/89) Multivariate Time-Series Anomaly Detection with Contaminated Data: Application to Physiological Signals (Thi Kieu Khanh Ho et al., 2023)
...
### (45/89) Variational Information Pursuit with Large Language and Multimodal Models for Interpretable Predictions (Kwan Ho Ryan Chan et al., 2023)
...
### (46/89) A Co-training Approach for Noisy Time Series Learning (Weiqi Zhang et al., 2023)
...
### (47/89) An Efficient Distributed Multi-Agent Reinforcement Learning for EV Charging Network Control (Amin Shojaeighadikolaei et al., 2023)
...
### (48/89) Language as Reality: A Co-Creative Storytelling Game Experience in 1001 Nights using Generative AI (Yuqian Sun et al., 2023)
...
### (49/89) Continuous Reinforcement Learning-based Dynamic Difficulty Adjustment in a Visual Working Memory Game (Masoud Rahimi et al., 2023)
...
### (50/89) On Popularity Bias of Multimodal-aware Recommender Systems: a Modalities-driven Analysis (Daniele Malitesta et al., 2023)
...
### (51/89) On the Consistency of Average Embeddings for Item Recommendation (Walid Bendada et al., 2023)
...
### (52/89) Exploring the Integration Strategies of Retriever and Large Language Models (Ye Liu et al., 2023)
...
### (53/89) Large Language Models Vote: Prompting for Rare Disease Identification (David Oniani et al., 2023)
...
### (54/89) Inducing Causal Structure for Abstractive Text Summarization (Lu Chen et al., 2023)
...
### (55/89) Text Similarity from Image Contents using Statistical and Semantic Analysis Techniques (Sagar Kulkarni et al., 2023)
...
### (56/89) Use of LLMs for Illicit Purposes: Threats, Prevention Measures, and Vulnerabilities (Maximilian Mozes et al., 2023)
...
### (57/89) Harnessing the Power of David against Goliath: Exploring Instruction Data Generation without Using Closed-Source Models (Yue Wang et al., 2023)
...
### (58/89) Improving Translation Faithfulness of Large Language Models via Augmenting Instructions (Yijie Chen et al., 2023)
...
### (59/89) From Chatter to Matter: Addressing Critical Steps of Emotion Recognition Learning in Task-oriented Dialogue (Shutong Feng et al., 2023)
...
### (60/89) Advancing Hungarian Text Processing with HuSpaCy: Efficient and Accurate NLP Pipelines (György Orosz et al., 2023)
...
### (61/89) Mind vs. Mouth: On Measuring Re-judge Inconsistency of Social Bias in Large Language Models (Yachao Zhao et al., 2023)
...
### (62/89) A Small and Fast BERT for Chinese Medical Punctuation Restoration (Tongtao Ling et al., 2023)
...
### (63/89) CALM : A Multi-task Benchmark for Comprehensive Assessment of Language Model Bias (Vipul Gupta et al., 2023)
...
### (64/89) CARE: Co-Attention Network for Joint Entity and Relation Extraction (Wenjun Kong et al., 2023)
...
### (65/89) Large Language Model as Autonomous Decision Maker (Yining Ye et al., 2023)
...
### (66/89) American Stories: A Large-Scale Structured Text Dataset of Historical U.S. Newspapers (Melissa Dell et al., 2023)
...
### (67/89) Learned Local Attention Maps for Synthesising Vessel Segmentations (Yash Deo et al., 2023)
...
### (68/89) Actuator Trajectory Planning for UAVs with Overhead Manipulator using Reinforcement Learning (Hazim Alzorgan et al., 2023)
...
Keywords: Reinforcement Learning  
[Paper Link](http://arxiv.org/abs/2308.12843v1)  
...
### (69/89) HuBo-VLM: Unified Vision-Language Model designed for HUman roBOt interaction tasks (Zichao Dong et al., 2023)
...
### (70/89) Automated Test Generation for Medical Rules Web Services: A Case Study at the Cancer Registry of Norway (Christoph Laaber et al., 2023)
...
### (71/89) Pre-training Code Representation with Semantic Flow Graph for Effective Bug Localization (Yali Du et al., 2023)
...
### (72/89) Prompt-Enhanced Software Vulnerability Detection Using ChatGPT (Chenyuan Zhang et al., 2023)
...
### (73/89) kTrans: Knowledge-Aware Transformer for Binary Code Embedding (Wenyu Zhu et al., 2023)
...
### (74/89) Sparks of Large Audio Models: A Survey and Outlook (Siddique Latif et al., 2023)
...
### (75/89) Real-time Detection of AI-Generated Speech for DeepFake Voice Conversion (Jordan J. Bird et al., 2023)
...
### (76/89) Attention-Based Acoustic Feature Fusion Network for Depression Detection (Xiao Xu et al., 2023)
...
### (77/89) Separating the Human Touch from AI-Generated Text using Higher Criticism: An Information-Theoretic Approach (Alon Kipnis, 2023)
...
### (78/89) Video Recommendation Using Social Network Analysis and User Viewing Patterns (Mehrdad Maghsoudi et al., 2023)
...
### (79/89) False Information, Bots and Malicious Campaigns: Demystifying Elements of Social Media Manipulations (Mohammad Majid Akhtar et al., 2023)
...
### (80/89) Human Comprehensible Active Learning of Genome-Scale Metabolic Networks (Lun Ai et al., 2023)
...
### (81/89) SayCanPay: Heuristic Planning with Large Language Models using Learnable Domain Knowledge (Rishi Hazra et al., 2023)
...
### (82/89) LR-XFL: Logical Reasoning-based Explainable Federated Learning (Yanci Zhang et al., 2023)
...
### (83/89) GPTEval: A Survey on Assessments of ChatGPT and GPT-4 (Rui Mao et al., 2023)
...
### (84/89) Security Assessment and Hardening of Fog Computing Systems (Carmine Cesarano, 2023)
...
### (85/89) Exploring Transferability of Multimodal Adversarial Samples for Vision-Language Pre-training Models with Contrastive Learning (Youze Wang et al., 2023)
...
### (86/89) Emotion-Aligned Contrastive Learning Between Images and Music (Shanti Stewart et al., 2023)
...
### (87/89) Hydrogen jet diffusion modeling by using physics-informed graph neural network and sparsely-distributed sensor data (Xinqi Zhang et al., 2023)
...
### (88/89) Deep Reinforcement Learning-driven Cross-Community Energy Interaction Optimal Scheduling (Yang Li et al., 2023)
...
### (89/89) Fall Detection using Knowledge Distillation Based Long short-term memory for Offline Embedded and Low Power Devices (Hannah Zhou et al., 2023)
