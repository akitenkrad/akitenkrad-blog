...
### (1/55) Enhancing Network Management Using Code Generated by Large Language Models (Sathiya Kumaran Mani et al., 2023)
...
### (2/55) Big AI Models for 6G Wireless Networks: Opportunities, Challenges, and Research Directions (Zirui Chen et al., 2023)
...
### (3/55) ChatGPT-based Investment Portfolio Selection (Oleksandr Romanko et al., 2023)
...
### (4/55) FunnyBirds: A Synthetic Vision Dataset for a Part-Based Analysis of Explainable AI Methods (Robin Hesse et al., 2023)
...
### (5/55) Complex Facial Expression Recognition Using Deep Knowledge Distillation of Basic Features (Angus Maiden et al., 2023)
...
### (6/55) Rethinking the Localization in Weakly Supervised Object Localization (Rui Xu et al., 2023)
...
### (7/55) Diffusion-based Visual Counterfactual Explanations -- Towards Systematic Quantitative Evaluation (Philipp Vaeth et al., 2023)
...
### (8/55) Experts Weights Averaging: A New General Training Scheme for Vision Transformers (Yongqi Huang et al., 2023)
...
### (9/55) Computer-Aided Cytology Diagnosis in Animals: CNN-Based Image Quality Assessment for Accurate Disease Classification (Jan Krupiński et al., 2023)
...
### (10/55) Diverse Data Augmentation with Diffusions for Effective Test-time Prompt Tuning (Chun-Mei Feng et al., 2023)
...
### (11/55) Masked-Attention Diffusion Guidance for Spatially Controlling Text-to-Image Generation (Yuki Endo, 2023)
...
### (12/55) Spatial-information Guided Adaptive Context-aware Network for Efficient RGB-D Semantic Segmentation (Yang Zhang et al., 2023)
...
### (13/55) Enhancing Generalization of Universal Adversarial Perturbation through Gradient Aggregation (Xuannan Liu et al., 2023)
...
### (14/55) ViGT: Proposal-free Video Grounding with Learnable Token in Transformer (Kun Li et al., 2023)
...
### (15/55) Cyclic-Bootstrap Labeling for Weakly Supervised Object Detection (Yufei Yin et al., 2023)
...
### (16/55) MS3D++: Ensemble of Experts for Multi-Source Unsupervised Domain Adaption in 3D Object Detection (Darren Tsai et al., 2023)
...
### (17/55) Compositional Learning in Transformer-Based Human-Object Interaction Detection (Zikun Zhuang et al., 2023)
...
### (18/55) Uncertainty-Aware Cross-Modal Transfer Network for Sketch-Based 3D Shape Retrieval (Yiyang Cai et al., 2023)
...
### (19/55) ARGUS: Visualization of AI-Assisted Task Guidance in AR (Sonia Castelo et al., 2023)
...
### (20/55) Comprehensive Benchmarking of Binary Neural Networks on NVM Crossbar Architectures (Ruirong Huang et al., 2023)
...
### (21/55) A Large Language Model Enhanced Conversational Recommender System (Yue Feng et al., 2023)
...
### (22/55) Identification of the Relevance of Comments in Codes Using Bag of Words and Transformer Based Models (Sruthi S et al., 2023)
...
### (23/55) Thinking Like an Expert:Multimodal Hypergraph-of-Thought (HoT) Reasoning to boost Foundation Modals (Fanglong Yao et al., 2023)
...
### (24/55) Weakly Supervised Text Classification on Free Text Comments in Patient-Reported Outcome Measures (Anna-Grace Linton et al., 2023)
...
### (25/55) Assessing Guest Nationality Composition from Hotel Reviews (Fabian Gröger et al., 2023)
...
### (26/55) Task Conditioned BERT for Joint Intent Detection and Slot-filling (Diogo Tavares et al., 2023)
...
### (27/55) Improving Zero-Shot Text Matching for Financial Auditing with Large Language Models (Lars Hillebrand et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2308.06111v1)  
...
### (28/55) Fly-Swat or Cannon? Cost-Effective Language Model Choice via Meta-Modeling (Marija Šakota et al., 2023)
...
### (29/55) A Case Study on Context Encoding in Multi-Encoder based Document-Level Neural Machine Translation (Ramakrishna Appicharla et al., 2023)
...
### (30/55) PIPPA: A Partially Synthetic Conversational Dataset (Tear Gosling et al., 2023)
...
### (31/55) SALSy: Security-Aware Layout Synthesis (Mohammad Eslami et al., 2023)
...
### (32/55) Physical Adversarial Attacks For Camera-based Smart Systems: Current Trends, Categorization, Applications, Research Challenges, and Future Outlook (Amira Guesmi et al., 2023)
...
### (33/55) A Uniform Representation of Classical and Quantum Source Code for Static Code Analysis (Maximilian Kaul et al., 2023)
...
### (34/55) Security of XCB and HCTR (Manish Kumar, 2023)
...
### (35/55) CyberForce: A Federated Reinforcement Learning Framework for Malware Mitigation (Chao Feng et al., 2023)
...
### (36/55) Software Doping Analysis for Human Oversight (Sebastian Biewer et al., 2023)
...
### (37/55) PrivacyLens: A Framework to Collect and Analyze the Landscape of Past, Present, and Future Smart Device Privacy Policies (Aamir Hamid et al., 2023)
...
### (38/55) Phased Deep Spatio-temporal Learning for Highway Traffic Volume Prediction (Weilong Ding et al., 2023)
...
### (39/55) PDE Discovery for Soft Sensors Using Coupled Physics-Informed Neural Network with Akaike's Information Criterion (Aina Wang et al., 2023)
...
### (40/55) Composable Function-preserving Expansions for Transformer Architectures (Andrea Gesmundo et al., 2023)
...
### (41/55) Towards Instance-adaptive Inference for Federated Learning (Chun-Mei Feng et al., 2023)
...
### (42/55) Does AI for science need another ImageNet Or totally different benchmarks? A case study of machine learning force fields (Yatao Li et al., 2023)
...
### (43/55) Lip2Vec: Efficient and Robust Visual Speech Recognition via Latent-to-Latent Visual to Audio Representation Mapping (Yasser Abdelaziz Dahou Djilali et al., 2023)
...
### (44/55) An Autoethnographic Exploration of XAI in Algorithmic Composition (Ashley Noel-Hirst et al., 2023)
...
### (45/55) Assessing Student Errors in Experimentation Using Artificial Intelligence and Large Language Models: A Comparative Study with Human Raters (Arne Bewersdorff et al., 2023)
...
### (46/55) Learning to Guide Human Experts via Personalized Large Language Models (Debodeep Banerjee et al., 2023)
...
### (47/55) Evidence of Human-Like Visual-Linguistic Integration in Multimodal Large Language Models During Predictive Language Processing (Viktor Kewenig et al., 2023)
...
### (48/55) Large Language Models in Cryptocurrency Securities Cases: Can ChatGPT Replace Lawyers? (Arianna Trozze et al., 2023)
...
### (49/55) TrajPAC: Towards Robustness Verification of Pedestrian Trajectory Prediction Models (Liang Zhang et al., 2023)
...
### (50/55) Learning to Team-Based Navigation: A Review of Deep Reinforcement Learning Techniques for Multi-Agent Pathfinding (Jaehoon Chung et al., 2023)
...
### (51/55) Audio-Visual Spatial Integration and Recursive Attention for Robust Sound Source Localization (Sung Jin Um et al., 2023)
...
### (52/55) Large Language Models for Telecom: Forthcoming Impact on the Industry (Ali Maatouk et al., 2023)
...
### (53/55) Decentralised Governance for Foundation Model based Systems: Exploring the Role of Blockchain in Responsible AI (Yue Liu et al., 2023)
...
### (54/55) Node Embedding for Homophilous Graphs with ARGEW: Augmentation of Random walks by Graph Edge Weights (Jun Hee Kim et al., 2023)
...
### (55/55) A Deep Recurrent-Reinforcement Learning Method for Intelligent AutoScaling of Serverless Functions (Siddharth Agarwal et al., 2023)
