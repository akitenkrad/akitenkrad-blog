...
### (1/89) Efficient Algorithms for Attributed Graph Alignment with Vanishing Edge Correlation (Ziao Wang et al., 2023)
...
### (2/89) Mitigating Misinformation Spreading in Social Networks Via Edge Blocking (Ahad N. Zehmakan et al., 2023)
...
### (3/89) A Model-Agnostic Framework for Recommendation via Interest-aware Item Embeddings (Amit Kumar Jaiswal et al., 2023)
...
### (4/89) A Comparative Study of Text Embedding Models for Semantic Text Similarity in Bug Reports (Avinash Patil et al., 2023)
...
### (5/89) Enhancing API Documentation through BERTopic Modeling and Summarization (AmirHossein Naghshzan et al., 2023)
...
### (6/89) Towards Automatically Addressing Self-Admitted Technical Debt: How Far Are We? (Antonio Mastropaolo et al., 2023)
...
### (7/89) CodeCoT and Beyond: Learning to Program and Test like a Developer (Dong Huang et al., 2023)
...
### (8/89) On the Effectiveness of Log Representation for Log-based Anomaly Detection (Xingfang Wu et al., 2023)
...
### (9/89) RatGPT: Turning online LLMs into Proxies for Malware Attacks (Mika Beckerich et al., 2023)
...
### (10/89) Forensic Data Analytics for Anomaly Detection in Evolving Networks (Li Yang et al., 2023)
...
### (11/89) Watch Out! Smartwatches as criminal tool and digital forensic investigations (Seungjae Jeon et al., 2023)
...
### (12/89) Smart Bulbs can be Hacked to Hack into your Household (Davide Bonaventura et al., 2023)
...
### (13/89) Towards a Practical Defense against Adversarial Attacks on Deep Learning-based Malware Detectors via Randomized Smoothing (Daniel Gibert et al., 2023)
...
### (14/89) How Does Pruning Impact Long-Tailed Multi-Label Medical Image Classifiers? (Gregory Holste et al., 2023)
...
### (15/89) FedPerfix: Towards Partial Model Personalization of Vision Transformers in Federated Learning (Guangyu Sun et al., 2023)
...
### (16/89) EgoSchema: A Diagnostic Benchmark for Very Long-form Video Language Understanding (Karttikeya Mangalam et al., 2023)
...
### (17/89) ICAR: Image-based Complementary Auto Reasoning (Xijun Wang et al., 2023)
...
### (18/89) Learning Lightweight Object Detectors via Multi-Teacher Progressive Distillation (Shengcao Cao et al., 2023)
...
### (19/89) ImGeoNet: Image-induced Geometry-aware Voxel Representation for Multi-view 3D Object Detection (Tao Tu et al., 2023)
...
### (20/89) Identity-Aware Semi-Supervised Learning for Comic Character Re-Identification (Gürkan Soykan et al., 2023)
...
### (21/89) SimFIR: A Simple Framework for Fisheye Image Rectification with Self-supervised Representation Learning (Hao Feng et al., 2023)
...
### (22/89) MarginMatch: Improving Semi-Supervised Learning with Pseudo-Margins (Tiberiu Sosea et al., 2023)
...
### (23/89) Uni-NLX: Unifying Textual Explanations for Vision and Vision-Language Tasks (Fawaz Sammani et al., 2023)
...
### (24/89) ARAI-MVSNet: A multi-view stereo depth estimation network with adaptive depth range and depth interval (Song Zhang et al., 2023)
...
### (25/89) FashionLOGO: Prompting Multimodal Large Language Models for Fashion Logo Embeddings (Yulin Su et al., 2023)
...
### (26/89) Semantic Information for Object Detection (Jean-Francois Nies, 2023)
...
### (27/89) Automatic Signboard Recognition in Low Quality Night Images (Manas Kagde et al., 2023)
...
### (28/89) Point-aware Interaction and CNN-induced Refinement Network for RGB-D Salient Object Detection (Runmin Cong et al., 2023)
...
### (29/89) A White-Box False Positive Adversarial Attack Method on Contrastive Loss-Based Offline Handwritten Signature Verification Models (Zhongliang Guo et al., 2023)
...
### (30/89) Frequency Perception Network for Camouflaged Object Detection (Runmin Cong et al., 2023)
...
### (31/89) Identity-Seeking Self-Supervised Representation Learning for Generalizable Person Re-identification (Zhaopeng Dou et al., 2023)
...
### (32/89) SRMAE: Masked Image Modeling for Scale-Invariant Deep Representations (Zhiming Wang et al., 2023)
...
### (33/89) Language-enhanced RNR-Map: Querying Renderable Neural Radiance Field maps with natural language (Francesco Taioli et al., 2023)
...
### (34/89) Bag of Tricks for Long-Tailed Multi-Label Classification on Chest X-Rays (Feng Hong et al., 2023)
...
### (35/89) MixBag: Bag-Level Data Augmentation for Learning from Label Proportions (Takanori Asanomi et al., 2023)
...
### (36/89) URL: Combating Label Noise for Lung Nodule Malignancy Grading (Xianze Ai et al., 2023)
...
### (37/89) Chat-3D: Data-efficiently Tuning Large Language Model for Universal Dialogue of 3D Scenes (Zehan Wang et al., 2023)
...
### (38/89) BOTT: Box Only Transformer Tracker for 3D Object Tracking (Lubing Zhou et al., 2023)
...
### (39/89) Learning Through Guidance: Knowledge Distillation for Endoscopic Image Classification (Harshala Gammulle et al., 2023)
...
### (40/89) Learning A Coarse-to-Fine Diffusion Transformer for Image Restoration (Liyan Wang et al., 2023)
...
### (41/89) Long-Range Grouping Transformer for Multi-View 3D Reconstruction (Liying Yang et al., 2023)
...
### (42/89) Diversifying AI: Towards Creative Chess with AlphaZero (Tom Zahavy et al., 2023)
...
### (43/89) Probabilistic Results on the Architecture of Mathematical Reasoning Aligned by Cognitive Alternation (Minzheng Li et al., 2023)
...
### (44/89) Consciousness in Artificial Intelligence: Insights from the Science of Consciousness (Patrick Butlin et al., 2023)
...
Keywords: AI  
[Paper Link](http://arxiv.org/abs/2308.08708v1)  
...
### (45/89) Characterizing Information Seeking Events in Health-Related Social Discourse (Omar Sharif et al., 2023)
...
### (46/89) Semantic Consistency for Assuring Reliability of Large Language Models (Harsh Raj et al., 2023)
...
### (47/89) Linearity of Relation Decoding in Transformer Language Models (Evan Hernandez et al., 2023)
...
### (48/89) MaScQA: A Question Answering Dataset for Investigating Materials Science Knowledge of Large Language Models (Mohd Zaki et al., 2023)
...
### (49/89) mCL-NER: Cross-Lingual Named Entity Recognition via Multi-view Contrastive Learning (Ying Mo et al., 2023)
...
### (50/89) Contrasting Linguistic Patterns in Human and LLM-Generated Text (Alberto Muñoz-Ortiz et al., 2023)
...
### (51/89) Reinforced Self-Training (ReST) for Language Modeling (Caglar Gulcehre et al., 2023)
...
Keywords: Language Model  
[Paper Link](http://arxiv.org/abs/2308.08998v1)  
...
### (52/89) Evaluation of really good grammatical error correction (Robert Östling et al., 2023)
...
### (53/89) Beam Retrieval: General End-to-End Retrieval for Multi-Hop Question Answering (Jiahao Zhang et al., 2023)
...
### (54/89) CMB: A Comprehensive Medical Benchmark in Chinese (Xidong Wang et al., 2023)
...
### (55/89) Factuality Detection using Machine Translation -- a Use Case for German Clinical Text (Mohammed Bin Sumait et al., 2023)
...
### (56/89) Linguistically-Informed Neural Architectures for Lexical, Syntactic and Semantic Tasks in Sanskrit (Jivnesh Sandhan, 2023)
...
### (57/89) Chinese Spelling Correction as Rephrasing Language Model (Linfeng Liu et al., 2023)
...
### (58/89) Task Relation Distillation and Prototypical Pseudo Label for Incremental Named Entity Recognition (Duzhen Zhang et al., 2023)
...
### (59/89) Exploring Demonstration Ensembling for In-context Learning (Muhammad Khalifa et al., 2023)
...
Categories: cs-AI, cs-CL, cs.CL  
Keywords: GPT  
[Paper Link](http://arxiv.org/abs/2308.08780v1)  
...
### (60/89) Differential Privacy, Linguistic Fairness, and Training Data Influence: Impossibility and Possibility Theorems for Multilingual Language Models (Phillip Rust et al., 2023)
...
### (61/89) Discrete Prompt Compression with Reinforcement Learning (Hoyoun Jung et al., 2023)
...
### (62/89) An Empirical Study of Catastrophic Forgetting in Large Language Models During Continual Fine-tuning (Yun Luo et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2308.08747v1)  
...
### (63/89) PMET: Precise Model Editing in a Transformer (Xiaopeng Li et al., 2023)
...
### (64/89) Enhancing Phrase Representation by Information Bottleneck Guided Text Diffusion Process for Keyphrase Extraction (Yuanzhen Luo et al., 2023)
...
### (65/89) Decoding Emotions: A comprehensive Multilingual Study of Speech Models for Speech Emotion Recognition (Anant Singh et al., 2023)
...
### (66/89) JPEG Quantized Coefficient Recovery via DCT Domain Spatial-Frequential Transformer (Mingyu Ouyang et al., 2023)
...
### (67/89) LesionMix: A Lesion-Level Data Augmentation Method for Medical Image Segmentation (Berke Doga Basaran et al., 2023)
...
### (68/89) Spectral information criterion for automatic elbow detection (L. Martino et al., 2023)
...
### (69/89) Reinforcement Learning for Battery Management in Dairy Farming (Nawazish Ali et al., 2023)
...
### (70/89) Deep-seeded Clustering for Unsupervised Valence-Arousal Emotion Recognition from Physiological Signals (Antoine Dubois et al., 2023)
...
### (71/89) CONVERT:Contrastive Graph Clustering with Reliable Augmentation (Xihong Yang et al., 2023)
...
### (72/89) Interpretable Graph Neural Networks for Tabular Data (Amr Alkhatib et al., 2023)
...
### (73/89) Causal Adversarial Perturbations for Individual Fairness and Robustness in Heterogeneous Data Spaces (Ahmad-Reza Ehyaei et al., 2023)
...
### (74/89) IMM: An Imitative Reinforcement Learning Approach with Predictive Representation Learning for Automatic Market Making (Hui Niu et al., 2023)
...
### (75/89) Beyond Sharing: Conflict-Aware Multivariate Time Series Anomaly Detection (Haotian Si et al., 2023)
...
### (76/89) Development of a Knowledge Graph Embeddings Model for Pain (Jaya Chaturvedi et al., 2023)
...
### (77/89) Mitigating Semantic Confusion from Hostile Neighborhood for Graph Active Learning (Tianmeng Yang et al., 2023)
...
### (78/89) Explainable AI for tool wear prediction in turning (Saleh Valizadeh Sotubadi et al., 2023)
...
### (79/89) Towards Lightweight Data Integration using Multi-workflow Provenance and Data Observability (Renan Souza et al., 2023)
...
### (80/89) Multi-FedLS: a Framework for Cross-Silo Federated Learning Applications on Multi-Cloud Environments (Rafaela C. Brum et al., 2023)
...
### (81/89) Hitting the High-Dimensional Notes: An ODE for SGD learning dynamics on GLMs and multi-index models (Elizabeth Collins-Woodfin et al., 2023)
...
### (82/89) Explicit Estimation of Magnitude and Phase Spectra in Parallel for High-Quality Speech Enhancement (Ye-Xin Lu et al., 2023)
...
### (83/89) Graph Neural Network Backend for Speaker Recognition (Liang He et al., 2023)
...
### (84/89) The DKU-MSXF Speaker Verification System for the VoxCeleb Speaker Recognition Challenge 2023 (Ze Li et al., 2023)
...
### (85/89) Unfolding for Joint Channel Estimation and Symbol Detection in MIMO Communication Systems (Swati Bhattacharya et al., 2023)
...
Keywords: QA  
[Paper Link](http://arxiv.org/abs/2308.08917v1)  
...
### (86/89) Federated Reinforcement Learning for Electric Vehicles Charging Control on Distribution Networks (Junkai Qian et al., 2023)
...
### (87/89) A Feasibility-Preserved Quantum Approximate Solver for the Capacitated Vehicle Routing Problem (Ningyi Xie et al., 2023)
...
### (88/89) Large Language Models at Work in China's Labor Market (Qin Chen et al., 2023)
...
### (89/89) ReProHRL: Towards Multi-Goal Navigation in the Real World using Hierarchical Agents (Tejaswini Manjunath et al., 2023)
