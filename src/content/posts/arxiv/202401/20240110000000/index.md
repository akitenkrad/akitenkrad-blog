...
### (16/88) Tiny Time Mixers (TTMs): Fast Pretrained Models for Enhanced Zero/Few-Shot Forecasting of Multivariate Time Series (Vijay Ekambaram et al., 2024)
...
### (51/88) TIER: Text-Image Encoder-based Regression for AIGC Image Quality Assessment (Jiquan Yuan et al., 2024)
