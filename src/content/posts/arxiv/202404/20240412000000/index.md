...
### (28/41 | 28/235) A Mathematical Theory for Learning Semantic Languages by Abstract Learners (Kuo-Yu Liao et al., 2024)
...
### (30/41 | 30/235) GoEX: Perspectives and Designs Towards a Runtime for Autonomous LLM Applications (Shishir G. Patil et al., 2024)
...
### (38/41 | 38/235) A Computational Analysis of the Dehumanisation of Migrants from Syria and Ukraine in Slovene News Media (Jaya Caporusso et al., 2024)
...
### (39/41 | 39/235) LM Transparency Tool: Interactive Tool for Analyzing Transformer Language Models (Igor Tufanov et al., 2024)
...
### (40/41 | 40/235) Charles Translator: A Machine Translation System between Ukrainian and Czech (Martin Popel et al., 2024)
...
### (41/41 | 41/235) DiffusionDialog: A Diffusion Model for Diverse Dialog Generation with Latent Space (Jianxiang Xiang et al., 2024)
...
### (1/56 | 42/235) Adapting LLaMA Decoder to Vision Transformer (Jiahao Wang et al., 2024)
...
### (2/56 | 43/235) VLLMs Provide Better Context for Emotion Understanding Through Common Sense Reasoning (Alexandros Xenos et al., 2024)
...
### (3/56 | 44/235) Implicit Multi-Spectral Transformer: An Lightweight and Effective Visible to Infrared Image Translation Model (Yijia Chen et al., 2024)
...
### (4/56 | 45/235) RealmDreamer: Text-Driven 3D Scene Generation with Inpainting and Depth Diffusion (Jaidev Shriram et al., 2024)
...
### (5/56 | 46/235) Tuning-Free Adaptive Style Incorporation for Structure-Consistent Text-Driven Style Transfer (Yanqi Ge et al., 2024)
...
### (6/56 | 47/235) AI-Guided Defect Detection Techniques to Model Single Crystal Diamond Growth (Rohan Reddy Mekala et al., 2024)
...
### (7/56 | 48/235) DreamScene360: Unconstrained Text-to-3D Scene Generation with Panoramic Gaussian Splatting (Shijie Zhou et al., 2024)
...
### (8/56 | 49/235) Object-Conditioned Energy-Based Attention Map Alignment in Text-to-Image Diffusion Models (Yasi Zhang et al., 2024)
...
### (9/56 | 50/235) Scaling Multi-Camera 3D Object Detection through Weak-to-Strong Eliciting (Hao Lu et al., 2024)
...
### (10/56 | 51/235) SafeGen: Mitigating Unsafe Content Generation in Text-to-Image Models (Xinfeng Li et al., 2024)
...
### (11/56 | 52/235) GoodDrag: Towards Good Practices for Drag Editing with Diffusion Models (Zewei Zhang et al., 2024)
...
### (12/56 | 53/235) AI-Guided Feature Segmentation Techniques to Model Features from Single Crystal Diamond Growth (Rohan Reddy Mekala et al., 2024)
...
### (13/56 | 54/235) Solving Masked Jigsaw Puzzles with Diffusion Vision Transformers (Jinyang Liu et al., 2024)
...
### (14/56 | 55/235) TrajPRed: Trajectory Prediction with Region-based Relation Learning (Chen Zhou et al., 2024)
...
### (15/56 | 56/235) Urban Architect: Steerable 3D Urban Scene Generation with Layout Prior (Fan Lu et al., 2024)
...
### (16/56 | 57/235) An inclusive review on deep learning techniques and their scope in handwriting recognition (Sukhdeep Singh et al., 2024)
...
### (17/56 | 58/235) MonoSelfRecon: Purely Self-Supervised Explicit Generalizable 3D Reconstruction of Indoor Scenes from Monocular RGB Views (Runfa Li et al., 2024)
...
### (18/56 | 59/235) UMBRAE: Unified Multimodal Decoding of Brain Signals (Weihao Xia et al., 2024)
...
### (19/56 | 60/235) HRVDA: High-Resolution Visual Document Assistant (Chaohu Liu et al., 2024)
...
### (20/56 | 61/235) Unsupervised Visible-Infrared ReID via Pseudo-label Correction and Modality-level Alignment (Yexin Liu et al., 2024)
...
### (21/56 | 62/235) Deep Generative Data Assimilation in Multimodal Setting (Yongquan Qu et al., 2024)
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.06665v2" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.06665v2.pdf" filename="2404.06665v2.pdf">Download PDF</button>
...
### (22/56 | 63/235) Multi-modal Document Presentation Attack Detection With Forensics Trace Disentanglement (Changsheng Chen et al., 2024)
...
### (23/56 | 64/235) Unified Language-driven Zero-shot Domain Adaptation (Senqiao Yang et al., 2024)
...
### (24/56 | 65/235) Lost in Translation: Modern Neural Networks Still Struggle With Small Realistic Image Transformations (Ofir Shifman et al., 2024)
...
### (25/56 | 66/235) BRAVE: Broadening the visual encoding of vision-language models (Oğuzhan Fatih Kar et al., 2024)
...
### (26/56 | 67/235) ORacle: Large Vision-Language Models for Knowledge-Guided Holistic OR Domain Modeling (Ege Özsoy et al., 2024)
...
### (27/56 | 68/235) Diffusion-based inpainting of incomplete Euclidean distance matrices of trajectories generated by a fractional Brownian motion (Alexander Lobashev et al., 2024)
...
### (28/56 | 69/235) MedRG: Medical Report Grounding with Multi-modal Large Language Model (Ke Zou et al., 2024)
...
### (29/56 | 70/235) Sparse Points to Dense Clouds: Enhancing 3D Detection with Limited LiDAR Data (Aakash Kumar et al., 2024)
...
### (30/56 | 71/235) A Transformer-Based Model for the Prediction of Human Gaze Behavior on Videos (Suleyman Ozdel et al., 2024)
...
### (31/56 | 72/235) InstantMesh: Efficient 3D Mesh Generation from a Single Image with Sparse-view Large Reconstruction Models (Jiale Xu et al., 2024)
...
### (32/56 | 73/235) Move Anything with Layered Scene Diffusion (Jiawei Ren et al., 2024)
...
### (33/56 | 74/235) Driver Attention Tracking and Analysis (Dat Viet Thanh Nguyen et al., 2024)
...
### (34/56 | 75/235) Adversarial purification for no-reference image-quality metrics: applicability study and new methods (Aleksandr Gushchin et al., 2024)
...
### (35/56 | 76/235) Fine color guidance in diffusion models and its application to image compression at extremely low bitrates (Tom Bordin et al., 2024)
...
### (36/56 | 77/235) Zero-shot Point Cloud Completion Via 2D Priors (Tianxin Huang et al., 2024)
...
### (37/56 | 78/235) Efficient and Scalable Chinese Vector Font Generation via Component Composition (Jinyu Song et al., 2024)
...
### (38/56 | 79/235) Gaze-Guided Graph Neural Network for Action Anticipation Conditioned on Intention (Suleyman Ozdel et al., 2024)
...
### (39/56 | 80/235) 3DMambaComplete: Exploring Structured State Space Model for Point Cloud Completion (Yixuan Li et al., 2024)
...
### (40/56 | 81/235) Identification of Fine-grained Systematic Errors via Controlled Scene Generation (Valentyn Boreiko et al., 2024)
...
### (41/56 | 82/235) Multi-Label Continual Learning for the Medical Domain: A Novel Benchmark (Marina Ceccon et al., 2024)
...
### (42/56 | 83/235) UDiFF: Generating Conditional Unsigned Distance Fields with Optimal Wavelet Diffusion (Junsheng Zhou et al., 2024)
...
### (43/56 | 84/235) SplatPose & Detect: Pose-Agnostic 3D Anomaly Detection (Mathis Kruse et al., 2024)
...
### (44/56 | 85/235) Self-supervised Monocular Depth Estimation on Water Scenes via Specular Reflection Prior (Zhengyang Lu et al., 2024)
...
### (45/56 | 86/235) Enhanced Cooperative Perception for Autonomous Vehicles Using Imperfect Communication (Ahmad Sarlak et al., 2024)
...
### (46/56 | 87/235) MoCap-to-Visual Domain Adaptation for Efficient Human Mesh Estimation from 2D Keypoints (Bedirhan Uguz et al., 2024)
...
### (47/56 | 88/235) An Evidential-enhanced Tri-Branch Consistency Learning Method for Semi-supervised Medical Image Segmentation (Zhenxi Zhang et al., 2024)
...
### (48/56 | 89/235) Accurate Tennis Court Line Detection on Amateur Recorded Matches (Sameer Agrawal et al., 2024)
...
### (49/56 | 90/235) YOLO based Ocean Eddy Localization with AWS SageMaker (Seraj Al Mahmud Mostafa et al., 2024)
...
### (50/56 | 91/235) An Animation-based Augmentation Approach for Action Recognition from Discontinuous Video (Xingyu Song et al., 2024)
...
### (51/56 | 92/235) Convolution-based Probability Gradient Loss for Semantic Segmentation (Guohang Shan et al., 2024)
...
### (52/56 | 93/235) Perception-Oriented Video Frame Interpolation via Asymmetric Blending (Guangyang Wu et al., 2024)
...
### (53/56 | 94/235) Efficient Denoising using Score Embedding in Score-based Diffusion Models (Andrew S. Na et al., 2024)
...
### (54/56 | 95/235) PEAVS: Perceptual Evaluation of Audio-Visual Synchrony Grounded in Viewers' Opinion Scores (Lucas Goncalves et al., 2024)
...
### (55/56 | 96/235) Unfolding ADMM for Enhanced Subspace Clustering of Hyperspectral Images (Xianlu Li et al., 2024)
...
### (56/56 | 97/235) Sparse Global Matching for Video Frame Interpolation with Large Motion (Chunxu Liu et al., 2024)
...
### (1/12 | 98/235) Vision-Language Model-based Physical Reasoning for Robot Liquid Perception (Wenqiang Lai et al., 2024)
...
### (2/12 | 99/235) Beyond Gait: Learning Knee Angle for Seamless Prosthesis Control in Multiple Scenarios (Pengwei Wang et al., 2024)
...
### (3/12 | 100/235) Using Neural Networks to Model Hysteretic Kinematics in Tendon-Actuated Continuum Robots (Yuan Wang et al., 2024)
...
### (4/12 | 101/235) Enhancing Safety in Mixed Traffic: Learning-Based Modeling and Efficient Control of Autonomous and Human-Driven Vehicles (Jie Wang et al., 2024)
...
### (5/12 | 102/235) CBFKIT: A Control Barrier Function Toolbox for Robotics Applications (Mitchell Black et al., 2024)
...
### (6/12 | 103/235) Wild Visual Navigation: Fast Traversability Learning via Pre-Trained Models and Online Self-Supervision (Matías Mattamala et al., 2024)
...
### (7/12 | 104/235) LaPlaSS: Latent Space Planning for Stochastic Systems (Marlyse Reeves et al., 2024)
...
### (8/12 | 105/235) A Data Efficient Framework for Learning Local Heuristics (Rishi Veerapaneni et al., 2024)
...
### (9/12 | 106/235) Fast and Accurate Relative Motion Tracking for Two Industrial Robots (Honglu He et al., 2024)
...
### (10/12 | 107/235) Incorporating Explanations into Human-Machine Interfaces for Trust and Situation Awareness in Autonomous Vehicles (Shahin Atakishiyev et al., 2024)
...
### (11/12 | 108/235) Reward Learning from Suboptimal Demonstrations with Applications in Surgical Electrocautery (Zohre Karimi et al., 2024)
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.07185v2" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.07185v2.pdf" filename="2404.07185v2.pdf">Download PDF</button>
...
### (12/12 | 109/235) Deep Reinforcement Learning for Mobile Robot Path Planning (Hao Liu et al., 2024)
...
### (1/35 | 110/235) Forecasting the Future with Future Technologies: Advancements in Large Meteorological Models (Hailong Shu et al., 2024)
...
### (2/35 | 111/235) How to Craft Backdoors with Unlabeled Data Alone? (Yifei Wang et al., 2024)
...
### (3/35 | 112/235) Advancing Real-time Pandemic Forecasting Using Large Language Models: A COVID-19 Case Study (Hongru Du et al., 2024)
...
### (4/35 | 113/235) LaTiM: Longitudinal representation learning in continuous-time models to predict disease progression (Rachid Zeghlache et al., 2024)
...
### (5/35 | 114/235) Toward a Better Understanding of Fourier Neural Operators: Analysis and Improvement from a Spectral Perspective (Shaoxiang Qin et al., 2024)
...
### (6/35 | 115/235) Differentiable Search for Finding Optimal Quantization Strategy (Lianqiang Li et al., 2024)
...
### (7/35 | 116/235) Sample-Efficient Human Evaluation of Large Language Models via Maximum Discrepancy Competition (Kehua Feng et al., 2024)
...
### (8/35 | 117/235) Global Contrastive Training for Multimodal Electronic Health Records with Language Supervision (Yingbo Ma et al., 2024)
...
### (9/35 | 118/235) VN-EGNN: E(3)-Equivariant Graph Neural Networks with Virtual Nodes Enhance Protein Binding Site Identification (Florian Sestak et al., 2024)
...
### (10/35 | 119/235) FiP: a Fixed-Point Approach for Causal Generative Modeling (Meyer Scetbon et al., 2024)
...
### (11/35 | 120/235) GANsemble for Small and Imbalanced Data Sets: A Baseline for Synthetic Microplastics Data (Daniel Platnick et al., 2024)
...
### (12/35 | 121/235) Sequential Decision Making with Expert Demonstrations under Unobserved Heterogeneity (Vahid Balazadeh et al., 2024)
...
### (13/35 | 122/235) A Gauss-Newton Approach for Min-Max Optimization in Generative Adversarial Networks (Neel Mishra et al., 2024)
...
### (14/35 | 123/235) What needs to go right for an induction head? A mechanistic study of in-context learning circuits and their formation (Aaditya K. Singh et al., 2024)
...
### (15/35 | 124/235) Towards Learning Stochastic Population Models by Gradient Descent (Justin N. Kreikemeyer et al., 2024)
...
### (16/35 | 125/235) Logit Calibration and Feature Contrast for Robust Federated Learning on Non-IID Data (Yu Qiao et al., 2024)
...
### (17/35 | 126/235) Toward Cross-Layer Energy Optimizations in Machine Learning Systems (Jae-Won Chung et al., 2024)
...
### (18/35 | 127/235) ONNXPruner: ONNX-Based General Model Pruning Adapter (Dongdong Ren et al., 2024)
...
### (19/35 | 128/235) Rethinking Out-of-Distribution Detection for Reinforcement Learning: Advancing Methods for Evaluation and Detection (Linas Nasvytis et al., 2024)
...
### (20/35 | 129/235) Transfer Learning via Latent Dependency Factor for Estimating PM 2.5 (Shrey Gupta et al., 2024)
...
### (21/35 | 130/235) Scaling Laws for Data Filtering -- Data Curation cannot be Compute Agnostic (Sachin Goyal et al., 2024)
...
### (22/35 | 131/235) How Consistent are Clinicians? Evaluating the Predictability of Sepsis Disease Progression with Dynamics Models (Unnseo Park et al., 2024)
...
### (23/35 | 132/235) CrimeAlarm: Towards Intensive Intent Dynamics in Fine-grained Crime Prediction (Kaixi Hu et al., 2024)
...
### (24/35 | 133/235) Knowledge graphs for empirical concept retrieval (Lenka Tětková et al., 2024)
...
### (25/35 | 134/235) Deep Generative Sampling in the Dual Divergence Space: A Data-efficient & Interpretative Approach for Generative AI (Sahil Garg et al., 2024)
...
### (26/35 | 135/235) Addressing the Abstraction and Reasoning Corpus via Procedural Example Generation (Michael Hodel, 2024)
...
### (27/35 | 136/235) Error Mitigation for TDoA UWB Indoor Localization using Unsupervised Machine Learning (Phuong Bich Duong et al., 2024)
...
### (28/35 | 137/235) Minimizing Chebyshev Prototype Risk Magically Mitigates the Perils of Overfitting (Nathaniel Dean et al., 2024)
...
### (29/35 | 138/235) Toward industrial use of continual learning : new metrics proposal for class incremental learning (Konaté Mohamed Abbas et al., 2024)
...
### (30/35 | 139/235) Register Your Forests: Decision Tree Ensemble Optimization by Explicit CPU Register Allocation (Daniel Biebert et al., 2024)
...
### (31/35 | 140/235) Optimal Regret with Limited Adaptivity for Generalized Linear Contextual Bandits (Ayush Sawarni et al., 2024)
...
### (32/35 | 141/235) Private Wasserstein Distance with Random Noises (Wenqian Li et al., 2024)
...
### (33/35 | 142/235) Disguised Copyright Infringement of Latent Diffusion Models (Yiwei Lu et al., 2024)
...
### (34/35 | 143/235) A Strategy Transfer and Decision Support Approach for Epidemic Control in Experience Shortage Scenarios (X. Xiao et al., 2024)

{{<citation>}}

X. Xiao, P. Chen, X. Cao, K. Liu, L. Deng, D. Zhao, Z. Chen, Q. Deng, F. Yu, H. Zhang. (2024)  
**A Strategy Transfer and Decision Support Approach for Epidemic Control in Experience Shortage Scenarios**
<br/>
<button class="copy-to-clipboard" title="A Strategy Transfer and Decision Support Approach for Epidemic Control in Experience Shortage Scenarios" index=143>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<br/>
<button class="copy-to-clipboard" title="SleepPPG-Net2: Deep learning generalization for sleep staging from photoplethysmography" index=144>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/4 | 145/235) Analyzing the Performance of Large Language Models on Code Summarization (Rajarshi Haldar et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Analyzing the Performance of Large Language Models on Code Summarization" index=145>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/4 | 146/235) Beyond Random Inputs: A Novel ML-Based Hardware Fuzzing (Mohamadreza Rostami et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Beyond Random Inputs: A Novel ML-Based Hardware Fuzzing" index=146>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/4 | 147/235) Research Artifacts in Software Engineering Publications: Status and Trends (Mugeng Liu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Research Artifacts in Software Engineering Publications: Status and Trends" index=147>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/4 | 148/235) Worst-Case Convergence Time of ML Algorithms via Extreme Value Theory (Saeid Tizpaz-Niari et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Worst-Case Convergence Time of ML Algorithms via Extreme Value Theory" index=148>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/6 | 149/235) NFARec: A Negative Feedback-Aware Recommender Model (Xinfeng Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="NFARec: A Negative Feedback-Aware Recommender Model" index=149>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/6 | 150/235) CaDRec: Contextualized and Debiased Recommender Model (Xinfeng Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="CaDRec: Contextualized and Debiased Recommender Model" index=150>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/6 | 151/235) Quati: A Brazilian Portuguese Information Retrieval Dataset from Native Speakers (Mirelle Bueno et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Quati: A Brazilian Portuguese Information Retrieval Dataset from Native Speakers" index=151>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/6 | 152/235) Apollonion: Profile-centric Dialog Agent (Shangyu Chen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Apollonion: Profile-centric Dialog Agent" index=152>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/6 | 153/235) TransTARec: Time-Adaptive Translating Embedding Model for Next POI Recommendation (Yiping Sun, 2024)
...
<br/>
<button class="copy-to-clipboard" title="TransTARec: Time-Adaptive Translating Embedding Model for Next POI Recommendation" index=153>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (6/6 | 154/235) Enhancing Adaptive Video Streaming through Fuzzy Logic-Based Content Recommendation Systems: A Comprehensive Review and Future Directions (Koffka Khan, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Enhancing Adaptive Video Streaming through Fuzzy Logic-Based Content Recommendation Systems: A Comprehensive Review and Future Directions" index=154>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/2 | 155/235) BAMBOO: a predictive and transferable machine learning force field framework for liquid electrolyte development (Sheng Gong et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="BAMBOO: a predictive and transferable machine learning force field framework for liquid electrolyte development" index=155>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/2 | 156/235) Building Workflows for Interactive Human in the Loop Automated Experiment (hAE) in STEM-EELS (Utkarsh Pratiush et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Building Workflows for Interactive Human in the Loop Automated Experiment (hAE) in STEM-EELS" index=156>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/4 | 157/235) Frontier AI Ethics: Anticipating and Evaluating the Societal Impacts of Generative Agents (Seth Lazar, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Frontier AI Ethics: Anticipating and Evaluating the Societal Impacts of Generative Agents" index=157>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/4 | 158/235) Accuracy of a Large Language Model in Distinguishing Anti- And Pro-vaccination Messages on Social Media: The Case of Human Papillomavirus Vaccination (Soojong Kim et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Accuracy of a Large Language Model in Distinguishing Anti- And Pro-vaccination Messages on Social Media: The Case of Human Papillomavirus Vaccination" index=158>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/4 | 159/235) Leveraging open-source models for legal language modeling and analysis: a case study on the Indian constitution (Vikhyath Gupta et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Leveraging open-source models for legal language modeling and analysis: a case study on the Indian constitution" index=159>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/4 | 160/235) Racial/Ethnic Categories in AI and Algorithmic Fairness: Why They Matter and What They Represent (Jennifer Mickel, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Racial/Ethnic Categories in AI and Algorithmic Fairness: Why They Matter and What They Represent" index=160>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/5 | 161/235) Towards Efficient and Real-Time Piano Transcription Using Neural Autoregressive Models (Taegyun Kwon et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Towards Efficient and Real-Time Piano Transcription Using Neural Autoregressive Models" index=161>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/5 | 162/235) Conformer-1: Robust ASR via Large-Scale Semisupervised Bootstrapping (Kevin Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Conformer-1: Robust ASR via Large-Scale Semisupervised Bootstrapping" index=162>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/5 | 163/235) CoVoMix: Advancing Zero-Shot Speech Generation for Human-like Multi-talker Conversations (Leying Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="CoVoMix: Advancing Zero-Shot Speech Generation for Human-like Multi-talker Conversations" index=163>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/5 | 164/235) Efficient Sound Field Reconstruction with Conditional Invertible Neural Networks (Xenofon Karakonstantis et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Efficient Sound Field Reconstruction with Conditional Invertible Neural Networks" index=164>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/5 | 165/235) What is Learnt by the LEArnable Front-end (LEAF)? Adapting Per-Channel Energy Normalisation (PCEN) to Noisy Conditions (Hanyu Meng et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="What is Learnt by the LEArnable Front-end (LEAF)? Adapting Per-Channel Energy Normalisation (PCEN) to Noisy Conditions" index=165>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/5 | 166/235) Zero-shot Logical Query Reasoning on any Knowledge Graph (Mikhail Galkin et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Zero-shot Logical Query Reasoning on any Knowledge Graph" index=166>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/5 | 167/235) Towards a Game-theoretic Understanding of Explanation-based Membership Inference Attacks (Kavita Kumari et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Towards a Game-theoretic Understanding of Explanation-based Membership Inference Attacks" index=167>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/5 | 168/235) Learn from Failure: Fine-Tuning LLMs with Trial-and-Error Data for Intuitionistic Propositional Logic Proving (Chenyang An et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Learn from Failure: Fine-Tuning LLMs with Trial-and-Error Data for Intuitionistic Propositional Logic Proving" index=168>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/5 | 169/235) A Survey on the Integration of Generative AI for Critical Thinking in Mobile Networks (Athanasios Karapantelakis et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Survey on the Integration of Generative AI for Critical Thinking in Mobile Networks" index=169>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/5 | 170/235) Causal Unit Selection using Tractable Arithmetic Circuits (Haiying Huang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Causal Unit Selection using Tractable Arithmetic Circuits" index=170>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 171/235) Fast System Technology Co-Optimization Framework for Emerging Technology Based on Graph Neural Networks (Tianliang Ma et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Fast System Technology Co-Optimization Framework for Emerging Technology Based on Graph Neural Networks" index=171>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/9 | 172/235) BISCUIT: Scaffolding LLM-Generated Code with Ephemeral UIs in Computational Notebooks (Ruijia Cheng et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="BISCUIT: Scaffolding LLM-Generated Code with Ephemeral UIs in Computational Notebooks" index=172>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/9 | 173/235) WordDecipher: Enhancing Digital Workspace Communication with Explainable AI for Non-native English Speakers (Yuexi Chen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="WordDecipher: Enhancing Digital Workspace Communication with Explainable AI for Non-native English Speakers" index=173>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/9 | 174/235) 'We Need Structured Output': Towards User-centered Constraints on Large Language Model Output (Michael Xieyang Liu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="'We Need Structured Output': Towards User-centered Constraints on Large Language Model Output" index=174>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/9 | 175/235) Mixed Reality Heritage Performance As a Decolonising Tool for Heritage Sites (Mariza Dima et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Mixed Reality Heritage Performance As a Decolonising Tool for Heritage Sites" index=175>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/9 | 176/235) Evaluating Navigation and Comparison Performance of Computational Notebooks on Desktop and in Virtual Reality (Sungwon In et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Evaluating Navigation and Comparison Performance of Computational Notebooks on Desktop and in Virtual Reality" index=176>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (6/9 | 177/235) Exploring Physiological Responses in Virtual Reality-based Interventions for Autism Spectrum Disorder: A Data-Driven Investigation (Gianpaolo Alvari et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Exploring Physiological Responses in Virtual Reality-based Interventions for Autism Spectrum Disorder: A Data-Driven Investigation" index=177>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (7/9 | 178/235) SARA: Smart AI Reading Assistant for Reading Comprehension (Enkeleda Thaqi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="SARA: Smart AI Reading Assistant for Reading Comprehension" index=178>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (8/9 | 179/235) Untangling Critical Interaction with AI in Students Written Assessment (Antonette Shibani et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Untangling Critical Interaction with AI in Students Written Assessment" index=179>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (9/9 | 180/235) Incremental XAI: Memorable Understanding of AI with Incremental Explanations (Jessica Y. Bo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Incremental XAI: Memorable Understanding of AI with Incremental Explanations" index=180>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/5 | 181/235) Differentially Private GANs for Generating Synthetic Indoor Location Data (Vahideh Moghtadaiee et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Differentially Private GANs for Generating Synthetic Indoor Location Data" index=181>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/5 | 182/235) Poisoning Prevention in Federated Learning and Differential Privacy via Stateful Proofs of Execution (Norrathep Rattanavipanon et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Poisoning Prevention in Federated Learning and Differential Privacy via Stateful Proofs of Execution" index=182>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/5 | 183/235) Indoor Location Fingerprinting Privacy: A Comprehensive Survey (Amir Fathalizadeh et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Indoor Location Fingerprinting Privacy: A Comprehensive Survey" index=183>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/5 | 184/235) Atlas-X Equity Financing: Unlocking New Methods to Securely Obfuscate Axe Inventory Data Based on Differential Privacy (Antigoni Polychroniadou et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Atlas-X Equity Financing: Unlocking New Methods to Securely Obfuscate Axe Inventory Data Based on Differential Privacy" index=184>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/5 | 185/235) Security Assessment of the LG Cryptosystem (Étienne Burle et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Security Assessment of the LG Cryptosystem" index=185>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/7 | 186/235) Dual Ensemble Kalman Filter for Stochastic Optimal Control (Anant A. Joshi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Dual Ensemble Kalman Filter for Stochastic Optimal Control" index=186>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/7 | 187/235) Lyapunov-Based Deep Residual Neural Network (ResNet) Adaptive Control (Omkar Sudhir Patil et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Lyapunov-Based Deep Residual Neural Network (ResNet) Adaptive Control" index=187>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/7 | 188/235) Structured Reinforcement Learning for Media Streaming at the Wireless Edge (Archana Bura et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Structured Reinforcement Learning for Media Streaming at the Wireless Edge" index=188>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/7 | 189/235) Synchronization Conditions for Nonlinear Oscillator Networks (Sanjeev Kumar Pandey et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Synchronization Conditions for Nonlinear Oscillator Networks" index=189>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/7 | 190/235) Analytical Formula for Calculations of Armour Losses in Three-Core Power Cables (Marius Hatlo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Analytical Formula for Calculations of Armour Losses in Three-Core Power Cables" index=190>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (6/7 | 191/235) Multi-Agent Soft Actor-Critic with Global Loss for Autonomous Mobility-on-Demand Fleet Control (Zeno Woywood et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Multi-Agent Soft Actor-Critic with Global Loss for Autonomous Mobility-on-Demand Fleet Control" index=191>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (7/7 | 192/235) Iterative distributed moving horizon estimation of linear systems with penalties on both system disturbances and noise (Xiaojie Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Iterative distributed moving horizon estimation of linear systems with penalties on both system disturbances and noise" index=192>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/2 | 193/235) VoiceShop: A Unified Speech-to-Speech Framework for Identity-Preserving Zero-Shot Voice Editing (Philip Anastassiou et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="VoiceShop: A Unified Speech-to-Speech Framework for Identity-Preserving Zero-Shot Voice Editing" index=193>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/2 | 194/235) Learning Multidimensional Disentangled Representations of Instrumental Sounds for Musical Similarity Assessment (Yuka Hashizume et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Learning Multidimensional Disentangled Representations of Instrumental Sounds for Musical Similarity Assessment" index=194>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 195/235) GCV-Turbo: End-to-end Acceleration of GNN-based Computer Vision Tasks on FPGA (Bingyi Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="GCV-Turbo: End-to-end Acceleration of GNN-based Computer Vision Tasks on FPGA" index=195>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/3 | 196/235) Improving Multi-Center Generalizability of GAN-Based Fat Suppression using Federated Learning (Pranav Kulkarni et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Improving Multi-Center Generalizability of GAN-Based Fat Suppression using Federated Learning" index=196>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/3 | 197/235) Accelerating Cardiac MRI Reconstruction with CMRatt: An Attention-Driven Approach (Anam Hashmi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Accelerating Cardiac MRI Reconstruction with CMRatt: An Attention-Driven Approach" index=197>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/3 | 198/235) Rethinking Perceptual Metrics for Medical Image Translation (Nicholas Konz et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Rethinking Perceptual Metrics for Medical Image Translation" index=198>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/3 | 199/235) Iterative solvers in adaptive FEM (Philipp Bringmann et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Iterative solvers in adaptive FEM" index=199>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/3 | 200/235) Solving Parametric PDEs with Radial Basis Functions and Deep Neural Networks (Guanhang Lei et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Solving Parametric PDEs with Radial Basis Functions and Deep Neural Networks" index=200>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/3 | 201/235) A conservative Eulerian finite element method for transport and diffusion in moving domains (Maxim Olshanskii et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A conservative Eulerian finite element method for transport and diffusion in moving domains" index=201>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/4 | 202/235) PACP: Priority-Aware Collaborative Perception for Connected and Autonomous Vehicles (Zhengru Fang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="PACP: Priority-Aware Collaborative Perception for Connected and Autonomous Vehicles" index=202>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/4 | 203/235) EMF Mitigation via 5G and 6G MAC Scheduling (Silvio Mandelli et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="EMF Mitigation via 5G and 6G MAC Scheduling" index=203>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/4 | 204/235) Agent-driven Generative Semantic Communication for Remote Surveillance (Wanting Yang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Agent-driven Generative Semantic Communication for Remote Surveillance" index=204>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/4 | 205/235) Responsible Federated Learning in Smart Transportation: Outlooks and Challenges (Xiaowen Huang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Responsible Federated Learning in Smart Transportation: Outlooks and Challenges" index=205>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/8 | 206/235) Joint Active And Passive IRS Aided Wireless Communication: Elements Allocation and Achievable Rate (Chaoying Huang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Joint Active And Passive IRS Aided Wireless Communication: Elements Allocation and Achievable Rate" index=206>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/8 | 207/235) Digital Over-the-Air Computation: Achieving High Reliability via Bit-Slicing (Jiawei Liu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Digital Over-the-Air Computation: Achieving High Reliability via Bit-Slicing" index=207>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/8 | 208/235) On the Performance of IRS-Assisted SSK and RPM over Rician Fading Channels (Harsh Raj et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="On the Performance of IRS-Assisted SSK and RPM over Rician Fading Channels" index=208>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/8 | 209/235) Near-Optimal Channel Estimation for Dense Array Systems (Mingyao Cui et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Near-Optimal Channel Estimation for Dense Array Systems" index=209>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/8 | 210/235) Perfectly Secure Key Agreement Over a Full Duplex Wireless Channel (Gerhard Wunder et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Perfectly Secure Key Agreement Over a Full Duplex Wireless Channel" index=210>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (6/8 | 211/235) New Partial Orders of Polar Codes for BMSC (Liuquan Yao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="New Partial Orders of Polar Codes for BMSC" index=211>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (7/8 | 212/235) Fractional decoding of algebraic geometry codes over extension fields (Eduardo Camps-Moreno et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Fractional decoding of algebraic geometry codes over extension fields" index=212>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (8/8 | 213/235) Characterising directed and undirected metrics of high-order interdependence (Fernando E. Rosas et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Characterising directed and undirected metrics of high-order interdependence" index=213>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 214/235) FairEM360: A Suite for Responsible Entity Matching (Nima Shahbazi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="FairEM360: A Suite for Responsible Entity Matching" index=214>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/5 | 215/235) A Modified Depolarization Approach for Efficient Quantum Machine Learning (Bikram Khanal et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Modified Depolarization Approach for Efficient Quantum Machine Learning" index=215>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/5 | 216/235) Quantum algorithms to simulate quadratic classical Hamiltonians and optimal control (Hari Krovi, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Quantum algorithms to simulate quadratic classical Hamiltonians and optimal control" index=216>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/5 | 217/235) Quantum Tunneling: From Theory to Error-Mitigated Quantum Simulation (Sorana Catrina et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Quantum Tunneling: From Theory to Error-Mitigated Quantum Simulation" index=217>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/5 | 218/235) Statistical evaluation of 571 GaAs quantum point contact transistors showing the 0.7 anomaly in quantized conductance using millikelvin cryogenic on-chip multiplexing (Pengcheng Ma et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Statistical evaluation of 571 GaAs quantum point contact transistors showing the 0.7 anomaly in quantized conductance using millikelvin cryogenic on-chip multiplexing" index=218>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/5 | 219/235) Certifying almost all quantum states with few single-qubit measurements (Hsin-Yuan Huang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Certifying almost all quantum states with few single-qubit measurements" index=219>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 220/235) sCWatter: Open source coupled wave scattering simulation for spectroscopy and microscopy (Ruijiao Sun et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="sCWatter: Open source coupled wave scattering simulation for spectroscopy and microscopy" index=220>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/3 | 221/235) An asymptotically optimal algorithm for generating bin cardinalities (Luc Devroye et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="An asymptotically optimal algorithm for generating bin cardinalities" index=221>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/3 | 222/235) Language Generation in the Limit (Jon Kleinberg et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Language Generation in the Limit" index=222>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/3 | 223/235) Fully Dynamic Correlation Clustering: Breaking 3-Approximation (Soheil Behnezhad et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Fully Dynamic Correlation Clustering: Breaking 3-Approximation" index=223>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 224/235) Predicting Mergers and Acquisitions: Temporal Dynamic Industry Networks (Dayu Yang, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Predicting Mergers and Acquisitions: Temporal Dynamic Industry Networks" index=224>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 225/235) Temperature Prediction for Stored Grain: A Multi-model Fusion Strategy Based on Machine Learning (Donghao Chen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Temperature Prediction for Stored Grain: A Multi-model Fusion Strategy Based on Machine Learning" index=225>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 226/235) Data-driven quasiconformal morphodynamic flows (Salem Mosleh et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Data-driven quasiconformal morphodynamic flows" index=226>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 227/235) POD Suboptimal Control of Evolution Problems: Theory and Applications (Stefan Banholzer et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="POD Suboptimal Control of Evolution Problems: Theory and Applications" index=227>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 228/235) Impact of Extensions on Browser Performance: An Empirical Study on Google Chrome (Bihui Jin et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Impact of Extensions on Browser Performance: An Empirical Study on Google Chrome" index=228>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 229/235) Algorithms and Analysis for Optimizing Robust Objectives in Fair Machine Learning (Cyrus Cousins, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Algorithms and Analysis for Optimizing Robust Objectives in Fair Machine Learning" index=229>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/3 | 230/235) Neural Optimizer Equation, Decay Function, and Learning Rate Schedule Joint Evolution (Brandon Morgan et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Neural Optimizer Equation, Decay Function, and Learning Rate Schedule Joint Evolution" index=230>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/3 | 231/235) Semantically-correlated memories in a dense associative model (Thomas F Burns, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Semantically-correlated memories in a dense associative model" index=231>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/3 | 232/235) A Tight $O(4^k/p_c)$ Runtime Bound for a ($μ$+1) GA on Jump$_k$ for Realistic Crossover Probabilities (Andre Opris et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Tight $O(4^k/p_c)$ Runtime Bound for a ($μ$+1) GA on Jump$_k$ for Realistic Crossover Probabilities" index=232>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 233/235) Probabilistic estimates of the diameters of the Rubik's Cube groups (So Hirata, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Probabilistic estimates of the diameters of the Rubik's Cube groups" index=233>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 3  
Keywords: Graph  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.07337v2" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.07337v2.pdf" filename="2404.07337v2.pdf">Download PDF</button>
...
### (1/1 | 234/235) On the existence of $δ$-temporal cliques in random simple temporal graphs (George B. Mertzios et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="On the existence of $δ$-temporal cliques in random simple temporal graphs" index=234>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 235/235) Linked open data per la valorizzazione di collezioni culturali: il dataset mythLOD (Valentina Pasqual et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Linked open data per la valorizzazione di collezioni culturali: il dataset mythLOD" index=235>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
