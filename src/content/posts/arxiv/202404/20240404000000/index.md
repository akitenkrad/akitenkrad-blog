...
### (34/69 | 34/327) Towards Better Understanding of Cybercrime: The Role of Fine-Tuned LLMs in Translation (Veronica Valeros et al., 2024)
...
### (35/69 | 35/327) IndoCulture: Exploring Geographically-Influenced Cultural Commonsense Reasoning Across Eleven Indonesian Provinces (Fajri Koto et al., 2024)
...
### (36/69 | 36/327) Generative AI-Based Text Generation Methods Using Pre-Trained GPT-2 Model (Rohit Pandey et al., 2024)
...
### (37/69 | 37/327) Octopus v2: On-device language model for super agent (Wei Chen et al., 2024)
...
### (38/69 | 38/327) Evaluating Large Language Models Using Contrast Sets: An Experimental Approach (Manish Sanwal, 2024)
...
### (39/69 | 39/327) GINopic: Topic Modeling with Graph Isomorphism Network (Suman Adhya et al., 2024)
...
### (40/69 | 40/327) Africa-Centric Self-Supervised Pre-Training for Multilingual Speech Representation in a Sub-Saharan Context (Antoine Caubrière et al., 2024)
...
### (41/69 | 41/327) Towards Better Generalization in Open-Domain Question Answering by Mitigating Context Memorization (Zixuan Zhang et al., 2024)
...
### (42/69 | 42/327) Rematch: Robust and Efficient Matching of Local Knowledge Graphs to Improve Structural and Semantic Similarity (Zoher Kachwala et al., 2024)
...
### (43/69 | 43/327) Multi-BERT: Leveraging Adapters and Prompt Tuning for Low-Resource Multi-Domain Adaptation (Parham Abed Azad et al., 2024)
...
### (44/69 | 44/327) $\texttt{LM}^\texttt{2}$: A Simple Society of Language Models Solves Complex Reasoning (Gurusha Juneja et al., 2024)
...
### (45/69 | 45/327) FLawN-T5: An Empirical Examination of Effective Instruction-Tuning Data Mixtures for Legal Reasoning (Joel Niklaus et al., 2024)
...
### (46/69 | 46/327) Breaking the Silence Detecting and Mitigating Gendered Abuse in Hindi, Tamil, and Indian English Online Spaces (Advaitha Vetagiri et al., 2024)
...
### (47/69 | 47/327) Dissecting Paraphrases: The Impact of Prompt Syntax and supplementary Information on Knowledge Retrieval from Pretrained Language Models (Stephan Linzbach et al., 2024)
...
### (48/69 | 48/327) Beyond Accuracy: Evaluating the Reasoning Behavior of Large Language Models -- A Survey (Philipp Mondorf et al., 2024)
...
### (49/69 | 49/327) M2SA: Multimodal and Multilingual Model for Sentiment Analysis of Tweets (Gaurish Thakkar et al., 2024)
...
### (50/69 | 50/327) A Computational Analysis of Lyric Similarity Perception (Haven Kim et al., 2024)
...
### (51/69 | 51/327) Collapse of Self-trained Language Models (David Herel et al., 2024)
...
### (52/69 | 52/327) Extracting Norms from Contracts Via ChatGPT: Opportunities and Challenges (Amanul Haque et al., 2024)
...
### (53/69 | 53/327) Kallaama: A Transcribed Speech Dataset about Agriculture in the Three Most Widely Spoken Languages in Senegal (Elodie Gauthier et al., 2024)
...
### (54/69 | 54/327) Polarity Calibration for Opinion Summarization (Yuanyuan Lei et al., 2024)
...
### (55/69 | 55/327) Release of Pre-Trained Models for the Japanese Language (Kei Sawada et al., 2024)
...
### (56/69 | 56/327) NLP Systems That Can't Tell Use from Mention Censor Counterspeech, but Teaching the Distinction Helps (Kristina Gligoric et al., 2024)
...
### (57/69 | 57/327) Laying Anchors: Semantically Priming Numerals in Language Modeling (Mandar Sharma et al., 2024)
...
### (58/69 | 58/327) Sentence-level Media Bias Analysis with Event Relation Graph (Yuanyuan Lei et al., 2024)
...
### (59/69 | 59/327) Entity Disambiguation via Fusion Entity Decoding (Junxiong Wang et al., 2024)
...
### (60/69 | 60/327) Using Interpretation Methods for Model Enhancement (Zhuo Chen et al., 2024)
...
### (61/69 | 61/327) BERTopic-Driven Stock Market Predictions: Unraveling Sentiment Insights (Enmin Zhu et al., 2024)
...
### (62/69 | 62/327) Preuve de concept d'un bot vocal dialoguant en wolof (Elodie Gauthier et al., 2024)
...
### (63/69 | 63/327) When Abel Kills Cain: What Machine Translation Cannot Capture (Aurélien Bénel et al., 2024)

{{<citation>}}

Aurélien Bénel, Joris Falip, Philippe Lacour. (2024)  
**When Abel Kills Cain: What Machine Translation Cannot Capture**
<br/>
<button class="copy-to-clipboard" title="When Abel Kills Cain: What Machine Translation Cannot Capture" index=63>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<br/>
<button class="copy-to-clipboard" title="Activation Steering for Robust Type Prediction in CodeLLMs" index=64>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (65/69 | 65/327) Self-StrAE at SemEval-2024 Task 1: Making Self-Structuring AutoEncoders Learn More With Less (Mattia Opper et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Self-StrAE at SemEval-2024 Task 1: Making Self-Structuring AutoEncoders Learn More With Less" index=65>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (66/69 | 66/327) Poro 34B and the Blessing of Multilinguality (Risto Luukkonen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Poro 34B and the Blessing of Multilinguality" index=66>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (67/69 | 67/327) Generative AI for Immersive Communication: The Next Frontier in Internet-of-Senses Through 6G (Nassim Sehad et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Generative AI for Immersive Communication: The Next Frontier in Internet-of-Senses Through 6G" index=67>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (68/69 | 68/327) Event Detection from Social Media for Epidemic Prediction (Tanmay Parekh et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Event Detection from Social Media for Epidemic Prediction" index=68>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (69/69 | 69/327) LastResort at SemEval-2024 Task 3: Exploring Multimodal Emotion Cause Pair Extraction as Sequence Labelling Task (Suyash Vardhan Mathur et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="LastResort at SemEval-2024 Task 3: Exploring Multimodal Emotion Cause Pair Extraction as Sequence Labelling Task" index=69>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/4 | 70/327) Advancing LLM Reasoning Generalists with Preference Trees (Lifan Yuan et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Advancing LLM Reasoning Generalists with Preference Trees" index=70>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/4 | 71/327) A Survey on Large Language Model-Based Game Agents (Sihao Hu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Survey on Large Language Model-Based Game Agents" index=71>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/4 | 72/327) Towards Generalizable and Faithful Logic Reasoning over Natural Language via Resolution Refutation (Zhouhao Sun et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Towards Generalizable and Faithful Logic Reasoning over Natural Language via Resolution Refutation" index=72>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/4 | 73/327) Imitation Game: A Model-based and Imitation Learning Deep Reinforcement Learning Hybrid (Eric MSP Veith et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Imitation Game: A Model-based and Imitation Learning Deep Reinforcement Learning Hybrid" index=73>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/10 | 74/327) Jailbreaking Leading Safety-Aligned LLMs with Simple Adaptive Attacks (Maksym Andriushchenko et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Jailbreaking Leading Safety-Aligned LLMs with Simple Adaptive Attacks" index=74>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/10 | 75/327) Great, Now Write an Article About That: The Crescendo Multi-Turn LLM Jailbreak Attack (Mark Russinovich et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Great, Now Write an Article About That: The Crescendo Multi-Turn LLM Jailbreak Attack" index=75>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/10 | 76/327) Jailbreaking Prompt Attack: A Controllable Adversarial Attack against Diffusion Models (Jiachen Ma et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Jailbreaking Prompt Attack: A Controllable Adversarial Attack against Diffusion Models" index=76>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/10 | 77/327) Topic-based Watermarks for LLM-Generated Text (Alexander Nemecek et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Topic-based Watermarks for LLM-Generated Text" index=77>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/10 | 78/327) Digital Forgetting in Large Language Models: A Survey of Unlearning Methods (Alberto Blanco-Justicia et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Digital Forgetting in Large Language Models: A Survey of Unlearning Methods" index=78>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (6/10 | 79/327) AAA: an Adaptive Mechanism for Locally Differential Private Mean Estimation (Fei Wei et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="AAA: an Adaptive Mechanism for Locally Differential Private Mean Estimation" index=79>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (7/10 | 80/327) Software-Defined Cryptography: A Design Feature of Cryptographic Agility (Jihoon Cho et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Software-Defined Cryptography: A Design Feature of Cryptographic Agility" index=80>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (8/10 | 81/327) Haina Storage: A Decentralized Secure Storage Framework Based on Improved Blockchain Structure (Zijian Zhou et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Haina Storage: A Decentralized Secure Storage Framework Based on Improved Blockchain Structure" index=81>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (9/10 | 82/327) What Blocks My Blockchain's Throughput? Developing a Generalizable Approach for Identifying Bottlenecks in Permissioned Blockchains (Orestis Papageorgiou et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="What Blocks My Blockchain's Throughput? Developing a Generalizable Approach for Identifying Bottlenecks in Permissioned Blockchains" index=82>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (10/10 | 83/327) Making Privacy-preserving Federated Graph Analytics with Strong Guarantees Practical (for Certain Queries) (Kunlong Liu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Making Privacy-preserving Federated Graph Analytics with Strong Guarantees Practical (for Certain Queries)" index=83>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/19 | 84/327) Bridging Language, Vision and Action: Multimodal VAEs in Robotic Manipulation Tasks (Gabriela Sejnova et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Bridging Language, Vision and Action: Multimodal VAEs in Robotic Manipulation Tasks" index=84>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/19 | 85/327) Large Language Models for Orchestrating Bimanual Robots (Kun Chu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Large Language Models for Orchestrating Bimanual Robots" index=85>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/19 | 86/327) Active Exploration in Bayesian Model-based Reinforcement Learning for Robot Manipulation (Carlos Plou et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Active Exploration in Bayesian Model-based Reinforcement Learning for Robot Manipulation" index=86>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/19 | 87/327) Task-priority Intermediated Hierarchical Distributed Policies: Reinforcement Learning of Adaptive Multi-robot Cooperative Transport (Yusei Naito et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Task-priority Intermediated Hierarchical Distributed Policies: Reinforcement Learning of Adaptive Multi-robot Cooperative Transport" index=87>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/19 | 88/327) ZeroCAP: Zero-Shot Multi-Robot Context Aware Pattern Formation via Large Language Models (Vishnunandan L. N. Venkatesh et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="ZeroCAP: Zero-Shot Multi-Robot Context Aware Pattern Formation via Large Language Models" index=88>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (6/19 | 89/327) Constrained Robotic Navigation on Preferred Terrains Using LLMs and Speech Instruction: Exploiting the Power of Adverbs (Faraz Lotfi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Constrained Robotic Navigation on Preferred Terrains Using LLMs and Speech Instruction: Exploiting the Power of Adverbs" index=89>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (7/19 | 90/327) Continuous Sculpting: Persistent Swarm Shape Formation Adaptable to Local Environmental Changes (Andrew G. Curtis et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Continuous Sculpting: Persistent Swarm Shape Formation Adaptable to Local Environmental Changes" index=90>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (8/19 | 91/327) CARLOS: An Open, Modular, and Scalable Simulation Framework for the Development and Testing of Software for C-ITS (Christian Geller et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="CARLOS: An Open, Modular, and Scalable Simulation Framework for the Development and Testing of Software for C-ITS" index=91>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (9/19 | 92/327) Towards Scalable & Efficient Interaction-Aware Planning in Autonomous Vehicles using Knowledge Distillation (Piyush Gupta et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Towards Scalable & Efficient Interaction-Aware Planning in Autonomous Vehicles using Knowledge Distillation" index=92>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (10/19 | 93/327) Interaction-Aware Vehicle Motion Planning with Collision Avoidance Constraints in Highway Traffic (Dongryul Kim et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Interaction-Aware Vehicle Motion Planning with Collision Avoidance Constraints in Highway Traffic" index=93>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (11/19 | 94/327) Uncertainty-aware Active Learning of NeRF-based Object Models for Robot Manipulators using Visual and Re-orientation Actions (Saptarshi Dasgupta et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Uncertainty-aware Active Learning of NeRF-based Object Models for Robot Manipulators using Visual and Re-orientation Actions" index=94>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (12/19 | 95/327) Multi-Robot Collaborative Navigation with Formation Adaptation (Zihao Deng et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Multi-Robot Collaborative Navigation with Formation Adaptation" index=95>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (13/19 | 96/327) Learning from Demonstration Framework for Multi-Robot Systems Using Interaction Keypoints and Soft Actor-Critic Methods (Vishnunandan L. N. Venkatesh et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Learning from Demonstration Framework for Multi-Robot Systems Using Interaction Keypoints and Soft Actor-Critic Methods" index=96>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (14/19 | 97/327) Federated Multi-Agent Mapping for Planetary Exploration (Tiberiu-Ioan Szatmari et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Federated Multi-Agent Mapping for Planetary Exploration" index=97>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (15/19 | 98/327) APEX: Ambidextrous Dual-Arm Robotic Manipulation Using Collision-Free Generative Diffusion Models (Apan Dastider et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="APEX: Ambidextrous Dual-Arm Robotic Manipulation Using Collision-Free Generative Diffusion Models" index=98>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (16/19 | 99/327) Predicting the Intention to Interact with a Service Robot:the Role of Gaze Cues (Simone Arreghini et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Predicting the Intention to Interact with a Service Robot:the Role of Gaze Cues" index=99>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (17/19 | 100/327) A Tutorial on Gaussian Process Learning-based Model Predictive Control (Jie Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Tutorial on Gaussian Process Learning-based Model Predictive Control" index=100>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (18/19 | 101/327) PRISM-TopoMap: Online Topological Mapping with Place Recognition and Scan Matching (Kirill Muravyev et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="PRISM-TopoMap: Online Topological Mapping with Place Recognition and Scan Matching" index=101>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (19/19 | 102/327) Generalizing 6-DoF Grasp Detection via Domain Prior Knowledge (Haoxiang Ma et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Generalizing 6-DoF Grasp Detection via Domain Prior Knowledge" index=102>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/82 | 103/327) Samba: Semantic Segmentation of Remotely Sensed Images with State Space Model (Qinfeng Zhu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Samba: Semantic Segmentation of Remotely Sensed Images with State Space Model" index=103>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/82 | 104/327) Pre-trained Vision and Language Transformers Are Few-Shot Incremental Learners (Keon-Hee Park et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Pre-trained Vision and Language Transformers Are Few-Shot Incremental Learners" index=104>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/82 | 105/327) Minimize Quantization Output Error with Bias Compensation (Cheng Gong et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Minimize Quantization Output Error with Bias Compensation" index=105>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/82 | 106/327) Leveraging Digital Perceptual Technologies for Remote Perception and Analysis of Human Biomechanical Processes: A Contactless Approach for Workload and Joint Force Assessment (Jesudara Omidokun et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Leveraging Digital Perceptual Technologies for Remote Perception and Analysis of Human Biomechanical Processes: A Contactless Approach for Workload and Joint Force Assessment" index=106>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/82 | 107/327) ViTamin: Designing Scalable Vision Models in the Vision-Language Era (Jieneng Chen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="ViTamin: Designing Scalable Vision Models in the Vision-Language Era" index=107>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (6/82 | 108/327) Bi-LORA: A Vision-Language Approach for Synthetic Image Detection (Mamadou Keita et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Bi-LORA: A Vision-Language Approach for Synthetic Image Detection" index=108>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.01959v2" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.01959v2.pdf" filename="2404.01959v2.pdf">Download PDF</button>
...
### (7/82 | 109/327) WcDT: World-centric Diffusion Transformer for Traffic Scene Generation (Chen Yang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="WcDT: World-centric Diffusion Transformer for Traffic Scene Generation" index=109>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (8/82 | 110/327) Red-Teaming Segment Anything Model (Krzysztof Jankowski et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Red-Teaming Segment Anything Model" index=110>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (9/82 | 111/327) Semantic Augmentation in Images using Language (Sahiti Yerramilli et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Semantic Augmentation in Images using Language" index=111>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (10/82 | 112/327) RAVE: Residual Vector Embedding for CLIP-Guided Backlit Image Enhancement (Tatiana Gaintseva et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="RAVE: Residual Vector Embedding for CLIP-Guided Backlit Image Enhancement" index=112>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (11/82 | 113/327) Leveraging YOLO-World and GPT-4V LMMs for Zero-Shot Person Detection and Action Recognition in Drone Imagery (Christian Limberg et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Leveraging YOLO-World and GPT-4V LMMs for Zero-Shot Person Detection and Action Recognition in Drone Imagery" index=113>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (12/82 | 114/327) LP++: A Surprisingly Strong Linear Probe for Few-Shot CLIP (Yunshi Huang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="LP++: A Surprisingly Strong Linear Probe for Few-Shot CLIP" index=114>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (13/82 | 115/327) ContrastCAD: Contrastive Learning-based Representation Learning for Computer-Aided Design Models (Minseop Jung et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="ContrastCAD: Contrastive Learning-based Representation Learning for Computer-Aided Design Models" index=115>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (14/82 | 116/327) EGTR: Extracting Graph from Transformer for Scene Graph Generation (Jinbae Im et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="EGTR: Extracting Graph from Transformer for Scene Graph Generation" index=116>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (15/82 | 117/327) 3D scene generation from scene graphs and self-attention (Pietro Bonazzi, 2024)
...
<br/>
<button class="copy-to-clipboard" title="3D scene generation from scene graphs and self-attention" index=117>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (16/82 | 118/327) BRAVEn: Improving Self-Supervised Pre-training for Visual and Auditory Speech Recognition (Alexandros Haliassos et al., 2024)
...
### (17/82 | 119/327) T-VSL: Text-Guided Visual Sound Source Localization in Mixtures (Tanvir Mahmud et al., 2024)
...
### (18/82 | 120/327) Exploring Latent Pathways: Enhancing the Interpretability of Autonomous Driving with a Variational Autoencoder (Anass Bairouk et al., 2024)
...
### (19/82 | 121/327) AddSR: Accelerating Diffusion-based Blind Super-Resolution with Adversarial Diffusion Distillation (Rui Xie et al., 2024)
...
### (20/82 | 122/327) Unleash the Potential of CLIP for Video Highlight Detection (Donghoon Han et al., 2024)
...
### (21/82 | 123/327) mChartQA: A universal benchmark for multimodal Chart Question Answer based on Vision-Language Alignment and Reasoning (Jingxuan Wei et al., 2024)
...
### (22/82 | 124/327) Iterated Learning Improves Compositionality in Large Vision-Language Models (Chenhao Zheng et al., 2024)
...
### (23/82 | 125/327) Multi-Level Label Correction by Distilling Proximate Patterns for Semi-supervised Semantic Segmentation (Hui Xiao et al., 2024)
...
### (24/82 | 126/327) DELAN: Dual-Level Alignment for Vision-and-Language Navigation by Cross-Modal Contrastive Learning (Mengfei Du et al., 2024)
...
### (25/82 | 127/327) Linear Combination of Saved Checkpoints Makes Consistency and Diffusion Models Better (Enshu Liu et al., 2024)
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.02241v2" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.02241v2.pdf" filename="2404.02241v2.pdf">Download PDF</button>
...
### (26/82 | 128/327) Diffusion$^2$: Dynamic 3D Content Generation via Score Composition of Orthogonal Diffusion Models (Zeyu Yang et al., 2024)
...
### (27/82 | 129/327) Enhancing Ship Classification in Optical Satellite Imagery: Integrating Convolutional Block Attention Module with ResNet for Improved Performance (Ryan Donghan Kwon et al., 2024)

{{<citation>}}

Ryan Donghan Kwon, Gangjoo Robin Nam, Jisoo Tak, Junseob Shin, Hyerin Cha, Yeom Hyeok, Seung Won Lee. (2024)  
...
<br/>
<button class="copy-to-clipboard" title="Enhancing Ship Classification in Optical Satellite Imagery: Integrating Convolutional Block Attention Module with ResNet for Improved Performance" index=129>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.02135v3" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.02135v3.pdf" filename="2404.02135v3.pdf">Download PDF</button>
...
### (28/82 | 130/327) Cooperative Students: Navigating Unsupervised Domain Adaptation in Nighttime Object Detection (Jicheng Yuan et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Cooperative Students: Navigating Unsupervised Domain Adaptation in Nighttime Object Detection" index=130>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (29/82 | 131/327) VLRM: Vision-Language Models act as Reward Models for Image Captioning (Maksim Dzabraev et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="VLRM: Vision-Language Models act as Reward Models for Image Captioning" index=131>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (30/82 | 132/327) Scene Adaptive Sparse Transformer for Event-based Object Detection (Yansong Peng et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Scene Adaptive Sparse Transformer for Event-based Object Detection" index=132>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (31/82 | 133/327) Disentangled Pre-training for Human-Object Interaction Detection (Zhuolong Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Disentangled Pre-training for Human-Object Interaction Detection" index=133>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (32/82 | 134/327) Task Integration Distillation for Object Detectors (Hai Su et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Task Integration Distillation for Object Detectors" index=134>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (33/82 | 135/327) A Universal Knowledge Embedded Contrastive Learning Framework for Hyperspectral Image Classification (Quanwei Liu et al., 2024)

{{<citation>}}

Quanwei Liu, Yanni Dong, Tao Huang, Lefei Zhang, Bo Du. (2024)  
**A Universal Knowledge Embedded Contrastive Learning Framework for Hyperspectral Image Classification**
<br/>
<button class="copy-to-clipboard" title="A Universal Knowledge Embedded Contrastive Learning Framework for Hyperspectral Image Classification" index=135>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.01673v2" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.01673v2.pdf" filename="2404.01673v2.pdf">Download PDF</button>
...
### (34/82 | 136/327) Supporting Mitosis Detection AI Training with Inter-Observer Eye-Gaze Consistencies (Hongyan Gu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Supporting Mitosis Detection AI Training with Inter-Observer Eye-Gaze Consistencies" index=136>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (35/82 | 137/327) Spin-UP: Spin Light for Natural Light Uncalibrated Photometric Stereo (Zongrui Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Spin-UP: Spin Light for Natural Light Uncalibrated Photometric Stereo" index=137>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (36/82 | 138/327) MotionChain: Conversational Motion Controllers via Multimodal Prompts (Biao Jiang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="MotionChain: Conversational Motion Controllers via Multimodal Prompts" index=138>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (37/82 | 139/327) Language Model Guided Interpretable Video Action Reasoning (Ning Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Language Model Guided Interpretable Video Action Reasoning" index=139>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (38/82 | 140/327) OFMPNet: Deep End-to-End Model for Occupancy and Flow Prediction in Urban Environment (Youshaa Murhij et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="OFMPNet: Deep End-to-End Model for Occupancy and Flow Prediction in Urban Environment" index=140>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (39/82 | 141/327) SelfPose3d: Self-Supervised Multi-Person Multi-View 3d Pose Estimation (Vinkle Srivastav et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="SelfPose3d: Self-Supervised Multi-Person Multi-View 3d Pose Estimation" index=141>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (40/82 | 142/327) Semi-Supervised Domain Adaptation for Wildfire Detection (JooYoung Jang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Semi-Supervised Domain Adaptation for Wildfire Detection" index=142>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (41/82 | 143/327) Sparse Semi-DETR: Sparse Learnable Queries for Semi-Supervised Object Detection (Tahira Shehzadi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Sparse Semi-DETR: Sparse Learnable Queries for Semi-Supervised Object Detection" index=143>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (42/82 | 144/327) Diffusion Deepfake (Chaitali Bhattacharyya et al., 2024)
...
**Diffusion Deepfake**
<br/>
<button class="copy-to-clipboard" title="Diffusion Deepfake" index=144>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (43/82 | 145/327) Bidirectional Multi-Scale Implicit Neural Representations for Image Deraining (Xiang Chen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Bidirectional Multi-Scale Implicit Neural Representations for Image Deraining" index=145>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (44/82 | 146/327) SnAG: Scalable and Accurate Video Grounding (Fangzhou Mu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="SnAG: Scalable and Accurate Video Grounding" index=146>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (45/82 | 147/327) Towards Robust 3D Pose Transfer with Adversarial Learning (Haoyu Chen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Towards Robust 3D Pose Transfer with Adversarial Learning" index=147>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (46/82 | 148/327) Lookahead Exploration with Neural Radiance Representation for Continuous Vision-Language Navigation (Zihan Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Lookahead Exploration with Neural Radiance Representation for Continuous Vision-Language Navigation" index=148>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (47/82 | 149/327) Co-Speech Gesture Video Generation via Motion-Decoupled Diffusion Model (Xu He et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Co-Speech Gesture Video Generation via Motion-Decoupled Diffusion Model" index=149>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (48/82 | 150/327) Upsample Guidance: Scale Up Diffusion Models without Training (Juno Hwang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Upsample Guidance: Scale Up Diffusion Models without Training" index=150>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (49/82 | 151/327) Learning to Control Camera Exposure via Reinforcement Learning (Kyunghyun Lee et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Learning to Control Camera Exposure via Reinforcement Learning" index=151>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (50/82 | 152/327) Learning Equi-angular Representations for Online Continual Learning (Minhyuk Seo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Learning Equi-angular Representations for Online Continual Learning" index=152>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (51/82 | 153/327) LR-FPN: Enhancing Remote Sensing Object Detection with Location Refined Feature Pyramid Network (Hanqian Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="LR-FPN: Enhancing Remote Sensing Object Detection with Location Refined Feature Pyramid Network" index=153>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (52/82 | 154/327) TSCM: A Teacher-Student Model for Vision Place Recognition Using Cross-Metric Knowledge Distillation (Yehui Shen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="TSCM: A Teacher-Student Model for Vision Place Recognition Using Cross-Metric Knowledge Distillation" index=154>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (53/82 | 155/327) PREGO: online mistake detection in PRocedural EGOcentric videos (Alessandro Flaborea et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="PREGO: online mistake detection in PRocedural EGOcentric videos" index=155>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (54/82 | 156/327) FashionEngine: Interactive Generation and Editing of 3D Clothed Humans (Tao Hu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="FashionEngine: Interactive Generation and Editing of 3D Clothed Humans" index=156>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (55/82 | 157/327) GEARS: Local Geometry-aware Hand-object Interaction Synthesis (Keyang Zhou et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="GEARS: Local Geometry-aware Hand-object Interaction Synthesis" index=157>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (56/82 | 158/327) A Linear Time and Space Local Point Cloud Geometry Encoder via Vectorized Kernel Mixture (VecKM) (Dehao Yuan et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Linear Time and Space Local Point Cloud Geometry Encoder via Vectorized Kernel Mixture (VecKM)" index=158>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (57/82 | 159/327) Segment Any 3D Object with Language (Seungjun Lee et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Segment Any 3D Object with Language" index=159>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (58/82 | 160/327) GaitSTR: Gait Recognition with Sequential Two-stream Refinement (Wanrong Zheng et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="GaitSTR: Gait Recognition with Sequential Two-stream Refinement" index=160>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (59/82 | 161/327) OOSTraj: Out-of-Sight Trajectory Prediction With Vision-Positioning Denoising (Haichao Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="OOSTraj: Out-of-Sight Trajectory Prediction With Vision-Positioning Denoising" index=161>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (60/82 | 162/327) Boosting Visual Recognition for Autonomous Driving in Real-world Degradations with Deep Channel Prior (Zhanwen Liu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Boosting Visual Recognition for Autonomous Driving in Real-world Degradations with Deep Channel Prior" index=162>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (61/82 | 163/327) RefQSR: Reference-based Quantization for Image Super-Resolution Networks (Hongjae Lee et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="RefQSR: Reference-based Quantization for Image Super-Resolution Networks" index=163>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (62/82 | 164/327) One Noise to Rule Them All: Multi-View Adversarial Attacks with Universal Perturbation (Mehmet Ergezer et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="One Noise to Rule Them All: Multi-View Adversarial Attacks with Universal Perturbation" index=164>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (63/82 | 165/327) Smooth Deep Saliency (Rudolf Herdt et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Smooth Deep Saliency" index=165>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (64/82 | 166/327) Visual Concept Connectome (VCC): Open World Concept Discovery and their Interlayer Connections in Deep Models (Matthew Kowal et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Visual Concept Connectome (VCC): Open World Concept Discovery and their Interlayer Connections in Deep Models" index=166>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (65/82 | 167/327) CHOSEN: Contrastive Hypothesis Selection for Multi-View Depth Refinement (Di Qiu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="CHOSEN: Contrastive Hypothesis Selection for Multi-View Depth Refinement" index=167>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (66/82 | 168/327) GeneAvatar: Generic Expression-Aware Volumetric Head Avatar Editing from a Single Image (Chong Bao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="GeneAvatar: Generic Expression-Aware Volumetric Head Avatar Editing from a Single Image" index=168>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (67/82 | 169/327) Adaptive Feature Fusion Neural Network for Glaucoma Segmentation on Unseen Fundus Images (Jiyuan Zhong et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Adaptive Feature Fusion Neural Network for Glaucoma Segmentation on Unseen Fundus Images" index=169>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (68/82 | 170/327) NeRFCodec: Neural Feature Compression Meets Neural Radiance Fields for Memory-Efficient Scene Representation (Sicheng Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="NeRFCodec: Neural Feature Compression Meets Neural Radiance Fields for Memory-Efficient Scene Representation" index=170>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (69/82 | 171/327) CAM-Based Methods Can See through Walls (Magamed Taimeskhanov et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="CAM-Based Methods Can See through Walls" index=171>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (70/82 | 172/327) Improving Bird's Eye View Semantic Segmentation by Task Decomposition (Tianhao Zhao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Improving Bird's Eye View Semantic Segmentation by Task Decomposition" index=172>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (71/82 | 173/327) ASTRA: An Action Spotting TRAnsformer for Soccer Videos (Artur Xarles et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="ASTRA: An Action Spotting TRAnsformer for Soccer Videos" index=173>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (72/82 | 174/327) Super-Resolution Analysis for Landfill Waste Classification (Matias Molina et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Super-Resolution Analysis for Landfill Waste Classification" index=174>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (73/82 | 175/327) A noisy elephant in the room: Is your out-of-distribution detector robust to label noise? (Galadrielle Humblot-Renaux et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A noisy elephant in the room: Is your out-of-distribution detector robust to label noise?" index=175>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (74/82 | 176/327) Beyond Image Super-Resolution for Image Recognition with Task-Driven Perceptual Loss (Jaeha Kim et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Beyond Image Super-Resolution for Image Recognition with Task-Driven Perceptual Loss" index=176>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (75/82 | 177/327) Learning Temporal Cues by Predicting Objects Move for Multi-camera 3D Object Detection (Seokha Moon et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Learning Temporal Cues by Predicting Objects Move for Multi-camera 3D Object Detection" index=177>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (76/82 | 178/327) Efficient 3D Implicit Head Avatar with Mesh-anchored Hash Table Blendshapes (Ziqian Bai et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Efficient 3D Implicit Head Avatar with Mesh-anchored Hash Table Blendshapes" index=178>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (77/82 | 179/327) Atom-Level Optical Chemical Structure Recognition with Limited Supervision (Martijn Oldenhof et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Atom-Level Optical Chemical Structure Recognition with Limited Supervision" index=179>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (78/82 | 180/327) Specularity Factorization for Low-Light Enhancement (Saurabh Saini et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Specularity Factorization for Low-Light Enhancement" index=180>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (79/82 | 181/327) Joint-Task Regularization for Partially Labeled Multi-Task Learning (Kento Nishi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Joint-Task Regularization for Partially Labeled Multi-Task Learning" index=181>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (80/82 | 182/327) Surface Reconstruction from Gaussian Splatting via Novel Stereo Views (Yaniv Wolf et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Surface Reconstruction from Gaussian Splatting via Novel Stereo Views" index=182>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (81/82 | 183/327) JRDB-PanoTrack: An Open-world Panoptic Segmentation and Tracking Robotic Dataset in Crowded Human Environments (Duy-Tho Le et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="JRDB-PanoTrack: An Open-world Panoptic Segmentation and Tracking Robotic Dataset in Crowded Human Environments" index=183>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (82/82 | 184/327) WaveDH: Wavelet Sub-bands Guided ConvNet for Efficient Image Dehazing (Seongmin Hwang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="WaveDH: Wavelet Sub-bands Guided ConvNet for Efficient Image Dehazing" index=184>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/6 | 185/327) Where to Move Next: Zero-shot Generalization of LLMs for Next POI Recommendation (Shanshan Feng et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Where to Move Next: Zero-shot Generalization of LLMs for Next POI Recommendation" index=185>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/6 | 186/327) IISAN: Efficiently Adapting Multimodal Representation for Sequential Recommendation with Decoupled PEFT (Junchen Fu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="IISAN: Efficiently Adapting Multimodal Representation for Sequential Recommendation with Decoupled PEFT" index=186>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/6 | 187/327) CIRP: Cross-Item Relational Pre-training for Multimodal Product Bundling (Yunshan Ma et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="CIRP: Cross-Item Relational Pre-training for Multimodal Product Bundling" index=187>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/6 | 188/327) Multi-granular Adversarial Attacks against Black-box Neural Ranking Models (Yu-An Liu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Multi-granular Adversarial Attacks against Black-box Neural Ranking Models" index=188>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/6 | 189/327) RAT: Retrieval-Augmented Transformer for Click-Through Rate Prediction (Yushen Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="RAT: Retrieval-Augmented Transformer for Click-Through Rate Prediction" index=189>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (6/6 | 190/327) A Survey of Web Content Control for Generative AI (Michael Dinzinger et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Survey of Web Content Control for Generative AI" index=190>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/48 | 191/327) Virtual Sensor for Real-Time Bearing Load Prediction Using Heterogeneous Temporal Graph Neural Networks (Mengjie Zhao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Virtual Sensor for Real-Time Bearing Load Prediction Using Heterogeneous Temporal Graph Neural Networks" index=191>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/48 | 192/327) Confidence-aware Reward Optimization for Fine-tuning Text-to-Image Models (Kyuyoung Kim et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Confidence-aware Reward Optimization for Fine-tuning Text-to-Image Models" index=192>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/48 | 193/327) Remote sensing framework for geological mapping via stacked autoencoders and clustering (Sandeep Nagar et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Remote sensing framework for geological mapping via stacked autoencoders and clustering" index=193>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/48 | 194/327) Predicting the Performance of Foundation Models via Agreement-on-the-Line (Aman Mehra et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Predicting the Performance of Foundation Models via Agreement-on-the-Line" index=194>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/48 | 195/327) Is Meta-training Really Necessary for Molecular Few-Shot Learning ? (Philippe Formont et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Is Meta-training Really Necessary for Molecular Few-Shot Learning ?" index=195>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (6/48 | 196/327) Selective Temporal Knowledge Graph Reasoning (Zhongni Hou et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Selective Temporal Knowledge Graph Reasoning" index=196>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (7/48 | 197/327) Is Exploration All You Need? Effective Exploration Characteristics for Transfer in Reinforcement Learning (Jonathan C. Balloch et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Is Exploration All You Need? Effective Exploration Characteristics for Transfer in Reinforcement Learning" index=197>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (8/48 | 198/327) A Generative Deep Learning Approach for Crash Severity Modeling with Imbalanced Data (Junlan Chen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Generative Deep Learning Approach for Crash Severity Modeling with Imbalanced Data" index=198>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (9/48 | 199/327) Noise Masking Attacks and Defenses for Pretrained Speech Models (Matthew Jagielski et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Noise Masking Attacks and Defenses for Pretrained Speech Models" index=199>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (10/48 | 200/327) Accelerating Transformer Pre-Training with 2:4 Sparsity (Yuezhou Hu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Accelerating Transformer Pre-Training with 2:4 Sparsity" index=200>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (11/48 | 201/327) Test-Time Model Adaptation with Only Forward Passes (Shuaicheng Niu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Test-Time Model Adaptation with Only Forward Passes" index=201>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (12/48 | 202/327) DSGNN: A Dual-View Supergrid-Aware Graph Neural Network for Regional Air Quality Estimation (Xin Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="DSGNN: A Dual-View Supergrid-Aware Graph Neural Network for Regional Air Quality Estimation" index=202>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (13/48 | 203/327) Heat Death of Generative Models in Closed-Loop Learning (Matteo Marchi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Heat Death of Generative Models in Closed-Loop Learning" index=203>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (14/48 | 204/327) AUTODIFF: Autoregressive Diffusion Modeling for Structure-based Drug Design (Xinze Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="AUTODIFF: Autoregressive Diffusion Modeling for Structure-based Drug Design" index=204>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (15/48 | 205/327) Unifying Qualitative and Quantitative Safety Verification of DNN-Controlled Systems (Dapeng Zhi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Unifying Qualitative and Quantitative Safety Verification of DNN-Controlled Systems" index=205>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (16/48 | 206/327) Transformer meets wcDTW to improve real-time battery bids: A new approach to scenario selection (Sujal Bhavsar et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Transformer meets wcDTW to improve real-time battery bids: A new approach to scenario selection" index=206>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (17/48 | 207/327) Audio Simulation for Sound Source Localization in Virtual Evironment (Yi Di Yuan et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Audio Simulation for Sound Source Localization in Virtual Evironment" index=207>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (18/48 | 208/327) MESEN: Exploit Multimodal Data to Design Unimodal Human Activity Recognition with Few Labels (Lilin Xu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="MESEN: Exploit Multimodal Data to Design Unimodal Human Activity Recognition with Few Labels" index=208>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (19/48 | 209/327) A (More) Realistic Evaluation Setup for Generalisation of Community Models on Malicious Content Detection (Ivo Verhoeven et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A (More) Realistic Evaluation Setup for Generalisation of Community Models on Malicious Content Detection" index=209>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (20/48 | 210/327) CATGNN: Cost-Efficient and Scalable Distributed Training for Graph Neural Networks (Xin Huang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="CATGNN: Cost-Efficient and Scalable Distributed Training for Graph Neural Networks" index=210>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (21/48 | 211/327) Mixture-of-Depths: Dynamically allocating compute in transformer-based language models (David Raposo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Mixture-of-Depths: Dynamically allocating compute in transformer-based language models" index=211>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (22/48 | 212/327) Enhancing Functional Safety in Automotive AMS Circuits through Unsupervised Machine Learning (Ayush Arunachalam et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Enhancing Functional Safety in Automotive AMS Circuits through Unsupervised Machine Learning" index=212>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (23/48 | 213/327) ImageNot: A contrast with ImageNet preserves model rankings (Olawale Salaudeen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="ImageNot: A contrast with ImageNet preserves model rankings" index=213>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (24/48 | 214/327) Incentives in Private Collaborative Machine Learning (Rachael Hwee Ling Sim et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Incentives in Private Collaborative Machine Learning" index=214>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (25/48 | 215/327) ADVREPAIR:Provable Repair of Adversarial Attack (Zhiming Chi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="ADVREPAIR:Provable Repair of Adversarial Attack" index=215>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (26/48 | 216/327) What Can Transformer Learn with Varying Depth? Case Studies on Sequence Learning Tasks (Xingwu Chen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="What Can Transformer Learn with Varying Depth? Case Studies on Sequence Learning Tasks" index=216>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (27/48 | 217/327) Pairwise Similarity Distribution Clustering for Noisy Label Learning (Sihan Bai, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Pairwise Similarity Distribution Clustering for Noisy Label Learning" index=217>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (28/48 | 218/327) HeMeNet: Heterogeneous Multichannel Equivariant Network for Protein Multitask Learning (Rong Han et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="HeMeNet: Heterogeneous Multichannel Equivariant Network for Protein Multitask Learning" index=218>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (29/48 | 219/327) GLEMOS: Benchmark for Instantaneous Graph Learning Model Selection (Namyong Park et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="GLEMOS: Benchmark for Instantaneous Graph Learning Model Selection" index=219>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (30/48 | 220/327) Propensity Score Alignment of Unpaired Multimodal Data (Johnny Xi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Propensity Score Alignment of Unpaired Multimodal Data" index=220>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (31/48 | 221/327) FraGNNet: A Deep Probabilistic Model for Mass Spectrum Prediction (Adamo Young et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="FraGNNet: A Deep Probabilistic Model for Mass Spectrum Prediction" index=221>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (32/48 | 222/327) Deep Neural Networks with 3D Point Clouds for Empirical Friction Measurements in Hydrodynamic Flood Models (Francisco Haces-Garcia et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Deep Neural Networks with 3D Point Clouds for Empirical Friction Measurements in Hydrodynamic Flood Models" index=222>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (33/48 | 223/327) Tuning for the Unknown: Revisiting Evaluation Strategies for Lifelong RL (Golnaz Mesbahi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Tuning for the Unknown: Revisiting Evaluation Strategies for Lifelong RL" index=223>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (34/48 | 224/327) Zero-Shot Multi-Lingual Speaker Verification in Clinical Trials (Ali Akram et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Zero-Shot Multi-Lingual Speaker Verification in Clinical Trials" index=224>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 10  
Keywords: Zero-shot  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.01981v2" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.01981v2.pdf" filename="2404.01981v2.pdf">Download PDF</button>
...
### (35/48 | 225/327) Adaptive Combinatorial Maximization: Beyond Approximate Greedy Policies (Shlomi Weitzman et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Adaptive Combinatorial Maximization: Beyond Approximate Greedy Policies" index=225>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (36/48 | 226/327) Leveraging Machine Learning for Early Autism Detection via INDT-ASD Indian Database (Trapti Shrivastava et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Leveraging Machine Learning for Early Autism Detection via INDT-ASD Indian Database" index=226>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (37/48 | 227/327) Procedural Fairness in Machine Learning (Ziming Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Procedural Fairness in Machine Learning" index=227>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (38/48 | 228/327) Fast and Adaptive Questionnaires for Voting Advice Applications (Fynn Bachmann et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Fast and Adaptive Questionnaires for Voting Advice Applications" index=228>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (39/48 | 229/327) Defense without Forgetting: Continual Adversarial Defense with Anisotropic & Isotropic Pseudo Replay (Yuhang Zhou et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Defense without Forgetting: Continual Adversarial Defense with Anisotropic & Isotropic Pseudo Replay" index=229>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (40/48 | 230/327) Improved Text Emotion Prediction Using Combined Valence and Arousal Ordinal Classification (Michael Mitsios et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Improved Text Emotion Prediction Using Combined Valence and Arousal Ordinal Classification" index=230>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (41/48 | 231/327) Asymptotics of Language Model Alignment (Joy Qiping Yang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Asymptotics of Language Model Alignment" index=231>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (42/48 | 232/327) Efficient Online Unlearning via Hessian-Free Recollection of Individual Data Statistics (Xinbao Qiao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Efficient Online Unlearning via Hessian-Free Recollection of Individual Data Statistics" index=232>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (43/48 | 233/327) Extremum-Seeking Action Selection for Accelerating Policy Optimization (Ya-Chien Chang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Extremum-Seeking Action Selection for Accelerating Policy Optimization" index=233>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (44/48 | 234/327) Universal representations for financial transactional data: embracing local, global, and external contexts (Alexandra Bazarova et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Universal representations for financial transactional data: embracing local, global, and external contexts" index=234>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (45/48 | 235/327) Attribution Regularization for Multimodal Paradigms (Sahiti Yerramilli et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Attribution Regularization for Multimodal Paradigms" index=235>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (46/48 | 236/327) Generalizable, Fast, and Accurate DeepQSPR with fastprop Part 1: Framework and Benchmarks (Jackson Burns et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Generalizable, Fast, and Accurate DeepQSPR with fastprop Part 1: Framework and Benchmarks" index=236>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (47/48 | 237/327) What is to be gained by ensemble models in analysis of spectroscopic data? (Katarina Domijan, 2024)
...
<br/>
<button class="copy-to-clipboard" title="What is to be gained by ensemble models in analysis of spectroscopic data?" index=237>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (48/48 | 238/327) Settling Time vs. Accuracy Tradeoffs for Clustering Big Data (Andrew Draganov et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Settling Time vs. Accuracy Tradeoffs for Clustering Big Data" index=238>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/4 | 239/327) Weakly-supervised Audio Separation via Bi-modal Semantic Similarity (Tanvir Mahmud et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Weakly-supervised Audio Separation via Bi-modal Semantic Similarity" index=239>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/4 | 240/327) SMITIN: Self-Monitored Inference-Time INtervention for Generative Music Transformers (Junghyun Koo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="SMITIN: Self-Monitored Inference-Time INtervention for Generative Music Transformers" index=240>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/4 | 241/327) SPMamba: State-space model is all you need in speech separation (Kai Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="SPMamba: State-space model is all you need in speech separation" index=241>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/4 | 242/327) Voice EHR: Introducing Multimodal Audio Data for Health (James Anibal et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Voice EHR: Introducing Multimodal Audio Data for Health" index=242>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/2 | 243/327) Transfer Learning from Whisper for Microscopic Intelligibility Prediction (Paul Best et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Transfer Learning from Whisper for Microscopic Intelligibility Prediction" index=243>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/2 | 244/327) Effective internal language model training and fusion for factorized transducer model (Jinxi Guo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Effective internal language model training and fusion for factorized transducer model" index=244>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/5 | 245/327) Preventing Model Collapse in Gaussian Process Latent Variable Models (Ying Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Preventing Model Collapse in Gaussian Process Latent Variable Models" index=245>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/5 | 246/327) On Stronger Computational Separations Between Multimodal and Unimodal Machine Learning (Ari Karchmer, 2024)
...
<br/>
<button class="copy-to-clipboard" title="On Stronger Computational Separations Between Multimodal and Unimodal Machine Learning" index=246>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/5 | 247/327) Doubly-Robust Off-Policy Evaluation with Estimated Logging Policy (Kyungbok Lee et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Doubly-Robust Off-Policy Evaluation with Estimated Logging Policy" index=247>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/5 | 248/327) FAIRM: Learning invariant representations for algorithmic fairness and domain generalization with minimax optimality (Sai Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="FAIRM: Learning invariant representations for algorithmic fairness and domain generalization with minimax optimality" index=248>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/5 | 249/327) Adversarial Combinatorial Bandits with Switching Costs (Yanyan Dong et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Adversarial Combinatorial Bandits with Switching Costs" index=249>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/7 | 250/327) InsightLens: Discovering and Exploring Insights from Conversational Contexts in Large-Language-Model-Powered Data Analysis (Luoxuan Weng et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="InsightLens: Discovering and Exploring Insights from Conversational Contexts in Large-Language-Model-Powered Data Analysis" index=250>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/7 | 251/327) Exploring How Multiple Levels of GPT-Generated Programming Hints Support or Disappoint Novices (Ruiwei Xiao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Exploring How Multiple Levels of GPT-Generated Programming Hints Support or Disappoint Novices" index=251>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/7 | 252/327) Explainability in JupyterLab and Beyond: Interactive XAI Systems for Integrated and Collaborative Workflows (Grace Guo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Explainability in JupyterLab and Beyond: Interactive XAI Systems for Integrated and Collaborative Workflows" index=252>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/7 | 253/327) Harder, Better, Faster, Stronger: Interactive Visualization for Human-Centered AI Tools (Md Naimul Hoque et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Harder, Better, Faster, Stronger: Interactive Visualization for Human-Centered AI Tools" index=253>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/7 | 254/327) Tell and show: Combining multiple modalities to communicate manipulation tasks to a robot (Petr Vanc et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Tell and show: Combining multiple modalities to communicate manipulation tasks to a robot" index=254>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (6/7 | 255/327) Gen4DS: Workshop on Data Storytelling in an Era of Generative AI (Xingyu Lan et al., 2024)

{{<citation>}}

Xingyu Lan, Leni Yang, Zezhong Wang, Yun Wang, Danqing Shi, Sheelagh Carpendale. (2024)  
**Gen4DS: Workshop on Data Storytelling in an Era of Generative AI**
<br/>
<button class="copy-to-clipboard" title="Gen4DS: Workshop on Data Storytelling in an Era of Generative AI" index=255>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 10  
Keywords: Generative AI  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.01622v2" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.01622v2.pdf" filename="2404.01622v2.pdf">Download PDF</button>
...
### (7/7 | 256/327) From Delays to Densities: Exploring Data Uncertainty through Speech, Text, and Visualization (Chase Stokes et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="From Delays to Densities: Exploring Data Uncertainty through Speech, Text, and Visualization" index=256>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/7 | 257/327) Self-Organized Agents: A LLM Multi-Agent Framework toward Ultra Large-Scale Code Generation and Optimization (Yoichi Ishibashi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Self-Organized Agents: A LLM Multi-Agent Framework toward Ultra Large-Scale Code Generation and Optimization" index=257>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/7 | 258/327) Automated User Story Generation with Test Case Specification Using Large Language Model (Tajmilur Rahman et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Automated User Story Generation with Test Case Specification Using Large Language Model" index=258>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/7 | 259/327) Peer-aided Repairer: Empowering Large Language Models to Repair Advanced Student Assignments (Qianhui Zhao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Peer-aided Repairer: Empowering Large Language Models to Repair Advanced Student Assignments" index=259>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/7 | 260/327) EV2Gym: A Flexible V2G Simulator for EV Smart Charging Research and Benchmarking (Stavros Orfanoudakis et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="EV2Gym: A Flexible V2G Simulator for EV Smart Charging Research and Benchmarking" index=260>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/7 | 261/327) Multitask-based Evaluation of Open-Source LLM on Software Vulnerability (Xin Yin et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Multitask-based Evaluation of Open-Source LLM on Software Vulnerability" index=261>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (6/7 | 262/327) Keeping Behavioral Programs Alive: Specifying and Executing Liveness Requirements (Tom Yaacov et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Keeping Behavioral Programs Alive: Specifying and Executing Liveness Requirements" index=262>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (7/7 | 263/327) FT2Ra: A Fine-Tuning-Inspired Approach to Retrieval-Augmented Code Completion (Qi Guo et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="FT2Ra: A Fine-Tuning-Inspired Approach to Retrieval-Augmented Code Completion" index=263>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/2 | 264/327) Intelligent Optimization of Mine Environmental Damage Assessment and Repair Strategies Based on Deep Learning (Qishuo Cheng, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Intelligent Optimization of Mine Environmental Damage Assessment and Repair Strategies Based on Deep Learning" index=264>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/2 | 265/327) Enhancing Portfolio Optimization with Transformer-GAN Integration: A Novel Approach in the Black-Litterman Framework (Enmin Zhu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Enhancing Portfolio Optimization with Transformer-GAN Integration: A Novel Approach in the Black-Litterman Framework" index=265>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/3 | 266/327) Distributed Autonomous Swarm Formation for Dynamic Network Bridging (Raffaele Galliera et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Distributed Autonomous Swarm Formation for Dynamic Network Bridging" index=266>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/3 | 267/327) EnergAIze: Multi Agent Deep Deterministic Policy Gradient for Vehicle to Grid Energy Management (Tiago Fonseca et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="EnergAIze: Multi Agent Deep Deterministic Policy Gradient for Vehicle to Grid Energy Management" index=267>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/3 | 268/327) Multi-Agent Reinforcement Learning with Control-Theoretic Safety Guarantees for Dynamic Network Bridging (Raffaele Galliera et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Multi-Agent Reinforcement Learning with Control-Theoretic Safety Guarantees for Dynamic Network Bridging" index=268>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/7 | 269/327) Guidelines for Cerebrovascular Segmentation: Managing Imperfect Annotations in the context of Semi-Supervised Learning (Pierre Rougé et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Guidelines for Cerebrovascular Segmentation: Managing Imperfect Annotations in the context of Semi-Supervised Learning" index=269>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/7 | 270/327) Contextual Embedding Learning to Enhance 2D Networks for Volumetric Image Segmentation (Zhuoyuan Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Contextual Embedding Learning to Enhance 2D Networks for Volumetric Image Segmentation" index=270>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/7 | 271/327) Rethinking Annotator Simulation: Realistic Evaluation of Whole-Body PET Lesion Interactive Segmentation Methods (Zdravko Marinov et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Rethinking Annotator Simulation: Realistic Evaluation of Whole-Body PET Lesion Interactive Segmentation Methods" index=271>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/7 | 272/327) A Closer Look at Spatial-Slice Features Learning for COVID-19 Detection (Chih-Chung Hsu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Closer Look at Spatial-Slice Features Learning for COVID-19 Detection" index=272>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/7 | 273/327) COVID-19 Detection Based on Blood Test Parameters using Various Artificial Intelligence Methods (Kavian Khanjani et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="COVID-19 Detection Based on Blood Test Parameters using Various Artificial Intelligence Methods" index=273>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (6/7 | 274/327) Synthetic Data for Robust Stroke Segmentation (Liam Chalcroft et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Synthetic Data for Robust Stroke Segmentation" index=274>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (7/7 | 275/327) Towards Enhanced Analysis of Lung Cancer Lesions in EBUS-TBNA -- A Semi-Supervised Video Object Detection Method (Jyun-An Lin et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Towards Enhanced Analysis of Lung Cancer Lesions in EBUS-TBNA -- A Semi-Supervised Video Object Detection Method" index=275>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/6 | 276/327) Guided-Mutation Genetic Algorithm for Mobile IoT Network Relay (Gyupil Kam et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Guided-Mutation Genetic Algorithm for Mobile IoT Network Relay" index=276>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/6 | 277/327) Collaborative Optimization of Wireless Communication and Computing Resource Allocation based on Multi-Agent Federated Weighting Deep Reinforcement Learning (Junjie Wu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Collaborative Optimization of Wireless Communication and Computing Resource Allocation based on Multi-Agent Federated Weighting Deep Reinforcement Learning" index=277>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/6 | 278/327) LLM-ABR: Designing Adaptive Bitrate Algorithms via Large Language Models (Zhiyuan He et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="LLM-ABR: Designing Adaptive Bitrate Algorithms via Large Language Models" index=278>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/6 | 279/327) Defining Problem from Solutions: Inverse Reinforcement Learning (IRL) and Its Applications for Next-Generation Networking (Yinqiu Liu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Defining Problem from Solutions: Inverse Reinforcement Learning (IRL) and Its Applications for Next-Generation Networking" index=279>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/6 | 280/327) DCP and VarDis: An Ad-Hoc Protocol Stack for Dynamic Swarms and Formations of Drones -- Extended Version (Samuel Pell et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="DCP and VarDis: An Ad-Hoc Protocol Stack for Dynamic Swarms and Formations of Drones -- Extended Version" index=280>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (6/6 | 281/327) SMaRTT-REPS: Sender-based Marked Rapidly-adapting Trimmed & Timed Transport with Recycled Entropies (Tommaso Bonato et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="SMaRTT-REPS: Sender-based Marked Rapidly-adapting Trimmed & Timed Transport with Recycled Entropies" index=281>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/3 | 282/327) Continuous Spiking Graph Neural Networks (Nan Yin et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Continuous Spiking Graph Neural Networks" index=282>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/3 | 283/327) Already Moderate Population Sizes Provably Yield Strong Robustness to Noise (Denis Antipov et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Already Moderate Population Sizes Provably Yield Strong Robustness to Noise" index=283>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 3  
Keywords: Benchmarking  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.02090v2" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.02090v2.pdf" filename="2404.02090v2.pdf">Download PDF</button>
...
### (3/3 | 284/327) Tensorized NeuroEvolution of Augmenting Topologies for GPU Acceleration (Lishuang Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Tensorized NeuroEvolution of Augmenting Topologies for GPU Acceleration" index=284>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 3  
Keywords: Benchmarking  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.01817v2" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.01817v2.pdf" filename="2404.01817v2.pdf">Download PDF</button>
...
### (1/1 | 285/327) Deterministic Search on Complete Bipartite Graphs by Continuous Time Quantum Walk (Honghong Lin et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Deterministic Search on Complete Bipartite Graphs by Continuous Time Quantum Walk" index=285>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 286/327) Robust Constrained Consensus and Inequality-constrained Distributed Optimization with Guaranteed Differential Privacy and Accurate Convergence (Yongqiang Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Robust Constrained Consensus and Inequality-constrained Distributed Optimization with Guaranteed Differential Privacy and Accurate Convergence" index=286>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/2 | 287/327) A Holistic Indicator of Polarization to Measure Online Sexism (Vahid Ghafouri et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Holistic Indicator of Polarization to Measure Online Sexism" index=287>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/2 | 288/327) How COVID-19 has Impacted the Anti-Vaccine Discourse: A Large-Scale Twitter Study Spanning Pre-COVID and Post-COVID Era (Soham Poddar et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="How COVID-19 has Impacted the Anti-Vaccine Discourse: A Large-Scale Twitter Study Spanning Pre-COVID and Post-COVID Era" index=288>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/5 | 289/327) Numerical simulation of the Gross-Pitaevskii equation via vortex tracking (Thiago Carvalho Corso et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Numerical simulation of the Gross-Pitaevskii equation via vortex tracking" index=289>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/5 | 290/327) Adaptive Gradient Enhanced Gaussian Process Surrogates for Inverse Problems (Phillip Semler et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Adaptive Gradient Enhanced Gaussian Process Surrogates for Inverse Problems" index=290>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/5 | 291/327) Comparison of Different Elastic Strain Definitions for Largely Deformed SEI of Chemo-Mechanically Coupled Silicon Battery Particles (Raphael Schoof et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Comparison of Different Elastic Strain Definitions for Largely Deformed SEI of Chemo-Mechanically Coupled Silicon Battery Particles" index=291>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/5 | 292/327) A second-order correction method for loosely coupled discretizations applied to parabolic-parabolic interface problems (Erik Burman et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A second-order correction method for loosely coupled discretizations applied to parabolic-parabolic interface problems" index=292>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/5 | 293/327) Estimates of discrete time derivatives for the parabolic-parabolic Robin-Robin coupling method (Erik Burman et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Estimates of discrete time derivatives for the parabolic-parabolic Robin-Robin coupling method" index=293>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 294/327) Emergence of Chemotactic Strategies with Multi-Agent Reinforcement Learning (Samuel Tovey et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Emergence of Chemotactic Strategies with Multi-Agent Reinforcement Learning" index=294>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/2 | 295/327) Sentiment Analysis of Citations in Scientific Articles Using ChatGPT: Identifying Potential Biases and Conflicts of Interest (Walid Hariri, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Sentiment Analysis of Citations in Scientific Articles Using ChatGPT: Identifying Potential Biases and Conflicts of Interest" index=295>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.01800v2" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.01800v2.pdf" filename="2404.01800v2.pdf">Download PDF</button>
...
### (2/2 | 296/327) The open access coverage of OpenAlex, Scopus and Web of Science (Marc-Andre Simard et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="The open access coverage of OpenAlex, Scopus and Web of Science" index=296>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 297/327) CSST Strong Lensing Preparation: a Framework for Detecting Strong Lenses in the Multi-color Imaging Survey by the China Survey Space Telescope (CSST) (Xu Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="CSST Strong Lensing Preparation: a Framework for Detecting Strong Lenses in the Multi-color Imaging Survey by the China Survey Space Telescope (CSST)" index=297>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 298/327) Robustly estimating heterogeneity in factorial data using Rashomon Partitions (Aparajithan Venkateswaran et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Robustly estimating heterogeneity in factorial data using Rashomon Partitions" index=298>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/3 | 299/327) The Meta Distribution of the SIR in Joint Communication and Sensing Networks (Kun Ma et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="The Meta Distribution of the SIR in Joint Communication and Sensing Networks" index=299>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/3 | 300/327) Learning-Based Joint Beamforming and Antenna Movement Design for Movable Antenna Systems (Caihao Weng et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Learning-Based Joint Beamforming and Antenna Movement Design for Movable Antenna Systems" index=300>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/3 | 301/327) Generating gaussian pseudorandom noise with binary sequences (Francisco-Javier Soto et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Generating gaussian pseudorandom noise with binary sequences" index=301>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/3 | 302/327) NetSmith: An Optimization Framework for Machine-Discovered Network Topologies (Conor Green et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="NetSmith: An Optimization Framework for Machine-Discovered Network Topologies" index=302>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/3 | 303/327) Analyzing the Single Event Upset Vulnerability of Binarized Neural Networks on SRAM FPGAs (Ioanna Souvatzoglou et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Analyzing the Single Event Upset Vulnerability of Binarized Neural Networks on SRAM FPGAs" index=303>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/3 | 304/327) A Fully-Configurable Open-Source Software-Defined Digital Quantized Spiking Neural Core Architecture (Shadi Matinizadeh et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Fully-Configurable Open-Source Software-Defined Digital Quantized Spiking Neural Core Architecture" index=304>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/9 | 305/327) A neural network-based approach to hybrid systems identification for control (Filippo Fabiani et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A neural network-based approach to hybrid systems identification for control" index=305>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/9 | 306/327) On the Regret of Recursive Methods for Discrete-Time Adaptive Control with Matched Uncertainty (Aren Karapetyan et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="On the Regret of Recursive Methods for Discrete-Time Adaptive Control with Matched Uncertainty" index=306>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/9 | 307/327) On the Effect of Quantization on Dynamic Mode Decomposition (Dipankar Maity et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="On the Effect of Quantization on Dynamic Mode Decomposition" index=307>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/9 | 308/327) Learning-based model augmentation with LFRs (Jan H. Hoekstra et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Learning-based model augmentation with LFRs" index=308>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/9 | 309/327) Integrating SystemC-AMS Power Modeling with a RISC-V ISS for Virtual Prototyping of Battery-operated Embedded Devices (Mohamed Amine Hamdi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Integrating SystemC-AMS Power Modeling with a RISC-V ISS for Virtual Prototyping of Battery-operated Embedded Devices" index=309>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (6/9 | 310/327) Identifying the Largest RoCoF and Its Implications (Licheng Wang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Identifying the Largest RoCoF and Its Implications" index=310>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (7/9 | 311/327) Real-Time Hybrid Simulation for Infrastructure Degradation Assessment: Conceptual Framework and Illustrative Application (Manuel Salmeron et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Real-Time Hybrid Simulation for Infrastructure Degradation Assessment: Conceptual Framework and Illustrative Application" index=311>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (8/9 | 312/327) On the reduction of Linear Parameter-Varying State-Space models (E. Javier Olucha et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="On the reduction of Linear Parameter-Varying State-Space models" index=312>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (9/9 | 313/327) A Stability-Based Abstraction Framework for Reach-Avoid Control of Stochastic Dynamical Systems with Unknown Noise Distributions (Thom Badings et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Stability-Based Abstraction Framework for Reach-Avoid Control of Stochastic Dynamical Systems with Unknown Noise Distributions" index=313>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 314/327) Learning Intersections of Halfspaces with Distribution Shift: Improved Algorithms and SQ Lower Bounds (Adam R. Klivans et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Learning Intersections of Halfspaces with Distribution Shift: Improved Algorithms and SQ Lower Bounds" index=314>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/2 | 315/327) MuxServe: Flexible Multiplexing for Efficient Multiple LLM Serving (Jiangfei Duan et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="MuxServe: Flexible Multiplexing for Efficient Multiple LLM Serving" index=315>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/2 | 316/327) A shared compilation stack for distributed-memory parallelism in stencil DSLs (George Bisbas et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A shared compilation stack for distributed-memory parallelism in stencil DSLs" index=316>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 317/327) Fluid Implicit Particle Simulation for CPU and GPU (Pedro Centeno et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Fluid Implicit Particle Simulation for CPU and GPU" index=317>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 318/327) Hyperviscosity stabilisation of the RBF-FD solution to natural convection (Žiga Vaupotič et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Hyperviscosity stabilisation of the RBF-FD solution to natural convection" index=318>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/2 | 319/327) Satellite Federated Edge Learning: Architecture Design and Convergence Analysis (Yuanming Shi et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Satellite Federated Edge Learning: Architecture Design and Convergence Analysis" index=319>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/2 | 320/327) Intelligent Reflecting Surfaces assisted Laser-based Optical Wireless Communication Networks (Ahrar N. Hamad et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Intelligent Reflecting Surfaces assisted Laser-based Optical Wireless Communication Networks" index=320>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 321/327) A multicore parallel algorithm for multiscale modelling of an entire human blood circulation network (Jiawei Liu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A multicore parallel algorithm for multiscale modelling of an entire human blood circulation network" index=321>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 322/327) Transformers as Transducers (Lena Strobl et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Transformers as Transducers" index=322>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/2 | 323/327) FLEXIS: FLEXible Frequent Subgraph Mining using Maximal Independent Sets (Akshit Sharma et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="FLEXIS: FLEXible Frequent Subgraph Mining using Maximal Independent Sets" index=323>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/2 | 324/327) Heterogeneous Data Access Model for Concurrency Control and Methods to Deal with High Data Contention (Alexander Thomasian, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Heterogeneous Data Access Model for Concurrency Control and Methods to Deal with High Data Contention" index=324>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 325/327) The edge code of hypergraphs (Delio Jaramillo-Velez, 2024)
...
<br/>
<button class="copy-to-clipboard" title="The edge code of hypergraphs" index=325>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 326/327) Generalized saturation game (Balázs Patkós et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Generalized saturation game" index=326>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 327/327) A Temporal Graph Model to Study the Dynamics of Collective Behavior and Performance in Team Sports: An Application to Basketball (Quentin Bourgeais et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Temporal Graph Model to Study the Dynamics of Collective Behavior and Performance in Team Sports: An Application to Basketball" index=327>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
