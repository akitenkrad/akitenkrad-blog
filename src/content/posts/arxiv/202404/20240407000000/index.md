...
### (1/11 | 1/173) Increased LLM Vulnerabilities from Fine-tuning and Quantization (Divyanshu Kumar et al., 2024)
...
### (2/11 | 2/173) AuditGPT: Auditing Smart Contracts with ChatGPT (Shihao Xia et al., 2024)
...
### (3/11 | 3/173) Evaluating Adversarial Robustness: A Comparison Of FGSM, Carlini-Wagner Attacks, And The Role of Distillation as Defense Mechanism (Trilokesh Ranjan Sarkar et al., 2024)
...
### (4/11 | 4/173) Re-pseudonymization Strategies for Smart Meter Data Are Not Robust to Deep Learning Profiling Attacks (Ana-Maria Cretu et al., 2024)
...
### (5/11 | 5/173) Reliable Feature Selection for Adversarially Robust Cyber-Attack Detection (João Vitorino et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Reliable Feature Selection for Adversarially Robust Cyber-Attack Detection" index=5>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (6/11 | 6/173) Watermark-based Detection and Attribution of AI-Generated Content (Zhengyuan Jiang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Watermark-based Detection and Attribution of AI-Generated Content" index=6>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (7/11 | 7/173) Precision Guided Approach to Mitigate Data Poisoning Attacks in Federated Learning (K Naveen Kumar et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Precision Guided Approach to Mitigate Data Poisoning Attacks in Federated Learning" index=7>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (8/11 | 8/173) You Can Use But Cannot Recognize: Preserving Visual Privacy in Deep Neural Networks (Qiushi Li et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="You Can Use But Cannot Recognize: Preserving Visual Privacy in Deep Neural Networks" index=8>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (9/11 | 9/173) From Theory to Comprehension: A Comparative Study of Differential Privacy and $k$-Anonymity (Saskia Nuñez von Voigt et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="From Theory to Comprehension: A Comparative Study of Differential Privacy and $k$-Anonymity" index=9>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (10/11 | 10/173) PrivShape: Extracting Shapes in Time Series under User-Level Local Differential Privacy (Yulian Mao et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="PrivShape: Extracting Shapes in Time Series under User-Level Local Differential Privacy" index=10>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (11/11 | 11/173) Smart Contract Languages: a comparative analysis (Massimo Bartoletti et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Smart Contract Languages: a comparative analysis" index=11>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/27 | 12/173) Deciphering Political Entity Sentiment in News with Large Language Models: Zero-Shot and Few-Shot Strategies (Alapan Kuila et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Deciphering Political Entity Sentiment in News with Large Language Models: Zero-Shot and Few-Shot Strategies" index=12>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (2/27 | 13/173) Assisting humans in complex comparisons: automated information comparison at scale (Truman Yuen et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Assisting humans in complex comparisons: automated information comparison at scale" index=13>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (3/27 | 14/173) Teaching Llama a New Language Through Cross-Lingual Knowledge Transfer (Hele-Andra Kuulmets et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Teaching Llama a New Language Through Cross-Lingual Knowledge Transfer" index=14>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (4/27 | 15/173) Extract, Define, Canonicalize: An LLM-based Framework for Knowledge Graph Construction (Bowen Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Extract, Define, Canonicalize: An LLM-based Framework for Knowledge Graph Construction" index=15>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (5/27 | 16/173) Simple Techniques for Enhancing Sentence Embeddings in Generative Language Models (Bowen Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Simple Techniques for Enhancing Sentence Embeddings in Generative Language Models" index=16>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (6/27 | 17/173) Cleared for Takeoff? Compositional & Conditional Reasoning may be the Achilles Heel to (Flight-Booking) Language Agents (Harsh Kohli et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Cleared for Takeoff? Compositional & Conditional Reasoning may be the Achilles Heel to (Flight-Booking) Language Agents" index=17>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (7/27 | 18/173) FFN-SkipLLM: A Hidden Gem for Autoregressive Decoding with Adaptive Feed Forward Skipping (Ajay Jaiswal et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="FFN-SkipLLM: A Hidden Gem for Autoregressive Decoding with Adaptive Feed Forward Skipping" index=18>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (8/27 | 19/173) SEME at SemEval-2024 Task 2: Comparing Masked and Generative Language Models on Natural Language Inference for Clinical Trials (Mathilde Aguiar et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="SEME at SemEval-2024 Task 2: Comparing Masked and Generative Language Models on Natural Language Inference for Clinical Trials" index=19>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (9/27 | 20/173) BuDDIE: A Business Document Dataset for Multi-task Information Extraction (Ran Zmigrod et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="BuDDIE: A Business Document Dataset for Multi-task Information Extraction" index=20>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (10/27 | 21/173) Unlocking Parameter-Efficient Fine-Tuning for Low-Resource Language Translation (Tong Su et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Unlocking Parameter-Efficient Fine-Tuning for Low-Resource Language Translation" index=21>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (11/27 | 22/173) Investigating the Robustness of Modelling Decisions for Few-Shot Cross-Topic Stance Detection: A Preregistered Study (Myrthe Reuver et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Investigating the Robustness of Modelling Decisions for Few-Shot Cross-Topic Stance Detection: A Preregistered Study" index=22>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (12/27 | 23/173) Scope Ambiguities in Large Language Models (Gaurav Kamath et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Scope Ambiguities in Large Language Models" index=23>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (13/27 | 24/173) Do Sentence Transformers Learn Quasi-Geospatial Concepts from General Text? (Ilya Ilyankou et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Do Sentence Transformers Learn Quasi-Geospatial Concepts from General Text?" index=24>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (14/27 | 25/173) Data Augmentation with In-Context Learning and Comparative Evaluation in Math Word Problem Solving (Gulsum Yigit et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Data Augmentation with In-Context Learning and Comparative Evaluation in Math Word Problem Solving" index=25>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (15/27 | 26/173) Forget NLI, Use a Dictionary: Zero-Shot Topic Classification for Low-Resource Languages with Application to Luxembourgish (Fred Philippy et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Forget NLI, Use a Dictionary: Zero-Shot Topic Classification for Low-Resource Languages with Application to Luxembourgish" index=26>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (16/27 | 27/173) SAAS: Solving Ability Amplification Strategy for Enhanced Mathematical Reasoning in Large Language Models (Hyeonwoo Kim et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="SAAS: Solving Ability Amplification Strategy for Enhanced Mathematical Reasoning in Large Language Models" index=27>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (17/27 | 28/173) Towards Realistic Few-Shot Relation Extraction: A New Meta Dataset and Evaluation (Fahmida Alam et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Towards Realistic Few-Shot Relation Extraction: A New Meta Dataset and Evaluation" index=28>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (18/27 | 29/173) Verifiable by Design: Aligning Language Models to Quote from Pre-Training Data (Jingyu Zhang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Verifiable by Design: Aligning Language Models to Quote from Pre-Training Data" index=29>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (19/27 | 30/173) Benchmarking and Improving Compositional Generalization of Multi-aspect Controllable Text Generation (Tianqi Zhong et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Benchmarking and Improving Compositional Generalization of Multi-aspect Controllable Text Generation" index=30>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (20/27 | 31/173) Chinese Tiny LLM: Pretraining a Chinese-Centric Large Language Model (Xinrun Du et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Chinese Tiny LLM: Pretraining a Chinese-Centric Large Language Model" index=31>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04167v2" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04167v2.pdf" filename="2404.04167v2.pdf">Download PDF</button>
...
### (21/27 | 32/173) CLUE: A Clinical Language Understanding Evaluation for LLMs (Amin Dada et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="CLUE: A Clinical Language Understanding Evaluation for LLMs" index=32>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (22/27 | 33/173) Assessing the quality of information extraction (Filip Seitl et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Assessing the quality of information extraction" index=33>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (23/27 | 34/173) Willkommens-Merkel, Chaos-Johnson, and Tore-Klose: Modeling the Evaluative Meaning of German Personal Name Compounds (Annerose Eichel et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Willkommens-Merkel, Chaos-Johnson, and Tore-Klose: Modeling the Evaluative Meaning of German Personal Name Compounds" index=34>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (24/27 | 35/173) How Lexical is Bilingual Lexicon Induction? (Harsh Kohli et al., 2024)

{{<citation>}}

Harsh Kohli, Helian Feng, Nicholas Dronen, Calvin McCarter, Sina Moeini, Ali Kebarighotbi. (2024)  
**How Lexical is Bilingual Lexicon Induction?**
<br/>
<button class="copy-to-clipboard" title="How Lexical is Bilingual Lexicon Induction?" index=35>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04221v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04221v1.pdf" filename="2404.04221v1.pdf">Download PDF</button>
...
### (25/27 | 36/173) Social Skill Training with Large Language Models (Diyi Yang et al., 2024)

{{<citation>}}

Diyi Yang, Caleb Ziems, William Held, Omar Shaikh, Michael S. Bernstein, John Mitchell. (2024)  
**Social Skill Training with Large Language Models**
<br/>
<button class="copy-to-clipboard" title="Social Skill Training with Large Language Models" index=36>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04204v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04204v1.pdf" filename="2404.04204v1.pdf">Download PDF</button>
...
### (26/27 | 37/173) BEAR: A Unified Framework for Evaluating Relational Knowledge in Causal and Masked Language Models (Jacek Wiland et al., 2024)

{{<citation>}}

Jacek Wiland, Max Ploner, Alan Akbik. (2024)  
**BEAR: A Unified Framework for Evaluating Relational Knowledge in Causal and Masked Language Models**
<br/>
<button class="copy-to-clipboard" title="BEAR: A Unified Framework for Evaluating Relational Knowledge in Causal and Masked Language Models" index=37>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04113v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04113v1.pdf" filename="2404.04113v1.pdf">Download PDF</button>
...
### (27/27 | 38/173) A Bi-consolidating Model for Joint Relational Triple Extraction (Xiaocheng Luo et al., 2024)

{{<citation>}}

Xiaocheng Luo, Yanping Chen, Ruixue Tang, Ruizhang Huang, Yongbin Qin. (2024)  
**A Bi-consolidating Model for Joint Relational Triple Extraction**
<br/>
<button class="copy-to-clipboard" title="A Bi-consolidating Model for Joint Relational Triple Extraction" index=38>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.03881v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.03881v1.pdf" filename="2404.03881v1.pdf">Download PDF</button>
...
### (1/35 | 39/173) Enhancing Breast Cancer Diagnosis in Mammography: Evaluation and Integration of Convolutional Neural Networks and Explainable AI (Maryam Ahmed et al., 2024)

{{<citation>}}

Maryam Ahmed, Tooba Bibi, Rizwan Ahmed Khan, Sidra Nasir. (2024)  
**Enhancing Breast Cancer Diagnosis in Mammography: Evaluation and Integration of Convolutional Neural Networks and Explainable AI**
<br/>
<button class="copy-to-clipboard" title="Enhancing Breast Cancer Diagnosis in Mammography: Evaluation and Integration of Convolutional Neural Networks and Explainable AI" index=39>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 91  
Keywords: Black Box, Convolution, Convolutional Neural Network, Convolutional Neural Network, Data Augmentation, Explainable AI, Fairness, Fine-tuning, Multi-modal, Multi-modal, Transfer Learning  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.03892v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.03892v1.pdf" filename="2404.03892v1.pdf">Download PDF</button>

---


**ABSTRACT**  
The study introduces an integrated framework combining <b>Convolutional</b> <b>Neural</b> <b>Networks</b> <b>(CNNs)</b> and <b>Explainable</b> <b>Artificial</b> Intelligence (XAI) for the enhanced diagnosis of breast cancer using the CBIS-DDSM dataset. Utilizing a <b>fine-tuned</b> ResNet50 architecture, our investigation not only provides effective differentiation of mammographic images into benign and malignant categories but also addresses the opaque <b>"black-box"</b> <b>nature</b> of deep learning models by employing XAI methodologies, namely Grad-CAM, LIME, and SHAP, to interpret <b>CNN</b> decision-making processes for healthcare professionals. Our methodology encompasses an elaborate <b>data</b> <b>preprocessing</b> pipeline and advanced <b>data</b> <b>augmentation</b> techniques to counteract dataset limitations, and <b>transfer</b> <b>learning</b> using pre-trained networks, such as VGG-16, DenseNet and ResNet was employed. A focal point of our study is the evaluation of XAI's effectiveness in interpreting model predictions, highlighted by utilising the Hausdorff measure to assess the alignment between AI-generated explanations and expert annotations quantitatively. This approach plays a critical role for XAI in promoting trustworthiness and ethical <b>fairness</b> in AI-assisted diagnostics. The findings from our research illustrate the effective collaboration between <b>CNNs</b> and XAI in advancing diagnostic methods for breast cancer, thereby facilitating a more seamless integration of advanced AI technologies within clinical settings. By enhancing the interpretability of AI-driven decisions, this work lays the groundwork for improved collaboration between AI systems and medical practitioners, ultimately enriching patient care. Furthermore, the implications of our research extend well beyond the current methodologies, advocating for subsequent inquiries into the integration of <b>multimodal</b> <b>data</b> <b>and</b> the refinement of AI explanations to satisfy the needs of clinical practice.

{{</citation>}}


### (2/35 | 40/173) Vision Transformers in Domain Adaptation and Generalization: A Study of Robustness (Shadi Alijani et al., 2024)

{{<citation>}}

Shadi Alijani, Jamil Fayyad, Homayoun Najjaran. (2024)  
**Vision Transformers in Domain Adaptation and Generalization: A Study of Robustness**
<br/>
<button class="copy-to-clipboard" title="Vision Transformers in Domain Adaptation and Generalization: A Study of Robustness" index=40>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 53  
Keywords: Benchmarking, Self-supervised Learning, Zero-shot, Question Answering, Reasoning, Large Language Model  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04346v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04346v1.pdf" filename="2404.04346v1.pdf">Download PDF</button>
...
### (4/35 | 42/173) Image-Text Co-Decomposition for Text-Supervised Semantic Segmentation (Ji-Jia Wu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Image-Text Co-Decomposition for Text-Supervised Semantic Segmentation" index=42>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 50  
Keywords: Diffusion Model, Online Reinforcement Learning, Reinforcement Learning, Text2image, Prompt  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04095v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04095v1.pdf" filename="2404.04095v1.pdf">Download PDF</button>
...
### (6/35 | 44/173) Learning Correlation Structures for Vision Transformers (Manjin Kim et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Learning Correlation Structures for Vision Transformers" index=44>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Categories: cs-CV, cs.CV  
Keyword Score: 50  
Keywords: Vision Transformer, Convolution, Transformer, Self-Attention, Vision Transformer  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.03924v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.03924v1.pdf" filename="2404.03924v1.pdf">Download PDF</button>
...
### (7/35 | 45/173) Sigma: Siamese Mamba Network for Multi-Modal Semantic Segmentation (Zifu Wan et al., 2024)

{{<citation>}}

Zifu Wan, Yuhao Wang, Silong Yong, Pingping Zhang, Simon Stepputtis, Katia Sycara, Yaqi Xie. (2024)  
**Sigma: Siamese Mamba Network for Multi-Modal Semantic Segmentation**
<br/>
<button class="copy-to-clipboard" title="Sigma: Siamese Mamba Network for Multi-Modal Semantic Segmentation" index=45>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<br/>
<button class="copy-to-clipboard" title="DiffOp-net: A Differential Operator-based Fully Convolutional Network for Unsupervised Deformable Image Registration" index=46>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 33  
Keywords: Benchmarking, Few-shot, Few-shot Learning, Pruning  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04434v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04434v1.pdf" filename="2404.04434v1.pdf">Download PDF</button>
...
### (11/35 | 49/173) Identity Decoupling for Multi-Subject Personalization of Text-to-Image Models (Sangwon Jang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Identity Decoupling for Multi-Subject Personalization of Text-to-Image Models" index=49>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Categories: cs-AI, cs-CV, cs.CV  
Keyword Score: 30  
Keywords: Diffusion Model, Data Augmentation, Text2image  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04243v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04243v1.pdf" filename="2404.04243v1.pdf">Download PDF</button>
...
### (12/35 | 50/173) Physical Property Understanding from Language-Embedded Feature Fields (Albert J. Zhai et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Physical Property Understanding from Language-Embedded Feature Fields" index=50>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04242v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04242v1.pdf" filename="2404.04242v1.pdf">Download PDF</button>
...
### (13/35 | 51/173) RaSim: A Range-aware High-fidelity RGB-D Data Simulation Pipeline for Real-world Applications (Xingyu Liu et al., 2024)

{{<citation>}}

Xingyu Liu, Chenyangguang Zhang, Gu Wang, Ruida Zhang, Xiangyang Ji. (2024)  
**RaSim: A Range-aware High-fidelity RGB-D Data Simulation Pipeline for Real-world Applications**
<br/>
<button class="copy-to-clipboard" title="RaSim: A Range-aware High-fidelity RGB-D Data Simulation Pipeline for Real-world Applications" index=51>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.03962v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.03962v1.pdf" filename="2404.03962v1.pdf">Download PDF</button>
...
### (14/35 | 52/173) Concept Weaver: Enabling Multi-Concept Fusion in Text-to-Image Models (Gihyun Kwon et al., 2024)

{{<citation>}}

Gihyun Kwon, Simon Jenni, Dingzeyu Li, Joon-Young Lee, Jong Chul Ye, Fabian Caba Heilbron. (2024)  
**Concept Weaver: Enabling Multi-Concept Fusion in Text-to-Image Models**
<br/>
<button class="copy-to-clipboard" title="Concept Weaver: Enabling Multi-Concept Fusion in Text-to-Image Models" index=52>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.03913v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.03913v1.pdf" filename="2404.03913v1.pdf">Download PDF</button>

---


**ABSTRACT**  
While there has been significant progress in customizing <b>text-to-image</b> generation models, generating images that combine multiple personalized concepts remains challenging. In this work, we introduce Concept Weaver, a method for composing customized <b>text-to-image</b> <b>diffusion</b> <b>models</b> at inference time. Specifically, the method breaks the process into two steps: creating a template image aligned with the semantics of input <b>prompts,</b> and then personalizing the template using a concept fusion strategy. The fusion strategy incorporates the appearance of the target concepts into the template image while retaining its structural details. The results indicate that our method can generate multiple custom concepts with higher identity fidelity compared to alternative approaches. Furthermore, the method is shown to seamlessly handle more than two concepts and closely follow the semantic meaning of the input <b>prompt</b> without blending appearances across different subjects.

{{</citation>}}


### (15/35 | 53/173) Idea-2-3D: Collaborative LMM Agents Enable 3D Model Generation from Interleaved Multimodal Inputs (Junhao Chen et al., 2024)

{{<citation>}}

Junhao Chen, Xiang Li, Xiaojun Ye, Chao Li, Zhaoxin Fan, Hao Zhao. (2024)  
**Idea-2-3D: Collaborative LMM Agents Enable 3D Model Generation from Interleaved Multimodal Inputs**
<br/>
<button class="copy-to-clipboard" title="Idea-2-3D: Collaborative LMM Agents Enable 3D Model Generation from Interleaved Multimodal Inputs" index=53>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Categories: cs-CV, cs.CV  
Keyword Score: 26  
Keywords: Human Intervention, Multi-modal, Multi-modal, Prompt  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04363v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04363v1.pdf" filename="2404.04363v1.pdf">Download PDF</button>
...
### (16/35 | 54/173) 3D Facial Expressions through Analysis-by-Neural-Synthesis (George Retsinas et al., 2024)

{{<citation>}}

George Retsinas, Panagiotis P. Filntisis, Radek Danecek, Victoria F. Abrevaya, Anastasios Roussos, Timo Bolkart, Petros Maragos. (2024)  
**3D Facial Expressions through Analysis-by-Neural-Synthesis**
<br/>
<button class="copy-to-clipboard" title="3D Facial Expressions through Analysis-by-Neural-Synthesis" index=54>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Categories: cs-CV, cs-LG, cs.CV  
Keyword Score: 23  
Keywords: Graph, Zero-shot, Vision-and-Language  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04072v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04072v1.pdf" filename="2404.04072v1.pdf">Download PDF</button>
...
### (19/35 | 57/173) Neural-Symbolic VideoQA: Learning Compositional Spatio-Temporal Reasoning for Real-world Video Question Answering (Lili Liang et al., 2024)

{{<citation>}}

Lili Liang, Guanglu Sun, Jin Qiu, Lizhong Zhang. (2024)  
**Neural-Symbolic VideoQA: Learning Compositional Spatio-Temporal Reasoning for Real-world Video Question Answering**
<br/>
<button class="copy-to-clipboard" title="Neural-Symbolic VideoQA: Learning Compositional Spatio-Temporal Reasoning for Real-world Video Question Answering" index=57>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<br/>
<button class="copy-to-clipboard" title="PhysPT: Physics-aware Pretrained Transformer for Estimating Human Dynamics from Monocular Videos" index=59>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Categories: cs-CV, cs.CV  
Keyword Score: 20  
Keywords: Self-supervised Learning, Transformer  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04430v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04430v1.pdf" filename="2404.04430v1.pdf">Download PDF</button>
...
### (22/35 | 60/173) No Time to Train: Empowering Non-Parametric Networks for Few-shot 3D Scene Segmentation (Xiangyang Zhu et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="No Time to Train: Empowering Non-Parametric Networks for Few-shot 3D Scene Segmentation" index=60>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04050v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04050v1.pdf" filename="2404.04050v1.pdf">Download PDF</button>

---


**ABSTRACT**  
To reduce the reliance on large-scale datasets, recent works in 3D segmentation resort to <b>few-shot</b> <b>learning.</b> Current 3D <b>few-shot</b> <b>segmentation</b> methods first pre-train models on 'seen' classes, and then evaluate their generalization performance on 'unseen' classes. However, the prior pre-training stage not only introduces excessive time overhead but also incurs a significant domain gap on 'unseen' classes. To tackle these issues, we propose a Non-parametric Network for <b>few-shot</b> <b>3D</b> Segmentation, Seg-NN, and its Parametric variant, Seg-PN. Without training, Seg-NN extracts dense representations by hand-crafted filters and achieves comparable performance to existing parametric models. Due to the elimination of pre-training, Seg-NN can alleviate the domain gap issue and save a substantial amount of time. Based on Seg-NN, Seg-PN only requires training a lightweight QUEry-Support Transferring (QUEST) module, which enhances the interaction between the support set and query set. Experiments suggest that Seg-PN outperforms previous state-of-the-art method by +4.19% and +7.71% mIoU on S3DIS and ScanNet datasets respectively, while reducing training time by -90%, indicating its effectiveness and efficiency.

{{</citation>}}


### (23/35 | 61/173) InstructHumans: Editing Animated 3D Human Textures with Instructions (Jiayin Zhu et al., 2024)

{{<citation>}}

Jiayin Zhu, Linlin Yang, Angela Yao. (2024)  
**InstructHumans: Editing Animated 3D Human Textures with Instructions**
<br/>
<button class="copy-to-clipboard" title="InstructHumans: Editing Animated 3D Human Textures with Instructions" index=61>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04037v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04037v1.pdf" filename="2404.04037v1.pdf">Download PDF</button>
...
### (24/35 | 62/173) VoltaVision: A Transfer Learning model for electronic component classification (Anas Mohammad Ishfaqul Muktadir Osmani et al., 2024)

{{<citation>}}

Anas Mohammad Ishfaqul Muktadir Osmani, Taimur Rahman, Salekul Islam. (2024)  
**VoltaVision: A Transfer Learning model for electronic component classification**
<br/>
<button class="copy-to-clipboard" title="VoltaVision: A Transfer Learning model for electronic component classification" index=62>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.03898v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.03898v1.pdf" filename="2404.03898v1.pdf">Download PDF</button>

---


**ABSTRACT**  
In this paper, we analyze the effectiveness of <b>transfer</b> <b>learning</b> on classifying electronic components. <b>Transfer</b> <b>learning</b> reuses pre-trained models to save time and resources in building a robust classifier rather than learning from scratch. Our work introduces a lightweight <b>CNN,</b> coined as VoltaVision, and compares its performance against more complex models. We test the hypothesis that transferring knowledge from a similar task to our target domain yields better results than state-of-the-art models trained on general datasets. Our dataset and code for this work are available at https://github.com/AnasIshfaque/VoltaVision.

{{</citation>}}


### (25/35 | 63/173) Increasing Fairness in Classification of Out of Distribution Data for Facial Recognition (Gianluca Barone et al., 2024)

{{<citation>}}

Gianluca Barone, Aashrit Cunchala, Rudy Nunez. (2024)  
**Increasing Fairness in Classification of Out of Distribution Data for Facial Recognition**
<br/>
<button class="copy-to-clipboard" title="Increasing Fairness in Classification of Out of Distribution Data for Facial Recognition" index=63>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 20  
Keywords: Fairness, Out-of-distribution  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.03876v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.03876v1.pdf" filename="2404.03876v1.pdf">Download PDF</button>

---


**ABSTRACT**  
Standard classification theory assumes that the distribution of images in the test and training sets are identical. Unfortunately, real-life scenarios typically feature unseen data <b>("out-of-distribution</b> data") which is different from data in the training distribution("in-distribution"). This issue is most prevalent in social justice problems where data from under-represented groups may appear in the test data without representing an equal proportion of the training data. This may result in a model returning confidently wrong decisions and predictions. We are interested in the following question: Can the performance of a neural network improve on facial images of <b>out-of-distribution</b> data when it is trained simultaneously on multiple datasets of in-distribution data? We approach this problem by incorporating the Outlier Exposure model and investigate how the model's performance changes when other datasets of facial images were implemented. We observe that the accuracy and other metrics of the model can be increased by applying Outlier Exposure, incorporating a trainable weight parameter to increase the machine's emphasis on outlier images, and by re-weighting the importance of different class labels. We also experimented with whether sorting the images and determining outliers via image features would have more of an effect on the metrics than sorting by average pixel value. Our goal was to make models not only more accurate but also more fair by scanning a more expanded range of images. We also tested the datasets in reverse order to see whether a more fair dataset with balanced features has an effect on the model's accuracy.

{{</citation>}}


### (26/35 | 64/173) Improving Detection in Aerial Images by Capturing Inter-Object Relationships (Botao Ren et al., 2024)

{{<citation>}}

Botao Ren, Botian Xu, Yifan Pu, Jingyi Wang, Zhidong Deng. (2024)  
**Improving Detection in Aerial Images by Capturing Inter-Object Relationships**
<br/>
<button class="copy-to-clipboard" title="Improving Detection in Aerial Images by Capturing Inter-Object Relationships" index=64>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04140v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04140v1.pdf" filename="2404.04140v1.pdf">Download PDF</button>
...
### (27/35 | 65/173) Analyzing Participants' Engagement during Online Meetings Using Unsupervised Remote Photoplethysmography with Behavioral Features (Alexander Vedernikov et al., 2024)

{{<citation>}}

Alexander Vedernikov, Zhaodong Sun, Virpi-Liisa Kykyri, Mikko Pohjola, Miriam Nokia, Xiaobai Li. (2024)  
...
<br/>
<button class="copy-to-clipboard" title="Analyzing Participants' Engagement during Online Meetings Using Unsupervised Remote Photoplethysmography with Behavioral Features" index=65>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04394v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04394v1.pdf" filename="2404.04394v1.pdf">Download PDF</button>
...
### (28/35 | 66/173) SpatialTracker: Tracking Any 2D Pixels in 3D Space (Yuxi Xiao et al., 2024)

{{<citation>}}

Yuxi Xiao, Qianqian Wang, Shangzhan Zhang, Nan Xue, Sida Peng, Yujun Shen, Xiaowei Zhou. (2024)  
**SpatialTracker: Tracking Any 2D Pixels in 3D Space**
<br/>
<button class="copy-to-clipboard" title="SpatialTracker: Tracking Any 2D Pixels in 3D Space" index=66>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04319v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04319v1.pdf" filename="2404.04319v1.pdf">Download PDF</button>
...
### (29/35 | 67/173) Robust Depth Enhancement via Polarization Prompt Fusion Tuning (Kei Ikemura et al., 2024)

{{<citation>}}

Kei Ikemura, Yiming Huang, Felix Heide, Zhaoxiang Zhang, Qifeng Chen, Chenyang Lei. (2024)  
**Robust Depth Enhancement via Polarization Prompt Fusion Tuning**
<br/>
<button class="copy-to-clipboard" title="Robust Depth Enhancement via Polarization Prompt Fusion Tuning" index=67>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 10  
Keywords: Prompt  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04318v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04318v1.pdf" filename="2404.04318v1.pdf">Download PDF</button>
...
### (30/35 | 68/173) SCAResNet: A ResNet Variant Optimized for Tiny Object Detection in Transmission and Distribution Towers (Weile Li et al., 2024)

{{<citation>}}

Weile Li, Muqing Shi, Zhonghua Hong. (2024)  
**SCAResNet: A ResNet Variant Optimized for Tiny Object Detection in Transmission and Distribution Towers**
<br/>
<button class="copy-to-clipboard" title="SCAResNet: A ResNet Variant Optimized for Tiny Object Detection in Transmission and Distribution Towers" index=68>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04155v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04155v1.pdf" filename="2404.04155v1.pdf">Download PDF</button>
...
### (32/35 | 70/173) Dynamic Risk Assessment Methodology with an LDM-based System for Parking Scenarios (Paola Natalia Cañas et al., 2024)

{{<citation>}}

Paola Natalia Cañas, Mikel García, Nerea Aranjuelo, Marcos Nieto, Aitor Iglesias, Igor Rodríguez. (2024)  
**Dynamic Risk Assessment Methodology with an LDM-based System for Parking Scenarios**
<br/>
<button class="copy-to-clipboard" title="Dynamic Risk Assessment Methodology with an LDM-based System for Parking Scenarios" index=70>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
---
Primary Category: cs.CV  
Categories: cs-CV, cs-SY, cs.CV, eess-SY  
Keyword Score: 6  
Keywords: Benchmarking, Benchmarking  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04040v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04040v1.pdf" filename="2404.04040v1.pdf">Download PDF</button>
...
### (33/35 | 71/173) Finsler-Laplace-Beltrami Operators with Application to Shape Analysis (Simon Weber et al., 2024)

{{<citation>}}

Simon Weber, Thomas Dagès, Maolin Gao, Daniel Cremers. (2024)  
**Finsler-Laplace-Beltrami Operators with Application to Shape Analysis**
<br/>
<button class="copy-to-clipboard" title="Finsler-Laplace-Beltrami Operators with Application to Shape Analysis" index=71>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 3  
Keywords: Benchmarking  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04211v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04211v1.pdf" filename="2404.04211v1.pdf">Download PDF</button>

---


**ABSTRACT**  
In this paper, we address common error sources for 3D Gaussian Splatting (3DGS) including blur, imperfect camera poses, and color inconsistencies, with the goal of improving its robustness for practical applications like reconstructions from handheld phone captures. Our main contribution involves modeling motion blur as a Gaussian distribution over camera poses, allowing us to address both camera pose refinement and motion blur correction in a unified way. Additionally, we propose mechanisms for defocus blur compensation and for addressing color in-consistencies caused by ambient light, shadows, or due to camera-related factors like varying white balancing settings. Our proposed solutions integrate in a seamless way with the 3DGS formulation while maintaining its benefits in terms of training efficiency and rendering speed. We experimentally validate our contributions on relevant <b>benchmark</b> datasets including Scannet++ and Deblur-NeRF, obtaining state-of-the-art results and thus consistent improvements over relevant baselines.

{{</citation>}}


### (35/35 | 73/173) Noisy Label Processing for Classification: A Survey (Mengting Li et al., 2024)

{{<citation>}}

Mengting Li, Chuang Zhu. (2024)  
**Noisy Label Processing for Classification: A Survey**
<br/>
<button class="copy-to-clipboard" title="Noisy Label Processing for Classification: A Survey" index=73>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/14 | 74/173) Can only LLMs do Reasoning?: Potential of Small Language Models in Task Planning (Gawon Choi et al., 2024)

{{<citation>}}

Gawon Choi, Hyemin Ahn. (2024)  
**Can only LLMs do Reasoning?: Potential of Small Language Models in Task Planning**
<br/>
<button class="copy-to-clipboard" title="Can only LLMs do Reasoning?: Potential of Small Language Models in Task Planning" index=74>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 90  
Keywords: Fine-tuning, GPT-2, GPT-3, GPT-3.5, GPT-4, Reasoning, Large Language Model, Large Language Model, Prompt  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.03891v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.03891v1.pdf" filename="2404.03891v1.pdf">Download PDF</button>

---


**ABSTRACT**  
In robotics, the use of <b>Large</b> <b>Language</b> <b>Models</b> <b>(LLMs)</b> is becoming prevalent, especially for understanding human commands. In particular, <b>LLMs</b> are utilized as domain-agnostic task planners for high-level human commands. <b>LLMs</b> are capable of Chain-of-Thought (CoT) <b>reasoning,</b> and this allows <b>LLMs</b> to be task planners. However, we need to consider that modern robots still struggle to perform complex actions, and the domains where robots can be deployed are limited in practice. This leads us to pose a question: If small LMs can be trained to reason in chains within a single domain, would even small LMs be good task planners for the robots? To train smaller LMs to reason in chains, we build `COmmand-STeps datasets' (COST) consisting of high-level commands along with corresponding actionable low-level steps, via <b>LLMs.</b> We release not only our datasets but also the <b>prompt</b> templates used to generate them, to allow anyone to build datasets for their domain. We compare <b>GPT3.5</b> and <b>GPT4</b> with the <b>finetuned</b> <b>GPT2</b> for task domains, in tabletop and kitchen environments, and the result shows that <b>GPT2-medium</b> is comparable to <b>GPT3.5</b> for task planning in a specific domain. Our dataset, code, and more output samples can be found in https://github.com/Gawon-Choi/small-LMs-Task-Planning

{{</citation>}}


### (2/14 | 75/173) VoicePilot: Harnessing LLMs as Speech Interfaces for Physically Assistive Robots (Akhil Padmanabha et al., 2024)

{{<citation>}}

Akhil Padmanabha, Jessie Yuan, Janavi Gupta, Zulekha Karachiwalla, Carmel Majidi, Henny Admoni, Zackory Erickson. (2024)  
**VoicePilot: Harnessing LLMs as Speech Interfaces for Physically Assistive Robots**
<br/>
<button class="copy-to-clipboard" title="VoicePilot: Harnessing LLMs as Speech Interfaces for Physically Assistive Robots" index=75>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04066v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04066v1.pdf" filename="2404.04066v1.pdf">Download PDF</button>
...
### (3/14 | 76/173) POMDP-Guided Active Force-Based Search for Robotic Insertion (Chen Wang et al., 2024)

{{<citation>}}

Chen Wang, Haoxiang Luo, Kun Zhang, Hua Chen, Jia Pan, Wei Zhang. (2024)  
**POMDP-Guided Active Force-Based Search for Robotic Insertion**
<br/>
<button class="copy-to-clipboard" title="POMDP-Guided Active Force-Based Search for Robotic Insertion" index=76>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04419v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04419v1.pdf" filename="2404.04419v1.pdf">Download PDF</button>
...
### (5/14 | 78/173) Admittance Control for Adaptive Remote Center of Motion in Robotic Laparoscopic Surgery (Ehsan Nasiri et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Admittance Control for Adaptive Remote Center of Motion in Robotic Laparoscopic Surgery" index=78>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04219v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04219v1.pdf" filename="2404.04219v1.pdf">Download PDF</button>
...
### (7/14 | 80/173) Scaling Motion Forecasting Models with Ensemble Distillation (Scott Ettinger et al., 2024)

{{<citation>}}

Scott Ettinger, Kratarth Goel, Avikalp Srivastava, Rami Al-Rfou. (2024)  
**Scaling Motion Forecasting Models with Ensemble Distillation**
<br/>
<button class="copy-to-clipboard" title="Scaling Motion Forecasting Models with Ensemble Distillation" index=80>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 20  
Keywords: Knowledge Distillation, Knowledge Distillation  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.03843v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.03843v1.pdf" filename="2404.03843v1.pdf">Download PDF</button>
...
### (8/14 | 81/173) A Ground Mobile Robot for Autonomous Terrestrial Laser Scanning-Based Field Phenotyping (Javier Rodriguez-Sanchez et al., 2024)

{{<citation>}}

Javier Rodriguez-Sanchez, Kyle Johnsen, Changying Li. (2024)  
**A Ground Mobile Robot for Autonomous Terrestrial Laser Scanning-Based Field Phenotyping**
<br/>
<button class="copy-to-clipboard" title="A Ground Mobile Robot for Autonomous Terrestrial Laser Scanning-Based Field Phenotyping" index=81>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04404v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04404v1.pdf" filename="2404.04404v1.pdf">Download PDF</button>
...
### (9/14 | 82/173) LOSS-SLAM: Lightweight Open-Set Semantic Simultaneous Localization and Mapping (Kurran Singh et al., 2024)

{{<citation>}}

Kurran Singh, Tim Magoun, John J. Leonard. (2024)  
**LOSS-SLAM: Lightweight Open-Set Semantic Simultaneous Localization and Mapping**
<br/>
<button class="copy-to-clipboard" title="LOSS-SLAM: Lightweight Open-Set Semantic Simultaneous Localization and Mapping" index=82>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04377v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04377v1.pdf" filename="2404.04377v1.pdf">Download PDF</button>

---


**ABSTRACT**  
Enabling robots to understand the world in terms of objects is a critical building block towards higher level autonomy. The success of <b>foundation</b> <b>models</b> in vision has created the ability to segment and identify nearly all objects in the world. However, utilizing such objects to localize the robot and build an open-set semantic map of the world remains an open research question. In this work, a system of identifying, localizing, and encoding objects is tightly coupled with probabilistic graphical models for performing open-set semantic simultaneous localization and mapping (SLAM). Results are presented demonstrating that the proposed lightweight object encoding can be used to perform more accurate object-based SLAM than existing open-set methods, closed-set methods, and geometric methods while incurring a lower computational overhead than existing open-set mapping methods.

{{</citation>}}


### (10/14 | 83/173) ToolEENet: Tool Affordance 6D Pose Estimation (Yunlong Wang et al., 2024)

{{<citation>}}

Yunlong Wang, Lei Zhang, Yuyang Tu, Hui Zhang, Kaixin Bai, Zhaopeng Chen, Jianwei Zhang. (2024)  
**ToolEENet: Tool Affordance 6D Pose Estimation**
<br/>
<button class="copy-to-clipboard" title="ToolEENet: Tool Affordance 6D Pose Estimation" index=83>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04193v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04193v1.pdf" filename="2404.04193v1.pdf">Download PDF</button>
...
### (11/14 | 84/173) Designing Robots to Help Women (Martin Cooney et al., 2024)

{{<citation>}}

Martin Cooney, Lena Klasén, Fernando Alonso-Fernandez. (2024)  
**Designing Robots to Help Women**
<br/>
<button class="copy-to-clipboard" title="Designing Robots to Help Women" index=84>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 10  
Keywords: Object Detection  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04123v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04123v1.pdf" filename="2404.04123v1.pdf">Download PDF</button>
...
### (12/14 | 85/173) Modeling Kinematic Uncertainty of Tendon-Driven Continuum Robots via Mixture Density Networks (Jordan Thompson et al., 2024)

{{<citation>}}

Jordan Thompson, Brian Y. Cho, Daniel S. Brown, Alan Kuntz. (2024)  
**Modeling Kinematic Uncertainty of Tendon-Driven Continuum Robots via Mixture Density Networks**
<br/>
<button class="copy-to-clipboard" title="Modeling Kinematic Uncertainty of Tendon-Driven Continuum Robots via Mixture Density Networks" index=85>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 5  
Keywords: Geometry  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04241v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04241v1.pdf" filename="2404.04241v1.pdf">Download PDF</button>

---


**ABSTRACT**  
Tendon-driven continuum robot kinematic models are frequently computationally expensive, inaccurate due to unmodeled effects, or both. In particular, unmodeled effects produce uncertainties that arise during the robot's operation that lead to variability in the resulting <b>geometry.</b> We propose a novel solution to these issues through the development of a Gaussian mixture kinematic model. We train a mixture density network to output a Gaussian mixture model representation of the robot <b>geometry</b> given the current tendon displacements. This model computes a probability distribution that is more representative of the true distribution of geometries at a given configuration than a model that outputs a single <b>geometry,</b> while also reducing the computation time. We demonstrate one use of this model through a trajectory optimization method that explicitly reasons about the workspace uncertainty to minimize the probability of collision.

{{</citation>}}


### (13/14 | 86/173) Multi-modal perception for soft robotic interactions using generative models (Enrico Donato et al., 2024)

{{<citation>}}

Enrico Donato, Egidio Falotico, Thomas George Thuruthel. (2024)  
**Multi-modal perception for soft robotic interactions using generative models**
<br/>
<button class="copy-to-clipboard" title="Multi-modal perception for soft robotic interactions using generative models" index=86>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04220v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04220v1.pdf" filename="2404.04220v1.pdf">Download PDF</button>
...
### (14/14 | 87/173) MM-Gaussian: 3D Gaussian-based Multi-modal Fusion for Localization and Reconstruction in Unbounded Scenes (Chenyang Wu et al., 2024)

{{<citation>}}

Chenyang Wu, Yifan Duan, Xinran Zhang, Yu Sheng, Jianmin Ji, Yanyong Zhang. (2024)  
**MM-Gaussian: 3D Gaussian-based Multi-modal Fusion for Localization and Reconstruction in Unbounded Scenes**
<br/>
<button class="copy-to-clipboard" title="MM-Gaussian: 3D Gaussian-based Multi-modal Fusion for Localization and Reconstruction in Unbounded Scenes" index=87>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 3  
Keywords: Multi-modal  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04026v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04026v1.pdf" filename="2404.04026v1.pdf">Download PDF</button>
...
### (1/8 | 88/173) Hypothesis Generation with Large Language Models (Yangqiaoyu Zhou et al., 2024)

{{<citation>}}

Yangqiaoyu Zhou, Haokun Liu, Tejes Srivastava, Hongyuan Mei, Chenhao Tan. (2024)  
**Hypothesis Generation with Large Language Models**
<br/>
<button class="copy-to-clipboard" title="Hypothesis Generation with Large Language Models" index=88>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<br/>
<button class="copy-to-clipboard" title="Exploring Autonomous Agents through the Lens of Large Language Models: A Review" index=89>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 60  
Keywords: Reasoning, In-context Learning, In-context Learning, Large Language Model, Large Language Model, Prompt  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04442v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04442v1.pdf" filename="2404.04442v1.pdf">Download PDF</button>

---


**ABSTRACT**  
<b>Large</b> <b>Language</b> <b>Models</b> <b>(LLMs)</b> are transforming artificial intelligence, enabling autonomous agents to perform diverse tasks across various domains. These agents, proficient in human-like text comprehension and generation, have the potential to revolutionize sectors from customer service to healthcare. However, they face challenges such as multimodality, human value alignment, hallucinations, and evaluation. Techniques like <b>prompting,</b> <b>reasoning,</b> tool utilization, and <b>in-context</b> <b>learning</b> are being explored to enhance their capabilities. Evaluation platforms like AgentBench, WebArena, and ToolLLM provide robust methods for assessing these agents in complex scenarios. These advancements are leading to the development of more resilient and capable autonomous agents, anticipated to become integral in our digital lives, assisting in tasks from email responses to disease diagnosis. The future of AI, with <b>LLMs</b> at the forefront, is promising.

{{</citation>}}


### (3/8 | 90/173) KGExplainer: Towards Exploring Connected Subgraph Explanations for Knowledge Graph Completion (Tengfei Ma et al., 2024)

{{<citation>}}

Tengfei Ma, Xiang song, Wen Tao, Mufei Li, Jiani Zhang, Xiaoqin Pan, Jianxin Lin, Bosheng Song, xiangxiang Zeng. (2024)  
**KGExplainer: Towards Exploring Connected Subgraph Explanations for Knowledge Graph Completion**
<br/>
<button class="copy-to-clipboard" title="KGExplainer: Towards Exploring Connected Subgraph Explanations for Knowledge Graph Completion" index=90>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Categories: cs-AI, cs.AI  
Keyword Score: 51  
Keywords: Graph, Graph Embedding, Benchmarking, Black Box, Knowledge Distillation, Knowledge Graph, Knowledge Graph, Recommendation  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.03893v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.03893v1.pdf" filename="2404.03893v1.pdf">Download PDF</button>
...
### (4/8 | 91/173) Intervention-Assisted Policy Gradient Methods for Online Stochastic Queuing Network Optimization: Technical Report (Jerrod Wigmore et al., 2024)

{{<citation>}}

Jerrod Wigmore, Brooke Shrader, Eytan Modiano. (2024)  
**Intervention-Assisted Policy Gradient Methods for Online Stochastic Queuing Network Optimization: Technical Report**
<br/>
<button class="copy-to-clipboard" title="Intervention-Assisted Policy Gradient Methods for Online Stochastic Queuing Network Optimization: Technical Report" index=91>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
---
Primary Category: cs.AI  
Categories: F-2-2; I-2-6, cs-AI, cs-LG, cs.AI  
Keyword Score: 30  
Keywords: Reinforcement Learning, Simulation, Simulator  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04106v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04106v1.pdf" filename="2404.04106v1.pdf">Download PDF</button>
...
### (5/8 | 92/173) Random Walk in Random Permutation Set Theory (Jiefeng Zhou et al., 2024)

{{<citation>}}

Jiefeng Zhou, Zhen Li, Yong Deng. (2024)  
**Random Walk in Random Permutation Set Theory**
<br/>
<button class="copy-to-clipboard" title="Random Walk in Random Permutation Set Theory" index=92>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.03978v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.03978v1.pdf" filename="2404.03978v1.pdf">Download PDF</button>
...
### (6/8 | 93/173) Large language models as oracles for instantiating ontologies with domain-specific knowledge (Giovanni Ciatto et al., 2024)

{{<citation>}}

Giovanni Ciatto, Andrea Agiollo, Matteo Magnini, Andrea Omicini. (2024)  
**Large language models as oracles for instantiating ontologies with domain-specific knowledge**
<br/>
<button class="copy-to-clipboard" title="Large language models as oracles for instantiating ontologies with domain-specific knowledge" index=93>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<br/>
<button class="copy-to-clipboard" title="AI Knowledge and Reasoning: Emulating Expert Creativity in Scientific Research" index=94>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 10  
Keywords: Reasoning  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04436v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04436v1.pdf" filename="2404.04436v1.pdf">Download PDF</button>

---


**ABSTRACT**  
We investigate whether modern AI can emulate expert creativity in complex scientific endeavors. We introduce novel methodology that utilizes original research articles published after the AI's training cutoff, ensuring no prior exposure, mitigating concerns of rote memorization and prior training. The AI are tasked with redacting findings, predicting outcomes from redacted research, and assessing prediction accuracy against reported results. Analysis on 589 published studies in four leading psychology journals over a 28-month period, showcase the AI's proficiency in understanding specialized research, deductive <b>reasoning,</b> and evaluating evidentiary alignment--cognitive hallmarks of human subject matter expertise and creativity. These findings suggest the potential of general-purpose AI to transform academia, with roles requiring knowledge-based creativity become increasingly susceptible to technological substitution.

{{</citation>}}


### (8/8 | 95/173) Visual Knowledge in the Big Model Era: Retrospect and Prospect (Wenguan Wang et al., 2024)

{{<citation>}}

Wenguan Wang, Yi Yang, Yunhe Pan. (2024)  
**Visual Knowledge in the Big Model Era: Retrospect and Prospect**
<br/>
<button class="copy-to-clipboard" title="Visual Knowledge in the Big Model Era: Retrospect and Prospect" index=95>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 10  
Keywords: Foundation Model  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04308v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04308v1.pdf" filename="2404.04308v1.pdf">Download PDF</button>
...
### (1/3 | 96/173) A Comparison of Methods for Evaluating Generative IR (Negar Arabzadeh et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="A Comparison of Methods for Evaluating Generative IR" index=96>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 35  
Keywords: Dense Retrieval, Fine-tuning, Representation Learning, Transformer  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04163v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04163v1.pdf" filename="2404.04163v1.pdf">Download PDF</button>

---


**ABSTRACT**  
This study investigates the existence of positional biases in <b>Transformer-based</b> models for text <b>representation</b> <b>learning,</b> particularly in the context of web document retrieval. We build on previous research that demonstrated loss of information in the middle of input sequences for causal language models, extending it to the domain of <b>representation</b> <b>learning.</b> We examine positional biases at various stages of training for an encoder-decoder model, including language model pre-training, contrastive pre-training, and contrastive <b>fine-tuning.</b> Experiments with the MS-MARCO document collection reveal that after contrastive pre-training the model already generates embeddings that better capture early contents of the input, with <b>fine-tuning</b> further aggravating this effect.

{{</citation>}}


### (3/3 | 98/173) JobFormer: Skill-Aware Job Recommendation with Semantic-Enhanced Transformer (Zhihao Guan et al., 2024)

{{<citation>}}

Zhihao Guan, Jia-Qi Yang, Yang Yang, Hengshu Zhu, Wenjie Li, Hui Xiong. (2024)  
**JobFormer: Skill-Aware Job Recommendation with Semantic-Enhanced Transformer**
<br/>
<button class="copy-to-clipboard" title="JobFormer: Skill-Aware Job Recommendation with Semantic-Enhanced Transformer" index=98>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/33 | 99/173) Prompt Public Large Language Models to Synthesize Data for Private On-device Applications (Shanshan Wu et al., 2024)

{{<citation>}}

Shanshan Wu, Zheng Xu, Yanxiang Zhang, Yuanbo Zhang, Daniel Ramage. (2024)  
**Prompt Public Large Language Models to Synthesize Data for Private On-device Applications**
<br/>
<button class="copy-to-clipboard" title="Prompt Public Large Language Models to Synthesize Data for Private On-device Applications" index=99>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 60  
Keywords: Federated Learning, Fine-tuning, Large Language Model, Large Language Model, Prompt, Differential Privacy  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04360v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04360v1.pdf" filename="2404.04360v1.pdf">Download PDF</button>
...
### (2/33 | 100/173) Dynamic Switch Layers For Unsupervised Learning (Haiguang Li et al., 2024)

{{<citation>}}

Haiguang Li, Usama Pervaiz, Michał Matuszak, Robert Kamara, Gilles Roux, Trausti Thormundsson, Joseph Antognini. (2024)  
**Dynamic Switch Layers For Unsupervised Learning**
<br/>
<button class="copy-to-clipboard" title="Dynamic Switch Layers For Unsupervised Learning" index=100>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 40  
Keywords: Graph Attention Networks, Supervised Learning, Unsupervised Learning, Unsupervised Learning  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04405v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04405v1.pdf" filename="2404.04405v1.pdf">Download PDF</button>
...
### (3/33 | 101/173) player2vec: A Language Modeling Approach to Understand Player Behavior in Games (Tianze Wang et al., 2024)

{{<citation>}}

Tianze Wang, Maryam Honari-Jahromi, Styliani Katsarou, Olga Mikheeva, Theodoros Panagiotakopoulos, Sahar Asadi, Oleg Smirnov. (2024)  
**player2vec: A Language Modeling Approach to Understand Player Behavior in Games**
<br/>
<button class="copy-to-clipboard" title="player2vec: A Language Modeling Approach to Understand Player Behavior in Games" index=101>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 40  
Keywords: Recommendation, Self-supervised Learning, Transformer, Tokenization  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04234v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04234v1.pdf" filename="2404.04234v1.pdf">Download PDF</button>
...
### (4/33 | 102/173) Robust Preference Optimization with Provable Noise Tolerance for LLMs (Xize Liang et al., 2024)

{{<citation>}}

Xize Liang, Chao Chen, Jie Wang, Yue Wu, Zhihang Fu, Zhihao Shi, Feng Wu, Jieping Ye. (2024)  
**Robust Preference Optimization with Provable Noise Tolerance for LLMs**
<br/>
<button class="copy-to-clipboard" title="Robust Preference Optimization with Provable Noise Tolerance for LLMs" index=102>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Categories: cs-AI, cs-CL, cs-LG, cs.LG  
Keyword Score: 40  
Keywords: Noise-tolerant, Text Generation, Large Language Model, Large Language Model  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04102v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04102v1.pdf" filename="2404.04102v1.pdf">Download PDF</button>
...
### (5/33 | 103/173) Enhancing IoT Intelligence: A Transformer-based Reinforcement Learning Methodology (Gaith Rjoub et al., 2024)

{{<citation>}}

Gaith Rjoub, Saidul Islam, Jamal Bentahar, Mohammed Amin Almaiah, Rana Alrawashdeh. (2024)  
**Enhancing IoT Intelligence: A Transformer-based Reinforcement Learning Methodology**
<br/>
<button class="copy-to-clipboard" title="Enhancing IoT Intelligence: A Transformer-based Reinforcement Learning Methodology" index=103>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 33  
Keywords: Benchmarking, Reinforcement Learning, Transformer, Self-Attention  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04205v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04205v1.pdf" filename="2404.04205v1.pdf">Download PDF</button>

---


**ABSTRACT**  
The proliferation of the Internet of Things (IoT) has led to an explosion of data generated by interconnected devices, presenting both opportunities and challenges for intelligent decision-making in complex environments. Traditional <b>Reinforcement</b> <b>Learning</b> (RL) approaches often struggle to fully harness this data due to their limited ability to process and interpret the intricate patterns and dependencies inherent in IoT applications. This paper introduces a novel framework that integrates <b>transformer</b> architectures with Proximal Policy Optimization (PPO) to address these challenges. By leveraging the <b>self-attention</b> mechanism of <b>transformers,</b> our approach enhances RL agents' capacity for understanding and acting within dynamic IoT environments, leading to improved decision-making processes. We demonstrate the effectiveness of our method across various IoT scenarios, from smart home automation to industrial control systems, showing marked improvements in decision-making efficiency and adaptability. Our contributions include a detailed exploration of the <b>transformer's</b> role in processing heterogeneous IoT data, a comprehensive evaluation of the framework's performance in diverse environments, and a <b>benchmark</b> against traditional RL methods. The results indicate significant advancements in enabling RL agents to navigate the complexities of IoT ecosystems, highlighting the potential of our approach to revolutionize intelligent automation and decision-making in the IoT landscape.

{{</citation>}}


### (6/33 | 104/173) Score identity Distillation: Exponentially Fast Distillation of Pretrained Diffusion Models for One-Step Generation (Mingyuan Zhou et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Score identity Distillation: Exponentially Fast Distillation of Pretrained Diffusion Models for One-Step Generation" index=104>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Categories: cs-AI, cs-LG, cs.LG  
Keyword Score: 30  
Keywords: Anomaly Detection, Autoencoder, Convolution  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04311v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04311v1.pdf" filename="2404.04311v1.pdf">Download PDF</button>

---


**ABSTRACT**  
The majority of modern consumer-level energy is generated by real-time smart metering systems. These frequently contain anomalies, which prevent reliable estimates of the series' evolution. This work introduces a hybrid modeling approach combining statistics and a <b>Convolutional</b> <b>Autoencoder</b> with a dynamic threshold. The threshold is determined based on Mahalanobis distance and moving averages. It has been tested using real-life energy consumption data collected from smart metering systems. The solution includes a real-time, meter-level <b>anomaly</b> <b>detection</b> system that connects to an advanced monitoring system. This makes a substantial contribution by detecting unusual data movements and delivering an early warning. Early detection and subsequent troubleshooting can financially benefit organizations and consumers and prevent disasters from occurring.

{{</citation>}}


### (10/33 | 108/173) Transformers for molecular property prediction: Lessons learned from the past five years (Afnan Sultan et al., 2024)

{{<citation>}}

Afnan Sultan, Jochen Sieg, Miriam Mathea, Andrea Volkamer. (2024)  
**Transformers for molecular property prediction: Lessons learned from the past five years**
<br/>
<button class="copy-to-clipboard" title="Transformers for molecular property prediction: Lessons learned from the past five years" index=108>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 30  
Keywords: Fine-tuning, Knowledge Distillation, Transformer  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.03969v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.03969v1.pdf" filename="2404.03969v1.pdf">Download PDF</button>
...
### (11/33 | 109/173) Optimizing Convolutional Neural Networks for Identifying Invasive Pollinator Apis Mellifera and Finding a Ligand drug to Protect California's Biodiversity (Arnav Swaroop, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Optimizing Convolutional Neural Networks for Identifying Invasive Pollinator Apis Mellifera and Finding a Ligand drug to Protect California's Biodiversity" index=109>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
---
Primary Category: cs.LG  
Categories: cs-LG, cs.LG, q-bio-BM, q-bio-QM  
Keyword Score: 30  
Keywords: Convolution, Convolutional Neural Network, Convolutional Neural Network  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.03870v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.03870v1.pdf" filename="2404.03870v1.pdf">Download PDF</button>
...
### (12/33 | 110/173) Dynamic Conditional Optimal Transport through Simulation-Free Flows (Gavin Kerrigan et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Dynamic Conditional Optimal Transport through Simulation-Free Flows" index=110>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04240v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04240v1.pdf" filename="2404.04240v1.pdf">Download PDF</button>
...
### (13/33 | 111/173) Model Selection with Model Zoo via Graph Learning (Ziyu Li et al., 2024)

{{<citation>}}

Ziyu Li, Hilco van der Wilk, Danning Zhan, Megha Khosla, Alessandro Bozzon, Rihan Hai. (2024)  
**Model Selection with Model Zoo via Graph Learning**
<br/>
<button class="copy-to-clipboard" title="Model Selection with Model Zoo via Graph Learning" index=111>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 23  
Keywords: Graph, Fine-tuning, Fine-tuning  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.03988v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.03988v1.pdf" filename="2404.03988v1.pdf">Download PDF</button>

---


**ABSTRACT**  
Pre-trained deep learning (DL) models are increasingly accessible in public repositories, i.e., model zoos. Given a new prediction task, finding the best model to <b>fine-tune</b> can be computationally intensive and costly, especially when the number of pre-trained models is large. Selecting the right pre-trained models is crucial, yet complicated by the diversity of models from various model families (like ResNet, Vit, Swin) and the hidden relationships between models and datasets. Existing methods, which utilize basic information from models and datasets to compute scores indicating model performance on target datasets, overlook the intrinsic relationships, limiting their effectiveness in model selection. In this study, we introduce TransferGraph, a novel framework that reformulates model selection as a <b>graph</b> learning problem. TransferGraph constructs a <b>graph</b> using extensive metadata extracted from models and datasets, while capturing their inherent relationships. Through comprehensive experiments across 16 real datasets, both images and texts, we demonstrate TransferGraph's effectiveness in capturing essential model-dataset relationships, yielding up to a 32% improvement in correlation between predicted performance and the actual <b>fine-tuning</b> results compared to the state-of-the-art methods.

{{</citation>}}


### (14/33 | 112/173) Pixel-wise RL on Diffusion Models: Reinforcement Learning from Rich Feedback (Mo Kordzanganeh et al., 2024)

{{<citation>}}

Mo Kordzanganeh, Danial Keshvary, Nariman Arian. (2024)  
**Pixel-wise RL on Diffusion Models: Reinforcement Learning from Rich Feedback**
<br/>
<button class="copy-to-clipboard" title="Pixel-wise RL on Diffusion Models: Reinforcement Learning from Rich Feedback" index=112>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04356v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04356v1.pdf" filename="2404.04356v1.pdf">Download PDF</button>
...
### (15/33 | 113/173) Exploring Probabilistic Models for Semi-supervised Learning (Jianfeng Wang, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Exploring Probabilistic Models for Semi-supervised Learning" index=113>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Categories: cs-LG, cs.LG  
Keyword Score: 20  
Keywords: Probabilistic Model, Semi-Supervised Learning  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04199v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04199v1.pdf" filename="2404.04199v1.pdf">Download PDF</button>

---


**ABSTRACT**  
This thesis studies advanced <b>probabilistic</b> <b>models,</b> including both their theoretical foundations and practical applications, for different <b>semi-supervised</b> <b>learning</b> (SSL) tasks. The proposed <b>probabilistic</b> <b>methods</b> are able to improve the safety of AI systems in real applications by providing reliable uncertainty estimates quickly, and at the same time, achieve competitive performance compared to their deterministic counterparts. The experimental results indicate that the methods proposed in the thesis have great value in safety-critical areas, such as the autonomous driving or medical imaging analysis domain, and pave the way for the future discovery of highly effective and efficient <b>probabilistic</b> <b>approaches</b> in the SSL sector.

{{</citation>}}


### (16/33 | 114/173) Fusing Dictionary Learning and Support Vector Machines for Unsupervised Anomaly Detection (Paul Irofti et al., 2024)

{{<citation>}}

Paul Irofti, Iulian-Andrei Hîji, Andrei Pătraşcu, Nicolae Cleju. (2024)  
**Fusing Dictionary Learning and Support Vector Machines for Unsupervised Anomaly Detection**
<br/>
<button class="copy-to-clipboard" title="Fusing Dictionary Learning and Support Vector Machines for Unsupervised Anomaly Detection" index=114>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
---
Primary Category: cs.LG  
Categories: cs-CR, cs-LG, cs-NA, cs.LG, math-NA  
Keyword Score: 20  
Keywords: Anomaly Detection, Unsupervised Learning  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04064v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04064v1.pdf" filename="2404.04064v1.pdf">Download PDF</button>
...
### (17/33 | 115/173) Rolling the dice for better deep learning performance: A study of randomness techniques in deep neural networks (Mohammed Ghaith Altarabichi et al., 2024)

{{<citation>}}

Mohammed Ghaith Altarabichi, Sławomir Nowaczyk, Sepideh Pashami, Peyman Sheikholharam Mashhadi, Julia Handl. (2024)  
**Rolling the dice for better deep learning performance: A study of randomness techniques in deep neural networks**
<br/>
<button class="copy-to-clipboard" title="Rolling the dice for better deep learning performance: A study of randomness techniques in deep neural networks" index=115>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 20  
Keywords: MNIST, Data Augmentation  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.03992v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.03992v1.pdf" filename="2404.03992v1.pdf">Download PDF</button>
...
### (18/33 | 116/173) Multi-Task Learning for Lung sound & Lung disease classification (Suma K V et al., 2024)

{{<citation>}}

Suma K V, Deepali Koppad, Preethi Kumar, Neha A Kantikar, Surabhi Ramesh. (2024)  
**Multi-Task Learning for Lung sound & Lung disease classification**
<br/>
<button class="copy-to-clipboard" title="Multi-Task Learning for Lung sound & Lung disease classification" index=116>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
---
Primary Category: cs.LG  
Categories: cs-AI, cs-LG, cs-SD, cs.LG  
Keyword Score: 20  
Keywords: Convolutional Neural Network, Logistic Regression  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.03908v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.03908v1.pdf" filename="2404.03908v1.pdf">Download PDF</button>
...
### (19/33 | 117/173) A proximal policy optimization based intelligent home solar management (Kode Creer et al., 2024)

{{<citation>}}

Kode Creer, Imitiaz Parvez. (2024)  
**A proximal policy optimization based intelligent home solar management**
<br/>
<button class="copy-to-clipboard" title="A proximal policy optimization based intelligent home solar management" index=117>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 16  
Keywords: Graph Neural Network, Benchmarking, Benchmarking  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04118v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04118v1.pdf" filename="2404.04118v1.pdf">Download PDF</button>

---


**ABSTRACT**  
We hypothesize that the absence of a standardized <b>benchmark</b> has allowed several fundamental pitfalls in <b>GNN</b> System design and evaluation that the community has overlooked. In this work, we propose GNNBench, a plug-and-play <b>benchmarking</b> platform focused on system innovation. GNNBench presents a new protocol to exchange their captive tensor data, supports custom classes in System APIs, and allows automatic integration of the same system module to many deep learning frameworks, such as PyTorch and TensorFlow. To demonstrate the importance of such a <b>benchmark</b> framework, we integrated several <b>GNN</b> systems. Our results show that integration with GNNBench helped us identify several measurement issues that deserve attention from the community.

{{</citation>}}


### (22/33 | 120/173) Growing Q-Networks: Solving Continuous Control Tasks with Adaptive Control Resolution (Tim Seyde et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Growing Q-Networks: Solving Continuous Control Tasks with Adaptive Control Resolution" index=120>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04253v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04253v1.pdf" filename="2404.04253v1.pdf">Download PDF</button>
...
### (23/33 | 121/173) Active Causal Learning for Decoding Chemical Complexities with Targeted Interventions (Zachary R. Fox et al., 2024)

{{<citation>}}

Zachary R. Fox, Ayana Ghosh. (2024)  
**Active Causal Learning for Decoding Chemical Complexities with Targeted Interventions**
<br/>
<button class="copy-to-clipboard" title="Active Causal Learning for Decoding Chemical Complexities with Targeted Interventions" index=121>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
---
Primary Category: cs.LG  
Categories: cs-LG, cs.LG, physics-chem-ph, physics-data-an, q-bio-BM  
Keyword Score: 13  
Keywords: Graph, Active Learning  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04224v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04224v1.pdf" filename="2404.04224v1.pdf">Download PDF</button>
...
### (24/33 | 122/173) Half-Space Feature Learning in Neural Networks (Mahesh Lorik Yadav et al., 2024)

{{<citation>}}

Mahesh Lorik Yadav, Harish Guruprasad Ramaswamy, Chandrashekar Lakshminarayanan. (2024)  
**Half-Space Feature Learning in Neural Networks**
<br/>
<button class="copy-to-clipboard" title="Half-Space Feature Learning in Neural Networks" index=122>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04454v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04454v1.pdf" filename="2404.04454v1.pdf">Download PDF</button>

---


**ABSTRACT**  
Adam with decoupled weight decay, also known as AdamW, is widely acclaimed for its superior performance in language modeling tasks, surpassing Adam with $\ell_2$ regularization in terms of generalization and optimization. However, this advantage is not theoretically well-understood. One challenge here is that though intuitively Adam with $\ell_2$ regularization optimizes the $\ell_2$ regularized loss, it is not clear if AdamW optimizes a specific objective. In this work, we make progress toward understanding the benefit of AdamW by showing that it implicitly performs constrained optimization. More concretely, we show in the full-batch setting, if AdamW converges with any non-increasing learning rate schedule whose partial sum diverges, it must converge to a <b>KKT</b> point of the original loss under the constraint that the $\ell_\infty$ norm of the parameter is bounded by the inverse of the weight decay factor. This result is built on the observation that Adam can be viewed as a smoothed version of SignGD, which is the normalized steepest descent with respect to $\ell_\infty$ norm, and a surprising connection between normalized steepest descent with weight decay and Frank-Wolfe.

{{</citation>}}


### (26/33 | 124/173) Compositional Estimation of Lipschitz Constants for Deep Neural Networks (Yuezhu Xu et al., 2024)

{{<citation>}}

Yuezhu Xu, S. Sivaranjani. (2024)  
**Compositional Estimation of Lipschitz Constants for Deep Neural Networks**
<br/>
<button class="copy-to-clipboard" title="Compositional Estimation of Lipschitz Constants for Deep Neural Networks" index=124>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04375v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04375v1.pdf" filename="2404.04375v1.pdf">Download PDF</button>
...
### (27/33 | 125/173) Generalizable Temperature Nowcasting with Physics-Constrained RNNs for Predictive Maintenance of Wind Turbine Components (Johannes Exenberger et al., 2024)

{{<citation>}}

Johannes Exenberger, Matteo Di Salvo, Thomas Hirsch, Franz Wotawa, Gerald Schweiger. (2024)  
**Generalizable Temperature Nowcasting with Physics-Constrained RNNs for Predictive Maintenance of Wind Turbine Components**
<br/>
<button class="copy-to-clipboard" title="Generalizable Temperature Nowcasting with Physics-Constrained RNNs for Predictive Maintenance of Wind Turbine Components" index=125>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04126v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04126v1.pdf" filename="2404.04126v1.pdf">Download PDF</button>
...
### (28/33 | 126/173) Continual Learning with Weight Interpolation (Jędrzej Kozal et al., 2024)

{{<citation>}}

Jędrzej Kozal, Jan Wasilewski, Bartosz Krawczyk, Michał Woźniak. (2024)  
**Continual Learning with Weight Interpolation**
<br/>
<button class="copy-to-clipboard" title="Continual Learning with Weight Interpolation" index=126>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04002v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04002v1.pdf" filename="2404.04002v1.pdf">Download PDF</button>
...
### (29/33 | 127/173) Demonstration Guided Multi-Objective Reinforcement Learning (Junlin Lu et al., 2024)

{{<citation>}}

Junlin Lu, Patrick Mannion, Karl Mason. (2024)  
**Demonstration Guided Multi-Objective Reinforcement Learning**
<br/>
<button class="copy-to-clipboard" title="Demonstration Guided Multi-Objective Reinforcement Learning" index=127>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.03997v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.03997v1.pdf" filename="2404.03997v1.pdf">Download PDF</button>
...
### (30/33 | 128/173) Generating Synthetic Ground Truth Distributions for Multi-step Trajectory Prediction using Probabilistic Composite Bézier Curves (Ronny Hug et al., 2024)

{{<citation>}}

Ronny Hug, Stefan Becker, Wolfgang Hübner, Michael Arens. (2024)  
...
<br/>
<button class="copy-to-clipboard" title="Generating Synthetic Ground Truth Distributions for Multi-step Trajectory Prediction using Probabilistic Composite Bézier Curves" index=128>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 3  
Keywords: Benchmarking  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04397v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04397v1.pdf" filename="2404.04397v1.pdf">Download PDF</button>
...
### (31/33 | 129/173) Hierarchical Neural Additive Models for Interpretable Demand Forecasts (Leif Feddersen et al., 2024)

{{<citation>}}

Leif Feddersen, Catherine Cleophas. (2024)  
**Hierarchical Neural Additive Models for Interpretable Demand Forecasts**
<br/>
<button class="copy-to-clipboard" title="Hierarchical Neural Additive Models for Interpretable Demand Forecasts" index=129>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 3  
Keywords: Benchmarking  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04070v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04070v1.pdf" filename="2404.04070v1.pdf">Download PDF</button>
...
### (32/33 | 130/173) Derivative-free tree optimization for complex systems (Ye Wei et al., 2024)

{{<citation>}}

Ye Wei, Bo Peng, Ruiwen Xie, Yangtao Chen, Yu Qin, Peng Wen, Stefan Bauer, Po-Yen Tung. (2024)  
**Derivative-free tree optimization for complex systems**
<br/>
<button class="copy-to-clipboard" title="Derivative-free tree optimization for complex systems" index=130>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 3  
Keywords: Benchmarking  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04062v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04062v1.pdf" filename="2404.04062v1.pdf">Download PDF</button>
...
### (33/33 | 131/173) Approximate UMAP allows for high-rate online visualization of high-dimensional data streams (Peter Wassenaar et al., 2024)

{{<citation>}}

Peter Wassenaar, Pierre Guetschel, Michael Tangermann. (2024)  
**Approximate UMAP allows for high-rate online visualization of high-dimensional data streams**
<br/>
<button class="copy-to-clipboard" title="Approximate UMAP allows for high-rate online visualization of high-dimensional data streams" index=131>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
---
Primary Category: cs.LG  
Categories: I-5-3; I-5-3; J-4, cs-AI, cs-HC, cs-LG, cs.LG, eess-SP  
Keyword Score: 3  
Keywords: Benchmarking  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04001v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04001v1.pdf" filename="2404.04001v1.pdf">Download PDF</button>
...
### (1/4 | 132/173) DeepLINK-T: deep learning inference for time series data using knockoffs and LSTM (Wenxuan Zuo et al., 2024)

{{<citation>}}

Wenxuan Zuo, Zifan Zhu, Yuxuan Du, Yi-Chun Yeh, Jed A. Fuhrman, Jinchi Lv, Yingying Fan, Fengzhu Sun. (2024)  
**DeepLINK-T: deep learning inference for time series data using knockoffs and LSTM**
<br/>
<button class="copy-to-clipboard" title="DeepLINK-T: deep learning inference for time series data using knockoffs and LSTM" index=132>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 13  
Keywords: Benchmarking, BART  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04425v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04425v1.pdf" filename="2404.04425v1.pdf">Download PDF</button>
...
### (4/4 | 135/173) Nonparametric Modern Hopfield Models (Jerry Yao-Chieh Hu et al., 2024)

{{<citation>}}

Jerry Yao-Chieh Hu, Bo-Yu Chen, Dennis Wu, Feng Ruan, Han Liu. (2024)  
**Nonparametric Modern Hopfield Models**
<br/>
<button class="copy-to-clipboard" title="Nonparametric Modern Hopfield Models" index=135>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/2 | 136/173) 'It is okay to be uncommon': Quantizing Sound Event Detection Networks on Hardware Accelerators with Uncommon Sub-Byte Support (Yushu Wu et al., 2024)

{{<citation>}}

Yushu Wu, Xiao Quan, Mohammad Rasool Izadi, Chuan-Che Huang. (2024)  
...
<br/>
<button class="copy-to-clipboard" title="'It is okay to be uncommon': Quantizing Sound Event Detection Networks on Hardware Accelerators with Uncommon Sub-Byte Support" index=136>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 10  
Keywords: Transformer  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04420v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04420v1.pdf" filename="2404.04420v1.pdf">Download PDF</button>
...
### (1/3 | 138/173) Open vocabulary keyword spotting through transfer learning from speech synthesis (Kesavaraj V et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Open vocabulary keyword spotting through transfer learning from speech synthesis" index=138>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 40  
Keywords: Knowledge Transfer, Transfer Learning, Text-to-speech, Text-to-speech  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.03914v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.03914v1.pdf" filename="2404.03914v1.pdf">Download PDF</button>
...
### (2/3 | 139/173) Which Experimental Design is Better Suited for VQA Tasks? Eye Tracking Study on Cognitive Load, Performance, and Gaze Allocations (Sita A. Vriend et al., 2024)

{{<citation>}}

Sita A. Vriend, Sandeep Vidyapu, Amer Rama, Kun-Ting Chen, Daniel Weiskopf. (2024)  
...
<br/>
<button class="copy-to-clipboard" title="Which Experimental Design is Better Suited for VQA Tasks? Eye Tracking Study on Cognitive Load, Performance, and Gaze Allocations" index=139>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04036v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04036v1.pdf" filename="2404.04036v1.pdf">Download PDF</button>
...
### (3/3 | 140/173) HIV Client Perspectives on Digital Health in Malawi (Lisa Orii et al., 2024)

{{<citation>}}

Lisa Orii, Caryl Feldacker, Jacqueline Madalitso Huwa, Agness Thawani, Evelyn Viola, Christine Kiruthu-Kamamia, Odala Sande, Hannock Tweya, Richard Anderson. (2024)  
**HIV Client Perspectives on Digital Health in Malawi**
<br/>
<button class="copy-to-clipboard" title="HIV Client Perspectives on Digital Health in Malawi" index=140>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04444v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04444v1.pdf" filename="2404.04444v1.pdf">Download PDF</button>
...
### (1/2 | 141/173) Superior Genetic Algorithms for the Target Set Selection Problem Based on Power-Law Parameter Choices and Simple Greedy Heuristics (Benjamin Doerr et al., 2024)

{{<citation>}}

Benjamin Doerr, Martin S. Krejca, Nguyen Vu. (2024)  
...
<br/>
<button class="copy-to-clipboard" title="Superior Genetic Algorithms for the Target Set Selection Problem Based on Power-Law Parameter Choices and Simple Greedy Heuristics" index=141>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/2 | 143/173) Stable Blockchain Sharding under Adversarial Transaction Generation (Ramesh Adhikari et al., 2024)

{{<citation>}}

Ramesh Adhikari, Costas Busch, Dariusz Kowalski. (2024)  
**Stable Blockchain Sharding under Adversarial Transaction Generation**
<br/>
<button class="copy-to-clipboard" title="Stable Blockchain Sharding under Adversarial Transaction Generation" index=143>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04438v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04438v1.pdf" filename="2404.04438v1.pdf">Download PDF</button>
...
### (2/2 | 144/173) Evaluation of Programming Models and Performance for Stencil Computation on Current GPU Architectures (Baodi Shan et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Evaluation of Programming Models and Performance for Stencil Computation on Current GPU Architectures" index=144>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 10  
Keywords: Recommendation  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04441v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04441v1.pdf" filename="2404.04441v1.pdf">Download PDF</button>
...
### (1/5 | 145/173) Nonlinear Kalman Filtering based on Self-Attention Mechanism and Lattice Trajectory Piecewise Linear Approximation (Jiaming Wang et al., 2024)

{{<citation>}}

Jiaming Wang, Xinyu Geng, Jun Xu. (2024)  
**Nonlinear Kalman Filtering based on Self-Attention Mechanism and Lattice Trajectory Piecewise Linear Approximation**
<br/>
<button class="copy-to-clipboard" title="Nonlinear Kalman Filtering based on Self-Attention Mechanism and Lattice Trajectory Piecewise Linear Approximation" index=145>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 20  
Keywords: Simulation, Simulator  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04156v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04156v1.pdf" filename="2404.04156v1.pdf">Download PDF</button>
...
### (3/5 | 147/173) Optimal Policy Synthesis from A Sequence of Goal Sets with An Application to Electric Distribution System Restoration (İlker Işık et al., 2024)

{{<citation>}}

İlker Işık, Onur Yigit Arpali, Ebru Aydin Gol. (2024)  
**Optimal Policy Synthesis from A Sequence of Goal Sets with An Application to Electric Distribution System Restoration**
<br/>
<button class="copy-to-clipboard" title="Optimal Policy Synthesis from A Sequence of Goal Sets with An Application to Electric Distribution System Restoration" index=147>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04338v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04338v1.pdf" filename="2404.04338v1.pdf">Download PDF</button>
...
### (4/5 | 148/173) Field Teams Coordination for Earthquake-Damaged Distribution System Energization (İlker Işık et al., 2024)

{{<citation>}}

İlker Işık, Ebru Aydin Gol. (2024)  
**Field Teams Coordination for Earthquake-Damaged Distribution System Energization**
<br/>
<button class="copy-to-clipboard" title="Field Teams Coordination for Earthquake-Damaged Distribution System Energization" index=148>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 10  
Keywords: Markov Decision Process  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04087v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04087v1.pdf" filename="2404.04087v1.pdf">Download PDF</button>
...
### (5/5 | 149/173) Queue-aware Network Control Algorithm with a High Quantum Computing Readiness-Evaluated in Discrete-time Flow Simulator for Fat-Pipe Networks (Arthur Witt, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Queue-aware Network Control Algorithm with a High Quantum Computing Readiness-Evaluated in Discrete-time Flow Simulator for Fat-Pipe Networks" index=149>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 150/173) Low-Rank Robust Subspace Tensor Clustering for Metro Passenger Flow Modeling (Jiuyun Hu et al., 2024)

{{<citation>}}

Jiuyun Hu, Ziyue Li, Chen Zhang, Fugee Tsung, Hao Yan. (2024)  
**Low-Rank Robust Subspace Tensor Clustering for Metro Passenger Flow Modeling**
<br/>
<button class="copy-to-clipboard" title="Low-Rank Robust Subspace Tensor Clustering for Metro Passenger Flow Modeling" index=150>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Categories: cs-AI, stat-ME, stat.ME  
Keyword Score: 26  
Keywords: Benchmarking, Clustering, Simulation, Simulator  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04403v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04403v1.pdf" filename="2404.04403v1.pdf">Download PDF</button>
...
### (1/1 | 151/173) Quantum-informed simulations for mechanics of materials: DFTB+MBD framework (Zhaoxiang Shen et al., 2024)

{{<citation>}}

Zhaoxiang Shen, Raúl I. Sosa, Stéphane P. A. Bordas, Alexandre Tkatchenko, Jakub Lengiewicz. (2024)  
**Quantum-informed simulations for mechanics of materials: DFTB+MBD framework**
<br/>
<button class="copy-to-clipboard" title="Quantum-informed simulations for mechanics of materials: DFTB+MBD framework" index=151>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Categories: cs-CE, cs.CE, physics-comp-ph, quant-ph  
Keyword Score: 23  
Keywords: Benchmarking, Simulation, Simulator  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04216v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04216v1.pdf" filename="2404.04216v1.pdf">Download PDF</button>
...
### (1/2 | 152/173) A posteriori error analysis of a space-time hybridizable discontinuous Galerkin method for the advection-diffusion problem (Yuan Wang et al., 2024)

{{<citation>}}

Yuan Wang, Sander Rhebergen. (2024)  
...
<br/>
<button class="copy-to-clipboard" title="A posteriori error analysis of a space-time hybridizable discontinuous Galerkin method for the advection-diffusion problem" index=152>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 20  
Keywords: Simulation, Simulator  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04130v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04130v1.pdf" filename="2404.04130v1.pdf">Download PDF</button>
...
### (2/2 | 153/173) Highly efficient NURBS-based isogeometric analysis for coupled nonlinear diffusion-reaction equations with and without advection (Ilham Asmouh et al., 2024)

{{<citation>}}

Ilham Asmouh, Alexander Ostermann. (2024)  
...
<br/>
<button class="copy-to-clipboard" title="Highly efficient NURBS-based isogeometric analysis for coupled nonlinear diffusion-reaction equations with and without advection" index=153>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 154/173) Pros and Cons! Evaluating ChatGPT on Software Vulnerability (Xin Yin, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Pros and Cons! Evaluating ChatGPT on Software Vulnerability" index=154>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 155/173) Quand rechercher c'est faire des vagues : Dans et {à} partir des images algorithmiques (Gaëtan Robillard, 2024)
...
<br/>
<button class="copy-to-clipboard" title="Quand rechercher c'est faire des vagues : Dans et {à} partir des images algorithmiques" index=155>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 20  
Keywords: Simulation, Simulator  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.03923v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.03923v1.pdf" filename="2404.03923v1.pdf">Download PDF</button>
...
### (1/2 | 156/173) Deep Phase Coded Image Prior (Nimrod Shabtay et al., 2024)

{{<citation>}}

Nimrod Shabtay, Eli Schwartz, Raja Giryes. (2024)  
**Deep Phase Coded Image Prior**
<br/>
<button class="copy-to-clipboard" title="Deep Phase Coded Image Prior" index=156>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.03906v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.03906v1.pdf" filename="2404.03906v1.pdf">Download PDF</button>
...
### (2/2 | 157/173) LiDAR-Guided Cross-Attention Fusion for Hyperspectral Band Selection and Image Classification (Judy X Yang et al., 2024)

{{<citation>}}

Judy X Yang, Jun Zhou, Jing Wang, Hui Tian, Wee Chung Liew. (2024)  
**LiDAR-Guided Cross-Attention Fusion for Hyperspectral Band Selection and Image Classification**
<br/>
<button class="copy-to-clipboard" title="LiDAR-Guided Cross-Attention Fusion for Hyperspectral Band Selection and Image Classification" index=157>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
---
Primary Category: eess.IV  
Categories: F-2-2, I-2-7, cs-CV, eess-IV, eess.IV  
Keyword Score: 10  
Keywords: Transformer  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.03883v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.03883v1.pdf" filename="2404.03883v1.pdf">Download PDF</button>
...
### (1/1 | 158/173) Semantic SQL -- Combining and optimizing semantic predicates in SQL (Akash Mittal et al., 2024)

{{<citation>}}

Akash Mittal, Anshul Bheemreddy, Huili Tao. (2024)  
**Semantic SQL -- Combining and optimizing semantic predicates in SQL**
<br/>
<button class="copy-to-clipboard" title="Semantic SQL -- Combining and optimizing semantic predicates in SQL" index=158>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/2 | 159/173) Simplifying explicit subtyping coercions in a polymorphic calculus with effects (Filip Koprivec et al., 2024)

{{<citation>}}

Filip Koprivec, Matija Pretnar. (2024)  
**Simplifying explicit subtyping coercions in a polymorphic calculus with effects**
<br/>
<button class="copy-to-clipboard" title="Simplifying explicit subtyping coercions in a polymorphic calculus with effects" index=159>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04218v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04218v1.pdf" filename="2404.04218v1.pdf">Download PDF</button>
...
### (2/2 | 160/173) V-Star: Learning Visibly Pushdown Grammars from Program Inputs (Xiaodong Jia et al., 2024)

{{<citation>}}

Xiaodong Jia, Gang Tan. (2024)  
**V-Star: Learning Visibly Pushdown Grammars from Program Inputs**
<br/>
<button class="copy-to-clipboard" title="V-Star: Learning Visibly Pushdown Grammars from Program Inputs" index=160>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
---
Primary Category: cs.PL  
Categories: cs-FL, cs-PL, cs.PL  
Keyword Score: 10  
Keywords: Active Learning  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04201v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04201v1.pdf" filename="2404.04201v1.pdf">Download PDF</button>
...
### (1/1 | 161/173) Algorithmic Fairness and Social Welfare (Annie Liang et al., 2024)
...
<br/>
<button class="copy-to-clipboard" title="Algorithmic Fairness and Social Welfare" index=161>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 10  
Keywords: Fairness  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04424v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04424v1.pdf" filename="2404.04424v1.pdf">Download PDF</button>
...
### (1/1 | 162/173) Counting Like Transformers: Compiling Temporal Counting Logic Into Softmax Transformers (Andy Yang et al., 2024)

{{<citation>}}

Andy Yang, David Chiang. (2024)  
**Counting Like Transformers: Compiling Temporal Counting Logic Into Softmax Transformers**
<br/>
<button class="copy-to-clipboard" title="Counting Like Transformers: Compiling Temporal Counting Logic Into Softmax Transformers" index=162>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Categories: cs-CL, cs-FL, cs-LG, cs-LO, cs.LO  
Keyword Score: 10  
Keywords: Transformer  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04393v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04393v1.pdf" filename="2404.04393v1.pdf">Download PDF</button>

---


**ABSTRACT**  
Deriving formal bounds on the expressivity of <b>transformers,</b> as well as studying <b>transformers</b> that are constructed to implement known algorithms, are both effective methods for better understanding the computational power of <b>transformers.</b> Towards both ends, we introduce the temporal counting logic $\textbf{K}_\text{t}$[#] alongside the RASP variant $\textbf{C-RASP}$. We show they are equivalent to each other, and that together they are the best-known lower bound on the formal expressivity of future-masked soft attention <b>transformers</b> with unbounded input size. We prove this by showing all $\textbf{K}_\text{t}$[#] formulas can be compiled into these <b>transformers.</b> As a case study, we demonstrate on paper how to use $\textbf{C-RASP}$ to construct simple <b>transformer</b> language models that, using greedy decoding, can only generate sentences that have given properties formally specified in $\textbf{K}_\text{t}$[#].
...
### (1/1 | 163/173) H3DFact: Heterogeneous 3D Integrated CIM for Factorization with Holographic Perceptual Representations (Zishen Wan et al., 2024)

{{<citation>}}

Zishen Wan, Che-Kai Liu, Mohamed Ibrahim, Hanchen Yang, Samuel Spetalnick, Tushar Krishna, Arijit Raychowdhury. (2024)  
**H3DFact: Heterogeneous 3D Integrated CIM for Factorization with Holographic Perceptual Representations**
<br/>
<button class="copy-to-clipboard" title="H3DFact: Heterogeneous 3D Integrated CIM for Factorization with Holographic Perceptual Representations" index=163>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 10  
Keywords: Reasoning  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04173v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04173v1.pdf" filename="2404.04173v1.pdf">Download PDF</button>
...
### (1/2 | 164/173) On the Quest for Effectiveness in Human Oversight: Interdisciplinary Perspectives (Sarah Sterz et al., 2024)

{{<citation>}}

Sarah Sterz, Kevin Baum, Sebastian Biewer, Holger Hermanns, Anne Lauber-Rönsberg, Philip Meinel, Markus Langer. (2024)  
**On the Quest for Effectiveness in Human Oversight: Interdisciplinary Perspectives**
<br/>
<button class="copy-to-clipboard" title="On the Quest for Effectiveness in Human Oversight: Interdisciplinary Perspectives" index=164>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 10  
Keywords: Prompt  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04059v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04059v1.pdf" filename="2404.04059v1.pdf">Download PDF</button>
...
### (2/2 | 165/173) A Conceptual Design of In-Game Real and Virtual Currency Tracker (Dennis Barzanoff et al., 2024)

{{<citation>}}

Dennis Barzanoff, Amna Asif. (2024)  
**A Conceptual Design of In-Game Real and Virtual Currency Tracker**
<br/>
<button class="copy-to-clipboard" title="A Conceptual Design of In-Game Real and Virtual Currency Tracker" index=165>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 10  
Keywords: Recommendation  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.03951v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.03951v1.pdf" filename="2404.03951v1.pdf">Download PDF</button>
...
### (1/1 | 166/173) Suppressing Modulation Instability with Reinforcement Learning (Nikolay Kalmykov et al., 2024)

{{<citation>}}

Nikolay Kalmykov, Rishat Zagidullin, Oleg Rogov, Sergey Rykovanov, Dmitry V. Dylov. (2024)  
**Suppressing Modulation Instability with Reinforcement Learning**
<br/>
<button class="copy-to-clipboard" title="Suppressing Modulation Instability with Reinforcement Learning" index=166>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
---
Primary Category: nlin.PS  
Categories: cs-AI, cs-LG, cs-SY, eess-SY, nlin-PS, nlin.PS, physics-app-ph  
Keyword Score: 10  
Keywords: Reinforcement Learning  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04310v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04310v1.pdf" filename="2404.04310v1.pdf">Download PDF</button>
...
### (1/3 | 167/173) A Fine-grained Classification of Subquadratic Patterns for Subgraph Listing and Friends (Karl Bringmann et al., 2024)

{{<citation>}}

Karl Bringmann, Egor Gorbachev. (2024)  
**A Fine-grained Classification of Subquadratic Patterns for Subgraph Listing and Friends**
<br/>
<button class="copy-to-clipboard" title="A Fine-grained Classification of Subquadratic Patterns for Subgraph Listing and Friends" index=167>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 3  
Keywords: Graph  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.03979v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.03979v1.pdf" filename="2404.03979v1.pdf">Download PDF</button>
...
### (3/3 | 169/173) Minor Containment and Disjoint Paths in almost-linear time (Tuukka Korhonen et al., 2024)

{{<citation>}}

Tuukka Korhonen, Michał Pilipczuk, Giannos Stamoulis. (2024)  
**Minor Containment and Disjoint Paths in almost-linear time**
<br/>
<button class="copy-to-clipboard" title="Minor Containment and Disjoint Paths in almost-linear time" index=169>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 170/173) Wireless Resource Optimization in Hybrid Semantic/Bit Communication Networks (Le Xia et al., 2024)

{{<citation>}}

Le Xia, Yao Sun, Dusit Niyato, Lan Zhang, Muhammad Ali Imran. (2024)  
**Wireless Resource Optimization in Hybrid Semantic/Bit Communication Networks**
<br/>
<button class="copy-to-clipboard" title="Wireless Resource Optimization in Hybrid Semantic/Bit Communication Networks" index=170>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
### (1/1 | 171/173) Hardness of circuit and monotone diameters of polytopes (Christian Nöbel et al., 2024)

{{<citation>}}

Christian Nöbel, Raphael Steiner. (2024)  
**Hardness of circuit and monotone diameters of polytopes**
<br/>
<button class="copy-to-clipboard" title="Hardness of circuit and monotone diameters of polytopes" index=171>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Categories: cs-DM, cs-DS, math-CO, math-OC, math.OC  
Keyword Score: 3  
Keywords: Graph  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04158v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04158v1.pdf" filename="2404.04158v1.pdf">Download PDF</button>
...
### (1/1 | 172/173) Discrete Fréchet Distance Oracles (Boris Aronov et al., 2024)

{{<citation>}}

Boris Aronov, Tsuri Farhana, Matthew J. Katz, Indu Ramesh. (2024)  
**Discrete Fréchet Distance Oracles**
<br/>
<button class="copy-to-clipboard" title="Discrete Fréchet Distance Oracles" index=172>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Keyword Score: 3  
Keywords: Graph  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.04065v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.04065v1.pdf" filename="2404.04065v1.pdf">Download PDF</button>
...
### (1/1 | 173/173) The Low-Degree Hardness of Finding Large Independent Sets in Sparse Random Hypergraphs (Abhishek Dhawan et al., 2024)

{{<citation>}}

Abhishek Dhawan, Yuzhou Wang. (2024)  
**The Low-Degree Hardness of Finding Large Independent Sets in Sparse Random Hypergraphs**
<br/>
<button class="copy-to-clipboard" title="The Low-Degree Hardness of Finding Large Independent Sets in Sparse Random Hypergraphs" index=173>
  <span class="copy-to-clipboard-item">Copy Title<span>
</button>
...
Categories: cs-CC, cs-DS, cs.CC, math-CO, math-PR, stat-ML  
Keyword Score: 3  
Keywords: Graph  
<a type="button" class="btn btn-outline-primary" href="http://arxiv.org/abs/2404.03842v1" target="_blank" >Paper Link</a>
<button type="button" class="btn btn-outline-primary download-pdf" url="https://arxiv.org/pdf/2404.03842v1.pdf" filename="2404.03842v1.pdf">Download PDF</button>
