...
### (1/94) Making Large Multimodal Models Understand Arbitrary Visual Prompts (Mu Cai et al., 2023)
...
### (2/94) PointBeV: A Sparse Approach to BeV Predictions (Loick Chambon et al., 2023)
...
### (3/94) GIFT: Generative Interpretable Fine-Tuning Transformers (Chinmay Savadikar et al., 2023)
...
### (4/94) Open-vocabulary object 6D pose estimation (Jaime Corsetti et al., 2023)
...
### (5/94) LightCLIP: Learning Multi-Level Interaction for Lightweight Vision-Language Models (Ying Nie et al., 2023)
...
### (6/94) SPOT: Self-Training with Patch-Order Permutation for Object-Centric Learning with Autoregressive Transformers (Ioannis Kakogeorgiou et al., 2023)
...
### (7/94) Towards Efficient 3D Object Detection in Bird's-Eye-View Space for Autonomous Driving: A Convolutional-Only Approach (Yuxin Li et al., 2023)
...
### (8/94) BCN: Batch Channel Normalization for Image Classification (Afifa Khaled et al., 2023)
...
### (9/94) Event Recognition in Laparoscopic Gynecology Videos with Hybrid Transformers (Sahar Nasirihaghighi et al., 2023)
...
### (10/94) Less is More: Learning Reference Knowledge Using No-Reference Image Quality Assessment (Xudong Li et al., 2023)
...
### (11/94) Generative models for visualising abstract social processes: Guiding streetview image synthesis of StyleGAN2 with indices of deprivation (Aleksi Knuutila, 2023)
...
### (12/94) Explainable AI in Diagnosing and Anticipating Leukemia Using Transfer Learning Method (Wahidul Hasan Abir et al., 2023)
...
### (13/94) Dolphins: Multimodal Language Model for Driving (Yingzi Ma et al., 2023)
...
### (14/94) Enhancing Image Captioning with Neural Models (Pooja Bhatnagar et al., 2023)
...
### (15/94) Large-scale Vision-Language Models Learn Super Images for Efficient and High-Performance Partially Relevant Video Retrieval (Taichi Nishimura et al., 2023)
...
### (16/94) SCHEME: Scalable Channer Mixer for Vision Transformers (Deepak Sridhar et al., 2023)
...
### (17/94) VIoTGPT: Learning to Schedule Vision Tools towards Intelligent Video Internet of Things (Yaoyao Zhong et al., 2023)
...
### (18/94) Learning to Estimate Critical Gait Parameters from Single-View RGB Videos with Transformer-Based Attention Network (Quoc Hung T. Le et al., 2023)
...
### (19/94) Study and Survey on Gesture Recognition Systems (Kshitij Deshpande et al., 2023)
...
### (20/94) SynFundus: Generating a synthetic fundus images dataset with millions of samples and multi-disease annotations (Fangxin Shang et al., 2023)
...
### (21/94) Efficient Multimodal Semantic Segmentation via Dual-Prompt Learning (Shaohua Dong et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2312.00360v1)  
...
### (22/94) Manipulating the Label Space for In-Context Classification (Haokun Chen et al., 2023)
...
### (23/94) Learning Anatomically Consistent Embedding for Chest Radiography (Ziyu Zhou et al., 2023)
...
### (24/94) Adaptability of Computer Vision at the Tactical Edge: Addressing Environmental Uncertainty (Hayden Moore, 2023)
...
### (25/94) Towards Generalizable Zero-Shot Manipulation via Translating Human Interaction Plans (Homanga Bharadhwaj et al., 2023)
...
### (26/94) TRC: Trust Region Conditional Value at Risk for Safe Reinforcement Learning (Dohyeong Kim et al., 2023)
...
### (27/94) Context Retrieval via Normalized Contextual Latent Interaction for Conversational Agent (Junfeng Liu et al., 2023)
...
### (28/94) Mitigating Over-smoothing in Transformers via Regularized Nonlocal Functionals (Tam Nguyen et al., 2023)
...
### (29/94) SeaLLMs -- Large Language Models for Southeast Asia (Xuan-Phi Nguyen et al., 2023)
...
### (30/94) Towards Transparency in Coreference Resolution: A Quantum-Inspired Approach (Hadi Wazni et al., 2023)
...
### (31/94) Contextualized word senses: from attention to compositionality (Pablo Gamallo, 2023)
...
### (32/94) The Efficiency Spectrum of Large Language Models: An Algorithmic Survey (Tianyu Ding et al., 2023)
...
### (33/94) The Ethics of Automating Legal Actors (Josef Valvoda et al., 2023)
...
### (34/94) Explanatory Argument Extraction of Correct Answers in Resident Medical Exams (Iakes Goenaga et al., 2023)
...
### (35/94) Questioning Biases in Case Judgment Summaries: Legal Datasets or Large Language Models? (Aniket Deroy et al., 2023)
...
### (36/94) Improving Unsupervised Relation Extraction by Augmenting Diverse Sentence Pairs (Qing Wang et al., 2023)
...
### (37/94) SurreyAI 2023 Submission for the Quality Estimation Shared Task (Archchana Sindhujan et al., 2023)
...
### (38/94) Summarization-based Data Augmentation for Document Classification (Yueguan Wang et al., 2023)
...
### (39/94) Japanese Tort-case Dataset for Rationale-supported Legal Judgment Prediction (Hiroaki Yamada et al., 2023)
...
### (40/94) CoLLiE: Collaborative Training of Large Language Models in an Efficient Way (Kai Lv et al., 2023)
...
### (41/94) On Exploring the Reasoning Capability of Large Language Models with Knowledge Graphs (Pei-Chi Lo et al., 2023)
...
### (42/94) The Case for Scalable, Data-Driven Theory: A Paradigm for Scientific Progress in NLP (Julian Michael, 2023)
...
### (43/94) PsyAttention: Psychological Attention Model for Personality Detection (Baohua Zhang et al., 2023)
...
### (44/94) SEPSIS: I Can Catch Your Lies -- A New Paradigm for Deception Detection (Anku Rani et al., 2023)
...
### (45/94) Explaining Knock-on Effects of Bias Mitigation (Svetoslav Nizhnichenkov et al., 2023)
...
### (46/94) Deep Unlearning: Fast and Efficient Training-free Approach to Controlled Forgetting (Sangamesh Kodge et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2312.00761v1)  
...
### (47/94) Mamba: Linear-Time Sequence Modeling with Selective State Spaces (Albert Gu et al., 2023)
...
### (48/94) Safe Reinforcement Learning in Tensor Reproducing Kernel Hilbert Space (Xiaoyuan Cheng et al., 2023)
...
### (49/94) Removing Biases from Molecular Representations via Information Maximization (Chenyu Wang et al., 2023)
...
### (50/94) Nonparametric Variational Regularisation of Pretrained Transformers (Fabio Fehr et al., 2023)
...
### (51/94) Hashmarks: Privacy-Preserving Benchmarks for High-Stakes AI Evaluation (Paul Bricman, 2023)
...
### (52/94) Forecasting Trends in Food Security: a Reservoir Computing Approach (Joschka Herteux et al., 2023)
...
### (53/94) Tracking Object Positions in Reinforcement Learning: A Metric for Keypoint Detection (extended version) (Emma Cramer et al., 2023)
...
### (54/94) Explainable Fraud Detection with Deep Symbolic Classification (Samantha Visbeek et al., 2023)
...
### (55/94) Interior Point Constrained Reinforcement Learning with Global Convergence Guarantees (Tingting Ni et al., 2023)
...
### (56/94) On the Out-Of-Distribution Robustness of Self-Supervised Representation Learning for Phonocardiogram Signals (Aristotelis Ballas et al., 2023)
...
### (57/94) A Bayesian approach for prompt optimization in pre-trained language models (Antonio Sabbatella et al., 2023)
...
### (58/94) LinguaLinked: A Distributed Large Language Model Inference System for Mobile Devices (Junchen Zhao et al., 2023)
...
### (59/94) Optimal Sample Complexity of Contrastive Learning (Noga Alon et al., 2023)
...
### (60/94) Streaming Bayesian Modeling for predicting Fat-Tailed Customer Lifetime Value (Alexey V. Calabourdin et al., 2023)
...
### (61/94) Benchmarking Multi-Domain Active Learning on Image Classification (Jiayi Li et al., 2023)
...
### (62/94) Temperature Balancing, Layer-wise Weight Analysis, and Neural Network Training (Yefan Zhou et al., 2023)
...
### (63/94) Efficient Off-Policy Safe Reinforcement Learning Using Trust Region Conditional Value at Risk (Dohyeong Kim et al., 2023)
...
### (64/94) Hypergraph Node Representation Learning with One-Stage Message Passing (Shilin Qu et al., 2023)
...
### (65/94) Developmental Pretraining (DPT) for Image Classification Networks (Niranjan Rajesh et al., 2023)
...
### (66/94) Age-Based Scheduling for Mobile Edge Computing: A Deep Reinforcement Learning Approach (Xingqiu He et al., 2023)
...
### (67/94) Text Attribute Control via Closed-Loop Disentanglement (Lei Sha et al., 2023)
...
### (68/94) Towards Clinical Prediction with Transparency: An Explainable AI Approach to Survival Modelling in Residential Aged Care (Teo Susnjak et al., 2023)
...
### (69/94) Sample Efficient Reinforcement Learning from Human Feedback via Active Exploration (Viraj Mehta et al., 2023)
...
### (70/94) Beyond ChatBots: ExploreLLM for Structured Thoughts and Personalized Model Responses (Xiao Ma et al., 2023)
...
### (71/94) Experiment on Gender and Racial/Ethnic Bias Against Video Game Streamers: Comparing Perceived Gameplay Skill and Viewer Engagement (David V. Nguyen et al., 2023)
...
### (72/94) A Spatio-Temporal Graph Convolutional Network for Gesture Recognition from High-Density Electromyography (Wenjuan Zhong et al., 2023)
...
### (73/94) Generative artificial intelligence enhances individual creativity but reduces the collective diversity of novel content (Anil R. Doshi et al., 2023)
...
### (74/94) Deciphering Digital Detectives: Understanding LLM Behaviors and Capabilities in Multi-Agent Mystery Games (Dekun Wu et al., 2023)
...
### (75/94) Enhancing Explainability in Mobility Data Science through a combination of methods (Georgios Makridis et al., 2023)
...
### (76/94) Green Edge AI: A Contemporary Survey (Yuyi Mao et al., 2023)
...
### (77/94) Agent-OM: Leveraging Large Language Models for Ontology Matching (Zhangcheng Qiang et al., 2023)
...
### (78/94) Unsupervised Adaptive Implicit Neural Representation Learning for Scan-Specific MRI Reconstruction (Junwei Yang et al., 2023)
...
### (79/94) A Recent Survey of Vision Transformers for Medical Image Segmentation (Asifullah Khan et al., 2023)
...
### (80/94) Using Honeybuckets to Characterize Cloud Storage Scanning in the Wild (Katherine Izhikevich et al., 2023)
...
### (81/94) Hiding in text/plain sight: Security defences of Tor Onion Services (Q Misell, 2023)
...
### (82/94) The Impact of Privacy and Security Attitudes and Concerns of Travellers on Their Willingness to Use Mobility-as-a-Service Systems (Maria Sophia Heering et al., 2023)
...
### (83/94) PyraTrans: Learning Attention-Enriched Multi-Scale Pyramid Network from Pre-Trained Transformers for Effective Malicious URL Detection (Ruitong Liu et al., 2023)
...
### (84/94) MalDicom: A Memory Forensic Framework for Detecting Malicious Payload in DICOM Files (Ayushi Mishra et al., 2023)
...
### (85/94) Unleashing Cheapfakes through Trojan Plugins of Large Language Models (Tian Dong et al., 2023)
...
### (86/94) Mark My Words: Analyzing and Evaluating Language Model Watermarks (Julien Piet et al., 2023)
...
### (87/94) RIS-Based On-the-Air Semantic Communications -- a Diffractional Deep Neural Network Approach (Shuyi Chen et al., 2023)
...
### (88/94) VEXIR2Vec: An Architecture-Neutral Embedding Framework for Binary Similarity (S. VenkataKeerthy et al., 2023)
...
### (89/94) Optimal complexity of goal-oriented adaptive FEM for nonsymmetric linear elliptic PDEs (Philipp Bringmann et al., 2023)
...
### (90/94) Self-Supervised Learning of Spatial Acoustic Representation with Cross-Channel Signal Reconstruction and Multi-Channel Conformer (Bing Yang et al., 2023)
...
### (91/94) Impact of Data Augmentation on QCNNs (Leting Zhouli et al., 2023)
...
### (92/94) Quantum Kernel t-Distributed Stochastic Neighbor Embedding (Yoshiaki Kawase et al., 2023)
...
### (93/94) Skipper: Improving the Reach and Fidelity of Quantum Annealers by Skipping Long Chains (Ramin Ayanzadeh et al., 2023)
...
### (94/94) RadioGalaxyNET: Dataset and Novel Computer Vision Algorithms for the Detection of Extended Radio Galaxies and Infrared Hosts (Nikhel Gupta et al., 2023)
