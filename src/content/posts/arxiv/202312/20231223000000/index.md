...
### (1/84) DriveLM: Driving with Graph Visual Question Answering (Chonghao Sima et al., 2023)
...
### (2/84) DUSt3R: Geometric 3D Vision Made Easy (Shuzhe Wang et al., 2023)
...
### (3/84) Entropic Open-set Active Learning (Bardia Safaei et al., 2023)
...
### (4/84) VideoPoet: A Large Language Model for Zero-Shot Video Generation (Dan Kondratyuk et al., 2023)
...
### (5/84) HD-Painter: High-Resolution and Prompt-Faithful Text-Guided Image Inpainting with Diffusion Models (Hayk Manukyan et al., 2023)
...
### (6/84) LiDAR-LLM: Exploring the Potential of Large Language Models for 3D LiDAR Understanding (Senqiao Yang et al., 2023)
...
### (7/84) A Strong Baseline for Temporal Video-Text Alignment (Zeqian Li et al., 2023)
...
### (8/84) Dual Attention U-Net with Feature Infusion: Pushing the Boundaries of Multiclass Defect Segmentation (Rasha Alshawi et al., 2023)
...
### (9/84) Open-Set: ID Card Presentation Attack Detection using Neural Transfer Style (Reuben Markham et al., 2023)
...
### (10/84) Controllable 3D Face Generation with Conditional Style Code Diffusion (Xiaolong Shen et al., 2023)
...
### (11/84) Reducing Hallucinations: Enhancing VQA for Flood Disaster Damage Assessment with Visual Contexts (Yimin Sun et al., 2023)
...
### (12/84) Q-SENN: Quantized Self-Explaining Neural Networks (Thomas Norrenbrock et al., 2023)
...
### (13/84) Universal Noise Annotation: Unveiling the Impact of Noisy annotation on Object Detection (Kwangrok Ryoo et al., 2023)
...
### (14/84) Few Shot Part Segmentation Reveals Compositional Logic for Industrial Anomaly Detection (Soopil Kim et al., 2023)
...
### (15/84) 3D Points Splatting for Real-Time Dynamic Hand Reconstruction (Zheheng Jiang et al., 2023)
...
### (16/84) A Semantic Space is Worth 256 Language Descriptions: Make Stronger Segmentation Models with Descriptive Properties (Junfei Xiao et al., 2023)
...
### (17/84) DECO: Query-Based End-to-End Object Detection with ConvNets (Xinghao Chen et al., 2023)
...
### (18/84) Free-Editor: Zero-shot Text-driven 3D Scene Editing (Nazmul Karim et al., 2023)
...
### (19/84) Weakly Supervised Semantic Segmentation for Driving Scenes (Dongseob Kim et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2312.13646v1)  
...
### (20/84) SPGroup3D: Superpoint Grouping Network for Indoor 3D Object Detection (Yun Zhu et al., 2023)
...
### (21/84) A Comprehensive End-to-End Computer Vision Framework for Restoration and Recognition of Low-Quality Engineering Drawings (Lvyang Yang et al., 2023)
...
### (22/84) DREAM-Talk: Diffusion-based Realistic Emotional Audio-driven Method for Single Image Talking Face Generation (Chenxu Zhang et al., 2023)
...
### (23/84) ARBiBench: Benchmarking Adversarial Robustness of Binarized Neural Networks (Peng Zhao et al., 2023)
...
### (24/84) MR-STGN: Multi-Residual Spatio Temporal Graph Network Using Attention Fusion for Patient Action Assessment (Youssef Mourchid et al., 2023)
...
### (25/84) InfoVisDial: An Informative Visual Dialogue Dataset by Bridging Large Multimodal and Language Models (Bingbing Wen et al., 2023)
...
### (26/84) WellFactor: Patient Profiling using Integrative Embedding of Healthcare Data (Dongjin Choi et al., 2023)
...
### (27/84) On Partial Optimal Transport: Revising the Infeasibility of Sinkhorn and Efficient Gradient Methods (Anh Duc Nguyen et al., 2023)

{{<citation>}}

Anh Duc Nguyen, Tuan Dung Nguyen, Quang Minh Nguyen, Hoang H. Nguyen, Kim-Chuan Toh. (2023)  
...
Keywords: AI  
[Paper Link](http://arxiv.org/abs/2312.13970v1)  
...
### (28/84) Comparative Evaluation of Anomaly Detection Methods for Fraud Detection in Online Credit Card Payments (Hugo Thimonier et al., 2023)
...
### (29/84) Capture the Flag: Uncovering Data Insights with Large Language Models (Issam Laradji et al., 2023)
...
### (30/84) Sparse Training for Federated Learning with Regularized Error Correction (Ran Greidi et al., 2023)
...
### (31/84) Critic-Guided Decision Transformer for Offline Reinforcement Learning (Yuanfu Wang et al., 2023)
...
### (32/84) Anchoring Path for Inductive Relation Prediction in Knowledge Graphs (Zhixiang Su et al., 2023)
...
### (33/84) Fine-tuning Graph Neural Networks by Preserving Graph Generative Patterns (Yifei Sun et al., 2023)
...
### (34/84) The Truth is in There: Improving Reasoning in Language Models with Layer-Selective Rank Reduction (Pratyusha Sharma et al., 2023)
...
### (35/84) CR-SAM: Curvature Regularized Sharpness-Aware Minimization (Tao Wu et al., 2023)
...
### (36/84) Domain Adaptive Graph Classification (Siyang Luo et al., 2023)
...
### (37/84) LingoQA: Video Question Answering for Autonomous Driving (Ana-Maria Marcu et al., 2023)
...
### (38/84) Multi-Agent Probabilistic Ensembles with Trajectory Sampling for Connected Autonomous Vehicles (Ruoqi Wen et al., 2023)
...
### (39/84) Domain-Specific Fine-Tuning of Large Language Models for Interactive Robot Programming (Benjamin Alt et al., 2023)
...
### (40/84) A Summarized History-based Dialogue System for Amnesia-Free Prompt Updates (Hyejin Hong et al., 2023)
...
### (41/84) Open-Source Reinforcement Learning Environments Implemented in MuJoCo with Franka Manipulator (Zichun Xu et al., 2023)
...
### (42/84) Team Irisapu Project Description for DRC2023 (Reon Ohashi et al., 2023)
...
### (43/84) Meta-control of Dialogue Systems Using Large Language Models (Kotaro Shukuri et al., 2023)
...
### (44/84) Compositional Zero-Shot Learning for Attribute-Based Object Reference in Human-Robot Interaction (Peng Gao et al., 2023)
...
### (45/84) Learning Human-like Representations to Enable Learning Human Values (Andrea Wynn et al., 2023)
...
### (46/84) Understanding Inter-Session Intentions via Complex Logical Reasoning (Jiaxin Bai et al., 2023)
...
### (47/84) HGE: Embedding Temporal Knowledge Graphs in a Product Space of Heterogeneous Geometric Subspaces (Jiaxin Pan et al., 2023)
...
### (48/84) RetailSynth: Synthetic Data Generation for Retail AI Systems Evaluation (Yu Xia et al., 2023)
...
### (49/84) Designing Artificial Intelligence Equipped Social Decentralized Autonomous Organizations for Tackling Sextortion Cases Version 0.7 (Norta Alex et al., 2023)
...
### (50/84) T-Eval: Evaluating the Tool Utilization Capability Step by Step (Zehui Chen et al., 2023)
...
### (51/84) ChatGPT as a commenter to the news: can LLMs generate human-like opinions? (Rayden Tseng et al., 2023)
...
### (52/84) Typhoon: Thai Large Language Models (Kunat Pipatanakul et al., 2023)
...
### (53/84) Diversifying Knowledge Enhancement of Biomedical Language Models using Adapter Modules and Knowledge Graphs (Juraj Vladika et al., 2023)
...
### (54/84) Evaluating Task-oriented Dialogue Systems: A Systematic Review of Measures, Constructs and their Operationalisations (Anouck Braggaar et al., 2023)
...
### (55/84) Team Flow at DRC2023: Building Common Ground and Text-based Turn-taking in a Travel Agent Spoken Dialogue System (Ryu Hirai et al., 2023)
...
### (56/84) Text2Analysis: A Benchmark of Table Question Answering with Advanced Data Analysis and Unclear Queries (Xinyi He et al., 2023)
...
### (57/84) Argue with Me Tersely: Towards Sentence-Level Counter-Argument Generation (Jiayu Lin et al., 2023)
...
### (58/84) Towards More Faithful Natural Language Explanation Using Multi-Level Contrastive Learning in VQA (Chengen Lai et al., 2023)
...
### (59/84) Speech Translation with Large Language Models: An Industrial Practice (Zhichao Huang et al., 2023)
...
### (60/84) How to Prune Your Language Model: Recovering Accuracy on the 'Sparsity May Cry'' Benchmark (Eldar Kurtic et al., 2023)
...
### (61/84) Developing Interactive Tourism Planning: A Dialogue Robot System Powered by a Large Language Mode (Katsumasa Yoshikawa et al., 2023)
...
Categories: cs-CL, cs.CL  
Keywords: Dialog, Dialogue  
[Paper Link](http://arxiv.org/abs/2312.13545v1)  
...
### (62/84) Automated Clinical Coding for Outpatient Departments (Viktor Schlegel et al., 2023)
...
### (63/84) Decoupling Representation and Knowledge for Few-Shot Intent Classification and Slot Filling (Jie Han et al., 2023)
...
### (64/84) BANSpEmo: A Bangla Emotional Speech Recognition Dataset (Md Gulzar Hussain et al., 2023)
...
### (65/84) AsyncMLD: Asynchronous Multi-LLM Framework for Dialogue Recommendation System (Naoki Yoshimaru et al., 2023)
...
### (66/84) User-adaptive Tourist Information Dialogue System with Yes/No Classifier and Sentiment Estimator (Ryo Yanagimoto et al., 2023)
...
### (67/84) Dialogue System of Team NTT-EASE for DRC2023 (Yuki Kubo et al., 2023)
...
### (68/84) Understanding the Role of Large Language Models in Personalizing and Scaffolding Strategies to Combat Academic Procrastination (Ananya Bhattacharjee et al., 2023)
...
### (69/84) On the choice of the optimal temporal support for audio classification with Pre-trained embeddings (Aurian Quelennec et al., 2023)
...
### (70/84) Self-Supervised Adaptive AV Fusion Module for Pre-Trained ASR Models (Christopher Simic et al., 2023)
...
### (71/84) Fine-grained Disentangled Representation Learning for Multimodal Emotion Recognition (Haoqin Sun et al., 2023)
...
### (72/84) kNN-CTC: Enhancing ASR via Retrieval of CTC Pseudo Labels (Jiaming Zhou et al., 2023)
...
### (73/84) Multi-Level Knowledge Distillation for Speech Emotion Recognition in Noisy Conditions (Yang Liu et al., 2023)
...
### (74/84) How Does Connecting Online Activities to Advertising Inferences Impact Privacy Perceptions? (Florian M. Farke et al., 2023)
...
### (75/84) Hunting imaging biomarkers in pulmonary fibrosis: Benchmarks of the AIIB23 challenge (Yang Nan et al., 2023)
...
### (76/84) Benchmark Evaluation of Anomaly-Based Intrusion Detection Systems in the Context of Smart Grids (Ömer Sen et al., 2023)
...
### (77/84) A Forecasting-Based DLP Approach for Data Security (Kishu Gupta et al., 2023)
...
### (78/84) HW-V2W-Map: Hardware Vulnerability to Weakness Mapping Framework for Root Cause Analysis with GPT-assisted Mitigation Suggestion (Yu-Zheng Lin et al., 2023)
...
### (79/84) Secure Information Embedding in Images with Hybrid Firefly Algorithm (Sahil Nokhwal et al., 2023)
...
### (80/84) Self-supervised Complex Network for Machine Sound Anomaly Detection (Miseul Kim et al., 2023)
...
### (81/84) BrainTalker: Low-Resource Brain-to-Speech Synthesis with Transfer Learning using Wav2Vec 2.0 (Miseul Kim et al., 2023)
...
### (82/84) Empowering Few-Shot Recommender Systems with Large Language Models -- Enhanced Representations (Zhoumeng Wang, 2023)
...
### (83/84) Using GPT-4 Prompts to Determine Whether Articles Contain Functional Evidence Supporting or Refuting Variant Pathogenicity (Samuel J. Aronson et al., 2023)
...
### (84/84) An integrated framework for accelerating reactive flow simulation using GPU and machine learning models (Runze Mao et al., 2023)
