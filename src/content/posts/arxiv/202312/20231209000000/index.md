...
### (1/97) Scaling Laws of Synthetic Images for Model Training ... for Now (Lijie Fan et al., 2023)
...
### (2/97) GenTron: Delving Deep into Diffusion Transformers for Image and Video Generation (Shoufa Chen et al., 2023)
...
### (3/97) Self-Guided Open-Vocabulary Semantic Segmentation (Osman Ülger et al., 2023)
...
### (4/97) Multimodal Industrial Anomaly Detection by Crossmodal Feature Mapping (Alex Costanzino et al., 2023)
...
### (5/97) Bootstrapping Autonomous Radars with Self-Supervised Learning (Yiduo Hao et al., 2023)
...
### (6/97) GSGFormer: Generative Social Graph Transformer for Multimodal Pedestrian Trajectory Prediction (Zhongchang Luo et al., 2023)
...
### (7/97) PhotoMaker: Customizing Realistic Human Photos via Stacked ID Embedding (Zhen Li et al., 2023)
...
### (8/97) OT-Attack: Enhancing Adversarial Transferability of Vision-Language Models via Optimal Transport Optimization (Dongchen Han et al., 2023)
...
### (9/97) Intelligent Anomaly Detection for Lane Rendering Using Transformer with Self-Supervised Pre-Training and Customized Fine-Tuning (Yongqi Dong et al., 2023)
...
### (10/97) DemoCaricature: Democratising Caricature Generation with a Rough Sketch (Dar-Yen Chen et al., 2023)
...
### (11/97) Multi-View Unsupervised Image Generation with Cross Attention Guidance (Llukman Cerkezi et al., 2023)
...
### (12/97) Towards a Perceptual Evaluation Framework for Lighting Estimation (Justine Giroux et al., 2023)
...
### (13/97) GPT4SGG: Synthesizing Scene Graphs from Holistic and Region-specific Narratives (Zuyao Chen et al., 2023)
...
### (14/97) GPT-4V with Emotion: A Zero-shot Benchmark for Multimodal Emotion Understanding (Zheng Lian et al., 2023)
...
### (15/97) Stronger, Fewer, & Superior: Harnessing Vision Foundation Models for Domain Generalized Semantic Segmentation (Zhixiang Wei et al., 2023)
...
### (16/97) TeMO: Towards Text-Driven 3D Stylization for Multi-Object Meshes (Xuying Zhang et al., 2023)
...
### (17/97) Fine-tune vision foundation model for crack segmentation in civil infrastructures (Kang Ge et al., 2023)
...
### (18/97) Adventures of Trustworthy Vision-Language Models: A Survey (Mayank Vatsa et al., 2023)
...
### (19/97) TLCE: Transfer-Learning Based Classifier Ensembles for Few-Shot Class-Incremental Learning (Shuangmei Wang et al., 2023)
...
### (20/97) Joint-Individual Fusion Structure with Fusion Attention Module for Multi-Modal Skin Cancer Classification (Peng Tang et al., 2023)
...
### (21/97) Augmentation-Free Dense Contrastive Knowledge Distillation for Efficient Semantic Segmentation (Jiawei Fan et al., 2023)
...
### (22/97) EulerMormer: Robust Eulerian Motion Magnification via Dynamic Filtering within Transformer (Fei Wang et al., 2023)
...
### (23/97) A Multilevel Guidance-Exploration Network and Behavior-Scene Matching Method for Human Behavior Anomaly Detection (Guoqing Yang et al., 2023)
...
### (24/97) VRPTEST: Evaluating Visual Referring Prompting in Large Multimodal Models (Zongjie Li et al., 2023)
...
### (25/97) Large Language Models are Good Prompt Learners for Low-Shot Image Classification (Zhaoheng Zheng et al., 2023)
...
### (26/97) An unsupervised approach towards promptable defect segmentation in laser-based additive manufacturing by Segment Anything (Israt Zarin Era et al., 2023)
...
### (27/97) Residual Graph Convolutional Network for Bird's-Eye-View Semantic Segmentation (Qiuxiao Chen et al., 2023)
...
### (28/97) Doodle Your 3D: From Abstract Freehand Sketches to Precise 3D Shapes (Hmrishav Bandyopadhyay et al., 2023)
...
### (29/97) PartDistill: 3D Shape Part Segmentation by Vision-Language Model Distillation (Ardian Umam et al., 2023)
...
### (30/97) KOALA: Self-Attention Matters in Knowledge Distillation of Latent Diffusion Models for Memory-Efficient and Fast Image Synthesis (Youngwan Lee et al., 2023)
...
### (31/97) Stable diffusion for Data Augmentation in COCO and Weed Datasets (Boyang Deng et al., 2023)
...
### (32/97) Style Transfer to Calvin and Hobbes comics using Stable Diffusion (Sloke Shrestha et al., 2023)
...
### (33/97) Large Language Models for Mathematicians (Simon Frieder et al., 2023)
...
### (34/97) Efficient Monotonic Multihead Attention (Xutai Ma et al., 2023)
...
### (35/97) An LLM Compiler for Parallel Function Calling (Sehoon Kim et al., 2023)
...
### (36/97) A Block Metropolis-Hastings Sampler for Controllable Energy-based Text Generation (Jarad Forristal et al., 2023)
...
### (37/97) Chain of Code: Reasoning with a Language Model-Augmented Code Emulator (Chengshu Li et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2312.04474v1)  
...
### (38/97) Fortify the Shortest Stave in Attention: Enhancing Context Awareness of Large Language Models for Effective Tool Use (Yuhan Chen et al., 2023)
...
### (39/97) OpenAsp: A Benchmark for Multi-document Open Aspect-based Summarization (Shmuel Amar et al., 2023)
...
### (40/97) LaMPilot: An Open Benchmark Dataset for Autonomous Driving with Language Model Programs (Yunsheng Ma et al., 2023)
...
### (41/97) PCoQA: Persian Conversational Question Answering Dataset (Hamed Hematian Hemati et al., 2023)
...
### (42/97) CLadder: A Benchmark to Assess Causal Reasoning Capabilities of Language Models (Zhijing Jin et al., 2023)
...
### (43/97) Enhancing Medical Task Performance in GPT-4V: A Comprehensive Study on Prompt Engineering Strategies (Pengcheng Chen et al., 2023)
...
### (44/97) Beyond Surface: Probing LLaMA Across Scales and Layers (Nuo Chen et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2312.04333v1)  
...
### (45/97) nerblackbox: A High-level Library for Named Entity Recognition in Python (Felix Stollenwerk, 2023)
...
### (46/97) PsyChat: A Client-Centric Dialogue System for Mental Health Support (Huachuan Qiu et al., 2023)
...
### (47/97) Language Model Knowledge Distillation for Efficient Question Answering in Spanish (Adrián Bazaga et al., 2023)
...
### (48/97) Analyzing the Inherent Response Tendency of LLMs: Real-World Instructions-Driven Jailbreak (Yanrui Du et al., 2023)
...
### (49/97) Comparing Large Language Model AI and Human-Generated Coaching Messages for Behavioral Weight Loss (Zhuoran Huang et al., 2023)
...
### (50/97) Multimodal Misinformation Detection in a South African Social Media Environment (Amica De Jager et al., 2023)
...
### (51/97) RoAST: Robustifying Language Models via Adversarial Perturbation with Selective Training (Jaehyung Kim et al., 2023)
...
### (52/97) Cost-Effective In-Context Learning for Entity Resolution: A Design Space Exploration (Meihao Fan et al., 2023)
...
### (53/97) Adversarial Learning for Feature Shift Detection and Correction (Miriam Barrabes et al., 2023)
...
### (54/97) Trajeglish: Learning the Language of Driving Scenarios (Jonah Philion et al., 2023)
...
### (55/97) Using Large Language Models for Hyperparameter Optimization (Michael R. Zhang et al., 2023)
...
### (56/97) On the Learnability of Watermarks for Language Models (Chenchen Gu et al., 2023)
...
### (57/97) Horizon-Free and Instance-Dependent Regret Bounds for Reinforcement Learning with General Function Approximation (Jiayi Huang et al., 2023)
...
### (58/97) A Structural-Clustering Based Active Learning for Graph Neural Networks (Ricky Maulana Fajri et al., 2023)
...
### (59/97) Graph Convolutions Enrich the Self-Attention in Transformers! (Jeongwhan Choi et al., 2023)
...
### (60/97) CODEX: A Cluster-Based Method for Explainable Reinforcement Learning (Timothy K. Mathes et al., 2023)
...
### (61/97) Constrained Hierarchical Clustering via Graph Coarsening and Optimal Cuts (Eliabelle Mauduit et al., 2023)
...
### (62/97) TimeDRL: Disentangled Representation Learning for Multivariate Time-Series (Ching Chang et al., 2023)
...
### (63/97) Breaking the Entanglement of Homophily and Heterophily in Semi-supervised Node Classification (Henan Sun et al., 2023)
...
### (64/97) A Transformer Model for Symbolic Regression towards Scientific Discovery (Florian Lalande et al., 2023)
...
### (65/97) LiDAR: Sensing Linear Probing Performance in Joint Embedding SSL Architectures (Vimal Thilak et al., 2023)
...
### (66/97) Series2Vec: Similarity-based Self-supervised Representation Learning for Time Series Classification (Navid Mohammadi Foumani et al., 2023)
...
### (67/97) MICRO: Model-Based Offline Reinforcement Learning with a Conservative Bellman Operator (Xiao-Yin Liu et al., 2023)
...
### (68/97) Dream2Real: Zero-Shot 3D Object Rearrangement with Vision-Language Models (Ivan Kapelyukh et al., 2023)
...
### (69/97) Semi-Supervised Active Learning for Semantic Segmentation in Unknown Environments Using Informative Path Planning (Julius Rückin et al., 2023)
...
### (70/97) Data-Driven Robust Reinforcement Learning Control of Uncertain Nonlinear Systems: Towards a Fully-Automated, Insulin-Based Artificial Pancreas (Alexandros Tanzanakis et al., 2023)
...
### (71/97) AVA: Towards Autonomous Visualization Agents through Visual Perception-Driven Decision-Making (Shusen Liu et al., 2023)
...
### (72/97) Leveraging Transformer-based Language Models to Automate Requirements Satisfaction Assessment (Amrit Poudel et al., 2023)
...
### (73/97) Occlusion-based Detection of Trojan-triggering Inputs in Large Language Models of Code (Aftab Hussain et al., 2023)
...
### (74/97) Deep3DSketch: 3D modeling from Free-hand Sketches with View- and Structural-Aware Adversarial Training (Tianrun Chen et al., 2023)
...
### (75/97) Content Moderation on Social Media in the EU: Insights From the DSA Transparency Database (Chiara Drolsbach et al., 2023)
...
### (76/97) Scalable Knowledge Graph Construction and Inference on Human Genome Variants (Shivika Prasanna et al., 2023)
...
### (77/97) How much informative is your XAI? A decision-making assessment task to objectively measure the goodness of explanations (Marco Matarese et al., 2023)
...
### (78/97) AI and Jobs: Has the Inflection Point Arrived? Evidence from an Online Labor Platform (Dandan Qiao et al., 2023)
...
### (79/97) Using a Large Language Model to generate a Design Structure Matrix (Edwin C. Y. Koh, 2023)
...
### (80/97) Developing Elementary Federated Learning Algorithms Leveraging the ChatGPT (Miroslav Popovic et al., 2023)
...
### (81/97) An Improved Scheduling with Advantage Actor-Critic for Storm Workloads (Gaoqiang Dong et al., 2023)
...
### (82/97) Adversarial Denoising Diffusion Model for Unsupervised Anomaly Detection (Jongmin Yu et al., 2023)
...
### (83/97) Guided Reconstruction with Conditioned Diffusion Models for Unsupervised Anomaly Detection in Brain MRIs (Finn Behrendt et al., 2023)
...
### (84/97) A Scalable Network-Aware Multi-Agent Reinforcement Learning Framework for Decentralized Inverter-based Voltage Control (Han Xu et al., 2023)
...
### (85/97) NeuJeans: Private Neural Network Inference with Joint Optimization of Convolution and Bootstrapping (Jae Hyung Ju et al., 2023)
...
### (86/97) Dynamic Data-Driven Digital Twins for Blockchain Systems (Georgios Diamantopoulos et al., 2023)
...
### (87/97) A Novel Federated Learning-based Intrusion Detection System for Flying Ad Hoc Networks (Ozlem Ceviz et al., 2023)
...
### (88/97) Making Translators Privacy-aware on the User's Side (Ryoma Sato, 2023)
...
### (89/97) Defense against ML-based Power Side-channel Attacks on DNN Accelerators with Adversarial Attacks (Xiaobei Yan et al., 2023)
...
### (90/97) Simulating the Air Quality Impact of Prescribed Fires Using a Graph Neural Network-Based PM$_{2.5}$ Emissions Forecasting System (Kyleen Liao et al., 2023)
...
### (91/97) Mastering Complex Coordination through Attention-based Dynamic Graph (Guangchong Zhou et al., 2023)
...
### (92/97) Multi-scale Residual Transformer for VLF Lightning Transients Classification (Jinghao Sun et al., 2023)
...
### (93/97) Resource Allocation for Semantic Communication under Physical-layer Security (Yang Li et al., 2023)
...
### (94/97) Joint Training or Not: An Exploration of Pre-trained Speech Models in Audio-Visual Speaker Diarization (Huan Zhao et al., 2023)
...
### (95/97) Synergistic Signals: Exploiting Co-Engagement and Semantic Links via Graph Neural Networks (Zijie Huang et al., 2023)
...
### (96/97) A Low-Overhead Incorporation-Extrapolation based Few-Shot CSI Feedback Framework for Massive MIMO Systems (Binggui Zhou et al., 2023)
...
### (97/97) Efficiently Predicting Protein Stability Changes Upon Single-point Mutation with Large Language Models (Yijie Zhang et al., 2023)
