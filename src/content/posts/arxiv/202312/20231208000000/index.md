...
### (1/106) A Layer-Wise Tokens-to-Token Transformer Network for Improved Historical Document Image Enhancement (Risab Biswas et al., 2023)
...
### (2/106) The Potential of Vision-Language Models for Content Moderation of Children's Videos (Syed Hammad Ahmed et al., 2023)
...
### (3/106) Skeleton-in-Context: Unified Skeleton Sequence Modeling with In-Context Learning (Xinshun Wang et al., 2023)
...
### (4/106) Self-conditioned Image Generation via Generating Representations (Tianhong Li et al., 2023)
...
Categories: cs-CV, cs.CV  
Keywords: ImageNet  
[Paper Link](http://arxiv.org/abs/2312.03701v1)  
...
### (5/106) Reason2Drive: Towards Interpretable and Chain-based Reasoning for Autonomous Driving (Ming Nie et al., 2023)
...
### (6/106) MOCHa: Multi-Objective Reinforcement Mitigating Caption Hallucinations (Assaf Ben-Kish et al., 2023)
...
### (7/106) Language-Informed Visual Concept Learning (Sharon Lee et al., 2023)
...
### (8/106) Foundation Model Assisted Weakly Supervised Semantic Segmentation (Xiaobo Yang et al., 2023)
...
### (9/106) DocBinFormer: A Two-Level Transformer Network for Effective Document Image Binarization (Risab Biswas et al., 2023)
...
### (10/106) SYNC-CLIP: Synthetic Data Make CLIP Generalize Better in Data-Limited Scenarios (Mushui Liu et al., 2023)
...
### (11/106) Enhancing Kinship Verification through Multiscale Retinex and Combined Deep-Shallow features (El Ouanas Belabbaci et al., 2023)
...
### (12/106) When an Image is Worth 1,024 x 1,024 Words: A Case Study in Computational Pathology (Wenhui Wang et al., 2023)
...
### (13/106) Personalized Face Inpainting with Diffusion Models by Parallel Visual Attention (Jianjin Xu et al., 2023)
...
### (14/106) How Low Can You Go? Surfacing Prototypical In-Distribution Samples for Unsupervised Anomaly Detection (Felix Meissen et al., 2023)
...
### (15/106) Texture-Semantic Collaboration Network for ORSI Salient Object Detection (Gongyang Li et al., 2023)
...
### (16/106) GPT-4 Enhanced Multimodal Grounding for Autonomous Driving: Leveraging Cross-Modal Attention with Large Language Models (Haicheng Liao et al., 2023)
...
### (17/106) Low-shot Object Learning with Mutual Exclusivity Bias (Anh Thai et al., 2023)
...
### (18/106) On the Diversity and Realism of Distilled Dataset: An Efficient Dataset Distillation Paradigm (Peng Sun et al., 2023)
...
### (19/106) Defense Against Adversarial Attacks using Convolutional Auto-Encoders (Shreyasi Mandal, 2023)
...
### (20/106) AnimateZero: Video Diffusion Models are Zero-Shot Image Animators (Jiwen Yu et al., 2023)
...
### (21/106) Memory-Efficient Optical Flow via Radius-Distribution Orthogonal Cost Volume (Gangwei Xu et al., 2023)
...
### (22/106) F3-Pruning: A Training-Free and Generalized Pruning Strategy towards Faster and Finer Text-to-Video Synthesis (Sitong Su et al., 2023)
...
### (23/106) ShareCMP: Polarization-Aware RGB-P Semantic Segmentation (Zhuoyan Liu et al., 2023)
...
### (24/106) DeepPyramid+: Medical Image Segmentation using Pyramid View Fusion and Deformable Pyramid Reception (Negin Ghamsarian et al., 2023)
...
### (25/106) SVQ: Sparse Vector Quantization for Spatiotemporal Forecasting (Chao Chen et al., 2023)
...
### (26/106) Riemannian Complex Matrix Convolution Network for PolSAR Image Classification (Junfei Shi et al., 2023)
...
### (27/106) PointMoment:Mixed-Moment-based Self-Supervised Representation Learning for 3D Point Clouds (Xin Cao et al., 2023)
...
### (28/106) Building Category Graphs Representation with Spatial and Temporal Attention for Visual Navigation (Xiaobo Hu et al., 2023)
...
### (29/106) GCFA:Geodesic Curve Feature Augmentation via Shape Space Theory (Yuexing Han et al., 2023)
...
### (30/106) On the Robustness of Large Multimodal Models Against Image Adversarial Attacks (Xuanimng Cui et al., 2023)

{{<citation>}}

Xuanimng Cui, Alejandro Aparcedo, Young Kyun Jang, Ser-Nam Lim. (2023)  
...
[Paper Link](http://arxiv.org/abs/2312.03777v1)  
...
### (31/106) Class Incremental Learning for Adversarial Robustness (Seungju Cho et al., 2023)
...
### (32/106) STEP CATFormer: Spatial-Temporal Effective Body-Part Cross Attention Transformer for Skeleton-based Action Recognition (Nguyen Huu Bao Long, 2023)
...
### (33/106) Satellite Imagery and AI: A New Era in Ocean Conservation, from Research to Deployment and Impact (Patrick Beukema et al., 2023)
...
### (34/106) Adaptive Weighted Co-Learning for Cross-Domain Few-Shot Learning (Abdullah Alchihabi et al., 2023)
...
### (35/106) A Pseudo-Semantic Loss for Autoregressive Models with Logical Constraints (Kareem Ahmed et al., 2023)
...
### (36/106) Adaptive Dependency Learning Graph Neural Networks (Abishek Sriramulu et al., 2023)
...
### (37/106) A Masked Pruning Approach for Dimensionality Reduction in Communication-Efficient Federated Learning Systems (Tamir L. S. Gez et al., 2023)
...
### (38/106) Learning Genomic Sequence Representations using Graph Neural Networks over De Bruijn Graphs (Kacper Kapuśniak et al., 2023)
...
### (39/106) Pearl: A Production-ready Reinforcement Learning Agent (Zheqing Zhu et al., 2023)
...
### (40/106) Interpretability Illusions in the Generalization of Simplified Models (Dan Friedman et al., 2023)
...
### (41/106) MACCA: Offline Multi-agent Reinforcement Learning with Causal Credit Assignment (Ziyan Wang et al., 2023)
...
### (42/106) Transformer-Powered Surrogates Close the ICF Simulation-Experiment Gap with Extremely Limited Data (Matthew L. Olson et al., 2023)
...
### (43/106) Multi-Scale and Multi-Modal Contrastive Learning Network for Biomedical Time Series (Hongbo Guo et al., 2023)
...
### (44/106) Towards Sobolev Pruning (Neil Kichler et al., 2023)
...
### (45/106) SmoothQuant+: Accurate and Efficient 4-bit Post-Training WeightQuantization for LLM (Jiayi Pan et al., 2023)
...
### (46/106) Compressed Context Memory For Online Language Model Interaction (Jang-Hyun Kim et al., 2023)
...
### (47/106) Generalized Contrastive Divergence: Joint Training of Energy-Based Model and Diffusion Model through Inverse Reinforcement Learning (Sangwoong Yoon et al., 2023)
...
### (48/106) Complementary Benefits of Contrastive Learning and Self-Training Under Distribution Shift (Saurabh Garg et al., 2023)
...
### (49/106) Enhancing Molecular Property Prediction via Mixture of Collaborative Experts (Xu Yao et al., 2023)
...
### (50/106) OMNIINPUT: A Model-centric Evaluation Framework through Output Distribution (Weitang Liu et al., 2023)
...
### (51/106) Anomaly Detection for Scalable Task Grouping in Reinforcement Learning-based RAN Optimization (Jimmy Li et al., 2023)
...
### (52/106) CAFE: Towards Compact, Adaptive, and Fast Embedding for Large-scale Recommendation Models (Hailin Zhang et al., 2023)
...
### (53/106) Customizable Combination of Parameter-Efficient Modules for Multi-Task Learning (Haowen Wang et al., 2023)
...
### (54/106) Multicoated and Folded Graph Neural Networks with Strong Lottery Tickets (Jiale Yan et al., 2023)
...
### (55/106) Bootstrap Your Own Variance (Polina Turishcheva et al., 2023)
...
### (56/106) Domain Invariant Representation Learning and Sleep Dynamics Modeling for Automatic Sleep Staging (Seungyeon Lee et al., 2023)
...
### (57/106) Data Safety vs. App Privacy: Comparing the Usability of Android and iOS Privacy Labels (Yanzi Lin et al., 2023)
...
### (58/106) Collaboration or Corporate Capture? Quantifying NLP's Reliance on Industry Artifacts and Contributions (Will Aitken et al., 2023)
...
### (59/106) Efficient Large Language Models: A Survey (Zhongwei Wan et al., 2023)
...
### (60/106) Evaluating and Mitigating Discrimination in Language Model Decisions (Alex Tamkin et al., 2023)
...
### (61/106) Improving Activation Steering in Language Models with Mean-Centring (Ole Jorgensen et al., 2023)
...
### (62/106) Not All Large Language Models (LLMs) Succumb to the 'Reversal Curse': A Comparative Study of Deductive Logical Reasoning in BERT and GPT Models (Jingye Yang et al., 2023)
...
### (63/106) Improving Bias Mitigation through Bias Experts in Natural Language Understanding (Eojin Jeon et al., 2023)
...
### (64/106) XAIQA: Explainer-Based Data Augmentation for Extractive Question Answering (Joel Stremmel et al., 2023)
...
### (65/106) Holmes: Towards Distributed Training Across Clusters with Heterogeneous NIC Environment (Fei Yang et al., 2023)
...
### (66/106) Sig-Networks Toolkit: Signature Networks for Longitudinal Language Modelling (Talia Tseriotou et al., 2023)
...
### (67/106) Exploring Answer Information Methods for Question Generation with Transformers (Talha Chafekar et al., 2023)
...
### (68/106) AMR Parsing is Far from Solved: GrAPES, the Granular AMR Parsing Evaluation Suite (Jonas Groschwitz et al., 2023)
...
### (69/106) Think from Words(TFW): Initiating Human-Like Cognition in Large Language Models Through Think from Words for Japanese Text-level Classification (Chengguang Gan et al., 2023)
...
### (70/106) Comparative Analysis of Multilingual Text Classification & Identification through Deep Learning and Embedding Visualization (Arinjay Wyawhare, 2023)
...
### (71/106) A Text-to-Text Model for Multilingual Offensive Language Identification (Tharindu Ranasinghe et al., 2023)
...
### (72/106) KhabarChin: Automatic Detection of Important News in the Persian Language (Hamed Hematian Hemati et al., 2023)
...
### (73/106) Teaching Specific Scientific Knowledge into Large Language Models through Additional Training (Kan Hatakeyama-Sato et al., 2023)
...
### (74/106) Measuring Misogyny in Natural Language Generation: Preliminary Results from a Case Study on two Reddit Communities (Aaron J. Snoswell et al., 2023)
...
### (75/106) Corporate Bankruptcy Prediction with Domain-Adapted BERT (Alex Kim et al., 2023)
...
### (76/106) Deliberative Technology for Alignment (Andrew Konya et al., 2023)
...
### (77/106) Geometry Matching for Multi-Embodiment Grasping (Maria Attarian et al., 2023)
...
### (78/106) MIRACLE: Inverse Reinforcement and Curriculum Learning Model for Human-inspired Mobile Robot Navigation (Nihal Gunukula et al., 2023)
...
### (79/106) Optimal Wildfire Escape Route Planning for Drones under Dynamic Fire and Smoke (Chang Liu et al., 2023)
...
### (80/106) VLFM: Vision-Language Frontier Maps for Zero-Shot Semantic Navigation (Naoki Yokoyama et al., 2023)
...
### (81/106) Dr. Jekyll and Mr. Hyde: Two Faces of LLMs (Matteo Gioele Collu et al., 2023)
...
### (82/106) Fed-urlBERT: Client-side Lightweight Federated Transformers for URL Threat Analysis (Yujie Li et al., 2023)
...
### (83/106) Behavioral Authentication for Security and Safety (Cheng Wang et al., 2023)
...
### (84/106) Securing Data Platforms: Strategic Masking Techniques for Privacy and Security for B2B Enterprise Data (Mandar Khoje, 2023)
...
### (85/106) A Simple Framework to Enhance the Adversarial Robustness of Deep Learning-based Intrusion Detection System (Xinwei Yuan et al., 2023)
...
### (86/106) High Pileup Particle Tracking with Object Condensation (Kilian Lieret et al., 2023)
...
### (87/106) LLM as OS (llmao), Agents as Apps: Envisioning AIOS, Agents and the AIOS-Agent Ecosystem (Yingqiang Ge et al., 2023)
...
### (88/106) An Integration of Pre-Trained Speech and Language Models for End-to-End Speech Recognition (Yukiya Hono et al., 2023)
...
### (89/106) Golden Gemini is All You Need: Finding the Sweet Spots for Speaker Verification (Tianchi Liu et al., 2023)
...
### (90/106) Generative agent-based modeling with actions grounded in physical, social, or digital space using Concordia (Alexander Sasha Vezhnevets et al., 2023)
...
### (91/106) Active Wildfires Detection and Dynamic Escape Routes Planning for Humans through Information Fusion between Drones and Satellites (Chang Liu et al., 2023)
...
### (92/106) Can language agents be alternatives to PPO? A Preliminary Empirical Study On OpenAI Gym (Junjie Sheng et al., 2023)
...
### (93/106) Editable Stain Transformation Of Histological Images Using Unpaired GANs (Tibor Sloboda et al., 2023)
...
### (94/106) PneumoLLM: Harnessing the Power of Large Language Model for Pneumoconiosis Diagnosis (Meiyue Song et al., 2023)
...
Keywords: Language Model  
[Paper Link](http://arxiv.org/abs/2312.03490v1)  
...
### (95/106) Augmenting optimization-based molecular design with graph neural networks (Shiqiang Zhang et al., 2023)
...
### (96/106) Invariance & Causal Representation Learning: Prospects and Limitations (Simon Bing et al., 2023)
...
### (97/106) Precision of Individual Shapley Value Explanations (Lars Henry Berge Olsen, 2023)
...
### (98/106) Blueprinting the Future: Automatic Item Categorization using Hierarchical Zero-Shot and Few-Shot Classifiers (Ting Wang et al., 2023)
...
### (99/106) MCAIMem: a Mixed SRAM and eDRAM Cell for Area and Energy-efficient on-chip AI Memory (Duy-Thanh Nguyen et al., 2023)
...
### (100/106) Clustering by Contour coreset and variational quantum eigensolver (Canaan Yung et al., 2023)
...
### (101/106) Boosting legal case retrieval by query content selection with large language models (Youchao Zhou et al., 2023)
...
### (102/106) JAMMIN-GPT: Text-based Improvisation using LLMs in Ableton Live (Sven Hollowell et al., 2023)
...
### (103/106) An AI for Scientific Discovery Route between Amorphous Networks and Mechanical Behavior (Changliang Zhu et al., 2023)
...
### (104/106) Public emotional dynamics toward AIGC content generation across social media platform (Qinglan Wei et al., 2023)
...
### (105/106) Masking Behaviors in Epidemiological Networks with Cognitively-plausible Reinforcement Learning (Konstantinos Mitsopoulos et al., 2023)
...
### (106/106) HEET: A Heterogeneity Measure to Quantify the Difference across Distributed Computing Systems (Ali Mokhtari et al., 2023)
