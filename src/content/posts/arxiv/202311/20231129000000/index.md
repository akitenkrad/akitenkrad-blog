...
### (1/144) Reducing Gender Bias in Machine Translation through Counterfactual Data Generation (Ranjita Naik et al., 2023)
...
### (2/144) Releasing the CRaQAn (Coreference Resolution in Question-Answering): An open-source dataset and dataset creation methodology using instruction-following models (Rob Grzywinski et al., 2023)
...
### (3/144) Applications of Large Language Models in Data Processing: Innovative Approaches to Segmenting and Renewing Information (Yu-Chen Lin et al., 2023)
...
### (4/144) BERT Goes Off-Topic: Investigating the Domain Transfer Challenge using Genre Classification (Dmitri Roussinov et al., 2023)
...
### (5/144) MEDITRON-70B: Scaling Medical Pretraining for Large Language Models (Zeming Chen et al., 2023)
...
### (6/144) BioLORD-2023: Semantic Textual Representations Fusing LLM and Clinical Knowledge Graph Insights (François Remy et al., 2023)
...
### (7/144) MMMU: A Massive Multi-discipline Multimodal Understanding and Reasoning Benchmark for Expert AGI (Xiang Yue et al., 2023)
...
### (8/144) A Quantitative Approach to Understand Self-Supervised Models as Cross-lingual Feature Extractors (Shuyue Stella Li et al., 2023)
...
### (9/144) Leveraging deep active learning to identify low-resource mobility functioning information in public clinical notes (Tuan-Dung Le et al., 2023)
...
### (10/144) Tell2Design: A Dataset for Language-Guided Floor Plan Generation (Sicong Leng et al., 2023)
...
### (11/144) WorldSense: A Synthetic Benchmark for Grounded Reasoning in Large Language Models (Youssef Benchekroun et al., 2023)
...
### (12/144) YUAN 2.0: A Large Language Model with Localized Filtering-based Attention (Shaohua Wu et al., 2023)
...
### (13/144) Towards Vision Enhancing LLMs: Empowering Multimodal Knowledge Storage and Sharing in LLMs (Yunxin Li et al., 2023)
...
### (14/144) Italian Crossword Generator: Enhancing Education through Interactive Word Puzzles (Kamyar Zeinalipour et al., 2023)
...
### (15/144) Justifiable Artificial Intelligence: Engineering Large Language Models for Legal Applications (Sabine Wehnert, 2023)
...
### (16/144) Cerbero-7B: A Leap Forward in Language-Specific LLMs Through Enhanced Chat Corpus Generation and Evaluation (Federico A. Galatolo et al., 2023)
...
### (17/144) Injecting linguistic knowledge into BERT for Dialogue State Tracking (Xiaohan Feng et al., 2023)
...
### (18/144) FreeAL: Towards Human-Free Active Learning in the Era of Large Language Models (Ruixuan Xiao et al., 2023)
...
### (19/144) Evaluating the Efficacy of Hybrid Deep Learning Models in Distinguishing AI-Generated Text (Finbarrs Oketunji, 2023)
...
### (20/144) Boot and Switch: Alternating Distillation for Zero-Shot Dense Retrieval (Fan Jiang et al., 2023)
...
### (21/144) Deficiency of Large Language Models in Finance: An Empirical Examination of Hallucination (Haoqiang Kang et al., 2023)
...
### (22/144) The effect of source disclosure on evaluation of AI-generated messages: A two-part study (Sue Lim et al., 2023)
...
### (23/144) Overview of the VLSP 2022 -- Abmusu Shared Task: A Data Challenge for Vietnamese Abstractive Multi-document Summarization (Mai-Vu Tran et al., 2023)
...
### (24/144) A Comparative and Experimental Study on Automatic Question Answering Systems and its Robustness against Word Jumbling (Shashidhar Reddy Javaji et al., 2023)
...
### (25/144) A Corpus for Named Entity Recognition in Chinese Novels with Multi-genres (Hanjie Zhao et al., 2023)
...
### (26/144) Improving Word Sense Disambiguation in Neural Machine Translation with Salient Document Context (Elijah Rippeth et al., 2023)
...
### (27/144) Optimizing and Fine-tuning Large Language Model for Urban Renewal (Xi Wang et al., 2023)
...
### (28/144) Robust Basket Recommendation via Noise-tolerated Graph Contrastive Learning (Xinrui He et al., 2023)
...
### (29/144) SEINE: SEgment-based Indexing for NEural information retrieval (Sibo Dong et al., 2023)
...
### (30/144) A Social-aware Gaussian Pre-trained Model for Effective Cold-start Recommendation (Siwei Liu et al., 2023)
...
### (31/144) UFIN: Universal Feature Interaction Network for Multi-Domain Click-Through Rate Prediction (Zhen Tian et al., 2023)
...
### (32/144) Target-Free Compound Activity Prediction via Few-Shot Learning (Peter Eckmann et al., 2023)
...
### (33/144) Influence Scores at Scale for Efficient Language Data Sampling (Nikhil Anand et al., 2023)
...
### (34/144) A Graph Neural Network-Based QUBO-Formulated Hamiltonian-Inspired Loss Function for Combinatorial Optimization using Reinforcement Learning (Redwan Ahmed Rizvee et al., 2023)
...
### (35/144) Metric Space Magnitude for Evaluating Unsupervised Representation Learning (Katharina Limbeck et al., 2023)
...
### (36/144) Forecasting Auxiliary Energy Consumption for Electric Heavy-Duty Vehicles (Yuantao Fan et al., 2023)
...
### (37/144) Sparsify-then-Classify: From Internal Neurons of Large Language Models To Efficient Text Classifiers (Yilun Liu et al., 2023)
...
### (38/144) Soil Organic Carbon Estimation from Climate-related Features with Graph Neural Network (Weiying Zhao et al., 2023)
...
### (39/144) Over-Squashing in Riemannian Graph Neural Networks (Julia Balla, 2023)
...
### (40/144) Reinforcement Learning for Wildfire Mitigation in Simulated Disaster Environments (Alexander Tapley et al., 2023)
...
### (41/144) Diagnosis driven Anomaly Detection for CPS (Henrik S. Steude et al., 2023)
...
### (42/144) Utilizing Explainability Techniques for Reinforcement Learning Model Assurance (Alexander Tapley et al., 2023)
...
### (43/144) Exploring Artificial Intelligence Methods for Energy Prediction in Healthcare Facilities: An In-Depth Extended Systematic Review (Marjan FatehiJananloo et al., 2023)
...
### (44/144) Attend Who is Weak: Enhancing Graph Condensation via Cross-Free Adversarial Training (Xinglin Li et al., 2023)
...
### (45/144) ChatTraffc: Text-to-Traffic Generation via Diffusion Model (Chengyang Zhang et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2311.16203v1)  
...
### (46/144) Leveraging Out-of-Domain Data for Domain-Specific Prompt Tuning in Multi-Modal Fake News Detection (Debarshi Brahma et al., 2023)
...
### (47/144) Out-of-Distribution Generalized Dynamic Graph Neural Network for Human Albumin Prediction (Zeyang Zhang et al., 2023)
...
### (48/144) SSIN: Self-Supervised Learning for Rainfall Spatial Interpolation (Jia Li et al., 2023)
...
### (49/144) Automatic Time Signature Determination for New Scores Using Lyrics for Latent Rhythmic Structure (Callie C. Liao et al., 2023)
...
### (50/144) Characterizing Video Question Answering with Sparsified Inputs (Shiyuan Huang et al., 2023)
...
### (51/144) Aligning Non-Causal Factors for Transformer-Based Source-Free Domain Adaptation (Sunandini Sanyal et al., 2023)
...
### (52/144) Removing NSFW Concepts from Vision-and-Language Models for Text-to-Image Retrieval and Generation (Samuele Poppi et al., 2023)
...
### (53/144) SemiVL: Semi-Supervised Semantic Segmentation with Vision-Language Guidance (Lukas Hoyer et al., 2023)
...
### (54/144) Video-Bench: A Comprehensive Benchmark and Toolkit for Evaluating Video-based Large Language Models (Munan Ning et al., 2023)
...
### (55/144) Test-time Adaptation of Discriminative Models via Diffusion Generative Feedback (Mihir Prabhudesai et al., 2023)
...
### (56/144) How Many Unicorns Are in This Image? A Safety Evaluation Benchmark for Vision LLMs (Haoqin Tu et al., 2023)
...
### (57/144) ViT-Lens-2: Gateway to Omni-modal Intelligence (Weixian Lei et al., 2023)
...
### (58/144) OccWorld: Learning a 3D Occupancy World Model for Autonomous Driving (Wenzhao Zheng et al., 2023)
...
### (59/144) VLPrompt: Vision-Language Prompting for Panoptic Scene Graph Generation (Zijian Zhou et al., 2023)
...
### (60/144) Unified Batch Normalization: Identifying and Alleviating the Feature Condensation in Batch Normalization and a Unified Framework (Shaobo Wang et al., 2023)
...
### (61/144) CoSeR: Bridging Image and Language for Cognitive Super-Resolution (Haoze Sun et al., 2023)
...
### (62/144) Direct2.5: Diverse Text-to-3D Generation via Multi-view 2.5D Diffusion (Yuanxun Lu et al., 2023)
...
### (63/144) FALCON: Fairness Learning via Contrastive Attention Approach to Continual Semantic Scene Understanding in Open World (Thanh-Dat Truong et al., 2023)
...
### (64/144) Efficient Pre-training for Localized Instruction Generation of Videos (Anil Batra et al., 2023)
...
### (65/144) From Pixels to Titles: Video Game Identification by Screenshots using Convolutional Neural Networks (Fabricio Breve, 2023)
...
### (66/144) Computer Vision for Carriers: PATRIOT (Ari Goodman et al., 2023)
...
### (67/144) ChartLlama: A Multimodal LLM for Chart Understanding and Generation (Yucheng Han et al., 2023)
...
### (68/144) Data Generation for Post-OCR correction of Cyrillic handwriting (Evgenii Davydkin et al., 2023)
...
### (69/144) EVCap: Retrieval-Augmented Image Captioning with External Visual-Name Memory for Open-World Comprehension (Jiaxuan Li et al., 2023)
...
### (70/144) RO-LLaMA: Generalist LLM for Radiation Oncology via Noise Augmentation and Consistency Regularization (Kwanyoung Kim et al., 2023)
...
### (71/144) InterControl: Generate Human Motion Interactions by Controlling Every Joint (Zhenzhi Wang et al., 2023)
...
### (72/144) Learning with Noisy Low-Cost MOS for Image Quality Assessment via Dual-Bias Calibration (Lei Wang et al., 2023)
...
### (73/144) FlowZero: Zero-Shot Text-to-Video Synthesis with LLM-Driven Dynamic Scene Syntax (Yu Lu et al., 2023)
...
### (74/144) LLMGA: Multimodal Large Language Model based Generation Assistant (Bin Xia et al., 2023)
...
### (75/144) C-SAW: Self-Supervised Prompt Learning for Image Generalization in Remote Sensing (Avigyan Bhattacharya et al., 2023)
...
### (76/144) PIPE : Parallelized Inference Through Post-Training Quantization Ensembling of Residual Expansions (Edouard Yvinec et al., 2023)
...
### (77/144) Video Anomaly Detection via Spatio-Temporal Pseudo-Anomaly Generation : A Unified Approach (Ayush K. Rai et al., 2023)
...
### (78/144) TFMQ-DM: Temporal Feature Maintenance Quantization for Diffusion Models (Yushi Huang et al., 2023)
...
### (79/144) Machine Learning-Based Jamun Leaf Disease Detection: A Comprehensive Review (Auvick Chandra Bhowmik et al., 2023)
...
### (80/144) Optimization of Image Processing Algorithms for Character Recognition in Cultural Typewritten Documents (Mariana Dias et al., 2023)
...
### (81/144) GPT4Vis: What Can GPT-4 Do for Zero-shot Visual Recognition? (Wenhao Wu et al., 2023)
...
### (82/144) Adinkra Symbol Recognition using Classical Machine Learning and Deep Learning (Michael Adjeisah et al., 2023)
...
### (83/144) MARIS: Referring Image Segmentation via Mutual-Aware Attention Features (Mengxi Zhang et al., 2023)
...
### (84/144) Variational Autoencoders for Feature Exploration and Malignancy Prediction of Lung Lesions (Benjamin Keel et al., 2023)
...
### (85/144) SAM-6D: Segment Anything Model Meets Zero-Shot 6D Object Pose Estimation (Jiehong Lin et al., 2023)
...
### (86/144) ArGue: Attribute-Guided Prompt Tuning for Vision-Language Models (Xinyu Tian et al., 2023)
...
### (87/144) HAVE-FUN: Human Avatar Reconstruction from Few-Shot Unconstrained Images (Xihe Yang et al., 2023)
...
### (88/144) Enhancing Diffusion Models with Text-Encoder Reinforcement Learning (Chaofeng Chen et al., 2023)
...
### (89/144) Mitigating Hallucination in Visual Language Models with Visual Supervision (Zhiyang Chen et al., 2023)
...
### (90/144) Reinforcement Learning from Diffusion Feedback: Q* for Image Search (Aboli Marathe, 2023)
...
### (91/144) Only Positive Cases: 5-fold High-order Attention Interaction Model for Skin Segmentation Derived Classification (Renkai Wu et al., 2023)
...
### (92/144) RetouchUAA: Unconstrained Adversarial Attack via Image Retouching (Mengda Xie et al., 2023)
...
### (93/144) 2D Feature Distillation for Weakly- and Semi-Supervised 3D Semantic Segmentation (Ozan Unal et al., 2023)
...
### (94/144) UniRepLKNet: A Universal Perception Large-Kernel ConvNet for Audio, Video, Point Cloud, Time-Series and Image Recognition (Xiaohan Ding et al., 2023)
...
### (95/144) Can Vision-Language Models Think from a First-Person Perspective? (Sijie Cheng et al., 2023)
...
### (96/144) Progressive Target-Styled Feature Augmentation for Unsupervised Domain Adaptation on Point Clouds (Zicheng Wang et al., 2023)
...
### (97/144) Pre-trained Language Models Do Not Help Auto-regressive Text-to-Image Generation (Yuhui Zhang et al., 2023)
...
### (98/144) Improving Adaptability and Generalizability of Efficient Transfer Learning for Vision-Language Models (Yongjin Yang et al., 2023)
...
### (99/144) Fully Authentic Visual Question Answering Dataset from Online Communities (Chongyan Chen et al., 2023)
...
### (100/144) PKU-I2IQA: An Image-to-Image Quality Assessment Database for AI Generated Images (Jiquan Yuan et al., 2023)
...
Categories: cs-CV, cs.CV, eess-IV  
Keywords: AI, QA  
[Paper Link](http://arxiv.org/abs/2311.15556v1)  
...
### (101/144) Instruct2Attack: Language-Guided Semantic Adversarial Attacks (Jiang Liu et al., 2023)
...
### (102/144) Beyond Pixels: Exploring Human-Readable SVG Generation for Simple Images with Vision Language Models (Tong Zhang et al., 2023)
...
### (103/144) EAFP-Med: An Efficient Adaptive Feature Processing Module Based on Prompts for Medical Image Detection (Xiang Li et al., 2023)
...
### (104/144) SED: A Simple Encoder-Decoder for Open-Vocabulary Semantic Segmentation (Bin Xie et al., 2023)
...
### (105/144) MeshGPT: Generating Triangle Meshes with Decoder-Only Transformers (Yawar Siddiqui et al., 2023)
...
### (106/144) Student Mastery or AI Deception? Analyzing ChatGPT's Assessment Proficiency and Evaluating Detection Strategies (Kevin Wang et al., 2023)
...
### (107/144) Generative AI and US Intellectual Property Law (Cherie M Poland, 2023)
...
### (108/144) Towards Responsible Governance of Biological Design Tools (Richard Moulange et al., 2023)
...
### (109/144) Public sentiment analysis and topic modeling regarding ChatGPT in mental health on Reddit: Negative sentiments increase over time (Yunna Cai et al., 2023)
...
### (110/144) Optimal Observer Design Using Reinforcement Learning and Quadratic Neural Networks (Soroush Asri et al., 2023)
...
### (111/144) Networked Multiagent Safe Reinforcement Learning for Low-carbon Demand Management in Distribution Network (Jichen Zhang et al., 2023)
...
### (112/144) Active Foundational Models for Fault Diagnosis of Electrical Motors (Sriram Anbalagan et al., 2023)
...
### (113/144) Transformer-QEC: Quantum Error Correction Code Decoding with Transferable Transformers (Hanrui Wang et al., 2023)
...
### (114/144) Towards Transfer Learning for Large-Scale Image Classification Using Annealing-based Quantum Boltzmann Machines (Daniëlle Schuman et al., 2023)
...
### (115/144) Seeing Beyond Cancer: Multi-Institutional Validation of Object Localization and 3D Semantic Segmentation using Deep Learning for Breast MRI (Arda Pekis et al., 2023)
...
### (116/144) Spatially Covariant Image Registration with Text Prompts (Hang Zhang et al., 2023)
...
### (117/144) Evaluating the Impact of Personalized Value Alignment in Human-Robot Interaction: Insights into Trust and Team Performance Outcomes (Shreyas Bhat et al., 2023)
...
### (118/144) Modular Customizable ROS-Based Framework for Rapid Development of Social Robots (Mahta Akhyani et al., 2023)
...
### (119/144) SceneDM: Scene-level Multi-agent Trajectory Generation with Consistent Diffusion Models (Zhiming Guo et al., 2023)
...
### (120/144) MOT-DETR: 3D Single Shot Detection and Tracking with Transformers to build 3D representations for Agro-Food Robots (David Rapado-Rincon et al., 2023)
...
### (121/144) RoboGPT: an intelligent agent of making embodied long-term decisions for daily instruction tasks (Yaran Chen et al., 2023)
...
### (122/144) Application of Diagnostic Test Methods To The Classification Of Time Series With Discrete Values (Artyom Gevorgyan et al., 2023)
...
### (123/144) An HCAI Methodological Framework: Putting It Into Action to Enable Human-Centered AI (Wei Xu et al., 2023)
...
Keywords: AI  
[Paper Link](http://arxiv.org/abs/2311.16027v1)  
...
### (124/144) Decoding Logic Errors: A Comparative Study on Bug Detection by Students and Large Language Models (Stephen MacNeil et al., 2023)
...
### (125/144) Sketched and Truncated Polynomial Krylov Subspace Methods: Matrix Equations (Davide Palitta et al., 2023)
...
### (126/144) RIDE: Real-time Intrusion Detection via Explainable Machine Learning Implemented in a Memristor Hardware Architecture (Jingdi Chen et al., 2023)
...
### (127/144) Microarchitectural Security of AWS Firecracker VMM for Serverless Cloud Platforms (Zane Weissman et al., 2023)
...
### (128/144) When Graph Convolution Meets Double Attention: Online Privacy Disclosure Detection with Multi-Label Text Classification (Zhanbo Liang et al., 2023)
...
### (129/144) Towards Adaptive RF Fingerprint-based Authentication of IIoT devices (Emmanuel Lomba et al., 2023)
...
### (130/144) Ontologising Trustworthy in the Telecommunications Domain (Ian Oliver et al., 2023)
...
### (131/144) Privacy-Preserving Data Sharing in Agriculture: Enforcing Policy Rules for Secure and Confidential Data Synthesis (Anantaa Kotal et al., 2023)
...
### (132/144) InstructMol: Multi-Modal Integration for Building a Versatile and Reliable Molecular Assistant in Drug Discovery (He Cao et al., 2023)
...
### (133/144) The Graph Convolutional Network with Multi-representation Alignment for Drug Synergy Prediction (Xinxing Yang et al., 2023)
...
### (134/144) A Fully Data-Driven Approach for Realistic Traffic Signal Control Using Offline Reinforcement Learning (Jianxiong Li et al., 2023)
...
### (135/144) Increasing Coverage and Precision of Textual Information in Multilingual Knowledge Graphs (Simone Conia et al., 2023)
...
### (136/144) Distributed Attacks over Federated Reinforcement Learning-enabled Cell Sleep Control (Han Zhang et al., 2023)
...
### (137/144) Multi-Agent Reinforcement Learning for Power Control in Wireless Networks via Adaptive Graphs (Lorenzo Mario Amorosa et al., 2023)
...
### (138/144) Characterising and Verifying the Core in Concurrent Multi-Player Mean-Payoff Games (Full Version) (Julian Gutierrez et al., 2023)
...
### (139/144) A-JEPA: Joint-Embedding Predictive Architecture Can Listen (Zhengcong Fei et al., 2023)
...
### (140/144) Voice Anonymization for All -- Bias Evaluation of the Voice Privacy Challenge Baseline System (Anna Leschanowsky et al., 2023)
...
### (141/144) A Knowledge Graph Approach for Exploratory Search in Research Institutions (Tim Schopf et al., 2023)
...
### (142/144) Universal Event Detection in Time Series (Menouar Azib et al., 2023)
...
### (143/144) InfoPattern: Unveiling Information Propagation Patterns in Social Media (Chi Han et al., 2023)
...
### (144/144) SpotServe: Serving Generative Large Language Models on Preemptible Instances (Xupeng Miao et al., 2023)
