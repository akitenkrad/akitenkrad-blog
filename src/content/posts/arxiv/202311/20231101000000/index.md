...
Hieu Tran, Zhichao Yang, Zonghai Yao, Hong Yu. (2023)  
**BioInstruct: Instruction Tuning of Large Language Models for Biomedical Natural Language Processing**  

---
Primary Category: cs.CL  
Categories: cs-AI, cs-CL, cs.CL  
Keywords: GPT, GPT-4, LLaMA, Language Model, NLP, Natural Language Processing  
[Paper Link](http://arxiv.org/abs/2310.19975v1)  
...
### (72/151) Strategies to Harness the Transformers' Potential: UNSL at eRisk 2023 (Horacio Thompson et al., 2023)

{{<citation>}}

Horacio Thompson, Leticia Cagnina, Marcelo Errecalde. (2023)  
...
Categories: cs-CL, cs.CL  
Keywords: Transformer, Transformers  
[Paper Link](http://arxiv.org/abs/2310.19970v1)  
...
### (73/151) The Impact of Depth and Width on Transformer Language Model Generalization (Jackson Petty et al., 2023)

{{<citation>}}

Jackson Petty, Sjoerd van Steenkiste, Ishita Dasgupta, Fei Sha, Dan Garrette, Tal Linzen. (2023)  
...
[Paper Link](http://arxiv.org/abs/2310.19956v1)  
...
### (74/151) Split-NER: Named Entity Recognition via Two Question-Answering-based Classifications (Jatin Arora et al., 2023)
...
---
Primary Category: cs.CL  
Categories: I-2-7; H-3-3, cs-CL, cs-IR, cs-LG, cs.CL  
Keywords: BERT, NER, NLP, Named Entity Recognition, QA  
[Paper Link](http://arxiv.org/abs/2310.19942v1)  
...
### (75/151) Jina Embeddings 2: 8192-Token General-Purpose Text Embeddings for Long Documents (Michael Günther et al., 2023)

{{<citation>}}

Michael Günther, Jackmin Ong, Isabelle Mohr, Alaeddine Abdessalem, Tanguy Abel, Mohammad Kalim Akram, Susana Guzman, Georgios Mastrapas, Saba Sturua, Bo Wang, Maximilian Werk, Nan Wang, Han Xiao. (2023)  
**Jina Embeddings 2: 8192-Token General-Purpose Text Embeddings for Long Documents**  

---
Primary Category: cs.CL  
Categories: 68T50, I-2-7, cs-AI, cs-CL, cs-LG, cs.CL  
Keywords: AI, BERT, Embedding, QA  
[Paper Link](http://arxiv.org/abs/2310.19923v1)  
...
### (76/151) The Eval4NLP 2023 Shared Task on Prompting Large Language Models as Explainable Metrics (Christoph Leiter et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2310.19792v1)  
...
### (77/151) What's 'up' with vision-language models? Investigating their struggle with spatial reasoning (Amita Kamath et al., 2023)
...
Keywords: AI, QA  
[Paper Link](http://arxiv.org/abs/2310.19785v1)  
...
### (78/151) Chain-of-Thought Embeddings for Stance Detection on Social Media (Joseph Gatto et al., 2023)

{{<citation>}}

Joseph Gatto, Omar Sharif, Sarah Masud Preum. (2023)  
**Chain-of-Thought Embeddings for Stance Detection on Social Media**  

---
Primary Category: cs.CL  
Categories: cs-CL, cs.CL  
Keywords: BERT, Embedding, Language Model, Social Media, Stance Detection  
[Paper Link](http://arxiv.org/abs/2310.19750v1)  
...
### (79/151) Collaborative Evaluation: Exploring the Synergy of Large Language Models and Humans for Open-ended Generation Evaluation (Qintong Li et al., 2023)

{{<citation>}}

Qintong Li, Leyang Cui, Lingpeng Kong, Wei Bi. (2023)  
...
Categories: cs-CL, cs.CL  
Keywords: Language Model  
[Paper Link](http://arxiv.org/abs/2310.19740v1)  
...
### (80/151) Evaluating Large Language Models: A Comprehensive Survey (Zishan Guo et al., 2023)

{{<citation>}}

Zishan Guo, Renren Jin, Chuang Liu, Yufei Huang, Dan Shi, Supryadi, Linhao Yu, Yan Liu, Jiaxuan Li, Bojian Xiong, Deyi Xiong. (2023)  
...
Categories: cs-AI, cs-CL, cs.CL  
Keywords: Language Model  
[Paper Link](http://arxiv.org/abs/2310.19736v2)  
...
### (81/151) Generating Medical Instructions with Conditional Transformer (Samuel Belkadi et al., 2023)

{{<citation>}}

Samuel Belkadi, Nicolo Micheletti, Lifeng Han, Warren Del-Pinto, Goran Nenadic. (2023)  
**Generating Medical Instructions with Conditional Transformer**  

---
Primary Category: cs.CL  
Categories: cs-AI, cs-CL, cs-LG, cs.CL  
Keywords: Language Model, NER, NLP, Named Entity Recognition, Natural Language Processing, T5, Transformer  
[Paper Link](http://arxiv.org/abs/2310.19727v1)  
...
### (82/151) Combining Language Models For Specialized Domains: A Colorful Approach (Daniel Eitan et al., 2023)
...
### (83/151) Integrating Pre-trained Language Model into Neural Machine Translation (Soon-Jae Hwang et al., 2023)

{{<citation>}}

Soon-Jae Hwang, Chang-Sung Jeong. (2023)  
**Integrating Pre-trained Language Model into Neural Machine Translation**  

---
Primary Category: cs.CL  
Categories: cs-AI, cs-CL, cs-LG, cs.CL  
Keywords: Embedding, Language Model, Machine Translation  
[Paper Link](http://arxiv.org/abs/2310.19680v1)  
...
### (84/151) MoCa: Measuring Human-Language Model Alignment on Causal and Moral Judgment Tasks (Allen Nie et al., 2023)

{{<citation>}}

Allen Nie, Yuhui Zhang, Atharva Amdekar, Chris Piech, Tatsunori Hashimoto, Tobias Gerstenberg. (2023)  
...
Categories: cs-CL, cs.CL  
Keywords: Language Model  
[Paper Link](http://arxiv.org/abs/2310.19677v2)  
...
### (85/151) Large Language Models: The Need for Nuance in Current Debates and a Pragmatic Perspective on Understanding (Bram M. A. van Dijk et al., 2023)

{{<citation>}}

Bram M. A. van Dijk, Tom Kouwenhoven, Marco R. Spruit, Max J. van Duijn. (2023)  
...
Categories: cs-AI, cs-CL, cs.CL  
Keywords: Language Model  
[Paper Link](http://arxiv.org/abs/2310.19671v2)  
...
### (86/151) Interpretable-by-Design Text Classification with Iteratively Generated Concept Bottleneck (Josh Magnus Ludan et al., 2023)

{{<citation>}}

Josh Magnus Ludan, Qing Lyu, Yue Yang, Liam Dugan, Mark Yatskar, Chris Callison-Burch. (2023)  
**Interpretable-by-Design Text Classification with Iteratively Generated Concept Bottleneck**  

---
Primary Category: cs.CL  
Categories: cs-CL, cs.CL  
Keywords: BERT, GPT, GPT-3.5, GPT-4, Language Model, Text Classification  
[Paper Link](http://arxiv.org/abs/2310.19660v1)  
...
### (87/151) Explaining Tree Model Decisions in Natural Language for Network Intrusion Detection (Noah Ziems et al., 2023)

{{<citation>}}

Noah Ziems, Gang Liu, John Flanagan, Meng Jiang. (2023)  
...
[Paper Link](http://arxiv.org/abs/2310.19658v1)  
...
### (88/151) Dynamics of Instruction Tuning: Each Ability of Large Language Models Has Its Own Growth Pace (Chiyu Song et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2310.19651v1)  
...
### (89/151) KeyGen2Vec: Learning Document Embedding via Multi-label Keyword Generation in Question-Answering (Iftitahu Ni'mah et al., 2023)

{{<citation>}}

Iftitahu Ni'mah, Samaneh Khoshrou, Vlado Menkovski, Mykola Pechenizkiy. (2023)  
**KeyGen2Vec: Learning Document Embedding via Multi-label Keyword Generation in Question-Answering**  

---
Primary Category: cs.CL  
Categories: cs-CL, cs.CL  
Keywords: Embedding, QA, Question Answering, Seq2Seq, Sequence-to-Sequence  
[Paper Link](http://arxiv.org/abs/2310.19650v1)  
...
### (90/151) Towards A Holistic Landscape of Situated Theory of Mind in Large Language Models (Ziqiao Ma et al., 2023)

{{<citation>}}

Ziqiao Ma, Jacob Sansom, Run Peng, Joyce Chai. (2023)  
...
Categories: cs-AI, cs-CL, cs.CL  
Keywords: Language Model  
[Paper Link](http://arxiv.org/abs/2310.19619v1)  
...
### (91/151) LLMaAA: Making Large Language Models as Active Annotators (Ruoyu Zhang et al., 2023)

{{<citation>}}

Ruoyu Zhang, Yanzeng Li, Yongliang Ma, Ming Zhou, Lei Zou. (2023)  
...
Categories: cs-AI, cs-CL, cs.CL  
Keywords: Language Model, NLP  
[Paper Link](http://arxiv.org/abs/2310.19596v2)  
...
### (92/151) Improving Input-label Mapping with Demonstration Replay for In-context Learning (Zhuocheng Gong et al., 2023)

{{<citation>}}

Zhuocheng Gong, Jiahao Liu, Qifan Wang, Jingang Wang, Xunliang Cai, Dongyan Zhao, Rui Yan. (2023)  
...
[Paper Link](http://arxiv.org/abs/2310.19572v1)  
...
### (93/151) CreoleVal: Multilingual Multitask Benchmarks for Creoles (Heather Lent et al., 2023)

{{<citation>}}

Heather Lent, Kushal Tatariya, Raj Dabre, Yiyi Chen, Marcell Fekete, Esther Ploeger, Li Zhou, Hans Erik Heje, Diptesh Kanojia, Paul Belony, Marcel Bollmann, Loïc Grobol, Miryam de Lhoneux, Daniel Hershcovich, Michel DeGraff, Anders Søgaard, Johannes Bjerva. (2023)  
...
[Paper Link](http://arxiv.org/abs/2310.19567v1)  
...
### (94/151) InfoEntropy Loss to Mitigate Bias of Learning Difficulties for Generative Language Models (Zhenpeng Su et al., 2023)

{{<citation>}}

Zhenpeng Su, Xing Wu, Xue Bai, Zijia Lin, Hui Chen, Guiguang Ding, Wei Zhou, Songlin Hu. (2023)  
...
### (95/151) Constituency Parsing using LLMs (Xuefeng Bai et al., 2023)

{{<citation>}}

Xuefeng Bai, Jialong Wu, Yulong Chen, Zhongqing Wang, Yue Zhang. (2023)  
**Constituency Parsing using LLMs**  

---
Primary Category: cs.CL  
Categories: cs-CL, cs.CL  
Keywords: ChatGPT, GPT, GPT-4, LLaMA  
[Paper Link](http://arxiv.org/abs/2310.19462v2)  
...
### (96/151) Mean BERTs make erratic language teachers: the effectiveness of latent bootstrapping in low-resource settings (David Samuel, 2023)
...
Categories: cs-CL, cs-LG, cs.CL  
Keywords: BERT  
[Paper Link](http://arxiv.org/abs/2310.19420v1)  
...
### (97/151) A Lightweight Method to Generate Unanswerable Questions in English (Vagrant Gautam et al., 2023)

{{<citation>}}

Vagrant Gautam, Miaoran Zhang, Dietrich Klakow. (2023)  
...
Keywords: BERT, QA  
[Paper Link](http://arxiv.org/abs/2310.19403v1)  
...
### (98/151) Improving Factual Consistency of Text Summarization by Adversarially Decoupling Comprehension and Embellishment Abilities of LLMs (Huawen Feng et al., 2023)

{{<citation>}}

Huawen Feng, Yan Fan, Xiong Liu, Ting-En Lin, Zekun Yao, Yuchuan Wu, Fei Huang, Yongbin Li, Qianli Ma. (2023)  
...
### (99/151) ROME: Evaluating Pre-trained Vision-Language Models on Reasoning beyond Visual Common Sense (Kankan Zhou et al., 2023)

{{<citation>}}

Kankan Zhou, Eason Lai, Wei Bin Au Yeong, Kyriakos Mouratidis, Jing Jiang. (2023)  
...
[Paper Link](http://arxiv.org/abs/2310.19301v1)  
...
### (100/151) Fusing Temporal Graphs into Transformers for Time-Sensitive Question Answering (Xin Su et al., 2023)

{{<citation>}}

Xin Su, Phillip Howard, Nagib Hakim, Steven Bethard. (2023)  
...
[Paper Link](http://arxiv.org/abs/2310.19292v1)  
...
### (101/151) Overview of the CLAIMSCAN-2023: Uncovering Truth in Social Media through Claim Detection and Identification of Claim Spans (Megha Sundriyal et al., 2023)
...
Primary Category: cs.CL  
Categories: cs-CL, cs.CL  
Keywords: AI, Information Retrieval, Social Media  
[Paper Link](http://arxiv.org/abs/2310.19267v1)  
...
### (102/151) M4LE: A Multi-Ability Multi-Range Multi-Task Multi-Domain Long-Context Evaluation Benchmark for Large Language Models (Wai-Chung Kwan et al., 2023)

{{<citation>}}

Wai-Chung Kwan, Xingshan Zeng, Yufei Wang, Yusen Sun, Liangyou Li, Lifeng Shang, Qun Liu, Kam-Fai Wong. (2023)  
...
Categories: cs-CL, cs.CL  
Keywords: Language Model, NLP  
[Paper Link](http://arxiv.org/abs/2310.19240v1)  
...
### (103/151) Building Real-World Meeting Summarization Systems using Large Language Models: A Practical Perspective (Md Tahmid Rahman Laskar et al., 2023)
...
Primary Category: cs.CL  
Categories: cs-CL, cs.CL  
Keywords: GPT, GPT-4, LLaMA, Language Model, PaLM, Summarization  
[Paper Link](http://arxiv.org/abs/2310.19233v1)  
...
### (104/151) Adapter Pruning using Tropical Characterization (Rishabh Bhardwaj et al., 2023)

{{<citation>}}

Rishabh Bhardwaj, Tushar Vaidya, Soujanya Poria. (2023)  
...
[Paper Link](http://arxiv.org/abs/2310.19232v1)  
...
### (105/151) EHRTutor: Enhancing Patient Understanding of Discharge Instructions (Zihao Zhang et al., 2023)

{{<citation>}}

Zihao Zhang, Zonghai Yao, Huixue Zhou, Feiyun ouyang, Hong Yu. (2023)  
...
Categories: cs-AI, cs-CL, cs.CL  
Keywords: Language Model  
[Paper Link](http://arxiv.org/abs/2310.19212v1)  
...
### (106/151) LitCab: Lightweight Calibration of Language Models on Outputs of Varied Lengths (Xin Liu et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2310.19208v1)  
...
### (107/151) FOCAL: Contrastive Learning for Multimodal Time-Series Sensing Signals in Factorized Orthogonal Latent Space (Shengzhong Liu et al., 2023)

{{<citation>}}

Shengzhong Liu, Tomoyoshi Kimura, Dongxin Liu, Ruijie Wang, Jinyang Li, Suhas Diggavi, Mani Srivastava, Tarek Abdelzaher. (2023)  
**FOCAL: Contrastive Learning for Multimodal Time-Series Sensing Signals in Factorized Orthogonal Latent Space**  

---
Primary Category: cs.AI  
Categories: cs-AI, cs-LG, cs-MM, cs.AI  
Keywords: Contrastive Learning  
[Paper Link](http://arxiv.org/abs/2310.20071v1)  
...
### (108/151) Concept Alignment as a Prerequisite for Value Alignment (Sunayana Rane et al., 2023)

{{<citation>}}

Sunayana Rane, Mark Ho, Ilia Sucholutsky, Thomas L. Griffiths. (2023)  
...
Keywords: AI  
[Paper Link](http://arxiv.org/abs/2310.20059v1)  
...
### (109/151) Look At Me, No Replay! SurpriseNet: Anomaly Detection Inspired Class Incremental Learning (Anton Lee et al., 2023)

{{<citation>}}

Anton Lee, Yaqian Zhang, Heitor Murilo Gomes, Albert Bifet, Bernhard Pfahringer. (2023)  
...
[Paper Link](http://arxiv.org/abs/2310.20052v1)  
...
### (110/151) Unmasking Bias and Inequities: A Systematic Review of Bias Detection and Mitigation in Healthcare Artificial Intelligence Using Electronic Health Records (Feng Chen et al., 2023)

{{<citation>}}

Feng Chen, Liqin Wang, Julie Hong, Jiaqi Jiang, Li Zhou. (2023)  
...
---
Primary Category: cs.AI  
Categories: cs-AI, cs-CY, cs-LG, cs.AI, q-bio-QM  
Keywords: AI, Bias  
[Paper Link](http://arxiv.org/abs/2310.19917v1)  
...
### (111/151) Herd: Using multiple, smaller LLMs to match the performances of proprietary, large LLMs via an intelligent composer (Surya Narayanan Hari et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2310.19902v1)  
...
### (112/151) Explainable Artificial Intelligence (XAI) 2.0: A Manifesto of Open Challenges and Interdisciplinary Research Directions (Luca Longo et al., 2023)

{{<citation>}}

Luca Longo, Mario Brcic, Federico Cabitza, Jaesik Choi, Roberto Confalonieri, Javier Del Ser, Riccardo Guidotti, Yoichi Hayashi, Francisco Herrera, Andreas Holzinger, Richard Jiang, Hassan Khosravi, Freddy Lecue, Gianclaudio Malgieri, Andrés Páez, Wojciech Samek, Johannes Schneider, Timo Speith, Simone Stumpf. (2023)  
**Explainable Artificial Intelligence (XAI) 2.0: A Manifesto of Open Challenges and Interdisciplinary Research Directions**  

---
Primary Category: cs.AI  
Categories: F-2-0; H-1-2; I-2; I-2-6; K-4; K-5, cs-AI, cs.AI  
Keywords: AI  
[Paper Link](http://arxiv.org/abs/2310.19775v1)  
...
### (113/151) Adversarial Attacks and Defenses in Large Language Models: Old and New Threats (Leo Schwinn et al., 2023)
...
Primary Category: cs.AI  
Categories: cs-AI, cs.AI  
Keywords: Adversarial Attack, ChatGPT, GPT, Google, Language Model  
[Paper Link](http://arxiv.org/abs/2310.19737v1)  
...
### (114/151) AI Alignment: A Comprehensive Survey (Jiaming Ji et al., 2023)

{{<citation>}}

Jiaming Ji, Tianyi Qiu, Boyuan Chen, Borong Zhang, Hantao Lou, Kaile Wang, Yawen Duan, Zhonghao He, Jiayi Zhou, Zhaowei Zhang, Fanzhi Zeng, Kwan Yee Ng, Juntao Dai, Xuehai Pan, Aidan O'Gara, Yingshan Lei, Hua Xu, Brian Tse, Jie Fu, Stephen McAleer, Yaodong Yang, Yizhou Wang, Song-Chun Zhu, Yike Guo, Wen Gao. (2023)  
...
### (115/151) Technical Report on the Learning of Case Relevance in Case-Based Reasoning with Abstract Argumentation (Guilherme Paulino-Passos et al., 2023)

{{<citation>}}

Guilherme Paulino-Passos, Francesca Toni. (2023)  
...
Categories: cs-AI, cs.AI  
Keywords: Reasoning  
[Paper Link](http://arxiv.org/abs/2310.19607v1)  
...
### (116/151) Trust, Accountability, and Autonomy in Knowledge Graph-based AI for Self-determination (Luis-Daniel Ibáñez et al., 2023)

{{<citation>}}

Luis-Daniel Ibáñez, John Domingue, Sabrina Kirrane, Oshani Seneviratne, Aisling Third, Maria-Esther Vidal. (2023)  
**Trust, Accountability, and Autonomy in Knowledge Graph-based AI for Self-determination**  

---
Primary Category: cs.AI  
Categories: cs-AI, cs-CY, cs-MA, cs.AI  
Keywords: AI, Google, Knowledge Graph, Language Model  
[Paper Link](http://arxiv.org/abs/2310.19503v2)  
...
### (117/151) Protecting Publicly Available Data With Machine Learning Shortcuts (Nicolas M. Müller et al., 2023)

{{<citation>}}

Nicolas M. Müller, Maximilian Burgert, Pascal Debus, Jennifer Williams, Philip Sperl, Konstantin Böttinger. (2023)  
...
Categories: cs-AI, cs.AI  
Keywords: AI  
[Paper Link](http://arxiv.org/abs/2310.19381v1)  
...
### (118/151) Uncertainty-guided Boundary Learning for Imbalanced Social Event Detection (Jiaqian Ren et al., 2023)

{{<citation>}}

Jiaqian Ren, Hao Peng, Lei Jiang, Zhiwei Liu, Jia Wu, Zhengtao Yu, Philip S. Yu. (2023)  
...
[Paper Link](http://arxiv.org/abs/2310.19247v1)  
...
### (119/151) Leveraging generative artificial intelligence to simulate student learning behavior (Songlin Xu et al., 2023)
...
Categories: cs-AI, cs.AI  
Keywords: AI  
[Paper Link](http://arxiv.org/abs/2310.19206v1)  
...
### (120/151) Evaluation Framework for Understanding Sensitive Attribute Association Bias in Latent Factor Recommendation Algorithms (Lex Beattie et al., 2023)

{{<citation>}}

Lex Beattie, Isabel Corpus, Lucy H. Lin, Praveen Ravichandran. (2023)  
...
Keywords: Bias, NLP  
[Paper Link](http://arxiv.org/abs/2310.20061v1)  
...
### (121/151) CoLLM: Integrating Collaborative Embeddings into Large Language Models for Recommendation (Yang Zhang et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2310.19488v1)  
...
### (122/151) LightSAGE: Graph Neural Networks for Large Scale Item Retrieval in Shopee's Advertisement Recommendation (Dang Minh Nguyen et al., 2023)

{{<citation>}}

Dang Minh Nguyen, Chenfei Wang, Yan Shen, Yifan Zeng. (2023)  
**LightSAGE: Graph Neural Networks for Large Scale Item Retrieval in Shopee's Advertisement Recommendation**  

---
Primary Category: cs.IR  
Categories: H-3-3; I-2-4, cs-IR, cs-LG, cs.IR  
Keywords: GNN, Graph Neural Network, Graph Neural Networks  
[Paper Link](http://arxiv.org/abs/2310.19394v1)  
...
### (123/151) Pre-trained Recommender Systems: A Causal Debiasing Perspective (Ziqian Lin et al., 2023)

{{<citation>}}

Ziqian Lin, Hao Ding, Nghia Hoang, Branislav Kveton, Anoop Deoras, Hao Wang. (2023)  
...
Keywords: AI  
[Paper Link](http://arxiv.org/abs/2310.19251v1)  
...
### (124/151) On the data-driven description of lattice materials mechanics (Ismael Ben-Yelun et al., 2023)

{{<citation>}}

Ismael Ben-Yelun, Luis Irastorza-Valera, Luis Saucedo-Mora, Francisco Javier Montáns, Francisco Chinesta. (2023)  
...
[Paper Link](http://arxiv.org/abs/2310.20056v1)  
...
### (125/151) GG-LLM: Geometrically Grounding Large Language Models for Zero-shot Human Activity Forecasting in Human-Aware Task Planning (Moritz A. Graule et al., 2023)

{{<citation>}}

Moritz A. Graule, Volkan Isler. (2023)  
...
Keywords: Language Model  
[Paper Link](http://arxiv.org/abs/2310.20034v1)  
...
### (126/151) Spatiotemporal Attention Enhances Lidar-Based Robot Navigation in Dynamic Environments (Jorge de Heuvel et al., 2023)

{{<citation>}}

Jorge de Heuvel, Xiangyu Zeng, Weixian Shi, Tharun Sethuraman, Maren Bennewitz. (2023)  
...
Categories: cs-RO, cs.RO  
Keywords: Attention  
[Paper Link](http://arxiv.org/abs/2310.19670v1)  
...
### (127/151) Large Trajectory Models are Scalable Motion Predictors and Planners (Qiao Sun et al., 2023)

{{<citation>}}

Qiao Sun, Shiduo Zhang, Danjiao Ma, Jingzhe Shi, Derun Li, Simian Luo, Yu Wang, Ningyi Xu, Guangzhi Cao, Hang Zhao. (2023)  
...
Keywords: Transformer  
[Paper Link](http://arxiv.org/abs/2310.19620v1)  
...
### (128/151) Improved Bayesian Regret Bounds for Thompson Sampling in Reinforcement Learning (Ahmadreza Moradipari et al., 2023)

{{<citation>}}

Ahmadreza Moradipari, Mohammad Pedramfar, Modjtaba Shokrian Zini, Vaneet Aggarwal. (2023)  
...
Keywords: Reinforcement Learning  
[Paper Link](http://arxiv.org/abs/2310.20007v1)  
...
### (129/151) An Online Bootstrap for Time Series (Nicolai Palm et al., 2023)

{{<citation>}}

Nicolai Palm, Thomas Nagler. (2023)  
...
Keywords: Time Series  
[Paper Link](http://arxiv.org/abs/2310.19683v1)  
...
### (130/151) Locally Optimal Best Arm Identification with a Fixed Budget (Masahiro Kato, 2023)
...
Categories: cs-LG, econ-EM, math-ST, math.ST, stat-ME, stat-ML, stat-TH  
Keywords: AI  
[Paper Link](http://arxiv.org/abs/2310.19788v1)  
...
### (131/151) Designing AI Support for Human Involvement in AI-assisted Decision Making: A Taxonomy of Human-AI Interactions from a Systematic Review (Catalina Gomez et al., 2023)

{{<citation>}}

Catalina Gomez, Sue Min Cho, Shichang Ke, Chien-Ming Huang, Mathias Unberath. (2023)  
...
Keywords: AI  
[Paper Link](http://arxiv.org/abs/2310.19778v2)  
...
### (132/151) Relation-driven Query of Multiple Time Series (Shuhan Liu et al., 2023)

{{<citation>}}

Shuhan Liu, Yuan Tian, Zikun Deng, Weiwei Cui, Haidong Zhang, Di Weng, Yingcai Wu. (2023)  
...
Keywords: Time Series  
[Paper Link](http://arxiv.org/abs/2310.19311v1)  
...
### (133/151) rTsfNet: a DNN model with Multi-head 3D Rotation and Time Series Feature Extraction for IMU-based Human Activity Recognition (Yu Enokibori, 2023)
...
### (134/151) Eliciting Topic Hierarchies from Large Language Models (Grace Li et al., 2023)

{{<citation>}}

Grace Li, Tao Long, Lydia B. Chilton. (2023)  
...
Categories: cs-HC, cs.HC  
Keywords: Language Model  
[Paper Link](http://arxiv.org/abs/2310.19275v1)  
...
### (135/151) Autoregressive Attention Neural Networks for Non-Line-of-Sight User Tracking with Dynamic Metasurface Antennas (Kyriakos Stylianopoulos et al., 2023)

{{<citation>}}

Kyriakos Stylianopoulos, Murat Bayraktar, Nuria González Prelcic, George C. Alexandropoulos. (2023)  
...
Keywords: Attention  
[Paper Link](http://arxiv.org/abs/2310.19767v1)  
...
### (136/151) Sentiment Analysis in Digital Spaces: An Overview of Reviews (Laura E. M. Ayravainen et al., 2023)

{{<citation>}}

Laura E. M. Ayravainen, Joanne Hinds, Brittany I. Davidson. (2023)  
**Sentiment Analysis in Digital Spaces: An Overview of Reviews**  

---
Primary Category: cs.CY  
Categories: I-2-7, cs-CL, cs-CY, cs.CY  
Keywords: Sentiment Analysis  
[Paper Link](http://arxiv.org/abs/2310.19687v1)  
...
### (137/151) Scalable Two-Minute Feedback: Digital, Lecture-Accompanying Survey as a Continuous Feedback Instrument (Armin Egetenmeier et al., 2023)

{{<citation>}}

Armin Egetenmeier, Sven Strickroth. (2023)  
...
Keywords: AI  
[Paper Link](http://arxiv.org/abs/2310.19334v1)  
...
### (138/151) Extracting user needs with Chat-GPT for dialogue recommendation (Yugen Sato et al., 2023)

{{<citation>}}

Yugen Sato, Taisei Nakajima, Tatsuki Kawamoto, Tomohiro Takagi. (2023)  
...
[Paper Link](http://arxiv.org/abs/2310.19303v1)  
...
### (139/151) Density Estimation for Entry Guidance Problems using Deep Learning (Jens A. Rataczak et al., 2023)

{{<citation>}}

Jens A. Rataczak, Davide Amato, Jay W. McMahon. (2023)  
...
Keywords: LSTM  
[Paper Link](http://arxiv.org/abs/2310.19684v1)  
...
### (140/151) Domain Generalization in Computational Pathology: Survey and Guidelines (Mostafa Jahanifar et al., 2023)

{{<citation>}}

Mostafa Jahanifar, Manahil Raza, Kesi Xu, Trinh Vuong, Rob Jewsbury, Adam Shephard, Neda Zamanitajeddin, Jin Tae Kwak, Shan E Ahmed Raza, Fayyaz Minhas, Nasir Rajpoot. (2023)  
...
[Paper Link](http://arxiv.org/abs/2310.19656v1)  
...
### (141/151) A Clinical Guideline Driven Automated Linear Feature Extraction for Vestibular Schwannoma (Navodini Wijethilake et al., 2023)

{{<citation>}}

Navodini Wijethilake, Steve Connor, Anna Oviedova, Rebecca Burger, Tom Vercauteren, Jonathan Shapey. (2023)  
...
Categories: cs-CV, cs-LG, eess-IV, eess.IV  
Keywords: Clinical  
[Paper Link](http://arxiv.org/abs/2310.19392v1)  
...
### (142/151) Consistent Query Answering for Primary Keys on Rooted Tree Queries (Paraschos Koutris et al., 2023)
...
Keywords: AI, QA  
[Paper Link](http://arxiv.org/abs/2310.19642v1)  
...
### (143/151) DCHT: Deep Complex Hybrid Transformer for Speech Enhancement (Jialu Li et al., 2023)

{{<citation>}}

Jialu Li, Junhui Li, Pu Wang, Youshan Zhang. (2023)  
...
Keywords: Transformer  
[Paper Link](http://arxiv.org/abs/2310.19602v1)  
...
### (144/151) DPATD: Dual-Phase Audio Transformer for Denoising (Junhui Li et al., 2023)
...
Keywords: Transformer  
[Paper Link](http://arxiv.org/abs/2310.19588v1)  
...
### (145/151) Transformer-based nowcasting of radar composites from satellite images for severe weather (Çağlar Küçük et al., 2023)

{{<citation>}}

Çağlar Küçük, Apostolos Giannakos, Stefan Schneider, Alexander Jann. (2023)  
**Transformer-based nowcasting of radar composites from satellite images for severe weather**  

---
Primary Category: physics.ao-ph  
Categories: cs-CV, cs-LG, eess-IV, physics-ao-ph, physics.ao-ph  
Keywords: Transformer  
[Paper Link](http://arxiv.org/abs/2310.19515v1)  
...
### (146/151) Denoising Diffusion Probabilistic Models for Hardware-Impaired Communication Systems: Towards Wireless Generative AI (Mehdi Letafati et al., 2023)
...
[Paper Link](http://arxiv.org/abs/2310.19460v1)  
...
### (147/151) Increased Multiplexing Gain with Reconfigurable Surfaces: Simultaneous Channel Orthogonalization and Information Embedding (Juan Vidal Alegria et al., 2023)

{{<citation>}}

Juan Vidal Alegria, Joao Vieira, Fredrik Rusek. (2023)  
...
Keywords: Embedding  
[Paper Link](http://arxiv.org/abs/2310.19409v1)  
...
### (148/151) Security Challenges for Cloud or Fog Computing-Based AI Applications (Amir Pakmehr et al., 2023)

{{<citation>}}

Amir Pakmehr, Andreas Aßmuth, Christoph P. Neumann, Gerald Pirkl. (2023)  
...
[Paper Link](http://arxiv.org/abs/2310.19459v1)  
...
### (149/151) Privacy-Preserving Federated Learning over Vertically and Horizontally Partitioned Data for Financial Anomaly Detection (Swanand Ravindra Kadhe et al., 2023)

{{<citation>}}

Swanand Ravindra Kadhe, Heiko Ludwig, Nathalie Baracaldo, Alan King, Yi Zhou, Keith Houck, Ambrish Rawat, Mark Purcell, Naoise Holohan, Mikio Takeuchi, Ryo Kawahara, Nir Drucker, Hayim Shaul, Eyal Kushnir, Omri Soceanu. (2023)  
...
[Paper Link](http://arxiv.org/abs/2310.19304v1)  
...
### (150/151) AdapINT: A Flexible and Adaptive In-Band Network Telemetry System Based on Deep Reinforcement Learning (Penghui Zhang et al., 2023)

{{<citation>}}

Penghui Zhang, Hua Zhang, Yibo Pi, Zijian Cao, Jingyu Wang, Jianxin Liao. (2023)  
...
Keywords: Reinforcement Learning  
[Paper Link](http://arxiv.org/abs/2310.19331v1)  
...
### (151/151) Can ChatGPT advance software testing intelligence? An experience report on metamorphic testing (Quang-Hung Luu et al., 2023)

{{<citation>}}

Quang-Hung Luu, Huai Liu, Tsong Yueh Chen. (2023)  
...
Keywords: ChatGPT, GPT  
[Paper Link](http://arxiv.org/abs/2310.19204v1)  
