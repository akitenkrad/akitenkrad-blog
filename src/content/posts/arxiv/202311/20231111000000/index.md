...
### (1/83) Window Attention is Bugged: How not to Interpolate Position Embeddings (Daniel Bolya et al., 2023)
...
### (2/83) 3D-QAE: Fully Quantum Auto-Encoding of 3D Point Clouds (Lakshika Rathi et al., 2023)
...
### (3/83) Accuracy of a Vision-Language Model on Challenging Medical Cases (Thomas Buckley et al., 2023)
...
### (4/83) High-Performance Transformers for Table Structure Recognition Need Early Convolutions (ShengYun Peng et al., 2023)
...
### (5/83) Object-centric Cross-modal Feature Distillation for Event-based Object Detection (Lei Li et al., 2023)
...
### (6/83) LLaVA-Plus: Learning to Use Tools for Creating Multimodal Agents (Shilong Liu et al., 2023)
...
### (7/83) Dual Pipeline Style Transfer with Input Distribution Differentiation (ShiQi Jiang et al., 2023)
...
### (8/83) Linear Gaussian Bounding Box Representation and Ring-Shaped Rotated Convolution for Oriented Object Detection (Zhen Zhou et al., 2023)
...
### (9/83) Improving Hand Recognition in Uncontrolled and Uncooperative Environments using Multiple Spatial Transformers and Loss Functions (Wojciech Michal Matkowski et al., 2023)
...
### (10/83) u-LLaVA: Unifying Multi-Modal Tasks via Large Language Model (Jinjin Xu et al., 2023)
...
### (11/83) On the Road with GPT-4V(ision): Early Explorations of Visual-Language Model on Autonomous Driving (Licheng Wen et al., 2023)
...
### (12/83) Spatial Attention-based Distribution Integration Network for Human Pose Estimation (Sihan Gao et al., 2023)
...
### (13/83) Improving Vision-and-Language Reasoning via Spatial Relations Modeling (Cheng Yang et al., 2023)
...
### (14/83) BrainNetDiff: Generative AI Empowers Brain Network Generation via Multimodal Diffusion Model (Yongcheng Zong et al., 2023)
...
### (15/83) Deep Learning in Computed Tomography Pulmonary Angiography Imaging: A Dual-Pronged Approach for Pulmonary Embolism Detection (Fabiha Bushra et al., 2023)
...
### (16/83) FireMatch: A Semi-Supervised Video Fire Detection Network Based on Consistency and Distribution Alignment (Qinghua Lin et al., 2023)
...
### (17/83) Dynamic Association Learning of Self-Attention and Convolution in Image Restoration (Kui Jiang et al., 2023)
...
### (18/83) OW-SLR: Overlapping Windows on Semi-Local Region for Image Super-Resolution (Rishav Bhardwaj et al., 2023)
...
### (19/83) SCAAT: Improving Neural Network Interpretability via Saliency Constrained Adaptive Adversarial Training (Rui Xu et al., 2023)

{{<citation>}}

Rui Xu, Wenkang Qin, Peixiang Huang, Haowang, Lin Luo. (2023)  
...
[Paper Link](http://arxiv.org/abs/2311.05143v1)  
...
### (20/83) Reducing the Side-Effects of Oscillations in Training of Quantized YOLO Networks (Kartik Gupta et al., 2023)
...
### (21/83) Efficient Parallelization Layouts for Large-Scale Distributed Model Training (Johannes Hagemann et al., 2023)
...
### (22/83) LLM Augmented Hierarchical Agents (Bharat Prakash et al., 2023)
...
### (23/83) Bayesian Methods for Media Mix Modelling with shape and funnel effects (Javier Marin, 2023)
...
### (24/83) Zero-Shot Goal-Directed Dialogue via RL on Imagined Conversations (Joey Hong et al., 2023)
...
### (25/83) Exploiting Neural-Network Statistics for Low-Power DNN Inference (Lennart Bamberg et al., 2023)
...
### (26/83) Embedding Space Interpolation Beyond Mini-Batch, Beyond Pairs and Beyond Examples (Shashanka Venkataramanan et al., 2023)
...
### (27/83) Anytime-Constrained Reinforcement Learning (Jeremy McMahan et al., 2023)
...
### (28/83) Diffusion Based Causal Representation Learning (Amir Mohammad Karimi Mamaghan et al., 2023)
...
### (29/83) Generalization in medical AI: a perspective on developing scalable models (Joachim A. Behar et al., 2023)
...
### (30/83) RepQ: Generalizing Quantization-Aware Training for Re-Parametrized Architectures (Anastasiia Prutianova et al., 2023)
...
### (31/83) Mixture of Weak & Strong Experts on Graphs (Hanqing Zeng et al., 2023)
...
### (32/83) RAPID: Training-free Retrieval-based Log Anomaly Detection with PLM considering Token-level information (Gunho No et al., 2023)
...
### (33/83) Cross-modal Prompts: Adapting Large Pre-trained Models for Audio-Visual Downstream Tasks (Haoyi Duan et al., 2023)
...
### (34/83) Counter-Empirical Attacking based on Adversarial Reinforcement Learning for Time-Relevant Scoring System (Xiangguo Sun et al., 2023)
...
### (35/83) On neural and dimensional collapse in supervised and unsupervised contrastive learning with hard negative sampling (Ruijie Jiang et al., 2023)
...
### (36/83) GeoFormer: Predicting Human Mobility using Generative Pre-trained Transformer (GPT) (Aivin V. Solatorio, 2023)
...
### (37/83) Social Media Bot Detection using Dropout-GAN (Anant Shukla et al., 2023)
...
### (38/83) Mental Health Diagnosis in the Digital Age: Harnessing Sentiment Analysis on Social Media Platforms upon Ultra-Sparse Feature Content (Haijian Shao et al., 2023)
...
### (39/83) What Do I Hear? Generating Sounds for Visuals with ChatGPT (David Chuan-En Lin et al., 2023)
...
### (40/83) FigStep: Jailbreaking Large Vision-language Models via Typographic Visual Prompts (Yichen Gong et al., 2023)
...
### (41/83) ChatGPT and other Large Language Models for Cybersecurity of Smart Grid Applications (Aydin Zaboli et al., 2023)
...
### (42/83) RAGLog: Log Anomaly Detection using Retrieval Augmented Generation (Jonathan Pan et al., 2023)
...
### (43/83) Conversational AI Threads for Visualizing Multidimensional Datasets (Matt-Heun Hong et al., 2023)
...
### (44/83) What is prompt literacy? An exploratory study of language learners' development of new literacy skill using generative AI (Yohan Hwang et al., 2023)
...
### (45/83) Joint SDN Synchronization and Controller Placement in Wireless Networks using Deep Reinforcement Learning (Akrit Mudvari et al., 2023)
...
### (46/83) Atom: Neural Traffic Compression with Spatio-Temporal Graph Neural Networks (Paul Almasan et al., 2023)
...
### (47/83) Removing RLHF Protections in GPT-4 via Fine-Tuning (Qiusi Zhan et al., 2023)
...
### (48/83) The Iron(ic) Melting Pot: Reviewing Human Evaluation in Humour, Irony and Sarcasm Generation (Tyler Loakman et al., 2023)
...
### (49/83) Text Representation Distillation via Information Bottleneck Principle (Yanzhao Zhang et al., 2023)
...
### (50/83) All Should Be Equal in the Eyes of Language Models: Counterfactually Aware Fair Text Generation (Pragyan Banerjee et al., 2023)
...
### (51/83) Cognitively Inspired Components for Social Conversational Agents (Alex Clay et al., 2023)
...
### (52/83) Mirror: A Universal Framework for Various Information Extraction Tasks (Tong Zhu et al., 2023)
...
### (53/83) Memorisation Cartography: Mapping out the Memorisation-Generalisation Continuum in Neural Machine Translation (Verna Dankers et al., 2023)
...
### (54/83) TencentLLMEval: A Hierarchical Evaluation of Real-World Capabilities for Human-Aligned LLMs (Shuyi Xie et al., 2023)
...
### (55/83) Do personality tests generalize to Large Language Models? (Florian E. Dorner et al., 2023)
...
### (56/83) DeeLM: Dependency-enhanced Large Language Model for Sentence Embeddings (Xianming Li et al., 2023)
...
### (57/83) A Survey on Hallucination in Large Language Models: Principles, Taxonomy, Challenges, and Open Questions (Lei Huang et al., 2023)
...
### (58/83) Large Language Models and Prompt Engineering for Biomedical Query Focused Multi-Document Summarisation (Diego Mollá, 2023)
...
### (59/83) Enhancing Computation Efficiency in Large Language Models through Weight and Activation Quantization (Jangwhan Lee et al., 2023)
...
### (60/83) Weakly-supervised Deep Cognate Detection Framework for Low-Resourced Languages Using Morphological Knowledge of Closely-Related Languages (Koustava Goswami et al., 2023)
...
### (61/83) Quranic Conversations: Developing a Semantic Search tool for the Quran using Arabic NLP Techniques (Yasser Shohoud et al., 2023)
...
### (62/83) Unsupervised Translation Quality Estimation Exploiting Synthetic Data and Pre-trained Multilingual Encoder (Yuto Kuroda et al., 2023)
...
### (63/83) Conic10K: A Challenging Math Problem Understanding and Reasoning Dataset (Haoyi Wu et al., 2023)
...
### (64/83) A Survey of Large Language Models in Medicine: Progress, Application, and Challenge (Hongjian Zhou et al., 2023)
...
### (65/83) Legal-HNet: Mixing Legal Long-Context Tokens with Hartley Transform (Daniele Giofré et al., 2023)
...
### (66/83) Characterizing Large Language Models as Rationalizers of Knowledge-intensive Tasks (Aditi Mishra et al., 2023)
...
### (67/83) A Framework to Assess (Dis)agreement Among Diverse Rater Groups (Vinodkumar Prabhakaran et al., 2023)
...
### (68/83) Multi-Agent Quantum Reinforcement Learning using Evolutionary Optimization (Michael Kölle et al., 2023)
...
### (69/83) Towards Quantum-Native Communication Systems: New Developments, Trends, and Challenges (Xiaolin Zhou et al., 2023)
...
### (70/83) Dirichlet Active Learning (Kevin Miller et al., 2023)
...
### (71/83) General Policies, Subgoal Structure, and Planning Width (Blai Bonet et al., 2023)
...
### (72/83) Kantian Deontology Meets AI Alignment: Towards Morally Robust Fairness Metrics (Carlos Mougan et al., 2023)
...
### (73/83) News and Misinformation Consumption in Europe: A Longitudinal Cross-Country Perspective (Anees Baqir et al., 2023)
...
Keywords: Twitter  
[Paper Link](http://arxiv.org/abs/2311.05487v1)  
...
### (74/83) Using ResNet to Utilize 4-class T2-FLAIR Slice Classification Based on the Cholinergic Pathways Hyperintensities Scale for Pathological Aging (Wei-Chun Kevin Tsai et al., 2023)
...
### (75/83) Transformer-based Model for Oral Epithelial Dysplasia Segmentation (Adam J Shephard et al., 2023)
...
### (76/83) On the Complexity of the Virtual Network Embedding in Specific Tree Topologies (Sergey Pankratov et al., 2023)
...
### (77/83) TLCFuse: Temporal Multi-Modality Fusion Towards Occlusion-Aware Semantic Segmentation-Aided Motion Planning (Gustavo Salazar-Gomez et al., 2023)
...
### (78/83) Green Resilience of Cyber-Physical Systems (Diaeddin Rimawi, 2023)
...
### (79/83) Improving Whispered Speech Recognition Performance using Pseudo-whispered based Data Augmentation (Zhaofeng Lin et al., 2023)
...
### (80/83) Rethinking Residual Connection in Training Large-Scale Spiking Neural Networks (Yudong Li et al., 2023)
...
### (81/83) A differentiable brain simulator bridging brain simulation and brain-inspired computing (Chaoming Wang et al., 2023)
...
### (82/83) Improving Computational Efficiency for Powered Descent Guidance via Transformer-based Tight Constraint Prediction (Julia Briden et al., 2023)
...
### (83/83) Vector Approximate Survey Propagation for Model-Mismatched Estimation (Or: How to Achieve Kabashima's 1RSB Prediction) (Qun Chen et al., 2023)
